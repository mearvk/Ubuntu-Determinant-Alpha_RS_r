# Algeria Data Sources and Full-Data Build
...
- **World Bank — World Development Indicators (WDI).** Macro/structural series for Algeria
  (`DZA`): GDP, GDP growth, agriculture value added, agricultural/arable land, employment.
  - https://data.worldbank.org · API: https://api.worldbank.org/v2/country/DZA/indicator/{code}
...
- **ONS (Office National des Statistiques).** National statistical office; preferred for table-level supplementation
  where a compatible series is transcribed. https://www.ons.dz/
...
`tools/dza` … see `tools/` builder for this country. It generates ten domain
