# Austria Data Sources and Full-Data Build
...
- **World Bank — World Development Indicators (WDI).** Macro/structural series for Austria
  (`AUT`): GDP, GDP growth, agriculture value added, agricultural/arable land, employment.
  - https://data.worldbank.org · API: https://api.worldbank.org/v2/country/AUT/indicator/{code}
...
- **Statistik Austria.** National statistical office; preferred for table-level supplementation
  where a compatible series is transcribed. https://www.statistik.at/
...
`tools/aut` … see `tools/` builder for this country. It generates ten domain
