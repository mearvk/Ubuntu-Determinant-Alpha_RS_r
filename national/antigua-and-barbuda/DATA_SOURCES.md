# Antigua and Barbuda Data Sources and Full-Data Build
...
- **World Bank — World Development Indicators (WDI).** Macro/structural series for Antigua and Barbuda
  (`ATG`): GDP, GDP growth, agriculture value added, agricultural/arable land, employment.
  - https://data.worldbank.org · API: https://api.worldbank.org/v2/country/ATG/indicator/{code}
...
- **Statistics Division.** National statistical office; preferred for table-level supplementation
  where a compatible series is transcribed. https://statistics.gov.ag/
...
`tools/atg` … see `tools/` builder for this country. It generates ten domain
...
3. Geography must be Antigua and Barbuda.
