# Australia Data Sources and Full-Data Build
...
- **World Bank — World Development Indicators (WDI).** Macro/structural series for Australia
  (`AUS`): GDP, GDP growth, agriculture value added, agricultural/arable land, employment.
  - https://data.worldbank.org · API: https://api.worldbank.org/v2/country/AUS/indicator/{code}
...
- **ABS (Australian Bureau of Statistics).** National statistical office; preferred for table-level supplementation
  where a compatible series is transcribed. https://www.abs.gov.au/
...
`tools/aus` … see `tools/` builder for this country. It generates ten domain
