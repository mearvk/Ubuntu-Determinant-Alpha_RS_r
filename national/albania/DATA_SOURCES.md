# Albania Data Sources and Full-Data Build
...
- **World Bank — World Development Indicators (WDI).** Macro/structural series for Albania
  (`ALB`): GDP, GDP growth, agriculture value added, agricultural/arable land, employment.
  - https://data.worldbank.org · API: https://api.worldbank.org/v2/country/ALB/indicator/{code}
...
- **INSTAT (Institute of Statistics).** National statistical office; preferred for table-level supplementation
  where a compatible series is transcribed. https://www.instat.gov.al/
...
`tools/alb` … see `tools/` builder for this country. It generates ten domain
