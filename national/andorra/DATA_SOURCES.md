# Andorra Data Sources and Full-Data Build
...
- **World Bank — World Development Indicators (WDI).** Macro/structural series for Andorra
  (`AND`): GDP, GDP growth, agriculture value added, agricultural/arable land, employment.
  - https://data.worldbank.org · API: https://api.worldbank.org/v2/country/AND/indicator/{code}
...
- **Departament d'Estadistica.** National statistical office; preferred for table-level supplementation
  where a compatible series is transcribed. https://www.estadistica.ad/
...
`tools/and` … see `tools/` builder for this country. It generates ten domain
