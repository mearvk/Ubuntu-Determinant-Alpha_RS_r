...
<head>
    ...
    <title>Request — StanfordLibrary™</title>
...
<nav class="nav"><div class="nav-inner">
    ...
    <ul class="nav-links">
        ...
        <li><a href="request.jsp" class="active">Request</a></li>
        <li><a href="status.jsp">Status</a></li>
    </ul>
</div></nav>
<section class="hero"><div class="hero-inner"><span class="hero-tag">Resource Requests</span><h1>Request</h1><p>Request books, articles, digital resources, interlibrary loans, and research materials from the Stanford Library system.</p></div></section>
    ...
    <form method="POST" action="request.jsp" style="max-width:600px;">
        ...
        <div class="form-group"><label>Request Type</label>
            <select name="type">
                ...
                <option value="interlibrary">Interlibrary Loan</option>
                <option value="research">Research Material</option>
                <option value="archive">Archive / Special Collections</option>
            </select>
        </div>
        <div class="form-group"><label>Your Name</label><input type="text" name="requestor" required placeholder="Your name"/></div>
        <div class="form-group"><label>Email</label><input type="email" name="email" required placeholder="Contact email"/></div>
        <div class="form-group"><label>Notes (optional)</label><textarea name="notes" placeholder="Additional details, ISBN, DOI, urgency..."></textarea></div>
...
<section class="section"><div class="section-inner">
    ...
    <div class="table-wrap"><table><thead><tr><th>Command</th><th>Description</th></tr></thead><tbody>
        <tr><td><code>REQUEST|type|title|author|requestor|email</code></td><td>Submit resource request</td></tr>
        <tr><td><code>REQUEST_STATUS|requestId</code></td><td>Track request status</td></tr>
        <tr><td><code>SEARCH|query</code></td><td>Search catalog</td></tr>
        <tr><td><code>STATUS</code></td><td>Server status</td></tr>
    </tbody></table></div>
</div></section>

<footer class="footer"><span>StanfordLibrary™ — Request — Port 49214 — MEARVK LLC — NitroWebExpress™ 2026</span></footer>
</body></html>
