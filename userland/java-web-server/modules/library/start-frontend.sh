...
# NitroWebExpressâ„¢ â€” Stanford Library Frontend Startup
...
echo "â•‘  Stanford Library â€” Frontend Startup                                      â•‘"
...
if [ "$HTTP_CODE" = "200" ] || [ "$HTTP_CODE" = "302" ]; then
    echo "  [âœ“] Stanford Library webapp is UP â€” http://localhost:8080/$CONTEXT/"
else
