#!/bin/bash
# Stanford Library™ — Module Install Script
...
echo "═══════════════════════════════════════════════════════════════"
echo " Stanford Library™ — Module Install"
echo "═══════════════════════════════════════════════════════════════"
echo ""
...
if [ -f "$MOD_ROOT/servlets/setup-db.sh" ]; then
    bash "$MOD_ROOT/servlets/setup-db.sh" && echo "  [✓] Database nwe_library ready" || echo "  [!] Database setup had issues"
else
...
if type nwe_ensure_ufw &>/dev/null; then
    ...
    sudo ufw allow 49214/tcp >/dev/null 2>&1 && echo "  [✓] Port 49214 (backend) opened" || true
else
    ...
    if command -v ufw &>/dev/null; then
        ...
        sudo ufw allow 49214/tcp >/dev/null 2>&1
...
echo ""
echo "═══════════════════════════════════════════════════════════════"
echo " Stanford Library™ install complete."
echo " Backend port: 49214"
echo " Frontend:     http://localhost:8080/library/"
echo "═══════════════════════════════════════════════════════════════"
