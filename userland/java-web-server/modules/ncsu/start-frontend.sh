#!/bin/bash
# ═══════════════════════════════════════════════════════════════════════════════════
# NitroWebExpress™ — NC State University Frontend Startup
...
echo ""
echo "╔═══════════════════════════════════════════════════════════════════════════╗"
echo "║  NC State University — Frontend Startup                                    ║"
...
if [ "$HTTP_CODE" = "200" ] || [ "$HTTP_CODE" = "302" ]; then
    echo "  [✓] NC State University webapp is UP — http://localhost:8080/$CONTEXT/"
else
