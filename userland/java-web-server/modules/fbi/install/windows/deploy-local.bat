...
set DEPLOY_DIR=%TOMCAT_HOME%\webapps\california-fbi

echo ═══════════════════════════════════════════════════════════════
echo  Fbi — Deploy Local (Windows)
...
echo [OK] Deployed: http://localhost:8080/california-fbi/
echo ═══════════════════════════════════════════════════════════════
pause
endlocal
