...
# NitroWebExpressâ„¢ â€” California FBI Frontend Startup
...
echo "â•‘  California FBI â€” Frontend Startup                                        â•‘"
...
if [ "$HTTP_CODE" = "200" ] || [ "$HTTP_CODE" = "302" ]; then
    echo "  [âœ“] California FBI webapp is UP â€” http://localhost:8080/$CONTEXT/"
else
