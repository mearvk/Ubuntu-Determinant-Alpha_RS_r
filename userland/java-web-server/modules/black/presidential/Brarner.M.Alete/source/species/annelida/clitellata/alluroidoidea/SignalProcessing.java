package presidential.Brarner.M.Alete.source.species.annelida.clitellata.alluroidoidea;
...
/**
 * Signal Processing for Family: Alluroidoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/clitellata/alluroidoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16569; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/clitellata/alluroidoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Clitellata"); ps.setString(3, "Alluroidoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("alluroidoidea_audio", "species.annelida.clitellata.alluroidoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("alluroidoidea_data", "species.annelida.clitellata.alluroidoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("alluroidoidea_graphics", "species.annelida.clitellata.alluroidoidea.graphics.spectrum", sb.toString());
        }
    }
}