package presidential.Brarner.M.Alete.source.species.cnidaria.scyphozoa.paraphyllinidae;
...
/**
 * Signal Processing for Family: Paraphyllinidae
 * <p>Phylum: Cnidaria | Class: Scyphozoa | Order: Coronatae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/scyphozoa/paraphyllinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11245; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/scyphozoa/paraphyllinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Scyphozoa"); ps.setString(3, "Paraphyllinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("paraphyllinidae_audio", "species.cnidaria.scyphozoa.paraphyllinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("paraphyllinidae_data", "species.cnidaria.scyphozoa.paraphyllinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("paraphyllinidae_graphics", "species.cnidaria.scyphozoa.paraphyllinidae.graphics.spectrum", sb.toString());
        }
    }
}