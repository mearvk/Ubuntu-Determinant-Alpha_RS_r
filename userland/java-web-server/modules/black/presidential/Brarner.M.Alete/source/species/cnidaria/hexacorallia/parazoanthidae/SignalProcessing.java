package presidential.Brarner.M.Alete.source.species.cnidaria.hexacorallia.parazoanthidae;
...
/**
 * Signal Processing for Family: Parazoanthidae
 * <p>Phylum: Cnidaria | Class: Hexacorallia | Order: Zoantharia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/parazoanthidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11085; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/parazoanthidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Parazoanthidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("parazoanthidae_audio", "species.cnidaria.hexacorallia.parazoanthidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("parazoanthidae_data", "species.cnidaria.hexacorallia.parazoanthidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("parazoanthidae_graphics", "species.cnidaria.hexacorallia.parazoanthidae.graphics.spectrum", sb.toString());
        }
    }
}