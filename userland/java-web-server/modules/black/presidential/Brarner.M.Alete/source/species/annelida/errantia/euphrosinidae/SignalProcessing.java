package presidential.Brarner.M.Alete.source.species.annelida.errantia.euphrosinidae;
...
/**
 * Signal Processing for Family: Euphrosinidae
 * <p>Phylum: Annelida | Class: Errantia | Order: Amphinomida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/errantia/euphrosinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16649; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/errantia/euphrosinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Errantia"); ps.setString(3, "Euphrosinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("euphrosinidae_audio", "species.annelida.errantia.euphrosinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("euphrosinidae_data", "species.annelida.errantia.euphrosinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("euphrosinidae_graphics", "species.annelida.errantia.euphrosinidae.graphics.spectrum", sb.toString());
        }
    }
}