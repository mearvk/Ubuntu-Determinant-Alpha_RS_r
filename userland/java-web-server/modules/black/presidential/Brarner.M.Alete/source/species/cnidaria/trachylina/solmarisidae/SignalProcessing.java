package presidential.Brarner.M.Alete.source.species.cnidaria.trachylina.solmarisidae;
...
/**
 * Signal Processing for Family: Solmarisidae
 * <p>Phylum: Cnidaria | Class: Trachylina | Order: Narcomedusida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/trachylina/solmarisidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11231; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/trachylina/solmarisidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Trachylina"); ps.setString(3, "Solmarisidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("solmarisidae_audio", "species.cnidaria.trachylina.solmarisidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("solmarisidae_data", "species.cnidaria.trachylina.solmarisidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("solmarisidae_graphics", "species.cnidaria.trachylina.solmarisidae.graphics.spectrum", sb.toString());
        }
    }
}