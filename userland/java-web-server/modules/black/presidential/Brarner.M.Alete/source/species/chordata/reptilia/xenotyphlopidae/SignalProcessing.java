package presidential.Brarner.M.Alete.source.species.chordata.reptilia.xenotyphlopidae;
...
/**
 * Signal Processing for Family: Xenotyphlopidae
 * <p>Phylum: Chordata | Class: Reptilia | Order: Scolecophidia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/reptilia/xenotyphlopidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12639; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/reptilia/xenotyphlopidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Reptilia"); ps.setString(3, "Xenotyphlopidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("xenotyphlopidae_audio", "species.chordata.reptilia.xenotyphlopidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("xenotyphlopidae_data", "species.chordata.reptilia.xenotyphlopidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("xenotyphlopidae_graphics", "species.chordata.reptilia.xenotyphlopidae.graphics.spectrum", sb.toString());
        }
    }
}