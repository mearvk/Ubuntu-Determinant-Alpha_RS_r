package presidential.Brarner.M.Alete.source.species.mollusca.vetigastropoda.pseudococculinidae;
...
/**
 * Signal Processing for Family: Pseudococculinidae
 * <p>Phylum: Mollusca | Class: Vetigastropoda | Order: Lepetellida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/vetigastropoda/pseudococculinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17720; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/vetigastropoda/pseudococculinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Vetigastropoda"); ps.setString(3, "Pseudococculinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudococculinidae_audio", "species.mollusca.vetigastropoda.pseudococculinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudococculinidae_data", "species.mollusca.vetigastropoda.pseudococculinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudococculinidae_graphics", "species.mollusca.vetigastropoda.pseudococculinidae.graphics.spectrum", sb.toString());
        }
    }
}