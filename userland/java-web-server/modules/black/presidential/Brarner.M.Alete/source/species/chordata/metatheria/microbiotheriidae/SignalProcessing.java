package presidential.Brarner.M.Alete.source.species.chordata.metatheria.microbiotheriidae;
...
/**
 * Signal Processing for Family: Microbiotheriidae
 * <p>Phylum: Chordata | Class: Metatheria | Order: Microbiotheria</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/metatheria/microbiotheriidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12557; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/metatheria/microbiotheriidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Metatheria"); ps.setString(3, "Microbiotheriidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("microbiotheriidae_audio", "species.chordata.metatheria.microbiotheriidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("microbiotheriidae_data", "species.chordata.metatheria.microbiotheriidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("microbiotheriidae_graphics", "species.chordata.metatheria.microbiotheriidae.graphics.spectrum", sb.toString());
        }
    }
}