package presidential.Brarner.M.Alete.source.species.nematoda.chromadorea.cylindrocorporidae;
...
/**
 * Signal Processing for Family: Cylindrocorporidae
 * <p>Phylum: Nematoda | Class: Chromadorea | Order: Diplogasterida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/chromadorea/cylindrocorporidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16328; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/chromadorea/cylindrocorporidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Chromadorea"); ps.setString(3, "Cylindrocorporidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cylindrocorporidae_audio", "species.nematoda.chromadorea.cylindrocorporidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cylindrocorporidae_data", "species.nematoda.chromadorea.cylindrocorporidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cylindrocorporidae_graphics", "species.nematoda.chromadorea.cylindrocorporidae.graphics.spectrum", sb.toString());
        }
    }
}