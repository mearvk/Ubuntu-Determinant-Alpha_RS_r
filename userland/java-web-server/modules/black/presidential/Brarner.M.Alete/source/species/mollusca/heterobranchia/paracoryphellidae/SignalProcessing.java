package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.paracoryphellidae;
...
/**
 * Signal Processing for Family: Paracoryphellidae
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Aeolidiina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/paracoryphellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17457; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/paracoryphellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Paracoryphellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("paracoryphellidae_audio", "species.mollusca.heterobranchia.paracoryphellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("paracoryphellidae_data", "species.mollusca.heterobranchia.paracoryphellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("paracoryphellidae_graphics", "species.mollusca.heterobranchia.paracoryphellidae.graphics.spectrum", sb.toString());
        }
    }
}