package presidential.Brarner.M.Alete.source.species.myxozoa.microsporea;
...
/**
 * Signal Processing for Phylum: Myxozoa, Class: Microsporea
 * <p>Families: 4</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/myxozoa/microsporea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11300; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/myxozoa/microsporea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Myxozoa"); ps.setString(2, "Microsporea"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("myxozoa_microsporea_audio", "species.myxozoa.microsporea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("myxozoa_microsporea_data", "species.myxozoa.microsporea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("myxozoa_microsporea_graphics", "species.myxozoa.microsporea.graphics.spectrum", sb.toString());
        }
    }
}