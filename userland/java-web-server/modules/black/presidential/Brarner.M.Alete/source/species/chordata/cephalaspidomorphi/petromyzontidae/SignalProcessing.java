package presidential.Brarner.M.Alete.source.species.chordata.cephalaspidomorphi.petromyzontidae;
...
/**
 * Signal Processing for Family: Petromyzontidae
 * <p>Phylum: Chordata | Class: Cephalaspidomorphi | Order: Petromyzontiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/cephalaspidomorphi/petromyzontidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11505; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/cephalaspidomorphi/petromyzontidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Cephalaspidomorphi"); ps.setString(3, "Petromyzontidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("petromyzontidae_audio", "species.chordata.cephalaspidomorphi.petromyzontidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("petromyzontidae_data", "species.chordata.cephalaspidomorphi.petromyzontidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("petromyzontidae_graphics", "species.chordata.cephalaspidomorphi.petromyzontidae.graphics.spectrum", sb.toString());
        }
    }
}