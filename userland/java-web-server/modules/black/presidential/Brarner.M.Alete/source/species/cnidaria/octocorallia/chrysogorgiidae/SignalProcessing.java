package presidential.Brarner.M.Alete.source.species.cnidaria.octocorallia.chrysogorgiidae;
...
/**
 * Signal Processing for Family: Chrysogorgiidae
 * <p>Phylum: Cnidaria | Class: Octocorallia | Order: Holaxonia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/octocorallia/chrysogorgiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11102; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/octocorallia/chrysogorgiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Octocorallia"); ps.setString(3, "Chrysogorgiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chrysogorgiidae_audio", "species.cnidaria.octocorallia.chrysogorgiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chrysogorgiidae_data", "species.cnidaria.octocorallia.chrysogorgiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chrysogorgiidae_graphics", "species.cnidaria.octocorallia.chrysogorgiidae.graphics.spectrum", sb.toString());
        }
    }
}