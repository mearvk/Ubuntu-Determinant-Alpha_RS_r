package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.assimineidae;
...
/**
 * Signal Processing for Family: Assimineidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/assimineidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17209; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/assimineidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Assimineidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("assimineidae_audio", "species.mollusca.caenogastropoda.assimineidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("assimineidae_data", "species.mollusca.caenogastropoda.assimineidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("assimineidae_graphics", "species.mollusca.caenogastropoda.assimineidae.graphics.spectrum", sb.toString());
        }
    }
}