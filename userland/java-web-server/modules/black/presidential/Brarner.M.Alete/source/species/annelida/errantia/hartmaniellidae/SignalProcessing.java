package presidential.Brarner.M.Alete.source.species.annelida.errantia.hartmaniellidae;
...
/**
 * Signal Processing for Family: Hartmaniellidae
 * <p>Phylum: Annelida | Class: Errantia | Order: Eunicida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/errantia/hartmaniellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16652; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/errantia/hartmaniellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Errantia"); ps.setString(3, "Hartmaniellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hartmaniellidae_audio", "species.annelida.errantia.hartmaniellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hartmaniellidae_data", "species.annelida.errantia.hartmaniellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hartmaniellidae_graphics", "species.annelida.errantia.hartmaniellidae.graphics.spectrum", sb.toString());
        }
    }
}