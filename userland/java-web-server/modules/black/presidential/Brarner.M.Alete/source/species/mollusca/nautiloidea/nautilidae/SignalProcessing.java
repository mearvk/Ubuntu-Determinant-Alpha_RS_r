package presidential.Brarner.M.Alete.source.species.mollusca.nautiloidea.nautilidae;
...
/**
 * Signal Processing for Family: Nautilidae
 * <p>Phylum: Mollusca | Class: Nautiloidea | Order: Nautilida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/nautiloidea/nautilidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17118; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/nautiloidea/nautilidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Nautiloidea"); ps.setString(3, "Nautilidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("nautilidae_audio", "species.mollusca.nautiloidea.nautilidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("nautilidae_data", "species.mollusca.nautiloidea.nautilidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("nautilidae_graphics", "species.mollusca.nautiloidea.nautilidae.graphics.spectrum", sb.toString());
        }
    }
}