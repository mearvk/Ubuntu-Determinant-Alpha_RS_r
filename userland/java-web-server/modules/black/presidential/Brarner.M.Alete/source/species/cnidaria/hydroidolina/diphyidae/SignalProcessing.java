package presidential.Brarner.M.Alete.source.species.cnidaria.hydroidolina.diphyidae;
...
/**
 * Signal Processing for Family: Diphyidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hydroidolina/diphyidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11208; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hydroidolina/diphyidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hydroidolina"); ps.setString(3, "Diphyidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("diphyidae_audio", "species.cnidaria.hydroidolina.diphyidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("diphyidae_data", "species.cnidaria.hydroidolina.diphyidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("diphyidae_graphics", "species.cnidaria.hydroidolina.diphyidae.graphics.spectrum", sb.toString());
        }
    }
}