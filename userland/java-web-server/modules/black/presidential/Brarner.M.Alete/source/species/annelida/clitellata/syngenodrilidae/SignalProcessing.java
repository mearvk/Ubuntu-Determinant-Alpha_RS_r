package presidential.Brarner.M.Alete.source.species.annelida.clitellata.syngenodrilidae;
...
/**
 * Signal Processing for Family: Syngenodrilidae
 * <p>Phylum: Annelida | Class: Clitellata | Order: Alluroidina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/clitellata/syngenodrilidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16571; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/clitellata/syngenodrilidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Clitellata"); ps.setString(3, "Syngenodrilidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("syngenodrilidae_audio", "species.annelida.clitellata.syngenodrilidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("syngenodrilidae_data", "species.annelida.clitellata.syngenodrilidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("syngenodrilidae_graphics", "species.annelida.clitellata.syngenodrilidae.graphics.spectrum", sb.toString());
        }
    }
}