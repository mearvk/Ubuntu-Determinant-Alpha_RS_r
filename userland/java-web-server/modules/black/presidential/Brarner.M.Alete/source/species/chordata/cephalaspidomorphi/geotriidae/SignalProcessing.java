package presidential.Brarner.M.Alete.source.species.chordata.cephalaspidomorphi.geotriidae;
...
/**
 * Signal Processing for Family: Geotriidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/cephalaspidomorphi/geotriidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11503; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/cephalaspidomorphi/geotriidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Cephalaspidomorphi"); ps.setString(3, "Geotriidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("geotriidae_audio", "species.chordata.cephalaspidomorphi.geotriidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("geotriidae_data", "species.chordata.cephalaspidomorphi.geotriidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("geotriidae_graphics", "species.chordata.cephalaspidomorphi.geotriidae.graphics.spectrum", sb.toString());
        }
    }
}