...
/**
 * Signal Processing for Family: Paramurrayonidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/calcinea/paramurrayonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11335; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/calcinea/paramurrayonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Calcinea"); ps.setString(3, "Paramurrayonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("paramurrayonidae_audio", "species.porifera.calcinea.paramurrayonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("paramurrayonidae_data", "species.porifera.calcinea.paramurrayonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("paramurrayonidae_graphics", "species.porifera.calcinea.paramurrayonidae.graphics.spectrum", sb.toString());
        }
    }
}