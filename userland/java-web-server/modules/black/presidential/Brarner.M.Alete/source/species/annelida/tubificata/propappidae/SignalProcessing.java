package presidential.Brarner.M.Alete.source.species.annelida.tubificata.propappidae;
...
/**
 * Signal Processing for Family: Propappidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/tubificata/propappidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16622; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/tubificata/propappidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Tubificata"); ps.setString(3, "Propappidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("propappidae_audio", "species.annelida.tubificata.propappidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("propappidae_data", "species.annelida.tubificata.propappidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("propappidae_graphics", "species.annelida.tubificata.propappidae.graphics.spectrum", sb.toString());
        }
    }
}