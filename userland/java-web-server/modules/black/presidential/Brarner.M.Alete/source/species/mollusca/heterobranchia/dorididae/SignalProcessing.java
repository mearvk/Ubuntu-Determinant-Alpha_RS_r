package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.dorididae;
...
/**
 * Signal Processing for Family: Dorididae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/dorididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17496; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/dorididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Dorididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dorididae_audio", "species.mollusca.heterobranchia.dorididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dorididae_data", "species.mollusca.heterobranchia.dorididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dorididae_graphics", "species.mollusca.heterobranchia.dorididae.graphics.spectrum", sb.toString());
        }
    }
}