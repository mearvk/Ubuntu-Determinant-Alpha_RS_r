package presidential.Brarner.M.Alete.source.species.annelida.errantia.alciopidae;
...
/**
 * Signal Processing for Family: Alciopidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/errantia/alciopidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16658; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/errantia/alciopidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Errantia"); ps.setString(3, "Alciopidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("alciopidae_audio", "species.annelida.errantia.alciopidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("alciopidae_data", "species.annelida.errantia.alciopidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("alciopidae_graphics", "species.annelida.errantia.alciopidae.graphics.spectrum", sb.toString());
        }
    }
}