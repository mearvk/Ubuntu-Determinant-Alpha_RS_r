package presidential.Brarner.M.Alete.source.species.annelida.errantia.paralacydoniidae;
...
/**
 * Signal Processing for Family: Paralacydoniidae
 * <p>Phylum: Annelida | Class: Errantia | Order: Phyllodocida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/errantia/paralacydoniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16672; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/errantia/paralacydoniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Errantia"); ps.setString(3, "Paralacydoniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("paralacydoniidae_audio", "species.annelida.errantia.paralacydoniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("paralacydoniidae_data", "species.annelida.errantia.paralacydoniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("paralacydoniidae_graphics", "species.annelida.errantia.paralacydoniidae.graphics.spectrum", sb.toString());
        }
    }
}