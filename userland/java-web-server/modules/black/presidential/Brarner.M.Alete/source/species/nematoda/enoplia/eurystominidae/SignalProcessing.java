package presidential.Brarner.M.Alete.source.species.nematoda.enoplia.eurystominidae;
...
/**
 * Signal Processing for Family: Eurystominidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/enoplia/eurystominidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16476; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/enoplia/eurystominidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Enoplia"); ps.setString(3, "Eurystominidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("eurystominidae_audio", "species.nematoda.enoplia.eurystominidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("eurystominidae_data", "species.nematoda.enoplia.eurystominidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("eurystominidae_graphics", "species.nematoda.enoplia.eurystominidae.graphics.spectrum", sb.toString());
        }
    }
}