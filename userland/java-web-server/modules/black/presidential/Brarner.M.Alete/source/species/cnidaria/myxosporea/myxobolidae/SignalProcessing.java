...
/**
 * Signal Processing for Family: Myxobolidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/myxosporea/myxobolidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11273; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/myxosporea/myxobolidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Myxosporea"); ps.setString(3, "Myxobolidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("myxobolidae_audio", "species.cnidaria.myxosporea.myxobolidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("myxobolidae_data", "species.cnidaria.myxosporea.myxobolidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("myxobolidae_graphics", "species.cnidaria.myxosporea.myxobolidae.graphics.spectrum", sb.toString());
        }
    }
}