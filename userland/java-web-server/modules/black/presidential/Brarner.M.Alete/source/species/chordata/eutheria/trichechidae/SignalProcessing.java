package presidential.Brarner.M.Alete.source.species.chordata.eutheria.trichechidae;
...
/**
 * Signal Processing for Family: Trichechidae
 * <p>Phylum: Chordata | Class: Eutheria | Order: Sirenia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/trichechidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12537; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/trichechidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Trichechidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("trichechidae_audio", "species.chordata.eutheria.trichechidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("trichechidae_data", "species.chordata.eutheria.trichechidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("trichechidae_graphics", "species.chordata.eutheria.trichechidae.graphics.spectrum", sb.toString());
        }
    }
}