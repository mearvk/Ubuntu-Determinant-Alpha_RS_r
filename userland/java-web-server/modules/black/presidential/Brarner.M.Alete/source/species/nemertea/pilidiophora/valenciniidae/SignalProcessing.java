package presidential.Brarner.M.Alete.source.species.nemertea.pilidiophora.valenciniidae;
...
/**
 * Signal Processing for Family: Valenciniidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nemertea/pilidiophora/valenciniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17833; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nemertea/pilidiophora/valenciniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nemertea"); ps.setString(2, "Pilidiophora"); ps.setString(3, "Valenciniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("valenciniidae_audio", "species.nemertea.pilidiophora.valenciniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("valenciniidae_data", "species.nemertea.pilidiophora.valenciniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("valenciniidae_graphics", "species.nemertea.pilidiophora.valenciniidae.graphics.spectrum", sb.toString());
        }
    }
}