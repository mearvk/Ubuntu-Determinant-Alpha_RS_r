package presidential.Brarner.M.Alete.source.species.bryozoa.stenolaemata.diaperoeciidae;
...
/**
 * Signal Processing for Family: Diaperoeciidae
 * <p>Phylum: Bryozoa | Class: Stenolaemata | Order: Tubuliporina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/stenolaemata/diaperoeciidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16877; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/stenolaemata/diaperoeciidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Stenolaemata"); ps.setString(3, "Diaperoeciidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("diaperoeciidae_audio", "species.bryozoa.stenolaemata.diaperoeciidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("diaperoeciidae_data", "species.bryozoa.stenolaemata.diaperoeciidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("diaperoeciidae_graphics", "species.bryozoa.stenolaemata.diaperoeciidae.graphics.spectrum", sb.toString());
        }
    }
}