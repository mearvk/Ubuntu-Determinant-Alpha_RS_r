package presidential.Brarner.M.Alete.source.species.mollusca.monoplacophora.neopilinidae;
...
/**
 * Signal Processing for Family: Neopilinidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/monoplacophora/neopilinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17756; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/monoplacophora/neopilinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Monoplacophora"); ps.setString(3, "Neopilinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("neopilinidae_audio", "species.mollusca.monoplacophora.neopilinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("neopilinidae_data", "species.mollusca.monoplacophora.neopilinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("neopilinidae_graphics", "species.mollusca.monoplacophora.neopilinidae.graphics.spectrum", sb.toString());
        }
    }
}