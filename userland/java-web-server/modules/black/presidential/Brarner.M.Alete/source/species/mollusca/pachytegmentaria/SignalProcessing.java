package presidential.Brarner.M.Alete.source.species.mollusca.pachytegmentaria;
...
/**
 * Signal Processing for Phylum: Mollusca, Class: Pachytegmentaria
 * <p>Families: 17</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/pachytegmentaria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17798; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/pachytegmentaria";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Pachytegmentaria"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mollusca_pachytegmentaria_audio", "species.mollusca.pachytegmentaria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mollusca_pachytegmentaria_data", "species.mollusca.pachytegmentaria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mollusca_pachytegmentaria_graphics", "species.mollusca.pachytegmentaria.graphics.spectrum", sb.toString());
        }
    }
}