package presidential.Brarner.M.Alete.source.species.annelida.clitellata.megascolecidae;
...
/**
 * Signal Processing for Family: Megascolecidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/clitellata/megascolecidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16591; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/clitellata/megascolecidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Clitellata"); ps.setString(3, "Megascolecidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("megascolecidae_audio", "species.annelida.clitellata.megascolecidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("megascolecidae_data", "species.annelida.clitellata.megascolecidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("megascolecidae_graphics", "species.annelida.clitellata.megascolecidae.graphics.spectrum", sb.toString());
        }
    }
}