package presidential.Brarner.M.Alete.source.species.nemertea.hoplonemertea.paradrepanophoridae;
...
/**
 * Signal Processing for Family: Paradrepanophoridae
 * <p>Phylum: Nemertea | Class: Hoplonemertea | Order: Polystilifera</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nemertea/hoplonemertea/paradrepanophoridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17827; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nemertea/hoplonemertea/paradrepanophoridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nemertea"); ps.setString(2, "Hoplonemertea"); ps.setString(3, "Paradrepanophoridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("paradrepanophoridae_audio", "species.nemertea.hoplonemertea.paradrepanophoridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("paradrepanophoridae_data", "species.nemertea.hoplonemertea.paradrepanophoridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("paradrepanophoridae_graphics", "species.nemertea.hoplonemertea.paradrepanophoridae.graphics.spectrum", sb.toString());
        }
    }
}