package presidential.Brarner.M.Alete.source.species.nematoda.chromadoria.sphaerolaimidae;
...
/**
 * Signal Processing for Family: Sphaerolaimidae
 * <p>Phylum: Nematoda | Class: Chromadoria | Order: Monhysterida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/chromadoria/sphaerolaimidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16438; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/chromadoria/sphaerolaimidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Chromadoria"); ps.setString(3, "Sphaerolaimidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sphaerolaimidae_audio", "species.nematoda.chromadoria.sphaerolaimidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sphaerolaimidae_data", "species.nematoda.chromadoria.sphaerolaimidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sphaerolaimidae_graphics", "species.nematoda.chromadoria.sphaerolaimidae.graphics.spectrum", sb.toString());
        }
    }
}