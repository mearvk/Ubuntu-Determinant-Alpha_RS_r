package presidential.Brarner.M.Alete.source.species.nematoda.chromadoria.aponchiidae;
...
/**
 * Signal Processing for Family: Aponchiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/chromadoria/aponchiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16433; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/chromadoria/aponchiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Chromadoria"); ps.setString(3, "Aponchiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("aponchiidae_audio", "species.nematoda.chromadoria.aponchiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("aponchiidae_data", "species.nematoda.chromadoria.aponchiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("aponchiidae_graphics", "species.nematoda.chromadoria.aponchiidae.graphics.spectrum", sb.toString());
        }
    }
}