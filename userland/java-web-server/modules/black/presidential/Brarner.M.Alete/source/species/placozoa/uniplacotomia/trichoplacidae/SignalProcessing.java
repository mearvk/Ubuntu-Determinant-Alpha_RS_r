package presidential.Brarner.M.Alete.source.species.placozoa.uniplacotomia.trichoplacidae;
...
/**
 * Signal Processing for Family: Trichoplacidae
 * <p>Phylum: Placozoa | Class: Uniplacotomia | Order: Trichoplacea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/placozoa/uniplacotomia/trichoplacidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11310; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/placozoa/uniplacotomia/trichoplacidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Placozoa"); ps.setString(2, "Uniplacotomia"); ps.setString(3, "Trichoplacidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("trichoplacidae_audio", "species.placozoa.uniplacotomia.trichoplacidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("trichoplacidae_data", "species.placozoa.uniplacotomia.trichoplacidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("trichoplacidae_graphics", "species.placozoa.uniplacotomia.trichoplacidae.graphics.spectrum", sb.toString());
        }
    }
}