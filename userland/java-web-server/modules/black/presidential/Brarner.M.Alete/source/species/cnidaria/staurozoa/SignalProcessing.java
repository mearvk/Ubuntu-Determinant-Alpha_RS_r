package presidential.Brarner.M.Alete.source.species.cnidaria.staurozoa;
...
/**
 * Signal Processing for Phylum: Cnidaria, Class: Staurozoa
 * <p>Families: 6</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/staurozoa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11263; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/staurozoa";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Staurozoa"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cnidaria_staurozoa_audio", "species.cnidaria.staurozoa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cnidaria_staurozoa_data", "species.cnidaria.staurozoa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cnidaria_staurozoa_graphics", "species.cnidaria.staurozoa.graphics.spectrum", sb.toString());
        }
    }
}