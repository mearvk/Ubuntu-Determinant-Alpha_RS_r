package presidential.Brarner.M.Alete.source.species.mollusca.heteroconchia.xylophagaidae;
...
/**
 * Signal Processing for Family: Xylophagaidae
 * <p>Phylum: Mollusca | Class: Heteroconchia | Order: Myida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heteroconchia/xylophagaidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16925; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heteroconchia/xylophagaidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heteroconchia"); ps.setString(3, "Xylophagaidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("xylophagaidae_audio", "species.mollusca.heteroconchia.xylophagaidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("xylophagaidae_data", "species.mollusca.heteroconchia.xylophagaidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("xylophagaidae_graphics", "species.mollusca.heteroconchia.xylophagaidae.graphics.spectrum", sb.toString());
        }
    }
}