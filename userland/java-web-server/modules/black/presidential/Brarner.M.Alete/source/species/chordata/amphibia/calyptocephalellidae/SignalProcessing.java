package presidential.Brarner.M.Alete.source.species.chordata.amphibia.calyptocephalellidae;
...
/**
 * Signal Processing for Family: Calyptocephalellidae
 * <p>Phylum: Chordata | Class: Amphibia | Order: Anura</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/amphibia/calyptocephalellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12057; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/amphibia/calyptocephalellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Amphibia"); ps.setString(3, "Calyptocephalellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("calyptocephalellidae_audio", "species.chordata.amphibia.calyptocephalellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("calyptocephalellidae_data", "species.chordata.amphibia.calyptocephalellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("calyptocephalellidae_graphics", "species.chordata.amphibia.calyptocephalellidae.graphics.spectrum", sb.toString());
        }
    }
}