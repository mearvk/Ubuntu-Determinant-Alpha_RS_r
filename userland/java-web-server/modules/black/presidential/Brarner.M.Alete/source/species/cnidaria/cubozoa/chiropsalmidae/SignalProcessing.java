package presidential.Brarner.M.Alete.source.species.cnidaria.cubozoa.chiropsalmidae;
...
/**
 * Signal Processing for Family: Chiropsalmidae
 * <p>Phylum: Cnidaria | Class: Cubozoa | Order: Chirodropida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/cubozoa/chiropsalmidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11136; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/cubozoa/chiropsalmidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Cubozoa"); ps.setString(3, "Chiropsalmidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chiropsalmidae_audio", "species.cnidaria.cubozoa.chiropsalmidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chiropsalmidae_data", "species.cnidaria.cubozoa.chiropsalmidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chiropsalmidae_graphics", "species.cnidaria.cubozoa.chiropsalmidae.graphics.spectrum", sb.toString());
        }
    }
}