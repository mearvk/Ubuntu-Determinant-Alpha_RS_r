package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.orbitestelloidea;
...
/**
 * Signal Processing for Family: Orbitestelloidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Orbitestellida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/orbitestelloidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17379; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/orbitestelloidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Orbitestelloidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("orbitestelloidea_audio", "species.mollusca.heterobranchia.orbitestelloidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("orbitestelloidea_data", "species.mollusca.heterobranchia.orbitestelloidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("orbitestelloidea_graphics", "species.mollusca.heterobranchia.orbitestelloidea.graphics.spectrum", sb.toString());
        }
    }
}