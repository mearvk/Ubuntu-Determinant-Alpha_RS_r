package presidential.Brarner.M.Alete.source.species.chordata.eutheria.rhinonycteridae;
...
/**
 * Signal Processing for Family: Rhinonycteridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/rhinonycteridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12455; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/rhinonycteridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Rhinonycteridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rhinonycteridae_audio", "species.chordata.eutheria.rhinonycteridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rhinonycteridae_data", "species.chordata.eutheria.rhinonycteridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rhinonycteridae_graphics", "species.chordata.eutheria.rhinonycteridae.graphics.spectrum", sb.toString());
        }
    }
}