package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.helicoidearafinesque;
...
/**
 * Signal Processing for Family: Helicoidea Rafinesque, 1815
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Helicoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/helicoidearafinesque/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17579; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/helicoidearafinesque";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Helicoidea Rafinesque, 1815"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("helicoidearafinesque_audio", "species.mollusca.heterobranchia.helicoidearafinesque.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("helicoidearafinesque_data", "species.mollusca.heterobranchia.helicoidearafinesque.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("helicoidearafinesque_graphics", "species.mollusca.heterobranchia.helicoidearafinesque.graphics.spectrum", sb.toString());
        }
    }
}