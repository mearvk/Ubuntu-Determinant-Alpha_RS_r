package presidential.Brarner.M.Alete.source.species.chordata.teleostei.grammicolepididae;
...
/**
 * Signal Processing for Family: Grammicolepididae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Zeioidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/grammicolepididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11781; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/grammicolepididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Grammicolepididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("grammicolepididae_audio", "species.chordata.teleostei.grammicolepididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("grammicolepididae_data", "species.chordata.teleostei.grammicolepididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("grammicolepididae_graphics", "species.chordata.teleostei.grammicolepididae.graphics.spectrum", sb.toString());
        }
    }
}