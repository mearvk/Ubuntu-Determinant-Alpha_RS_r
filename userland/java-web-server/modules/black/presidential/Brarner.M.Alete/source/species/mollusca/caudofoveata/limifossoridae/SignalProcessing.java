package presidential.Brarner.M.Alete.source.species.mollusca.caudofoveata.limifossoridae;
...
/**
 * Signal Processing for Family: Limifossoridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caudofoveata/limifossoridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17070; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caudofoveata/limifossoridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caudofoveata"); ps.setString(3, "Limifossoridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("limifossoridae_audio", "species.mollusca.caudofoveata.limifossoridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("limifossoridae_data", "species.mollusca.caudofoveata.limifossoridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("limifossoridae_graphics", "species.mollusca.caudofoveata.limifossoridae.graphics.spectrum", sb.toString());
        }
    }
}