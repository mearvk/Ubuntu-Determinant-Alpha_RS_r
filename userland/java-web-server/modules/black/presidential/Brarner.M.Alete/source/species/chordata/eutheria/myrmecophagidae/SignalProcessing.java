package presidential.Brarner.M.Alete.source.species.chordata.eutheria.myrmecophagidae;
...
/**
 * Signal Processing for Family: Myrmecophagidae
 * <p>Phylum: Chordata | Class: Eutheria | Order: Vermilingua</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/myrmecophagidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12477; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/myrmecophagidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Myrmecophagidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("myrmecophagidae_audio", "species.chordata.eutheria.myrmecophagidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("myrmecophagidae_data", "species.chordata.eutheria.myrmecophagidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("myrmecophagidae_graphics", "species.chordata.eutheria.myrmecophagidae.graphics.spectrum", sb.toString());
        }
    }
}