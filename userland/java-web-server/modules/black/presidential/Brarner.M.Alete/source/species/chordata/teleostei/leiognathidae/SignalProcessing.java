package presidential.Brarner.M.Alete.source.species.chordata.teleostei.leiognathidae;
...
/**
 * Signal Processing for Family: Leiognathidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/leiognathidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11639; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/leiognathidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Leiognathidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("leiognathidae_audio", "species.chordata.teleostei.leiognathidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("leiognathidae_data", "species.chordata.teleostei.leiognathidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("leiognathidae_graphics", "species.chordata.teleostei.leiognathidae.graphics.spectrum", sb.toString());
        }
    }
}