package presidential.Brarner.M.Alete.source.species.chordata.aves.chloropseidae;
...
/**
 * Signal Processing for Family: Chloropseidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/chloropseidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12224; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/chloropseidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Chloropseidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chloropseidae_audio", "species.chordata.aves.chloropseidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chloropseidae_data", "species.chordata.aves.chloropseidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chloropseidae_graphics", "species.chordata.aves.chloropseidae.graphics.spectrum", sb.toString());
        }
    }
}