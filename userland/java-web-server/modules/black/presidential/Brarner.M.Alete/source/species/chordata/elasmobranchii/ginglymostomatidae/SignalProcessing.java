package presidential.Brarner.M.Alete.source.species.chordata.elasmobranchii.ginglymostomatidae;
...
/**
 * Signal Processing for Family: Ginglymostomatidae
 * <p>Phylum: Chordata | Class: Elasmobranchii | Order: Orectolobiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/elasmobranchii/ginglymostomatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12008; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/elasmobranchii/ginglymostomatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Elasmobranchii"); ps.setString(3, "Ginglymostomatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ginglymostomatidae_audio", "species.chordata.elasmobranchii.ginglymostomatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ginglymostomatidae_data", "species.chordata.elasmobranchii.ginglymostomatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ginglymostomatidae_graphics", "species.chordata.elasmobranchii.ginglymostomatidae.graphics.spectrum", sb.toString());
        }
    }
}