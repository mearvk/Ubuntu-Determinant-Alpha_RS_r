package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.struthiolariidae;
...
/**
 * Signal Processing for Family: Struthiolariidae
 * <p>Phylum: Mollusca | Class: Caenogastropoda | Order: Strombida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/struthiolariidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17258; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/struthiolariidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Struthiolariidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("struthiolariidae_audio", "species.mollusca.caenogastropoda.struthiolariidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("struthiolariidae_data", "species.mollusca.caenogastropoda.struthiolariidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("struthiolariidae_graphics", "species.mollusca.caenogastropoda.struthiolariidae.graphics.spectrum", sb.toString());
        }
    }
}