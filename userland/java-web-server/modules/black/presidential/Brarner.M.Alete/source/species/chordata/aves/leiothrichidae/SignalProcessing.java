package presidential.Brarner.M.Alete.source.species.chordata.aves.leiothrichidae;
...
/**
 * Signal Processing for Family: Leiothrichidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/leiothrichidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12259; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/leiothrichidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Leiothrichidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("leiothrichidae_audio", "species.chordata.aves.leiothrichidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("leiothrichidae_data", "species.chordata.aves.leiothrichidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("leiothrichidae_graphics", "species.chordata.aves.leiothrichidae.graphics.spectrum", sb.toString());
        }
    }
}