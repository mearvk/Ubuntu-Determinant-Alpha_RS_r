package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.truncatellinidae;
...
/**
 * Signal Processing for Family: Truncatellinidae
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Pupilloidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/truncatellinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17663; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/truncatellinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Truncatellinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("truncatellinidae_audio", "species.mollusca.heterobranchia.truncatellinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("truncatellinidae_data", "species.mollusca.heterobranchia.truncatellinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("truncatellinidae_graphics", "species.mollusca.heterobranchia.truncatellinidae.graphics.spectrum", sb.toString());
        }
    }
}