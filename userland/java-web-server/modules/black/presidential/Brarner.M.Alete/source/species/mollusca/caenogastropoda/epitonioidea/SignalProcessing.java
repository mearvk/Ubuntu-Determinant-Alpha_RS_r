package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.epitonioidea;
...
/**
 * Signal Processing for Family: Epitonioidea
 * <p>Phylum: Mollusca | Class: Caenogastropoda | Order: Epitoniina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/epitonioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17182; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/epitonioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Epitonioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("epitonioidea_audio", "species.mollusca.caenogastropoda.epitonioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("epitonioidea_data", "species.mollusca.caenogastropoda.epitonioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("epitonioidea_graphics", "species.mollusca.caenogastropoda.epitonioidea.graphics.spectrum", sb.toString());
        }
    }
}