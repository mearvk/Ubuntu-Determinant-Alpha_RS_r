package presidential.Brarner.M.Alete.source.species.placozoa.uniplacotomia;
...
/**
 * Signal Processing for Phylum: Placozoa, Class: Uniplacotomia
 * <p>Families: 3</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/placozoa/uniplacotomia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11307; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/placozoa/uniplacotomia";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Placozoa"); ps.setString(2, "Uniplacotomia"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("placozoa_uniplacotomia_audio", "species.placozoa.uniplacotomia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("placozoa_uniplacotomia_data", "species.placozoa.uniplacotomia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("placozoa_uniplacotomia_graphics", "species.placozoa.uniplacotomia.graphics.spectrum", sb.toString());
        }
    }
}