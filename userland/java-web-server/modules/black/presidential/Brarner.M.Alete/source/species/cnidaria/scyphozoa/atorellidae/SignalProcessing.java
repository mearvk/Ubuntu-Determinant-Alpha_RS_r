package presidential.Brarner.M.Alete.source.species.cnidaria.scyphozoa.atorellidae;
...
/**
 * Signal Processing for Family: Atorellidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/scyphozoa/atorellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11241; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/scyphozoa/atorellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Scyphozoa"); ps.setString(3, "Atorellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("atorellidae_audio", "species.cnidaria.scyphozoa.atorellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("atorellidae_data", "species.cnidaria.scyphozoa.atorellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("atorellidae_graphics", "species.cnidaria.scyphozoa.atorellidae.graphics.spectrum", sb.toString());
        }
    }
}