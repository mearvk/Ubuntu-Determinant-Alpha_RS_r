package presidential.Brarner.M.Alete.source.species.chordata.aves.rhodinocichlidae;
...
/**
 * Signal Processing for Family: Rhodinocichlidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/rhodinocichlidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12323; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/rhodinocichlidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Rhodinocichlidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rhodinocichlidae_audio", "species.chordata.aves.rhodinocichlidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rhodinocichlidae_data", "species.chordata.aves.rhodinocichlidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rhodinocichlidae_graphics", "species.chordata.aves.rhodinocichlidae.graphics.spectrum", sb.toString());
        }
    }
}