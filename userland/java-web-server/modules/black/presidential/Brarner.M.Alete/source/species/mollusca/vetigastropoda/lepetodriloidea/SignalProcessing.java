package presidential.Brarner.M.Alete.source.species.mollusca.vetigastropoda.lepetodriloidea;
...
/**
 * Signal Processing for Family: Lepetodriloidea
 * <p>Phylum: Mollusca | Class: Vetigastropoda | Order: Scissurellina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/vetigastropoda/lepetodriloidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17704; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/vetigastropoda/lepetodriloidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Vetigastropoda"); ps.setString(3, "Lepetodriloidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lepetodriloidea_audio", "species.mollusca.vetigastropoda.lepetodriloidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lepetodriloidea_data", "species.mollusca.vetigastropoda.lepetodriloidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lepetodriloidea_graphics", "species.mollusca.vetigastropoda.lepetodriloidea.graphics.spectrum", sb.toString());
        }
    }
}