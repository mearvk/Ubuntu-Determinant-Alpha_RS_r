package presidential.Brarner.M.Alete.source.species.mollusca.monoplacophora.tryblidiidae;
...
/**
 * Signal Processing for Family: Tryblidiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/monoplacophora/tryblidiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17758; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/monoplacophora/tryblidiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Monoplacophora"); ps.setString(3, "Tryblidiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tryblidiidae_audio", "species.mollusca.monoplacophora.tryblidiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tryblidiidae_data", "species.mollusca.monoplacophora.tryblidiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tryblidiidae_graphics", "species.mollusca.monoplacophora.tryblidiidae.graphics.spectrum", sb.toString());
        }
    }
}