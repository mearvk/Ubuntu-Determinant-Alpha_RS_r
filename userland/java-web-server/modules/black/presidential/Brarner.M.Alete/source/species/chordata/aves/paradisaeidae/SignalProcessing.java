package presidential.Brarner.M.Alete.source.species.chordata.aves.paradisaeidae;
...
/**
 * Signal Processing for Family: Paradisaeidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/paradisaeidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12289; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/paradisaeidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Paradisaeidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("paradisaeidae_audio", "species.chordata.aves.paradisaeidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("paradisaeidae_data", "species.chordata.aves.paradisaeidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("paradisaeidae_graphics", "species.chordata.aves.paradisaeidae.graphics.spectrum", sb.toString());
        }
    }
}