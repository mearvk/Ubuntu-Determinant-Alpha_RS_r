package presidential.Brarner.M.Alete.source.species.mollusca.heteroconchia.glauconomidae;
...
/**
 * Signal Processing for Family: Glauconomidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heteroconchia/glauconomidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16989; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heteroconchia/glauconomidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heteroconchia"); ps.setString(3, "Glauconomidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("glauconomidae_audio", "species.mollusca.heteroconchia.glauconomidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("glauconomidae_data", "species.mollusca.heteroconchia.glauconomidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("glauconomidae_graphics", "species.mollusca.heteroconchia.glauconomidae.graphics.spectrum", sb.toString());
        }
    }
}