package presidential.Brarner.M.Alete.source.species.cnidaria.hexacorallia.gonactiniidae;
...
/**
 * Signal Processing for Family: Gonactiniidae
 * <p>Phylum: Cnidaria | Class: Hexacorallia | Order: Protantheae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/gonactiniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11045; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/gonactiniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Gonactiniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gonactiniidae_audio", "species.cnidaria.hexacorallia.gonactiniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gonactiniidae_data", "species.cnidaria.hexacorallia.gonactiniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gonactiniidae_graphics", "species.cnidaria.hexacorallia.gonactiniidae.graphics.spectrum", sb.toString());
        }
    }
}