package presidential.Brarner.M.Alete.source.species.cnidaria.staurozoa.depastridae;
...
/**
 * Signal Processing for Family: Depastridae
 * <p>Phylum: Cnidaria | Class: Staurozoa | Order: Cleistocarpida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/staurozoa/depastridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11265; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/staurozoa/depastridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Staurozoa"); ps.setString(3, "Depastridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("depastridae_audio", "species.cnidaria.staurozoa.depastridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("depastridae_data", "species.cnidaria.staurozoa.depastridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("depastridae_graphics", "species.cnidaria.staurozoa.depastridae.graphics.spectrum", sb.toString());
        }
    }
}