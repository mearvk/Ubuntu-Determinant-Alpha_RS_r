package presidential.Brarner.M.Alete.source.species.bryozoa.eurystomata.epistomiidae;
...
/**
 * Signal Processing for Family: Epistomiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/eurystomata/epistomiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16772; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/eurystomata/epistomiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Eurystomata"); ps.setString(3, "Epistomiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("epistomiidae_audio", "species.bryozoa.eurystomata.epistomiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("epistomiidae_data", "species.bryozoa.eurystomata.epistomiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("epistomiidae_graphics", "species.bryozoa.eurystomata.epistomiidae.graphics.spectrum", sb.toString());
        }
    }
}