package presidential.Brarner.M.Alete.source.species.chordata.reptilia.phrynosomatidae;
...
/**
 * Signal Processing for Family: Phrynosomatidae
 * <p>Phylum: Chordata | Class: Reptilia | Order: Iguania</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/reptilia/phrynosomatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12608; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/reptilia/phrynosomatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Reptilia"); ps.setString(3, "Phrynosomatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("phrynosomatidae_audio", "species.chordata.reptilia.phrynosomatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("phrynosomatidae_data", "species.chordata.reptilia.phrynosomatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("phrynosomatidae_graphics", "species.chordata.reptilia.phrynosomatidae.graphics.spectrum", sb.toString());
        }
    }
}