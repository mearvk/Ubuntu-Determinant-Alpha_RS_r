package presidential.Brarner.M.Alete.source.species.cnidaria.hexacorallia.dendrophylliidae;
...
/**
 * Signal Processing for Family: Dendrophylliidae
 * <p>Phylum: Cnidaria | Class: Hexacorallia | Order: Dendrophylliina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/dendrophylliidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11066; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/dendrophylliidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Dendrophylliidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dendrophylliidae_audio", "species.cnidaria.hexacorallia.dendrophylliidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dendrophylliidae_data", "species.cnidaria.hexacorallia.dendrophylliidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dendrophylliidae_graphics", "species.cnidaria.hexacorallia.dendrophylliidae.graphics.spectrum", sb.toString());
        }
    }
}