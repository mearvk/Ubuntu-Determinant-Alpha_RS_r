package presidential.Brarner.M.Alete.source.species.cnidaria.myxosporea.chloromyxidae;
...
/**
 * Signal Processing for Family: Chloromyxidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/myxosporea/chloromyxidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11271; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/myxosporea/chloromyxidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Myxosporea"); ps.setString(3, "Chloromyxidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chloromyxidae_audio", "species.cnidaria.myxosporea.chloromyxidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chloromyxidae_data", "species.cnidaria.myxosporea.chloromyxidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chloromyxidae_graphics", "species.cnidaria.myxosporea.chloromyxidae.graphics.spectrum", sb.toString());
        }
    }
}