package presidential.Brarner.M.Alete.source.species.nemertea.hoplonemertea.emplectonematidae;
...
/**
 * Signal Processing for Family: Emplectonematidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nemertea/hoplonemertea/emplectonematidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17820; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nemertea/hoplonemertea/emplectonematidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nemertea"); ps.setString(2, "Hoplonemertea"); ps.setString(3, "Emplectonematidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("emplectonematidae_audio", "species.nemertea.hoplonemertea.emplectonematidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("emplectonematidae_data", "species.nemertea.hoplonemertea.emplectonematidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("emplectonematidae_graphics", "species.nemertea.hoplonemertea.emplectonematidae.graphics.spectrum", sb.toString());
        }
    }
}