package presidential.Brarner.M.Alete.source.species.chordata.amphibia.proteidae;
...
/**
 * Signal Processing for Family: Proteidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/amphibia/proteidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12117; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/amphibia/proteidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Amphibia"); ps.setString(3, "Proteidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("proteidae_audio", "species.chordata.amphibia.proteidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("proteidae_data", "species.chordata.amphibia.proteidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("proteidae_graphics", "species.chordata.amphibia.proteidae.graphics.spectrum", sb.toString());
        }
    }
}