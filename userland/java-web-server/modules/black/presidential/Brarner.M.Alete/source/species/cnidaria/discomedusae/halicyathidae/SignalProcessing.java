package presidential.Brarner.M.Alete.source.species.cnidaria.discomedusae.halicyathidae;
...
/**
 * Signal Processing for Family: Halicyathidae
 * <p>Phylum: Cnidaria | Class: Discomedusae | Order: Semaeostomeae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/discomedusae/halicyathidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11260; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/discomedusae/halicyathidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Discomedusae"); ps.setString(3, "Halicyathidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("halicyathidae_audio", "species.cnidaria.discomedusae.halicyathidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("halicyathidae_data", "species.cnidaria.discomedusae.halicyathidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("halicyathidae_graphics", "species.cnidaria.discomedusae.halicyathidae.graphics.spectrum", sb.toString());
        }
    }
}