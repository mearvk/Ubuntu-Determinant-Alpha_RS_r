package presidential.Brarner.M.Alete.source.species.chordata.aves.sapayoidae;
...
/**
 * Signal Processing for Family: Sapayoidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/sapayoidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12325; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/sapayoidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Sapayoidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sapayoidae_audio", "species.chordata.aves.sapayoidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sapayoidae_data", "species.chordata.aves.sapayoidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sapayoidae_graphics", "species.chordata.aves.sapayoidae.graphics.spectrum", sb.toString());
        }
    }
}