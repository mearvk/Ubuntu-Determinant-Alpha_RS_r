package presidential.Brarner.M.Alete.source.species.chordata.elasmobranchii.heterodontidae;
...
/**
 * Signal Processing for Family: Heterodontidae
 * <p>Phylum: Chordata | Class: Elasmobranchii | Order: Heterodontiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/elasmobranchii/heterodontidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11987; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/elasmobranchii/heterodontidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Elasmobranchii"); ps.setString(3, "Heterodontidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("heterodontidae_audio", "species.chordata.elasmobranchii.heterodontidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("heterodontidae_data", "species.chordata.elasmobranchii.heterodontidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("heterodontidae_graphics", "species.chordata.elasmobranchii.heterodontidae.graphics.spectrum", sb.toString());
        }
    }
}