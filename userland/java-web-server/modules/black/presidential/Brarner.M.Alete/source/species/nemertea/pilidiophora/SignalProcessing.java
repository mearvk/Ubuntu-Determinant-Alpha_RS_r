package presidential.Brarner.M.Alete.source.species.nemertea.pilidiophora;
...
/**
 * Signal Processing for Phylum: Nemertea, Class: Pilidiophora
 * <p>Families: 5</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nemertea/pilidiophora/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17829; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nemertea/pilidiophora";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nemertea"); ps.setString(2, "Pilidiophora"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("nemertea_pilidiophora_audio", "species.nemertea.pilidiophora.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("nemertea_pilidiophora_data", "species.nemertea.pilidiophora.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("nemertea_pilidiophora_graphics", "species.nemertea.pilidiophora.graphics.spectrum", sb.toString());
        }
    }
}