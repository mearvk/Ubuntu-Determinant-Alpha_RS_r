package presidential.Brarner.M.Alete.source.species.chordata.elasmobranchii.platyrhinidae;
...
/**
 * Signal Processing for Family: Platyrhinidae
 * <p>Phylum: Chordata | Class: Elasmobranchii | Order: Rhinobatiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/elasmobranchii/platyrhinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12020; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/elasmobranchii/platyrhinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Elasmobranchii"); ps.setString(3, "Platyrhinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("platyrhinidae_audio", "species.chordata.elasmobranchii.platyrhinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("platyrhinidae_data", "species.chordata.elasmobranchii.platyrhinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("platyrhinidae_graphics", "species.chordata.elasmobranchii.platyrhinidae.graphics.spectrum", sb.toString());
        }
    }
}