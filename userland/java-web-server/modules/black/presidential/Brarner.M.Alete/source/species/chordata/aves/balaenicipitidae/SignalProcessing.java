package presidential.Brarner.M.Alete.source.species.chordata.aves.balaenicipitidae;
...
/**
 * Signal Processing for Family: Balaenicipitidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/balaenicipitidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12348; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/balaenicipitidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Balaenicipitidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("balaenicipitidae_audio", "species.chordata.aves.balaenicipitidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("balaenicipitidae_data", "species.chordata.aves.balaenicipitidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("balaenicipitidae_graphics", "species.chordata.aves.balaenicipitidae.graphics.spectrum", sb.toString());
        }
    }
}