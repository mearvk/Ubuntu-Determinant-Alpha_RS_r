package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.murchisonellidae;
...
/**
 * Signal Processing for Family: Murchisonellidae
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Allomorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/murchisonellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17332; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/murchisonellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Murchisonellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("murchisonellidae_audio", "species.mollusca.heterobranchia.murchisonellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("murchisonellidae_data", "species.mollusca.heterobranchia.murchisonellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("murchisonellidae_graphics", "species.mollusca.heterobranchia.murchisonellidae.graphics.spectrum", sb.toString());
        }
    }
}