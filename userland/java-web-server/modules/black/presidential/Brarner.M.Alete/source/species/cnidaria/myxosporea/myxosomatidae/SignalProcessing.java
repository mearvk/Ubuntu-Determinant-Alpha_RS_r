package presidential.Brarner.M.Alete.source.species.cnidaria.myxosporea.myxosomatidae;
...
/**
 * Signal Processing for Family: Myxosomatidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/myxosporea/myxosomatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11274; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/myxosporea/myxosomatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Myxosporea"); ps.setString(3, "Myxosomatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("myxosomatidae_audio", "species.cnidaria.myxosporea.myxosomatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("myxosomatidae_data", "species.cnidaria.myxosporea.myxosomatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("myxosomatidae_graphics", "species.cnidaria.myxosporea.myxosomatidae.graphics.spectrum", sb.toString());
        }
    }
}