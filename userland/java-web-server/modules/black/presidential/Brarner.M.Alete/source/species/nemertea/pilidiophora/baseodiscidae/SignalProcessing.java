package presidential.Brarner.M.Alete.source.species.nemertea.pilidiophora.baseodiscidae;
...
/**
 * Signal Processing for Family: Baseodiscidae
 * <p>Phylum: Nemertea | Class: Pilidiophora | Order: Heteronemertea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nemertea/pilidiophora/baseodiscidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17830; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nemertea/pilidiophora/baseodiscidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nemertea"); ps.setString(2, "Pilidiophora"); ps.setString(3, "Baseodiscidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("baseodiscidae_audio", "species.nemertea.pilidiophora.baseodiscidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("baseodiscidae_data", "species.nemertea.pilidiophora.baseodiscidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("baseodiscidae_graphics", "species.nemertea.pilidiophora.baseodiscidae.graphics.spectrum", sb.toString());
        }
    }
}