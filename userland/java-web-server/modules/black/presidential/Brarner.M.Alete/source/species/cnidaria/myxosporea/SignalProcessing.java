package presidential.Brarner.M.Alete.source.species.cnidaria.myxosporea;
...
/**
 * Signal Processing for Phylum: Cnidaria, Class: Myxosporea
 * <p>Families: 5</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/myxosporea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11270; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/myxosporea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Myxosporea"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cnidaria_myxosporea_audio", "species.cnidaria.myxosporea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cnidaria_myxosporea_data", "species.cnidaria.myxosporea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cnidaria_myxosporea_graphics", "species.cnidaria.myxosporea.graphics.spectrum", sb.toString());
        }
    }
}