package presidential.Brarner.M.Alete.source.species.chordata.eutheria.chlamyphoridae;
...
/**
 * Signal Processing for Family: Chlamyphoridae
 * <p>Phylum: Chordata | Class: Eutheria | Order: Cingulata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/chlamyphoridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12457; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/chlamyphoridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Chlamyphoridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chlamyphoridae_audio", "species.chordata.eutheria.chlamyphoridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chlamyphoridae_data", "species.chordata.eutheria.chlamyphoridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chlamyphoridae_graphics", "species.chordata.eutheria.chlamyphoridae.graphics.spectrum", sb.toString());
        }
    }
}