package presidential.Brarner.M.Alete.source.species.mollusca.monoplacophora.neopilinoidea;
...
/**
 * Signal Processing for Family: Neopilinoidea
 * <p>Phylum: Mollusca | Class: Monoplacophora | Order: Neopilinida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/monoplacophora/neopilinoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17755; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/monoplacophora/neopilinoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Monoplacophora"); ps.setString(3, "Neopilinoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("neopilinoidea_audio", "species.mollusca.monoplacophora.neopilinoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("neopilinoidea_data", "species.mollusca.monoplacophora.neopilinoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("neopilinoidea_graphics", "species.mollusca.monoplacophora.neopilinoidea.graphics.spectrum", sb.toString());
        }
    }
}