package presidential.Brarner.M.Alete.source.species.mollusca.patellogastropoda.lepetoidea;
...
/**
 * Signal Processing for Family: Lepetoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/patellogastropoda/lepetoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17125; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/patellogastropoda/lepetoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Patellogastropoda"); ps.setString(3, "Lepetoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lepetoidea_audio", "species.mollusca.patellogastropoda.lepetoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lepetoidea_data", "species.mollusca.patellogastropoda.lepetoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lepetoidea_graphics", "species.mollusca.patellogastropoda.lepetoidea.graphics.spectrum", sb.toString());
        }
    }
}