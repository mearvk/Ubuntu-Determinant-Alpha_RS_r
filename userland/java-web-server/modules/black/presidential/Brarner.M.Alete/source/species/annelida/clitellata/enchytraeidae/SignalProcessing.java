package presidential.Brarner.M.Alete.source.species.annelida.clitellata.enchytraeidae;
...
/**
 * Signal Processing for Family: Enchytraeidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/clitellata/enchytraeidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16565; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/clitellata/enchytraeidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Clitellata"); ps.setString(3, "Enchytraeidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("enchytraeidae_audio", "species.annelida.clitellata.enchytraeidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("enchytraeidae_data", "species.annelida.clitellata.enchytraeidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("enchytraeidae_graphics", "species.annelida.clitellata.enchytraeidae.graphics.spectrum", sb.toString());
        }
    }
}