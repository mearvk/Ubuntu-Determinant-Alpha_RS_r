package presidential.Brarner.M.Alete.source.species.chordata.teleostei.aenigmachannidae;
...
/**
 * Signal Processing for Family: Aenigmachannidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Channoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/aenigmachannidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11573; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/aenigmachannidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Aenigmachannidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("aenigmachannidae_audio", "species.chordata.teleostei.aenigmachannidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("aenigmachannidae_data", "species.chordata.teleostei.aenigmachannidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("aenigmachannidae_graphics", "species.chordata.teleostei.aenigmachannidae.graphics.spectrum", sb.toString());
        }
    }
}