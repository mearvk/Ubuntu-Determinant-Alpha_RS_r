package presidential.Brarner.M.Alete.source.species.chordata.amphibia.salamandridae;
...
/**
 * Signal Processing for Family: Salamandridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/amphibia/salamandridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12119; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/amphibia/salamandridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Amphibia"); ps.setString(3, "Salamandridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("salamandridae_audio", "species.chordata.amphibia.salamandridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("salamandridae_data", "species.chordata.amphibia.salamandridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("salamandridae_graphics", "species.chordata.amphibia.salamandridae.graphics.spectrum", sb.toString());
        }
    }
}