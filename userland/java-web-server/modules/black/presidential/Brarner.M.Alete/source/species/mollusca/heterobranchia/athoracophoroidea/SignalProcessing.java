package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.athoracophoroidea;
...
/**
 * Signal Processing for Family: Athoracophoroidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Succineoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/athoracophoroidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17675; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/athoracophoroidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Athoracophoroidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("athoracophoroidea_audio", "species.mollusca.heterobranchia.athoracophoroidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("athoracophoroidea_data", "species.mollusca.heterobranchia.athoracophoroidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("athoracophoroidea_graphics", "species.mollusca.heterobranchia.athoracophoroidea.graphics.spectrum", sb.toString());
        }
    }
}