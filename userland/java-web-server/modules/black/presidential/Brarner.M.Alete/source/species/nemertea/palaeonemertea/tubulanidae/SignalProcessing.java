package presidential.Brarner.M.Alete.source.species.nemertea.palaeonemertea.tubulanidae;
...
/**
 * Signal Processing for Family: Tubulanidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nemertea/palaeonemertea/tubulanidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17838; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nemertea/palaeonemertea/tubulanidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nemertea"); ps.setString(2, "Palaeonemertea"); ps.setString(3, "Tubulanidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tubulanidae_audio", "species.nemertea.palaeonemertea.tubulanidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tubulanidae_data", "species.nemertea.palaeonemertea.tubulanidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tubulanidae_graphics", "species.nemertea.palaeonemertea.tubulanidae.graphics.spectrum", sb.toString());
        }
    }
}