package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.papillodermatoidea;
...
/**
 * Signal Processing for Family: Papillodermatoidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Helicina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/papillodermatoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17548; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/papillodermatoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Papillodermatoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("papillodermatoidea_audio", "species.mollusca.heterobranchia.papillodermatoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("papillodermatoidea_data", "species.mollusca.heterobranchia.papillodermatoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("papillodermatoidea_graphics", "species.mollusca.heterobranchia.papillodermatoidea.graphics.spectrum", sb.toString());
        }
    }
}