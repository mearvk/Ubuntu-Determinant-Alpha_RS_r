package presidential.Brarner.M.Alete.source.species.nematoda.chromadorea.tylenchorhynchidae;
...
/**
 * Signal Processing for Family: Tylenchorhynchidae
 * <p>Phylum: Nematoda | Class: Chromadorea | Order: Tylenchida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/chromadorea/tylenchorhynchidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16400; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/chromadorea/tylenchorhynchidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Chromadorea"); ps.setString(3, "Tylenchorhynchidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tylenchorhynchidae_audio", "species.nematoda.chromadorea.tylenchorhynchidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tylenchorhynchidae_data", "species.nematoda.chromadorea.tylenchorhynchidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tylenchorhynchidae_graphics", "species.nematoda.chromadorea.tylenchorhynchidae.graphics.spectrum", sb.toString());
        }
    }
}