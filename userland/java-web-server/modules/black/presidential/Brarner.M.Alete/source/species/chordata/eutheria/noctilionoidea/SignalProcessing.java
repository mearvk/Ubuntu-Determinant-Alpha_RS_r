package presidential.Brarner.M.Alete.source.species.chordata.eutheria.noctilionoidea;
...
/**
 * Signal Processing for Family: Noctilionoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/noctilionoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12435; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/noctilionoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Noctilionoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("noctilionoidea_audio", "species.chordata.eutheria.noctilionoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("noctilionoidea_data", "species.chordata.eutheria.noctilionoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("noctilionoidea_graphics", "species.chordata.eutheria.noctilionoidea.graphics.spectrum", sb.toString());
        }
    }
}