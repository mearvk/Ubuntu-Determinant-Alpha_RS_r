package presidential.Brarner.M.Alete.source.species.nematoda.chromadoria;
...
/**
 * Signal Processing for Phylum: Nematoda, Class: Chromadoria
 * <p>Families: 36</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/chromadoria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16402; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/chromadoria";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Chromadoria"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("nematoda_chromadoria_audio", "species.nematoda.chromadoria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("nematoda_chromadoria_data", "species.nematoda.chromadoria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("nematoda_chromadoria_graphics", "species.nematoda.chromadoria.graphics.spectrum", sb.toString());
        }
    }
}