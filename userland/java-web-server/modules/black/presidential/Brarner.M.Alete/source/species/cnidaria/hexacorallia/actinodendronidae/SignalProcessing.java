package presidential.Brarner.M.Alete.source.species.cnidaria.hexacorallia.actinodendronidae;
...
/**
 * Signal Processing for Family: Actinodendronidae
 * <p>Phylum: Cnidaria | Class: Hexacorallia | Order: Thenaria</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/actinodendronidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11018; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/actinodendronidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Actinodendronidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("actinodendronidae_audio", "species.cnidaria.hexacorallia.actinodendronidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("actinodendronidae_data", "species.cnidaria.hexacorallia.actinodendronidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("actinodendronidae_graphics", "species.cnidaria.hexacorallia.actinodendronidae.graphics.spectrum", sb.toString());
        }
    }
}