package presidential.Brarner.M.Alete.source.species.chordata.reptilia.lamprophiidae;
...
/**
 * Signal Processing for Family: Lamprophiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/reptilia/lamprophiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12624; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/reptilia/lamprophiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Reptilia"); ps.setString(3, "Lamprophiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lamprophiidae_audio", "species.chordata.reptilia.lamprophiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lamprophiidae_data", "species.chordata.reptilia.lamprophiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lamprophiidae_graphics", "species.chordata.reptilia.lamprophiidae.graphics.spectrum", sb.toString());
        }
    }
}