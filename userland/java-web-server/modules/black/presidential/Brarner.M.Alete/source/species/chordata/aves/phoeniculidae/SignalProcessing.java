package presidential.Brarner.M.Alete.source.species.chordata.aves.phoeniculidae;
...
/**
 * Signal Processing for Family: Phoeniculidae
 * <p>Phylum: Chordata | Class: Aves | Order: Bucerotiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/phoeniculidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12146; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/phoeniculidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Phoeniculidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("phoeniculidae_audio", "species.chordata.aves.phoeniculidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("phoeniculidae_data", "species.chordata.aves.phoeniculidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("phoeniculidae_graphics", "species.chordata.aves.phoeniculidae.graphics.spectrum", sb.toString());
        }
    }
}