package presidential.Brarner.M.Alete.source.species.cnidaria.hexacorallia.caryophylliidae;
...
/**
 * Signal Processing for Family: Caryophylliidae
 * <p>Phylum: Cnidaria | Class: Hexacorallia | Order: Caryophylliina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/caryophylliidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11061; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/caryophylliidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Caryophylliidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("caryophylliidae_audio", "species.cnidaria.hexacorallia.caryophylliidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("caryophylliidae_data", "species.cnidaria.hexacorallia.caryophylliidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("caryophylliidae_graphics", "species.cnidaria.hexacorallia.caryophylliidae.graphics.spectrum", sb.toString());
        }
    }
}