package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.siphonarioidea;
...
/**
 * Signal Processing for Family: Siphonarioidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Siphonariida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/siphonarioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17536; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/siphonarioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Siphonarioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("siphonarioidea_audio", "species.mollusca.heterobranchia.siphonarioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("siphonarioidea_data", "species.mollusca.heterobranchia.siphonarioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("siphonarioidea_graphics", "species.mollusca.heterobranchia.siphonarioidea.graphics.spectrum", sb.toString());
        }
    }
}