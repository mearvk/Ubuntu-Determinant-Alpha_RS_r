package presidential.Brarner.M.Alete.source.species.mollusca.heteroconchia.gastrochaenoidea;
...
/**
 * Signal Processing for Family: Gastrochaenoidea
 * <p>Phylum: Mollusca | Class: Heteroconchia | Order: Gastrochaenida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heteroconchia/gastrochaenoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16910; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heteroconchia/gastrochaenoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heteroconchia"); ps.setString(3, "Gastrochaenoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gastrochaenoidea_audio", "species.mollusca.heteroconchia.gastrochaenoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gastrochaenoidea_data", "species.mollusca.heteroconchia.gastrochaenoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gastrochaenoidea_graphics", "species.mollusca.heteroconchia.gastrochaenoidea.graphics.spectrum", sb.toString());
        }
    }
}