package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.plakobranchoidea;
...
/**
 * Signal Processing for Family: Plakobranchoidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Sacoglossa</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/plakobranchoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17528; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/plakobranchoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Plakobranchoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("plakobranchoidea_audio", "species.mollusca.heterobranchia.plakobranchoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("plakobranchoidea_data", "species.mollusca.heterobranchia.plakobranchoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("plakobranchoidea_graphics", "species.mollusca.heterobranchia.plakobranchoidea.graphics.spectrum", sb.toString());
        }
    }
}