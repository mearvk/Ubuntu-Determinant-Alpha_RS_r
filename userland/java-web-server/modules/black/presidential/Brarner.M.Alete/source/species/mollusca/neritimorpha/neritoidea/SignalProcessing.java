package presidential.Brarner.M.Alete.source.species.mollusca.neritimorpha.neritoidea;
...
/**
 * Signal Processing for Family: Neritoidea
 * <p>Phylum: Mollusca | Class: Neritimorpha | Order: Neritina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/neritimorpha/neritoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17696; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/neritimorpha/neritoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Neritimorpha"); ps.setString(3, "Neritoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("neritoidea_audio", "species.mollusca.neritimorpha.neritoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("neritoidea_data", "species.mollusca.neritimorpha.neritoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("neritoidea_graphics", "species.mollusca.neritimorpha.neritoidea.graphics.spectrum", sb.toString());
        }
    }
}