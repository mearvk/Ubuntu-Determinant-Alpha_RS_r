...
/**
 * Signal Processing for Family: Tiguassuidae
 * <p>Phylum: Annelida | Class: Lumbriculata | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/lumbriculata/tiguassuidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16594; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/lumbriculata/tiguassuidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Lumbriculata"); ps.setString(3, "Tiguassuidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tiguassuidae_audio", "species.annelida.lumbriculata.tiguassuidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tiguassuidae_data", "species.annelida.lumbriculata.tiguassuidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tiguassuidae_graphics", "species.annelida.lumbriculata.tiguassuidae.graphics.spectrum", sb.toString());
        }
    }
}