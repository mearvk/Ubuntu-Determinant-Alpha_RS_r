package presidential.Brarner.M.Alete.source.species.mollusca.coleoidea.vampyroteuthidae;
...
/**
 * Signal Processing for Family: Vampyroteuthidae
 * <p>Phylum: Mollusca | Class: Coleoidea | Order: Vampyromorphida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/coleoidea/vampyroteuthidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17116; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/coleoidea/vampyroteuthidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Coleoidea"); ps.setString(3, "Vampyroteuthidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("vampyroteuthidae_audio", "species.mollusca.coleoidea.vampyroteuthidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("vampyroteuthidae_data", "species.mollusca.coleoidea.vampyroteuthidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("vampyroteuthidae_graphics", "species.mollusca.coleoidea.vampyroteuthidae.graphics.spectrum", sb.toString());
        }
    }
}