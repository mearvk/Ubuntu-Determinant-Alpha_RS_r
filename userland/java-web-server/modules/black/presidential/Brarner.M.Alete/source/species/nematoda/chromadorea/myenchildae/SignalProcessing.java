package presidential.Brarner.M.Alete.source.species.nematoda.chromadorea.myenchildae;
...
/**
 * Signal Processing for Family: Myenchildae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/chromadorea/myenchildae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16296; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/chromadorea/myenchildae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Chromadorea"); ps.setString(3, "Myenchildae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("myenchildae_audio", "species.nematoda.chromadorea.myenchildae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("myenchildae_data", "species.nematoda.chromadorea.myenchildae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("myenchildae_graphics", "species.nematoda.chromadorea.myenchildae.graphics.spectrum", sb.toString());
        }
    }
}