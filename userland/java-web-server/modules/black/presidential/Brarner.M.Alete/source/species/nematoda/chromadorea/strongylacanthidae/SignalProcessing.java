package presidential.Brarner.M.Alete.source.species.nematoda.chromadorea.strongylacanthidae;
...
/**
 * Signal Processing for Family: Strongylacanthidae
 * <p>Phylum: Nematoda | Class: Chromadorea | Order: Strongylida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/chromadorea/strongylacanthidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16384; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/chromadorea/strongylacanthidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Chromadorea"); ps.setString(3, "Strongylacanthidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("strongylacanthidae_audio", "species.nematoda.chromadorea.strongylacanthidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("strongylacanthidae_data", "species.nematoda.chromadorea.strongylacanthidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("strongylacanthidae_graphics", "species.nematoda.chromadorea.strongylacanthidae.graphics.spectrum", sb.toString());
        }
    }
}