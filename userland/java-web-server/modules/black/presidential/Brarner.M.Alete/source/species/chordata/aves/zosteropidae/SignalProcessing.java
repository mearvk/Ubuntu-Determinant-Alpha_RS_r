package presidential.Brarner.M.Alete.source.species.chordata.aves.zosteropidae;
...
/**
 * Signal Processing for Family: Zosteropidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/zosteropidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12346; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/zosteropidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Zosteropidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("zosteropidae_audio", "species.chordata.aves.zosteropidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("zosteropidae_data", "species.chordata.aves.zosteropidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("zosteropidae_graphics", "species.chordata.aves.zosteropidae.graphics.spectrum", sb.toString());
        }
    }
}