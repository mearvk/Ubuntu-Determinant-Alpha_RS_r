package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.megalomastomatidae;
...
/**
 * Signal Processing for Family: Megalomastomatidae
 * <p>Phylum: Mollusca | Class: Caenogastropoda | Order: Cyclophorida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/megalomastomatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17168; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/megalomastomatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Megalomastomatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("megalomastomatidae_audio", "species.mollusca.caenogastropoda.megalomastomatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("megalomastomatidae_data", "species.mollusca.caenogastropoda.megalomastomatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("megalomastomatidae_graphics", "species.mollusca.caenogastropoda.megalomastomatidae.graphics.spectrum", sb.toString());
        }
    }
}