package presidential.Brarner.M.Alete.source.species.chordata.aves.phaenicophilidae;
...
/**
 * Signal Processing for Family: Phaenicophilidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/phaenicophilidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12300; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/phaenicophilidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Phaenicophilidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("phaenicophilidae_audio", "species.chordata.aves.phaenicophilidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("phaenicophilidae_data", "species.chordata.aves.phaenicophilidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("phaenicophilidae_graphics", "species.chordata.aves.phaenicophilidae.graphics.spectrum", sb.toString());
        }
    }
}