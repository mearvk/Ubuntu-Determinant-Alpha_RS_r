package presidential.Brarner.M.Alete.source.species.porifera.calcinea.levinellidae;
...
/**
 * Signal Processing for Family: Levinellidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/calcinea/levinellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11331; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/calcinea/levinellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Calcinea"); ps.setString(3, "Levinellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("levinellidae_audio", "species.porifera.calcinea.levinellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("levinellidae_data", "species.porifera.calcinea.levinellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("levinellidae_graphics", "species.porifera.calcinea.levinellidae.graphics.spectrum", sb.toString());
        }
    }
}