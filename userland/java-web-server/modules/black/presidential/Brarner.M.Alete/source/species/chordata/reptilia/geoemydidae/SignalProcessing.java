package presidential.Brarner.M.Alete.source.species.chordata.reptilia.geoemydidae;
...
/**
 * Signal Processing for Family: Geoemydidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/reptilia/geoemydidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12649; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/reptilia/geoemydidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Reptilia"); ps.setString(3, "Geoemydidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("geoemydidae_audio", "species.chordata.reptilia.geoemydidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("geoemydidae_data", "species.chordata.reptilia.geoemydidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("geoemydidae_graphics", "species.chordata.reptilia.geoemydidae.graphics.spectrum", sb.toString());
        }
    }
}