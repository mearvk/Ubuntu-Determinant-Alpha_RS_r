package presidential.Brarner.M.Alete.source.species.chordata.reptilia.testudinoidea;
...
/**
 * Signal Processing for Family: Testudinoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/reptilia/testudinoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12647; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/reptilia/testudinoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Reptilia"); ps.setString(3, "Testudinoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("testudinoidea_audio", "species.chordata.reptilia.testudinoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("testudinoidea_data", "species.chordata.reptilia.testudinoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("testudinoidea_graphics", "species.chordata.reptilia.testudinoidea.graphics.spectrum", sb.toString());
        }
    }
}