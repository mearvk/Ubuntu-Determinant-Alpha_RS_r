package presidential.Brarner.M.Alete.source.species.cnidaria.cubozoa.carybdeidae;
...
/**
 * Signal Processing for Family: Carybdeidae
 * <p>Phylum: Cnidaria | Class: Cubozoa | Order: Carybdeida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/cubozoa/carybdeidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11134; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/cubozoa/carybdeidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Cubozoa"); ps.setString(3, "Carybdeidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("carybdeidae_audio", "species.cnidaria.cubozoa.carybdeidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("carybdeidae_data", "species.cnidaria.cubozoa.carybdeidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("carybdeidae_graphics", "species.cnidaria.cubozoa.carybdeidae.graphics.spectrum", sb.toString());
        }
    }
}