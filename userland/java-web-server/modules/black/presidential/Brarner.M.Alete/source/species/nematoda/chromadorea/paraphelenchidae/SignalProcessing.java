package presidential.Brarner.M.Alete.source.species.nematoda.chromadorea.paraphelenchidae;
...
/**
 * Signal Processing for Family: Paraphelenchidae
 * <p>Phylum: Nematoda | Class: Chromadorea | Order: Aphelenchida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/chromadorea/paraphelenchidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16297; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/chromadorea/paraphelenchidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Chromadorea"); ps.setString(3, "Paraphelenchidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("paraphelenchidae_audio", "species.nematoda.chromadorea.paraphelenchidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("paraphelenchidae_data", "species.nematoda.chromadorea.paraphelenchidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("paraphelenchidae_graphics", "species.nematoda.chromadorea.paraphelenchidae.graphics.spectrum", sb.toString());
        }
    }
}