package presidential.Brarner.M.Alete.source.species.mollusca.heteroconchia.galeommatoidea;
...
/**
 * Signal Processing for Family: Galeommatoidea
 * <p>Phylum: Mollusca | Class: Heteroconchia | Order: Galeommatida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heteroconchia/galeommatoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16907; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heteroconchia/galeommatoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heteroconchia"); ps.setString(3, "Galeommatoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("galeommatoidea_audio", "species.mollusca.heteroconchia.galeommatoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("galeommatoidea_data", "species.mollusca.heteroconchia.galeommatoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("galeommatoidea_graphics", "species.mollusca.heteroconchia.galeommatoidea.graphics.spectrum", sb.toString());
        }
    }
}