package presidential.Brarner.M.Alete.source.species.chordata.appendicularia.kowalewskaiidae;
...
/**
 * Signal Processing for Family: Kowalewskaiidae
 * <p>Phylum: Chordata | Class: Appendicularia | Order: Copelata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/appendicularia/kowalewskaiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11481; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/appendicularia/kowalewskaiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Appendicularia"); ps.setString(3, "Kowalewskaiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("kowalewskaiidae_audio", "species.chordata.appendicularia.kowalewskaiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("kowalewskaiidae_data", "species.chordata.appendicularia.kowalewskaiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("kowalewskaiidae_graphics", "species.chordata.appendicularia.kowalewskaiidae.graphics.spectrum", sb.toString());
        }
    }
}