package presidential.Brarner.M.Alete.source.species.chordata.elasmobranchii.gymnuridae;
...
/**
 * Signal Processing for Family: Gymnuridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/elasmobranchii/gymnuridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11999; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/elasmobranchii/gymnuridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Elasmobranchii"); ps.setString(3, "Gymnuridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gymnuridae_audio", "species.chordata.elasmobranchii.gymnuridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gymnuridae_data", "species.chordata.elasmobranchii.gymnuridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gymnuridae_graphics", "species.chordata.elasmobranchii.gymnuridae.graphics.spectrum", sb.toString());
        }
    }
}