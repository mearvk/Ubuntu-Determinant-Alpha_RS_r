package presidential.Brarner.M.Alete.source.species.cnidaria.discomedusae.ulmaridae;
...
/**
 * Signal Processing for Family: Ulmaridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/discomedusae/ulmaridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11262; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/discomedusae/ulmaridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Discomedusae"); ps.setString(3, "Ulmaridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ulmaridae_audio", "species.cnidaria.discomedusae.ulmaridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ulmaridae_data", "species.cnidaria.discomedusae.ulmaridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ulmaridae_graphics", "species.cnidaria.discomedusae.ulmaridae.graphics.spectrum", sb.toString());
        }
    }
}