package presidential.Brarner.M.Alete.source.species.mollusca.protobranchia.tindariidae;
...
/**
 * Signal Processing for Family: Tindariidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/protobranchia/tindariidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17059; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/protobranchia/tindariidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Protobranchia"); ps.setString(3, "Tindariidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tindariidae_audio", "species.mollusca.protobranchia.tindariidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tindariidae_data", "species.mollusca.protobranchia.tindariidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tindariidae_graphics", "species.mollusca.protobranchia.tindariidae.graphics.spectrum", sb.toString());
        }
    }
}