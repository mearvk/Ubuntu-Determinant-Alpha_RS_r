package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.chromodoridoidea;
...
/**
 * Signal Processing for Family: Chromodoridoidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Doridoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/chromodoridoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17489; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/chromodoridoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Chromodoridoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chromodoridoidea_audio", "species.mollusca.heterobranchia.chromodoridoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chromodoridoidea_data", "species.mollusca.heterobranchia.chromodoridoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chromodoridoidea_graphics", "species.mollusca.heterobranchia.chromodoridoidea.graphics.spectrum", sb.toString());
        }
    }
}