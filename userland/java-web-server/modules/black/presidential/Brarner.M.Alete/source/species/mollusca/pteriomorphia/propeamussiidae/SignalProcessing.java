package presidential.Brarner.M.Alete.source.species.mollusca.pteriomorphia.propeamussiidae;
...
/**
 * Signal Processing for Family: Propeamussiidae
 * <p>Phylum: Mollusca | Class: Pteriomorphia | Order: Limida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/pteriomorphia/propeamussiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17028; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/pteriomorphia/propeamussiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Pteriomorphia"); ps.setString(3, "Propeamussiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("propeamussiidae_audio", "species.mollusca.pteriomorphia.propeamussiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("propeamussiidae_data", "species.mollusca.pteriomorphia.propeamussiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("propeamussiidae_graphics", "species.mollusca.pteriomorphia.propeamussiidae.graphics.spectrum", sb.toString());
        }
    }
}