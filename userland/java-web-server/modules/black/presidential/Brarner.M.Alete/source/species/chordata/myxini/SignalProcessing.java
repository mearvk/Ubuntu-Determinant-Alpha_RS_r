package presidential.Brarner.M.Alete.source.species.chordata.myxini;
...
/**
 * Signal Processing for Phylum: Chordata, Class: Myxini
 * <p>Families: 1</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/myxini/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11506; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/myxini";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Myxini"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chordata_myxini_audio", "species.chordata.myxini.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chordata_myxini_data", "species.chordata.myxini.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chordata_myxini_graphics", "species.chordata.myxini.graphics.spectrum", sb.toString());
        }
    }
}