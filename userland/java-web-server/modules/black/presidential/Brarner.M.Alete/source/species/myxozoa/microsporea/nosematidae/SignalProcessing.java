...
/**
 * Signal Processing for Family: Nosematidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/myxozoa/microsporea/nosematidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11302; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/myxozoa/microsporea/nosematidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Myxozoa"); ps.setString(2, "Microsporea"); ps.setString(3, "Nosematidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("nosematidae_audio", "species.myxozoa.microsporea.nosematidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("nosematidae_data", "species.myxozoa.microsporea.nosematidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("nosematidae_graphics", "species.myxozoa.microsporea.nosematidae.graphics.spectrum", sb.toString());
        }
    }
}