package presidential.Brarner.M.Alete.source.species.nematoda.chromadorea.heterocheilidae;
...
/**
 * Signal Processing for Family: Heterocheilidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/chromadorea/heterocheilidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16309; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/chromadorea/heterocheilidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Chromadorea"); ps.setString(3, "Heterocheilidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("heterocheilidae_audio", "species.nematoda.chromadorea.heterocheilidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("heterocheilidae_data", "species.nematoda.chromadorea.heterocheilidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("heterocheilidae_graphics", "species.nematoda.chromadorea.heterocheilidae.graphics.spectrum", sb.toString());
        }
    }
}