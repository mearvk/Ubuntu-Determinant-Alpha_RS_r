package presidential.Brarner.M.Alete.source.species.chordata.teleostei.gnathanacanthidae;
...
/**
 * Signal Processing for Family: Gnathanacanthidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Scorpaenoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/gnathanacanthidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11750; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/gnathanacanthidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Gnathanacanthidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gnathanacanthidae_audio", "species.chordata.teleostei.gnathanacanthidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gnathanacanthidae_data", "species.chordata.teleostei.gnathanacanthidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gnathanacanthidae_graphics", "species.chordata.teleostei.gnathanacanthidae.graphics.spectrum", sb.toString());
        }
    }
}