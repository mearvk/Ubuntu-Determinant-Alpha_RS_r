package presidential.Brarner.M.Alete.source.species.porifera.calcaronea;
...
/**
 * Signal Processing for Phylum: Porifera, Class: Calcaronea
 * <p>Families: 14</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/calcaronea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11311; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/calcaronea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Calcaronea"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("porifera_calcaronea_audio", "species.porifera.calcaronea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("porifera_calcaronea_data", "species.porifera.calcaronea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("porifera_calcaronea_graphics", "species.porifera.calcaronea.graphics.spectrum", sb.toString());
        }
    }
}