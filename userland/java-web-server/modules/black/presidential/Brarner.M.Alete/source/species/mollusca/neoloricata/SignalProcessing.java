package presidential.Brarner.M.Alete.source.species.mollusca.neoloricata;
...
/**
 * Signal Processing for Phylum: Mollusca, Class: Neoloricata
 * <p>Families: 9</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/neoloricata/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17759; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/neoloricata";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Neoloricata"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mollusca_neoloricata_audio", "species.mollusca.neoloricata.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mollusca_neoloricata_data", "species.mollusca.neoloricata.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mollusca_neoloricata_graphics", "species.mollusca.neoloricata.graphics.spectrum", sb.toString());
        }
    }
}