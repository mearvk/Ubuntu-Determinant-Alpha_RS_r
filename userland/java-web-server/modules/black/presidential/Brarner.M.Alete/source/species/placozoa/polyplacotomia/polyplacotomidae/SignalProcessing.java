package presidential.Brarner.M.Alete.source.species.placozoa.polyplacotomia.polyplacotomidae;
...
/**
 * Signal Processing for Family: Polyplacotomidae
 * <p>Phylum: Placozoa | Class: Polyplacotomia | Order: Polyplacotomea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/placozoa/polyplacotomia/polyplacotomidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11306; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/placozoa/polyplacotomia/polyplacotomidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Placozoa"); ps.setString(2, "Polyplacotomia"); ps.setString(3, "Polyplacotomidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("polyplacotomidae_audio", "species.placozoa.polyplacotomia.polyplacotomidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("polyplacotomidae_data", "species.placozoa.polyplacotomia.polyplacotomidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("polyplacotomidae_graphics", "species.placozoa.polyplacotomia.polyplacotomidae.graphics.spectrum", sb.toString());
        }
    }
}