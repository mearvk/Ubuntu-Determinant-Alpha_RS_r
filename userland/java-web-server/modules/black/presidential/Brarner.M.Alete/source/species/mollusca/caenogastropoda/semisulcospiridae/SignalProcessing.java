package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.semisulcospiridae;
...
/**
 * Signal Processing for Family: Semisulcospiridae
 * <p>Phylum: Mollusca | Class: Caenogastropoda | Order: Cerithiida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/semisulcospiridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17158; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/semisulcospiridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Semisulcospiridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("semisulcospiridae_audio", "species.mollusca.caenogastropoda.semisulcospiridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("semisulcospiridae_data", "species.mollusca.caenogastropoda.semisulcospiridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("semisulcospiridae_graphics", "species.mollusca.caenogastropoda.semisulcospiridae.graphics.spectrum", sb.toString());
        }
    }
}