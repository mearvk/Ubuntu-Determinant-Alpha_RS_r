...
/**
 * Signal Processing for Family: Cephalothricidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nemertea/palaeonemertea/cephalothricidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17837; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nemertea/palaeonemertea/cephalothricidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nemertea"); ps.setString(2, "Palaeonemertea"); ps.setString(3, "Cephalothricidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cephalothricidae_audio", "species.nemertea.palaeonemertea.cephalothricidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cephalothricidae_data", "species.nemertea.palaeonemertea.cephalothricidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cephalothricidae_graphics", "species.nemertea.palaeonemertea.cephalothricidae.graphics.spectrum", sb.toString());
        }
    }
}