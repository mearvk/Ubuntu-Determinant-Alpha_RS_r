package presidential.Brarner.M.Alete.source.species.cnidaria.octocorallia.subergorgiidae;
...
/**
 * Signal Processing for Family: Subergorgiidae
 * <p>Phylum: Cnidaria | Class: Octocorallia | Order: Scleraxonia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/octocorallia/subergorgiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11115; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/octocorallia/subergorgiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Octocorallia"); ps.setString(3, "Subergorgiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("subergorgiidae_audio", "species.cnidaria.octocorallia.subergorgiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("subergorgiidae_data", "species.cnidaria.octocorallia.subergorgiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("subergorgiidae_graphics", "species.cnidaria.octocorallia.subergorgiidae.graphics.spectrum", sb.toString());
        }
    }
}