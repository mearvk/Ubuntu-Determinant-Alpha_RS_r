package presidential.Brarner.M.Alete.source.species.chordata.dipnoi.neoceratodontidae;
...
/**
 * Signal Processing for Family: Neoceratodontidae
 * <p>Phylum: Chordata | Class: Dipnoi | Order: Ceratodontiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/dipnoi/neoceratodontidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12044; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/dipnoi/neoceratodontidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Dipnoi"); ps.setString(3, "Neoceratodontidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("neoceratodontidae_audio", "species.chordata.dipnoi.neoceratodontidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("neoceratodontidae_data", "species.chordata.dipnoi.neoceratodontidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("neoceratodontidae_graphics", "species.chordata.dipnoi.neoceratodontidae.graphics.spectrum", sb.toString());
        }
    }
}