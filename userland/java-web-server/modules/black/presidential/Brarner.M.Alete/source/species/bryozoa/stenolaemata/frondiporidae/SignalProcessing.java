package presidential.Brarner.M.Alete.source.species.bryozoa.stenolaemata.frondiporidae;
...
/**
 * Signal Processing for Family: Frondiporidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/stenolaemata/frondiporidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16880; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/stenolaemata/frondiporidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Stenolaemata"); ps.setString(3, "Frondiporidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("frondiporidae_audio", "species.bryozoa.stenolaemata.frondiporidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("frondiporidae_data", "species.bryozoa.stenolaemata.frondiporidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("frondiporidae_graphics", "species.bryozoa.stenolaemata.frondiporidae.graphics.spectrum", sb.toString());
        }
    }
}