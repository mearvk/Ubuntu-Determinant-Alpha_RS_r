...
/**
 * Signal Processing for Family: Thelohaniidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/myxozoa/microsporea/thelohaniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11304; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/myxozoa/microsporea/thelohaniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Myxozoa"); ps.setString(2, "Microsporea"); ps.setString(3, "Thelohaniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thelohaniidae_audio", "species.myxozoa.microsporea.thelohaniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thelohaniidae_data", "species.myxozoa.microsporea.thelohaniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thelohaniidae_graphics", "species.myxozoa.microsporea.thelohaniidae.graphics.spectrum", sb.toString());
        }
    }
}