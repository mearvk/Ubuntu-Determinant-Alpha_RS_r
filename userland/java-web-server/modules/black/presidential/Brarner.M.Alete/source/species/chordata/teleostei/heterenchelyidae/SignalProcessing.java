package presidential.Brarner.M.Alete.source.species.chordata.teleostei.heterenchelyidae;
...
/**
 * Signal Processing for Family: Heterenchelyidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Anguilloidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/heterenchelyidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11809; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/heterenchelyidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Heterenchelyidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("heterenchelyidae_audio", "species.chordata.teleostei.heterenchelyidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("heterenchelyidae_data", "species.chordata.teleostei.heterenchelyidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("heterenchelyidae_graphics", "species.chordata.teleostei.heterenchelyidae.graphics.spectrum", sb.toString());
        }
    }
}