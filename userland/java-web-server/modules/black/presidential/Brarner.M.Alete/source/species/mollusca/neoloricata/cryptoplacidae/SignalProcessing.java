package presidential.Brarner.M.Alete.source.species.mollusca.neoloricata.cryptoplacidae;
...
/**
 * Signal Processing for Family: Cryptoplacidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/neoloricata/cryptoplacidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17762; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/neoloricata/cryptoplacidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Neoloricata"); ps.setString(3, "Cryptoplacidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cryptoplacidae_audio", "species.mollusca.neoloricata.cryptoplacidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cryptoplacidae_data", "species.mollusca.neoloricata.cryptoplacidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cryptoplacidae_graphics", "species.mollusca.neoloricata.cryptoplacidae.graphics.spectrum", sb.toString());
        }
    }
}