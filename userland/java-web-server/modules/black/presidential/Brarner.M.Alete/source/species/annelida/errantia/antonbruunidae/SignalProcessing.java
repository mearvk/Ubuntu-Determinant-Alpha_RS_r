package presidential.Brarner.M.Alete.source.species.annelida.errantia.antonbruunidae;
...
/**
 * Signal Processing for Family: Antonbruunidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/errantia/antonbruunidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16659; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/errantia/antonbruunidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Errantia"); ps.setString(3, "Antonbruunidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("antonbruunidae_audio", "species.annelida.errantia.antonbruunidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("antonbruunidae_data", "species.annelida.errantia.antonbruunidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("antonbruunidae_graphics", "species.annelida.errantia.antonbruunidae.graphics.spectrum", sb.toString());
        }
    }
}