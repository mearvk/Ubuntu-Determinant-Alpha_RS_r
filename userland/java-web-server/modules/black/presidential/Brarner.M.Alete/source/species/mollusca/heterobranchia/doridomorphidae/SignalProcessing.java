package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.doridomorphidae;
...
/**
 * Signal Processing for Family: Doridomorphidae
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Cladobranchia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/doridomorphidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17472; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/doridomorphidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Doridomorphidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("doridomorphidae_audio", "species.mollusca.heterobranchia.doridomorphidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("doridomorphidae_data", "species.mollusca.heterobranchia.doridomorphidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("doridomorphidae_graphics", "species.mollusca.heterobranchia.doridomorphidae.graphics.spectrum", sb.toString());
        }
    }
}