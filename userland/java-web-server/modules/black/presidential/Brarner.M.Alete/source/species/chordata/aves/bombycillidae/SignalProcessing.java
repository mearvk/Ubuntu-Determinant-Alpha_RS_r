package presidential.Brarner.M.Alete.source.species.chordata.aves.bombycillidae;
...
/**
 * Signal Processing for Family: Bombycillidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/bombycillidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12213; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/bombycillidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Bombycillidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("bombycillidae_audio", "species.chordata.aves.bombycillidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("bombycillidae_data", "species.chordata.aves.bombycillidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("bombycillidae_graphics", "species.chordata.aves.bombycillidae.graphics.spectrum", sb.toString());
        }
    }
}