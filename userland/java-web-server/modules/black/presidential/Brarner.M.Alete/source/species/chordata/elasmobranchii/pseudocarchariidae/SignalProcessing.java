package presidential.Brarner.M.Alete.source.species.chordata.elasmobranchii.pseudocarchariidae;
...
/**
 * Signal Processing for Family: Pseudocarchariidae
 * <p>Phylum: Chordata | Class: Elasmobranchii | Order: Lamniformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/elasmobranchii/pseudocarchariidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11997; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/elasmobranchii/pseudocarchariidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Elasmobranchii"); ps.setString(3, "Pseudocarchariidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudocarchariidae_audio", "species.chordata.elasmobranchii.pseudocarchariidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudocarchariidae_data", "species.chordata.elasmobranchii.pseudocarchariidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudocarchariidae_graphics", "species.chordata.elasmobranchii.pseudocarchariidae.graphics.spectrum", sb.toString());
        }
    }
}