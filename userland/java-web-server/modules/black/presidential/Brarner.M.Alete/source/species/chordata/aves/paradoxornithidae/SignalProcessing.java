package presidential.Brarner.M.Alete.source.species.chordata.aves.paradoxornithidae;
...
/**
 * Signal Processing for Family: Paradoxornithidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/paradoxornithidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12290; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/paradoxornithidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Paradoxornithidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("paradoxornithidae_audio", "species.chordata.aves.paradoxornithidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("paradoxornithidae_data", "species.chordata.aves.paradoxornithidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("paradoxornithidae_graphics", "species.chordata.aves.paradoxornithidae.graphics.spectrum", sb.toString());
        }
    }
}