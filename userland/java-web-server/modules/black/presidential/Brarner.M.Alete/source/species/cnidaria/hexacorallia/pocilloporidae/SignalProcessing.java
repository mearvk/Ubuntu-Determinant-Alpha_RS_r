package presidential.Brarner.M.Alete.source.species.cnidaria.hexacorallia.pocilloporidae;
...
/**
 * Signal Processing for Family: Pocilloporidae
 * <p>Phylum: Cnidaria | Class: Hexacorallia | Order: Astrocoeniina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/pocilloporidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11060; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/pocilloporidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Pocilloporidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pocilloporidae_audio", "species.cnidaria.hexacorallia.pocilloporidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pocilloporidae_data", "species.cnidaria.hexacorallia.pocilloporidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pocilloporidae_graphics", "species.cnidaria.hexacorallia.pocilloporidae.graphics.spectrum", sb.toString());
        }
    }
}