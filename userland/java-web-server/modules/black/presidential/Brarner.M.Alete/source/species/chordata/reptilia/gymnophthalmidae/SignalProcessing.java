package presidential.Brarner.M.Alete.source.species.chordata.reptilia.gymnophthalmidae;
...
/**
 * Signal Processing for Family: Gymnophthalmidae
 * <p>Phylum: Chordata | Class: Reptilia | Order: Autarchoglossa</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/reptilia/gymnophthalmidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12580; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/reptilia/gymnophthalmidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Reptilia"); ps.setString(3, "Gymnophthalmidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gymnophthalmidae_audio", "species.chordata.reptilia.gymnophthalmidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gymnophthalmidae_data", "species.chordata.reptilia.gymnophthalmidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gymnophthalmidae_graphics", "species.chordata.reptilia.gymnophthalmidae.graphics.spectrum", sb.toString());
        }
    }
}