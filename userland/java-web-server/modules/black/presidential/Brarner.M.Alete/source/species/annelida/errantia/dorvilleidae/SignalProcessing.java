package presidential.Brarner.M.Alete.source.species.annelida.errantia.dorvilleidae;
...
/**
 * Signal Processing for Family: Dorvilleidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/errantia/dorvilleidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16650; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/errantia/dorvilleidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Errantia"); ps.setString(3, "Dorvilleidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dorvilleidae_audio", "species.annelida.errantia.dorvilleidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dorvilleidae_data", "species.annelida.errantia.dorvilleidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dorvilleidae_graphics", "species.annelida.errantia.dorvilleidae.graphics.spectrum", sb.toString());
        }
    }
}