package presidential.Brarner.M.Alete.source.species.chordata.teleostei.dactyloscopidae;
...
/**
 * Signal Processing for Family: Dactyloscopidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Blennioidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/dactyloscopidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11568; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/dactyloscopidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Dactyloscopidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dactyloscopidae_audio", "species.chordata.teleostei.dactyloscopidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dactyloscopidae_data", "species.chordata.teleostei.dactyloscopidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dactyloscopidae_graphics", "species.chordata.teleostei.dactyloscopidae.graphics.spectrum", sb.toString());
        }
    }
}