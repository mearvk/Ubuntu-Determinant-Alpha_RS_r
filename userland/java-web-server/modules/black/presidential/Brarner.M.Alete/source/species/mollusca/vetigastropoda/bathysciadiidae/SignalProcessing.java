package presidential.Brarner.M.Alete.source.species.mollusca.vetigastropoda.bathysciadiidae;
...
/**
 * Signal Processing for Family: Bathysciadiidae
 * <p>Phylum: Mollusca | Class: Vetigastropoda | Order: Cocculinina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/vetigastropoda/bathysciadiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17723; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/vetigastropoda/bathysciadiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Vetigastropoda"); ps.setString(3, "Bathysciadiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("bathysciadiidae_audio", "species.mollusca.vetigastropoda.bathysciadiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("bathysciadiidae_data", "species.mollusca.vetigastropoda.bathysciadiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("bathysciadiidae_graphics", "species.mollusca.vetigastropoda.bathysciadiidae.graphics.spectrum", sb.toString());
        }
    }
}