package presidential.Brarner.M.Alete.source.species.annelida.errantia.chrysopetalidae;
...
/**
 * Signal Processing for Family: Chrysopetalidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/errantia/chrysopetalidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16661; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/errantia/chrysopetalidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Errantia"); ps.setString(3, "Chrysopetalidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chrysopetalidae_audio", "species.annelida.errantia.chrysopetalidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chrysopetalidae_data", "species.annelida.errantia.chrysopetalidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chrysopetalidae_graphics", "species.annelida.errantia.chrysopetalidae.graphics.spectrum", sb.toString());
        }
    }
}