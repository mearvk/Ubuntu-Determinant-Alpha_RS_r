package presidential.Brarner.M.Alete.source.species.chordata.prototheria.ornithorhynchidae;
...
/**
 * Signal Processing for Family: Ornithorhynchidae
 * <p>Phylum: Chordata | Class: Prototheria | Order: Monotremata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/prototheria/ornithorhynchidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12386; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/prototheria/ornithorhynchidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Prototheria"); ps.setString(3, "Ornithorhynchidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ornithorhynchidae_audio", "species.chordata.prototheria.ornithorhynchidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ornithorhynchidae_data", "species.chordata.prototheria.ornithorhynchidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ornithorhynchidae_graphics", "species.chordata.prototheria.ornithorhynchidae.graphics.spectrum", sb.toString());
        }
    }
}