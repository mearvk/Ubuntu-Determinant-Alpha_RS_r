package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.calyptraeoidea;
...
/**
 * Signal Processing for Family: Calyptraeoidea
 * <p>Phylum: Mollusca | Class: Caenogastropoda | Order: Calyptraeina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/calyptraeoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17240; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/calyptraeoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Calyptraeoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("calyptraeoidea_audio", "species.mollusca.caenogastropoda.calyptraeoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("calyptraeoidea_data", "species.mollusca.caenogastropoda.calyptraeoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("calyptraeoidea_graphics", "species.mollusca.caenogastropoda.calyptraeoidea.graphics.spectrum", sb.toString());
        }
    }
}