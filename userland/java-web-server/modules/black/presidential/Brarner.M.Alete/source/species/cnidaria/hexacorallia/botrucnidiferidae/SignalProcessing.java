package presidential.Brarner.M.Alete.source.species.cnidaria.hexacorallia.botrucnidiferidae;
...
/**
 * Signal Processing for Family: Botrucnidiferidae
 * <p>Phylum: Cnidaria | Class: Hexacorallia | Order: Ceriantharia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/botrucnidiferidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11054; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/botrucnidiferidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Botrucnidiferidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("botrucnidiferidae_audio", "species.cnidaria.hexacorallia.botrucnidiferidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("botrucnidiferidae_data", "species.cnidaria.hexacorallia.botrucnidiferidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("botrucnidiferidae_graphics", "species.cnidaria.hexacorallia.botrucnidiferidae.graphics.spectrum", sb.toString());
        }
    }
}