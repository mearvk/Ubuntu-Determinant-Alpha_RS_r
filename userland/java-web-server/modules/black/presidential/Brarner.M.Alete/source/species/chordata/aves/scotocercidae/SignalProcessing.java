package presidential.Brarner.M.Alete.source.species.chordata.aves.scotocercidae;
...
/**
 * Signal Processing for Family: Scotocercidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/scotocercidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12326; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/scotocercidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Scotocercidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("scotocercidae_audio", "species.chordata.aves.scotocercidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("scotocercidae_data", "species.chordata.aves.scotocercidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("scotocercidae_graphics", "species.chordata.aves.scotocercidae.graphics.spectrum", sb.toString());
        }
    }
}