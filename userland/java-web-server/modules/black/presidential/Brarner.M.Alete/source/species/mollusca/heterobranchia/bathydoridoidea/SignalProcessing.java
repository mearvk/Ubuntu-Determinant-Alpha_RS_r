package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.bathydoridoidea;
...
/**
 * Signal Processing for Family: Bathydoridoidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Bathydoridoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/bathydoridoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17487; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/bathydoridoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Bathydoridoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("bathydoridoidea_audio", "species.mollusca.heterobranchia.bathydoridoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("bathydoridoidea_data", "species.mollusca.heterobranchia.bathydoridoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("bathydoridoidea_graphics", "species.mollusca.heterobranchia.bathydoridoidea.graphics.spectrum", sb.toString());
        }
    }
}