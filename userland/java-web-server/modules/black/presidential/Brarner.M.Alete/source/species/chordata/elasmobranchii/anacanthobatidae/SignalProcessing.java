package presidential.Brarner.M.Alete.source.species.chordata.elasmobranchii.anacanthobatidae;
...
/**
 * Signal Processing for Family: Anacanthobatidae
 * <p>Phylum: Chordata | Class: Elasmobranchii | Order: Rajiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/elasmobranchii/anacanthobatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12016; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/elasmobranchii/anacanthobatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Elasmobranchii"); ps.setString(3, "Anacanthobatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("anacanthobatidae_audio", "species.chordata.elasmobranchii.anacanthobatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("anacanthobatidae_data", "species.chordata.elasmobranchii.anacanthobatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("anacanthobatidae_graphics", "species.chordata.elasmobranchii.anacanthobatidae.graphics.spectrum", sb.toString());
        }
    }
}