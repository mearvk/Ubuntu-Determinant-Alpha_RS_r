package presidential.Brarner.M.Alete.source.species.chordata.metatheria.burramyidae;
...
/**
 * Signal Processing for Family: Burramyidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/metatheria/burramyidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12553; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/metatheria/burramyidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Metatheria"); ps.setString(3, "Burramyidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("burramyidae_audio", "species.chordata.metatheria.burramyidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("burramyidae_data", "species.chordata.metatheria.burramyidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("burramyidae_graphics", "species.chordata.metatheria.burramyidae.graphics.spectrum", sb.toString());
        }
    }
}