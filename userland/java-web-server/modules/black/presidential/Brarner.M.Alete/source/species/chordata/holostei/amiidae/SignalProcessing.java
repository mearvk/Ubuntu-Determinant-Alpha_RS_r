package presidential.Brarner.M.Alete.source.species.chordata.holostei.amiidae;
...
/**
 * Signal Processing for Family: Amiidae
 * <p>Phylum: Chordata | Class: Holostei | Order: Amiiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/holostei/amiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11514; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/holostei/amiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Holostei"); ps.setString(3, "Amiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("amiidae_audio", "species.chordata.holostei.amiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("amiidae_data", "species.chordata.holostei.amiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("amiidae_graphics", "species.chordata.holostei.amiidae.graphics.spectrum", sb.toString());
        }
    }
}