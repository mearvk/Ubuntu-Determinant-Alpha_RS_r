...
/**
 * Signal Processing for Family: Salpidae
 * <p>Phylum: Chordata | Class: Thaliacea | Order: Salpida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/thaliacea/salpidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11501; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/thaliacea/salpidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Thaliacea"); ps.setString(3, "Salpidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("salpidae_audio", "species.chordata.thaliacea.salpidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("salpidae_data", "species.chordata.thaliacea.salpidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("salpidae_graphics", "species.chordata.thaliacea.salpidae.graphics.spectrum", sb.toString());
        }
    }
}