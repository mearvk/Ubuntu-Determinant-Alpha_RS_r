package presidential.Brarner.M.Alete.source.species.annelida.errantia.eulepethidae;
...
/**
 * Signal Processing for Family: Eulepethidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/errantia/eulepethidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16662; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/errantia/eulepethidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Errantia"); ps.setString(3, "Eulepethidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("eulepethidae_audio", "species.annelida.errantia.eulepethidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("eulepethidae_data", "species.annelida.errantia.eulepethidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("eulepethidae_graphics", "species.annelida.errantia.eulepethidae.graphics.spectrum", sb.toString());
        }
    }
}