package presidential.Brarner.M.Alete.source.species.mollusca.pteriomorphia.cyclochlamydidae;
...
/**
 * Signal Processing for Family: Cyclochlamydidae
 * <p>Phylum: Mollusca | Class: Pteriomorphia | Order: Pectinina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/pteriomorphia/cyclochlamydidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17038; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/pteriomorphia/cyclochlamydidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Pteriomorphia"); ps.setString(3, "Cyclochlamydidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cyclochlamydidae_audio", "species.mollusca.pteriomorphia.cyclochlamydidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cyclochlamydidae_data", "species.mollusca.pteriomorphia.cyclochlamydidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cyclochlamydidae_graphics", "species.mollusca.pteriomorphia.cyclochlamydidae.graphics.spectrum", sb.toString());
        }
    }
}