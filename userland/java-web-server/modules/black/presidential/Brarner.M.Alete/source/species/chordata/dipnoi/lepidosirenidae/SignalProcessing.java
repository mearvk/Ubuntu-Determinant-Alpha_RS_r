package presidential.Brarner.M.Alete.source.species.chordata.dipnoi.lepidosirenidae;
...
/**
 * Signal Processing for Family: Lepidosirenidae
 * <p>Phylum: Chordata | Class: Dipnoi | Order: Lepidosireniformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/dipnoi/lepidosirenidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12045; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/dipnoi/lepidosirenidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Dipnoi"); ps.setString(3, "Lepidosirenidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lepidosirenidae_audio", "species.chordata.dipnoi.lepidosirenidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lepidosirenidae_data", "species.chordata.dipnoi.lepidosirenidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lepidosirenidae_graphics", "species.chordata.dipnoi.lepidosirenidae.graphics.spectrum", sb.toString());
        }
    }
}