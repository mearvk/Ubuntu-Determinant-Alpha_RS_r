package presidential.Brarner.M.Alete.source.species.mollusca.scaphopoda.wemersoniellidae;
...
/**
 * Signal Processing for Family: Wemersoniellidae
 * <p>Phylum: Mollusca | Class: Scaphopoda | Order: Gadilimorpha</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/scaphopoda/wemersoniellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17786; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/scaphopoda/wemersoniellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Scaphopoda"); ps.setString(3, "Wemersoniellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("wemersoniellidae_audio", "species.mollusca.scaphopoda.wemersoniellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("wemersoniellidae_data", "species.mollusca.scaphopoda.wemersoniellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("wemersoniellidae_graphics", "species.mollusca.scaphopoda.wemersoniellidae.graphics.spectrum", sb.toString());
        }
    }
}