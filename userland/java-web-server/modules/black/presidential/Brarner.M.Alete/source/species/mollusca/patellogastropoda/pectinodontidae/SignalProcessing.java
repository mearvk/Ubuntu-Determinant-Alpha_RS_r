package presidential.Brarner.M.Alete.source.species.mollusca.patellogastropoda.pectinodontidae;
...
/**
 * Signal Processing for Family: Pectinodontidae
 * <p>Phylum: Mollusca | Class: Patellogastropoda | Order: Nacellina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/patellogastropoda/pectinodontidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17127; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/patellogastropoda/pectinodontidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Patellogastropoda"); ps.setString(3, "Pectinodontidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pectinodontidae_audio", "species.mollusca.patellogastropoda.pectinodontidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pectinodontidae_data", "species.mollusca.patellogastropoda.pectinodontidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pectinodontidae_graphics", "species.mollusca.patellogastropoda.pectinodontidae.graphics.spectrum", sb.toString());
        }
    }
}