package presidential.Brarner.M.Alete.source.species.annelida.canalipalpata.telothelepodidae;
...
/**
 * Signal Processing for Family: Telothelepodidae
 * <p>Phylum: Annelida | Class: Canalipalpata | Order: Terebellida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/canalipalpata/telothelepodidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16710; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/canalipalpata/telothelepodidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Canalipalpata"); ps.setString(3, "Telothelepodidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("telothelepodidae_audio", "species.annelida.canalipalpata.telothelepodidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("telothelepodidae_data", "species.annelida.canalipalpata.telothelepodidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("telothelepodidae_graphics", "species.annelida.canalipalpata.telothelepodidae.graphics.spectrum", sb.toString());
        }
    }
}