package presidential.Brarner.M.Alete.source.species.chordata.teleostei.ceratioidea;
...
/**
 * Signal Processing for Family: Ceratioidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/ceratioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11925; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/ceratioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Ceratioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ceratioidea_audio", "species.chordata.teleostei.ceratioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ceratioidea_data", "species.chordata.teleostei.ceratioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ceratioidea_graphics", "species.chordata.teleostei.ceratioidea.graphics.spectrum", sb.toString());
        }
    }
}