package presidential.Brarner.M.Alete.source.species.mollusca.scaphopoda.dentalioidea;
...
/**
 * Signal Processing for Family: Dentalioidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/scaphopoda/dentalioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17770; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/scaphopoda/dentalioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Scaphopoda"); ps.setString(3, "Dentalioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dentalioidea_audio", "species.mollusca.scaphopoda.dentalioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dentalioidea_data", "species.mollusca.scaphopoda.dentalioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dentalioidea_graphics", "species.mollusca.scaphopoda.dentalioidea.graphics.spectrum", sb.toString());
        }
    }
}