package presidential.Brarner.M.Alete.source.species.chordata.aves.ptilonorhynchidae;
...
/**
 * Signal Processing for Family: Ptilonorhynchidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/ptilonorhynchidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12317; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/ptilonorhynchidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Ptilonorhynchidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ptilonorhynchidae_audio", "species.chordata.aves.ptilonorhynchidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ptilonorhynchidae_data", "species.chordata.aves.ptilonorhynchidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ptilonorhynchidae_graphics", "species.chordata.aves.ptilonorhynchidae.graphics.spectrum", sb.toString());
        }
    }
}