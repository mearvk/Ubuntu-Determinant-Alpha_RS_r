package presidential.Brarner.M.Alete.source.species.annelida.clitellata.rhinodrilidae;
...
/**
 * Signal Processing for Family: Rhinodrilidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/clitellata/rhinodrilidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16579; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/clitellata/rhinodrilidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Clitellata"); ps.setString(3, "Rhinodrilidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rhinodrilidae_audio", "species.annelida.clitellata.rhinodrilidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rhinodrilidae_data", "species.annelida.clitellata.rhinodrilidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rhinodrilidae_graphics", "species.annelida.clitellata.rhinodrilidae.graphics.spectrum", sb.toString());
        }
    }
}