package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.abyssochrysoidea;
...
/**
 * Signal Processing for Family: Abyssochrysoidea
 * <p>Phylum: Mollusca | Class: Caenogastropoda | Order: Littorinida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/abyssochrysoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17171; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/abyssochrysoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Abyssochrysoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("abyssochrysoidea_audio", "species.mollusca.caenogastropoda.abyssochrysoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("abyssochrysoidea_data", "species.mollusca.caenogastropoda.abyssochrysoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("abyssochrysoidea_graphics", "species.mollusca.caenogastropoda.abyssochrysoidea.graphics.spectrum", sb.toString());
        }
    }
}