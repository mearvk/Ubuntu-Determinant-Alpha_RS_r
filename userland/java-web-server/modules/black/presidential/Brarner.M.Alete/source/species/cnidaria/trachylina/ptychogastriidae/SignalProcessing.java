package presidential.Brarner.M.Alete.source.species.cnidaria.trachylina.ptychogastriidae;
...
/**
 * Signal Processing for Family: Ptychogastriidae
 * <p>Phylum: Cnidaria | Class: Trachylina | Order: Trachymedusae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/trachylina/ptychogastriidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11235; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/trachylina/ptychogastriidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Trachylina"); ps.setString(3, "Ptychogastriidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ptychogastriidae_audio", "species.cnidaria.trachylina.ptychogastriidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ptychogastriidae_data", "species.cnidaria.trachylina.ptychogastriidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ptychogastriidae_graphics", "species.cnidaria.trachylina.ptychogastriidae.graphics.spectrum", sb.toString());
        }
    }
}