package presidential.Brarner.M.Alete.source.species.mollusca.caudofoveata.prochaetodermatidae;
...
/**
 * Signal Processing for Family: Prochaetodermatidae
 * <p>Phylum: Mollusca | Class: Caudofoveata | Order: Chaetodermatida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caudofoveata/prochaetodermatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17071; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caudofoveata/prochaetodermatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caudofoveata"); ps.setString(3, "Prochaetodermatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("prochaetodermatidae_audio", "species.mollusca.caudofoveata.prochaetodermatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("prochaetodermatidae_data", "species.mollusca.caudofoveata.prochaetodermatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("prochaetodermatidae_graphics", "species.mollusca.caudofoveata.prochaetodermatidae.graphics.spectrum", sb.toString());
        }
    }
}