package presidential.Brarner.M.Alete.source.species.chordata.teleostei.scombrolabracidae;
...
/**
 * Signal Processing for Family: Scombrolabracidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Scombroidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/scombrolabracidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11680; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/scombrolabracidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Scombrolabracidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("scombrolabracidae_audio", "species.chordata.teleostei.scombrolabracidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("scombrolabracidae_data", "species.chordata.teleostei.scombrolabracidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("scombrolabracidae_graphics", "species.chordata.teleostei.scombrolabracidae.graphics.spectrum", sb.toString());
        }
    }
}