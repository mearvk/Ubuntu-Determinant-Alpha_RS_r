package presidential.Brarner.M.Alete.source.species.mollusca.protobranchia.lametilidae;
...
/**
 * Signal Processing for Family: Lametilidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/protobranchia/lametilidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17053; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/protobranchia/lametilidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Protobranchia"); ps.setString(3, "Lametilidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lametilidae_audio", "species.mollusca.protobranchia.lametilidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lametilidae_data", "species.mollusca.protobranchia.lametilidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lametilidae_graphics", "species.mollusca.protobranchia.lametilidae.graphics.spectrum", sb.toString());
        }
    }
}