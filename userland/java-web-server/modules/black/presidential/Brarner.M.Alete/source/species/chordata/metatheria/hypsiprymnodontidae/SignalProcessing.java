package presidential.Brarner.M.Alete.source.species.chordata.metatheria.hypsiprymnodontidae;
...
/**
 * Signal Processing for Family: Hypsiprymnodontidae
 * <p>Phylum: Chordata | Class: Metatheria | Order: Macropodiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/metatheria/hypsiprymnodontidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12544; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/metatheria/hypsiprymnodontidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Metatheria"); ps.setString(3, "Hypsiprymnodontidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hypsiprymnodontidae_audio", "species.chordata.metatheria.hypsiprymnodontidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hypsiprymnodontidae_data", "species.chordata.metatheria.hypsiprymnodontidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hypsiprymnodontidae_graphics", "species.chordata.metatheria.hypsiprymnodontidae.graphics.spectrum", sb.toString());
        }
    }
}