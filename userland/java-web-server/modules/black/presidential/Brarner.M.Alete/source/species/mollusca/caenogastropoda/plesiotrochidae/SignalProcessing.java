package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.plesiotrochidae;
...
/**
 * Signal Processing for Family: Plesiotrochidae
 * <p>Phylum: Mollusca | Class: Caenogastropoda | Order: Campanilida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/plesiotrochidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17140; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/plesiotrochidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Plesiotrochidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("plesiotrochidae_audio", "species.mollusca.caenogastropoda.plesiotrochidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("plesiotrochidae_data", "species.mollusca.caenogastropoda.plesiotrochidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("plesiotrochidae_graphics", "species.mollusca.caenogastropoda.plesiotrochidae.graphics.spectrum", sb.toString());
        }
    }
}