package presidential.Brarner.M.Alete.source.species.mollusca.heteroconchia.hemidonacoidea;
...
/**
 * Signal Processing for Family: Hemidonacoidea
 * <p>Phylum: Mollusca | Class: Heteroconchia | Order: Venerida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heteroconchia/hemidonacoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16993; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heteroconchia/hemidonacoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heteroconchia"); ps.setString(3, "Hemidonacoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hemidonacoidea_audio", "species.mollusca.heteroconchia.hemidonacoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hemidonacoidea_data", "species.mollusca.heteroconchia.hemidonacoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hemidonacoidea_graphics", "species.mollusca.heteroconchia.hemidonacoidea.graphics.spectrum", sb.toString());
        }
    }
}