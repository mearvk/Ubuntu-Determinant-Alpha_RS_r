package presidential.Brarner.M.Alete.source.species.cnidaria.hydroidolina.pyrostephidae;
...
/**
 * Signal Processing for Family: Pyrostephidae
 * <p>Phylum: Cnidaria | Class: Hydroidolina | Order: Physonectae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hydroidolina/pyrostephidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11219; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hydroidolina/pyrostephidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hydroidolina"); ps.setString(3, "Pyrostephidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pyrostephidae_audio", "species.cnidaria.hydroidolina.pyrostephidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pyrostephidae_data", "species.cnidaria.hydroidolina.pyrostephidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pyrostephidae_graphics", "species.cnidaria.hydroidolina.pyrostephidae.graphics.spectrum", sb.toString());
        }
    }
}