package presidential.Brarner.M.Alete.source.species.nemertea.palaeonemertea;
...
/**
 * Signal Processing for Phylum: Nemertea, Class: Palaeonemertea
 * <p>Families: 3</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nemertea/palaeonemertea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17835; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nemertea/palaeonemertea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nemertea"); ps.setString(2, "Palaeonemertea"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("nemertea_palaeonemertea_audio", "species.nemertea.palaeonemertea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("nemertea_palaeonemertea_data", "species.nemertea.palaeonemertea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("nemertea_palaeonemertea_graphics", "species.nemertea.palaeonemertea.graphics.spectrum", sb.toString());
        }
    }
}