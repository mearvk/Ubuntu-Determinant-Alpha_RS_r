package presidential.Brarner.M.Alete.source.species.mollusca.coleoidea.opisthoteuthidae;
...
/**
 * Signal Processing for Family: Opisthoteuthidae
 * <p>Phylum: Mollusca | Class: Coleoidea | Order: Cirrina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/coleoidea/opisthoteuthidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17105; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/coleoidea/opisthoteuthidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Coleoidea"); ps.setString(3, "Opisthoteuthidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("opisthoteuthidae_audio", "species.mollusca.coleoidea.opisthoteuthidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("opisthoteuthidae_data", "species.mollusca.coleoidea.opisthoteuthidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("opisthoteuthidae_graphics", "species.mollusca.coleoidea.opisthoteuthidae.graphics.spectrum", sb.toString());
        }
    }
}