package presidential.Brarner.M.Alete.source.species.chordata.teleostei.alepocephaloidea;
...
/**
 * Signal Processing for Family: Alepocephaloidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/alepocephaloidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11952; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/alepocephaloidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Alepocephaloidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("alepocephaloidea_audio", "species.chordata.teleostei.alepocephaloidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("alepocephaloidea_data", "species.chordata.teleostei.alepocephaloidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("alepocephaloidea_graphics", "species.chordata.teleostei.alepocephaloidea.graphics.spectrum", sb.toString());
        }
    }
}