package presidential.Brarner.M.Alete.source.species.chordata.holocephali.chimaeridae;
...
/**
 * Signal Processing for Family: Chimaeridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/holocephali/chimaeridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12037; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/holocephali/chimaeridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Holocephali"); ps.setString(3, "Chimaeridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chimaeridae_audio", "species.chordata.holocephali.chimaeridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chimaeridae_data", "species.chordata.holocephali.chimaeridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chimaeridae_graphics", "species.chordata.holocephali.chimaeridae.graphics.spectrum", sb.toString());
        }
    }
}