package presidential.Brarner.M.Alete.source.species.annelida.polychaeta.endomyzostomatidae;
...
/**
 * Signal Processing for Family: Endomyzostomatidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/polychaeta/endomyzostomatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16637; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/polychaeta/endomyzostomatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Polychaeta"); ps.setString(3, "Endomyzostomatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("endomyzostomatidae_audio", "species.annelida.polychaeta.endomyzostomatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("endomyzostomatidae_data", "species.annelida.polychaeta.endomyzostomatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("endomyzostomatidae_graphics", "species.annelida.polychaeta.endomyzostomatidae.graphics.spectrum", sb.toString());
        }
    }
}