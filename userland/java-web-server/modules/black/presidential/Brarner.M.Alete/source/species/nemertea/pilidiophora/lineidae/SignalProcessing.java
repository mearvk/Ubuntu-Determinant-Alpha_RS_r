package presidential.Brarner.M.Alete.source.species.nemertea.pilidiophora.lineidae;
...
/**
 * Signal Processing for Family: Lineidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nemertea/pilidiophora/lineidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17831; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nemertea/pilidiophora/lineidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nemertea"); ps.setString(2, "Pilidiophora"); ps.setString(3, "Lineidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lineidae_audio", "species.nemertea.pilidiophora.lineidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lineidae_data", "species.nemertea.pilidiophora.lineidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lineidae_graphics", "species.nemertea.pilidiophora.lineidae.graphics.spectrum", sb.toString());
        }
    }
}