package presidential.Brarner.M.Alete.source.species.porifera.calcaronea.achramorphidae;
...
/**
 * Signal Processing for Family: Achramorphidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/calcaronea/achramorphidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11315; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/calcaronea/achramorphidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Calcaronea"); ps.setString(3, "Achramorphidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("achramorphidae_audio", "species.porifera.calcaronea.achramorphidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("achramorphidae_data", "species.porifera.calcaronea.achramorphidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("achramorphidae_graphics", "species.porifera.calcaronea.achramorphidae.graphics.spectrum", sb.toString());
        }
    }
}