package presidential.Brarner.M.Alete.source.species.cnidaria.myxosporea.sphaerosporidae;
...
/**
 * Signal Processing for Family: Sphaerosporidae
 * <p>Phylum: Cnidaria | Class: Myxosporea | Order: Bivalvulida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/myxosporea/sphaerosporidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11275; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/myxosporea/sphaerosporidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Myxosporea"); ps.setString(3, "Sphaerosporidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sphaerosporidae_audio", "species.cnidaria.myxosporea.sphaerosporidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sphaerosporidae_data", "species.cnidaria.myxosporea.sphaerosporidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sphaerosporidae_graphics", "species.cnidaria.myxosporea.sphaerosporidae.graphics.spectrum", sb.toString());
        }
    }
}