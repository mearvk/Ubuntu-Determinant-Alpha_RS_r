package presidential.Brarner.M.Alete.source.species.nematoda.chromadoria.desmoscolecidae;
...
/**
 * Signal Processing for Family: Desmoscolecidae
 * <p>Phylum: Nematoda | Class: Chromadoria | Order: Desmoscolecida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/chromadoria/desmoscolecidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16430; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/chromadoria/desmoscolecidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Chromadoria"); ps.setString(3, "Desmoscolecidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("desmoscolecidae_audio", "species.nematoda.chromadoria.desmoscolecidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("desmoscolecidae_data", "species.nematoda.chromadoria.desmoscolecidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("desmoscolecidae_graphics", "species.nematoda.chromadoria.desmoscolecidae.graphics.spectrum", sb.toString());
        }
    }
}