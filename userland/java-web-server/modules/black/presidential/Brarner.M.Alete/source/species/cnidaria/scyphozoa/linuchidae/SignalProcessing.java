package presidential.Brarner.M.Alete.source.species.cnidaria.scyphozoa.linuchidae;
...
/**
 * Signal Processing for Family: Linuchidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/scyphozoa/linuchidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11243; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/scyphozoa/linuchidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Scyphozoa"); ps.setString(3, "Linuchidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("linuchidae_audio", "species.cnidaria.scyphozoa.linuchidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("linuchidae_data", "species.cnidaria.scyphozoa.linuchidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("linuchidae_graphics", "species.cnidaria.scyphozoa.linuchidae.graphics.spectrum", sb.toString());
        }
    }
}