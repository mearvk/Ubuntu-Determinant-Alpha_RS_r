package presidential.Brarner.M.Alete.source.species.porifera.calcinea.soleneiscidae;
...
/**
 * Signal Processing for Family: Soleneiscidae
 * <p>Phylum: Porifera | Class: Calcinea | Order: Clathrinida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/calcinea/soleneiscidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11332; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/calcinea/soleneiscidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Calcinea"); ps.setString(3, "Soleneiscidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("soleneiscidae_audio", "species.porifera.calcinea.soleneiscidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("soleneiscidae_data", "species.porifera.calcinea.soleneiscidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("soleneiscidae_graphics", "species.porifera.calcinea.soleneiscidae.graphics.spectrum", sb.toString());
        }
    }
}