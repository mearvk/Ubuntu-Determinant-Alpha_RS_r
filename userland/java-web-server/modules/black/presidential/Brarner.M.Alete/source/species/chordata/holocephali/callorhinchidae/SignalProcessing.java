package presidential.Brarner.M.Alete.source.species.chordata.holocephali.callorhinchidae;
...
/**
 * Signal Processing for Family: Callorhinchidae
 * <p>Phylum: Chordata | Class: Holocephali | Order: Chimaeroidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/holocephali/callorhinchidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12036; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/holocephali/callorhinchidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Holocephali"); ps.setString(3, "Callorhinchidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("callorhinchidae_audio", "species.chordata.holocephali.callorhinchidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("callorhinchidae_data", "species.chordata.holocephali.callorhinchidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("callorhinchidae_graphics", "species.chordata.holocephali.callorhinchidae.graphics.spectrum", sb.toString());
        }
    }
}