...
/**
 * Signal Processing for Family: Lophopodidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/phylactolaemata/lophopodidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16891; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/phylactolaemata/lophopodidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Phylactolaemata"); ps.setString(3, "Lophopodidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lophopodidae_audio", "species.bryozoa.phylactolaemata.lophopodidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lophopodidae_data", "species.bryozoa.phylactolaemata.lophopodidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lophopodidae_graphics", "species.bryozoa.phylactolaemata.lophopodidae.graphics.spectrum", sb.toString());
        }
    }
}