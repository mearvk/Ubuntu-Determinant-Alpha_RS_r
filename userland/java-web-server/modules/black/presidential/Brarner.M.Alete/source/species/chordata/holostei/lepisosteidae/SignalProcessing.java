...
/**
 * Signal Processing for Family: Lepisosteidae
 * <p>Phylum: Chordata | Class: Holostei | Order: Lepisosteiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/holostei/lepisosteidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11515; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/holostei/lepisosteidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Holostei"); ps.setString(3, "Lepisosteidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lepisosteidae_audio", "species.chordata.holostei.lepisosteidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lepisosteidae_data", "species.chordata.holostei.lepisosteidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lepisosteidae_graphics", "species.chordata.holostei.lepisosteidae.graphics.spectrum", sb.toString());
        }
    }
}