package presidential.Brarner.M.Alete.source.species.cnidaria.octocorallia.kophobelemnidae;
...
/**
 * Signal Processing for Family: Kophobelemnidae
 * <p>Phylum: Cnidaria | Class: Octocorallia | Order: Sessiliflorae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/octocorallia/kophobelemnidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11122; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/octocorallia/kophobelemnidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Octocorallia"); ps.setString(3, "Kophobelemnidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("kophobelemnidae_audio", "species.cnidaria.octocorallia.kophobelemnidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("kophobelemnidae_data", "species.cnidaria.octocorallia.kophobelemnidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("kophobelemnidae_graphics", "species.cnidaria.octocorallia.kophobelemnidae.graphics.spectrum", sb.toString());
        }
    }
}