package presidential.Brarner.M.Alete.source.species.nematoda.chromadorea.dracunculoidea;
...
/**
 * Signal Processing for Family: Dracunculoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/chromadorea/dracunculoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16324; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/chromadorea/dracunculoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Chromadorea"); ps.setString(3, "Dracunculoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dracunculoidea_audio", "species.nematoda.chromadorea.dracunculoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dracunculoidea_data", "species.nematoda.chromadorea.dracunculoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dracunculoidea_graphics", "species.nematoda.chromadorea.dracunculoidea.graphics.spectrum", sb.toString());
        }
    }
}