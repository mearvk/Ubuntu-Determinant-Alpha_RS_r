package presidential.Brarner.M.Alete.source.species.chordata.aves.musophagidae;
...
/**
 * Signal Processing for Family: Musophagidae
 * <p>Phylum: Chordata | Class: Aves | Order: Musophagiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/musophagidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12199; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/musophagidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Musophagidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("musophagidae_audio", "species.chordata.aves.musophagidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("musophagidae_data", "species.chordata.aves.musophagidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("musophagidae_graphics", "species.chordata.aves.musophagidae.graphics.spectrum", sb.toString());
        }
    }
}