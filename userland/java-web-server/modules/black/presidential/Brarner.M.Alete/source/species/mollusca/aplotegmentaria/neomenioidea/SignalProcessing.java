package presidential.Brarner.M.Alete.source.species.mollusca.aplotegmentaria.neomenioidea;
...
/**
 * Signal Processing for Family: Neomenioidea
 * <p>Phylum: Mollusca | Class: Aplotegmentaria | Order: Neomeniida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/aplotegmentaria/neomenioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17788; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/aplotegmentaria/neomenioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Aplotegmentaria"); ps.setString(3, "Neomenioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("neomenioidea_audio", "species.mollusca.aplotegmentaria.neomenioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("neomenioidea_data", "species.mollusca.aplotegmentaria.neomenioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("neomenioidea_graphics", "species.mollusca.aplotegmentaria.neomenioidea.graphics.spectrum", sb.toString());
        }
    }
}