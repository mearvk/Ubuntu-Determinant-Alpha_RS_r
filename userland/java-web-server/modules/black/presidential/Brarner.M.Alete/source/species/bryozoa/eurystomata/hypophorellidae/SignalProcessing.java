package presidential.Brarner.M.Alete.source.species.bryozoa.eurystomata.hypophorellidae;
...
/**
 * Signal Processing for Family: Hypophorellidae
 * <p>Phylum: Bryozoa | Class: Eurystomata | Order: Stolonifera</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/eurystomata/hypophorellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16857; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/eurystomata/hypophorellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Eurystomata"); ps.setString(3, "Hypophorellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hypophorellidae_audio", "species.bryozoa.eurystomata.hypophorellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hypophorellidae_data", "species.bryozoa.eurystomata.hypophorellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hypophorellidae_graphics", "species.bryozoa.eurystomata.hypophorellidae.graphics.spectrum", sb.toString());
        }
    }
}