package presidential.Brarner.M.Alete.source.species.mollusca.monoplacophora.tryblidioidea;
...
/**
 * Signal Processing for Family: Tryblidioidea
 * <p>Phylum: Mollusca | Class: Monoplacophora | Order: Tryblidiida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/monoplacophora/tryblidioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17757; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/monoplacophora/tryblidioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Monoplacophora"); ps.setString(3, "Tryblidioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tryblidioidea_audio", "species.mollusca.monoplacophora.tryblidioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tryblidioidea_data", "species.mollusca.monoplacophora.tryblidioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tryblidioidea_graphics", "species.mollusca.monoplacophora.tryblidioidea.graphics.spectrum", sb.toString());
        }
    }
}