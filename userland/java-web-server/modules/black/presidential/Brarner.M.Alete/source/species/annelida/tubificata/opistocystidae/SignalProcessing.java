package presidential.Brarner.M.Alete.source.species.annelida.tubificata.opistocystidae;
...
/**
 * Signal Processing for Family: Opistocystidae
 * <p>Phylum: Annelida | Class: Tubificata | Order: Tubificida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/tubificata/opistocystidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16619; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/tubificata/opistocystidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Tubificata"); ps.setString(3, "Opistocystidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("opistocystidae_audio", "species.annelida.tubificata.opistocystidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("opistocystidae_data", "species.annelida.tubificata.opistocystidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("opistocystidae_graphics", "species.annelida.tubificata.opistocystidae.graphics.spectrum", sb.toString());
        }
    }
}