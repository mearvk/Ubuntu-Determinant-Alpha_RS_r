package presidential.Brarner.M.Alete.source.species.cnidaria.discomedusae.lychnorhizidae;
...
/**
 * Signal Processing for Family: Lychnorhizidae
 * <p>Phylum: Cnidaria | Class: Discomedusae | Order: Daktyliophorae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/discomedusae/lychnorhizidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11254; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/discomedusae/lychnorhizidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Discomedusae"); ps.setString(3, "Lychnorhizidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lychnorhizidae_audio", "species.cnidaria.discomedusae.lychnorhizidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lychnorhizidae_data", "species.cnidaria.discomedusae.lychnorhizidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lychnorhizidae_graphics", "species.cnidaria.discomedusae.lychnorhizidae.graphics.spectrum", sb.toString());
        }
    }
}