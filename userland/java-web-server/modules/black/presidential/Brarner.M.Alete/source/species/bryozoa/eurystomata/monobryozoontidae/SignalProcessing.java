package presidential.Brarner.M.Alete.source.species.bryozoa.eurystomata.monobryozoontidae;
...
/**
 * Signal Processing for Family: Monobryozoontidae
 * <p>Phylum: Bryozoa | Class: Eurystomata | Order: Carnosa</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/eurystomata/monobryozoontidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16849; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/eurystomata/monobryozoontidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Eurystomata"); ps.setString(3, "Monobryozoontidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("monobryozoontidae_audio", "species.bryozoa.eurystomata.monobryozoontidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("monobryozoontidae_data", "species.bryozoa.eurystomata.monobryozoontidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("monobryozoontidae_graphics", "species.bryozoa.eurystomata.monobryozoontidae.graphics.spectrum", sb.toString());
        }
    }
}