package presidential.Brarner.M.Alete.source.species.bryozoa.eurystomata.conescharellinidae;
...
/**
 * Signal Processing for Family: Conescharellinidae
 * <p>Phylum: Bryozoa | Class: Eurystomata | Order: Ascophora</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/eurystomata/conescharellinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16801; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/eurystomata/conescharellinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Eurystomata"); ps.setString(3, "Conescharellinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("conescharellinidae_audio", "species.bryozoa.eurystomata.conescharellinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("conescharellinidae_data", "species.bryozoa.eurystomata.conescharellinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("conescharellinidae_graphics", "species.bryozoa.eurystomata.conescharellinidae.graphics.spectrum", sb.toString());
        }
    }
}