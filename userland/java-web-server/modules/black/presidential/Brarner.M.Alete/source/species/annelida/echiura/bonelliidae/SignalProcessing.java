package presidential.Brarner.M.Alete.source.species.annelida.echiura.bonelliidae;
...
/**
 * Signal Processing for Family: Bonelliidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/echiura/bonelliidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16642; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/echiura/bonelliidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Echiura"); ps.setString(3, "Bonelliidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("bonelliidae_audio", "species.annelida.echiura.bonelliidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("bonelliidae_data", "species.annelida.echiura.bonelliidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("bonelliidae_graphics", "species.annelida.echiura.bonelliidae.graphics.spectrum", sb.toString());
        }
    }
}