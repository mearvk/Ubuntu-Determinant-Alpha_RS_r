package presidential.Brarner.M.Alete.source.species.cnidaria.discomedusae.versurigidae;
...
/**
 * Signal Processing for Family: Versurigidae
 * <p>Phylum: Cnidaria | Class: Discomedusae | Order: Kolpophorae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/discomedusae/versurigidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11258; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/discomedusae/versurigidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Discomedusae"); ps.setString(3, "Versurigidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("versurigidae_audio", "species.cnidaria.discomedusae.versurigidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("versurigidae_data", "species.cnidaria.discomedusae.versurigidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("versurigidae_graphics", "species.cnidaria.discomedusae.versurigidae.graphics.spectrum", sb.toString());
        }
    }
}