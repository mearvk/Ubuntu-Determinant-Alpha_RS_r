package presidential.Brarner.M.Alete.source.species.chordata.aves.polioptilidae;
...
/**
 * Signal Processing for Family: Polioptilidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/polioptilidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12311; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/polioptilidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Polioptilidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("polioptilidae_audio", "species.chordata.aves.polioptilidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("polioptilidae_data", "species.chordata.aves.polioptilidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("polioptilidae_graphics", "species.chordata.aves.polioptilidae.graphics.spectrum", sb.toString());
        }
    }
}