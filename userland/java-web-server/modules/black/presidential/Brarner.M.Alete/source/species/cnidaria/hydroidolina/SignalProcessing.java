package presidential.Brarner.M.Alete.source.species.cnidaria.hydroidolina;
...
/**
 * Signal Processing for Phylum: Cnidaria, Class: Hydroidolina
 * <p>Families: 83</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hydroidolina/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11137; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hydroidolina";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hydroidolina"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cnidaria_hydroidolina_audio", "species.cnidaria.hydroidolina.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cnidaria_hydroidolina_data", "species.cnidaria.hydroidolina.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cnidaria_hydroidolina_graphics", "species.cnidaria.hydroidolina.graphics.spectrum", sb.toString());
        }
    }
}