package presidential.Brarner.M.Alete.source.species.mollusca.caudofoveata;
...
/**
 * Signal Processing for Phylum: Mollusca, Class: Caudofoveata
 * <p>Families: 3</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caudofoveata/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17068; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caudofoveata";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caudofoveata"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mollusca_caudofoveata_audio", "species.mollusca.caudofoveata.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mollusca_caudofoveata_data", "species.mollusca.caudofoveata.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mollusca_caudofoveata_graphics", "species.mollusca.caudofoveata.graphics.spectrum", sb.toString());
        }
    }
}