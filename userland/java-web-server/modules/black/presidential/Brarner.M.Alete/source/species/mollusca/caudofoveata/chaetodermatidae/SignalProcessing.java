package presidential.Brarner.M.Alete.source.species.mollusca.caudofoveata.chaetodermatidae;
...
/**
 * Signal Processing for Family: Chaetodermatidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caudofoveata/chaetodermatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17069; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caudofoveata/chaetodermatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caudofoveata"); ps.setString(3, "Chaetodermatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chaetodermatidae_audio", "species.mollusca.caudofoveata.chaetodermatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chaetodermatidae_data", "species.mollusca.caudofoveata.chaetodermatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chaetodermatidae_graphics", "species.mollusca.caudofoveata.chaetodermatidae.graphics.spectrum", sb.toString());
        }
    }
}