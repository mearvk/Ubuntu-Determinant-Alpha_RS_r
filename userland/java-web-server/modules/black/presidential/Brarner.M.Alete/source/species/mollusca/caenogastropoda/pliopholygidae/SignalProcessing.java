package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.pliopholygidae;
...
/**
 * Signal Processing for Family: Pliopholygidae
 * <p>Phylum: Mollusca | Class: Caenogastropoda | Order: Viviparida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/pliopholygidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17238; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/pliopholygidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Pliopholygidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pliopholygidae_audio", "species.mollusca.caenogastropoda.pliopholygidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pliopholygidae_data", "species.mollusca.caenogastropoda.pliopholygidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pliopholygidae_graphics", "species.mollusca.caenogastropoda.pliopholygidae.graphics.spectrum", sb.toString());
        }
    }
}