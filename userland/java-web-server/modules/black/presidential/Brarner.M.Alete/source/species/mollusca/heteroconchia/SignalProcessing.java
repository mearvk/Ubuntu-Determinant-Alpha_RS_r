package presidential.Brarner.M.Alete.source.species.mollusca.heteroconchia;
...
/**
 * Signal Processing for Phylum: Mollusca, Class: Heteroconchia
 * <p>Families: 110</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heteroconchia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16898; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heteroconchia";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heteroconchia"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mollusca_heteroconchia_audio", "species.mollusca.heteroconchia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mollusca_heteroconchia_data", "species.mollusca.heteroconchia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mollusca_heteroconchia_graphics", "species.mollusca.heteroconchia.graphics.spectrum", sb.toString());
        }
    }
}