package presidential.Brarner.M.Alete.source.species.chordata.aves.phylloscopidae;
...
/**
 * Signal Processing for Family: Phylloscopidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/phylloscopidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12302; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/phylloscopidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Phylloscopidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("phylloscopidae_audio", "species.chordata.aves.phylloscopidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("phylloscopidae_data", "species.chordata.aves.phylloscopidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("phylloscopidae_graphics", "species.chordata.aves.phylloscopidae.graphics.spectrum", sb.toString());
        }
    }
}