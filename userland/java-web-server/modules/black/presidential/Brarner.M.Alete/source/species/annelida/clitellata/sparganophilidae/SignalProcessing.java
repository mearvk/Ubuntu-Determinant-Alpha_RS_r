package presidential.Brarner.M.Alete.source.species.annelida.clitellata.sparganophilidae;
...
/**
 * Signal Processing for Family: Sparganophilidae
 * <p>Phylum: Annelida | Class: Clitellata | Order: Crassiclitellata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/clitellata/sparganophilidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16580; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/clitellata/sparganophilidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Clitellata"); ps.setString(3, "Sparganophilidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sparganophilidae_audio", "species.annelida.clitellata.sparganophilidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sparganophilidae_data", "species.annelida.clitellata.sparganophilidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sparganophilidae_graphics", "species.annelida.clitellata.sparganophilidae.graphics.spectrum", sb.toString());
        }
    }
}