package presidential.Brarner.M.Alete.source.species.mollusca.coleoidea.sepiadariidae;
...
/**
 * Signal Processing for Family: Sepiadariidae
 * <p>Phylum: Mollusca | Class: Coleoidea | Order: Sepiida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/coleoidea/sepiadariidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17073; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/coleoidea/sepiadariidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Coleoidea"); ps.setString(3, "Sepiadariidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sepiadariidae_audio", "species.mollusca.coleoidea.sepiadariidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sepiadariidae_data", "species.mollusca.coleoidea.sepiadariidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sepiadariidae_graphics", "species.mollusca.coleoidea.sepiadariidae.graphics.spectrum", sb.toString());
        }
    }
}