package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.haplotrematidae;
...
/**
 * Signal Processing for Family: Haplotrematidae
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Oleacinoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/haplotrematidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17627; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/haplotrematidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Haplotrematidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("haplotrematidae_audio", "species.mollusca.heterobranchia.haplotrematidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("haplotrematidae_data", "species.mollusca.heterobranchia.haplotrematidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("haplotrematidae_graphics", "species.mollusca.heterobranchia.haplotrematidae.graphics.spectrum", sb.toString());
        }
    }
}