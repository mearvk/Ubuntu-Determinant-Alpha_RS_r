package presidential.Brarner.M.Alete.source.species.cnidaria.hydroidolina.monobrachiidae;
...
/**
 * Signal Processing for Family: Monobrachiidae
 * <p>Phylum: Cnidaria | Class: Hydroidolina | Order: Anthoathecatae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hydroidolina/monobrachiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11138; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hydroidolina/monobrachiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hydroidolina"); ps.setString(3, "Monobrachiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("monobrachiidae_audio", "species.cnidaria.hydroidolina.monobrachiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("monobrachiidae_data", "species.cnidaria.hydroidolina.monobrachiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("monobrachiidae_graphics", "species.cnidaria.hydroidolina.monobrachiidae.graphics.spectrum", sb.toString());
        }
    }
}