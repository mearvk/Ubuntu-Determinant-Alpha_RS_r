package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia;
...
/**
 * Signal Processing for Phylum: Mollusca, Class: Heterobranchia
 * <p>Families: 359</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17326; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mollusca_heterobranchia_audio", "species.mollusca.heterobranchia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mollusca_heterobranchia_data", "species.mollusca.heterobranchia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mollusca_heterobranchia_graphics", "species.mollusca.heterobranchia.graphics.spectrum", sb.toString());
        }
    }
}