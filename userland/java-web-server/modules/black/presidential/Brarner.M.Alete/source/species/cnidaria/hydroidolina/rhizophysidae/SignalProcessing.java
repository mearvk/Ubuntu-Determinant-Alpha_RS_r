package presidential.Brarner.M.Alete.source.species.cnidaria.hydroidolina.rhizophysidae;
...
/**
 * Signal Processing for Family: Rhizophysidae
 * <p>Phylum: Cnidaria | Class: Hydroidolina | Order: Cystonectae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hydroidolina/rhizophysidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11213; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hydroidolina/rhizophysidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hydroidolina"); ps.setString(3, "Rhizophysidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rhizophysidae_audio", "species.cnidaria.hydroidolina.rhizophysidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rhizophysidae_data", "species.cnidaria.hydroidolina.rhizophysidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rhizophysidae_graphics", "species.cnidaria.hydroidolina.rhizophysidae.graphics.spectrum", sb.toString());
        }
    }
}