...
/**
 * Signal Processing for Family: Tetrastemmatidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nemertea/hoplonemertea/tetrastemmatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17824; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nemertea/hoplonemertea/tetrastemmatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nemertea"); ps.setString(2, "Hoplonemertea"); ps.setString(3, "Tetrastemmatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tetrastemmatidae_audio", "species.nemertea.hoplonemertea.tetrastemmatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tetrastemmatidae_data", "species.nemertea.hoplonemertea.tetrastemmatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tetrastemmatidae_graphics", "species.nemertea.hoplonemertea.tetrastemmatidae.graphics.spectrum", sb.toString());
        }
    }
}