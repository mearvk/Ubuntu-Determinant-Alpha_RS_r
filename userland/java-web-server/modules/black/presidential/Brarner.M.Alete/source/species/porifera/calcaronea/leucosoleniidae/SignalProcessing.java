package presidential.Brarner.M.Alete.source.species.porifera.calcaronea.leucosoleniidae;
...
/**
 * Signal Processing for Family: Leucosoleniidae
 * <p>Phylum: Porifera | Class: Calcaronea | Order: Leucosolenida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/calcaronea/leucosoleniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11321; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/calcaronea/leucosoleniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Calcaronea"); ps.setString(3, "Leucosoleniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("leucosoleniidae_audio", "species.porifera.calcaronea.leucosoleniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("leucosoleniidae_data", "species.porifera.calcaronea.leucosoleniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("leucosoleniidae_graphics", "species.porifera.calcaronea.leucosoleniidae.graphics.spectrum", sb.toString());
        }
    }
}