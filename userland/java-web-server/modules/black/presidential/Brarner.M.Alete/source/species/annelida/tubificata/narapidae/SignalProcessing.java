package presidential.Brarner.M.Alete.source.species.annelida.tubificata.narapidae;
...
/**
 * Signal Processing for Family: Narapidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/tubificata/narapidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16618; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/tubificata/narapidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Tubificata"); ps.setString(3, "Narapidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("narapidae_audio", "species.annelida.tubificata.narapidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("narapidae_data", "species.annelida.tubificata.narapidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("narapidae_graphics", "species.annelida.tubificata.narapidae.graphics.spectrum", sb.toString());
        }
    }
}