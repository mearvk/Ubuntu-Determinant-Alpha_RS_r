package presidential.Brarner.M.Alete.source.species.chordata.aves.nesospingidae;
...
/**
 * Signal Processing for Family: Nesospingidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/nesospingidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12279; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/nesospingidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Nesospingidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("nesospingidae_audio", "species.chordata.aves.nesospingidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("nesospingidae_data", "species.chordata.aves.nesospingidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("nesospingidae_graphics", "species.chordata.aves.nesospingidae.graphics.spectrum", sb.toString());
        }
    }
}