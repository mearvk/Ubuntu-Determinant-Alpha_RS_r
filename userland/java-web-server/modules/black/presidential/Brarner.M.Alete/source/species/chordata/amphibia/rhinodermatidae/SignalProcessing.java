package presidential.Brarner.M.Alete.source.species.chordata.amphibia.rhinodermatidae;
...
/**
 * Signal Processing for Family: Rhinodermatidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/amphibia/rhinodermatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12093; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/amphibia/rhinodermatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Amphibia"); ps.setString(3, "Rhinodermatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rhinodermatidae_audio", "species.chordata.amphibia.rhinodermatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rhinodermatidae_data", "species.chordata.amphibia.rhinodermatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rhinodermatidae_graphics", "species.chordata.amphibia.rhinodermatidae.graphics.spectrum", sb.toString());
        }
    }
}