package presidential.Brarner.M.Alete.source.species.mollusca.neoloricata.schizochitonidae;
...
/**
 * Signal Processing for Family: Schizochitonidae
 * <p>Phylum: Mollusca | Class: Neoloricata | Order: Chitonina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/neoloricata/schizochitonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17766; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/neoloricata/schizochitonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Neoloricata"); ps.setString(3, "Schizochitonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("schizochitonidae_audio", "species.mollusca.neoloricata.schizochitonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("schizochitonidae_data", "species.mollusca.neoloricata.schizochitonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("schizochitonidae_graphics", "species.mollusca.neoloricata.schizochitonidae.graphics.spectrum", sb.toString());
        }
    }
}