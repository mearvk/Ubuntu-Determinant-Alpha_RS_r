package presidential.Brarner.M.Alete.source.species.annelida.canalipalpata.ampharetidae;
...
/**
 * Signal Processing for Family: Ampharetidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/canalipalpata/ampharetidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16701; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/canalipalpata/ampharetidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Canalipalpata"); ps.setString(3, "Ampharetidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ampharetidae_audio", "species.annelida.canalipalpata.ampharetidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ampharetidae_data", "species.annelida.canalipalpata.ampharetidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ampharetidae_graphics", "species.annelida.canalipalpata.ampharetidae.graphics.spectrum", sb.toString());
        }
    }
}