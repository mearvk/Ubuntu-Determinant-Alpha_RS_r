package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.glacidorboidea;
...
/**
 * Signal Processing for Family: Glacidorboidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Glacidorbina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/glacidorboidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17518; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/glacidorboidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Glacidorboidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("glacidorboidea_audio", "species.mollusca.heterobranchia.glacidorboidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("glacidorboidea_data", "species.mollusca.heterobranchia.glacidorboidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("glacidorboidea_graphics", "species.mollusca.heterobranchia.glacidorboidea.graphics.spectrum", sb.toString());
        }
    }
}