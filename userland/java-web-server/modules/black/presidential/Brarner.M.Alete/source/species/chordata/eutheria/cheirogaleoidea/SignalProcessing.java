package presidential.Brarner.M.Alete.source.species.chordata.eutheria.cheirogaleoidea;
...
/**
 * Signal Processing for Family: Cheirogaleoidea
 * <p>Phylum: Chordata | Class: Eutheria | Order: Lemuriformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/cheirogaleoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12490; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/cheirogaleoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Cheirogaleoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cheirogaleoidea_audio", "species.chordata.eutheria.cheirogaleoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cheirogaleoidea_data", "species.chordata.eutheria.cheirogaleoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cheirogaleoidea_graphics", "species.chordata.eutheria.cheirogaleoidea.graphics.spectrum", sb.toString());
        }
    }
}