package presidential.Brarner.M.Alete.source.species.chordata.holocephali;
...
/**
 * Signal Processing for Phylum: Chordata, Class: Holocephali
 * <p>Families: 3</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/holocephali/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12035; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/holocephali";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Holocephali"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chordata_holocephali_audio", "species.chordata.holocephali.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chordata_holocephali_data", "species.chordata.holocephali.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chordata_holocephali_graphics", "species.chordata.holocephali.graphics.spectrum", sb.toString());
        }
    }
}