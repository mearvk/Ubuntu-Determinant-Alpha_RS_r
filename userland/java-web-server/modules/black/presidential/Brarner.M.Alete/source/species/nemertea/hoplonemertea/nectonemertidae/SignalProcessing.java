package presidential.Brarner.M.Alete.source.species.nemertea.hoplonemertea.nectonemertidae;
...
/**
 * Signal Processing for Family: Nectonemertidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nemertea/hoplonemertea/nectonemertidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17826; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nemertea/hoplonemertea/nectonemertidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nemertea"); ps.setString(2, "Hoplonemertea"); ps.setString(3, "Nectonemertidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("nectonemertidae_audio", "species.nemertea.hoplonemertea.nectonemertidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("nectonemertidae_data", "species.nemertea.hoplonemertea.nectonemertidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("nectonemertidae_graphics", "species.nemertea.hoplonemertea.nectonemertidae.graphics.spectrum", sb.toString());
        }
    }
}