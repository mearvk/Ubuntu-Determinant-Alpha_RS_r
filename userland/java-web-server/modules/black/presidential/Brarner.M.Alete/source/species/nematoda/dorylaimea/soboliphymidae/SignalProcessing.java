package presidential.Brarner.M.Alete.source.species.nematoda.dorylaimea.soboliphymidae;
...
/**
 * Signal Processing for Family: Soboliphymidae
 * <p>Phylum: Nematoda | Class: Dorylaimea | Order: Dioctophymatina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/dorylaimea/soboliphymidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16470; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/dorylaimea/soboliphymidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Dorylaimea"); ps.setString(3, "Soboliphymidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("soboliphymidae_audio", "species.nematoda.dorylaimea.soboliphymidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("soboliphymidae_data", "species.nematoda.dorylaimea.soboliphymidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("soboliphymidae_graphics", "species.nematoda.dorylaimea.soboliphymidae.graphics.spectrum", sb.toString());
        }
    }
}