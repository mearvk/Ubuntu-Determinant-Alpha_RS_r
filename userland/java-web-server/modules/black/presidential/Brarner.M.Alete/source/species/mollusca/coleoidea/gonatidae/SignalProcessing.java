package presidential.Brarner.M.Alete.source.species.mollusca.coleoidea.gonatidae;
...
/**
 * Signal Processing for Family: Gonatidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/coleoidea/gonatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17089; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/coleoidea/gonatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Coleoidea"); ps.setString(3, "Gonatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gonatidae_audio", "species.mollusca.coleoidea.gonatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gonatidae_data", "species.mollusca.coleoidea.gonatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gonatidae_graphics", "species.mollusca.coleoidea.gonatidae.graphics.spectrum", sb.toString());
        }
    }
}