package presidential.Brarner.M.Alete.source.species.chordata.aves.urocynchramidae;
...
/**
 * Signal Processing for Family: Urocynchramidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/urocynchramidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12341; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/urocynchramidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Urocynchramidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("urocynchramidae_audio", "species.chordata.aves.urocynchramidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("urocynchramidae_data", "species.chordata.aves.urocynchramidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("urocynchramidae_graphics", "species.chordata.aves.urocynchramidae.graphics.spectrum", sb.toString());
        }
    }
}