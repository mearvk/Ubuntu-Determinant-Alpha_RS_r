package presidential.Brarner.M.Alete.source.species.myxozoa.microsporea.pleistophoridae;
...
/**
 * Signal Processing for Family: Pleistophoridae
 * <p>Phylum: Myxozoa | Class: Microsporea | Order: Microsporida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/myxozoa/microsporea/pleistophoridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11303; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/myxozoa/microsporea/pleistophoridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Myxozoa"); ps.setString(2, "Microsporea"); ps.setString(3, "Pleistophoridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pleistophoridae_audio", "species.myxozoa.microsporea.pleistophoridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pleistophoridae_data", "species.myxozoa.microsporea.pleistophoridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pleistophoridae_graphics", "species.myxozoa.microsporea.pleistophoridae.graphics.spectrum", sb.toString());
        }
    }
}