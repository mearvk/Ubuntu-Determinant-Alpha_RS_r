package presidential.Brarner.M.Alete.source.species.chordata.eutheria.dipodoidea;
...
/**
 * Signal Processing for Family: Dipodoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/dipodoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12522; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/dipodoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Dipodoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dipodoidea_audio", "species.chordata.eutheria.dipodoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dipodoidea_data", "species.chordata.eutheria.dipodoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dipodoidea_graphics", "species.chordata.eutheria.dipodoidea.graphics.spectrum", sb.toString());
        }
    }
}