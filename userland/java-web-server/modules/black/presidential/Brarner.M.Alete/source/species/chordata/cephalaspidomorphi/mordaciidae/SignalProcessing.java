package presidential.Brarner.M.Alete.source.species.chordata.cephalaspidomorphi.mordaciidae;
...
/**
 * Signal Processing for Family: Mordaciidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/cephalaspidomorphi/mordaciidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11504; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/cephalaspidomorphi/mordaciidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Cephalaspidomorphi"); ps.setString(3, "Mordaciidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mordaciidae_audio", "species.chordata.cephalaspidomorphi.mordaciidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mordaciidae_data", "species.chordata.cephalaspidomorphi.mordaciidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mordaciidae_graphics", "species.chordata.cephalaspidomorphi.mordaciidae.graphics.spectrum", sb.toString());
        }
    }
}