package presidential.Brarner.M.Alete.source.species.nemertea.hoplonemertea.ototyphlonemertidae;
...
/**
 * Signal Processing for Family: Ototyphlonemertidae
 * <p>Phylum: Nemertea | Class: Hoplonemertea | Order: Monostilifera</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nemertea/hoplonemertea/ototyphlonemertidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17822; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nemertea/hoplonemertea/ototyphlonemertidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nemertea"); ps.setString(2, "Hoplonemertea"); ps.setString(3, "Ototyphlonemertidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ototyphlonemertidae_audio", "species.nemertea.hoplonemertea.ototyphlonemertidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ototyphlonemertidae_data", "species.nemertea.hoplonemertea.ototyphlonemertidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ototyphlonemertidae_graphics", "species.nemertea.hoplonemertea.ototyphlonemertidae.graphics.spectrum", sb.toString());
        }
    }
}