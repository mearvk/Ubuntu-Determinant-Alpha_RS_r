package presidential.Brarner.M.Alete.source.species.chordata.aves.mitrospingidae;
...
/**
 * Signal Processing for Family: Mitrospingidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/mitrospingidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12271; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/mitrospingidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Mitrospingidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mitrospingidae_audio", "species.chordata.aves.mitrospingidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mitrospingidae_data", "species.chordata.aves.mitrospingidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mitrospingidae_graphics", "species.chordata.aves.mitrospingidae.graphics.spectrum", sb.toString());
        }
    }
}