package presidential.Brarner.M.Alete.source.species.annelida.scolecida.opheliidae;
...
/**
 * Signal Processing for Family: Opheliidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/scolecida/opheliidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16719; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/scolecida/opheliidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Scolecida"); ps.setString(3, "Opheliidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("opheliidae_audio", "species.annelida.scolecida.opheliidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("opheliidae_data", "species.annelida.scolecida.opheliidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("opheliidae_graphics", "species.annelida.scolecida.opheliidae.graphics.spectrum", sb.toString());
        }
    }
}