package presidential.Brarner.M.Alete.source.species.chordata.teleostei.chlorophthalmidae;
...
/**
 * Signal Processing for Family: Chlorophthalmidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Chlorophthalmoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/chlorophthalmidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11796; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/chlorophthalmidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Chlorophthalmidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chlorophthalmidae_audio", "species.chordata.teleostei.chlorophthalmidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chlorophthalmidae_data", "species.chordata.teleostei.chlorophthalmidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chlorophthalmidae_graphics", "species.chordata.teleostei.chlorophthalmidae.graphics.spectrum", sb.toString());
        }
    }
}