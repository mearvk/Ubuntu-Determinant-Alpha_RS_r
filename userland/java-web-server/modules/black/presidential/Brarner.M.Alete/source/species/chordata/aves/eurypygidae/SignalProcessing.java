package presidential.Brarner.M.Alete.source.species.chordata.aves.eurypygidae;
...
/**
 * Signal Processing for Family: Eurypygidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/eurypygidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12182; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/eurypygidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Eurypygidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("eurypygidae_audio", "species.chordata.aves.eurypygidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("eurypygidae_data", "species.chordata.aves.eurypygidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("eurypygidae_graphics", "species.chordata.aves.eurypygidae.graphics.spectrum", sb.toString());
        }
    }
}