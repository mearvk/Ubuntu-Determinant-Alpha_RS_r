package presidential.Brarner.M.Alete.source.species.chordata.aves.haematopodidae;
...
/**
 * Signal Processing for Family: Haematopodidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/haematopodidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12159; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/haematopodidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Haematopodidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("haematopodidae_audio", "species.chordata.aves.haematopodidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("haematopodidae_data", "species.chordata.aves.haematopodidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("haematopodidae_graphics", "species.chordata.aves.haematopodidae.graphics.spectrum", sb.toString());
        }
    }
}