package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.bothriembryontidae;
...
/**
 * Signal Processing for Family: Bothriembryontidae
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Orthalicoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/bothriembryontidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17633; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/bothriembryontidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Bothriembryontidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("bothriembryontidae_audio", "species.mollusca.heterobranchia.bothriembryontidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("bothriembryontidae_data", "species.mollusca.heterobranchia.bothriembryontidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("bothriembryontidae_graphics", "species.mollusca.heterobranchia.bothriembryontidae.graphics.spectrum", sb.toString());
        }
    }
}