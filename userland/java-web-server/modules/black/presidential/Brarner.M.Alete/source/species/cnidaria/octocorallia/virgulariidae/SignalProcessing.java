package presidential.Brarner.M.Alete.source.species.cnidaria.octocorallia.virgulariidae;
...
/**
 * Signal Processing for Family: Virgulariidae
 * <p>Phylum: Cnidaria | Class: Octocorallia | Order: Subselliflorae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/octocorallia/virgulariidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11132; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/octocorallia/virgulariidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Octocorallia"); ps.setString(3, "Virgulariidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("virgulariidae_audio", "species.cnidaria.octocorallia.virgulariidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("virgulariidae_data", "species.cnidaria.octocorallia.virgulariidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("virgulariidae_graphics", "species.cnidaria.octocorallia.virgulariidae.graphics.spectrum", sb.toString());
        }
    }
}