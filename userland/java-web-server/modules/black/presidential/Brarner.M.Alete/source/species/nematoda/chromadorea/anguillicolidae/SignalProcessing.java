package presidential.Brarner.M.Alete.source.species.nematoda.chromadorea.anguillicolidae;
...
/**
 * Signal Processing for Family: Anguillicolidae
 * <p>Phylum: Nematoda | Class: Chromadorea | Order: Camallanida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/chromadorea/anguillicolidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16322; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/chromadorea/anguillicolidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Chromadorea"); ps.setString(3, "Anguillicolidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("anguillicolidae_audio", "species.nematoda.chromadorea.anguillicolidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("anguillicolidae_data", "species.nematoda.chromadorea.anguillicolidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("anguillicolidae_graphics", "species.nematoda.chromadorea.anguillicolidae.graphics.spectrum", sb.toString());
        }
    }
}