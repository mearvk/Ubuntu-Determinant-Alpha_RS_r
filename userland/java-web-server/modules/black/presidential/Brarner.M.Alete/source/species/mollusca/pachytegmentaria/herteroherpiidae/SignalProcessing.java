package presidential.Brarner.M.Alete.source.species.mollusca.pachytegmentaria.herteroherpiidae;
...
/**
 * Signal Processing for Family: Herteroherpiidae
 * <p>Phylum: Mollusca | Class: Pachytegmentaria | Order: Sterrofustia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/pachytegmentaria/herteroherpiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17813; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/pachytegmentaria/herteroherpiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Pachytegmentaria"); ps.setString(3, "Herteroherpiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("herteroherpiidae_audio", "species.mollusca.pachytegmentaria.herteroherpiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("herteroherpiidae_data", "species.mollusca.pachytegmentaria.herteroherpiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("herteroherpiidae_graphics", "species.mollusca.pachytegmentaria.herteroherpiidae.graphics.spectrum", sb.toString());
        }
    }
}