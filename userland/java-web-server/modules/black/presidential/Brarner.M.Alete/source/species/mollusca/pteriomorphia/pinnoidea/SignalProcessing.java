package presidential.Brarner.M.Alete.source.species.mollusca.pteriomorphia.pinnoidea;
...
/**
 * Signal Processing for Family: Pinnoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/pteriomorphia/pinnoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17041; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/pteriomorphia/pinnoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Pteriomorphia"); ps.setString(3, "Pinnoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pinnoidea_audio", "species.mollusca.pteriomorphia.pinnoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pinnoidea_data", "species.mollusca.pteriomorphia.pinnoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pinnoidea_graphics", "species.mollusca.pteriomorphia.pinnoidea.graphics.spectrum", sb.toString());
        }
    }
}