package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.tjaernoeiidae;
...
/**
 * Signal Processing for Family: Tjaernoeiidae
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/tjaernoeiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17327; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/tjaernoeiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Tjaernoeiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tjaernoeiidae_audio", "species.mollusca.heterobranchia.tjaernoeiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tjaernoeiidae_data", "species.mollusca.heterobranchia.tjaernoeiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tjaernoeiidae_graphics", "species.mollusca.heterobranchia.tjaernoeiidae.graphics.spectrum", sb.toString());
        }
    }
}