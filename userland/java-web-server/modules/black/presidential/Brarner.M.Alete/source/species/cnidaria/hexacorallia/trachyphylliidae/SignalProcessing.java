package presidential.Brarner.M.Alete.source.species.cnidaria.hexacorallia.trachyphylliidae;
...
/**
 * Signal Processing for Family: Trachyphylliidae
 * <p>Phylum: Cnidaria | Class: Hexacorallia | Order: Faviina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/trachyphylliidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11075; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/trachyphylliidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Trachyphylliidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("trachyphylliidae_audio", "species.cnidaria.hexacorallia.trachyphylliidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("trachyphylliidae_data", "species.cnidaria.hexacorallia.trachyphylliidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("trachyphylliidae_graphics", "species.cnidaria.hexacorallia.trachyphylliidae.graphics.spectrum", sb.toString());
        }
    }
}