package presidential.Brarner.M.Alete.source.species.mollusca.pachytegmentaria.proneomeniidae;
...
/**
 * Signal Processing for Family: Proneomeniidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/pachytegmentaria/proneomeniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17806; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/pachytegmentaria/proneomeniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Pachytegmentaria"); ps.setString(3, "Proneomeniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("proneomeniidae_audio", "species.mollusca.pachytegmentaria.proneomeniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("proneomeniidae_data", "species.mollusca.pachytegmentaria.proneomeniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("proneomeniidae_graphics", "species.mollusca.pachytegmentaria.proneomeniidae.graphics.spectrum", sb.toString());
        }
    }
}