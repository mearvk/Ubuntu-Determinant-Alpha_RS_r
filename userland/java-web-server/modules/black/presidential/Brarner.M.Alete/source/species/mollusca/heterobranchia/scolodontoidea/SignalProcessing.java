package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.scolodontoidea;
...
/**
 * Signal Processing for Family: Scolodontoidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Scolodontina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/scolodontoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17679; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/scolodontoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Scolodontoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("scolodontoidea_audio", "species.mollusca.heterobranchia.scolodontoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("scolodontoidea_data", "species.mollusca.heterobranchia.scolodontoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("scolodontoidea_graphics", "species.mollusca.heterobranchia.scolodontoidea.graphics.spectrum", sb.toString());
        }
    }
}