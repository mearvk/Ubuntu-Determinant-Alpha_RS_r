package presidential.Brarner.M.Alete.source.species.nematoda.enoplia.thoracostomopsidae;
...
/**
 * Signal Processing for Family: Thoracostomopsidae
 * <p>Phylum: Nematoda | Class: Enoplia | Order: Enoplida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/enoplia/thoracostomopsidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16489; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/enoplia/thoracostomopsidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Enoplia"); ps.setString(3, "Thoracostomopsidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thoracostomopsidae_audio", "species.nematoda.enoplia.thoracostomopsidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thoracostomopsidae_data", "species.nematoda.enoplia.thoracostomopsidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thoracostomopsidae_graphics", "species.nematoda.enoplia.thoracostomopsidae.graphics.spectrum", sb.toString());
        }
    }
}