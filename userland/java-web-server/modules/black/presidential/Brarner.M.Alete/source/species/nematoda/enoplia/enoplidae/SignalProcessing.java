package presidential.Brarner.M.Alete.source.species.nematoda.enoplia.enoplidae;
...
/**
 * Signal Processing for Family: Enoplidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/enoplia/enoplidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16475; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/enoplia/enoplidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Enoplia"); ps.setString(3, "Enoplidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("enoplidae_audio", "species.nematoda.enoplia.enoplidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("enoplidae_data", "species.nematoda.enoplia.enoplidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("enoplidae_graphics", "species.nematoda.enoplia.enoplidae.graphics.spectrum", sb.toString());
        }
    }
}