package presidential.Brarner.M.Alete.source.species.chordata.eutheria.geomyidae;
...
/**
 * Signal Processing for Family: Geomyidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/geomyidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12502; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/geomyidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Geomyidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("geomyidae_audio", "species.chordata.eutheria.geomyidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("geomyidae_data", "species.chordata.eutheria.geomyidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("geomyidae_graphics", "species.chordata.eutheria.geomyidae.graphics.spectrum", sb.toString());
        }
    }
}