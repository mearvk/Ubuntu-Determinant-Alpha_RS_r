package presidential.Brarner.M.Alete.source.species.nematoda.enoplia.leptosomatidae;
...
/**
 * Signal Processing for Family: Leptosomatidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/enoplia/leptosomatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16479; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/enoplia/leptosomatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Enoplia"); ps.setString(3, "Leptosomatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("leptosomatidae_audio", "species.nematoda.enoplia.leptosomatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("leptosomatidae_data", "species.nematoda.enoplia.leptosomatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("leptosomatidae_graphics", "species.nematoda.enoplia.leptosomatidae.graphics.spectrum", sb.toString());
        }
    }
}