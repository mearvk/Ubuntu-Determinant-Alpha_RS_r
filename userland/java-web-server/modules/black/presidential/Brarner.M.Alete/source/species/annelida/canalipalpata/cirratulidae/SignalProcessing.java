package presidential.Brarner.M.Alete.source.species.annelida.canalipalpata.cirratulidae;
...
/**
 * Signal Processing for Family: Cirratulidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/canalipalpata/cirratulidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16702; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/canalipalpata/cirratulidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Canalipalpata"); ps.setString(3, "Cirratulidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cirratulidae_audio", "species.annelida.canalipalpata.cirratulidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cirratulidae_data", "species.annelida.canalipalpata.cirratulidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cirratulidae_graphics", "species.annelida.canalipalpata.cirratulidae.graphics.spectrum", sb.toString());
        }
    }
}