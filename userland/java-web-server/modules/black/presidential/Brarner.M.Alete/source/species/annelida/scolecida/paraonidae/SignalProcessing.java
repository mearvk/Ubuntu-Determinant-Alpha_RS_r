package presidential.Brarner.M.Alete.source.species.annelida.scolecida.paraonidae;
...
/**
 * Signal Processing for Family: Paraonidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/scolecida/paraonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16721; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/scolecida/paraonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Scolecida"); ps.setString(3, "Paraonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("paraonidae_audio", "species.annelida.scolecida.paraonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("paraonidae_data", "species.annelida.scolecida.paraonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("paraonidae_graphics", "species.annelida.scolecida.paraonidae.graphics.spectrum", sb.toString());
        }
    }
}