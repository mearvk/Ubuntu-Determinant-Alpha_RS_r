package presidential.Brarner.M.Alete.source.species.chordata.elasmobranchii.carcharhinidae;
...
/**
 * Signal Processing for Family: Carcharhinidae
 * <p>Phylum: Chordata | Class: Elasmobranchii | Order: Carcharhiniformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/elasmobranchii/carcharhinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11979; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/elasmobranchii/carcharhinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Elasmobranchii"); ps.setString(3, "Carcharhinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("carcharhinidae_audio", "species.chordata.elasmobranchii.carcharhinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("carcharhinidae_data", "species.chordata.elasmobranchii.carcharhinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("carcharhinidae_graphics", "species.chordata.elasmobranchii.carcharhinidae.graphics.spectrum", sb.toString());
        }
    }
}