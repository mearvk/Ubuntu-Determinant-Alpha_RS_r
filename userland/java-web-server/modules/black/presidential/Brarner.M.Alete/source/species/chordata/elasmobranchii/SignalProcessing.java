package presidential.Brarner.M.Alete.source.species.chordata.elasmobranchii;
...
/**
 * Signal Processing for Phylum: Chordata, Class: Elasmobranchii
 * <p>Families: 56</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/elasmobranchii/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11978; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/elasmobranchii";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Elasmobranchii"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chordata_elasmobranchii_audio", "species.chordata.elasmobranchii.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chordata_elasmobranchii_data", "species.chordata.elasmobranchii.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chordata_elasmobranchii_graphics", "species.chordata.elasmobranchii.graphics.spectrum", sb.toString());
        }
    }
}