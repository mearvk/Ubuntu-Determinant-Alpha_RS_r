package presidential.Brarner.M.Alete.source.species.chordata.aves.promeropidae;
...
/**
 * Signal Processing for Family: Promeropidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/promeropidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12313; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/promeropidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Promeropidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("promeropidae_audio", "species.chordata.aves.promeropidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("promeropidae_data", "species.chordata.aves.promeropidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("promeropidae_graphics", "species.chordata.aves.promeropidae.graphics.spectrum", sb.toString());
        }
    }
}