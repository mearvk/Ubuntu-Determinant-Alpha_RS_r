package presidential.Brarner.M.Alete.source.species.mollusca.vetigastropoda.melanodrymiidae;
...
/**
 * Signal Processing for Family: Melanodrymiidae
 * <p>Phylum: Mollusca | Class: Vetigastropoda | Order: Neomphalina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/vetigastropoda/melanodrymiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17726; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/vetigastropoda/melanodrymiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Vetigastropoda"); ps.setString(3, "Melanodrymiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("melanodrymiidae_audio", "species.mollusca.vetigastropoda.melanodrymiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("melanodrymiidae_data", "species.mollusca.vetigastropoda.melanodrymiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("melanodrymiidae_graphics", "species.mollusca.vetigastropoda.melanodrymiidae.graphics.spectrum", sb.toString());
        }
    }
}