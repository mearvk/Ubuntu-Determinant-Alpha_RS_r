package presidential.Brarner.M.Alete.source.species.annelida.errantia.pilargidae;
...
/**
 * Signal Processing for Family: Pilargidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/errantia/pilargidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16675; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/errantia/pilargidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Errantia"); ps.setString(3, "Pilargidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pilargidae_audio", "species.annelida.errantia.pilargidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pilargidae_data", "species.annelida.errantia.pilargidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pilargidae_graphics", "species.annelida.errantia.pilargidae.graphics.spectrum", sb.toString());
        }
    }
}