package presidential.Brarner.M.Alete.source.species.mollusca.vetigastropoda.chilodontaidae;
...
/**
 * Signal Processing for Family: Chilodontaidae
 * <p>Phylum: Mollusca | Class: Vetigastropoda | Order: Seguenziida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/vetigastropoda/chilodontaidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17733; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/vetigastropoda/chilodontaidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Vetigastropoda"); ps.setString(3, "Chilodontaidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chilodontaidae_audio", "species.mollusca.vetigastropoda.chilodontaidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chilodontaidae_data", "species.mollusca.vetigastropoda.chilodontaidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chilodontaidae_graphics", "species.mollusca.vetigastropoda.chilodontaidae.graphics.spectrum", sb.toString());
        }
    }
}