package presidential.Brarner.M.Alete.source.species.chordata.reptilia.cylindrophiidae;
...
/**
 * Signal Processing for Family: Cylindrophiidae
 * <p>Phylum: Chordata | Class: Reptilia | Order: Alethinophidia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/reptilia/cylindrophiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12620; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/reptilia/cylindrophiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Reptilia"); ps.setString(3, "Cylindrophiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cylindrophiidae_audio", "species.chordata.reptilia.cylindrophiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cylindrophiidae_data", "species.chordata.reptilia.cylindrophiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cylindrophiidae_graphics", "species.chordata.reptilia.cylindrophiidae.graphics.spectrum", sb.toString());
        }
    }
}