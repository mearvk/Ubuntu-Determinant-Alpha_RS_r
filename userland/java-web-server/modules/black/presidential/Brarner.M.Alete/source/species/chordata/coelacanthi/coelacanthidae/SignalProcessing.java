package presidential.Brarner.M.Alete.source.species.chordata.coelacanthi.coelacanthidae;
...
/**
 * Signal Processing for Family: Coelacanthidae
 * <p>Phylum: Chordata | Class: Coelacanthi | Order: Coelacanthiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/coelacanthi/coelacanthidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12040; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/coelacanthi/coelacanthidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Coelacanthi"); ps.setString(3, "Coelacanthidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("coelacanthidae_audio", "species.chordata.coelacanthi.coelacanthidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("coelacanthidae_data", "species.chordata.coelacanthi.coelacanthidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("coelacanthidae_graphics", "species.chordata.coelacanthi.coelacanthidae.graphics.spectrum", sb.toString());
        }
    }
}