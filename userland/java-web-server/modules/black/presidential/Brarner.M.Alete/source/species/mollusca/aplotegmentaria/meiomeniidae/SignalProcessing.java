package presidential.Brarner.M.Alete.source.species.mollusca.aplotegmentaria.meiomeniidae;
...
/**
 * Signal Processing for Family: Meiomeniidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/aplotegmentaria/meiomeniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17796; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/aplotegmentaria/meiomeniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Aplotegmentaria"); ps.setString(3, "Meiomeniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("meiomeniidae_audio", "species.mollusca.aplotegmentaria.meiomeniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("meiomeniidae_data", "species.mollusca.aplotegmentaria.meiomeniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("meiomeniidae_graphics", "species.mollusca.aplotegmentaria.meiomeniidae.graphics.spectrum", sb.toString());
        }
    }
}