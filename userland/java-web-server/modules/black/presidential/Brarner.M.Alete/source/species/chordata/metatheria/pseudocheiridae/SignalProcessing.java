package presidential.Brarner.M.Alete.source.species.chordata.metatheria.pseudocheiridae;
...
/**
 * Signal Processing for Family: Pseudocheiridae
 * <p>Phylum: Chordata | Class: Metatheria | Order: Phalangeriformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/metatheria/pseudocheiridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12550; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/metatheria/pseudocheiridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Metatheria"); ps.setString(3, "Pseudocheiridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudocheiridae_audio", "species.chordata.metatheria.pseudocheiridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudocheiridae_data", "species.chordata.metatheria.pseudocheiridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudocheiridae_graphics", "species.chordata.metatheria.pseudocheiridae.graphics.spectrum", sb.toString());
        }
    }
}