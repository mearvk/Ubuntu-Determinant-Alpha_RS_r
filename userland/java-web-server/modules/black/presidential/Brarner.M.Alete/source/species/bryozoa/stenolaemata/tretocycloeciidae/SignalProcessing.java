package presidential.Brarner.M.Alete.source.species.bryozoa.stenolaemata.tretocycloeciidae;
...
/**
 * Signal Processing for Family: Tretocycloeciidae
 * <p>Phylum: Bryozoa | Class: Stenolaemata | Order: Cerioporina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/stenolaemata/tretocycloeciidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16875; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/stenolaemata/tretocycloeciidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Stenolaemata"); ps.setString(3, "Tretocycloeciidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tretocycloeciidae_audio", "species.bryozoa.stenolaemata.tretocycloeciidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tretocycloeciidae_data", "species.bryozoa.stenolaemata.tretocycloeciidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tretocycloeciidae_graphics", "species.bryozoa.stenolaemata.tretocycloeciidae.graphics.spectrum", sb.toString());
        }
    }
}