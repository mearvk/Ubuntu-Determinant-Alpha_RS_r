package presidential.Brarner.M.Alete.source.species.chordata.aves.cisticolidae;
...
/**
 * Signal Processing for Family: Cisticolidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/cisticolidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12227; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/cisticolidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Cisticolidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cisticolidae_audio", "species.chordata.aves.cisticolidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cisticolidae_data", "species.chordata.aves.cisticolidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cisticolidae_graphics", "species.chordata.aves.cisticolidae.graphics.spectrum", sb.toString());
        }
    }
}