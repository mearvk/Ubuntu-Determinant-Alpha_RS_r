package presidential.Brarner.M.Alete.source.species.chordata.aves.rostratulidae;
...
/**
 * Signal Processing for Family: Rostratulidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/rostratulidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12167; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/rostratulidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Rostratulidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rostratulidae_audio", "species.chordata.aves.rostratulidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rostratulidae_data", "species.chordata.aves.rostratulidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rostratulidae_graphics", "species.chordata.aves.rostratulidae.graphics.spectrum", sb.toString());
        }
    }
}