package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.trimusculoidea;
...
/**
 * Signal Processing for Family: Trimusculoidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Ellobiida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/trimusculoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17418; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/trimusculoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Trimusculoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("trimusculoidea_audio", "species.mollusca.heterobranchia.trimusculoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("trimusculoidea_data", "species.mollusca.heterobranchia.trimusculoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("trimusculoidea_graphics", "species.mollusca.heterobranchia.trimusculoidea.graphics.spectrum", sb.toString());
        }
    }
}