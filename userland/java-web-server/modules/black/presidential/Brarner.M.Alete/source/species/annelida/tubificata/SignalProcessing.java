package presidential.Brarner.M.Alete.source.species.annelida.tubificata;
...
/**
 * Signal Processing for Phylum: Annelida, Class: Tubificata
 * <p>Families: 8</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/tubificata/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16614; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/tubificata";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Tubificata"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("annelida_tubificata_audio", "species.annelida.tubificata.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("annelida_tubificata_data", "species.annelida.tubificata.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("annelida_tubificata_graphics", "species.annelida.tubificata.graphics.spectrum", sb.toString());
        }
    }
}