package presidential.Brarner.M.Alete.source.species.chordata.aves.spheniscidae;
...
/**
 * Signal Processing for Family: Spheniscidae
 * <p>Phylum: Chordata | Class: Aves | Order: Sphenisciformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/spheniscidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12374; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/spheniscidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Spheniscidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("spheniscidae_audio", "species.chordata.aves.spheniscidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("spheniscidae_data", "species.chordata.aves.spheniscidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("spheniscidae_graphics", "species.chordata.aves.spheniscidae.graphics.spectrum", sb.toString());
        }
    }
}