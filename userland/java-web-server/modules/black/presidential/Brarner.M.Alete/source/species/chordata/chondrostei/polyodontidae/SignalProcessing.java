package presidential.Brarner.M.Alete.source.species.chordata.chondrostei.polyodontidae;
...
/**
 * Signal Processing for Family: Polyodontidae
 * <p>Phylum: Chordata | Class: Chondrostei | Order: Acipenseroidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/chondrostei/polyodontidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11510; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/chondrostei/polyodontidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Chondrostei"); ps.setString(3, "Polyodontidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("polyodontidae_audio", "species.chordata.chondrostei.polyodontidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("polyodontidae_data", "species.chordata.chondrostei.polyodontidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("polyodontidae_graphics", "species.chordata.chondrostei.polyodontidae.graphics.spectrum", sb.toString());
        }
    }
}