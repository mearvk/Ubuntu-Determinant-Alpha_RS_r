package presidential.Brarner.M.Alete.source.species.chordata.teleostei.nemichthyidae;
...
/**
 * Signal Processing for Family: Nemichthyidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/nemichthyidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11815; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/nemichthyidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Nemichthyidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("nemichthyidae_audio", "species.chordata.teleostei.nemichthyidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("nemichthyidae_data", "species.chordata.teleostei.nemichthyidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("nemichthyidae_graphics", "species.chordata.teleostei.nemichthyidae.graphics.spectrum", sb.toString());
        }
    }
}