package presidential.Brarner.M.Alete.source.species.nematoda.dorylaimea.tylencholaimellidae;
...
/**
 * Signal Processing for Family: Tylencholaimellidae
 * <p>Phylum: Nematoda | Class: Dorylaimea | Order: Dorylaimida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/dorylaimea/tylencholaimellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16461; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/dorylaimea/tylencholaimellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Dorylaimea"); ps.setString(3, "Tylencholaimellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tylencholaimellidae_audio", "species.nematoda.dorylaimea.tylencholaimellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tylencholaimellidae_data", "species.nematoda.dorylaimea.tylencholaimellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tylencholaimellidae_graphics", "species.nematoda.dorylaimea.tylencholaimellidae.graphics.spectrum", sb.toString());
        }
    }
}