package presidential.Brarner.M.Alete.source.species.annelida.randiellata.randiellidae;
...
/**
 * Signal Processing for Family: Randiellidae
 * <p>Phylum: Annelida | Class: Randiellata | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/randiellata/randiellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16613; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/randiellata/randiellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Randiellata"); ps.setString(3, "Randiellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("randiellidae_audio", "species.annelida.randiellata.randiellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("randiellidae_data", "species.annelida.randiellata.randiellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("randiellidae_graphics", "species.annelida.randiellata.randiellidae.graphics.spectrum", sb.toString());
        }
    }
}