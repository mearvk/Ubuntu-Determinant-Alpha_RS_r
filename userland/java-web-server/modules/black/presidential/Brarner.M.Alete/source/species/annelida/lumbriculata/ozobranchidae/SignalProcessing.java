package presidential.Brarner.M.Alete.source.species.annelida.lumbriculata.ozobranchidae;
...
/**
 * Signal Processing for Family: Ozobranchidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/lumbriculata/ozobranchidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16609; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/lumbriculata/ozobranchidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Lumbriculata"); ps.setString(3, "Ozobranchidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ozobranchidae_audio", "species.annelida.lumbriculata.ozobranchidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ozobranchidae_data", "species.annelida.lumbriculata.ozobranchidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ozobranchidae_graphics", "species.annelida.lumbriculata.ozobranchidae.graphics.spectrum", sb.toString());
        }
    }
}