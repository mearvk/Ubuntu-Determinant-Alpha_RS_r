package presidential.Brarner.M.Alete.source.species.mollusca.pteriomorphia.parallelodontidae;
...
/**
 * Signal Processing for Family: Parallelodontidae
 * <p>Phylum: Mollusca | Class: Pteriomorphia | Order: Arcida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/pteriomorphia/parallelodontidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17019; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/pteriomorphia/parallelodontidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Pteriomorphia"); ps.setString(3, "Parallelodontidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("parallelodontidae_audio", "species.mollusca.pteriomorphia.parallelodontidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("parallelodontidae_data", "species.mollusca.pteriomorphia.parallelodontidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("parallelodontidae_graphics", "species.mollusca.pteriomorphia.parallelodontidae.graphics.spectrum", sb.toString());
        }
    }
}