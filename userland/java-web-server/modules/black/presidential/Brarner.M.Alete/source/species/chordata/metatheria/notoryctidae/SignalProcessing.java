package presidential.Brarner.M.Alete.source.species.chordata.metatheria.notoryctidae;
...
/**
 * Signal Processing for Family: Notoryctidae
 * <p>Phylum: Chordata | Class: Metatheria | Order: Notoryctemorphia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/metatheria/notoryctidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12558; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/metatheria/notoryctidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Metatheria"); ps.setString(3, "Notoryctidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("notoryctidae_audio", "species.chordata.metatheria.notoryctidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("notoryctidae_data", "species.chordata.metatheria.notoryctidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("notoryctidae_graphics", "species.chordata.metatheria.notoryctidae.graphics.spectrum", sb.toString());
        }
    }
}