package presidential.Brarner.M.Alete.source.species.nematoda.chromadorea.pseudogasteroididae;
...
/**
 * Signal Processing for Family: Pseudogasteroididae
 * <p>Phylum: Nematoda | Class: Chromadorea | Order: Rhabditida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/chromadorea/pseudogasteroididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16348; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/chromadorea/pseudogasteroididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Chromadorea"); ps.setString(3, "Pseudogasteroididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudogasteroididae_audio", "species.nematoda.chromadorea.pseudogasteroididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudogasteroididae_data", "species.nematoda.chromadorea.pseudogasteroididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudogasteroididae_graphics", "species.nematoda.chromadorea.pseudogasteroididae.graphics.spectrum", sb.toString());
        }
    }
}