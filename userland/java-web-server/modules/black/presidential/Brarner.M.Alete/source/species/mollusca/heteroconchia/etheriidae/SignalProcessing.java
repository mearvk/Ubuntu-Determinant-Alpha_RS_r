package presidential.Brarner.M.Alete.source.species.mollusca.heteroconchia.etheriidae;
...
/**
 * Signal Processing for Family: Etheriidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heteroconchia/etheriidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16968; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heteroconchia/etheriidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heteroconchia"); ps.setString(3, "Etheriidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("etheriidae_audio", "species.mollusca.heteroconchia.etheriidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("etheriidae_data", "species.mollusca.heteroconchia.etheriidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("etheriidae_graphics", "species.mollusca.heteroconchia.etheriidae.graphics.spectrum", sb.toString());
        }
    }
}