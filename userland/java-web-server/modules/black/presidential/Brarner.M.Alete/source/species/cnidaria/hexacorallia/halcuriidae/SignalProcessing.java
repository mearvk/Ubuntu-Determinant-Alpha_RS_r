package presidential.Brarner.M.Alete.source.species.cnidaria.hexacorallia.halcuriidae;
...
/**
 * Signal Processing for Family: Halcuriidae
 * <p>Phylum: Cnidaria | Class: Hexacorallia | Order: Endocoelantheae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/halcuriidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11002; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/halcuriidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Halcuriidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("halcuriidae_audio", "species.cnidaria.hexacorallia.halcuriidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("halcuriidae_data", "species.cnidaria.hexacorallia.halcuriidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("halcuriidae_graphics", "species.cnidaria.hexacorallia.halcuriidae.graphics.spectrum", sb.toString());
        }
    }
}