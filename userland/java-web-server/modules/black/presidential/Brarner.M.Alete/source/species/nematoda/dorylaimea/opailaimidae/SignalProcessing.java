package presidential.Brarner.M.Alete.source.species.nematoda.dorylaimea.opailaimidae;
...
/**
 * Signal Processing for Family: Opailaimidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/dorylaimea/opailaimidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16457; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/dorylaimea/opailaimidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Dorylaimea"); ps.setString(3, "Opailaimidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("opailaimidae_audio", "species.nematoda.dorylaimea.opailaimidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("opailaimidae_data", "species.nematoda.dorylaimea.opailaimidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("opailaimidae_graphics", "species.nematoda.dorylaimea.opailaimidae.graphics.spectrum", sb.toString());
        }
    }
}