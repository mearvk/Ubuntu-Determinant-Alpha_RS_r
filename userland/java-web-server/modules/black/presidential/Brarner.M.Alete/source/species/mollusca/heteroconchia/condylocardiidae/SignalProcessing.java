package presidential.Brarner.M.Alete.source.species.mollusca.heteroconchia.condylocardiidae;
...
/**
 * Signal Processing for Family: Condylocardiidae
 * <p>Phylum: Mollusca | Class: Heteroconchia | Order: Carditida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heteroconchia/condylocardiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16905; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heteroconchia/condylocardiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heteroconchia"); ps.setString(3, "Condylocardiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("condylocardiidae_audio", "species.mollusca.heteroconchia.condylocardiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("condylocardiidae_data", "species.mollusca.heteroconchia.condylocardiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("condylocardiidae_graphics", "species.mollusca.heteroconchia.condylocardiidae.graphics.spectrum", sb.toString());
        }
    }
}