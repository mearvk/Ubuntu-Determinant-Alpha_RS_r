package presidential.Brarner.M.Alete.source.species.chordata.aves.psittacidae;
...
/**
 * Signal Processing for Family: Psittacidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/psittacidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12369; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/psittacidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Psittacidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("psittacidae_audio", "species.chordata.aves.psittacidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("psittacidae_data", "species.chordata.aves.psittacidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("psittacidae_graphics", "species.chordata.aves.psittacidae.graphics.spectrum", sb.toString());
        }
    }
}