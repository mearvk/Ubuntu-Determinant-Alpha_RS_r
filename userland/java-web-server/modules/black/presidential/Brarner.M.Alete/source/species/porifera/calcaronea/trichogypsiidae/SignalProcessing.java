package presidential.Brarner.M.Alete.source.species.porifera.calcaronea.trichogypsiidae;
...
/**
 * Signal Processing for Family: Trichogypsiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/calcaronea/trichogypsiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11314; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/calcaronea/trichogypsiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Calcaronea"); ps.setString(3, "Trichogypsiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("trichogypsiidae_audio", "species.porifera.calcaronea.trichogypsiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("trichogypsiidae_data", "species.porifera.calcaronea.trichogypsiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("trichogypsiidae_graphics", "species.porifera.calcaronea.trichogypsiidae.graphics.spectrum", sb.toString());
        }
    }
}