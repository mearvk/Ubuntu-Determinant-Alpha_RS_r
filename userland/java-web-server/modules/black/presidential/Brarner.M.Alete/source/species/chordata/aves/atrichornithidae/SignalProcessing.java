package presidential.Brarner.M.Alete.source.species.chordata.aves.atrichornithidae;
...
/**
 * Signal Processing for Family: Atrichornithidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/atrichornithidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12211; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/atrichornithidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Atrichornithidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("atrichornithidae_audio", "species.chordata.aves.atrichornithidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("atrichornithidae_data", "species.chordata.aves.atrichornithidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("atrichornithidae_graphics", "species.chordata.aves.atrichornithidae.graphics.spectrum", sb.toString());
        }
    }
}