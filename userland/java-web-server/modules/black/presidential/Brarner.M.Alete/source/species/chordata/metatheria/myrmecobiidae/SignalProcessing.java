package presidential.Brarner.M.Alete.source.species.chordata.metatheria.myrmecobiidae;
...
/**
 * Signal Processing for Family: Myrmecobiidae
 * <p>Phylum: Chordata | Class: Metatheria | Order: Dasyuromorphia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/metatheria/myrmecobiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12541; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/metatheria/myrmecobiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Metatheria"); ps.setString(3, "Myrmecobiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("myrmecobiidae_audio", "species.chordata.metatheria.myrmecobiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("myrmecobiidae_data", "species.chordata.metatheria.myrmecobiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("myrmecobiidae_graphics", "species.chordata.metatheria.myrmecobiidae.graphics.spectrum", sb.toString());
        }
    }
}