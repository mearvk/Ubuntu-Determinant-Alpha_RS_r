package presidential.Brarner.M.Alete.source.species.cnidaria.discomedusae.rhizostomatidae;
...
/**
 * Signal Processing for Family: Rhizostomatidae
 * <p>Phylum: Cnidaria | Class: Discomedusae | Order: Rhizostomeae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/discomedusae/rhizostomatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11251; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/discomedusae/rhizostomatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Discomedusae"); ps.setString(3, "Rhizostomatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rhizostomatidae_audio", "species.cnidaria.discomedusae.rhizostomatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rhizostomatidae_data", "species.cnidaria.discomedusae.rhizostomatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rhizostomatidae_graphics", "species.cnidaria.discomedusae.rhizostomatidae.graphics.spectrum", sb.toString());
        }
    }
}