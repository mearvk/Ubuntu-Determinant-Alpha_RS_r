package presidential.Brarner.M.Alete.source.species.nematoda.dorylaimea.phlyctainophoridae;
...
/**
 * Signal Processing for Family: Phlyctainophoridae
 * <p>Phylum: Nematoda | Class: Dorylaimea | Order: Muspiceida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/dorylaimea/phlyctainophoridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16465; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/dorylaimea/phlyctainophoridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Dorylaimea"); ps.setString(3, "Phlyctainophoridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("phlyctainophoridae_audio", "species.nematoda.dorylaimea.phlyctainophoridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("phlyctainophoridae_data", "species.nematoda.dorylaimea.phlyctainophoridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("phlyctainophoridae_graphics", "species.nematoda.dorylaimea.phlyctainophoridae.graphics.spectrum", sb.toString());
        }
    }
}