package presidential.Brarner.M.Alete.source.species.mollusca.scaphopoda.gadilidae;
...
/**
 * Signal Processing for Family: Gadilidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/scaphopoda/gadilidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17784; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/scaphopoda/gadilidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Scaphopoda"); ps.setString(3, "Gadilidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gadilidae_audio", "species.mollusca.scaphopoda.gadilidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gadilidae_data", "species.mollusca.scaphopoda.gadilidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gadilidae_graphics", "species.mollusca.scaphopoda.gadilidae.graphics.spectrum", sb.toString());
        }
    }
}