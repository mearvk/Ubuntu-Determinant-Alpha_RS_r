package presidential.Brarner.M.Alete.source.species.mollusca.aplotegmentaria.gymnomeniidae;
...
/**
 * Signal Processing for Family: Gymnomeniidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/aplotegmentaria/gymnomeniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17793; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/aplotegmentaria/gymnomeniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Aplotegmentaria"); ps.setString(3, "Gymnomeniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gymnomeniidae_audio", "species.mollusca.aplotegmentaria.gymnomeniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gymnomeniidae_data", "species.mollusca.aplotegmentaria.gymnomeniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gymnomeniidae_graphics", "species.mollusca.aplotegmentaria.gymnomeniidae.graphics.spectrum", sb.toString());
        }
    }
}