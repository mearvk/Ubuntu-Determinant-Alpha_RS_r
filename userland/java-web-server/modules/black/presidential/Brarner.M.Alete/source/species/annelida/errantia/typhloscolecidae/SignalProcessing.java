package presidential.Brarner.M.Alete.source.species.annelida.errantia.typhloscolecidae;
...
/**
 * Signal Processing for Family: Typhloscolecidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/errantia/typhloscolecidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16682; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/errantia/typhloscolecidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Errantia"); ps.setString(3, "Typhloscolecidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("typhloscolecidae_audio", "species.annelida.errantia.typhloscolecidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("typhloscolecidae_data", "species.annelida.errantia.typhloscolecidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("typhloscolecidae_graphics", "species.annelida.errantia.typhloscolecidae.graphics.spectrum", sb.toString());
        }
    }
}