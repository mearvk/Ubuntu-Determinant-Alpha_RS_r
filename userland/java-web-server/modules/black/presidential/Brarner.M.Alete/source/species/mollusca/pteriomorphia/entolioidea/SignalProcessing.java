package presidential.Brarner.M.Alete.source.species.mollusca.pteriomorphia.entolioidea;
...
/**
 * Signal Processing for Family: Entolioidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/pteriomorphia/entolioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17026; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/pteriomorphia/entolioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Pteriomorphia"); ps.setString(3, "Entolioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("entolioidea_audio", "species.mollusca.pteriomorphia.entolioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("entolioidea_data", "species.mollusca.pteriomorphia.entolioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("entolioidea_graphics", "species.mollusca.pteriomorphia.entolioidea.graphics.spectrum", sb.toString());
        }
    }
}