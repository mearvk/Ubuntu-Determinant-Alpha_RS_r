package presidential.Brarner.M.Alete.source.species.chordata.eutheria.spalacidae;
...
/**
 * Signal Processing for Family: Spalacidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/spalacidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12530; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/spalacidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Spalacidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("spalacidae_audio", "species.chordata.eutheria.spalacidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("spalacidae_data", "species.chordata.eutheria.spalacidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("spalacidae_graphics", "species.chordata.eutheria.spalacidae.graphics.spectrum", sb.toString());
        }
    }
}