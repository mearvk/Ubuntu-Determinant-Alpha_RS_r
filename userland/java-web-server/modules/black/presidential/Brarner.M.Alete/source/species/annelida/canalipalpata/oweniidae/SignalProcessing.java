package presidential.Brarner.M.Alete.source.species.annelida.canalipalpata.oweniidae;
...
/**
 * Signal Processing for Family: Oweniidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/canalipalpata/oweniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16686; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/canalipalpata/oweniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Canalipalpata"); ps.setString(3, "Oweniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("oweniidae_audio", "species.annelida.canalipalpata.oweniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("oweniidae_data", "species.annelida.canalipalpata.oweniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("oweniidae_graphics", "species.annelida.canalipalpata.oweniidae.graphics.spectrum", sb.toString());
        }
    }
}