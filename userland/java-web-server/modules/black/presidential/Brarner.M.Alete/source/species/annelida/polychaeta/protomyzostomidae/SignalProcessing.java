package presidential.Brarner.M.Alete.source.species.annelida.polychaeta.protomyzostomidae;
...
/**
 * Signal Processing for Family: Protomyzostomidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/polychaeta/protomyzostomidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16639; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/polychaeta/protomyzostomidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Polychaeta"); ps.setString(3, "Protomyzostomidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("protomyzostomidae_audio", "species.annelida.polychaeta.protomyzostomidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("protomyzostomidae_data", "species.annelida.polychaeta.protomyzostomidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("protomyzostomidae_graphics", "species.annelida.polychaeta.protomyzostomidae.graphics.spectrum", sb.toString());
        }
    }
}