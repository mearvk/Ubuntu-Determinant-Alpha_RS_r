package presidential.Brarner.M.Alete.source.species.mollusca.heteroconchia.sphaerioidea;
...
/**
 * Signal Processing for Family: Sphaerioidea
 * <p>Phylum: Mollusca | Class: Heteroconchia | Order: Sphaeriida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heteroconchia/sphaerioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16953; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heteroconchia/sphaerioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heteroconchia"); ps.setString(3, "Sphaerioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sphaerioidea_audio", "species.mollusca.heteroconchia.sphaerioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sphaerioidea_data", "species.mollusca.heteroconchia.sphaerioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sphaerioidea_graphics", "species.mollusca.heteroconchia.sphaerioidea.graphics.spectrum", sb.toString());
        }
    }
}