package presidential.Brarner.M.Alete.source.species.chordata.teleostei.pseudotrichonotidae;
...
/**
 * Signal Processing for Family: Pseudotrichonotidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Synodontoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/pseudotrichonotidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11803; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/pseudotrichonotidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Pseudotrichonotidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudotrichonotidae_audio", "species.chordata.teleostei.pseudotrichonotidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudotrichonotidae_data", "species.chordata.teleostei.pseudotrichonotidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudotrichonotidae_graphics", "species.chordata.teleostei.pseudotrichonotidae.graphics.spectrum", sb.toString());
        }
    }
}