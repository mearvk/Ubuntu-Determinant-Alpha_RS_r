package presidential.Brarner.M.Alete.source.species.mollusca.heteroconchia.cleidothaeridae;
...
/**
 * Signal Processing for Family: Cleidothaeridae
 * <p>Phylum: Mollusca | Class: Heteroconchia | Order: Thraciida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heteroconchia/cleidothaeridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16962; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heteroconchia/cleidothaeridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heteroconchia"); ps.setString(3, "Cleidothaeridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cleidothaeridae_audio", "species.mollusca.heteroconchia.cleidothaeridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cleidothaeridae_data", "species.mollusca.heteroconchia.cleidothaeridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cleidothaeridae_graphics", "species.mollusca.heteroconchia.cleidothaeridae.graphics.spectrum", sb.toString());
        }
    }
}