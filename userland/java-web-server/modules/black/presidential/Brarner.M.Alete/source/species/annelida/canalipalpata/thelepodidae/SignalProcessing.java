package presidential.Brarner.M.Alete.source.species.annelida.canalipalpata.thelepodidae;
...
/**
 * Signal Processing for Family: Thelepodidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/canalipalpata/thelepodidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16712; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/canalipalpata/thelepodidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Canalipalpata"); ps.setString(3, "Thelepodidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thelepodidae_audio", "species.annelida.canalipalpata.thelepodidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thelepodidae_data", "species.annelida.canalipalpata.thelepodidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thelepodidae_graphics", "species.annelida.canalipalpata.thelepodidae.graphics.spectrum", sb.toString());
        }
    }
}