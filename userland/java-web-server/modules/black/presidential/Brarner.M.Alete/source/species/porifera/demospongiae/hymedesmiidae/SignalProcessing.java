package presidential.Brarner.M.Alete.source.species.porifera.demospongiae.hymedesmiidae;
...
/**
 * Signal Processing for Family: Hymedesmiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/demospongiae/hymedesmiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11424; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/demospongiae/hymedesmiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Demospongiae"); ps.setString(3, "Hymedesmiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hymedesmiidae_audio", "species.porifera.demospongiae.hymedesmiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hymedesmiidae_data", "species.porifera.demospongiae.hymedesmiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hymedesmiidae_graphics", "species.porifera.demospongiae.hymedesmiidae.graphics.spectrum", sb.toString());
        }
    }
}