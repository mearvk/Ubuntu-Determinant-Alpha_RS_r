package presidential.Brarner.M.Alete.source.species.mollusca.vetigastropoda.pleurotomarioidea;
...
/**
 * Signal Processing for Family: Pleurotomarioidea
 * <p>Phylum: Mollusca | Class: Vetigastropoda | Order: Pleurotomariida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/vetigastropoda/pleurotomarioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17729; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/vetigastropoda/pleurotomarioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Vetigastropoda"); ps.setString(3, "Pleurotomarioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pleurotomarioidea_audio", "species.mollusca.vetigastropoda.pleurotomarioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pleurotomarioidea_data", "species.mollusca.vetigastropoda.pleurotomarioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pleurotomarioidea_graphics", "species.mollusca.vetigastropoda.pleurotomarioidea.graphics.spectrum", sb.toString());
        }
    }
}