package presidential.Brarner.M.Alete.source.species.cnidaria.octocorallia.alcyoniidae;
...
/**
 * Signal Processing for Family: Alcyoniidae
 * <p>Phylum: Cnidaria | Class: Octocorallia | Order: Alcyoniina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/octocorallia/alcyoniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11095; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/octocorallia/alcyoniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Octocorallia"); ps.setString(3, "Alcyoniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("alcyoniidae_audio", "species.cnidaria.octocorallia.alcyoniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("alcyoniidae_data", "species.cnidaria.octocorallia.alcyoniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("alcyoniidae_graphics", "species.cnidaria.octocorallia.alcyoniidae.graphics.spectrum", sb.toString());
        }
    }
}