package presidential.Brarner.M.Alete.source.species.annelida.clitellata.lumbricoidea;
...
/**
 * Signal Processing for Family: Lumbricoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/clitellata/lumbricoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16583; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/clitellata/lumbricoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Clitellata"); ps.setString(3, "Lumbricoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lumbricoidea_audio", "species.annelida.clitellata.lumbricoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lumbricoidea_data", "species.annelida.clitellata.lumbricoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lumbricoidea_graphics", "species.annelida.clitellata.lumbricoidea.graphics.spectrum", sb.toString());
        }
    }
}