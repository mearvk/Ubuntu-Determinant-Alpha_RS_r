package presidential.Brarner.M.Alete.source.species.chordata.teleostei.cryptacanthodidae;
...
/**
 * Signal Processing for Family: Cryptacanthodidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Zoarcoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/cryptacanthodidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11705; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/cryptacanthodidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Cryptacanthodidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cryptacanthodidae_audio", "species.chordata.teleostei.cryptacanthodidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cryptacanthodidae_data", "species.chordata.teleostei.cryptacanthodidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cryptacanthodidae_graphics", "species.chordata.teleostei.cryptacanthodidae.graphics.spectrum", sb.toString());
        }
    }
}