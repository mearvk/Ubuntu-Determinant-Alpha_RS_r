package presidential.Brarner.M.Alete.source.species.bryozoa.phylactolaemata.cristatellidae;
...
/**
 * Signal Processing for Family: Cristatellidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/phylactolaemata/cristatellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16889; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/phylactolaemata/cristatellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Phylactolaemata"); ps.setString(3, "Cristatellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cristatellidae_audio", "species.bryozoa.phylactolaemata.cristatellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cristatellidae_data", "species.bryozoa.phylactolaemata.cristatellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cristatellidae_graphics", "species.bryozoa.phylactolaemata.cristatellidae.graphics.spectrum", sb.toString());
        }
    }
}