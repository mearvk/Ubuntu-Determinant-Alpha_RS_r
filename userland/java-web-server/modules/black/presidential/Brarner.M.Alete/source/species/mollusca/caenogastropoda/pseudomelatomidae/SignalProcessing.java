package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.pseudomelatomidae;
...
/**
 * Signal Processing for Family: Pseudomelatomidae
 * <p>Phylum: Mollusca | Class: Caenogastropoda | Order: Neogastropoda</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/pseudomelatomidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17286; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/pseudomelatomidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Pseudomelatomidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudomelatomidae_audio", "species.mollusca.caenogastropoda.pseudomelatomidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudomelatomidae_data", "species.mollusca.caenogastropoda.pseudomelatomidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudomelatomidae_graphics", "species.mollusca.caenogastropoda.pseudomelatomidae.graphics.spectrum", sb.toString());
        }
    }
}