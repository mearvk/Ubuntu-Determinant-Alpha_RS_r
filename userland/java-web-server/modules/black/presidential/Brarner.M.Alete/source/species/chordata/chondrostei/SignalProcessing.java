package presidential.Brarner.M.Alete.source.species.chordata.chondrostei;
...
/**
 * Signal Processing for Phylum: Chordata, Class: Chondrostei
 * <p>Families: 2</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/chondrostei/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11508; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/chondrostei";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Chondrostei"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chordata_chondrostei_audio", "species.chordata.chondrostei.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chordata_chondrostei_data", "species.chordata.chondrostei.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chordata_chondrostei_graphics", "species.chordata.chondrostei.graphics.spectrum", sb.toString());
        }
    }
}