package presidential.Brarner.M.Alete.source.species.chordata.amphibia.rhyacotritonidae;
...
/**
 * Signal Processing for Family: Rhyacotritonidae
 * <p>Phylum: Chordata | Class: Amphibia | Order: Caudata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/amphibia/rhyacotritonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12118; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/amphibia/rhyacotritonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Amphibia"); ps.setString(3, "Rhyacotritonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rhyacotritonidae_audio", "species.chordata.amphibia.rhyacotritonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rhyacotritonidae_data", "species.chordata.amphibia.rhyacotritonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rhyacotritonidae_graphics", "species.chordata.amphibia.rhyacotritonidae.graphics.spectrum", sb.toString());
        }
    }
}