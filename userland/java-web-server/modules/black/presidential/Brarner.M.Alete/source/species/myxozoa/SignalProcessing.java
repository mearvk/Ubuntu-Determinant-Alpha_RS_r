package presidential.Brarner.M.Alete.source.species.myxozoa;
...
/**
 * Signal Processing for Kingdom Animalia, Phylum: Myxozoa
 * <p>Classes: 2 | Families: 5</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/myxozoa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10402; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/myxozoa";
        }
    }
    ...
    private static void writeToDatabase(String table, String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Myxozoa"); ps.setString(2, expName); ps.setString(3, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("species_myxozoa_audio", "species.myxozoa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("species_myxozoa_data", "species.myxozoa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("species_myxozoa_graphics", "species.myxozoa.graphics.spectrum", sb.toString());
        }
    }
}