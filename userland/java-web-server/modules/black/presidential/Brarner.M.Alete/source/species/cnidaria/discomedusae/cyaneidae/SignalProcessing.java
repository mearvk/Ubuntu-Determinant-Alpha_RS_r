package presidential.Brarner.M.Alete.source.species.cnidaria.discomedusae.cyaneidae;
...
/**
 * Signal Processing for Family: Cyaneidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/discomedusae/cyaneidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11259; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/discomedusae/cyaneidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Discomedusae"); ps.setString(3, "Cyaneidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cyaneidae_audio", "species.cnidaria.discomedusae.cyaneidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cyaneidae_data", "species.cnidaria.discomedusae.cyaneidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cyaneidae_graphics", "species.cnidaria.discomedusae.cyaneidae.graphics.spectrum", sb.toString());
        }
    }
}