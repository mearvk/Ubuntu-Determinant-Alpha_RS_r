package presidential.Brarner.M.Alete.source.species.cnidaria.hydroidolina.cladocorynidae;
...
/**
 * Signal Processing for Family: Cladocorynidae
 * <p>Phylum: Cnidaria | Class: Hydroidolina | Order: Capitata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hydroidolina/cladocorynidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11144; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hydroidolina/cladocorynidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hydroidolina"); ps.setString(3, "Cladocorynidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cladocorynidae_audio", "species.cnidaria.hydroidolina.cladocorynidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cladocorynidae_data", "species.cnidaria.hydroidolina.cladocorynidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cladocorynidae_graphics", "species.cnidaria.hydroidolina.cladocorynidae.graphics.spectrum", sb.toString());
        }
    }
}