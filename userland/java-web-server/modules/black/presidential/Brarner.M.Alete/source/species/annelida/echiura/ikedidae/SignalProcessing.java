package presidential.Brarner.M.Alete.source.species.annelida.echiura.ikedidae;
...
/**
 * Signal Processing for Family: Ikedidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/echiura/ikedidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16645; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/echiura/ikedidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Echiura"); ps.setString(3, "Ikedidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ikedidae_audio", "species.annelida.echiura.ikedidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ikedidae_data", "species.annelida.echiura.ikedidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ikedidae_graphics", "species.annelida.echiura.ikedidae.graphics.spectrum", sb.toString());
        }
    }
}