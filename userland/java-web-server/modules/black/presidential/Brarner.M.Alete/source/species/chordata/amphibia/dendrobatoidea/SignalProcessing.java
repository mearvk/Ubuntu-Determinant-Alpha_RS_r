package presidential.Brarner.M.Alete.source.species.chordata.amphibia.dendrobatoidea;
...
/**
 * Signal Processing for Family: Dendrobatoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/amphibia/dendrobatoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12106; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/amphibia/dendrobatoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Amphibia"); ps.setString(3, "Dendrobatoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dendrobatoidea_audio", "species.chordata.amphibia.dendrobatoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dendrobatoidea_data", "species.chordata.amphibia.dendrobatoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dendrobatoidea_graphics", "species.chordata.amphibia.dendrobatoidea.graphics.spectrum", sb.toString());
        }
    }
}