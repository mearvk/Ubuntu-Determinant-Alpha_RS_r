package presidential.Brarner.M.Alete.source.species.cnidaria.hexacorallia.ptychodactiidae;
...
/**
 * Signal Processing for Family: Ptychodactiidae
 * <p>Phylum: Cnidaria | Class: Hexacorallia | Order: Ptychodacteae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/ptychodactiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11047; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/ptychodactiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Ptychodactiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ptychodactiidae_audio", "species.cnidaria.hexacorallia.ptychodactiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ptychodactiidae_data", "species.cnidaria.hexacorallia.ptychodactiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ptychodactiidae_graphics", "species.cnidaria.hexacorallia.ptychodactiidae.graphics.spectrum", sb.toString());
        }
    }
}