package presidential.Brarner.M.Alete.source.species.cnidaria.trachylina.armorhydridae;
...
/**
 * Signal Processing for Family: Armorhydridae
 * <p>Phylum: Cnidaria | Class: Trachylina | Order: Limnomedusae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/trachylina/armorhydridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11224; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/trachylina/armorhydridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Trachylina"); ps.setString(3, "Armorhydridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("armorhydridae_audio", "species.cnidaria.trachylina.armorhydridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("armorhydridae_data", "species.cnidaria.trachylina.armorhydridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("armorhydridae_graphics", "species.cnidaria.trachylina.armorhydridae.graphics.spectrum", sb.toString());
        }
    }
}