package presidential.Brarner.M.Alete.source.species.cnidaria.staurozoa.kyopodiidae;
...
/**
 * Signal Processing for Family: Kyopodiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/staurozoa/kyopodiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11267; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/staurozoa/kyopodiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Staurozoa"); ps.setString(3, "Kyopodiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("kyopodiidae_audio", "species.cnidaria.staurozoa.kyopodiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("kyopodiidae_data", "species.cnidaria.staurozoa.kyopodiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("kyopodiidae_graphics", "species.cnidaria.staurozoa.kyopodiidae.graphics.spectrum", sb.toString());
        }
    }
}