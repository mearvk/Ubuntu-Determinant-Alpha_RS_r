package presidential.Brarner.M.Alete.source.species.annelida.echiura;
...
/**
 * Signal Processing for Phylum: Annelida, Class: Echiura
 * <p>Families: 5</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/echiura/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16641; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/echiura";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Echiura"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("annelida_echiura_audio", "species.annelida.echiura.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("annelida_echiura_data", "species.annelida.echiura.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("annelida_echiura_graphics", "species.annelida.echiura.graphics.spectrum", sb.toString());
        }
    }
}