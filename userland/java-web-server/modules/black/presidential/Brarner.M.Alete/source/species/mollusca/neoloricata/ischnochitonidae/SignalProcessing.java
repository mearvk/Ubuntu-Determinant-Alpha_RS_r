package presidential.Brarner.M.Alete.source.species.mollusca.neoloricata.ischnochitonidae;
...
/**
 * Signal Processing for Family: Ischnochitonidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/neoloricata/ischnochitonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17765; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/neoloricata/ischnochitonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Neoloricata"); ps.setString(3, "Ischnochitonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ischnochitonidae_audio", "species.mollusca.neoloricata.ischnochitonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ischnochitonidae_data", "species.mollusca.neoloricata.ischnochitonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ischnochitonidae_graphics", "species.mollusca.neoloricata.ischnochitonidae.graphics.spectrum", sb.toString());
        }
    }
}