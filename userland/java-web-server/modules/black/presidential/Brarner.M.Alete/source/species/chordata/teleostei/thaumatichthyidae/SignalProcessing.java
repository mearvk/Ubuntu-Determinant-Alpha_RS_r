package presidential.Brarner.M.Alete.source.species.chordata.teleostei.thaumatichthyidae;
...
/**
 * Signal Processing for Family: Thaumatichthyidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Ogcocephalioidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/thaumatichthyidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11936; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/thaumatichthyidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Thaumatichthyidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thaumatichthyidae_audio", "species.chordata.teleostei.thaumatichthyidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thaumatichthyidae_data", "species.chordata.teleostei.thaumatichthyidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thaumatichthyidae_graphics", "species.chordata.teleostei.thaumatichthyidae.graphics.spectrum", sb.toString());
        }
    }
}