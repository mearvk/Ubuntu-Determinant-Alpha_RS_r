package presidential.Brarner.M.Alete.source.species.annelida.tubificata.phreodrilidae;
...
/**
 * Signal Processing for Family: Phreodrilidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/tubificata/phreodrilidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16621; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/tubificata/phreodrilidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Tubificata"); ps.setString(3, "Phreodrilidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("phreodrilidae_audio", "species.annelida.tubificata.phreodrilidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("phreodrilidae_data", "species.annelida.tubificata.phreodrilidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("phreodrilidae_graphics", "species.annelida.tubificata.phreodrilidae.graphics.spectrum", sb.toString());
        }
    }
}