package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.falsicingulidae;
...
/**
 * Signal Processing for Family: Falsicingulidae
 * <p>Phylum: Mollusca | Class: Caenogastropoda | Order: Rissoidina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/falsicingulidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17219; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/falsicingulidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Falsicingulidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("falsicingulidae_audio", "species.mollusca.caenogastropoda.falsicingulidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("falsicingulidae_data", "species.mollusca.caenogastropoda.falsicingulidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("falsicingulidae_graphics", "species.mollusca.caenogastropoda.falsicingulidae.graphics.spectrum", sb.toString());
        }
    }
}