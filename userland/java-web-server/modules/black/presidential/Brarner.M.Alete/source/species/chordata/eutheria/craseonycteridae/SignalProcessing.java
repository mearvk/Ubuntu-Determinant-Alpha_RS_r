package presidential.Brarner.M.Alete.source.species.chordata.eutheria.craseonycteridae;
...
/**
 * Signal Processing for Family: Craseonycteridae
 * <p>Phylum: Chordata | Class: Eutheria | Order: Yinpterochiroptera</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/craseonycteridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12451; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/craseonycteridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Craseonycteridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("craseonycteridae_audio", "species.chordata.eutheria.craseonycteridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("craseonycteridae_data", "species.chordata.eutheria.craseonycteridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("craseonycteridae_graphics", "species.chordata.eutheria.craseonycteridae.graphics.spectrum", sb.toString());
        }
    }
}