package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.pterotracheoidea;
...
/**
 * Signal Processing for Family: Pterotracheoidea
 * <p>Phylum: Mollusca | Class: Caenogastropoda | Order: Littorinina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/pterotracheoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17190; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/pterotracheoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Pterotracheoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pterotracheoidea_audio", "species.mollusca.caenogastropoda.pterotracheoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pterotracheoidea_data", "species.mollusca.caenogastropoda.pterotracheoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pterotracheoidea_graphics", "species.mollusca.caenogastropoda.pterotracheoidea.graphics.spectrum", sb.toString());
        }
    }
}