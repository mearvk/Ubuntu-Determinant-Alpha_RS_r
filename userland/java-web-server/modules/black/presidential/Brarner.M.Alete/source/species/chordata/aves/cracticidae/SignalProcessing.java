package presidential.Brarner.M.Alete.source.species.chordata.aves.cracticidae;
...
/**
 * Signal Processing for Family: Cracticidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/cracticidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12234; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/cracticidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Cracticidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cracticidae_audio", "species.chordata.aves.cracticidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cracticidae_data", "species.chordata.aves.cracticidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cracticidae_graphics", "species.chordata.aves.cracticidae.graphics.spectrum", sb.toString());
        }
    }
}