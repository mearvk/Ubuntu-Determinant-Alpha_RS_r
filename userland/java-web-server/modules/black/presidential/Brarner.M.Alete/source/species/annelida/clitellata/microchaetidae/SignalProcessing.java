package presidential.Brarner.M.Alete.source.species.annelida.clitellata.microchaetidae;
...
/**
 * Signal Processing for Family: Microchaetidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/clitellata/microchaetidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16578; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/clitellata/microchaetidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Clitellata"); ps.setString(3, "Microchaetidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("microchaetidae_audio", "species.annelida.clitellata.microchaetidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("microchaetidae_data", "species.annelida.clitellata.microchaetidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("microchaetidae_graphics", "species.annelida.clitellata.microchaetidae.graphics.spectrum", sb.toString());
        }
    }
}