package presidential.Brarner.M.Alete.source.species.mollusca.patellogastropoda.neolepetopsidae;
...
/**
 * Signal Processing for Family: Neolepetopsidae
 * <p>Phylum: Mollusca | Class: Patellogastropoda | Order: Lottiina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/patellogastropoda/neolepetopsidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17124; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/patellogastropoda/neolepetopsidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Patellogastropoda"); ps.setString(3, "Neolepetopsidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("neolepetopsidae_audio", "species.mollusca.patellogastropoda.neolepetopsidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("neolepetopsidae_data", "species.mollusca.patellogastropoda.neolepetopsidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("neolepetopsidae_graphics", "species.mollusca.patellogastropoda.neolepetopsidae.graphics.spectrum", sb.toString());
        }
    }
}