package presidential.Brarner.M.Alete.source.species.chordata.reptilia.xenopeltidae;
...
/**
 * Signal Processing for Family: Xenopeltidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/reptilia/xenopeltidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12633; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/reptilia/xenopeltidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Reptilia"); ps.setString(3, "Xenopeltidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("xenopeltidae_audio", "species.chordata.reptilia.xenopeltidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("xenopeltidae_data", "species.chordata.reptilia.xenopeltidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("xenopeltidae_graphics", "species.chordata.reptilia.xenopeltidae.graphics.spectrum", sb.toString());
        }
    }
}