package presidential.Brarner.M.Alete.source.species.nematoda.chromadorea.schneidernematidae;
...
/**
 * Signal Processing for Family: Schneidernematidae
 * <p>Phylum: Nematoda | Class: Chromadorea | Order: Ascaridida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/chromadorea/schneidernematidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16315; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/chromadorea/schneidernematidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Chromadorea"); ps.setString(3, "Schneidernematidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("schneidernematidae_audio", "species.nematoda.chromadorea.schneidernematidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("schneidernematidae_data", "species.nematoda.chromadorea.schneidernematidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("schneidernematidae_graphics", "species.nematoda.chromadorea.schneidernematidae.graphics.spectrum", sb.toString());
        }
    }
}