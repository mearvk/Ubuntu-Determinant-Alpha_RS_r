package presidential.Brarner.M.Alete.source.species.annelida.echiura.echiuridae;
...
/**
 * Signal Processing for Family: Echiuridae
 * <p>Phylum: Annelida | Class: Echiura | Order: Echiurida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/echiura/echiuridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16644; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/echiura/echiuridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Echiura"); ps.setString(3, "Echiuridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("echiuridae_audio", "species.annelida.echiura.echiuridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("echiuridae_data", "species.annelida.echiura.echiuridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("echiuridae_graphics", "species.annelida.echiura.echiuridae.graphics.spectrum", sb.toString());
        }
    }
}