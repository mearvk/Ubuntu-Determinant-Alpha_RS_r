package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.omalogyroidea;
...
/**
 * Signal Processing for Family: Omalogyroidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Omalogyrina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/omalogyroidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17343; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/omalogyroidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Omalogyroidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("omalogyroidea_audio", "species.mollusca.heterobranchia.omalogyroidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("omalogyroidea_data", "species.mollusca.heterobranchia.omalogyroidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("omalogyroidea_graphics", "species.mollusca.heterobranchia.omalogyroidea.graphics.spectrum", sb.toString());
        }
    }
}