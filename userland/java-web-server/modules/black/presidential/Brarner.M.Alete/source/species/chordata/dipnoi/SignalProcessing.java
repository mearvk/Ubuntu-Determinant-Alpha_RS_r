package presidential.Brarner.M.Alete.source.species.chordata.dipnoi;
...
/**
 * Signal Processing for Phylum: Chordata, Class: Dipnoi
 * <p>Families: 4</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/dipnoi/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12042; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/dipnoi";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Dipnoi"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chordata_dipnoi_audio", "species.chordata.dipnoi.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chordata_dipnoi_data", "species.chordata.dipnoi.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chordata_dipnoi_graphics", "species.chordata.dipnoi.graphics.spectrum", sb.toString());
        }
    }
}