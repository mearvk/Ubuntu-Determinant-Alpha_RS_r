package presidential.Brarner.M.Alete.source.species.mollusca.coleoidea.vitreledonellidae;
...
/**
 * Signal Processing for Family: Vitreledonellidae
 * <p>Phylum: Mollusca | Class: Coleoidea | Order: Incirrina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/coleoidea/vitreledonellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17115; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/coleoidea/vitreledonellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Coleoidea"); ps.setString(3, "Vitreledonellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("vitreledonellidae_audio", "species.mollusca.coleoidea.vitreledonellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("vitreledonellidae_data", "species.mollusca.coleoidea.vitreledonellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("vitreledonellidae_graphics", "species.mollusca.coleoidea.vitreledonellidae.graphics.spectrum", sb.toString());
        }
    }
}