package presidential.Brarner.M.Alete.source.species.nemertea.pilidiophora.hubrechtidae;
...
/**
 * Signal Processing for Family: Hubrechtidae
 * <p>Phylum: Nemertea | Class: Pilidiophora | Order: Hubrechtida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nemertea/pilidiophora/hubrechtidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17834; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nemertea/pilidiophora/hubrechtidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nemertea"); ps.setString(2, "Pilidiophora"); ps.setString(3, "Hubrechtidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hubrechtidae_audio", "species.nemertea.pilidiophora.hubrechtidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hubrechtidae_data", "species.nemertea.pilidiophora.hubrechtidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hubrechtidae_graphics", "species.nemertea.pilidiophora.hubrechtidae.graphics.spectrum", sb.toString());
        }
    }
}