package presidential.Brarner.M.Alete.source.species.mollusca.patellogastropoda;
...
/**
 * Signal Processing for Phylum: Mollusca, Class: Patellogastropoda
 * <p>Families: 12</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/patellogastropoda/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17119; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/patellogastropoda";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Patellogastropoda"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mollusca_patellogastropoda_audio", "species.mollusca.patellogastropoda.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mollusca_patellogastropoda_data", "species.mollusca.patellogastropoda.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mollusca_patellogastropoda_graphics", "species.mollusca.patellogastropoda.graphics.spectrum", sb.toString());
        }
    }
}