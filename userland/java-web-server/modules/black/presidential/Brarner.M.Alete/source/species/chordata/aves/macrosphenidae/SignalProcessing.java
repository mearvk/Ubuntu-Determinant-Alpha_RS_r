package presidential.Brarner.M.Alete.source.species.chordata.aves.macrosphenidae;
...
/**
 * Signal Processing for Family: Macrosphenidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/macrosphenidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12262; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/macrosphenidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Macrosphenidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("macrosphenidae_audio", "species.chordata.aves.macrosphenidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("macrosphenidae_data", "species.chordata.aves.macrosphenidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("macrosphenidae_graphics", "species.chordata.aves.macrosphenidae.graphics.spectrum", sb.toString());
        }
    }
}