package presidential.Brarner.M.Alete.source.species.mollusca.neritimorpha.hydrocenoidea;
...
/**
 * Signal Processing for Family: Hydrocenoidea
 * <p>Phylum: Mollusca | Class: Neritimorpha | Order: Hydrocenina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/neritimorpha/hydrocenoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17694; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/neritimorpha/hydrocenoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Neritimorpha"); ps.setString(3, "Hydrocenoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hydrocenoidea_audio", "species.mollusca.neritimorpha.hydrocenoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hydrocenoidea_data", "species.mollusca.neritimorpha.hydrocenoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hydrocenoidea_graphics", "species.mollusca.neritimorpha.hydrocenoidea.graphics.spectrum", sb.toString());
        }
    }
}