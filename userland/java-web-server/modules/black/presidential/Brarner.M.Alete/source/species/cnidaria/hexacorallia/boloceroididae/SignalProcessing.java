package presidential.Brarner.M.Alete.source.species.cnidaria.hexacorallia.boloceroididae;
...
/**
 * Signal Processing for Family: Boloceroididae
 * <p>Phylum: Cnidaria | Class: Hexacorallia | Order: Boloceroidaria</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/boloceroididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11014; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/boloceroididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Boloceroididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("boloceroididae_audio", "species.cnidaria.hexacorallia.boloceroididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("boloceroididae_data", "species.cnidaria.hexacorallia.boloceroididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("boloceroididae_graphics", "species.cnidaria.hexacorallia.boloceroididae.graphics.spectrum", sb.toString());
        }
    }
}