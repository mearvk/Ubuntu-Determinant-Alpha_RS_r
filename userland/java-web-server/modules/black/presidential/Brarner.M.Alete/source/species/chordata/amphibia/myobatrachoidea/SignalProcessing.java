package presidential.Brarner.M.Alete.source.species.chordata.amphibia.myobatrachoidea;
...
/**
 * Signal Processing for Family: Myobatrachoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/amphibia/myobatrachoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12109; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/amphibia/myobatrachoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Amphibia"); ps.setString(3, "Myobatrachoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("myobatrachoidea_audio", "species.chordata.amphibia.myobatrachoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("myobatrachoidea_data", "species.chordata.amphibia.myobatrachoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("myobatrachoidea_graphics", "species.chordata.amphibia.myobatrachoidea.graphics.spectrum", sb.toString());
        }
    }
}