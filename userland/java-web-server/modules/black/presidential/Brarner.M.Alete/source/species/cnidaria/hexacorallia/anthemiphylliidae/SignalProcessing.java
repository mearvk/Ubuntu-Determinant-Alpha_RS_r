...
/**
 * Signal Processing for Family: Anthemiphylliidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/anthemiphylliidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11067; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/anthemiphylliidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Anthemiphylliidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("anthemiphylliidae_audio", "species.cnidaria.hexacorallia.anthemiphylliidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("anthemiphylliidae_data", "species.cnidaria.hexacorallia.anthemiphylliidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("anthemiphylliidae_graphics", "species.cnidaria.hexacorallia.anthemiphylliidae.graphics.spectrum", sb.toString());
        }
    }
}