package presidential.Brarner.M.Alete.source.species.chordata.coelacanthi;
...
/**
 * Signal Processing for Phylum: Chordata, Class: Coelacanthi
 * <p>Families: 2</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/coelacanthi/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12039; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/coelacanthi";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Coelacanthi"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chordata_coelacanthi_audio", "species.chordata.coelacanthi.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chordata_coelacanthi_data", "species.chordata.coelacanthi.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chordata_coelacanthi_graphics", "species.chordata.coelacanthi.graphics.spectrum", sb.toString());
        }
    }
}