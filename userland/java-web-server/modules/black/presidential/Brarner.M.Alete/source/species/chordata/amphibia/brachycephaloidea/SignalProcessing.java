package presidential.Brarner.M.Alete.source.species.chordata.amphibia.brachycephaloidea;
...
/**
 * Signal Processing for Family: Brachycephaloidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/amphibia/brachycephaloidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12098; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/amphibia/brachycephaloidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Amphibia"); ps.setString(3, "Brachycephaloidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("brachycephaloidea_audio", "species.chordata.amphibia.brachycephaloidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("brachycephaloidea_data", "species.chordata.amphibia.brachycephaloidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("brachycephaloidea_graphics", "species.chordata.amphibia.brachycephaloidea.graphics.spectrum", sb.toString());
        }
    }
}