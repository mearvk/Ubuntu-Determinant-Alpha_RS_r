package presidential.Brarner.M.Alete.source.species.annelida.clitellata.megascolecoidea;
...
/**
 * Signal Processing for Family: Megascolecoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/clitellata/megascolecoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16589; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/clitellata/megascolecoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Clitellata"); ps.setString(3, "Megascolecoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("megascolecoidea_audio", "species.annelida.clitellata.megascolecoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("megascolecoidea_data", "species.annelida.clitellata.megascolecoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("megascolecoidea_graphics", "species.annelida.clitellata.megascolecoidea.graphics.spectrum", sb.toString());
        }
    }
}