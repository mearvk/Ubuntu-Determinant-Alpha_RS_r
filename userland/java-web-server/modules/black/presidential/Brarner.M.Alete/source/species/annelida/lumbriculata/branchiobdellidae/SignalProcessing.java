package presidential.Brarner.M.Alete.source.species.annelida.lumbriculata.branchiobdellidae;
...
/**
 * Signal Processing for Family: Branchiobdellidae
 * <p>Phylum: Annelida | Class: Lumbriculata | Order: Branchiobdellida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/lumbriculata/branchiobdellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16596; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/lumbriculata/branchiobdellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Lumbriculata"); ps.setString(3, "Branchiobdellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("branchiobdellidae_audio", "species.annelida.lumbriculata.branchiobdellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("branchiobdellidae_data", "species.annelida.lumbriculata.branchiobdellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("branchiobdellidae_graphics", "species.annelida.lumbriculata.branchiobdellidae.graphics.spectrum", sb.toString());
        }
    }
}