package presidential.Brarner.M.Alete.source.species.chordata.ascidiacea.polycitoridae;
...
/**
 * Signal Processing for Family: Polycitoridae
 * <p>Phylum: Chordata | Class: Ascidiacea | Order: Aplousobranchia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/ascidiacea/polycitoridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11486; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/ascidiacea/polycitoridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Ascidiacea"); ps.setString(3, "Polycitoridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("polycitoridae_audio", "species.chordata.ascidiacea.polycitoridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("polycitoridae_data", "species.chordata.ascidiacea.polycitoridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("polycitoridae_graphics", "species.chordata.ascidiacea.polycitoridae.graphics.spectrum", sb.toString());
        }
    }
}