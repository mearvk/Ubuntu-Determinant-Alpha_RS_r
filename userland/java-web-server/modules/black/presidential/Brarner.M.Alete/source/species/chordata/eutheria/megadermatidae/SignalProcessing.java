package presidential.Brarner.M.Alete.source.species.chordata.eutheria.megadermatidae;
...
/**
 * Signal Processing for Family: Megadermatidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/megadermatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12453; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/megadermatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Megadermatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("megadermatidae_audio", "species.chordata.eutheria.megadermatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("megadermatidae_data", "species.chordata.eutheria.megadermatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("megadermatidae_graphics", "species.chordata.eutheria.megadermatidae.graphics.spectrum", sb.toString());
        }
    }
}