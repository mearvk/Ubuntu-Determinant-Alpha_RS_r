package presidential.Brarner.M.Alete.source.species.mollusca.neritimorpha.neritilioidea;
...
/**
 * Signal Processing for Family: Neritilioidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/neritimorpha/neritilioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17691; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/neritimorpha/neritilioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Neritimorpha"); ps.setString(3, "Neritilioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("neritilioidea_audio", "species.mollusca.neritimorpha.neritilioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("neritilioidea_data", "species.mollusca.neritimorpha.neritilioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("neritilioidea_graphics", "species.mollusca.neritimorpha.neritilioidea.graphics.spectrum", sb.toString());
        }
    }
}