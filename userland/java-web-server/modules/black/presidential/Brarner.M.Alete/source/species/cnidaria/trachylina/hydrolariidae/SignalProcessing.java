package presidential.Brarner.M.Alete.source.species.cnidaria.trachylina.hydrolariidae;
...
/**
 * Signal Processing for Family: Hydrolariidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/trachylina/hydrolariidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11225; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/trachylina/hydrolariidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Trachylina"); ps.setString(3, "Hydrolariidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hydrolariidae_audio", "species.cnidaria.trachylina.hydrolariidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hydrolariidae_data", "species.cnidaria.trachylina.hydrolariidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hydrolariidae_graphics", "species.cnidaria.trachylina.hydrolariidae.graphics.spectrum", sb.toString());
        }
    }
}