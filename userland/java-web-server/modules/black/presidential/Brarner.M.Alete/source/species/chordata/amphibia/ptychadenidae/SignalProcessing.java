package presidential.Brarner.M.Alete.source.species.chordata.amphibia.ptychadenidae;
...
/**
 * Signal Processing for Family: Ptychadenidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/amphibia/ptychadenidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12088; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/amphibia/ptychadenidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Amphibia"); ps.setString(3, "Ptychadenidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ptychadenidae_audio", "species.chordata.amphibia.ptychadenidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ptychadenidae_data", "species.chordata.amphibia.ptychadenidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ptychadenidae_graphics", "species.chordata.amphibia.ptychadenidae.graphics.spectrum", sb.toString());
        }
    }
}