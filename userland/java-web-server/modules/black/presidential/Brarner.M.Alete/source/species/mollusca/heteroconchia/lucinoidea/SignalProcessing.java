package presidential.Brarner.M.Alete.source.species.mollusca.heteroconchia.lucinoidea;
...
/**
 * Signal Processing for Family: Lucinoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heteroconchia/lucinoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16912; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heteroconchia/lucinoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heteroconchia"); ps.setString(3, "Lucinoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lucinoidea_audio", "species.mollusca.heteroconchia.lucinoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lucinoidea_data", "species.mollusca.heteroconchia.lucinoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lucinoidea_graphics", "species.mollusca.heteroconchia.lucinoidea.graphics.spectrum", sb.toString());
        }
    }
}