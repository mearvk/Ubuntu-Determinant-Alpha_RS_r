package presidential.Brarner.M.Alete.source.species.annelida.polychaeta.eenymeenymyzostomatidae;
...
/**
 * Signal Processing for Family: Eenymeenymyzostomatidae
 * <p>Phylum: Annelida | Class: Polychaeta | Order: Myzostomida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/polychaeta/eenymeenymyzostomatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16636; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/polychaeta/eenymeenymyzostomatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Polychaeta"); ps.setString(3, "Eenymeenymyzostomatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("eenymeenymyzostomatidae_audio", "species.annelida.polychaeta.eenymeenymyzostomatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("eenymeenymyzostomatidae_data", "species.annelida.polychaeta.eenymeenymyzostomatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("eenymeenymyzostomatidae_graphics", "species.annelida.polychaeta.eenymeenymyzostomatidae.graphics.spectrum", sb.toString());
        }
    }
}