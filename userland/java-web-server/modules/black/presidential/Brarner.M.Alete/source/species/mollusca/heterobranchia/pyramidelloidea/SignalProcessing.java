package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.pyramidelloidea;
...
/**
 * Signal Processing for Family: Pyramidelloidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Pyramidellida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/pyramidelloidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17520; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/pyramidelloidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Pyramidelloidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pyramidelloidea_audio", "species.mollusca.heterobranchia.pyramidelloidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pyramidelloidea_data", "species.mollusca.heterobranchia.pyramidelloidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pyramidelloidea_graphics", "species.mollusca.heterobranchia.pyramidelloidea.graphics.spectrum", sb.toString());
        }
    }
}