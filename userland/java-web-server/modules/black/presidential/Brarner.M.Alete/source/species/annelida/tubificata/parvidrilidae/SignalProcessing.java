...
/**
 * Signal Processing for Family: Parvidrilidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/tubificata/parvidrilidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16620; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/tubificata/parvidrilidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Tubificata"); ps.setString(3, "Parvidrilidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("parvidrilidae_audio", "species.annelida.tubificata.parvidrilidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("parvidrilidae_data", "species.annelida.tubificata.parvidrilidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("parvidrilidae_graphics", "species.annelida.tubificata.parvidrilidae.graphics.spectrum", sb.toString());
        }
    }
}