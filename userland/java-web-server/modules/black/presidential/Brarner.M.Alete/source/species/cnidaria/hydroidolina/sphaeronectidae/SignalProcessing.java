package presidential.Brarner.M.Alete.source.species.cnidaria.hydroidolina.sphaeronectidae;
...
/**
 * Signal Processing for Family: Sphaeronectidae
 * <p>Phylum: Cnidaria | Class: Hydroidolina | Order: Calycophorae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hydroidolina/sphaeronectidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11211; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hydroidolina/sphaeronectidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hydroidolina"); ps.setString(3, "Sphaeronectidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sphaeronectidae_audio", "species.cnidaria.hydroidolina.sphaeronectidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sphaeronectidae_data", "species.cnidaria.hydroidolina.sphaeronectidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sphaeronectidae_graphics", "species.cnidaria.hydroidolina.sphaeronectidae.graphics.spectrum", sb.toString());
        }
    }
}