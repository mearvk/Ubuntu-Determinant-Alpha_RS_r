package presidential.Brarner.M.Alete.source.species.chordata.cephalaspidomorphi;
...
/**
 * Signal Processing for Phylum: Chordata, Class: Cephalaspidomorphi
 * <p>Families: 3</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/cephalaspidomorphi/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11502; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/cephalaspidomorphi";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Cephalaspidomorphi"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chordata_cephalaspidomorphi_audio", "species.chordata.cephalaspidomorphi.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chordata_cephalaspidomorphi_data", "species.chordata.cephalaspidomorphi.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chordata_cephalaspidomorphi_graphics", "species.chordata.cephalaspidomorphi.graphics.spectrum", sb.toString());
        }
    }
}