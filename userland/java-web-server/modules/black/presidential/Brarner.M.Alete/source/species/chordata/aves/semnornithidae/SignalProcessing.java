package presidential.Brarner.M.Alete.source.species.chordata.aves.semnornithidae;
...
/**
 * Signal Processing for Family: Semnornithidae
 * <p>Phylum: Chordata | Class: Aves | Order: Piciformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/semnornithidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12362; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/semnornithidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Semnornithidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("semnornithidae_audio", "species.chordata.aves.semnornithidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("semnornithidae_data", "species.chordata.aves.semnornithidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("semnornithidae_graphics", "species.chordata.aves.semnornithidae.graphics.spectrum", sb.toString());
        }
    }
}