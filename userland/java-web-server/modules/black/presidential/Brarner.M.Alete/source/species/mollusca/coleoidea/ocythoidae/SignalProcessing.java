package presidential.Brarner.M.Alete.source.species.mollusca.coleoidea.ocythoidae;
...
/**
 * Signal Processing for Family: Ocythoidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/coleoidea/ocythoidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17113; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/coleoidea/ocythoidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Coleoidea"); ps.setString(3, "Ocythoidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ocythoidae_audio", "species.mollusca.coleoidea.ocythoidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ocythoidae_data", "species.mollusca.coleoidea.ocythoidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ocythoidae_graphics", "species.mollusca.coleoidea.ocythoidae.graphics.spectrum", sb.toString());
        }
    }
}