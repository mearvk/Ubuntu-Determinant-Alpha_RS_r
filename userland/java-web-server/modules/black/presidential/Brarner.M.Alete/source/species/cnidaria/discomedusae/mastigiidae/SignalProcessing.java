package presidential.Brarner.M.Alete.source.species.cnidaria.discomedusae.mastigiidae;
...
/**
 * Signal Processing for Family: Mastigiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/discomedusae/mastigiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11250; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/discomedusae/mastigiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Discomedusae"); ps.setString(3, "Mastigiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mastigiidae_audio", "species.cnidaria.discomedusae.mastigiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mastigiidae_data", "species.cnidaria.discomedusae.mastigiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mastigiidae_graphics", "species.cnidaria.discomedusae.mastigiidae.graphics.spectrum", sb.toString());
        }
    }
}