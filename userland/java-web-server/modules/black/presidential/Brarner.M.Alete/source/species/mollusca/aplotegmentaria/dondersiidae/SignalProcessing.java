package presidential.Brarner.M.Alete.source.species.mollusca.aplotegmentaria.dondersiidae;
...
/**
 * Signal Processing for Family: Dondersiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/aplotegmentaria/dondersiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17792; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/aplotegmentaria/dondersiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Aplotegmentaria"); ps.setString(3, "Dondersiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dondersiidae_audio", "species.mollusca.aplotegmentaria.dondersiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dondersiidae_data", "species.mollusca.aplotegmentaria.dondersiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dondersiidae_graphics", "species.mollusca.aplotegmentaria.dondersiidae.graphics.spectrum", sb.toString());
        }
    }
}