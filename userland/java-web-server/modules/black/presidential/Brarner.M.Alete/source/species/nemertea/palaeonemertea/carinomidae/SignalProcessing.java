package presidential.Brarner.M.Alete.source.species.nemertea.palaeonemertea.carinomidae;
...
/**
 * Signal Processing for Family: Carinomidae
 * <p>Phylum: Nemertea | Class: Palaeonemertea | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nemertea/palaeonemertea/carinomidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17836; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nemertea/palaeonemertea/carinomidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nemertea"); ps.setString(2, "Palaeonemertea"); ps.setString(3, "Carinomidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("carinomidae_audio", "species.nemertea.palaeonemertea.carinomidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("carinomidae_data", "species.nemertea.palaeonemertea.carinomidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("carinomidae_graphics", "species.nemertea.palaeonemertea.carinomidae.graphics.spectrum", sb.toString());
        }
    }
}