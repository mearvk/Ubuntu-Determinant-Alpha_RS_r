package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.pneumodermatidae;
...
/**
 * Signal Processing for Family: Pneumodermatidae
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Gymnosomata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/pneumodermatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17386; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/pneumodermatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Pneumodermatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pneumodermatidae_audio", "species.mollusca.heterobranchia.pneumodermatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pneumodermatidae_data", "species.mollusca.heterobranchia.pneumodermatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pneumodermatidae_graphics", "species.mollusca.heterobranchia.pneumodermatidae.graphics.spectrum", sb.toString());
        }
    }
}