package presidential.Brarner.M.Alete.source.species.chordata.elasmobranchii.potamotrygonidae;
...
/**
 * Signal Processing for Family: Potamotrygonidae
 * <p>Phylum: Chordata | Class: Elasmobranchii | Order: Myliobatiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/elasmobranchii/potamotrygonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12004; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/elasmobranchii/potamotrygonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Elasmobranchii"); ps.setString(3, "Potamotrygonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("potamotrygonidae_audio", "species.chordata.elasmobranchii.potamotrygonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("potamotrygonidae_data", "species.chordata.elasmobranchii.potamotrygonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("potamotrygonidae_graphics", "species.chordata.elasmobranchii.potamotrygonidae.graphics.spectrum", sb.toString());
        }
    }
}