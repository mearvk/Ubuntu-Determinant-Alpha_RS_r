package presidential.Brarner.M.Alete.source.species.mollusca.scaphopoda.dentaliidae;
...
/**
 * Signal Processing for Family: Dentaliidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/scaphopoda/dentaliidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17774; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/scaphopoda/dentaliidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Scaphopoda"); ps.setString(3, "Dentaliidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dentaliidae_audio", "species.mollusca.scaphopoda.dentaliidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dentaliidae_data", "species.mollusca.scaphopoda.dentaliidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dentaliidae_graphics", "species.mollusca.scaphopoda.dentaliidae.graphics.spectrum", sb.toString());
        }
    }
}