package presidential.Brarner.M.Alete.source.species.chordata.reptilia.trionychoidea;
...
/**
 * Signal Processing for Family: Trionychoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/reptilia/trionychoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12652; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/reptilia/trionychoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Reptilia"); ps.setString(3, "Trionychoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("trionychoidea_audio", "species.chordata.reptilia.trionychoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("trionychoidea_data", "species.chordata.reptilia.trionychoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("trionychoidea_graphics", "species.chordata.reptilia.trionychoidea.graphics.spectrum", sb.toString());
        }
    }
}