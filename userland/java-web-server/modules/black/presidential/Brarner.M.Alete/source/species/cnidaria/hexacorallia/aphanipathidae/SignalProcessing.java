package presidential.Brarner.M.Alete.source.species.cnidaria.hexacorallia.aphanipathidae;
...
/**
 * Signal Processing for Family: Aphanipathidae
 * <p>Phylum: Cnidaria | Class: Hexacorallia | Order: Antipatharia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/aphanipathidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11049; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/aphanipathidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Aphanipathidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("aphanipathidae_audio", "species.cnidaria.hexacorallia.aphanipathidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("aphanipathidae_data", "species.cnidaria.hexacorallia.aphanipathidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("aphanipathidae_graphics", "species.cnidaria.hexacorallia.aphanipathidae.graphics.spectrum", sb.toString());
        }
    }
}