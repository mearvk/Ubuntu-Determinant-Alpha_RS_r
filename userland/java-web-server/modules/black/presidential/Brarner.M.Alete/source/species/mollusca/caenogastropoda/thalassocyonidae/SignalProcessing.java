package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.thalassocyonidae;
...
/**
 * Signal Processing for Family: Thalassocyonidae
 * <p>Phylum: Mollusca | Class: Caenogastropoda | Order: Tonnida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/thalassocyonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17324; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/thalassocyonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Thalassocyonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thalassocyonidae_audio", "species.mollusca.caenogastropoda.thalassocyonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thalassocyonidae_data", "species.mollusca.caenogastropoda.thalassocyonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thalassocyonidae_graphics", "species.mollusca.caenogastropoda.thalassocyonidae.graphics.spectrum", sb.toString());
        }
    }
}