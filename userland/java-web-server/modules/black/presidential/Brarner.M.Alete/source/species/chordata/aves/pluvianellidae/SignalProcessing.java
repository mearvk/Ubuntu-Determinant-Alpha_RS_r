package presidential.Brarner.M.Alete.source.species.chordata.aves.pluvianellidae;
...
/**
 * Signal Processing for Family: Pluvianellidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/pluvianellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12164; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/pluvianellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Pluvianellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pluvianellidae_audio", "species.chordata.aves.pluvianellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pluvianellidae_data", "species.chordata.aves.pluvianellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pluvianellidae_graphics", "species.chordata.aves.pluvianellidae.graphics.spectrum", sb.toString());
        }
    }
}