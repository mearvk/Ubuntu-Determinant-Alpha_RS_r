package presidential.Brarner.M.Alete.source.species.cnidaria.hydroidolina.cytaeididae;
...
/**
 * Signal Processing for Family: Cytaeididae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hydroidolina/cytaeididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11167; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hydroidolina/cytaeididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hydroidolina"); ps.setString(3, "Cytaeididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cytaeididae_audio", "species.cnidaria.hydroidolina.cytaeididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cytaeididae_data", "species.cnidaria.hydroidolina.cytaeididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cytaeididae_graphics", "species.cnidaria.hydroidolina.cytaeididae.graphics.spectrum", sb.toString());
        }
    }
}