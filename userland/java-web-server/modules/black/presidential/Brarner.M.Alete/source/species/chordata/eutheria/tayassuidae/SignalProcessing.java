package presidential.Brarner.M.Alete.source.species.chordata.eutheria.tayassuidae;
...
/**
 * Signal Processing for Family: Tayassuidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/tayassuidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12400; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/tayassuidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Tayassuidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tayassuidae_audio", "species.chordata.eutheria.tayassuidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tayassuidae_data", "species.chordata.eutheria.tayassuidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tayassuidae_graphics", "species.chordata.eutheria.tayassuidae.graphics.spectrum", sb.toString());
        }
    }
}