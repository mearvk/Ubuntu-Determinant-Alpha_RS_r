package presidential.Brarner.M.Alete.source.species.chordata.reptilia.cordylidae;
...
/**
 * Signal Processing for Family: Cordylidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/reptilia/cordylidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12577; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/reptilia/cordylidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Reptilia"); ps.setString(3, "Cordylidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cordylidae_audio", "species.chordata.reptilia.cordylidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cordylidae_data", "species.chordata.reptilia.cordylidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cordylidae_graphics", "species.chordata.reptilia.cordylidae.graphics.spectrum", sb.toString());
        }
    }
}