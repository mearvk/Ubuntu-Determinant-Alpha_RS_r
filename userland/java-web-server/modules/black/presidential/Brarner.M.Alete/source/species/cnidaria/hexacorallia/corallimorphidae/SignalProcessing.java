package presidential.Brarner.M.Alete.source.species.cnidaria.hexacorallia.corallimorphidae;
...
/**
 * Signal Processing for Family: Corallimorphidae
 * <p>Phylum: Cnidaria | Class: Hexacorallia | Order: Corallimorpharia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/corallimorphidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11057; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/corallimorphidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Corallimorphidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("corallimorphidae_audio", "species.cnidaria.hexacorallia.corallimorphidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("corallimorphidae_data", "species.cnidaria.hexacorallia.corallimorphidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("corallimorphidae_graphics", "species.cnidaria.hexacorallia.corallimorphidae.graphics.spectrum", sb.toString());
        }
    }
}