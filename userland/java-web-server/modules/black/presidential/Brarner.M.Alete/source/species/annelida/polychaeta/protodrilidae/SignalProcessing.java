package presidential.Brarner.M.Alete.source.species.annelida.polychaeta.protodrilidae;
...
/**
 * Signal Processing for Family: Protodrilidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/polychaeta/protodrilidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16630; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/polychaeta/protodrilidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Polychaeta"); ps.setString(3, "Protodrilidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("protodrilidae_audio", "species.annelida.polychaeta.protodrilidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("protodrilidae_data", "species.annelida.polychaeta.protodrilidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("protodrilidae_graphics", "species.annelida.polychaeta.protodrilidae.graphics.spectrum", sb.toString());
        }
    }
}