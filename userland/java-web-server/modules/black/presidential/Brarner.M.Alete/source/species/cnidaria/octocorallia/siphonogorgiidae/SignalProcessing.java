package presidential.Brarner.M.Alete.source.species.cnidaria.octocorallia.siphonogorgiidae;
...
/**
 * Signal Processing for Family: Siphonogorgiidae
 * <p>Phylum: Cnidaria | Class: Octocorallia | Order: Alcyonacea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/octocorallia/siphonogorgiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11092; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/octocorallia/siphonogorgiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Octocorallia"); ps.setString(3, "Siphonogorgiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("siphonogorgiidae_audio", "species.cnidaria.octocorallia.siphonogorgiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("siphonogorgiidae_data", "species.cnidaria.octocorallia.siphonogorgiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("siphonogorgiidae_graphics", "species.cnidaria.octocorallia.siphonogorgiidae.graphics.spectrum", sb.toString());
        }
    }
}