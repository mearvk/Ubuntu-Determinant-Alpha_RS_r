package presidential.Brarner.M.Alete.source.species.bryozoa.stenolaemata.corymboporidae;
...
/**
 * Signal Processing for Family: Corymboporidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/stenolaemata/corymboporidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16873; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/stenolaemata/corymboporidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Stenolaemata"); ps.setString(3, "Corymboporidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("corymboporidae_audio", "species.bryozoa.stenolaemata.corymboporidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("corymboporidae_data", "species.bryozoa.stenolaemata.corymboporidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("corymboporidae_graphics", "species.bryozoa.stenolaemata.corymboporidae.graphics.spectrum", sb.toString());
        }
    }
}