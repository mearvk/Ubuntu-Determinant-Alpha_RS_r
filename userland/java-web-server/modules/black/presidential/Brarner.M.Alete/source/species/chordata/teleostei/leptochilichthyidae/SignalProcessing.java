package presidential.Brarner.M.Alete.source.species.chordata.teleostei.leptochilichthyidae;
...
/**
 * Signal Processing for Family: Leptochilichthyidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Argentinoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/leptochilichthyidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11955; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/leptochilichthyidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Leptochilichthyidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("leptochilichthyidae_audio", "species.chordata.teleostei.leptochilichthyidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("leptochilichthyidae_data", "species.chordata.teleostei.leptochilichthyidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("leptochilichthyidae_graphics", "species.chordata.teleostei.leptochilichthyidae.graphics.spectrum", sb.toString());
        }
    }
}