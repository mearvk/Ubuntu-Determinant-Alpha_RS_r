package presidential.Brarner.M.Alete.source.species.mollusca.heteroconchia.saxicavellidae;
...
/**
 * Signal Processing for Family: Saxicavellidae
 * <p>Phylum: Mollusca | Class: Heteroconchia | Order: Solenida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heteroconchia/saxicavellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16949; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heteroconchia/saxicavellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heteroconchia"); ps.setString(3, "Saxicavellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("saxicavellidae_audio", "species.mollusca.heteroconchia.saxicavellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("saxicavellidae_data", "species.mollusca.heteroconchia.saxicavellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("saxicavellidae_graphics", "species.mollusca.heteroconchia.saxicavellidae.graphics.spectrum", sb.toString());
        }
    }
}