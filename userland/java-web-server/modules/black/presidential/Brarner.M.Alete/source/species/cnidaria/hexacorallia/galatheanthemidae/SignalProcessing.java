package presidential.Brarner.M.Alete.source.species.cnidaria.hexacorallia.galatheanthemidae;
...
/**
 * Signal Processing for Family: Galatheanthemidae
 * <p>Phylum: Cnidaria | Class: Hexacorallia | Order: Athenaria</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/galatheanthemidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11006; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/galatheanthemidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Galatheanthemidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("galatheanthemidae_audio", "species.cnidaria.hexacorallia.galatheanthemidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("galatheanthemidae_data", "species.cnidaria.hexacorallia.galatheanthemidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("galatheanthemidae_graphics", "species.cnidaria.hexacorallia.galatheanthemidae.graphics.spectrum", sb.toString());
        }
    }
}