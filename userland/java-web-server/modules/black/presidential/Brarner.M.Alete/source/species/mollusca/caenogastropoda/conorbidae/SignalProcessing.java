package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.conorbidae;
...
/**
 * Signal Processing for Family: Conorbidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/conorbidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17279; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/conorbidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Conorbidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("conorbidae_audio", "species.mollusca.caenogastropoda.conorbidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("conorbidae_data", "species.mollusca.caenogastropoda.conorbidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("conorbidae_graphics", "species.mollusca.caenogastropoda.conorbidae.graphics.spectrum", sb.toString());
        }
    }
}