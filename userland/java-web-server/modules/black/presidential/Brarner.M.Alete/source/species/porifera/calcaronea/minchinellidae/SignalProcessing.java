...
/**
 * Signal Processing for Family: Minchinellidae
 * <p>Phylum: Porifera | Class: Calcaronea | Order: Lithonida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/calcaronea/minchinellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11324; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/calcaronea/minchinellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Calcaronea"); ps.setString(3, "Minchinellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("minchinellidae_audio", "species.porifera.calcaronea.minchinellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("minchinellidae_data", "species.porifera.calcaronea.minchinellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("minchinellidae_graphics", "species.porifera.calcaronea.minchinellidae.graphics.spectrum", sb.toString());
        }
    }
}