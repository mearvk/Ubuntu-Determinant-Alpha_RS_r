package presidential.Brarner.M.Alete.source.species.chordata.eutheria.hipposideridae;
...
/**
 * Signal Processing for Family: Hipposideridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/hipposideridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12452; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/hipposideridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Hipposideridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hipposideridae_audio", "species.chordata.eutheria.hipposideridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hipposideridae_data", "species.chordata.eutheria.hipposideridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hipposideridae_graphics", "species.chordata.eutheria.hipposideridae.graphics.spectrum", sb.toString());
        }
    }
}