package presidential.Brarner.M.Alete.source.species.chordata.ascidiacea.hypobythiidae;
...
/**
 * Signal Processing for Family: Hypobythiidae
 * <p>Phylum: Chordata | Class: Ascidiacea | Order: Phlebobranchia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/ascidiacea/hypobythiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11493; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/ascidiacea/hypobythiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Ascidiacea"); ps.setString(3, "Hypobythiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hypobythiidae_audio", "species.chordata.ascidiacea.hypobythiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hypobythiidae_data", "species.chordata.ascidiacea.hypobythiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hypobythiidae_graphics", "species.chordata.ascidiacea.hypobythiidae.graphics.spectrum", sb.toString());
        }
    }
}