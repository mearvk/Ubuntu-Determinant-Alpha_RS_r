package presidential.Brarner.M.Alete.source.species.cnidaria.staurozoa.kishinouyeidae;
...
/**
 * Signal Processing for Family: Kishinouyeidae
 * <p>Phylum: Cnidaria | Class: Staurozoa | Order: Eleutherocarpida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/staurozoa/kishinouyeidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11266; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/staurozoa/kishinouyeidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Staurozoa"); ps.setString(3, "Kishinouyeidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("kishinouyeidae_audio", "species.cnidaria.staurozoa.kishinouyeidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("kishinouyeidae_data", "species.cnidaria.staurozoa.kishinouyeidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("kishinouyeidae_graphics", "species.cnidaria.staurozoa.kishinouyeidae.graphics.spectrum", sb.toString());
        }
    }
}