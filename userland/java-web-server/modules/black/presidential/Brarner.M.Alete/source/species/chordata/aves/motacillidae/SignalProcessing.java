package presidential.Brarner.M.Alete.source.species.chordata.aves.motacillidae;
...
/**
 * Signal Processing for Family: Motacillidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/motacillidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12275; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/motacillidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Motacillidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("motacillidae_audio", "species.chordata.aves.motacillidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("motacillidae_data", "species.chordata.aves.motacillidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("motacillidae_graphics", "species.chordata.aves.motacillidae.graphics.spectrum", sb.toString());
        }
    }
}