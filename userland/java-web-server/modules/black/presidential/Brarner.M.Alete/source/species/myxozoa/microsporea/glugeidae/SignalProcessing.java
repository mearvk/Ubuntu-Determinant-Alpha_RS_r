package presidential.Brarner.M.Alete.source.species.myxozoa.microsporea.glugeidae;
...
/**
 * Signal Processing for Family: Glugeidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/myxozoa/microsporea/glugeidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11301; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/myxozoa/microsporea/glugeidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Myxozoa"); ps.setString(2, "Microsporea"); ps.setString(3, "Glugeidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("glugeidae_audio", "species.myxozoa.microsporea.glugeidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("glugeidae_data", "species.myxozoa.microsporea.glugeidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("glugeidae_graphics", "species.myxozoa.microsporea.glugeidae.graphics.spectrum", sb.toString());
        }
    }
}