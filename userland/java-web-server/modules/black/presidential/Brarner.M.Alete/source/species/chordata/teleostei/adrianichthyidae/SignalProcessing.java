package presidential.Brarner.M.Alete.source.species.chordata.teleostei.adrianichthyidae;
...
/**
 * Signal Processing for Family: Adrianichthyidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Adrianichthyoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/adrianichthyidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11523; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/adrianichthyidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Adrianichthyidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("adrianichthyidae_audio", "species.chordata.teleostei.adrianichthyidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("adrianichthyidae_data", "species.chordata.teleostei.adrianichthyidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("adrianichthyidae_graphics", "species.chordata.teleostei.adrianichthyidae.graphics.spectrum", sb.toString());
        }
    }
}