package presidential.Brarner.M.Alete.source.species.cnidaria.trachylina.tetraplatidae;
...
/**
 * Signal Processing for Family: Tetraplatidae
 * <p>Phylum: Cnidaria | Class: Trachylina | Order: Narcomedusae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/trachylina/tetraplatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11228; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/trachylina/tetraplatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Trachylina"); ps.setString(3, "Tetraplatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tetraplatidae_audio", "species.cnidaria.trachylina.tetraplatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tetraplatidae_data", "species.cnidaria.trachylina.tetraplatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tetraplatidae_graphics", "species.cnidaria.trachylina.tetraplatidae.graphics.spectrum", sb.toString());
        }
    }
}