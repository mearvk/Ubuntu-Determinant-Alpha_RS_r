package presidential.Brarner.M.Alete.source.species.chordata.teleostei.lepidogalaxiidae;
...
/**
 * Signal Processing for Family: Lepidogalaxiidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Osmeroidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/lepidogalaxiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11964; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/lepidogalaxiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Lepidogalaxiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lepidogalaxiidae_audio", "species.chordata.teleostei.lepidogalaxiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lepidogalaxiidae_data", "species.chordata.teleostei.lepidogalaxiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lepidogalaxiidae_graphics", "species.chordata.teleostei.lepidogalaxiidae.graphics.spectrum", sb.toString());
        }
    }
}