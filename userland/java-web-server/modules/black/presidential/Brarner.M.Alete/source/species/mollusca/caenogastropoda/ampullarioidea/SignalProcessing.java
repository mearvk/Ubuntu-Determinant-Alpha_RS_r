package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.ampullarioidea;
...
/**
 * Signal Processing for Family: Ampullarioidea
 * <p>Phylum: Mollusca | Class: Caenogastropoda | Order: Ampullariida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/ampullarioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17134; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/ampullarioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Ampullarioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ampullarioidea_audio", "species.mollusca.caenogastropoda.ampullarioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ampullarioidea_data", "species.mollusca.caenogastropoda.ampullarioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ampullarioidea_graphics", "species.mollusca.caenogastropoda.ampullarioidea.graphics.spectrum", sb.toString());
        }
    }
}