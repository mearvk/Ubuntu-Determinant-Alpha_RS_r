package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.trigonochlamydidae;
...
/**
 * Signal Processing for Family: Trigonochlamydidae
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Limacoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/trigonochlamydidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17617; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/trigonochlamydidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Trigonochlamydidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("trigonochlamydidae_audio", "species.mollusca.heterobranchia.trigonochlamydidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("trigonochlamydidae_data", "species.mollusca.heterobranchia.trigonochlamydidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("trigonochlamydidae_graphics", "species.mollusca.heterobranchia.trigonochlamydidae.graphics.spectrum", sb.toString());
        }
    }
}