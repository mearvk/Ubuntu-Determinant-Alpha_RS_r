package presidential.Brarner.M.Alete.source.species.chordata.aves.cardinalidae;
...
/**
 * Signal Processing for Family: Cardinalidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/cardinalidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12220; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/cardinalidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Cardinalidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cardinalidae_audio", "species.chordata.aves.cardinalidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cardinalidae_data", "species.chordata.aves.cardinalidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cardinalidae_graphics", "species.chordata.aves.cardinalidae.graphics.spectrum", sb.toString());
        }
    }
}