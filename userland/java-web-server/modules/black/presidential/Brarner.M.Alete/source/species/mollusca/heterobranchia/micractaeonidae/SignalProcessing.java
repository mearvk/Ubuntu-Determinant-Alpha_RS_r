package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.micractaeonidae;
...
/**
 * Signal Processing for Family: Micractaeonidae
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Achatinina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/micractaeonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17542; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/micractaeonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Micractaeonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("micractaeonidae_audio", "species.mollusca.heterobranchia.micractaeonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("micractaeonidae_data", "species.mollusca.heterobranchia.micractaeonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("micractaeonidae_graphics", "species.mollusca.heterobranchia.micractaeonidae.graphics.spectrum", sb.toString());
        }
    }
}