package presidential.Brarner.M.Alete.source.species.chordata.eutheria.rhinolophoidea;
...
/**
 * Signal Processing for Family: Rhinolophoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/rhinolophoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12450; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/rhinolophoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Rhinolophoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rhinolophoidea_audio", "species.chordata.eutheria.rhinolophoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rhinolophoidea_data", "species.chordata.eutheria.rhinolophoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rhinolophoidea_graphics", "species.chordata.eutheria.rhinolophoidea.graphics.spectrum", sb.toString());
        }
    }
}