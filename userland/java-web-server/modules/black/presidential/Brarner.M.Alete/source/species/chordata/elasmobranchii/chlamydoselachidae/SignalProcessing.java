package presidential.Brarner.M.Alete.source.species.chordata.elasmobranchii.chlamydoselachidae;
...
/**
 * Signal Processing for Family: Chlamydoselachidae
 * <p>Phylum: Chordata | Class: Elasmobranchii | Order: Hexanchiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/elasmobranchii/chlamydoselachidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11988; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/elasmobranchii/chlamydoselachidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Elasmobranchii"); ps.setString(3, "Chlamydoselachidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chlamydoselachidae_audio", "species.chordata.elasmobranchii.chlamydoselachidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chlamydoselachidae_data", "species.chordata.elasmobranchii.chlamydoselachidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chlamydoselachidae_graphics", "species.chordata.elasmobranchii.chlamydoselachidae.graphics.spectrum", sb.toString());
        }
    }
}