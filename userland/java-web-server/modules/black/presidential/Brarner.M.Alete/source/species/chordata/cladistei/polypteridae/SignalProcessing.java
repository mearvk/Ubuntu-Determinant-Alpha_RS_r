package presidential.Brarner.M.Alete.source.species.chordata.cladistei.polypteridae;
...
/**
 * Signal Processing for Family: Polypteridae
 * <p>Phylum: Chordata | Class: Cladistei | Order: Polypteriformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/cladistei/polypteridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11512; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/cladistei/polypteridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Cladistei"); ps.setString(3, "Polypteridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("polypteridae_audio", "species.chordata.cladistei.polypteridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("polypteridae_data", "species.chordata.cladistei.polypteridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("polypteridae_graphics", "species.chordata.cladistei.polypteridae.graphics.spectrum", sb.toString());
        }
    }
}