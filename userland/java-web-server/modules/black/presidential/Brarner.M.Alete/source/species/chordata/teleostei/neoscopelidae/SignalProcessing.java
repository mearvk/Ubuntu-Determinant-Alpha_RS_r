package presidential.Brarner.M.Alete.source.species.chordata.teleostei.neoscopelidae;
...
/**
 * Signal Processing for Family: Neoscopelidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Myctophiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/neoscopelidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11972; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/neoscopelidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Neoscopelidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("neoscopelidae_audio", "species.chordata.teleostei.neoscopelidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("neoscopelidae_data", "species.chordata.teleostei.neoscopelidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("neoscopelidae_graphics", "species.chordata.teleostei.neoscopelidae.graphics.spectrum", sb.toString());
        }
    }
}