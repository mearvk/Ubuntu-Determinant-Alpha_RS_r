package presidential.Brarner.M.Alete.source.species.mollusca.neritimorpha.proserpinellidae;
...
/**
 * Signal Processing for Family: Proserpinellidae
 * <p>Phylum: Mollusca | Class: Neritimorpha | Order: Helicinina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/neritimorpha/proserpinellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17689; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/neritimorpha/proserpinellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Neritimorpha"); ps.setString(3, "Proserpinellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("proserpinellidae_audio", "species.mollusca.neritimorpha.proserpinellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("proserpinellidae_data", "species.mollusca.neritimorpha.proserpinellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("proserpinellidae_graphics", "species.mollusca.neritimorpha.proserpinellidae.graphics.spectrum", sb.toString());
        }
    }
}