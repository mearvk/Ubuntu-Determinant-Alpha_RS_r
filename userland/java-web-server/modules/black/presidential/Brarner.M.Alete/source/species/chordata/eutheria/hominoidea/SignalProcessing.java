package presidential.Brarner.M.Alete.source.species.chordata.eutheria.hominoidea;
...
/**
 * Signal Processing for Family: Hominoidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/hominoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12485; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/hominoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Hominoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hominoidea_audio", "species.chordata.eutheria.hominoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hominoidea_data", "species.chordata.eutheria.hominoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hominoidea_graphics", "species.chordata.eutheria.hominoidea.graphics.spectrum", sb.toString());
        }
    }
}