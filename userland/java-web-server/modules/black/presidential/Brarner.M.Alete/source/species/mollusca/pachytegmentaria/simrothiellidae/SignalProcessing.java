package presidential.Brarner.M.Alete.source.species.mollusca.pachytegmentaria.simrothiellidae;
...
/**
 * Signal Processing for Family: Simrothiellidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/pachytegmentaria/simrothiellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17809; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/pachytegmentaria/simrothiellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Pachytegmentaria"); ps.setString(3, "Simrothiellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("simrothiellidae_audio", "species.mollusca.pachytegmentaria.simrothiellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("simrothiellidae_data", "species.mollusca.pachytegmentaria.simrothiellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("simrothiellidae_graphics", "species.mollusca.pachytegmentaria.simrothiellidae.graphics.spectrum", sb.toString());
        }
    }
}