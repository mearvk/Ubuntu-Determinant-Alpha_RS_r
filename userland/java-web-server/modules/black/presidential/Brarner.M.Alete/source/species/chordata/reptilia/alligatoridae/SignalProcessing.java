package presidential.Brarner.M.Alete.source.species.chordata.reptilia.alligatoridae;
...
/**
 * Signal Processing for Family: Alligatoridae
 * <p>Phylum: Chordata | Class: Reptilia | Order: Crocodilia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/reptilia/alligatoridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12564; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/reptilia/alligatoridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Reptilia"); ps.setString(3, "Alligatoridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("alligatoridae_audio", "species.chordata.reptilia.alligatoridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("alligatoridae_data", "species.chordata.reptilia.alligatoridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("alligatoridae_graphics", "species.chordata.reptilia.alligatoridae.graphics.spectrum", sb.toString());
        }
    }
}