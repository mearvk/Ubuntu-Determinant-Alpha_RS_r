package presidential.Brarner.M.Alete.source.species.chordata.eutheria.chrysochloridae;
...
/**
 * Signal Processing for Family: Chrysochloridae
 * <p>Phylum: Chordata | Class: Eutheria | Order: Chrysochloridea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/chrysochloridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12389; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/chrysochloridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Chrysochloridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chrysochloridae_audio", "species.chordata.eutheria.chrysochloridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chrysochloridae_data", "species.chordata.eutheria.chrysochloridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chrysochloridae_graphics", "species.chordata.eutheria.chrysochloridae.graphics.spectrum", sb.toString());
        }
    }
}