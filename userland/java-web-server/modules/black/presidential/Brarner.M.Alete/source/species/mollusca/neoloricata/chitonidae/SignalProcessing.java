package presidential.Brarner.M.Alete.source.species.mollusca.neoloricata.chitonidae;
...
/**
 * Signal Processing for Family: Chitonidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/neoloricata/chitonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17764; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/neoloricata/chitonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Neoloricata"); ps.setString(3, "Chitonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chitonidae_audio", "species.mollusca.neoloricata.chitonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chitonidae_data", "species.mollusca.neoloricata.chitonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chitonidae_graphics", "species.mollusca.neoloricata.chitonidae.graphics.spectrum", sb.toString());
        }
    }
}