...
/**
 * Signal Processing for Family: Nausithoidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/scyphozoa/nausithoidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11244; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/scyphozoa/nausithoidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Scyphozoa"); ps.setString(3, "Nausithoidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("nausithoidae_audio", "species.cnidaria.scyphozoa.nausithoidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("nausithoidae_data", "species.cnidaria.scyphozoa.nausithoidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("nausithoidae_graphics", "species.cnidaria.scyphozoa.nausithoidae.graphics.spectrum", sb.toString());
        }
    }
}