package presidential.Brarner.M.Alete.source.species.chordata.holostei;
...
/**
 * Signal Processing for Phylum: Chordata, Class: Holostei
 * <p>Families: 2</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/holostei/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11513; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/holostei";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Holostei"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chordata_holostei_audio", "species.chordata.holostei.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chordata_holostei_data", "species.chordata.holostei.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chordata_holostei_graphics", "species.chordata.holostei.graphics.spectrum", sb.toString());
        }
    }
}