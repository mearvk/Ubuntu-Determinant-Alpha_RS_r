package presidential.Brarner.M.Alete.source.species.mollusca.pachytegmentaria.rhipidoherpiidae;
...
/**
 * Signal Processing for Family: Rhipidoherpiidae
 * <p>Phylum: Mollusca | Class: Pachytegmentaria | Order: Cavibelonia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/pachytegmentaria/rhipidoherpiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17807; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/pachytegmentaria/rhipidoherpiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Pachytegmentaria"); ps.setString(3, "Rhipidoherpiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("rhipidoherpiidae_audio", "species.mollusca.pachytegmentaria.rhipidoherpiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("rhipidoherpiidae_data", "species.mollusca.pachytegmentaria.rhipidoherpiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("rhipidoherpiidae_graphics", "species.mollusca.pachytegmentaria.rhipidoherpiidae.graphics.spectrum", sb.toString());
        }
    }
}