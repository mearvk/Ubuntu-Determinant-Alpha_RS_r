package presidential.Brarner.M.Alete.source.species.chordata.metatheria;
...
/**
 * Signal Processing for Phylum: Chordata, Class: Metatheria
 * <p>Families: 23</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/metatheria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12539; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/metatheria";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Metatheria"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chordata_metatheria_audio", "species.chordata.metatheria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chordata_metatheria_data", "species.chordata.metatheria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chordata_metatheria_graphics", "species.chordata.metatheria.graphics.spectrum", sb.toString());
        }
    }
}