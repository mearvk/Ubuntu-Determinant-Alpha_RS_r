package presidential.Brarner.M.Alete.source.species.cnidaria.hexacorallia.fungiacyathidae;
...
/**
 * Signal Processing for Family: Fungiacyathidae
 * <p>Phylum: Cnidaria | Class: Hexacorallia | Order: Fungiina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hexacorallia/fungiacyathidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11077; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hexacorallia/fungiacyathidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hexacorallia"); ps.setString(3, "Fungiacyathidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("fungiacyathidae_audio", "species.cnidaria.hexacorallia.fungiacyathidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("fungiacyathidae_data", "species.cnidaria.hexacorallia.fungiacyathidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("fungiacyathidae_graphics", "species.cnidaria.hexacorallia.fungiacyathidae.graphics.spectrum", sb.toString());
        }
    }
}