package presidential.Brarner.M.Alete.source.species.annelida.polychaeta.asteriomyzostomidae;
...
/**
 * Signal Processing for Family: Asteriomyzostomidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/polychaeta/asteriomyzostomidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16634; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/polychaeta/asteriomyzostomidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Polychaeta"); ps.setString(3, "Asteriomyzostomidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("asteriomyzostomidae_audio", "species.annelida.polychaeta.asteriomyzostomidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("asteriomyzostomidae_data", "species.annelida.polychaeta.asteriomyzostomidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("asteriomyzostomidae_graphics", "species.annelida.polychaeta.asteriomyzostomidae.graphics.spectrum", sb.toString());
        }
    }
}