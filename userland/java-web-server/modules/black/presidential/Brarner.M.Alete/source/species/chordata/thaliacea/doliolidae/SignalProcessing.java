package presidential.Brarner.M.Alete.source.species.chordata.thaliacea.doliolidae;
...
/**
 * Signal Processing for Family: Doliolidae
 * <p>Phylum: Chordata | Class: Thaliacea | Order: Doliolida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/thaliacea/doliolidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11499; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/thaliacea/doliolidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Thaliacea"); ps.setString(3, "Doliolidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("doliolidae_audio", "species.chordata.thaliacea.doliolidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("doliolidae_data", "species.chordata.thaliacea.doliolidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("doliolidae_graphics", "species.chordata.thaliacea.doliolidae.graphics.spectrum", sb.toString());
        }
    }
}