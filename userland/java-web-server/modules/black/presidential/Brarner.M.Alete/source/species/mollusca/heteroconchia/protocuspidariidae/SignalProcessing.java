package presidential.Brarner.M.Alete.source.species.mollusca.heteroconchia.protocuspidariidae;
...
/**
 * Signal Processing for Family: Protocuspidariidae
 * <p>Phylum: Mollusca | Class: Heteroconchia | Order: Poromyida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heteroconchia/protocuspidariidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16938; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heteroconchia/protocuspidariidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heteroconchia"); ps.setString(3, "Protocuspidariidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("protocuspidariidae_audio", "species.mollusca.heteroconchia.protocuspidariidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("protocuspidariidae_data", "species.mollusca.heteroconchia.protocuspidariidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("protocuspidariidae_graphics", "species.mollusca.heteroconchia.protocuspidariidae.graphics.spectrum", sb.toString());
        }
    }
}