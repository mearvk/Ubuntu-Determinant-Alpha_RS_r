package presidential.Brarner.M.Alete.source.species.cnidaria.hydroidolina.kirchenpaueriidae;
...
/**
 * Signal Processing for Family: Kirchenpaueriidae
 * <p>Phylum: Cnidaria | Class: Hydroidolina | Order: Leptothecatae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hydroidolina/kirchenpaueriidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11189; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hydroidolina/kirchenpaueriidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hydroidolina"); ps.setString(3, "Kirchenpaueriidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("kirchenpaueriidae_audio", "species.cnidaria.hydroidolina.kirchenpaueriidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("kirchenpaueriidae_data", "species.cnidaria.hydroidolina.kirchenpaueriidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("kirchenpaueriidae_graphics", "species.cnidaria.hydroidolina.kirchenpaueriidae.graphics.spectrum", sb.toString());
        }
    }
}