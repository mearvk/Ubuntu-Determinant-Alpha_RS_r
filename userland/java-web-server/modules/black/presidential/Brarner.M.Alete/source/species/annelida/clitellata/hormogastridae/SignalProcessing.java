package presidential.Brarner.M.Alete.source.species.annelida.clitellata.hormogastridae;
...
/**
 * Signal Processing for Family: Hormogastridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/clitellata/hormogastridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16586; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/clitellata/hormogastridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Clitellata"); ps.setString(3, "Hormogastridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hormogastridae_audio", "species.annelida.clitellata.hormogastridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hormogastridae_data", "species.annelida.clitellata.hormogastridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hormogastridae_graphics", "species.annelida.clitellata.hormogastridae.graphics.spectrum", sb.toString());
        }
    }
}