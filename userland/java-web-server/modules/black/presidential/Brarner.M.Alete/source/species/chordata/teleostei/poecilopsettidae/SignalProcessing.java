package presidential.Brarner.M.Alete.source.species.chordata.teleostei.poecilopsettidae;
...
/**
 * Signal Processing for Family: Poecilopsettidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Pleuronectoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/poecilopsettidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11720; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/poecilopsettidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Poecilopsettidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("poecilopsettidae_audio", "species.chordata.teleostei.poecilopsettidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("poecilopsettidae_data", "species.chordata.teleostei.poecilopsettidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("poecilopsettidae_graphics", "species.chordata.teleostei.poecilopsettidae.graphics.spectrum", sb.toString());
        }
    }
}