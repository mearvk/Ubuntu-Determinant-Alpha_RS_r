package presidential.Brarner.M.Alete.source.species.annelida.lumbriculata.lumbriculidae;
...
/**
 * Signal Processing for Family: Lumbriculidae
 * <p>Phylum: Annelida | Class: Lumbriculata | Order: Lumbriculida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/lumbriculata/lumbriculidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16611; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/lumbriculata/lumbriculidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Lumbriculata"); ps.setString(3, "Lumbriculidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lumbriculidae_audio", "species.annelida.lumbriculata.lumbriculidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lumbriculidae_data", "species.annelida.lumbriculata.lumbriculidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lumbriculidae_graphics", "species.annelida.lumbriculata.lumbriculidae.graphics.spectrum", sb.toString());
        }
    }
}