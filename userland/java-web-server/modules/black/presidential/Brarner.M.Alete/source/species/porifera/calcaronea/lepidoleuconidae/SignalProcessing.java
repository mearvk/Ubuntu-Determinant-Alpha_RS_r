package presidential.Brarner.M.Alete.source.species.porifera.calcaronea.lepidoleuconidae;
...
/**
 * Signal Processing for Family: Lepidoleuconidae
 * <p>Phylum: Porifera | Class: Calcaronea | Order: Baerida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/calcaronea/lepidoleuconidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11313; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/calcaronea/lepidoleuconidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Calcaronea"); ps.setString(3, "Lepidoleuconidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lepidoleuconidae_audio", "species.porifera.calcaronea.lepidoleuconidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lepidoleuconidae_data", "species.porifera.calcaronea.lepidoleuconidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lepidoleuconidae_graphics", "species.porifera.calcaronea.lepidoleuconidae.graphics.spectrum", sb.toString());
        }
    }
}