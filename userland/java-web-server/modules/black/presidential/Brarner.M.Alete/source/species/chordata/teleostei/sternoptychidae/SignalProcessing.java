package presidential.Brarner.M.Alete.source.species.chordata.teleostei.sternoptychidae;
...
/**
 * Signal Processing for Family: Sternoptychidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Gonostomatoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/sternoptychidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11975; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/sternoptychidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Sternoptychidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sternoptychidae_audio", "species.chordata.teleostei.sternoptychidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sternoptychidae_data", "species.chordata.teleostei.sternoptychidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sternoptychidae_graphics", "species.chordata.teleostei.sternoptychidae.graphics.spectrum", sb.toString());
        }
    }
}