package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.phallomedusidae;
...
/**
 * Signal Processing for Family: Phallomedusidae
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Amphibolina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/phallomedusidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17517; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/phallomedusidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Phallomedusidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("phallomedusidae_audio", "species.mollusca.heterobranchia.phallomedusidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("phallomedusidae_data", "species.mollusca.heterobranchia.phallomedusidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("phallomedusidae_graphics", "species.mollusca.heterobranchia.phallomedusidae.graphics.spectrum", sb.toString());
        }
    }
}