...
/**
 * Signal Processing for Family: Synochidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/enoplia/synochidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16488; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/enoplia/synochidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Enoplia"); ps.setString(3, "Synochidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("synochidae_audio", "species.nematoda.enoplia.synochidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("synochidae_data", "species.nematoda.enoplia.synochidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("synochidae_graphics", "species.nematoda.enoplia.synochidae.graphics.spectrum", sb.toString());
        }
    }
}