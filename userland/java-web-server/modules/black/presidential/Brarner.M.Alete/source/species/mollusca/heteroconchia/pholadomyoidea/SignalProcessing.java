package presidential.Brarner.M.Alete.source.species.mollusca.heteroconchia.pholadomyoidea;
...
/**
 * Signal Processing for Family: Pholadomyoidea
 * <p>Phylum: Mollusca | Class: Heteroconchia | Order: Pholadomyida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heteroconchia/pholadomyoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16933; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heteroconchia/pholadomyoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heteroconchia"); ps.setString(3, "Pholadomyoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pholadomyoidea_audio", "species.mollusca.heteroconchia.pholadomyoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pholadomyoidea_data", "species.mollusca.heteroconchia.pholadomyoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pholadomyoidea_graphics", "species.mollusca.heteroconchia.pholadomyoidea.graphics.spectrum", sb.toString());
        }
    }
}