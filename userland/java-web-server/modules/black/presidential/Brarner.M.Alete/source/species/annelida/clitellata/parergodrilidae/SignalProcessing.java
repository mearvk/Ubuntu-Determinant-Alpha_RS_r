package presidential.Brarner.M.Alete.source.species.annelida.clitellata.parergodrilidae;
...
/**
 * Signal Processing for Family: Parergodrilidae
 * <p>Phylum: Annelida | Class: Clitellata | Order: Apodadrilida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/clitellata/parergodrilidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16567; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/clitellata/parergodrilidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Clitellata"); ps.setString(3, "Parergodrilidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("parergodrilidae_audio", "species.annelida.clitellata.parergodrilidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("parergodrilidae_data", "species.annelida.clitellata.parergodrilidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("parergodrilidae_graphics", "species.annelida.clitellata.parergodrilidae.graphics.spectrum", sb.toString());
        }
    }
}