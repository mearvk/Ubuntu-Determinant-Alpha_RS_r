package presidential.Brarner.M.Alete.source.species.bryozoa.eurystomata.membraniporidae;
...
/**
 * Signal Processing for Family: Membraniporidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/eurystomata/membraniporidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16781; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/eurystomata/membraniporidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Eurystomata"); ps.setString(3, "Membraniporidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("membraniporidae_audio", "species.bryozoa.eurystomata.membraniporidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("membraniporidae_data", "species.bryozoa.eurystomata.membraniporidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("membraniporidae_graphics", "species.bryozoa.eurystomata.membraniporidae.graphics.spectrum", sb.toString());
        }
    }
}