package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.umbraculoidea;
...
/**
 * Signal Processing for Family: Umbraculoidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Umbraculida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/umbraculoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17403; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/umbraculoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Umbraculoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("umbraculoidea_audio", "species.mollusca.heterobranchia.umbraculoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("umbraculoidea_data", "species.mollusca.heterobranchia.umbraculoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("umbraculoidea_graphics", "species.mollusca.heterobranchia.umbraculoidea.graphics.spectrum", sb.toString());
        }
    }
}