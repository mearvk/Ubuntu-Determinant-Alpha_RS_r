package presidential.Brarner.M.Alete.source.species.chordata.eutheria.galagidae;
...
/**
 * Signal Processing for Family: Galagidae
 * <p>Phylum: Chordata | Class: Eutheria | Order: Lorisiformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/galagidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12496; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/galagidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Galagidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("galagidae_audio", "species.chordata.eutheria.galagidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("galagidae_data", "species.chordata.eutheria.galagidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("galagidae_graphics", "species.chordata.eutheria.galagidae.graphics.spectrum", sb.toString());
        }
    }
}