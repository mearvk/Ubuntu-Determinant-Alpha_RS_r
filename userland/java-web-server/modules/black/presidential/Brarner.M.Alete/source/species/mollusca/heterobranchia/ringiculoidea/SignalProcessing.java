package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.ringiculoidea;
...
/**
 * Signal Processing for Family: Ringiculoidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Ringiculida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/ringiculoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17399; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/ringiculoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Ringiculoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ringiculoidea_audio", "species.mollusca.heterobranchia.ringiculoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ringiculoidea_data", "species.mollusca.heterobranchia.ringiculoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ringiculoidea_graphics", "species.mollusca.heterobranchia.ringiculoidea.graphics.spectrum", sb.toString());
        }
    }
}