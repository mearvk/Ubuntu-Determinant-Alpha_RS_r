package presidential.Brarner.M.Alete.source.species.annelida.lumbriculata.glossiphoniidae;
...
/**
 * Signal Processing for Family: Glossiphoniidae
 * <p>Phylum: Annelida | Class: Lumbriculata | Order: Rhynchobdellida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/lumbriculata/glossiphoniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16608; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/lumbriculata/glossiphoniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Lumbriculata"); ps.setString(3, "Glossiphoniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("glossiphoniidae_audio", "species.annelida.lumbriculata.glossiphoniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("glossiphoniidae_data", "species.annelida.lumbriculata.glossiphoniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("glossiphoniidae_graphics", "species.annelida.lumbriculata.glossiphoniidae.graphics.spectrum", sb.toString());
        }
    }
}