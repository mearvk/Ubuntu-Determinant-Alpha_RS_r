package presidential.Brarner.M.Alete.source.species.chordata.aves.conopophagidae;
...
/**
 * Signal Processing for Family: Conopophagidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/conopophagidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12230; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/conopophagidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Conopophagidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("conopophagidae_audio", "species.chordata.aves.conopophagidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("conopophagidae_data", "species.chordata.aves.conopophagidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("conopophagidae_graphics", "species.chordata.aves.conopophagidae.graphics.spectrum", sb.toString());
        }
    }
}