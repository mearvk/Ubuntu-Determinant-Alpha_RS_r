package presidential.Brarner.M.Alete.source.species.chordata.amphibia;
...
/**
 * Signal Processing for Phylum: Chordata, Class: Amphibia
 * <p>Families: 83</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/amphibia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12047; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/amphibia";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Amphibia"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("chordata_amphibia_audio", "species.chordata.amphibia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("chordata_amphibia_data", "species.chordata.amphibia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("chordata_amphibia_graphics", "species.chordata.amphibia.graphics.spectrum", sb.toString());
        }
    }
}