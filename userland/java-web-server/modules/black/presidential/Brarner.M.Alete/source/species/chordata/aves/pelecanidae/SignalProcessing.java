package presidential.Brarner.M.Alete.source.species.chordata.aves.pelecanidae;
...
/**
 * Signal Processing for Family: Pelecanidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/pelecanidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12349; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/pelecanidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Pelecanidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pelecanidae_audio", "species.chordata.aves.pelecanidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pelecanidae_data", "species.chordata.aves.pelecanidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pelecanidae_graphics", "species.chordata.aves.pelecanidae.graphics.spectrum", sb.toString());
        }
    }
}