package presidential.Brarner.M.Alete.source.species.placozoa.uniplacotomia.hoilungidae;
...
/**
 * Signal Processing for Family: Hoilungidae
 * <p>Phylum: Placozoa | Class: Uniplacotomia | Order: Hoilungea</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/placozoa/uniplacotomia/hoilungidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11309; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/placozoa/uniplacotomia/hoilungidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Placozoa"); ps.setString(2, "Uniplacotomia"); ps.setString(3, "Hoilungidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hoilungidae_audio", "species.placozoa.uniplacotomia.hoilungidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hoilungidae_data", "species.placozoa.uniplacotomia.hoilungidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hoilungidae_graphics", "species.placozoa.uniplacotomia.hoilungidae.graphics.spectrum", sb.toString());
        }
    }
}