package presidential.Brarner.M.Alete.source.species.bryozoa.phylactolaemata.fredericellidae;
...
/**
 * Signal Processing for Family: Fredericellidae
 * <p>Phylum: Bryozoa | Class: Phylactolaemata | Order: Plumatellida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/phylactolaemata/fredericellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16890; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/phylactolaemata/fredericellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Phylactolaemata"); ps.setString(3, "Fredericellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("fredericellidae_audio", "species.bryozoa.phylactolaemata.fredericellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("fredericellidae_data", "species.bryozoa.phylactolaemata.fredericellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("fredericellidae_graphics", "species.bryozoa.phylactolaemata.fredericellidae.graphics.spectrum", sb.toString());
        }
    }
}