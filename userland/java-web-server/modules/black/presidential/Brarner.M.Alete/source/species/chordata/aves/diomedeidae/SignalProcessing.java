package presidential.Brarner.M.Alete.source.species.chordata.aves.diomedeidae;
...
/**
 * Signal Processing for Family: Diomedeidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/diomedeidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12364; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/diomedeidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Diomedeidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("diomedeidae_audio", "species.chordata.aves.diomedeidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("diomedeidae_data", "species.chordata.aves.diomedeidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("diomedeidae_graphics", "species.chordata.aves.diomedeidae.graphics.spectrum", sb.toString());
        }
    }
}