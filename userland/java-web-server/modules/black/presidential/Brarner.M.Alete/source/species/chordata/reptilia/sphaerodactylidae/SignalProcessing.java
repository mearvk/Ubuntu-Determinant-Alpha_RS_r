package presidential.Brarner.M.Alete.source.species.chordata.reptilia.sphaerodactylidae;
...
/**
 * Signal Processing for Family: Sphaerodactylidae
 * <p>Phylum: Chordata | Class: Reptilia | Order: Gekkota</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/reptilia/sphaerodactylidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12596; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/reptilia/sphaerodactylidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Reptilia"); ps.setString(3, "Sphaerodactylidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sphaerodactylidae_audio", "species.chordata.reptilia.sphaerodactylidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sphaerodactylidae_data", "species.chordata.reptilia.sphaerodactylidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sphaerodactylidae_graphics", "species.chordata.reptilia.sphaerodactylidae.graphics.spectrum", sb.toString());
        }
    }
}