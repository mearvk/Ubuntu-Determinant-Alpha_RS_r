package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.strophocheilidae;
...
/**
 * Signal Processing for Family: Strophocheilidae
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Rhytidoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/strophocheilidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17674; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/strophocheilidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Strophocheilidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("strophocheilidae_audio", "species.mollusca.heterobranchia.strophocheilidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("strophocheilidae_data", "species.mollusca.heterobranchia.strophocheilidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("strophocheilidae_graphics", "species.mollusca.heterobranchia.strophocheilidae.graphics.spectrum", sb.toString());
        }
    }
}