package presidential.Brarner.M.Alete.source.species.mollusca.neritimorpha.neritiliidae;
...
/**
 * Signal Processing for Family: Neritiliidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/neritimorpha/neritiliidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17692; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/neritimorpha/neritiliidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Neritimorpha"); ps.setString(3, "Neritiliidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("neritiliidae_audio", "species.mollusca.neritimorpha.neritiliidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("neritiliidae_data", "species.mollusca.neritimorpha.neritiliidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("neritiliidae_graphics", "species.mollusca.neritimorpha.neritiliidae.graphics.spectrum", sb.toString());
        }
    }
}