package presidential.Brarner.M.Alete.source.species.chordata.aves.melanopareiidae;
...
/**
 * Signal Processing for Family: Melanopareiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/melanopareiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12267; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/melanopareiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Melanopareiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("melanopareiidae_audio", "species.chordata.aves.melanopareiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("melanopareiidae_data", "species.chordata.aves.melanopareiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("melanopareiidae_graphics", "species.chordata.aves.melanopareiidae.graphics.spectrum", sb.toString());
        }
    }
}