package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.hyalogyrinidae;
...
/**
 * Signal Processing for Family: Hyalogyrinidae
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Ectobranchia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/hyalogyrinidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17375; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/hyalogyrinidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Hyalogyrinidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("hyalogyrinidae_audio", "species.mollusca.heterobranchia.hyalogyrinidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("hyalogyrinidae_data", "species.mollusca.heterobranchia.hyalogyrinidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("hyalogyrinidae_graphics", "species.mollusca.heterobranchia.hyalogyrinidae.graphics.spectrum", sb.toString());
        }
    }
}