package presidential.Brarner.M.Alete.source.species.chordata.teleostei.pseudopimelodidae;
...
/**
 * Signal Processing for Family: Pseudopimelodidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Siluriformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/pseudopimelodidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11898; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/pseudopimelodidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Pseudopimelodidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudopimelodidae_audio", "species.chordata.teleostei.pseudopimelodidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudopimelodidae_data", "species.chordata.teleostei.pseudopimelodidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudopimelodidae_graphics", "species.chordata.teleostei.pseudopimelodidae.graphics.spectrum", sb.toString());
        }
    }
}