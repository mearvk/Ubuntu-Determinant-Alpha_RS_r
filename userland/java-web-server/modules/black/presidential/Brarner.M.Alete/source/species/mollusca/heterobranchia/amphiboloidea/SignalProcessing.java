package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.amphiboloidea;
...
/**
 * Signal Processing for Family: Amphiboloidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/amphiboloidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17514; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/amphiboloidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Amphiboloidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("amphiboloidea_audio", "species.mollusca.heterobranchia.amphiboloidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("amphiboloidea_data", "species.mollusca.heterobranchia.amphiboloidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("amphiboloidea_graphics", "species.mollusca.heterobranchia.amphiboloidea.graphics.spectrum", sb.toString());
        }
    }
}