package presidential.Brarner.M.Alete.source.species.mollusca.caenogastropoda.cerithiopsidae;
...
/**
 * Signal Processing for Family: Cerithiopsidae
 * <p>Phylum: Mollusca | Class: Caenogastropoda | Order: Triphorina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/caenogastropoda/cerithiopsidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17234; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/caenogastropoda/cerithiopsidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Caenogastropoda"); ps.setString(3, "Cerithiopsidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cerithiopsidae_audio", "species.mollusca.caenogastropoda.cerithiopsidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cerithiopsidae_data", "species.mollusca.caenogastropoda.cerithiopsidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cerithiopsidae_graphics", "species.mollusca.caenogastropoda.cerithiopsidae.graphics.spectrum", sb.toString());
        }
    }
}