package presidential.Brarner.M.Alete.source.species.chordata.eutheria.vespertilionoidea;
...
/**
 * Signal Processing for Family: Vespertilionoidea
 * <p>Phylum: Chordata | Class: Eutheria | Order: Yangochiroptera</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/eutheria/vespertilionoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12443; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/eutheria/vespertilionoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Eutheria"); ps.setString(3, "Vespertilionoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("vespertilionoidea_audio", "species.chordata.eutheria.vespertilionoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("vespertilionoidea_data", "species.chordata.eutheria.vespertilionoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("vespertilionoidea_graphics", "species.chordata.eutheria.vespertilionoidea.graphics.spectrum", sb.toString());
        }
    }
}