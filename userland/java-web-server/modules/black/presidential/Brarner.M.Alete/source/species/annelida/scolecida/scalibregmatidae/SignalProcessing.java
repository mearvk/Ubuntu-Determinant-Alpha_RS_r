package presidential.Brarner.M.Alete.source.species.annelida.scolecida.scalibregmatidae;
...
/**
 * Signal Processing for Family: Scalibregmatidae
 * <p>Phylum: Annelida | Class: Scolecida | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/scolecida/scalibregmatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16722; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/scolecida/scalibregmatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Scolecida"); ps.setString(3, "Scalibregmatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("scalibregmatidae_audio", "species.annelida.scolecida.scalibregmatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("scalibregmatidae_data", "species.annelida.scolecida.scalibregmatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("scalibregmatidae_graphics", "species.annelida.scolecida.scalibregmatidae.graphics.spectrum", sb.toString());
        }
    }
}