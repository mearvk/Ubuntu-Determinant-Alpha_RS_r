package presidential.Brarner.M.Alete.source.species.chordata.teleostei.saccopharyngidae;
...
/**
 * Signal Processing for Family: Saccopharyngidae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Saccopharyngoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/saccopharyngidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11828; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/saccopharyngidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Saccopharyngidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("saccopharyngidae_audio", "species.chordata.teleostei.saccopharyngidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("saccopharyngidae_data", "species.chordata.teleostei.saccopharyngidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("saccopharyngidae_graphics", "species.chordata.teleostei.saccopharyngidae.graphics.spectrum", sb.toString());
        }
    }
}