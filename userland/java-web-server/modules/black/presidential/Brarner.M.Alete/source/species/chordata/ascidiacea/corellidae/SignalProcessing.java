package presidential.Brarner.M.Alete.source.species.chordata.ascidiacea.corellidae;
...
/**
 * Signal Processing for Family: Corellidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/ascidiacea/corellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11491; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/ascidiacea/corellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Ascidiacea"); ps.setString(3, "Corellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("corellidae_audio", "species.chordata.ascidiacea.corellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("corellidae_data", "species.chordata.ascidiacea.corellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("corellidae_graphics", "species.chordata.ascidiacea.corellidae.graphics.spectrum", sb.toString());
        }
    }
}