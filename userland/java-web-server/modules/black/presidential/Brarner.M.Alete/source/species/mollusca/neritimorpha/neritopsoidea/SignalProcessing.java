package presidential.Brarner.M.Alete.source.species.mollusca.neritimorpha.neritopsoidea;
...
/**
 * Signal Processing for Family: Neritopsoidea
 * <p>Phylum: Mollusca | Class: Neritimorpha | Order: Neritopsina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/neritimorpha/neritopsoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17698; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/neritimorpha/neritopsoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Neritimorpha"); ps.setString(3, "Neritopsoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("neritopsoidea_audio", "species.mollusca.neritimorpha.neritopsoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("neritopsoidea_data", "species.mollusca.neritimorpha.neritopsoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("neritopsoidea_graphics", "species.mollusca.neritimorpha.neritopsoidea.graphics.spectrum", sb.toString());
        }
    }
}