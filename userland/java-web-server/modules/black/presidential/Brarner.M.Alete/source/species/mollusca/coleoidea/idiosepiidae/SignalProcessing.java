package presidential.Brarner.M.Alete.source.species.mollusca.coleoidea.idiosepiidae;
...
/**
 * Signal Processing for Family: Idiosepiidae
 * <p>Phylum: Mollusca | Class: Coleoidea | Order: Sepiolida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/coleoidea/idiosepiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17075; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/coleoidea/idiosepiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Coleoidea"); ps.setString(3, "Idiosepiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("idiosepiidae_audio", "species.mollusca.coleoidea.idiosepiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("idiosepiidae_data", "species.mollusca.coleoidea.idiosepiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("idiosepiidae_graphics", "species.mollusca.coleoidea.idiosepiidae.graphics.spectrum", sb.toString());
        }
    }
}