package presidential.Brarner.M.Alete.source.species.chordata.thaliacea.pyrosomatidae;
...
/**
 * Signal Processing for Family: Pyrosomatidae
 * <p>Phylum: Chordata | Class: Thaliacea | Order: Pyrosomida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/thaliacea/pyrosomatidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11500; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/thaliacea/pyrosomatidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Thaliacea"); ps.setString(3, "Pyrosomatidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pyrosomatidae_audio", "species.chordata.thaliacea.pyrosomatidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pyrosomatidae_data", "species.chordata.thaliacea.pyrosomatidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pyrosomatidae_graphics", "species.chordata.thaliacea.pyrosomatidae.graphics.spectrum", sb.toString());
        }
    }
}