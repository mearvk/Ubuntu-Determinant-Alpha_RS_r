package presidential.Brarner.M.Alete.source.species.mollusca.aplotegmentaria;
...
/**
 * Signal Processing for Phylum: Mollusca, Class: Aplotegmentaria
 * <p>Families: 10</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/aplotegmentaria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17787; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/aplotegmentaria";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Aplotegmentaria"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mollusca_aplotegmentaria_audio", "species.mollusca.aplotegmentaria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mollusca_aplotegmentaria_data", "species.mollusca.aplotegmentaria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mollusca_aplotegmentaria_graphics", "species.mollusca.aplotegmentaria.graphics.spectrum", sb.toString());
        }
    }
}