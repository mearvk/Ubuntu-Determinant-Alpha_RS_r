package presidential.Brarner.M.Alete.source.species.annelida.polychaeta;
...
/**
 * Signal Processing for Phylum: Annelida, Class: Polychaeta
 * <p>Families: 17</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/polychaeta/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16623; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/polychaeta";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Polychaeta"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("annelida_polychaeta_audio", "species.annelida.polychaeta.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("annelida_polychaeta_data", "species.annelida.polychaeta.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("annelida_polychaeta_graphics", "species.annelida.polychaeta.graphics.spectrum", sb.toString());
        }
    }
}