package presidential.Brarner.M.Alete.source.species.chordata.teleostei.callanthiidae;
...
/**
 * Signal Processing for Family: Callanthiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/callanthiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11605; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/callanthiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Callanthiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("callanthiidae_audio", "species.chordata.teleostei.callanthiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("callanthiidae_data", "species.chordata.teleostei.callanthiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("callanthiidae_graphics", "species.chordata.teleostei.callanthiidae.graphics.spectrum", sb.toString());
        }
    }
}