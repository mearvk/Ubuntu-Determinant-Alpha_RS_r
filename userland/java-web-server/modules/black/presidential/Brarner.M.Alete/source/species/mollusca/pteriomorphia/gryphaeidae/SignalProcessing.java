package presidential.Brarner.M.Alete.source.species.mollusca.pteriomorphia.gryphaeidae;
...
/**
 * Signal Processing for Family: Gryphaeidae
 * <p>Phylum: Mollusca | Class: Pteriomorphia | Order: Ostreida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/pteriomorphia/gryphaeidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17035; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/pteriomorphia/gryphaeidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Pteriomorphia"); ps.setString(3, "Gryphaeidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("gryphaeidae_audio", "species.mollusca.pteriomorphia.gryphaeidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("gryphaeidae_data", "species.mollusca.pteriomorphia.gryphaeidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("gryphaeidae_graphics", "species.mollusca.pteriomorphia.gryphaeidae.graphics.spectrum", sb.toString());
        }
    }
}