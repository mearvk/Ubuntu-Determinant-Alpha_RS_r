package presidential.Brarner.M.Alete.source.species.porifera.calcaronea.heteropiidae;
...
/**
 * Signal Processing for Family: Heteropiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/porifera/calcaronea/heteropiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11318; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/porifera/calcaronea/heteropiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Porifera"); ps.setString(2, "Calcaronea"); ps.setString(3, "Heteropiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("heteropiidae_audio", "species.porifera.calcaronea.heteropiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("heteropiidae_data", "species.porifera.calcaronea.heteropiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("heteropiidae_graphics", "species.porifera.calcaronea.heteropiidae.graphics.spectrum", sb.toString());
        }
    }
}