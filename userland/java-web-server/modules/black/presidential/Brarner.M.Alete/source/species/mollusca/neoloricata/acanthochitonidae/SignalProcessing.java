package presidential.Brarner.M.Alete.source.species.mollusca.neoloricata.acanthochitonidae;
...
/**
 * Signal Processing for Family: Acanthochitonidae
 * <p>Phylum: Mollusca | Class: Neoloricata | Order: Acanthochitonina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/neoloricata/acanthochitonidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17760; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/neoloricata/acanthochitonidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Neoloricata"); ps.setString(3, "Acanthochitonidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("acanthochitonidae_audio", "species.mollusca.neoloricata.acanthochitonidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("acanthochitonidae_data", "species.mollusca.neoloricata.acanthochitonidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("acanthochitonidae_graphics", "species.mollusca.neoloricata.acanthochitonidae.graphics.spectrum", sb.toString());
        }
    }
}