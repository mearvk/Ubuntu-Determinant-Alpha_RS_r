package presidential.Brarner.M.Alete.source.species.bryozoa.phylactolaemata;
...
/**
 * Signal Processing for Phylum: Bryozoa, Class: Phylactolaemata
 * <p>Families: 5</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/phylactolaemata/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16888; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/phylactolaemata";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Phylactolaemata"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("bryozoa_phylactolaemata_audio", "species.bryozoa.phylactolaemata.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("bryozoa_phylactolaemata_data", "species.bryozoa.phylactolaemata.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("bryozoa_phylactolaemata_graphics", "species.bryozoa.phylactolaemata.graphics.spectrum", sb.toString());
        }
    }
}