package presidential.Brarner.M.Alete.source.species.chordata.aves.phalacrocoracidae;
...
/**
 * Signal Processing for Family: Phalacrocoracidae
 * <p>Phylum: Chordata | Class: Aves | Order: Suliformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/phalacrocoracidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12381; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/phalacrocoracidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Phalacrocoracidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("phalacrocoracidae_audio", "species.chordata.aves.phalacrocoracidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("phalacrocoracidae_data", "species.chordata.aves.phalacrocoracidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("phalacrocoracidae_graphics", "species.chordata.aves.phalacrocoracidae.graphics.spectrum", sb.toString());
        }
    }
}