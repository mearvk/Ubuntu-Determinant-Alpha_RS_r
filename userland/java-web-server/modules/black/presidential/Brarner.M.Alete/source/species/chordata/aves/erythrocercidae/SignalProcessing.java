package presidential.Brarner.M.Alete.source.species.chordata.aves.erythrocercidae;
...
/**
 * Signal Processing for Family: Erythrocercidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/aves/erythrocercidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12241; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/aves/erythrocercidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Aves"); ps.setString(3, "Erythrocercidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("erythrocercidae_audio", "species.chordata.aves.erythrocercidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("erythrocercidae_data", "species.chordata.aves.erythrocercidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("erythrocercidae_graphics", "species.chordata.aves.erythrocercidae.graphics.spectrum", sb.toString());
        }
    }
}