package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.architectonicoidea;
...
/**
 * Signal Processing for Family: Architectonicoidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Architectonicina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/architectonicoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17339; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/architectonicoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Architectonicoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("architectonicoidea_audio", "species.mollusca.heterobranchia.architectonicoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("architectonicoidea_data", "species.mollusca.heterobranchia.architectonicoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("architectonicoidea_graphics", "species.mollusca.heterobranchia.architectonicoidea.graphics.spectrum", sb.toString());
        }
    }
}