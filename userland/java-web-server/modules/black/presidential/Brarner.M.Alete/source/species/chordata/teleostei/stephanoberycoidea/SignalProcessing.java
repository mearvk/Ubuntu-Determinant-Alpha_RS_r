package presidential.Brarner.M.Alete.source.species.chordata.teleostei.stephanoberycoidea;
...
/**
 * Signal Processing for Family: Stephanoberycoidea
 * <p>Phylum: Chordata | Class: Teleostei | Order: Stephanoberyciformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/stephanoberycoidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11760; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/stephanoberycoidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Stephanoberycoidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("stephanoberycoidea_audio", "species.chordata.teleostei.stephanoberycoidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("stephanoberycoidea_data", "species.chordata.teleostei.stephanoberycoidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("stephanoberycoidea_graphics", "species.chordata.teleostei.stephanoberycoidea.graphics.spectrum", sb.toString());
        }
    }
}