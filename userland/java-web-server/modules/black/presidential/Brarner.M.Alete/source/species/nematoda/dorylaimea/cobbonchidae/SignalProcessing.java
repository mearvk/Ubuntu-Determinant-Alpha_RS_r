package presidential.Brarner.M.Alete.source.species.nematoda.dorylaimea.cobbonchidae;
...
/**
 * Signal Processing for Family: Cobbonchidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/dorylaimea/cobbonchidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16447; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/dorylaimea/cobbonchidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Dorylaimea"); ps.setString(3, "Cobbonchidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cobbonchidae_audio", "species.nematoda.dorylaimea.cobbonchidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cobbonchidae_data", "species.nematoda.dorylaimea.cobbonchidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cobbonchidae_graphics", "species.nematoda.dorylaimea.cobbonchidae.graphics.spectrum", sb.toString());
        }
    }
}