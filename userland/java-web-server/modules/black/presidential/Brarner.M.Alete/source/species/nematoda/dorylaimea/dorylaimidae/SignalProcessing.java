package presidential.Brarner.M.Alete.source.species.nematoda.dorylaimea.dorylaimidae;
...
/**
 * Signal Processing for Family: Dorylaimidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/dorylaimea/dorylaimidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16449; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/dorylaimea/dorylaimidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Dorylaimea"); ps.setString(3, "Dorylaimidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("dorylaimidae_audio", "species.nematoda.dorylaimea.dorylaimidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("dorylaimidae_data", "species.nematoda.dorylaimea.dorylaimidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("dorylaimidae_graphics", "species.nematoda.dorylaimea.dorylaimidae.graphics.spectrum", sb.toString());
        }
    }
}