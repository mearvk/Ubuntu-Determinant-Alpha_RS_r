package presidential.Brarner.M.Alete.source.species.annelida.clitellata.glossoscolecidae;
...
/**
 * Signal Processing for Family: Glossoscolecidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/clitellata/glossoscolecidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16575; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/clitellata/glossoscolecidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Clitellata"); ps.setString(3, "Glossoscolecidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("glossoscolecidae_audio", "species.annelida.clitellata.glossoscolecidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("glossoscolecidae_data", "species.annelida.clitellata.glossoscolecidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("glossoscolecidae_graphics", "species.annelida.clitellata.glossoscolecidae.graphics.spectrum", sb.toString());
        }
    }
}