package presidential.Brarner.M.Alete.source.species.chordata.teleostei.anoplogastridae;
...
/**
 * Signal Processing for Family: Anoplogastridae
 * <p>Phylum: Chordata | Class: Teleostei | Order: Trachichthyoidei</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/anoplogastridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11533; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/anoplogastridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Anoplogastridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("anoplogastridae_audio", "species.chordata.teleostei.anoplogastridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("anoplogastridae_data", "species.chordata.teleostei.anoplogastridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("anoplogastridae_graphics", "species.chordata.teleostei.anoplogastridae.graphics.spectrum", sb.toString());
        }
    }
}