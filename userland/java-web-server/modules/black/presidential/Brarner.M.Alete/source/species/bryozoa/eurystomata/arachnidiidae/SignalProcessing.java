package presidential.Brarner.M.Alete.source.species.bryozoa.eurystomata.arachnidiidae;
...
/**
 * Signal Processing for Family: Arachnidiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/eurystomata/arachnidiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16848; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/eurystomata/arachnidiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Eurystomata"); ps.setString(3, "Arachnidiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("arachnidiidae_audio", "species.bryozoa.eurystomata.arachnidiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("arachnidiidae_data", "species.bryozoa.eurystomata.arachnidiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("arachnidiidae_graphics", "species.bryozoa.eurystomata.arachnidiidae.graphics.spectrum", sb.toString());
        }
    }
}