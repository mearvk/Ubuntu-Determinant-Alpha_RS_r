package presidential.Brarner.M.Alete.source.species.mollusca.heteroconchia.margaritiferidae;
...
/**
 * Signal Processing for Family: Margaritiferidae
 * <p>Phylum: Mollusca | Class: Heteroconchia | Order: Unionida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heteroconchia/margaritiferidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16974; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heteroconchia/margaritiferidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heteroconchia"); ps.setString(3, "Margaritiferidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("margaritiferidae_audio", "species.mollusca.heteroconchia.margaritiferidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("margaritiferidae_data", "species.mollusca.heteroconchia.margaritiferidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("margaritiferidae_graphics", "species.mollusca.heteroconchia.margaritiferidae.graphics.spectrum", sb.toString());
        }
    }
}