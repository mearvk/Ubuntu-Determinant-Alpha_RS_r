package presidential.Brarner.M.Alete.source.species.chordata.ascidiacea.didemnidae;
...
/**
 * Signal Processing for Family: Didemnidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/ascidiacea/didemnidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11485; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/ascidiacea/didemnidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Ascidiacea"); ps.setString(3, "Didemnidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("didemnidae_audio", "species.chordata.ascidiacea.didemnidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("didemnidae_data", "species.chordata.ascidiacea.didemnidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("didemnidae_graphics", "species.chordata.ascidiacea.didemnidae.graphics.spectrum", sb.toString());
        }
    }
}