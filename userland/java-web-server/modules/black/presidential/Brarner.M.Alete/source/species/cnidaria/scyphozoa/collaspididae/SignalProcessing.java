package presidential.Brarner.M.Alete.source.species.cnidaria.scyphozoa.collaspididae;
...
/**
 * Signal Processing for Family: Collaspididae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/scyphozoa/collaspididae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11242; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/scyphozoa/collaspididae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Scyphozoa"); ps.setString(3, "Collaspididae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("collaspididae_audio", "species.cnidaria.scyphozoa.collaspididae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("collaspididae_data", "species.cnidaria.scyphozoa.collaspididae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("collaspididae_graphics", "species.cnidaria.scyphozoa.collaspididae.graphics.spectrum", sb.toString());
        }
    }
}