...
/**
 * Signal Processing for Family: Fritillaridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/appendicularia/fritillaridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11480; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/appendicularia/fritillaridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Appendicularia"); ps.setString(3, "Fritillaridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("fritillaridae_audio", "species.chordata.appendicularia.fritillaridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("fritillaridae_data", "species.chordata.appendicularia.fritillaridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("fritillaridae_graphics", "species.chordata.appendicularia.fritillaridae.graphics.spectrum", sb.toString());
        }
    }
}