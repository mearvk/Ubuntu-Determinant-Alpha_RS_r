package presidential.Brarner.M.Alete.source.species.mollusca.aplotegmentaria.sandalomeniidae;
...
/**
 * Signal Processing for Family: Sandalomeniidae
 * <p>Phylum: Mollusca | Class: Aplotegmentaria | Order: Pholidoskepia</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/aplotegmentaria/sandalomeniidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17797; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/aplotegmentaria/sandalomeniidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Aplotegmentaria"); ps.setString(3, "Sandalomeniidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("sandalomeniidae_audio", "species.mollusca.aplotegmentaria.sandalomeniidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("sandalomeniidae_data", "species.mollusca.aplotegmentaria.sandalomeniidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("sandalomeniidae_graphics", "species.mollusca.aplotegmentaria.sandalomeniidae.graphics.spectrum", sb.toString());
        }
    }
}