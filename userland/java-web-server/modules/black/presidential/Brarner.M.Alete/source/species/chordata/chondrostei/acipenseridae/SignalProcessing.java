package presidential.Brarner.M.Alete.source.species.chordata.chondrostei.acipenseridae;
...
/**
 * Signal Processing for Family: Acipenseridae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/chondrostei/acipenseridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11509; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/chondrostei/acipenseridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Chondrostei"); ps.setString(3, "Acipenseridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("acipenseridae_audio", "species.chordata.chondrostei.acipenseridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("acipenseridae_data", "species.chordata.chondrostei.acipenseridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("acipenseridae_graphics", "species.chordata.chondrostei.acipenseridae.graphics.spectrum", sb.toString());
        }
    }
}