package presidential.Brarner.M.Alete.source.species.mollusca.heterobranchia.cavolinioidea;
...
/**
 * Signal Processing for Family: Cavolinioidea
 * <p>Phylum: Mollusca | Class: Heterobranchia | Order: Thecosomata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/heterobranchia/cavolinioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17390; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/heterobranchia/cavolinioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Heterobranchia"); ps.setString(3, "Cavolinioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cavolinioidea_audio", "species.mollusca.heterobranchia.cavolinioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cavolinioidea_data", "species.mollusca.heterobranchia.cavolinioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cavolinioidea_graphics", "species.mollusca.heterobranchia.cavolinioidea.graphics.spectrum", sb.toString());
        }
    }
}