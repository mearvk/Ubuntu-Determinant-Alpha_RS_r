package presidential.Brarner.M.Alete.source.species.mollusca.protobranchia.manzanellidae;
...
/**
 * Signal Processing for Family: Manzanellidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/protobranchia/manzanellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17050; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/protobranchia/manzanellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Protobranchia"); ps.setString(3, "Manzanellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("manzanellidae_audio", "species.mollusca.protobranchia.manzanellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("manzanellidae_data", "species.mollusca.protobranchia.manzanellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("manzanellidae_graphics", "species.mollusca.protobranchia.manzanellidae.graphics.spectrum", sb.toString());
        }
    }
}