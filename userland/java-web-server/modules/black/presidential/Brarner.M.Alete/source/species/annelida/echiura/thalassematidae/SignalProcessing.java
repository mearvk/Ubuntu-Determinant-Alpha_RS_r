package presidential.Brarner.M.Alete.source.species.annelida.echiura.thalassematidae;
...
/**
 * Signal Processing for Family: Thalassematidae
 * <p>Phylum: Annelida | Class: Echiura | Order: Bonelliida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/echiura/thalassematidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16643; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/echiura/thalassematidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Echiura"); ps.setString(3, "Thalassematidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("thalassematidae_audio", "species.annelida.echiura.thalassematidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("thalassematidae_data", "species.annelida.echiura.thalassematidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("thalassematidae_graphics", "species.annelida.echiura.thalassematidae.graphics.spectrum", sb.toString());
        }
    }
}