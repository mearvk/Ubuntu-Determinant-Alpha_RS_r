package presidential.Brarner.M.Alete.source.species.bryozoa.eurystomata.penetrantiidae;
...
/**
 * Signal Processing for Family: Penetrantiidae
 * <p>Phylum: Bryozoa | Class: Eurystomata | Order: Terebriporina</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/eurystomata/penetrantiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16863; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/eurystomata/penetrantiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Eurystomata"); ps.setString(3, "Penetrantiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("penetrantiidae_audio", "species.bryozoa.eurystomata.penetrantiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("penetrantiidae_data", "species.bryozoa.eurystomata.penetrantiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("penetrantiidae_graphics", "species.bryozoa.eurystomata.penetrantiidae.graphics.spectrum", sb.toString());
        }
    }
}