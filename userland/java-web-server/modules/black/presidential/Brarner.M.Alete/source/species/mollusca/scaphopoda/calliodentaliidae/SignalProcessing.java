package presidential.Brarner.M.Alete.source.species.mollusca.scaphopoda.calliodentaliidae;
...
/**
 * Signal Processing for Family: Calliodentaliidae
 * <p>Phylum: Mollusca | Class: Scaphopoda | Order: Dentaliida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/scaphopoda/calliodentaliidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17773; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/scaphopoda/calliodentaliidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Scaphopoda"); ps.setString(3, "Calliodentaliidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("calliodentaliidae_audio", "species.mollusca.scaphopoda.calliodentaliidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("calliodentaliidae_data", "species.mollusca.scaphopoda.calliodentaliidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("calliodentaliidae_graphics", "species.mollusca.scaphopoda.calliodentaliidae.graphics.spectrum", sb.toString());
        }
    }
}