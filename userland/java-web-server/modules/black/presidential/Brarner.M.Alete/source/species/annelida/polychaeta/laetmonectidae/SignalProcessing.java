package presidential.Brarner.M.Alete.source.species.annelida.polychaeta.laetmonectidae;
...
/**
 * Signal Processing for Family: Laetmonectidae
 * <p>Phylum: Annelida | Class: Polychaeta | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/polychaeta/laetmonectidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16627; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/polychaeta/laetmonectidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Polychaeta"); ps.setString(3, "Laetmonectidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("laetmonectidae_audio", "species.annelida.polychaeta.laetmonectidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("laetmonectidae_data", "species.annelida.polychaeta.laetmonectidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("laetmonectidae_graphics", "species.annelida.polychaeta.laetmonectidae.graphics.spectrum", sb.toString());
        }
    }
}