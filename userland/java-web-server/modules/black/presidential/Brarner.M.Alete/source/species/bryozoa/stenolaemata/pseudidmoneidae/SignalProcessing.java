package presidential.Brarner.M.Alete.source.species.bryozoa.stenolaemata.pseudidmoneidae;
...
/**
 * Signal Processing for Family: Pseudidmoneidae
 * <p>Phylum: Bryozoa | Class: Stenolaemata | Order: Cancellata</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/bryozoa/stenolaemata/pseudidmoneidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16871; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/bryozoa/stenolaemata/pseudidmoneidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Bryozoa"); ps.setString(2, "Stenolaemata"); ps.setString(3, "Pseudidmoneidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("pseudidmoneidae_audio", "species.bryozoa.stenolaemata.pseudidmoneidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("pseudidmoneidae_data", "species.bryozoa.stenolaemata.pseudidmoneidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("pseudidmoneidae_graphics", "species.bryozoa.stenolaemata.pseudidmoneidae.graphics.spectrum", sb.toString());
        }
    }
}