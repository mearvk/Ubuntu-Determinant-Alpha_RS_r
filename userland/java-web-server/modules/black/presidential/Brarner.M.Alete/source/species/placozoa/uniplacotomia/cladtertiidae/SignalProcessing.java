...
/**
 * Signal Processing for Family: Cladtertiidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/placozoa/uniplacotomia/cladtertiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11308; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/placozoa/uniplacotomia/cladtertiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Placozoa"); ps.setString(2, "Uniplacotomia"); ps.setString(3, "Cladtertiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cladtertiidae_audio", "species.placozoa.uniplacotomia.cladtertiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cladtertiidae_data", "species.placozoa.uniplacotomia.cladtertiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cladtertiidae_graphics", "species.placozoa.uniplacotomia.cladtertiidae.graphics.spectrum", sb.toString());
        }
    }
}