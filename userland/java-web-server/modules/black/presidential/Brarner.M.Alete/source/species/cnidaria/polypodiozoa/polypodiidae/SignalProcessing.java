...
/**
 * Signal Processing for Family: Polypodiidae
 * <p>Phylum: Cnidaria | Class: Polypodiozoa | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/polypodiozoa/polypodiidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11238; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/polypodiozoa/polypodiidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Polypodiozoa"); ps.setString(3, "Polypodiidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("polypodiidae_audio", "species.cnidaria.polypodiozoa.polypodiidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("polypodiidae_data", "species.cnidaria.polypodiozoa.polypodiidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("polypodiidae_graphics", "species.cnidaria.polypodiozoa.polypodiidae.graphics.spectrum", sb.toString());
        }
    }
}