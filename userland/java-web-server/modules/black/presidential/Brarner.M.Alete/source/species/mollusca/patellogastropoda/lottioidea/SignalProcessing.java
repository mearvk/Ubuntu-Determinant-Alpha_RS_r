package presidential.Brarner.M.Alete.source.species.mollusca.patellogastropoda.lottioidea;
...
/**
 * Signal Processing for Family: Lottioidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/patellogastropoda/lottioidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17120; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/patellogastropoda/lottioidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Patellogastropoda"); ps.setString(3, "Lottioidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("lottioidea_audio", "species.mollusca.patellogastropoda.lottioidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("lottioidea_data", "species.mollusca.patellogastropoda.lottioidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("lottioidea_graphics", "species.mollusca.patellogastropoda.lottioidea.graphics.spectrum", sb.toString());
        }
    }
}