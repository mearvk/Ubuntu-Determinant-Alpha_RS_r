package presidential.Brarner.M.Alete.source.species.cnidaria.hydroidolina.proboscidactylidae;
...
/**
 * Signal Processing for Family: Proboscidactylidae
 * <p>Phylum: Cnidaria | Class: Hydroidolina | Order: Filifera</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/hydroidolina/proboscidactylidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11172; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/hydroidolina/proboscidactylidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Hydroidolina"); ps.setString(3, "Proboscidactylidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("proboscidactylidae_audio", "species.cnidaria.hydroidolina.proboscidactylidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("proboscidactylidae_data", "species.cnidaria.hydroidolina.proboscidactylidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("proboscidactylidae_graphics", "species.cnidaria.hydroidolina.proboscidactylidae.graphics.spectrum", sb.toString());
        }
    }
}