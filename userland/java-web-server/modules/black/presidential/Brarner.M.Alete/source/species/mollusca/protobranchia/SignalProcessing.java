package presidential.Brarner.M.Alete.source.species.mollusca.protobranchia;
...
/**
 * Signal Processing for Phylum: Mollusca, Class: Protobranchia
 * <p>Families: 19</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/protobranchia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17048; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/protobranchia";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Protobranchia"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("mollusca_protobranchia_audio", "species.mollusca.protobranchia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("mollusca_protobranchia_data", "species.mollusca.protobranchia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("mollusca_protobranchia_graphics", "species.mollusca.protobranchia.graphics.spectrum", sb.toString());
        }
    }
}