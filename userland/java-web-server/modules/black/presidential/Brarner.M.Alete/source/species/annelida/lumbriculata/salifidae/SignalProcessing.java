...
/**
 * Signal Processing for Family: Salifidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/lumbriculata/salifidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16600; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/lumbriculata/salifidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Lumbriculata"); ps.setString(3, "Salifidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("salifidae_audio", "species.annelida.lumbriculata.salifidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("salifidae_data", "species.annelida.lumbriculata.salifidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("salifidae_graphics", "species.annelida.lumbriculata.salifidae.graphics.spectrum", sb.toString());
        }
    }
}