package presidential.Brarner.M.Alete.source.species.nematoda.chromadoria.plectidae;
...
/**
 * Signal Processing for Family: Plectidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/nematoda/chromadoria/plectidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16412; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/nematoda/chromadoria/plectidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Nematoda"); ps.setString(2, "Chromadoria"); ps.setString(3, "Plectidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("plectidae_audio", "species.nematoda.chromadoria.plectidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("plectidae_data", "species.nematoda.chromadoria.plectidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("plectidae_graphics", "species.nematoda.chromadoria.plectidae.graphics.spectrum", sb.toString());
        }
    }
}