package presidential.Brarner.M.Alete.source.species.annelida.clitellata.capilloventridae;
...
/**
 * Signal Processing for Family: Capilloventridae
 * <p>Phylum: Annelida | Class: Clitellata | Order: </p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/clitellata/capilloventridae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16564; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/clitellata/capilloventridae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Clitellata"); ps.setString(3, "Capilloventridae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("capilloventridae_audio", "species.annelida.clitellata.capilloventridae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("capilloventridae_data", "species.annelida.clitellata.capilloventridae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("capilloventridae_graphics", "species.annelida.clitellata.capilloventridae.graphics.spectrum", sb.toString());
        }
    }
}