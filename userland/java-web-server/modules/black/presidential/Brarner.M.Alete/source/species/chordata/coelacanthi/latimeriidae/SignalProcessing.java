package presidential.Brarner.M.Alete.source.species.chordata.coelacanthi.latimeriidae;
...
/**
 * Signal Processing for Family: Latimeriidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/coelacanthi/latimeriidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12041; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/coelacanthi/latimeriidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Coelacanthi"); ps.setString(3, "Latimeriidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("latimeriidae_audio", "species.chordata.coelacanthi.latimeriidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("latimeriidae_data", "species.chordata.coelacanthi.latimeriidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("latimeriidae_graphics", "species.chordata.coelacanthi.latimeriidae.graphics.spectrum", sb.toString());
        }
    }
}