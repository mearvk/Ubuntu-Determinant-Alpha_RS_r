package presidential.Brarner.M.Alete.source.species.chordata.teleostei.cyclopteroidea;
...
/**
 * Signal Processing for Family: Cyclopteroidea
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/teleostei/cyclopteroidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11737; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/teleostei/cyclopteroidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Teleostei"); ps.setString(3, "Cyclopteroidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("cyclopteroidea_audio", "species.chordata.teleostei.cyclopteroidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("cyclopteroidea_data", "species.chordata.teleostei.cyclopteroidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("cyclopteroidea_graphics", "species.chordata.teleostei.cyclopteroidea.graphics.spectrum", sb.toString());
        }
    }
}