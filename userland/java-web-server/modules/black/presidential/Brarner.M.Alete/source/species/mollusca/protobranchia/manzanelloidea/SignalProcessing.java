package presidential.Brarner.M.Alete.source.species.mollusca.protobranchia.manzanelloidea;
...
/**
 * Signal Processing for Family: Manzanelloidea
 * <p>Phylum: Mollusca | Class: Protobranchia | Order: Manzanellida</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/mollusca/protobranchia/manzanelloidea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 17049; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/mollusca/protobranchia/manzanelloidea";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Mollusca"); ps.setString(2, "Protobranchia"); ps.setString(3, "Manzanelloidea"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("manzanelloidea_audio", "species.mollusca.protobranchia.manzanelloidea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("manzanelloidea_data", "species.mollusca.protobranchia.manzanelloidea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("manzanelloidea_graphics", "species.mollusca.protobranchia.manzanelloidea.graphics.spectrum", sb.toString());
        }
    }
}