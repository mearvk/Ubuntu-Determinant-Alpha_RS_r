package presidential.Brarner.M.Alete.source.species.annelida.lumbriculata.americobdellidae;
...
/**
 * Signal Processing for Family: Americobdellidae
 * <p>Phylum: Annelida | Class: Lumbriculata | Order: Erpobdelliformes</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/annelida/lumbriculata/americobdellidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 16597; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/annelida/lumbriculata/americobdellidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Annelida"); ps.setString(2, "Lumbriculata"); ps.setString(3, "Americobdellidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("americobdellidae_audio", "species.annelida.lumbriculata.americobdellidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("americobdellidae_data", "species.annelida.lumbriculata.americobdellidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("americobdellidae_graphics", "species.annelida.lumbriculata.americobdellidae.graphics.spectrum", sb.toString());
        }
    }
}