package presidential.Brarner.M.Alete.source.species.chordata.elasmobranchii.narkidae;
...
/**
 * Signal Processing for Family: Narkidae
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/chordata/elasmobranchii/narkidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 12033; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/chordata/elasmobranchii/narkidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Chordata"); ps.setString(2, "Elasmobranchii"); ps.setString(3, "Narkidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("narkidae_audio", "species.chordata.elasmobranchii.narkidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("narkidae_data", "species.chordata.elasmobranchii.narkidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("narkidae_graphics", "species.chordata.elasmobranchii.narkidae.graphics.spectrum", sb.toString());
        }
    }
}