...
/**
 * Signal Processing for Family: Tesseranthidae
 * <p>Phylum: Cnidaria | Class: Staurozoa | Order: Stauromedusae</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/species/cnidaria/staurozoa/tesseranthidae/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 11264; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/species/cnidaria/staurozoa/tesseranthidae";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cnidaria"); ps.setString(2, "Staurozoa"); ps.setString(3, "Tesseranthidae"); ps.setString(4, expName); ps.setString(5, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("tesseranthidae_audio", "species.cnidaria.staurozoa.tesseranthidae.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("tesseranthidae_data", "species.cnidaria.staurozoa.tesseranthidae.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("tesseranthidae_graphics", "species.cnidaria.staurozoa.tesseranthidae.graphics.spectrum", sb.toString());
        }
    }
}