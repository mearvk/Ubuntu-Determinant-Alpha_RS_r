...
/**
 * Signal Processing for Art Museum: C.S. Brown Cultural Arts Center
 * <p>City: Winton | Type: Art Center</p>
 * <p>Notes: Cultural arts and heritage center</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/csbrownculturalartscenter/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18411; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/csbrownculturalartscenter";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "C.S. Brown Cultural Arts Center"); ps.setString(2, "Winton"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_csbrownculturalartscenter_audio", "art.csbrownculturalartscenter.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_csbrownculturalartscenter_data", "art.csbrownculturalartscenter.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_csbrownculturalartscenter_graphics", "art.csbrownculturalartscenter.graphics.spectrum", sb.toString());
        }
    }
}