package presidential.Brarner.M.Alete.source.art.cameronartmuseum;
...
/**
 * Signal Processing for Art Museum: Cameron Art Museum
 * <p>City: Wilmington | Type: Art Museum</p>
 * <p>Notes: Regional and national art; historic collections</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/cameronartmuseum/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18409; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/cameronartmuseum";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Cameron Art Museum"); ps.setString(2, "Wilmington"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_cameronartmuseum_audio", "art.cameronartmuseum.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_cameronartmuseum_data", "art.cameronartmuseum.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_cameronartmuseum_graphics", "art.cameronartmuseum.graphics.spectrum", sb.toString());
        }
    }
}