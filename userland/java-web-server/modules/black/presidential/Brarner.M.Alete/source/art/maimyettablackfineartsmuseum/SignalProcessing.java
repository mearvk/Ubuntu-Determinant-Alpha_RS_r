...
/**
 * Signal Processing for Art Museum: Maimy Etta Black Fine Arts Museum
 * <p>City: Forest City | Type: Art Museum</p>
 * <p>Notes: Local fine arts museum</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/maimyettablackfineartsmuseum/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18410; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/maimyettablackfineartsmuseum";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Maimy Etta Black Fine Arts Museum"); ps.setString(2, "Forest City"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_maimyettablackfineartsmuseum_audio", "art.maimyettablackfineartsmuseum.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_maimyettablackfineartsmuseum_data", "art.maimyettablackfineartsmuseum.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_maimyettablackfineartsmuseum_graphics", "art.maimyettablackfineartsmuseum.graphics.spectrum", sb.toString());
        }
    }
}