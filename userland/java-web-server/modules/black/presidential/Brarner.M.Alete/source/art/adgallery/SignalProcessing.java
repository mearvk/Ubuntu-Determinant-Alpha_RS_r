package presidential.Brarner.M.Alete.source.art.adgallery;
...
/**
 * Signal Processing for Art Museum: A.D. Gallery
 * <p>City: Pembroke | Type: University Gallery</p>
 * <p>Notes: UNC Pembroke; contemporary and student exhibitions</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/adgallery/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18402; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/adgallery";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "A.D. Gallery"); ps.setString(2, "Pembroke"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_adgallery_audio", "art.adgallery.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_adgallery_data", "art.adgallery.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_adgallery_graphics", "art.adgallery.graphics.spectrum", sb.toString());
        }
    }
}