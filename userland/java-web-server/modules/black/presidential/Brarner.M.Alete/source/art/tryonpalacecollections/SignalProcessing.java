package presidential.Brarner.M.Alete.source.art.tryonpalacecollections;
...
/**
 * Signal Processing for Art Museum: Tryon Palace Collections
 * <p>City: New Bern | Type: Historic Site Museum</p>
 * <p>Notes: State historic site with art and decorative arts collections</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/tryonpalacecollections/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18412; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/tryonpalacecollections";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Tryon Palace Collections"); ps.setString(2, "New Bern"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_tryonpalacecollections_audio", "art.tryonpalacecollections.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_tryonpalacecollections_data", "art.tryonpalacecollections.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_tryonpalacecollections_graphics", "art.tryonpalacecollections.graphics.spectrum", sb.toString());
        }
    }
}