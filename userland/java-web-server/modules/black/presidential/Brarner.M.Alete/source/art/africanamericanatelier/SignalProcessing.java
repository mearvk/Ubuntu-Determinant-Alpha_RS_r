package presidential.Brarner.M.Alete.source.art.africanamericanatelier;
...
/**
 * Signal Processing for Art Museum: African American Atelier
 * <p>City: Greensboro | Type: Art Center</p>
 * <p>Notes: African American visual arts; Greensboro Cultural Center</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/africanamericanatelier/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18403; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/africanamericanatelier";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "African American Atelier"); ps.setString(2, "Greensboro"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_africanamericanatelier_audio", "art.africanamericanatelier.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_africanamericanatelier_data", "art.africanamericanatelier.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_africanamericanatelier_graphics", "art.africanamericanatelier.graphics.spectrum", sb.toString());
        }
    }
}