package presidential.Brarner.M.Alete.source.art.acklandartmuseum;
...
/**
 * Signal Processing for Art Museum: Ackland Art Museum
 * <p>City: Chapel Hill | Type: University Museum</p>
 * <p>Notes: UNC-Chapel Hill; Asian, European, African, contemporary art</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/acklandartmuseum/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18401; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/acklandartmuseum";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Ackland Art Museum"); ps.setString(2, "Chapel Hill"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_acklandartmuseum_audio", "art.acklandartmuseum.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_acklandartmuseum_data", "art.acklandartmuseum.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_acklandartmuseum_graphics", "art.acklandartmuseum.graphics.spectrum", sb.toString());
        }
    }
}