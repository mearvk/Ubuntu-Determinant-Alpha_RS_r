package presidential.Brarner.M.Alete.source.art.andygriffithmuseum;
...
/**
 * Signal Processing for Art Museum: Andy Griffith Museum
 * <p>City: Mount Airy | Type: Heritage Museum</p>
 * <p>Notes: Cultural artifacts including visual materials</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/andygriffithmuseum/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18419; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/andygriffithmuseum";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Andy Griffith Museum"); ps.setString(2, "Mount Airy"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_andygriffithmuseum_audio", "art.andygriffithmuseum.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_andygriffithmuseum_data", "art.andygriffithmuseum.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_andygriffithmuseum_graphics", "art.andygriffithmuseum.graphics.spectrum", sb.toString());
        }
    }
}