...
/**
 * Signal Processing for Art Museum: North Carolina Museum of Art
 * <p>City: Raleigh | Type: State Art Museum</p>
 * <p>Notes: Major statewide art museum; extensive permanent collection</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/northcarolinamuseumofart/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18400; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/northcarolinamuseumofart";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "North Carolina Museum of Art"); ps.setString(2, "Raleigh"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_northcarolinamuseumofart_audio", "art.northcarolinamuseumofart.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_northcarolinamuseumofart_data", "art.northcarolinamuseumofart.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_northcarolinamuseumofart_graphics", "art.northcarolinamuseumofart.graphics.spectrum", sb.toString());
        }
    }
}