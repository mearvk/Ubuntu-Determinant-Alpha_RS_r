...
/**
 * Signal Processing for Art Museum: Maritime Museums (Beaufort
 * <p>City: Hatteras | Type: Southport)</p>
 * <p>Notes: Multiple</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/maritimemuseumsbeaufort/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18414; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/maritimemuseumsbeaufort";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Maritime Museums (Beaufort"); ps.setString(2, "Hatteras"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_maritimemuseumsbeaufort_audio", "art.maritimemuseumsbeaufort.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_maritimemuseumsbeaufort_data", "art.maritimemuseumsbeaufort.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_maritimemuseumsbeaufort_graphics", "art.maritimemuseumsbeaufort.graphics.spectrum", sb.toString());
        }
    }
}