package presidential.Brarner.M.Alete.source.art.roanokeislandfestivalpark;
...
/**
 * Signal Processing for Art Museum: Roanoke Island Festival Park
 * <p>City: Manteo | Type: State Historic Park</p>
 * <p>Notes: Historic and cultural collections</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/roanokeislandfestivalpark/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18415; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/roanokeislandfestivalpark";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Roanoke Island Festival Park"); ps.setString(2, "Manteo"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_roanokeislandfestivalpark_audio", "art.roanokeislandfestivalpark.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_roanokeislandfestivalpark_data", "art.roanokeislandfestivalpark.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_roanokeislandfestivalpark_graphics", "art.roanokeislandfestivalpark.graphics.spectrum", sb.toString());
        }
    }
}