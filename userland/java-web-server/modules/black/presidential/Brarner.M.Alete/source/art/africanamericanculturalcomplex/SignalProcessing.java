package presidential.Brarner.M.Alete.source.art.africanamericanculturalcomplex;
...
/**
 * Signal Processing for Art Museum: African American Cultural Complex
 * <p>City: Raleigh | Type: Art & History Center</p>
 * <p>Notes: African American contributions; art collections</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/africanamericanculturalcomplex/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18417; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/africanamericanculturalcomplex";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "African American Cultural Complex"); ps.setString(2, "Raleigh"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_africanamericanculturalcomplex_audio", "art.africanamericanculturalcomplex.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_africanamericanculturalcomplex_data", "art.africanamericanculturalcomplex.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_africanamericanculturalcomplex_graphics", "art.africanamericanculturalcomplex.graphics.spectrum", sb.toString());
        }
    }
}