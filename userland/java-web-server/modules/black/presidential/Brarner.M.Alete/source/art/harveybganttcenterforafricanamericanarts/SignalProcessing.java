...
/**
 * Signal Processing for Art Museum: Harvey B. Gantt Center for African American Arts + Culture
 * <p>City: Charlotte | Type: Art Museum</p>
 * <p>Notes: African American art, culture, and history</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/harveybganttcenterforafricanamericanarts/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18404; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/harveybganttcenterforafricanamericanarts";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Harvey B. Gantt Center for African American Arts + Culture"); ps.setString(2, "Charlotte"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_harveybganttcenterforafricanamericanarts_audio", "art.harveybganttcenterforafricanamericanarts.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_harveybganttcenterforafricanamericanarts_data", "art.harveybganttcenterforafricanamericanarts.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_harveybganttcenterforafricanamericanarts_graphics", "art.harveybganttcenterforafricanamericanarts.graphics.spectrum", sb.toString());
        }
    }
}