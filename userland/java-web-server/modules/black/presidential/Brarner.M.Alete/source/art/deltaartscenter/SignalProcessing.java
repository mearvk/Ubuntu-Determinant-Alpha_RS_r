package presidential.Brarner.M.Alete.source.art.deltaartscenter;
...
/**
 * Signal Processing for Art Museum: Delta Arts Center
 * <p>City: Winston-Salem | Type: Art Center</p>
 * <p>Notes: African American arts and culture</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/deltaartscenter/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18405; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/deltaartscenter";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Delta Arts Center"); ps.setString(2, "Winston-Salem"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_deltaartscenter_audio", "art.deltaartscenter.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_deltaartscenter_data", "art.deltaartscenter.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_deltaartscenter_graphics", "art.deltaartscenter.graphics.spectrum", sb.toString());
        }
    }
}