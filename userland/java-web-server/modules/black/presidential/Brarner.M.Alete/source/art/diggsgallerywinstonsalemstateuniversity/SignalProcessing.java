package presidential.Brarner.M.Alete.source.art.diggsgallerywinstonsalemstateuniversity;
...
/**
 * Signal Processing for Art Museum: Diggs Gallery (Winston-Salem State University)
 * <p>City: Winston-Salem | Type: University Museum</p>
 * <p>Notes: African and African Diaspora art; major university collection</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/diggsgallerywinstonsalemstateuniversity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18406; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/diggsgallerywinstonsalemstateuniversity";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "Diggs Gallery (Winston-Salem State University)"); ps.setString(2, "Winston-Salem"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_diggsgallerywinstonsalemstateuniversity_audio", "art.diggsgallerywinstonsalemstateuniversity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_diggsgallerywinstonsalemstateuniversity_data", "art.diggsgallerywinstonsalemstateuniversity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_diggsgallerywinstonsalemstateuniversity_graphics", "art.diggsgallerywinstonsalemstateuniversity.graphics.spectrum", sb.toString());
        }
    }
}