package presidential.Brarner.M.Alete.source.art.northcarolinacentraluniversityartmuseum;
...
/**
 * Signal Processing for Art Museum: North Carolina Central University Art Museum
 * <p>City: Durham | Type: University Museum</p>
 * <p>Notes: African American art; NCCU campus</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/northcarolinacentraluniversityartmuseum/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18407; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/northcarolinacentraluniversityartmuseum";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "North Carolina Central University Art Museum"); ps.setString(2, "Durham"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_northcarolinacentraluniversityartmuseum_audio", "art.northcarolinacentraluniversityartmuseum.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_northcarolinacentraluniversityartmuseum_data", "art.northcarolinacentraluniversityartmuseum.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_northcarolinacentraluniversityartmuseum_graphics", "art.northcarolinacentraluniversityartmuseum.graphics.spectrum", sb.toString());
        }
    }
}