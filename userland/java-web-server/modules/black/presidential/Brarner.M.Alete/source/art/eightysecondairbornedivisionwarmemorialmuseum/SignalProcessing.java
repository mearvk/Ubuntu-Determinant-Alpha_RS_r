...
/**
 * Signal Processing for Art Museum: 82nd Airborne Division War Memorial Museum
 * <p>City: Fort Liberty | Type: Military Museum</p>
 * <p>Notes: Includes historical art and artifacts</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/eightysecondairbornedivisionwarmemorialmuseum/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18416; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/eightysecondairbornedivisionwarmemorialmuseum";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "82nd Airborne Division War Memorial Museum"); ps.setString(2, "Fort Liberty"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_82ndairbornedivisionwarmemorialmuseum_audio", "art.eightysecondairbornedivisionwarmemorialmuseum.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_82ndairbornedivisionwarmemorialmuseum_data", "art.eightysecondairbornedivisionwarmemorialmuseum.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_82ndairbornedivisionwarmemorialmuseum_graphics", "art.eightysecondairbornedivisionwarmemorialmuseum.graphics.spectrum", sb.toString());
        }
    }
}