package presidential.Brarner.M.Alete.source.art.americanclassicmotorcyclemuseum;
...
/**
 * Signal Processing for Art Museum: American Classic Motorcycle Museum
 * <p>City: Asheboro | Type: Specialty Museum</p>
 * <p>Notes: Includes design and mechanical art</p>
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/art/americanclassicmotorcyclemuseum/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 18418; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/BrarnerScience";
            dbUser = "root"; dbPass = ""; outputDir = "output/art/americanclassicmotorcyclemuseum";
        }
    }
    ...
    private static void writeToDatabase(String expName, String data) throws Exception {
        try (Connection conn = DriverManager.getConnection(dbUrl, dbUser, dbPass);
            ...
            ps.setString(1, "American Classic Motorcycle Museum"); ps.setString(2, "Asheboro"); ps.setString(3, expName); ps.setString(4, data); ps.executeUpdate();
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("art_americanclassicmotorcyclemuseum_audio", "art.americanclassicmotorcyclemuseum.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("art_americanclassicmotorcyclemuseum_data", "art.americanclassicmotorcyclemuseum.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("art_americanclassicmotorcyclemuseum_graphics", "art.americanclassicmotorcyclemuseum.graphics.spectrum", sb.toString());
        }
    }
}