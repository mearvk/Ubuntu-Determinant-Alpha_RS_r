...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/raleigh002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/raleigh002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_raleigh002_audio", "postal.raleigh002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_raleigh002_data", "postal.raleigh002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_raleigh002_graphics", "postal.raleigh002.graphics.spectrum", sb.toString());
        }
    }
}