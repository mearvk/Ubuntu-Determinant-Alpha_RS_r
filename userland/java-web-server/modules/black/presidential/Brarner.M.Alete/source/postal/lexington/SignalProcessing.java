package presidential.Brarner.M.Alete.source.postal.lexington;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/lexington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9043; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/lexington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_lexington_audio", "postal.lexington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_lexington_data", "postal.lexington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_lexington_graphics", "postal.lexington.graphics.spectrum", sb.toString());
        }
    }
}