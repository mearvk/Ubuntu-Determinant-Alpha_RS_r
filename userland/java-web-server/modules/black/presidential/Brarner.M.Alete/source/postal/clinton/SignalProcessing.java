package presidential.Brarner.M.Alete.source.postal.clinton;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/clinton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9045; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/clinton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_clinton_audio", "postal.clinton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_clinton_data", "postal.clinton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_clinton_graphics", "postal.clinton.graphics.spectrum", sb.toString());
        }
    }
}