...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/newbern/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9029; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/newbern";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_newbern_audio", "postal.newbern.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_newbern_data", "postal.newbern.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_newbern_graphics", "postal.newbern.graphics.spectrum", sb.toString());
        }
    }
}