package presidential.Brarner.M.Alete.source.postal.asheville;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/asheville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9009; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/asheville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_asheville_audio", "postal.asheville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_asheville_data", "postal.asheville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_asheville_graphics", "postal.asheville.graphics.spectrum", sb.toString());
        }
    }
}