package presidential.Brarner.M.Alete.source.postal.havelock;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/havelock/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9042; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/havelock";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_havelock_audio", "postal.havelock.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_havelock_data", "postal.havelock.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_havelock_graphics", "postal.havelock.graphics.spectrum", sb.toString());
        }
    }
}