package presidential.Brarner.M.Alete.source.postal.monroe;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/monroe/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9025; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/monroe";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_monroe_audio", "postal.monroe.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_monroe_data", "postal.monroe.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_monroe_graphics", "postal.monroe.graphics.spectrum", sb.toString());
        }
    }
}