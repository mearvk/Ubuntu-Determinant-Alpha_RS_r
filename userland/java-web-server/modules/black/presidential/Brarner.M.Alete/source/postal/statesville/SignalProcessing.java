package presidential.Brarner.M.Alete.source.postal.statesville;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/statesville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9030; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/statesville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_statesville_audio", "postal.statesville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_statesville_data", "postal.statesville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_statesville_graphics", "postal.statesville.graphics.spectrum", sb.toString());
        }
    }
}