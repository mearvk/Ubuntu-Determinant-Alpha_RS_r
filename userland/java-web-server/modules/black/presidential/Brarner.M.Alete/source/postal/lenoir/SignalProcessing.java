package presidential.Brarner.M.Alete.source.postal.lenoir;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/lenoir/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9044; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/lenoir";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_lenoir_audio", "postal.lenoir.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_lenoir_data", "postal.lenoir.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_lenoir_graphics", "postal.lenoir.graphics.spectrum", sb.toString());
        }
    }
}