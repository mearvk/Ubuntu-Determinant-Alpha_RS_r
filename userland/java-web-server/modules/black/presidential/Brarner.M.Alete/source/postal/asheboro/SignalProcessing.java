package presidential.Brarner.M.Alete.source.postal.asheboro;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/asheboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9047; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/asheboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_asheboro_audio", "postal.asheboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_asheboro_data", "postal.asheboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_asheboro_graphics", "postal.asheboro.graphics.spectrum", sb.toString());
        }
    }
}