...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/rockymount/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9017; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/rockymount";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_rockymount_audio", "postal.rockymount.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_rockymount_data", "postal.rockymount.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_rockymount_graphics", "postal.rockymount.graphics.spectrum", sb.toString());
        }
    }
}