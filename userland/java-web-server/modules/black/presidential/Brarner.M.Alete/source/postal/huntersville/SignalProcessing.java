package presidential.Brarner.M.Alete.source.postal.huntersville;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/huntersville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9019; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/huntersville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_huntersville_audio", "postal.huntersville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_huntersville_data", "postal.huntersville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_huntersville_graphics", "postal.huntersville.graphics.spectrum", sb.toString());
        }
    }
}