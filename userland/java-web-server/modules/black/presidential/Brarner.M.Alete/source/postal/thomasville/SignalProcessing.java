package presidential.Brarner.M.Alete.source.postal.thomasville;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/thomasville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9032; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/thomasville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_thomasville_audio", "postal.thomasville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_thomasville_data", "postal.thomasville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_thomasville_graphics", "postal.thomasville.graphics.spectrum", sb.toString());
        }
    }
}