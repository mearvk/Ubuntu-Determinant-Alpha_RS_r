package presidential.Brarner.M.Alete.source.postal.albemarle;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/albemarle/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9048; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/albemarle";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_albemarle_audio", "postal.albemarle.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_albemarle_data", "postal.albemarle.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_albemarle_graphics", "postal.albemarle.graphics.spectrum", sb.toString());
        }
    }
}