...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/cary/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9012; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/cary";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_cary_audio", "postal.cary.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_cary_data", "postal.cary.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_cary_graphics", "postal.cary.graphics.spectrum", sb.toString());
        }
    }
}