package presidential.Brarner.M.Alete.source.postal.hendersonville;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/hendersonville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9033; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/hendersonville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_hendersonville_audio", "postal.hendersonville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_hendersonville_data", "postal.hendersonville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_hendersonville_graphics", "postal.hendersonville.graphics.spectrum", sb.toString());
        }
    }
}