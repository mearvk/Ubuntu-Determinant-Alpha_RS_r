package presidential.Brarner.M.Alete.source.postal.sanford;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/sanford/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9046; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/sanford";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_sanford_audio", "postal.sanford.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_sanford_data", "postal.sanford.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_sanford_graphics", "postal.sanford.graphics.spectrum", sb.toString());
        }
    }
}