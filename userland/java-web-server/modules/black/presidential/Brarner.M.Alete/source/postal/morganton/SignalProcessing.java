package presidential.Brarner.M.Alete.source.postal.morganton;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/morganton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9035; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/morganton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_morganton_audio", "postal.morganton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_morganton_data", "postal.morganton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_morganton_graphics", "postal.morganton.graphics.spectrum", sb.toString());
        }
    }
}