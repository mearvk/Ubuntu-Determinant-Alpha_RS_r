package presidential.Brarner.M.Alete.source.postal.concord;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/concord/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9013; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/concord";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_concord_audio", "postal.concord.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_concord_data", "postal.concord.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_concord_graphics", "postal.concord.graphics.spectrum", sb.toString());
        }
    }
}