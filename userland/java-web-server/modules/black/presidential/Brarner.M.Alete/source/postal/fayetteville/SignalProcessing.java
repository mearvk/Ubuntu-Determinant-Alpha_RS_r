...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/fayetteville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/fayetteville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_fayetteville_audio", "postal.fayetteville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_fayetteville_data", "postal.fayetteville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_fayetteville_graphics", "postal.fayetteville.graphics.spectrum", sb.toString());
        }
    }
}