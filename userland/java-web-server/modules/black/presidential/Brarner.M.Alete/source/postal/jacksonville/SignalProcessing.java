package presidential.Brarner.M.Alete.source.postal.jacksonville;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/jacksonville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9015; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/jacksonville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_jacksonville_audio", "postal.jacksonville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_jacksonville_data", "postal.jacksonville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_jacksonville_graphics", "postal.jacksonville.graphics.spectrum", sb.toString());
        }
    }
}