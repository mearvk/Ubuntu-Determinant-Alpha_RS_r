...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/wakeforest/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9024; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/wakeforest";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_wakeforest_audio", "postal.wakeforest.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_wakeforest_data", "postal.wakeforest.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_wakeforest_graphics", "postal.wakeforest.graphics.spectrum", sb.toString());
        }
    }
}