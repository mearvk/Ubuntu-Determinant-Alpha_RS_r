...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/laurinburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9052; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/laurinburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_laurinburg_audio", "postal.laurinburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_laurinburg_data", "postal.laurinburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_laurinburg_graphics", "postal.laurinburg.graphics.spectrum", sb.toString());
        }
    }
}