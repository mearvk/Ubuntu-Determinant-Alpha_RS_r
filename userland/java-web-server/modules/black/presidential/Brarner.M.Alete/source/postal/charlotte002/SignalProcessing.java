package presidential.Brarner.M.Alete.source.postal.charlotte002;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/charlotte002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/charlotte002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_charlotte002_audio", "postal.charlotte002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_charlotte002_data", "postal.charlotte002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_charlotte002_graphics", "postal.charlotte002.graphics.spectrum", sb.toString());
        }
    }
}