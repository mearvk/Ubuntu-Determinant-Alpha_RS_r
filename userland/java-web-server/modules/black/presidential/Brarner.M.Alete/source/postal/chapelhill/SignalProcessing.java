...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/chapelhill/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9016; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/chapelhill";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_chapelhill_audio", "postal.chapelhill.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_chapelhill_data", "postal.chapelhill.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_chapelhill_graphics", "postal.chapelhill.graphics.spectrum", sb.toString());
        }
    }
}