package presidential.Brarner.M.Alete.source.postal.hickory;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/hickory/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9021; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/hickory";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_hickory_audio", "postal.hickory.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_hickory_data", "postal.hickory.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_hickory_graphics", "postal.hickory.graphics.spectrum", sb.toString());
        }
    }
}