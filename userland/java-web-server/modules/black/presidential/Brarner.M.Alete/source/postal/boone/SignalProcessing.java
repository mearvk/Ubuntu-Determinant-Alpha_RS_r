package presidential.Brarner.M.Alete.source.postal.boone;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/boone/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9034; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/boone";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_boone_audio", "postal.boone.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_boone_data", "postal.boone.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_boone_graphics", "postal.boone.graphics.spectrum", sb.toString());
        }
    }
}