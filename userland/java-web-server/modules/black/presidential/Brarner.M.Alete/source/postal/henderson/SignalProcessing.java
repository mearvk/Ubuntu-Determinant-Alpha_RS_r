package presidential.Brarner.M.Alete.source.postal.henderson;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/henderson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9053; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/henderson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_henderson_audio", "postal.henderson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_henderson_data", "postal.henderson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_henderson_graphics", "postal.henderson.graphics.spectrum", sb.toString());
        }
    }
}