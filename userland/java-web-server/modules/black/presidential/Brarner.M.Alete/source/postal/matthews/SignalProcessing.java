package presidential.Brarner.M.Alete.source.postal.matthews;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/matthews/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9027; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/matthews";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_matthews_audio", "postal.matthews.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_matthews_data", "postal.matthews.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_matthews_graphics", "postal.matthews.graphics.spectrum", sb.toString());
        }
    }
}