...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/lumberton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9040; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/lumberton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_lumberton_audio", "postal.lumberton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_lumberton_data", "postal.lumberton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_lumberton_graphics", "postal.lumberton.graphics.spectrum", sb.toString());
        }
    }
}