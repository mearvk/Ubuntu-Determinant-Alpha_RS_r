package presidential.Brarner.M.Alete.source.postal.mountairy;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/mountairy/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9039; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/mountairy";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_mountairy_audio", "postal.mountairy.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_mountairy_data", "postal.mountairy.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_mountairy_graphics", "postal.mountairy.graphics.spectrum", sb.toString());
        }
    }
}