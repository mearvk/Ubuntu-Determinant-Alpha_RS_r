...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/burlington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9018; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/burlington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_burlington_audio", "postal.burlington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_burlington_data", "postal.burlington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_burlington_graphics", "postal.burlington.graphics.spectrum", sb.toString());
        }
    }
}