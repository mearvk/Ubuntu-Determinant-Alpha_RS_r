package presidential.Brarner.M.Alete.source.postal.goldsboro;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/goldsboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9028; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/goldsboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_goldsboro_audio", "postal.goldsboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_goldsboro_data", "postal.goldsboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_goldsboro_graphics", "postal.goldsboro.graphics.spectrum", sb.toString());
        }
    }
}