package presidential.Brarner.M.Alete.source.postal.washington;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/washington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9054; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/washington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_washington_audio", "postal.washington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_washington_data", "postal.washington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_washington_graphics", "postal.washington.graphics.spectrum", sb.toString());
        }
    }
}