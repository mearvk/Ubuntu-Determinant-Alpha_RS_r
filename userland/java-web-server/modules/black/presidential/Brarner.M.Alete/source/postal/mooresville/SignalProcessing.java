package presidential.Brarner.M.Alete.source.postal.mooresville;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/mooresville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9023; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/mooresville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_mooresville_audio", "postal.mooresville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_mooresville_data", "postal.mooresville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_mooresville_graphics", "postal.mooresville.graphics.spectrum", sb.toString());
        }
    }
}