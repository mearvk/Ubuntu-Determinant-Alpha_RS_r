package presidential.Brarner.M.Alete.source.postal.eden;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/eden/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9051; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/eden";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_eden_audio", "postal.eden.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_eden_data", "postal.eden.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_eden_graphics", "postal.eden.graphics.spectrum", sb.toString());
        }
    }
}