package presidential.Brarner.M.Alete.source.postal.tarboro;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/tarboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9038; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/tarboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_tarboro_audio", "postal.tarboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_tarboro_data", "postal.tarboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_tarboro_graphics", "postal.tarboro.graphics.spectrum", sb.toString());
        }
    }
}