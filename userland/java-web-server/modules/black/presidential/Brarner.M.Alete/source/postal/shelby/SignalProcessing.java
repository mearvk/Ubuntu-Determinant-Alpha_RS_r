package presidential.Brarner.M.Alete.source.postal.shelby;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/shelby/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9041; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/shelby";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_shelby_audio", "postal.shelby.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_shelby_data", "postal.shelby.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_shelby_graphics", "postal.shelby.graphics.spectrum", sb.toString());
        }
    }
}