...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/salisbury/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9026; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/salisbury";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_salisbury_audio", "postal.salisbury.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_salisbury_data", "postal.salisbury.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_salisbury_graphics", "postal.salisbury.graphics.spectrum", sb.toString());
        }
    }
}