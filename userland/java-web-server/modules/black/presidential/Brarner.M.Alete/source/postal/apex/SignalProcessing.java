package presidential.Brarner.M.Alete.source.postal.apex;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/apex/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9020; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/apex";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_apex_audio", "postal.apex.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_apex_data", "postal.apex.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_apex_graphics", "postal.apex.graphics.spectrum", sb.toString());
        }
    }
}