...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/greenville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9022; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/greenville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_greenville_audio", "postal.greenville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_greenville_data", "postal.greenville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_greenville_graphics", "postal.greenville.graphics.spectrum", sb.toString());
        }
    }
}