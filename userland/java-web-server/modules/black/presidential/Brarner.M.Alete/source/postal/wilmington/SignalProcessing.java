package presidential.Brarner.M.Alete.source.postal.wilmington;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/wilmington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9010; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/wilmington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_wilmington_audio", "postal.wilmington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_wilmington_data", "postal.wilmington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_wilmington_graphics", "postal.wilmington.graphics.spectrum", sb.toString());
        }
    }
}