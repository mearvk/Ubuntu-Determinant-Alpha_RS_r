package presidential.Brarner.M.Alete.source.postal.roanokerapids;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/roanokerapids/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9037; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/roanokerapids";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_roanokerapids_audio", "postal.roanokerapids.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_roanokerapids_data", "postal.roanokerapids.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_roanokerapids_graphics", "postal.roanokerapids.graphics.spectrum", sb.toString());
        }
    }
}