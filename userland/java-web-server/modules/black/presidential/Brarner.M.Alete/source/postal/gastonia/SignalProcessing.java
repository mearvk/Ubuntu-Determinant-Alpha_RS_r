package presidential.Brarner.M.Alete.source.postal.gastonia;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/gastonia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9014; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/gastonia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_gastonia_audio", "postal.gastonia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_gastonia_data", "postal.gastonia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_gastonia_graphics", "postal.gastonia.graphics.spectrum", sb.toString());
        }
    }
}