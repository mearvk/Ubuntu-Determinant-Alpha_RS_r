package presidential.Brarner.M.Alete.source.postal.greensboro002;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/greensboro002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/greensboro002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_greensboro002_audio", "postal.greensboro002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_greensboro002_data", "postal.greensboro002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_greensboro002_graphics", "postal.greensboro002.graphics.spectrum", sb.toString());
        }
    }
}