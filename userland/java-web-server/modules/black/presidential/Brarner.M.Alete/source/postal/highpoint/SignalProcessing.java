...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/highpoint/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9011; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/highpoint";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_highpoint_audio", "postal.highpoint.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_highpoint_data", "postal.highpoint.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_highpoint_graphics", "postal.highpoint.graphics.spectrum", sb.toString());
        }
    }
}