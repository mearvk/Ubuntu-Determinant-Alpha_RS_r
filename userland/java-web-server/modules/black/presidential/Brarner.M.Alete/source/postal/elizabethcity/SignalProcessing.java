package presidential.Brarner.M.Alete.source.postal.elizabethcity;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/elizabethcity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9036; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/elizabethcity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_elizabethcity_audio", "postal.elizabethcity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_elizabethcity_data", "postal.elizabethcity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_elizabethcity_graphics", "postal.elizabethcity.graphics.spectrum", sb.toString());
        }
    }
}