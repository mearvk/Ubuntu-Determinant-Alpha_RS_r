package presidential.Brarner.M.Alete.source.postal.winstonsalem;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/winstonsalem/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/winstonsalem";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_winstonsalem_audio", "postal.winstonsalem.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_winstonsalem_data", "postal.winstonsalem.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_winstonsalem_graphics", "postal.winstonsalem.graphics.spectrum", sb.toString());
        }
    }
}