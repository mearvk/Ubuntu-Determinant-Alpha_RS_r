package presidential.Brarner.M.Alete.source.postal.durham;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/durham/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/durham";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_durham_audio", "postal.durham.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_durham_data", "postal.durham.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_durham_graphics", "postal.durham.graphics.spectrum", sb.toString());
        }
    }
}