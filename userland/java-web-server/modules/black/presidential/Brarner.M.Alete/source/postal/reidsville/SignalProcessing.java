package presidential.Brarner.M.Alete.source.postal.reidsville;
...
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/postal/reidsville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9050; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/postal/reidsville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("postal_reidsville_audio", "postal.reidsville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("postal_reidsville_data", "postal.reidsville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("postal_reidsville_graphics", "postal.reidsville.graphics.spectrum", sb.toString());
        }
    }
}