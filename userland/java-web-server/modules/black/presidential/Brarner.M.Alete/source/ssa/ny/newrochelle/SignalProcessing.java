...
/**
 * Signal Processing for SSA Office: NEW ROCHELLE NY
 * <p>Office Code: 128</p>
 * <p>Address: 85 HARRISON ST, NEW ROCHELLE, NY 10801</p>
 * <p>Phone: (855) 210-1026 | Fax: (833) 902-2551</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/newrochelle/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9598; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/newrochelle";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newrochelle_audio", "ssa.ny.newrochelle.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newrochelle_data", "ssa.ny.newrochelle.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newrochelle_graphics", "ssa.ny.newrochelle.graphics.spectrum", sb.toString());
        }
    }
}