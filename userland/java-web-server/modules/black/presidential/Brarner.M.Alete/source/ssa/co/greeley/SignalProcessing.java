package presidential.Brarner.M.Alete.source.ssa.co.greeley;
...
/**
 * Signal Processing for SSA Office: GREELEY CO
 * <p>Office Code: 885</p>
 * <p>Address: 5400 WEST 11 ST, GREELEY, CO 80634</p>
 * <p>Phone: (877) 405-9195 | Fax: (833) 612-0152</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/co/greeley/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10271; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/co/greeley";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_co/greeley_audio", "ssa.co.greeley.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_co/greeley_data", "ssa.co.greeley.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_co/greeley_graphics", "ssa.co.greeley.graphics.spectrum", sb.toString());
        }
    }
}