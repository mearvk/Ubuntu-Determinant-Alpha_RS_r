package presidential.Brarner.M.Alete.source.ssa.wi.fonddulac;
...
/**
 * Signal Processing for SSA Office: FOND DU LAC WI
 * <p>Office Code: 538</p>
 * <p>Address: 180 KNIGHTS WAY, FOND DU LAC, WI 54935</p>
 * <p>Phone: (888) 717-1526 | Fax: (833) 950-3741</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/fonddulac/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9967; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/fonddulac";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/fonddulac_audio", "ssa.wi.fonddulac.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/fonddulac_data", "ssa.wi.fonddulac.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/fonddulac_graphics", "ssa.wi.fonddulac.graphics.spectrum", sb.toString());
        }
    }
}