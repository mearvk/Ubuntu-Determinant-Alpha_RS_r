...
/**
 * Signal Processing for SSA Office: PROVIDENCE RI
 * <p>Office Code: 72</p>
 * <p>Address: ONE EMPIRE PLAZA, PROVIDENCE, RI 2903</p>
 * <p>Phone: (877) 402-0808 | Fax: (833) 950-2346</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ri/providence/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9548; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ri/providence";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ri/providence_audio", "ssa.ri.providence.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ri/providence_data", "ssa.ri.providence.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ri/providence_graphics", "ssa.ri.providence.graphics.spectrum", sb.toString());
        }
    }
}