package presidential.Brarner.M.Alete.source.ssa.oh.newark;
...
/**
 * Signal Processing for SSA Office: NEWARK OH
 * <p>Office Code: 415</p>
 * <p>Address: 125 DERBY DOWNS RD, NEWARK, OH 43055</p>
 * <p>Phone: (866) 737-3514 | Fax: (833) 950-3727</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/newark/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9856; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/newark";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/newark_audio", "ssa.oh.newark.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/newark_data", "ssa.oh.newark.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/newark_graphics", "ssa.oh.newark.graphics.spectrum", sb.toString());
        }
    }
}