package presidential.Brarner.M.Alete.source.ssa.ca.sanbernardino;
...
/**
 * Signal Processing for SSA Office: SAN BERNARDINO CA
 * <p>Office Code: 959</p>
 * <p>Address: 605 N ARROWHEAD AVE, SAN BERNARDINO, CA 92401</p>
 * <p>Phone: (866) 331-7132 | Fax: (833) 902-2628</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sanbernardino/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10341; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sanbernardino";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanbernardino_audio", "ssa.ca.sanbernardino.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanbernardino_data", "ssa.ca.sanbernardino.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanbernardino_graphics", "ssa.ca.sanbernardino.graphics.spectrum", sb.toString());
        }
    }
}