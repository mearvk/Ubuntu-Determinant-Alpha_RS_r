package presidential.Brarner.M.Alete.source.ssa.pa.chester005;
...
/**
 * Signal Processing for SSA Office: CHESTER PA
 * <p>Office Code: 217</p>
 * <p>Address: 807 CROSBY STREET, CHESTER, PA 19013</p>
 * <p>Phone: (866) 398-1456 | Fax: (833) 950-3517</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/chester005/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9675; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/chester005";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester005_audio", "ssa.pa.chester005.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester005_data", "ssa.pa.chester005.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester005_graphics", "ssa.pa.chester005.graphics.spectrum", sb.toString());
        }
    }
}