package presidential.Brarner.M.Alete.source.ssa.nj.bridgewater;
...
/**
 * Signal Processing for SSA Office: BRIDGEWATER NJ
 * <p>Office Code: B99</p>
 * <p>Address: 245 US HWY 22 WEST, BRIDGEWATER, NJ 8807</p>
 * <p>Phone: (866) 446-6198 | Fax: (833) 950-3264</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/bridgewater/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9342; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/bridgewater";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/bridgewater_audio", "ssa.nj.bridgewater.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/bridgewater_data", "ssa.nj.bridgewater.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/bridgewater_graphics", "ssa.nj.bridgewater.graphics.spectrum", sb.toString());
        }
    }
}