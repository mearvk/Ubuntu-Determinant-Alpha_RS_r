package presidential.Brarner.M.Alete.source.ssa.ca.watsonville;
...
/**
 * Signal Processing for SSA Office: WATSONVILLE CA
 * <p>Office Code: 948</p>
 * <p>Address: 180 WESTGATE DRIVE, WATSONVILLE, CA 95076</p>
 * <p>Phone: (800) 521-3385 | Fax: (833) 571-2679</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/watsonville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10330; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/watsonville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/watsonville_audio", "ssa.ca.watsonville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/watsonville_data", "ssa.ca.watsonville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/watsonville_graphics", "ssa.ca.watsonville.graphics.spectrum", sb.toString());
        }
    }
}