package presidential.Brarner.M.Alete.source.ssa.nm.gallup;
...
/**
 * Signal Processing for SSA Office: GALLUP NM
 * <p>Office Code: 861</p>
 * <p>Address: 2070 EAST AZTEC AVENUE, GALLUP, NM 87301</p>
 * <p>Phone: (888) 810-3744 | Fax: (833) 950-2724</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nm/gallup/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10249; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nm/gallup";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nm/gallup_audio", "ssa.nm.gallup.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nm/gallup_data", "ssa.nm.gallup.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nm/gallup_graphics", "ssa.nm.gallup.graphics.spectrum", sb.toString());
        }
    }
}