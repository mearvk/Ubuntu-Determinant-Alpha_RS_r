...
/**
 * Signal Processing for SSA Office: ST CLOUD MN
 * <p>Office Code: 679</p>
 * <p>Address: 3800 VETERANS DRIVE, SAINT CLOUD, MN 56303</p>
 * <p>Phone: (877) 405-1446 | Fax: (833) 902-2696</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/saintcloud/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10094; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/saintcloud";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/saintcloud_audio", "ssa.mn.saintcloud.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/saintcloud_data", "ssa.mn.saintcloud.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/saintcloud_graphics", "ssa.mn.saintcloud.graphics.spectrum", sb.toString());
        }
    }
}