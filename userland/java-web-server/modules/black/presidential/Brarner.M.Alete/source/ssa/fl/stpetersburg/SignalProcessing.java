package presidential.Brarner.M.Alete.source.ssa.fl.stpetersburg;
...
/**
 * Signal Processing for SSA Office: ST PETERSBURG FL
 * <p>Office Code: 662</p>
 * <p>Address: 30 DR MLK ST S, ST PETERSBURG, FL 33701</p>
 * <p>Phone: (866) 613-3965 | Fax: (833) 710-0161</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/stpetersburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10081; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/stpetersburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/stpetersburg_audio", "ssa.fl.stpetersburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/stpetersburg_data", "ssa.fl.stpetersburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/stpetersburg_graphics", "ssa.fl.stpetersburg.graphics.spectrum", sb.toString());
        }
    }
}