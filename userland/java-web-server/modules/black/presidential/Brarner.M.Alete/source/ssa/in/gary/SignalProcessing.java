package presidential.Brarner.M.Alete.source.ssa.in.gary;
...
/**
 * Signal Processing for SSA Office: GARY IN
 * <p>Office Code: 464</p>
 * <p>Address: 808 SOUTH LAKE STREET, GARY, IN 46403</p>
 * <p>Phone: (866) 593-2911 | Fax: (833) 950-2140</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/gary/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9901; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/gary";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/gary_audio", "ssa.in.gary.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/gary_data", "ssa.in.gary.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/gary_graphics", "ssa.in.gary.graphics.spectrum", sb.toString());
        }
    }
}