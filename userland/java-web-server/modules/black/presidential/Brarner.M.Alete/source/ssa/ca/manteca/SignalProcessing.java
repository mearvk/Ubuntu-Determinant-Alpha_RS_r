package presidential.Brarner.M.Alete.source.ssa.ca.manteca;
...
/**
 * Signal Processing for SSA Office: MANTECA CA
 * <p>Office Code: 523</p>
 * <p>Address: 510 COMMERCE CT, MANTECA, CA 95336</p>
 * <p>Phone: (866) 320-2587 | Fax: (833) 950-3377</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/manteca/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9957; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/manteca";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/manteca_audio", "ssa.ca.manteca.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/manteca_data", "ssa.ca.manteca.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/manteca_graphics", "ssa.ca.manteca.graphics.spectrum", sb.toString());
        }
    }
}