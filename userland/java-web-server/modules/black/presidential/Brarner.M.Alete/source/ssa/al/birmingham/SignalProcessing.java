package presidential.Brarner.M.Alete.source.ssa.al.birmingham;
...
/**
 * Signal Processing for SSA Office: BIRMINGHAM EAST AL
 * <p>Office Code: C17</p>
 * <p>Address: 1972 GADSDEN HWY, BIRMINGHAM, AL 35235</p>
 * <p>Phone: (866) 613-2743 | Fax: (833) 950-3465</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/birmingham/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9351; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/birmingham";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/birmingham_audio", "ssa.al.birmingham.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/birmingham_data", "ssa.al.birmingham.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/birmingham_graphics", "ssa.al.birmingham.graphics.spectrum", sb.toString());
        }
    }
}