package presidential.Brarner.M.Alete.source.ssa.mo.capegirardeau;
...
/**
 * Signal Processing for SSA Office: CAPE GIRARDEAU
 * <p>Office Code: 739</p>
 * <p>Address: 2445 CAPE CENTRE DR, CAPE GIRARDEAU, MO 63703</p>
 * <p>Phone: (866) 931-7077 | Fax: (833) 912-2553</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/capegirardeau/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10141; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/capegirardeau";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/capegirardeau_audio", "ssa.mo.capegirardeau.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/capegirardeau_data", "ssa.mo.capegirardeau.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/capegirardeau_graphics", "ssa.mo.capegirardeau.graphics.spectrum", sb.toString());
        }
    }
}