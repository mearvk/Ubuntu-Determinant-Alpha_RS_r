package presidential.Brarner.M.Alete.source.ssa.mi.chesterfield;
...
/**
 * Signal Processing for SSA Office: CHESTERFIELD MI
 * <p>Office Code: C46</p>
 * <p>Address: 26200 21 MILE ROAD, CHESTERFIELD, MI 48051</p>
 * <p>Phone: (866) 635-0788 | Fax: (833) 950-3699</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/chesterfield/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9364; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/chesterfield";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/chesterfield_audio", "ssa.mi.chesterfield.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/chesterfield_data", "ssa.mi.chesterfield.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/chesterfield_graphics", "ssa.mi.chesterfield.graphics.spectrum", sb.toString());
        }
    }
}