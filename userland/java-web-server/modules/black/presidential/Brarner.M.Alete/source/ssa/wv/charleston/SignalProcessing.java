...
/**
 * Signal Processing for SSA Office: CHARLESTON WV
 * <p>Office Code: 305</p>
 * <p>Address: 500 QUARRIER STREET, CHARLESTON, WV 25301</p>
 * <p>Phone: (888) 527-9305 | Fax: (833) 912-2310</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/charleston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9755; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/charleston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/charleston_audio", "ssa.wv.charleston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/charleston_data", "ssa.wv.charleston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/charleston_graphics", "ssa.wv.charleston.graphics.spectrum", sb.toString());
        }
    }
}