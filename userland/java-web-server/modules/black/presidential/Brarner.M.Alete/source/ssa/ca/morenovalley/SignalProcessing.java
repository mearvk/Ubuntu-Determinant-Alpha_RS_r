package presidential.Brarner.M.Alete.source.ssa.ca.morenovalley;
...
/**
 * Signal Processing for SSA Office: MORENO VALLEY CA
 * <p>Office Code: B73</p>
 * <p>Address: 22815 CALLE SAN JUAN DE LOS LAGOS, MORENO VALLEY, CA 92553</p>
 * <p>Phone: (888) 590-2705 | Fax: (833) 571-0630</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/morenovalley/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9328; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/morenovalley";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/morenovalley_audio", "ssa.ca.morenovalley.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/morenovalley_data", "ssa.ca.morenovalley.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/morenovalley_graphics", "ssa.ca.morenovalley.graphics.spectrum", sb.toString());
        }
    }
}