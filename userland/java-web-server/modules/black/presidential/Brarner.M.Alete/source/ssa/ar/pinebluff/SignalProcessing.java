package presidential.Brarner.M.Alete.source.ssa.ar.pinebluff;
...
/**
 * Signal Processing for SSA Office: PINE BLUFF AR
 * <p>Office Code: 759</p>
 * <p>Address: 3511 MARKET STREET, PINE BLUFF, AR 71601</p>
 * <p>Phone: (866) 563-9693 | Fax: (833) 950-2704</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/pinebluff/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10157; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/pinebluff";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/pinebluff_audio", "ssa.ar.pinebluff.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/pinebluff_data", "ssa.ar.pinebluff.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/pinebluff_graphics", "ssa.ar.pinebluff.graphics.spectrum", sb.toString());
        }
    }
}