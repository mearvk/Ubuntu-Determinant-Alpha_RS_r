package presidential.Brarner.M.Alete.source.ssa.tx.dallas;
...
/**
 * Signal Processing for SSA Office: DALLAS NORTH TX
 * <p>Office Code: 814</p>
 * <p>Address: 10824 N.CENTRAL EXPWY, DALLAS, TX 75231</p>
 * <p>Phone: (866) 572-2492 | Fax: (833) 515-0513</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/dallas/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10205; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/dallas";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/dallas_audio", "ssa.tx.dallas.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/dallas_data", "ssa.tx.dallas.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/dallas_graphics", "ssa.tx.dallas.graphics.spectrum", sb.toString());
        }
    }
}