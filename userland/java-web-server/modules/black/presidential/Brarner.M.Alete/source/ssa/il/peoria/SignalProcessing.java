package presidential.Brarner.M.Alete.source.ssa.il.peoria;
...
/**
 * Signal Processing for SSA Office: PEORIA IL
 * <p>Office Code: 487</p>
 * <p>Address: 815 W PIONEER PARKWAY, PEORIA, IL 61615</p>
 * <p>Phone: (877) 319-6039 | Fax: (833) 950-2502</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/peoria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9922; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/peoria";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/peoria_audio", "ssa.il.peoria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/peoria_data", "ssa.il.peoria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/peoria_graphics", "ssa.il.peoria.graphics.spectrum", sb.toString());
        }
    }
}