...
/**
 * Signal Processing for SSA Office: CAMPBELL CA
 * <p>Office Code: D38</p>
 * <p>Address: 1480 W CAMPBELL AVE, CAMPBELL, CA 95008</p>
 * <p>Phone: (866) 348-5832 | Fax: (833) 571-0644</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/campbell/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9424; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/campbell";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/campbell_audio", "ssa.ca.campbell.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/campbell_data", "ssa.ca.campbell.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/campbell_graphics", "ssa.ca.campbell.graphics.spectrum", sb.toString());
        }
    }
}