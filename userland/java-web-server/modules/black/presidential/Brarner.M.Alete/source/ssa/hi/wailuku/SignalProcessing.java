...
/**
 * Signal Processing for SSA Office: WAILUKU HI
 * <p>Office Code: 166</p>
 * <p>Address: 2200 MAIN STREET, WAILUKU, HI 96793</p>
 * <p>Phone: (855) 572-4863 | Fax: (833) 950-2740</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/hi/wailuku/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9628; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/hi/wailuku";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_hi/wailuku_audio", "ssa.hi.wailuku.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_hi/wailuku_data", "ssa.hi.wailuku.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_hi/wailuku_graphics", "ssa.hi.wailuku.graphics.spectrum", sb.toString());
        }
    }
}