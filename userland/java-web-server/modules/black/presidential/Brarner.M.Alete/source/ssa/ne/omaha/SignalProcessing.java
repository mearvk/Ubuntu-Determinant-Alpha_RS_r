...
/**
 * Signal Processing for SSA Office: OMAHA NE
 * <p>Office Code: 725</p>
 * <p>Address: 604 N 109TH CT, OMAHA, NE 68154</p>
 * <p>Phone: (866) 716-8299 | Fax: (833) 515-0443</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ne/omaha/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10130; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ne/omaha";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ne/omaha_audio", "ssa.ne.omaha.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ne/omaha_data", "ssa.ne.omaha.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ne/omaha_graphics", "ssa.ne.omaha.graphics.spectrum", sb.toString());
        }
    }
}