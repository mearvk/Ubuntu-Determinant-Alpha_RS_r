...
/**
 * Signal Processing for SSA Office: STILLWATER OK
 * <p>Office Code: B46</p>
 * <p>Address: 406 E HALL OF FAME AVE, STILLWATER, OK 74075</p>
 * <p>Phone: (888) 366-6143 | Fax: (833) 939-1989</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/stillwater/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9308; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/stillwater";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/stillwater_audio", "ssa.ok.stillwater.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/stillwater_data", "ssa.ok.stillwater.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/stillwater_graphics", "ssa.ok.stillwater.graphics.spectrum", sb.toString());
        }
    }
}