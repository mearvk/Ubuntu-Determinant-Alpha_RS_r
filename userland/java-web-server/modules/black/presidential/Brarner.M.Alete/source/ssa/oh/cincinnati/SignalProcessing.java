package presidential.Brarner.M.Alete.source.ssa.oh.cincinnati;
...
/**
 * Signal Processing for SSA Office: CINCINNATI-D/T
 * <p>Office Code: 387</p>
 * <p>Address: 550 MAIN ST, CINCINNATI, OH 45202</p>
 * <p>Phone: (866) 593-1519 | Fax: (833) 950-2790</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/cincinnati/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9828; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/cincinnati";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cincinnati_audio", "ssa.oh.cincinnati.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cincinnati_data", "ssa.oh.cincinnati.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cincinnati_graphics", "ssa.oh.cincinnati.graphics.spectrum", sb.toString());
        }
    }
}