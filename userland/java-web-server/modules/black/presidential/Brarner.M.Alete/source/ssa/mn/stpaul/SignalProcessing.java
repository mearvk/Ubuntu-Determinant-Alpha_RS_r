...
/**
 * Signal Processing for SSA Office: ST PAUL MN
 * <p>Office Code: 677</p>
 * <p>Address: 332 MINNESOTA ST, ST PAUL, MN 55101</p>
 * <p>Phone: (866) 667-7481 | Fax: (833) 902-2692</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/stpaul/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10092; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/stpaul";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/stpaul_audio", "ssa.mn.stpaul.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/stpaul_data", "ssa.mn.stpaul.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/stpaul_graphics", "ssa.mn.stpaul.graphics.spectrum", sb.toString());
        }
    }
}