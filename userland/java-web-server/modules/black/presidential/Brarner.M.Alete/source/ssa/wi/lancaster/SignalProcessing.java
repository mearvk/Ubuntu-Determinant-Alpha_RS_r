package presidential.Brarner.M.Alete.source.ssa.wi.lancaster;
...
/**
 * Signal Processing for SSA Office: LANCASTER WI
 * <p>Office Code: 552</p>
 * <p>Address: 175 W ALONA LN, LANCASTER, WI 53813</p>
 * <p>Phone: (877) 405-7841 | Fax: (833) 597-0056</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/lancaster/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9981; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/lancaster";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/lancaster_audio", "ssa.wi.lancaster.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/lancaster_data", "ssa.wi.lancaster.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/lancaster_graphics", "ssa.wi.lancaster.graphics.spectrum", sb.toString());
        }
    }
}