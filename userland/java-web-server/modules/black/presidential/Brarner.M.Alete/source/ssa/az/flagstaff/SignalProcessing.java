package presidential.Brarner.M.Alete.source.ssa.az.flagstaff;
...
/**
 * Signal Processing for SSA Office: FLAGSTAFF AZ
 * <p>Office Code: B57</p>
 * <p>Address: 2715 S WDLNDS VLG BLVD, FLAGSTAFF, AZ 86001</p>
 * <p>Phone: (877) 319-0735 | Fax: (833) 950-3659</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/az/flagstaff/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9318; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/az/flagstaff";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_az/flagstaff_audio", "ssa.az.flagstaff.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_az/flagstaff_data", "ssa.az.flagstaff.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_az/flagstaff_graphics", "ssa.az.flagstaff.graphics.spectrum", sb.toString());
        }
    }
}