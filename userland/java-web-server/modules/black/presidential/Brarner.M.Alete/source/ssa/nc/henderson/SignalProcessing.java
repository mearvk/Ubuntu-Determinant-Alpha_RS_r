package presidential.Brarner.M.Alete.source.ssa.nc.henderson;
...
/**
 * Signal Processing for SSA Office: HENDERSON NC
 * <p>Office Code: B10</p>
 * <p>Address: 858 S BECKFORD DR, HENDERSON, NC 27536</p>
 * <p>Phone: (877) 628-6584 | Fax: (833) 950-3119</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/henderson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9282; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/henderson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/henderson_audio", "ssa.nc.henderson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/henderson_data", "ssa.nc.henderson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/henderson_graphics", "ssa.nc.henderson.graphics.spectrum", sb.toString());
        }
    }
}