package presidential.Brarner.M.Alete.source.ssa.ny.ithaca;
...
/**
 * Signal Processing for SSA Office: ITHACA NY
 * <p>Office Code: 152</p>
 * <p>Address: 127 W STATE STREET, ITHACA, NY 14850</p>
 * <p>Phone: (866) 706-8289 | Fax: (833) 950-2674</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/ithaca/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9620; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/ithaca";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/ithaca_audio", "ssa.ny.ithaca.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/ithaca_data", "ssa.ny.ithaca.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/ithaca_graphics", "ssa.ny.ithaca.graphics.spectrum", sb.toString());
        }
    }
}