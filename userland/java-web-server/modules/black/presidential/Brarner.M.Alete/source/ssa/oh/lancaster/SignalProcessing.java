package presidential.Brarner.M.Alete.source.ssa.oh.lancaster;
...
/**
 * Signal Processing for SSA Office: LANCASTER OH
 * <p>Office Code: 419</p>
 * <p>Address: 252 VENTURE PLACE, LANCASTER, OH 43130</p>
 * <p>Phone: (877) 841-5712 | Fax: (833) 596-0556</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/lancaster/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9860; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/lancaster";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/lancaster_audio", "ssa.oh.lancaster.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/lancaster_data", "ssa.oh.lancaster.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/lancaster_graphics", "ssa.oh.lancaster.graphics.spectrum", sb.toString());
        }
    }
}