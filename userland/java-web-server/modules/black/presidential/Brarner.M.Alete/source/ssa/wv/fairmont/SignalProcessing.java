package presidential.Brarner.M.Alete.source.ssa.wv.fairmont;
...
/**
 * Signal Processing for SSA Office: FAIRMONT WV
 * <p>Office Code: 317</p>
 * <p>Address: 1000 TECHNOLOGY DR., FAIRMONT, WV 26554</p>
 * <p>Phone: (877) 405-7674 | Fax: (833) 950-2574</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/fairmont/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9767; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/fairmont";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/fairmont_audio", "ssa.wv.fairmont.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/fairmont_data", "ssa.wv.fairmont.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/fairmont_graphics", "ssa.wv.fairmont.graphics.spectrum", sb.toString());
        }
    }
}