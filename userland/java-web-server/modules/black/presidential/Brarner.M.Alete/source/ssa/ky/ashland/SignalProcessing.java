...
/**
 * Signal Processing for SSA Office: ASHLAND KY
 * <p>Office Code: 438</p>
 * <p>Address: 1405 GREENUP AVENUE, ASHLAND, KY 41101</p>
 * <p>Phone: (866) 269-3993 | Fax: (833) 950-3151</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/ashland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9875; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/ashland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/ashland_audio", "ssa.ky.ashland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/ashland_data", "ssa.ky.ashland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/ashland_graphics", "ssa.ky.ashland.graphics.spectrum", sb.toString());
        }
    }
}