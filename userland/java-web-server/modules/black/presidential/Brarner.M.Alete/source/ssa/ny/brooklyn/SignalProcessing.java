package presidential.Brarner.M.Alete.source.ssa.ny.brooklyn;
...
/**
 * Signal Processing for SSA Office: CANARSIE NY
 * <p>Office Code: D57</p>
 * <p>Address: 1871 ROCKAWAY PARKWAY, BROOKLYN, NY 11236</p>
 * <p>Phone: (866) 667-7342 | Fax: (833) 950-3285</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/brooklyn/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9438; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/brooklyn";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn_audio", "ssa.ny.brooklyn.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn_data", "ssa.ny.brooklyn.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn_graphics", "ssa.ny.brooklyn.graphics.spectrum", sb.toString());
        }
    }
}