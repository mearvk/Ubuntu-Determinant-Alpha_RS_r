package presidential.Brarner.M.Alete.source.ssa.ma.lowell;
...
/**
 * Signal Processing for SSA Office: LOWELL MA
 * <p>Office Code: 35</p>
 * <p>Address: 151 WARREN STREET, LOWELL, MA 1852</p>
 * <p>Phone: (877) 746-9850 | Fax: (833) 902-2510</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/lowell/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9518; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/lowell";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/lowell_audio", "ssa.ma.lowell.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/lowell_data", "ssa.ma.lowell.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/lowell_graphics", "ssa.ma.lowell.graphics.spectrum", sb.toString());
        }
    }
}