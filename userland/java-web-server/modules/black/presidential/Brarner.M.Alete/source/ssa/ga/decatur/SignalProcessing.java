package presidential.Brarner.M.Alete.source.ssa.ga.decatur;
...
/**
 * Signal Processing for SSA Office: DECATUR GA
 * <p>Office Code: 621</p>
 * <p>Address: 3554 COVINGTON HWY, DECATUR, GA 30032</p>
 * <p>Phone: (877) 626-9909 | Fax: (833) 950-3165</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/decatur/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10044; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/decatur";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/decatur_audio", "ssa.ga.decatur.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/decatur_data", "ssa.ga.decatur.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/decatur_graphics", "ssa.ga.decatur.graphics.spectrum", sb.toString());
        }
    }
}