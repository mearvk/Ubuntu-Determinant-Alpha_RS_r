package presidential.Brarner.M.Alete.source.ssa.ms.kosciusko;
...
/**
 * Signal Processing for SSA Office: KOSCIUSKO MS
 * <p>Office Code: B15</p>
 * <p>Address: 80 VETERANS MEMORIAL DR, KOSCIUSKO, MS 39090</p>
 * <p>Phone: (866) 875-5995 | Fax: (833) 950-3127</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/kosciusko/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9286; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/kosciusko";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/kosciusko_audio", "ssa.ms.kosciusko.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/kosciusko_data", "ssa.ms.kosciusko.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/kosciusko_graphics", "ssa.ms.kosciusko.graphics.spectrum", sb.toString());
        }
    }
}