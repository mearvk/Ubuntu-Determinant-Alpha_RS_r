package presidential.Brarner.M.Alete.source.ssa.ny.brooklyn006;
...
/**
 * Signal Processing for SSA Office: CYPRESS HILLS
 * <p>Office Code: 139</p>
 * <p>Address: 3386 FULTON STREET, BROOKLYN, NY 11208</p>
 * <p>Phone: (866) 613-2767 | Fax: (833) 939-1984</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/brooklyn006/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9608; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/brooklyn006";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn006_audio", "ssa.ny.brooklyn006.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn006_data", "ssa.ny.brooklyn006.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn006_graphics", "ssa.ny.brooklyn006.graphics.spectrum", sb.toString());
        }
    }
}