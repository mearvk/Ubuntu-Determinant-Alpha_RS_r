package presidential.Brarner.M.Alete.source.ssa.tx.mcallen;
...
/**
 * Signal Processing for SSA Office: MCALLEN TX
 * <p>Office Code: 841</p>
 * <p>Address: 3004 N MCCOLL RD, MCALLEN, TX 78501</p>
 * <p>Phone: (855) 886-9628 | Fax: (833) 436-4145</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/mcallen/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10232; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/mcallen";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/mcallen_audio", "ssa.tx.mcallen.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/mcallen_data", "ssa.tx.mcallen.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/mcallen_graphics", "ssa.tx.mcallen.graphics.spectrum", sb.toString());
        }
    }
}