package presidential.Brarner.M.Alete.source.ssa.oh.worthington;
...
/**
 * Signal Processing for SSA Office: COLUMBUS NORTH
 * <p>Office Code: D63</p>
 * <p>Address: 1051 WORTHINGTON WOODS, WORTHINGTON, OH 43085</p>
 * <p>Phone: (866) 789-0957 | Fax: (833) 596-0552</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/worthington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9444; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/worthington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/worthington_audio", "ssa.oh.worthington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/worthington_data", "ssa.oh.worthington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/worthington_graphics", "ssa.oh.worthington.graphics.spectrum", sb.toString());
        }
    }
}