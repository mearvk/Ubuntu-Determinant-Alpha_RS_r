package presidential.Brarner.M.Alete.source.ssa.nv.henderson;
...
/**
 * Signal Processing for SSA Office: HENDERSON NV
 * <p>Office Code: A00</p>
 * <p>Address: 10416 S EASTERN AVENUE, HENDERSON, NV 89052</p>
 * <p>Phone: (855) 207-7084 | Fax: (833) 950-3025</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nv/henderson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9200; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nv/henderson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nv/henderson_audio", "ssa.nv.henderson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nv/henderson_data", "ssa.nv.henderson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nv/henderson_graphics", "ssa.nv.henderson.graphics.spectrum", sb.toString());
        }
    }
}