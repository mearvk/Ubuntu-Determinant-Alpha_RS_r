package presidential.Brarner.M.Alete.source.ssa.va.covington;
...
/**
 * Signal Processing for SSA Office: COVINGTON VA
 * <p>Office Code: 296</p>
 * <p>Address: 1010 S CRAIG AVENUE, COVINGTON, VA 24426</p>
 * <p>Phone: (888) 527-9334 | Fax: (833) 950-2298</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/covington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9746; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/covington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/covington_audio", "ssa.va.covington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/covington_data", "ssa.va.covington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/covington_graphics", "ssa.va.covington.graphics.spectrum", sb.toString());
        }
    }
}