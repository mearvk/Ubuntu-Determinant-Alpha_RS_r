package presidential.Brarner.M.Alete.source.ssa.mo.kansascity006;
...
/**
 * Signal Processing for SSA Office: FOSU West - Branch 2
 * <p>Office Code: 8IF</p>
 * <p>Address: 601 E 12TH ST, KANSAS CITY, MO 64106</p>
 * <p>Phone: (877) 685-5942 | Fax: (833) 997-3179</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/kansascity006/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10379; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/kansascity006";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity006_audio", "ssa.mo.kansascity006.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity006_data", "ssa.mo.kansascity006.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity006_graphics", "ssa.mo.kansascity006.graphics.spectrum", sb.toString());
        }
    }
}