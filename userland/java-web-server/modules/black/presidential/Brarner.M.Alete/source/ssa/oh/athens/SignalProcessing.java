package presidential.Brarner.M.Alete.source.ssa.oh.athens;
...
/**
 * Signal Processing for SSA Office: ATHENS OH
 * <p>Office Code: 405</p>
 * <p>Address: 743A EAST STATE STREET, ATHENS, OH 45701</p>
 * <p>Phone: (877) 840-7683 | Fax: (833) 950-3427</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/athens/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9846; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/athens";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/athens_audio", "ssa.oh.athens.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/athens_data", "ssa.oh.athens.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/athens_graphics", "ssa.oh.athens.graphics.spectrum", sb.toString());
        }
    }
}