package presidential.Brarner.M.Alete.source.ssa.ca.losangeles;
...
/**
 * Signal Processing for SSA Office: WILSHIRE CENTER
 * <p>Office Code: D44</p>
 * <p>Address: 4000 WILSHIRE BLVD, LOS ANGELES, CA 90010</p>
 * <p>Phone: (866) 964-7592 | Fax: (833) 902-2600</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/losangeles/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9427; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/losangeles";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles_audio", "ssa.ca.losangeles.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles_data", "ssa.ca.losangeles.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles_graphics", "ssa.ca.losangeles.graphics.spectrum", sb.toString());
        }
    }
}