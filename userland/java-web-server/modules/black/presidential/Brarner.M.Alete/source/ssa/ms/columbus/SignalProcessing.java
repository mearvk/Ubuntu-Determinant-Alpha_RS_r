package presidential.Brarner.M.Alete.source.ssa.ms.columbus;
...
/**
 * Signal Processing for SSA Office: COLUMBUS MS
 * <p>Office Code: 644</p>
 * <p>Address: 3577 BLUECUTT RD, COLUMBUS, MS 39705</p>
 * <p>Phone: (877) 626-9914 | Fax: (833) 950-3801</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/columbus/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10064; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/columbus";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/columbus_audio", "ssa.ms.columbus.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/columbus_data", "ssa.ms.columbus.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/columbus_graphics", "ssa.ms.columbus.graphics.spectrum", sb.toString());
        }
    }
}