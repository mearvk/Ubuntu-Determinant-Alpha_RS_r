package presidential.Brarner.M.Alete.source.ssa.ca.sanleandro;
...
/**
 * Signal Processing for SSA Office: SAN LEANDRO CA
 * <p>Office Code: D48</p>
 * <p>Address: 320 DAVIS ST, SAN LEANDRO, CA 94577</p>
 * <p>Phone: (866) 331-2181 | Fax: (833) 902-2606</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sanleandro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9430; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sanleandro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanleandro_audio", "ssa.ca.sanleandro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanleandro_data", "ssa.ca.sanleandro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanleandro_graphics", "ssa.ca.sanleandro.graphics.spectrum", sb.toString());
        }
    }
}