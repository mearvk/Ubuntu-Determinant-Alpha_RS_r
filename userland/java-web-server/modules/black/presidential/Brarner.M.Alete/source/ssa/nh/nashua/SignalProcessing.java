package presidential.Brarner.M.Alete.source.ssa.nh.nashua;
...
/**
 * Signal Processing for SSA Office: NASHUA NH
 * <p>Office Code: 14</p>
 * <p>Address: 175 AMHERST ST, NASHUA, NH 3064</p>
 * <p>Phone: (877) 444-0134 | Fax: (833) 515-0447</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nh/nashua/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9502; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nh/nashua";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nh/nashua_audio", "ssa.nh.nashua.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nh/nashua_data", "ssa.nh.nashua.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nh/nashua_graphics", "ssa.nh.nashua.graphics.spectrum", sb.toString());
        }
    }
}