package presidential.Brarner.M.Alete.source.ssa.oh.xenia;
...
/**
 * Signal Processing for SSA Office: XENIA OH
 * <p>Office Code: B29</p>
 * <p>Address: 80 N PROGRESS DR, XENIA, OH 45385</p>
 * <p>Phone: (866) 755-5372 | Fax: (833) 950-3397</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/xenia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9296; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/xenia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/xenia_audio", "ssa.oh.xenia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/xenia_data", "ssa.oh.xenia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/xenia_graphics", "ssa.oh.xenia.graphics.spectrum", sb.toString());
        }
    }
}