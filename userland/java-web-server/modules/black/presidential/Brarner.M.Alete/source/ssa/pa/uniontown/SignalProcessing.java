package presidential.Brarner.M.Alete.source.ssa.pa.uniontown;
...
/**
 * Signal Processing for SSA Office: UNIONTOWN PA
 * <p>Office Code: 212</p>
 * <p>Address: 627 PITTSBURGH ROAD, UNIONTOWN, PA 15401</p>
 * <p>Phone: (866) 320-7459 | Fax: (833) 950-3191</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/uniontown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9670; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/uniontown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/uniontown_audio", "ssa.pa.uniontown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/uniontown_data", "ssa.pa.uniontown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/uniontown_graphics", "ssa.pa.uniontown.graphics.spectrum", sb.toString());
        }
    }
}