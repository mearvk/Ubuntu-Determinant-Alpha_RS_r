package presidential.Brarner.M.Alete.source.ssa.ma.northadams;
...
/**
 * Signal Processing for SSA Office: NORTH ADAMS MA
 * <p>Office Code: C67</p>
 * <p>Address: 96 MARSHALL STREET, NORTH ADAMS, MA 1247</p>
 * <p>Phone: (877) 319-5709 | Fax: (833) 950-3260</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/northadams/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9377; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/northadams";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/northadams_audio", "ssa.ma.northadams.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/northadams_data", "ssa.ma.northadams.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/northadams_graphics", "ssa.ma.northadams.graphics.spectrum", sb.toString());
        }
    }
}