package presidential.Brarner.M.Alete.source.ssa.sc.bennettsville;
...
/**
 * Signal Processing for SSA Office: BENNETTSVILLE SC
 * <p>Office Code: 591</p>
 * <p>Address: 1028 CHERAW ST, BENNETTSVILLE, SC 29512</p>
 * <p>Phone: (888) 810-7617 | Fax: (833) 950-2241</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/bennettsville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10015; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/bennettsville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/bennettsville_audio", "ssa.sc.bennettsville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/bennettsville_data", "ssa.sc.bennettsville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/bennettsville_graphics", "ssa.sc.bennettsville.graphics.spectrum", sb.toString());
        }
    }
}