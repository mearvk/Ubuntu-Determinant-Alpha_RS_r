package presidential.Brarner.M.Alete.source.ssa.ny.olean;
...
/**
 * Signal Processing for SSA Office: OLEAN NY
 * <p>Office Code: 142</p>
 * <p>Address: 1618 W STATE ST, OLEAN, NY 14760</p>
 * <p>Phone: (877) 319-5773 | Fax: (833) 950-2366</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/olean/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9611; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/olean";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/olean_audio", "ssa.ny.olean.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/olean_data", "ssa.ny.olean.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/olean_graphics", "ssa.ny.olean.graphics.spectrum", sb.toString());
        }
    }
}