package presidential.Brarner.M.Alete.source.ssa.oh.akron002;
...
/**
 * Signal Processing for SSA Office: AKRON-WEST OH
 * <p>Office Code: 422</p>
 * <p>Address: 2166 ROMIG RD, AKRON, OH 44320</p>
 * <p>Phone: (866) 837-5359 | Fax: (833) 596-0581</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/akron002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9863; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/akron002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/akron002_audio", "ssa.oh.akron002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/akron002_data", "ssa.oh.akron002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/akron002_graphics", "ssa.oh.akron002.graphics.spectrum", sb.toString());
        }
    }
}