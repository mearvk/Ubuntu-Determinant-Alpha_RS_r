package presidential.Brarner.M.Alete.source.ssa.il.westfrankfort;
...
/**
 * Signal Processing for SSA Office: WEST FRANKFORT
 * <p>Office Code: D04</p>
 * <p>Address: 1005 FACTORY OUTLET DR, WEST FRANKFORT, IL 62896</p>
 * <p>Phone: (888) 223-8869 | Fax: (833) 950-3707</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/westfrankfort/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9402; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/westfrankfort";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/westfrankfort_audio", "ssa.il.westfrankfort.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/westfrankfort_data", "ssa.il.westfrankfort.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/westfrankfort_graphics", "ssa.il.westfrankfort.graphics.spectrum", sb.toString());
        }
    }
}