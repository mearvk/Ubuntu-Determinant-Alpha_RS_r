package presidential.Brarner.M.Alete.source.ssa.ca.losangeles003;
...
/**
 * Signal Processing for SSA Office: WATTS CA
 * <p>Office Code: 64</p>
 * <p>Address: 12429 AVALON BLVD, LOS ANGELES, CA 90061</p>
 * <p>Phone: (877) 836-1558 | Fax: (833) 950-2732</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/losangeles003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9544; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/losangeles003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles003_audio", "ssa.ca.losangeles003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles003_data", "ssa.ca.losangeles003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles003_graphics", "ssa.ca.losangeles003.graphics.spectrum", sb.toString());
        }
    }
}