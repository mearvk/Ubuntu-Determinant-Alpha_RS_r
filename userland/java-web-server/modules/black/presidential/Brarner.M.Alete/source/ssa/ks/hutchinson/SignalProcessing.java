package presidential.Brarner.M.Alete.source.ssa.ks.hutchinson;
...
/**
 * Signal Processing for SSA Office: HUTCHINSON KS
 * <p>Office Code: 774</p>
 * <p>Address: 811 E 30TH AVE, HUTCHINSON, KS 67502</p>
 * <p>Phone: (877) 846-8333 | Fax: (833) 950-2338</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ks/hutchinson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10170; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ks/hutchinson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ks/hutchinson_audio", "ssa.ks.hutchinson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ks/hutchinson_data", "ssa.ks.hutchinson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ks/hutchinson_graphics", "ssa.ks.hutchinson.graphics.spectrum", sb.toString());
        }
    }
}