package presidential.Brarner.M.Alete.source.ssa.nj.mountlaurel;
...
/**
 * Signal Processing for SSA Office: MT LAUREL NJ
 * <p>Office Code: C73</p>
 * <p>Address: 532 FELLOWSHIP ROAD, MOUNT LAUREL, NJ 8054</p>
 * <p>Phone: (866) 837-5002 | Fax: (833) 950-3279</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/mountlaurel/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9382; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/mountlaurel";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/mountlaurel_audio", "ssa.nj.mountlaurel.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/mountlaurel_data", "ssa.nj.mountlaurel.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/mountlaurel_graphics", "ssa.nj.mountlaurel.graphics.spectrum", sb.toString());
        }
    }
}