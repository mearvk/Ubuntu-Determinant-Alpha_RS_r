package presidential.Brarner.M.Alete.source.ssa.mo.kansascity;
...
/**
 * Signal Processing for SSA Office: FOSU West - Branch 3
 * <p>Office Code: NA9</p>
 * <p>Address: 601 E 12TH ST, KANSAS CITY, MO 64106</p>
 * <p>Phone: (877) 685-5942 | Fax: (833) 551-0602</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/kansascity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9485; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/kansascity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity_audio", "ssa.mo.kansascity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity_data", "ssa.mo.kansascity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity_graphics", "ssa.mo.kansascity.graphics.spectrum", sb.toString());
        }
    }
}