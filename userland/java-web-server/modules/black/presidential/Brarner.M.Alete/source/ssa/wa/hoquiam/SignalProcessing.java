...
/**
 * Signal Processing for SSA Office: GRAYS HARBOR WA
 * <p>Office Code: 921</p>
 * <p>Address: 820 SIMPSON AVE, HOQUIAM, WA 98550</p>
 * <p>Phone: (855) 634-4197 | Fax: (833) 950-2614</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/hoquiam/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10304; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/hoquiam";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/hoquiam_audio", "ssa.wa.hoquiam.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/hoquiam_data", "ssa.wa.hoquiam.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/hoquiam_graphics", "ssa.wa.hoquiam.graphics.spectrum", sb.toString());
        }
    }
}