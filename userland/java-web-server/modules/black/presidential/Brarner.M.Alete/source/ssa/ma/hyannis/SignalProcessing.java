...
/**
 * Signal Processing for SSA Office: HYANNIS MA
 * <p>Office Code: 54</p>
 * <p>Address: SUITE 4, HYANNIS, MA 2601</p>
 * <p>Phone: (866) 467-0440 | Fax: (833) 926-1864</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/hyannis/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9536; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/hyannis";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/hyannis_audio", "ssa.ma.hyannis.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/hyannis_data", "ssa.ma.hyannis.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/hyannis_graphics", "ssa.ma.hyannis.graphics.spectrum", sb.toString());
        }
    }
}