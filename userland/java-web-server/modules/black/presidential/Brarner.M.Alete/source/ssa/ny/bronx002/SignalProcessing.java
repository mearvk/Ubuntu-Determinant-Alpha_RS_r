package presidential.Brarner.M.Alete.source.ssa.ny.bronx002;
...
/**
 * Signal Processing for SSA Office: SOUTH BRONX NY
 * <p>Office Code: 112</p>
 * <p>Address: 820 CONCOURSE VILLAGE WEST, BRONX, NY 10451</p>
 * <p>Phone: (855) 531-1684 | Fax: (833) 515-0473</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/bronx002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9583; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/bronx002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx002_audio", "ssa.ny.bronx002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx002_data", "ssa.ny.bronx002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx002_graphics", "ssa.ny.bronx002.graphics.spectrum", sb.toString());
        }
    }
}