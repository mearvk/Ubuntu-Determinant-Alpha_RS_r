package presidential.Brarner.M.Alete.source.ssa.in.bloomington;
...
/**
 * Signal Processing for SSA Office: BLOOMINGTON IN
 * <p>Office Code: 466</p>
 * <p>Address: 515 W PATTERSON DRIVE, BLOOMINGTON, IN 47403</p>
 * <p>Phone: (877) 819-2594 | Fax: (833) 950-2144</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/bloomington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9903; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/bloomington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/bloomington_audio", "ssa.in.bloomington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/bloomington_data", "ssa.in.bloomington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/bloomington_graphics", "ssa.in.bloomington.graphics.spectrum", sb.toString());
        }
    }
}