package presidential.Brarner.M.Alete.source.ssa.ca.lakeport;
...
/**
 * Signal Processing for SSA Office: LAKEPORT CA
 * <p>Office Code: A32</p>
 * <p>Address: 991 PARALLEL DR, LAKEPORT, CA 95453</p>
 * <p>Phone: (888) 676-2666 | Fax: (833) 950-3361</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/lakeport/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9220; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/lakeport";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/lakeport_audio", "ssa.ca.lakeport.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/lakeport_data", "ssa.ca.lakeport.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/lakeport_graphics", "ssa.ca.lakeport.graphics.spectrum", sb.toString());
        }
    }
}