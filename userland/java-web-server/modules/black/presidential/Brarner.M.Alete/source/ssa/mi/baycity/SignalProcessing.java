package presidential.Brarner.M.Alete.source.ssa.mi.baycity;
...
/**
 * Signal Processing for SSA Office: BAY CITY MI
 * <p>Office Code: 356</p>
 * <p>Address: 1115 WASHINGTON AVE, BAY CITY, MI 48708</p>
 * <p>Phone: (866) 366-4924 | Fax: (833) 950-2134</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/baycity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9803; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/baycity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/baycity_audio", "ssa.mi.baycity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/baycity_data", "ssa.mi.baycity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/baycity_graphics", "ssa.mi.baycity.graphics.spectrum", sb.toString());
        }
    }
}