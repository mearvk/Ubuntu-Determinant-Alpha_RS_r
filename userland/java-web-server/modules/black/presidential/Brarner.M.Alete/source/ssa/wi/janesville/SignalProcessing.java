package presidential.Brarner.M.Alete.source.ssa.wi.janesville;
...
/**
 * Signal Processing for SSA Office: JANESVILLE WI
 * <p>Office Code: 546</p>
 * <p>Address: 222 N ACADEMY ST, JANESVILLE, WI 53548</p>
 * <p>Phone: (877) 850-7826 | Fax: (833) 596-0597</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/janesville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9975; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/janesville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/janesville_audio", "ssa.wi.janesville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/janesville_data", "ssa.wi.janesville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/janesville_graphics", "ssa.wi.janesville.graphics.spectrum", sb.toString());
        }
    }
}