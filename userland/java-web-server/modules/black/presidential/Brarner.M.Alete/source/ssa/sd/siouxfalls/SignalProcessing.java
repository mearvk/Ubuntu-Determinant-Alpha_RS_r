...
/**
 * Signal Processing for SSA Office: SIOUX FALLS SD
 * <p>Office Code: 715</p>
 * <p>Address: 5021 S NEVADA AVE, SIOUX FALLS, SD 57108</p>
 * <p>Phone: (877) 274-5421 | Fax: (833) 950-3547</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sd/siouxfalls/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10124; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sd/siouxfalls";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sd/siouxfalls_audio", "ssa.sd.siouxfalls.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sd/siouxfalls_data", "ssa.sd.siouxfalls.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sd/siouxfalls_graphics", "ssa.sd.siouxfalls.graphics.spectrum", sb.toString());
        }
    }
}