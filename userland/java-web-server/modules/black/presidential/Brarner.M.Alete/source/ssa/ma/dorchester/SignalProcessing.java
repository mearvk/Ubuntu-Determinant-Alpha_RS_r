package presidential.Brarner.M.Alete.source.ssa.ma.dorchester;
...
/**
 * Signal Processing for SSA Office: DORCHESTER MA
 * <p>Office Code: 48</p>
 * <p>Address: 115 FREEPORT ST, DORCHESTER, MA 2122</p>
 * <p>Phone: (866) 931-2550 | Fax: (833) 926-1845</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/dorchester/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9530; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/dorchester";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/dorchester_audio", "ssa.ma.dorchester.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/dorchester_data", "ssa.ma.dorchester.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/dorchester_graphics", "ssa.ma.dorchester.graphics.spectrum", sb.toString());
        }
    }
}