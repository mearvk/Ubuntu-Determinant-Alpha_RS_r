package presidential.Brarner.M.Alete.source.ssa.ca.merced;
...
/**
 * Signal Processing for SSA Office: MERCED CA
 * <p>Office Code: 60</p>
 * <p>Address: 3185 M ST, MERCED, CA 95348</p>
 * <p>Phone: (888) 632-7069 | Fax: (833) 950-2434</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/merced/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9540; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/merced";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/merced_audio", "ssa.ca.merced.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/merced_data", "ssa.ca.merced.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/merced_graphics", "ssa.ca.merced.graphics.spectrum", sb.toString());
        }
    }
}