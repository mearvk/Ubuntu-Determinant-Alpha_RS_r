package presidential.Brarner.M.Alete.source.ssa.tx.mission;
...
/**
 * Signal Processing for SSA Office: MISSION TX
 * <p>Office Code: 11A</p>
 * <p>Address: 1013 BUSINESS PARK DR, MISSION, TX 78572</p>
 * <p>Phone: (855) 245-0647 | Fax: (833) 950-2400</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/mission/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9580; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/mission";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/mission_audio", "ssa.tx.mission.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/mission_data", "ssa.tx.mission.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/mission_graphics", "ssa.tx.mission.graphics.spectrum", sb.toString());
        }
    }
}