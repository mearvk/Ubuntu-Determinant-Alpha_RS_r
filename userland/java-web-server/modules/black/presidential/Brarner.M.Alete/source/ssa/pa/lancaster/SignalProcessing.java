package presidential.Brarner.M.Alete.source.ssa.pa.lancaster;
...
/**
 * Signal Processing for SSA Office: LANCASTER PA
 * <p>Office Code: 208</p>
 * <p>Address: 1808 COLONIAL VILLAGE LN, LANCASTER, PA 17601</p>
 * <p>Phone: (888) 384-9919 | Fax: (833) 950-3183</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/lancaster/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9666; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/lancaster";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/lancaster_audio", "ssa.pa.lancaster.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/lancaster_data", "ssa.pa.lancaster.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/lancaster_graphics", "ssa.pa.lancaster.graphics.spectrum", sb.toString());
        }
    }
}