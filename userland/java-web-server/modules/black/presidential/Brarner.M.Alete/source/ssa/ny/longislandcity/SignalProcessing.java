package presidential.Brarner.M.Alete.source.ssa.ny.longislandcity;
...
/**
 * Signal Processing for SSA Office: LONG ISLAND CITY
 * <p>Office Code: C01</p>
 * <p>Address: 31-08 37TH AVENUE, LONG ISLAND CITY, NY 11101</p>
 * <p>Phone: (866) 837-1096 | Fax: (833) 950-3266</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/longislandcity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9343; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/longislandcity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/longislandcity_audio", "ssa.ny.longislandcity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/longislandcity_data", "ssa.ny.longislandcity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/longislandcity_graphics", "ssa.ny.longislandcity.graphics.spectrum", sb.toString());
        }
    }
}