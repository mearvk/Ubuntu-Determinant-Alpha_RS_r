package presidential.Brarner.M.Alete.source.ssa.or.bend;
...
/**
 * Signal Processing for SSA Office: BEND OR
 * <p>Office Code: D53</p>
 * <p>Address: 250 NW FRANKLIN AVE, BEND, OR 97703</p>
 * <p>Phone: (877) 405-0302 | Fax: (833) 950-3553</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/or/bend/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9435; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/or/bend";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_or/bend_audio", "ssa.or.bend.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_or/bend_data", "ssa.or.bend.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_or/bend_graphics", "ssa.or.bend.graphics.spectrum", sb.toString());
        }
    }
}