package presidential.Brarner.M.Alete.source.ssa.ny.newyork;
...
/**
 * Signal Processing for SSA Office: EAST VILLAGE
 * <p>Office Code: B95</p>
 * <p>Address: 650 EAST 12TH ST, NEW YORK, NY 10009</p>
 * <p>Phone: (877) 405-1447 | Fax: (833) 950-2966</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/newyork/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9339; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/newyork";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork_audio", "ssa.ny.newyork.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork_data", "ssa.ny.newyork.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork_graphics", "ssa.ny.newyork.graphics.spectrum", sb.toString());
        }
    }
}