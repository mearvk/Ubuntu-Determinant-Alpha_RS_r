package presidential.Brarner.M.Alete.source.ssa.ny.flushing;
...
/**
 * Signal Processing for SSA Office: FLUSHING NY
 * <p>Office Code: 150</p>
 * <p>Address: 138-50 BARCLAY AVE, FLUSHING, NY 11355</p>
 * <p>Phone: (877) 457-1735 | Fax: (833) 950-2380</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/flushing/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9618; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/flushing";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/flushing_audio", "ssa.ny.flushing.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/flushing_data", "ssa.ny.flushing.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/flushing_graphics", "ssa.ny.flushing.graphics.spectrum", sb.toString());
        }
    }
}