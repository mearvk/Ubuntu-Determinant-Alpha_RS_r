package presidential.Brarner.M.Alete.source.ssa.ky.henderson;
...
/**
 * Signal Processing for SSA Office: HENDERSON KY
 * <p>Office Code: B20</p>
 * <p>Address: 2000 N ELM ST, HENDERSON, KY 42420</p>
 * <p>Phone: (855) 628-1593 | Fax: (833) 950-3135</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/henderson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9290; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/henderson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/henderson_audio", "ssa.ky.henderson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/henderson_data", "ssa.ky.henderson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/henderson_graphics", "ssa.ky.henderson.graphics.spectrum", sb.toString());
        }
    }
}