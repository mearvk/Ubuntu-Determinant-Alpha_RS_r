package presidential.Brarner.M.Alete.source.ssa.pr.caguas;
...
/**
 * Signal Processing for SSA Office: CAGUAS PR
 * <p>Office Code: 281</p>
 * <p>Address: 30 CALLE PADIAL GATSBY BLDG, CAGUAS, PR 725</p>
 * <p>Phone: (833) 882-1200 | Fax: (833) 950-3615</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pr/caguas/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9731; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pr/caguas";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pr/caguas_audio", "ssa.pr.caguas.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pr/caguas_data", "ssa.pr.caguas.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pr/caguas_graphics", "ssa.pr.caguas.graphics.spectrum", sb.toString());
        }
    }
}