...
/**
 * Signal Processing for SSA Office: HOUMA LA
 * <p>Office Code: 807</p>
 * <p>Address: 178 CIVIC CENTER BLVD, HOUMA, LA 70360</p>
 * <p>Phone: (866) 899-5631 | Fax: (833) 950-3643</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/houma/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10199; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/houma";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/houma_audio", "ssa.la.houma.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/houma_data", "ssa.la.houma.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/houma_graphics", "ssa.la.houma.graphics.spectrum", sb.toString());
        }
    }
}