package presidential.Brarner.M.Alete.source.ssa.me.portland;
...
/**
 * Signal Processing for SSA Office: PORTLAND ME
 * <p>Office Code: 1</p>
 * <p>Address: 400 CONGRESS ST, PORTLAND, ME 4101</p>
 * <p>Phone: (877) 319-3076 | Fax: (833) 950-3575</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/me/portland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9490; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/me/portland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_me/portland_audio", "ssa.me.portland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_me/portland_data", "ssa.me.portland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_me/portland_graphics", "ssa.me.portland.graphics.spectrum", sb.toString());
        }
    }
}