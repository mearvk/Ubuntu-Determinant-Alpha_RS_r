package presidential.Brarner.M.Alete.source.ssa.sc.sumter;
...
/**
 * Signal Processing for SSA Office: SUMTER SC
 * <p>Office Code: 595</p>
 * <p>Address: 240 N BULTMAN DR, SUMTER, SC 29150</p>
 * <p>Phone: (877) 445-0840 | Fax: (833) 950-2552</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/sumter/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10019; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/sumter";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/sumter_audio", "ssa.sc.sumter.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/sumter_data", "ssa.sc.sumter.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/sumter_graphics", "ssa.sc.sumter.graphics.spectrum", sb.toString());
        }
    }
}