package presidential.Brarner.M.Alete.source.ssa.nj.riogrande;
...
/**
 * Signal Processing for SSA Office: RIO GRANDE NJ
 * <p>Office Code: A27</p>
 * <p>Address: 1046 ROUTE 47 SOUTH, RIO GRANDE, NJ 8242</p>
 * <p>Phone: (877) 405-9194 | Fax: (833) 950-2952</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/riogrande/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9216; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/riogrande";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/riogrande_audio", "ssa.nj.riogrande.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/riogrande_data", "ssa.nj.riogrande.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/riogrande_graphics", "ssa.nj.riogrande.graphics.spectrum", sb.toString());
        }
    }
}