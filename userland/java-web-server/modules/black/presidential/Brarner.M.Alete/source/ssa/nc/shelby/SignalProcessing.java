package presidential.Brarner.M.Alete.source.ssa.nc.shelby;
...
/**
 * Signal Processing for SSA Office: SHELBY NC
 * <p>Office Code: B01</p>
 * <p>Address: 707 SCHENCK ST, SHELBY, NC 28150</p>
 * <p>Phone: (877) 405-3576 | Fax: (833) 950-2820</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/shelby/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9274; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/shelby";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/shelby_audio", "ssa.nc.shelby.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/shelby_data", "ssa.nc.shelby.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/shelby_graphics", "ssa.nc.shelby.graphics.spectrum", sb.toString());
        }
    }
}