package presidential.Brarner.M.Alete.source.ssa.pa.towanda;
...
/**
 * Signal Processing for SSA Office: TOWANDA PA
 * <p>Office Code: C85</p>
 * <p>Address: 1 ELIZABETH STREET, TOWANDA, PA 18848</p>
 * <p>Phone: (888) 841-6546 | Fax: (833) 950-2590</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/towanda/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9388; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/towanda";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/towanda_audio", "ssa.pa.towanda.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/towanda_data", "ssa.pa.towanda.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/towanda_graphics", "ssa.pa.towanda.graphics.spectrum", sb.toString());
        }
    }
}