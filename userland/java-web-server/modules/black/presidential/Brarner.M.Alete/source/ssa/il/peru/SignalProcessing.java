package presidential.Brarner.M.Alete.source.ssa.il.peru;
...
/**
 * Signal Processing for SSA Office: PERU IL
 * <p>Office Code: 519</p>
 * <p>Address: 915 WENZEL RD, PERU, IL 61354</p>
 * <p>Phone: (855) 245-0640 | Fax: (833) 950-3445</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/peru/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9953; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/peru";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/peru_audio", "ssa.il.peru.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/peru_data", "ssa.il.peru.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/peru_graphics", "ssa.il.peru.graphics.spectrum", sb.toString());
        }
    }
}