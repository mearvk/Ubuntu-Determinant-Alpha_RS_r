package presidential.Brarner.M.Alete.source.ssa.il.chicago004;
...
/**
 * Signal Processing for SSA Office: CHICAGO-WEST IL
 * <p>Office Code: 498</p>
 * <p>Address: 5130 WEST NORTH AVENUE, CHICAGO, IL 60639</p>
 * <p>Phone: (866) 614-4761 | Fax: (833) 950-2804</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/chicago004/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9933; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/chicago004";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago004_audio", "ssa.il.chicago004.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago004_data", "ssa.il.chicago004.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago004_graphics", "ssa.il.chicago004.graphics.spectrum", sb.toString());
        }
    }
}