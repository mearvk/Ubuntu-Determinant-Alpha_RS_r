package presidential.Brarner.M.Alete.source.ssa.ut.southjordan;
...
/**
 * Signal Processing for SSA Office: SOUTH JORDAN
 * <p>Office Code: D28</p>
 * <p>Address: 10138 S JORDAN GTWY, SOUTH JORDAN, UT 84095</p>
 * <p>Phone: (866) 690-1947 | Fax: (833) 950-2908</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ut/southjordan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9417; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ut/southjordan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ut/southjordan_audio", "ssa.ut.southjordan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ut/southjordan_data", "ssa.ut.southjordan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ut/southjordan_graphics", "ssa.ut.southjordan.graphics.spectrum", sb.toString());
        }
    }
}