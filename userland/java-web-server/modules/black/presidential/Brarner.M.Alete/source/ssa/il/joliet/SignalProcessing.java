package presidential.Brarner.M.Alete.source.ssa.il.joliet;
...
/**
 * Signal Processing for SSA Office: JOLIET IL
 * <p>Office Code: 494</p>
 * <p>Address: 552 HOUBOLT RD, JOLIET, IL 60431</p>
 * <p>Phone: (866) 783-7302 | Fax: (833) 950-2796</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/joliet/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9929; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/joliet";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/joliet_audio", "ssa.il.joliet.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/joliet_data", "ssa.il.joliet.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/joliet_graphics", "ssa.il.joliet.graphics.spectrum", sb.toString());
        }
    }
}