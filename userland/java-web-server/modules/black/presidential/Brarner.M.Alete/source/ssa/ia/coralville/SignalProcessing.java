...
/**
 * Signal Processing for SSA Office: CORALVILLE IA
 * <p>Office Code: B34</p>
 * <p>Address: 1100 6TH ST, CORALVILLE, IA 52241</p>
 * <p>Phone: (866) 964-2039 | Fax: (833) 950-2642</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/coralville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9301; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/coralville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/coralville_audio", "ssa.ia.coralville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/coralville_data", "ssa.ia.coralville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/coralville_graphics", "ssa.ia.coralville.graphics.spectrum", sb.toString());
        }
    }
}