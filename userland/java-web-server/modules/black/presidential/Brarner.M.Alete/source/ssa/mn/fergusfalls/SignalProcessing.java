package presidential.Brarner.M.Alete.source.ssa.mn.fergusfalls;
...
/**
 * Signal Processing for SSA Office: FERGUS FALLS MN
 * <p>Office Code: D22</p>
 * <p>Address: 1023 W LINCOLN AVE, FERGUS FALLS, MN 56537</p>
 * <p>Phone: (877) 402-0827 | Fax: (833) 950-2898</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/fergusfalls/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9414; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/fergusfalls";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/fergusfalls_audio", "ssa.mn.fergusfalls.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/fergusfalls_data", "ssa.mn.fergusfalls.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/fergusfalls_graphics", "ssa.mn.fergusfalls.graphics.spectrum", sb.toString());
        }
    }
}