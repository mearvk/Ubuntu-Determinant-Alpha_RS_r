package presidential.Brarner.M.Alete.source.ssa.or.ontario;
...
/**
 * Signal Processing for SSA Office: ONTARIO OR
 * <p>Office Code: B77</p>
 * <p>Address: 908 SE 5TH AVENUE, ONTARIO, OR 97914</p>
 * <p>Phone: (866) 403-8016 | Fax: (833) 950-3230</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/or/ontario/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9332; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/or/ontario";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_or/ontario_audio", "ssa.or.ontario.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_or/ontario_data", "ssa.or.ontario.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_or/ontario_graphics", "ssa.or.ontario.graphics.spectrum", sb.toString());
        }
    }
}