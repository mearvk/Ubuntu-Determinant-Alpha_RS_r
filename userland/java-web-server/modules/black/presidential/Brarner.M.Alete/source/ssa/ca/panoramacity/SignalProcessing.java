package presidential.Brarner.M.Alete.source.ssa.ca.panoramacity;
...
/**
 * Signal Processing for SSA Office: PANORAMA CITY CA
 * <p>Office Code: 975</p>
 * <p>Address: 14500 ROSCOE BLVD, PANORAMA CITY, CA 91402</p>
 * <p>Phone: (866) 341-0785 | Fax: (833) 950-2446</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/panoramacity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10357; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/panoramacity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/panoramacity_audio", "ssa.ca.panoramacity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/panoramacity_data", "ssa.ca.panoramacity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/panoramacity_graphics", "ssa.ca.panoramacity.graphics.spectrum", sb.toString());
        }
    }
}