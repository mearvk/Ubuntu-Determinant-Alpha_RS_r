package presidential.Brarner.M.Alete.source.ssa.va.fredericksburg;
...
/**
 * Signal Processing for SSA Office: FREDERICKSBURG
 * <p>Office Code: A38</p>
 * <p>Address: 9915 PATRIOT HIGHWAY, FREDERICKSBURG, VA 22407</p>
 * <p>Phone: (888) 759-3919 | Fax: (833) 612-0142</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/fredericksburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9224; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/fredericksburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/fredericksburg_audio", "ssa.va.fredericksburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/fredericksburg_data", "ssa.va.fredericksburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/fredericksburg_graphics", "ssa.va.fredericksburg.graphics.spectrum", sb.toString());
        }
    }
}