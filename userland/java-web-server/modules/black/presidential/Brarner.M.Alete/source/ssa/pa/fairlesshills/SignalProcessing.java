package presidential.Brarner.M.Alete.source.ssa.pa.fairlesshills;
...
/**
 * Signal Processing for SSA Office: FAIRLESS HILLS PA
 * <p>Office Code: 234</p>
 * <p>Address: 444 LINCOLN HWY, FAIRLESS HILLS, PA 19030</p>
 * <p>Phone: (866) 964-7318 | Fax: (833) 515-0401</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/fairlesshills/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9691; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/fairlesshills";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/fairlesshills_audio", "ssa.pa.fairlesshills.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/fairlesshills_data", "ssa.pa.fairlesshills.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/fairlesshills_graphics", "ssa.pa.fairlesshills.graphics.spectrum", sb.toString());
        }
    }
}