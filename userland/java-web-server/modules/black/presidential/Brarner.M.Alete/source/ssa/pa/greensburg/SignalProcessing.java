package presidential.Brarner.M.Alete.source.ssa.pa.greensburg;
...
/**
 * Signal Processing for SSA Office: GREENSBURG PA
 * <p>Office Code: 223</p>
 * <p>Address: 122 W 3RD STREET, GREENSBURG, PA 15601</p>
 * <p>Phone: (877) 748-9768 | Fax: (833) 950-3529</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/greensburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9681; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/greensburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/greensburg_audio", "ssa.pa.greensburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/greensburg_data", "ssa.pa.greensburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/greensburg_graphics", "ssa.pa.greensburg.graphics.spectrum", sb.toString());
        }
    }
}