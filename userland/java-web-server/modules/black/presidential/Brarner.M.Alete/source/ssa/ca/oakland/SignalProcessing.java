package presidential.Brarner.M.Alete.source.ssa.ca.oakland;
...
/**
 * Signal Processing for SSA Office: EAST OAKLAND CA
 * <p>Office Code: 28</p>
 * <p>Address: 7200 BANCROFT AVENUE, OAKLAND, CA 94605</p>
 * <p>Phone: (888) 527-9329 | Fax: (833) 950-2430</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/oakland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9512; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/oakland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/oakland_audio", "ssa.ca.oakland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/oakland_data", "ssa.ca.oakland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/oakland_graphics", "ssa.ca.oakland.graphics.spectrum", sb.toString());
        }
    }
}