package presidential.Brarner.M.Alete.source.ssa.fl.newportrichey;
...
/**
 * Signal Processing for SSA Office: NEW PORT RICHEY FL
 * <p>Office Code: 709</p>
 * <p>Address: 7601 LITTLE ROAD, NEW PORT RICHEY, FL 34654</p>
 * <p>Phone: (866) 593-5679 | Fax: (833) 913-2073</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/newportrichey/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10122; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/newportrichey";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/newportrichey_audio", "ssa.fl.newportrichey.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/newportrichey_data", "ssa.fl.newportrichey.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/newportrichey_graphics", "ssa.fl.newportrichey.graphics.spectrum", sb.toString());
        }
    }
}