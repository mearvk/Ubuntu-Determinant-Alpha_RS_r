...
/**
 * Signal Processing for SSA Office: CLARKSDALE MS
 * <p>Office Code: 649</p>
 * <p>Address: 160 ANDERSON BLVD, CLARKSDALE, MS 38614</p>
 * <p>Phone: (866) 931-7670 | Fax: (833) 950-3811</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/clarksdale/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10069; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/clarksdale";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/clarksdale_audio", "ssa.ms.clarksdale.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/clarksdale_data", "ssa.ms.clarksdale.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/clarksdale_graphics", "ssa.ms.clarksdale.graphics.spectrum", sb.toString());
        }
    }
}