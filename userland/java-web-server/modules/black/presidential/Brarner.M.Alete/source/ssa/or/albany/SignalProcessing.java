package presidential.Brarner.M.Alete.source.ssa.or.albany;
...
/**
 * Signal Processing for SSA Office: ALBANY OR
 * <p>Office Code: B76</p>
 * <p>Address: 1390 WAVERLY DRIVE SE, ALBANY, OR 97322</p>
 * <p>Phone: (877) 405-9196 | Fax: (833) 950-3228</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/or/albany/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9331; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/or/albany";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_or/albany_audio", "ssa.or.albany.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_or/albany_data", "ssa.or.albany.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_or/albany_graphics", "ssa.or.albany.graphics.spectrum", sb.toString());
        }
    }
}