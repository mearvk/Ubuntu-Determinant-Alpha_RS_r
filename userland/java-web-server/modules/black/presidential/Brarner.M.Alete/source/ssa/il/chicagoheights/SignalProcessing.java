package presidential.Brarner.M.Alete.source.ssa.il.chicagoheights;
...
/**
 * Signal Processing for SSA Office: CHICAGO HEIGHTS IL
 * <p>Office Code: 509</p>
 * <p>Address: 104 S HALSTED STREET, CHICAGO HEIGHTS, IL 60411</p>
 * <p>Phone: (877) 274-5413 | Fax: (833) 950-3111</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/chicagoheights/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9944; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/chicagoheights";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicagoheights_audio", "ssa.il.chicagoheights.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicagoheights_data", "ssa.il.chicagoheights.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicagoheights_graphics", "ssa.il.chicagoheights.graphics.spectrum", sb.toString());
        }
    }
}