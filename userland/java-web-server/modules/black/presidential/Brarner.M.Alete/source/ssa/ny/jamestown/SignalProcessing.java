package presidential.Brarner.M.Alete.source.ssa.ny.jamestown;
...
/**
 * Signal Processing for SSA Office: JAMESTOWN NY
 * <p>Office Code: 111</p>
 * <p>Address: 321 HAZELTINE AVE, JAMESTOWN, NY 14701</p>
 * <p>Phone: (877) 319-3079 | Fax: (833) 515-0471</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/jamestown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9582; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/jamestown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/jamestown_audio", "ssa.ny.jamestown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/jamestown_data", "ssa.ny.jamestown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/jamestown_graphics", "ssa.ny.jamestown.graphics.spectrum", sb.toString());
        }
    }
}