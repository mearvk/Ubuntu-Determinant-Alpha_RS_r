package presidential.Brarner.M.Alete.source.ssa.fl.miamibeach;
...
/**
 * Signal Processing for SSA Office: MIAMI BEACH FL
 * <p>Office Code: 671</p>
 * <p>Address: 1801 ALTON RD, MIAMI BEACH, FL 33139</p>
 * <p>Phone: (877) 714-0374 | Fax: (833) 795-0130</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/miamibeach/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10087; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/miamibeach";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/miamibeach_audio", "ssa.fl.miamibeach.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/miamibeach_data", "ssa.fl.miamibeach.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/miamibeach_graphics", "ssa.fl.miamibeach.graphics.spectrum", sb.toString());
        }
    }
}