package presidential.Brarner.M.Alete.source.ssa.co.louisville;
...
/**
 * Signal Processing for SSA Office: LOUISVILLE CO
 * <p>Office Code: 889</p>
 * <p>Address: 480 W DAHLIA ST, LOUISVILLE, CO 80027</p>
 * <p>Phone: (877) 405-5872 | Fax: (833) 641-2557</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/co/louisville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10274; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/co/louisville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_co/louisville_audio", "ssa.co.louisville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_co/louisville_data", "ssa.co.louisville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_co/louisville_graphics", "ssa.co.louisville.graphics.spectrum", sb.toString());
        }
    }
}