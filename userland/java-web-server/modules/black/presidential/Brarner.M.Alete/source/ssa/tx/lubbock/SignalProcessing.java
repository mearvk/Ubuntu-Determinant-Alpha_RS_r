package presidential.Brarner.M.Alete.source.ssa.tx.lubbock;
...
/**
 * Signal Processing for SSA Office: LUBBOCK TX
 * <p>Office Code: 827</p>
 * <p>Address: 5825 16TH STREET, LUBBOCK, TX 79416</p>
 * <p>Phone: (866) 467-0460 | Fax: (833) 902-2582</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/lubbock/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10218; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/lubbock";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/lubbock_audio", "ssa.tx.lubbock.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/lubbock_data", "ssa.tx.lubbock.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/lubbock_graphics", "ssa.tx.lubbock.graphics.spectrum", sb.toString());
        }
    }
}