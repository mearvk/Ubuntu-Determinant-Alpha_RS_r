package presidential.Brarner.M.Alete.source.ssa.fl.pensacola;
...
/**
 * Signal Processing for SSA Office: PENSACOLA FL
 * <p>Office Code: 660</p>
 * <p>Address: 411 W GARDEN STREET, PENSACOLA, FL 32502</p>
 * <p>Phone: (877) 505-4550 | Fax: (833) 679-0239</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/pensacola/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10079; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/pensacola";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/pensacola_audio", "ssa.fl.pensacola.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/pensacola_data", "ssa.fl.pensacola.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/pensacola_graphics", "ssa.fl.pensacola.graphics.spectrum", sb.toString());
        }
    }
}