package presidential.Brarner.M.Alete.source.ssa.wi.wausau;
...
/**
 * Signal Processing for SSA Office: WAUSAU WI
 * <p>Office Code: 542</p>
 * <p>Address: 352 GRAND AVE, WAUSAU, WI 54403</p>
 * <p>Phone: (855) 269-9186 | Fax: (833) 950-3749</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/wausau/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9971; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/wausau";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/wausau_audio", "ssa.wi.wausau.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/wausau_data", "ssa.wi.wausau.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/wausau_graphics", "ssa.wi.wausau.graphics.spectrum", sb.toString());
        }
    }
}