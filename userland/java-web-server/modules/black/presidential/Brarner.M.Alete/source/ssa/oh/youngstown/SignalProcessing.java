package presidential.Brarner.M.Alete.source.ssa.oh.youngstown;
...
/**
 * Signal Processing for SSA Office: YOUNGSTOWN OH
 * <p>Office Code: 397</p>
 * <p>Address: 354 E FEDERAL ST, YOUNGSTOWN, OH 44503</p>
 * <p>Phone: (877) 714-0393 | Fax: (833) 950-3095</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/youngstown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9838; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/youngstown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/youngstown_audio", "ssa.oh.youngstown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/youngstown_data", "ssa.oh.youngstown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/youngstown_graphics", "ssa.oh.youngstown.graphics.spectrum", sb.toString());
        }
    }
}