package presidential.Brarner.M.Alete.source.ssa.ca.bakersfield002;
...
/**
 * Signal Processing for SSA Office: BAKERSFIELD CA
 * <p>Office Code: 963</p>
 * <p>Address: 5300 OFFICE PARK DRIVE, BAKERSFIELD, CA 93309</p>
 * <p>Phone: (866) 476-1489 | Fax: (833) 940-2147</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/bakersfield002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10345; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/bakersfield002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/bakersfield002_audio", "ssa.ca.bakersfield002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/bakersfield002_data", "ssa.ca.bakersfield002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/bakersfield002_graphics", "ssa.ca.bakersfield002.graphics.spectrum", sb.toString());
        }
    }
}