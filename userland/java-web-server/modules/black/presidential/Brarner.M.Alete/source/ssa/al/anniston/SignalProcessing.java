...
/**
 * Signal Processing for SSA Office: ANNISTON AL
 * <p>Office Code: 627</p>
 * <p>Address: 801 QUINTARD AVE, ANNISTON, AL 36201</p>
 * <p>Phone: (877) 701-2139 | Fax: (833) 950-3493</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/anniston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10050; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/anniston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/anniston_audio", "ssa.al.anniston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/anniston_data", "ssa.al.anniston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/anniston_graphics", "ssa.al.anniston.graphics.spectrum", sb.toString());
        }
    }
}