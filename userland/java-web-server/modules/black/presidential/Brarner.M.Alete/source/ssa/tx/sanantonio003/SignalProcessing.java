...
/**
 * Signal Processing for SSA Office: SAN ANTONIO NW TX
 * <p>Office Code: 852</p>
 * <p>Address: 411 RICHLAND HILLS DR, SAN ANTONIO, TX 78245</p>
 * <p>Phone: (877) 697-4799 | Fax: (833) 950-2417</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/sanantonio003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10241; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/sanantonio003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanantonio003_audio", "ssa.tx.sanantonio003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanantonio003_data", "ssa.tx.sanantonio003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanantonio003_graphics", "ssa.tx.sanantonio003.graphics.spectrum", sb.toString());
        }
    }
}