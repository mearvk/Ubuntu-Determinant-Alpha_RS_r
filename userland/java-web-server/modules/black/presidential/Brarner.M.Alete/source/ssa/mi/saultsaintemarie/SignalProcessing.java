package presidential.Brarner.M.Alete.source.ssa.mi.saultsaintemarie;
...
/**
 * Signal Processing for SSA Office: SAULT ST MARIE MI
 * <p>Office Code: 881</p>
 * <p>Address: 2861 ASHMUN ST, SAULT SAINTE MARIE, MI 49783</p>
 * <p>Phone: (855) 285-6007 | Fax: (833) 950-2188</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/saultsaintemarie/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10267; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/saultsaintemarie";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/saultsaintemarie_audio", "ssa.mi.saultsaintemarie.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/saultsaintemarie_data", "ssa.mi.saultsaintemarie.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/saultsaintemarie_graphics", "ssa.mi.saultsaintemarie.graphics.spectrum", sb.toString());
        }
    }
}