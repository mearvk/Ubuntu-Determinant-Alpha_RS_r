package presidential.Brarner.M.Alete.source.ssa.ca.vallejo;
...
/**
 * Signal Processing for SSA Office: VALLEJO CA
 * <p>Office Code: 973</p>
 * <p>Address: 106 PLAZA DR, VALLEJO, CA 94591</p>
 * <p>Phone: (888) 808-5487 | Fax: (833) 950-2442</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/vallejo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10355; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/vallejo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/vallejo_audio", "ssa.ca.vallejo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/vallejo_data", "ssa.ca.vallejo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/vallejo_graphics", "ssa.ca.vallejo.graphics.spectrum", sb.toString());
        }
    }
}