package presidential.Brarner.M.Alete.source.ssa.mo.sikeston;
...
/**
 * Signal Processing for SSA Office: SIKESTON MO
 * <p>Office Code: D77</p>
 * <p>Address: 711 YORK DR, SIKESTON, MO 63801</p>
 * <p>Phone: (866) 964-4261 | Fax: (833) 950-2950</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/sikeston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9446; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/sikeston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/sikeston_audio", "ssa.mo.sikeston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/sikeston_data", "ssa.mo.sikeston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/sikeston_graphics", "ssa.mo.sikeston.graphics.spectrum", sb.toString());
        }
    }
}