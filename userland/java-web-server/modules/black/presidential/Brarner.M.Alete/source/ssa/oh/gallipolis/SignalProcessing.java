package presidential.Brarner.M.Alete.source.ssa.oh.gallipolis;
...
/**
 * Signal Processing for SSA Office: GALLIPOLIS OH
 * <p>Office Code: D12</p>
 * <p>Address: 2455 STATE ROUTE 160, GALLIPOLIS, OH 45631</p>
 * <p>Phone: (888) 397-6343 | Fax: (833) 580-0161</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/gallipolis/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9407; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/gallipolis";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/gallipolis_audio", "ssa.oh.gallipolis.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/gallipolis_data", "ssa.oh.gallipolis.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/gallipolis_graphics", "ssa.oh.gallipolis.graphics.spectrum", sb.toString());
        }
    }
}