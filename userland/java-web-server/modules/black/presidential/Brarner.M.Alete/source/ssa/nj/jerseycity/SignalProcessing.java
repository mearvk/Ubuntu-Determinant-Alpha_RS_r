package presidential.Brarner.M.Alete.source.ssa.nj.jerseycity;
...
/**
 * Signal Processing for SSA Office: JERSEY CITY NJ
 * <p>Office Code: 176</p>
 * <p>Address: 325 WEST SIDE AVENUE, JERSEY CITY, NJ 7305</p>
 * <p>Phone: (877) 405-2884 | Fax: (833) 950-2982</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/jerseycity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9637; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/jerseycity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/jerseycity_audio", "ssa.nj.jerseycity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/jerseycity_data", "ssa.nj.jerseycity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/jerseycity_graphics", "ssa.nj.jerseycity.graphics.spectrum", sb.toString());
        }
    }
}