package presidential.Brarner.M.Alete.source.ssa.la.alexandria;
...
/**
 * Signal Processing for SSA Office: ALEXANDRIA LA
 * <p>Office Code: 804</p>
 * <p>Address: 3401 NORTH BLVD, ALEXANDRIA, LA 71301</p>
 * <p>Phone: (877) 876-3171 | Fax: (833) 950-3637</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/alexandria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10196; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/alexandria";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/alexandria_audio", "ssa.la.alexandria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/alexandria_data", "ssa.la.alexandria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/alexandria_graphics", "ssa.la.alexandria.graphics.spectrum", sb.toString());
        }
    }
}