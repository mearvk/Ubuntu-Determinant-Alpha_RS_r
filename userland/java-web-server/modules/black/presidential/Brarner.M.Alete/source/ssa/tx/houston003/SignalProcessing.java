package presidential.Brarner.M.Alete.source.ssa.tx.houston003;
...
/**
 * Signal Processing for SSA Office: HOUSTON NORTHEAST TX
 * <p>Office Code: 856</p>
 * <p>Address: 5414 ALDINE MAIL RD, HOUSTON, TX 77039</p>
 * <p>Phone: (866) 931-2729 | Fax: (833) 950-2714</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/houston003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10244; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/houston003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/houston003_audio", "ssa.tx.houston003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/houston003_data", "ssa.tx.houston003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/houston003_graphics", "ssa.tx.houston003.graphics.spectrum", sb.toString());
        }
    }
}