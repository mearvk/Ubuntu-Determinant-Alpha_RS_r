package presidential.Brarner.M.Alete.source.ssa.ny.freeport;
...
/**
 * Signal Processing for SSA Office: FREEPORT NY
 * <p>Office Code: 151</p>
 * <p>Address: 84 N. MAIN STREET, FREEPORT, NY 11520</p>
 * <p>Phone: (866) 964-0028 | Fax: (833) 950-2672</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/freeport/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9619; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/freeport";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/freeport_audio", "ssa.ny.freeport.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/freeport_data", "ssa.ny.freeport.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/freeport_graphics", "ssa.ny.freeport.graphics.spectrum", sb.toString());
        }
    }
}