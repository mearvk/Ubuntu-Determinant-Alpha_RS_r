package presidential.Brarner.M.Alete.source.ssa.ms.greenville;
...
/**
 * Signal Processing for SSA Office: GREENVILLE MS
 * <p>Office Code: 647</p>
 * <p>Address: 305 MAIN STREET, GREENVILLE, MS 38701</p>
 * <p>Phone: (866) 602-8776 | Fax: (833) 950-3807</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/greenville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10067; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/greenville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/greenville_audio", "ssa.ms.greenville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/greenville_data", "ssa.ms.greenville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/greenville_graphics", "ssa.ms.greenville.graphics.spectrum", sb.toString());
        }
    }
}