package presidential.Brarner.M.Alete.source.ssa.in.marion;
...
/**
 * Signal Processing for SSA Office: MARION IN
 * <p>Office Code: 471</p>
 * <p>Address: 844 N MILLER AVENUE, MARION, IN 46952</p>
 * <p>Phone: (888) 397-9795 | Fax: (833) 950-2158</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/marion/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9908; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/marion";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/marion_audio", "ssa.in.marion.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/marion_data", "ssa.in.marion.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/marion_graphics", "ssa.in.marion.graphics.spectrum", sb.toString());
        }
    }
}