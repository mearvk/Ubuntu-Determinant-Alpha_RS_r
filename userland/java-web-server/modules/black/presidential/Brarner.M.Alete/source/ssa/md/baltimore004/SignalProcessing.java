...
/**
 * Signal Processing for SSA Office: BALTIMORE WABASH MD
 * <p>Office Code: 199</p>
 * <p>Address: 6100A WABASH AVENUE, BALTIMORE, MD 21215</p>
 * <p>Phone: (866) 708-3210 | Fax: (833) 597-0138</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/baltimore004/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9657; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/baltimore004";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/baltimore004_audio", "ssa.md.baltimore004.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/baltimore004_data", "ssa.md.baltimore004.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/baltimore004_graphics", "ssa.md.baltimore004.graphics.spectrum", sb.toString());
        }
    }
}