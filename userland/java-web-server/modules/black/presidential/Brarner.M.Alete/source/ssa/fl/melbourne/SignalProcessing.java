package presidential.Brarner.M.Alete.source.ssa.fl.melbourne;
...
/**
 * Signal Processing for SSA Office: MELBOURNE FL
 * <p>Office Code: 673</p>
 * <p>Address: 1715 W NASA BLVD, MELBOURNE, FL 32901</p>
 * <p>Phone: (866) 716-7667 | Fax: (833) 913-2069</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/melbourne/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10088; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/melbourne";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/melbourne_audio", "ssa.fl.melbourne.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/melbourne_data", "ssa.fl.melbourne.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/melbourne_graphics", "ssa.fl.melbourne.graphics.spectrum", sb.toString());
        }
    }
}