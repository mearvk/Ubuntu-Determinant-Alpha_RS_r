package presidential.Brarner.M.Alete.source.ssa.ma.waltham;
...
/**
 * Signal Processing for SSA Office: WALTHAM MA
 * <p>Office Code: 51</p>
 * <p>Address: 135 BEAVER STREET, WALTHAM, MA 2452</p>
 * <p>Phone: (877) 457-1737 | Fax: (833) 873-4342</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/waltham/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9533; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/waltham";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/waltham_audio", "ssa.ma.waltham.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/waltham_data", "ssa.ma.waltham.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/waltham_graphics", "ssa.ma.waltham.graphics.spectrum", sb.toString());
        }
    }
}