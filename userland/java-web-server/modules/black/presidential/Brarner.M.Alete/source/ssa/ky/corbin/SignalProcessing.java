...
/**
 * Signal Processing for SSA Office: CORBIN KY
 * <p>Office Code: 445</p>
 * <p>Address: 159 FUTURE DR, CORBIN, KY 40701</p>
 * <p>Phone: (877) 405-0470 | Fax: (833) 950-3481</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/corbin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9882; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/corbin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/corbin_audio", "ssa.ky.corbin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/corbin_data", "ssa.ky.corbin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/corbin_graphics", "ssa.ky.corbin.graphics.spectrum", sb.toString());
        }
    }
}