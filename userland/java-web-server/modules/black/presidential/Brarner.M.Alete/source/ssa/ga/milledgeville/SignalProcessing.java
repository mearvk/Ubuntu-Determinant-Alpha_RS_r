package presidential.Brarner.M.Alete.source.ssa.ga.milledgeville;
...
/**
 * Signal Processing for SSA Office: MILLEDGEVILLE GA
 * <p>Office Code: 610</p>
 * <p>Address: 109 CYPRESS CORNERS, MILLEDGEVILLE, GA 31061</p>
 * <p>Phone: (866) 348-5817 | Fax: (833) 950-2858</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/milledgeville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10033; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/milledgeville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/milledgeville_audio", "ssa.ga.milledgeville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/milledgeville_data", "ssa.ga.milledgeville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/milledgeville_graphics", "ssa.ga.milledgeville.graphics.spectrum", sb.toString());
        }
    }
}