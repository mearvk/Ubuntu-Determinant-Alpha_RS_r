package presidential.Brarner.M.Alete.source.ssa.ok.ardmore;
...
/**
 * Signal Processing for SSA Office: ARDMORE OK
 * <p>Office Code: 786</p>
 * <p>Address: 321 HOLIDAY DRIVE, ARDMORE, OK 73401</p>
 * <p>Phone: (888) 619-4774 | Fax: (833) 950-3011</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/ardmore/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10181; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/ardmore";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/ardmore_audio", "ssa.ok.ardmore.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/ardmore_data", "ssa.ok.ardmore.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/ardmore_graphics", "ssa.ok.ardmore.graphics.spectrum", sb.toString());
        }
    }
}