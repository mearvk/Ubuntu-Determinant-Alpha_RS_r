package presidential.Brarner.M.Alete.source.ssa.ca.napa;
...
/**
 * Signal Processing for SSA Office: NAPA CA
 * <p>Office Code: A79</p>
 * <p>Address: 1850 SOSCOL AVE, NAPA, CA 94559</p>
 * <p>Phone: (877) 836-1559 | Fax: (833) 950-3367</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/napa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9259; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/napa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/napa_audio", "ssa.ca.napa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/napa_data", "ssa.ca.napa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/napa_graphics", "ssa.ca.napa.graphics.spectrum", sb.toString());
        }
    }
}