package presidential.Brarner.M.Alete.source.ssa.ms.gulfport;
...
/**
 * Signal Processing for SSA Office: GULFPORT MS
 * <p>Office Code: 646</p>
 * <p>Address: 9394 THREE RIVERS ROAD, GULFPORT, MS 39503</p>
 * <p>Phone: (877) 897-0609 | Fax: (833) 950-3805</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/gulfport/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10066; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/gulfport";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/gulfport_audio", "ssa.ms.gulfport.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/gulfport_data", "ssa.ms.gulfport.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/gulfport_graphics", "ssa.ms.gulfport.graphics.spectrum", sb.toString());
        }
    }
}