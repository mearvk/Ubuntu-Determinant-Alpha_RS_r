package presidential.Brarner.M.Alete.source.ssa.oh.canton;
...
/**
 * Signal Processing for SSA Office: CANTON OH
 * <p>Office Code: 400</p>
 * <p>Address: 301 MCKINLEY AVE SW, CANTON, OH 44702</p>
 * <p>Phone: (877) 255-1509 | Fax: (833) 950-3417</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/canton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9841; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/canton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/canton_audio", "ssa.oh.canton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/canton_data", "ssa.oh.canton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/canton_graphics", "ssa.oh.canton.graphics.spectrum", sb.toString());
        }
    }
}