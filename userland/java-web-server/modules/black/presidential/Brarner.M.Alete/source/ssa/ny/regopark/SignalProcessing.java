...
/**
 * Signal Processing for SSA Office: REGO PARK NY
 * <p>Office Code: 119</p>
 * <p>Address: 6344 AUSTIN STREET, REGO PARK, NY 11374</p>
 * <p>Phone: (877) 255-1506 | Fax: (833) 902-2530</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/regopark/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9590; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/regopark";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/regopark_audio", "ssa.ny.regopark.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/regopark_data", "ssa.ny.regopark.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/regopark_graphics", "ssa.ny.regopark.graphics.spectrum", sb.toString());
        }
    }
}