package presidential.Brarner.M.Alete.source.ssa.oh.toledo;
...
/**
 * Signal Processing for SSA Office: TOLEDO-WEST OH
 * <p>Office Code: 376</p>
 * <p>Address: 4906 MONROE ST, TOLEDO, OH 43623</p>
 * <p>Phone: (877) 274-5429 | Fax: (833) 950-2786</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/toledo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9821; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/toledo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/toledo_audio", "ssa.oh.toledo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/toledo_data", "ssa.oh.toledo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/toledo_graphics", "ssa.oh.toledo.graphics.spectrum", sb.toString());
        }
    }
}