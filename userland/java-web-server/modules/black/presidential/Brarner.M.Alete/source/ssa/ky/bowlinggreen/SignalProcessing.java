package presidential.Brarner.M.Alete.source.ssa.ky.bowlinggreen;
...
/**
 * Signal Processing for SSA Office: BOWLING GREEN KY
 * <p>Office Code: 443</p>
 * <p>Address: 2724 CHANDLER DRIVE, BOWLING GREEN, KY 42104</p>
 * <p>Phone: (877) 801-0817 | Fax: (833) 950-3477</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/bowlinggreen/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9880; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/bowlinggreen";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/bowlinggreen_audio", "ssa.ky.bowlinggreen.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/bowlinggreen_data", "ssa.ky.bowlinggreen.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/bowlinggreen_graphics", "ssa.ky.bowlinggreen.graphics.spectrum", sb.toString());
        }
    }
}