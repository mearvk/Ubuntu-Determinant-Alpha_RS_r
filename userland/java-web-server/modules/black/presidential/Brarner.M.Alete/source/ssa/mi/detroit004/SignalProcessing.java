package presidential.Brarner.M.Alete.source.ssa.mi.detroit004;
...
/**
 * Signal Processing for SSA Office: DETROIT COLLEGE PARK FIELD OFFICE
 * <p>Office Code: 373</p>
 * <p>Address: 7800 W. OUTER DR, DETROIT, MI 48235</p>
 * <p>Phone: (866) 365-6741 | Fax: (833) 950-2780</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/detroit004/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9819; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/detroit004";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/detroit004_audio", "ssa.mi.detroit004.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/detroit004_data", "ssa.mi.detroit004.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/detroit004_graphics", "ssa.mi.detroit004.graphics.spectrum", sb.toString());
        }
    }
}