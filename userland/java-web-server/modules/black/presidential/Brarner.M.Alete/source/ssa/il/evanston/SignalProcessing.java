package presidential.Brarner.M.Alete.source.ssa.il.evanston;
...
/**
 * Signal Processing for SSA Office: EVANSTON IL
 * <p>Office Code: 504</p>
 * <p>Address: 2116 GREEN BAY RD, EVANSTON, IL 60201</p>
 * <p>Phone: (888) 371-0791 | Fax: (833) 950-3101</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/evanston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9939; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/evanston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/evanston_audio", "ssa.il.evanston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/evanston_data", "ssa.il.evanston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/evanston_graphics", "ssa.il.evanston.graphics.spectrum", sb.toString());
        }
    }
}