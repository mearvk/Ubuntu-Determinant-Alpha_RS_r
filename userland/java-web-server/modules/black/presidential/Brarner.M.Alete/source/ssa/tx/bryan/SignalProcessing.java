package presidential.Brarner.M.Alete.source.ssa.tx.bryan;
...
/**
 * Signal Processing for SSA Office: BRYAN TX
 * <p>Office Code: 836</p>
 * <p>Address: 2120 W BRIARGATE DR, BRYAN, TX 77802</p>
 * <p>Phone: (866) 568-9428 | Fax: (833) 939-2027</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/bryan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10227; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/bryan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/bryan_audio", "ssa.tx.bryan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/bryan_data", "ssa.tx.bryan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/bryan_graphics", "ssa.tx.bryan.graphics.spectrum", sb.toString());
        }
    }
}