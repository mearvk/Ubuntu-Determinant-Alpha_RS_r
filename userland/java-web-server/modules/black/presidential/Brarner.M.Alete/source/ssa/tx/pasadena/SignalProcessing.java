package presidential.Brarner.M.Alete.source.ssa.tx.pasadena;
...
/**
 * Signal Processing for SSA Office: PASADENA TX
 * <p>Office Code: 850</p>
 * <p>Address: 3300 WATTERS ROAD, PASADENA, TX 77504</p>
 * <p>Phone: (866) 563-4603 | Fax: (833) 950-2414</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/pasadena/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10239; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/pasadena";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/pasadena_audio", "ssa.tx.pasadena.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/pasadena_data", "ssa.tx.pasadena.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/pasadena_graphics", "ssa.tx.pasadena.graphics.spectrum", sb.toString());
        }
    }
}