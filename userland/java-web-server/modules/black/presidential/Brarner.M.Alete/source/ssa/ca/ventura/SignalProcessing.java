package presidential.Brarner.M.Alete.source.ssa.ca.ventura;
...
/**
 * Signal Processing for SSA Office: VENTURA CA
 * <p>Office Code: 974</p>
 * <p>Address: 6477 TELEPHONE ROAD, VENTURA, CA 93003</p>
 * <p>Phone: (877) 651-7118 | Fax: (833) 950-2444</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/ventura/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10356; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/ventura";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/ventura_audio", "ssa.ca.ventura.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/ventura_data", "ssa.ca.ventura.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/ventura_graphics", "ssa.ca.ventura.graphics.spectrum", sb.toString());
        }
    }
}