package presidential.Brarner.M.Alete.source.ssa.fl.winterhaven;
...
/**
 * Signal Processing for SSA Office: WINTER HAVEN FL
 * <p>Office Code: A43</p>
 * <p>Address: 1395 NW HAVENDALE BLVD, WINTER HAVEN, FL 33881</p>
 * <p>Phone: (877) 457-1739 | Fax: (833) 950-2518</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/winterhaven/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9228; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/winterhaven";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/winterhaven_audio", "ssa.fl.winterhaven.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/winterhaven_data", "ssa.fl.winterhaven.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/winterhaven_graphics", "ssa.fl.winterhaven.graphics.spectrum", sb.toString());
        }
    }
}