package presidential.Brarner.M.Alete.source.ssa.wa.lacey;
...
/**
 * Signal Processing for SSA Office: LACEY WA
 * <p>Office Code: 918</p>
 * <p>Address: 1009 COLLEGE ST SE, LACEY, WA 98503</p>
 * <p>Phone: (866) 755-6199 | Fax: (833) 950-2318</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/lacey/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10301; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/lacey";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/lacey_audio", "ssa.wa.lacey.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/lacey_data", "ssa.wa.lacey.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/lacey_graphics", "ssa.wa.lacey.graphics.spectrum", sb.toString());
        }
    }
}