package presidential.Brarner.M.Alete.source.ssa.ny.mineola;
...
/**
 * Signal Processing for SSA Office: MINEOLA NY
 * <p>Office Code: 138</p>
 * <p>Address: 163 MINEOLA BLVD, MINEOLA, NY 11501</p>
 * <p>Phone: (866) 758-1318 | Fax: (833) 939-1982</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/mineola/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9607; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/mineola";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/mineola_audio", "ssa.ny.mineola.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/mineola_data", "ssa.ny.mineola.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/mineola_graphics", "ssa.ny.mineola.graphics.spectrum", sb.toString());
        }
    }
}