package presidential.Brarner.M.Alete.source.ssa.ny.westseneca;
...
/**
 * Signal Processing for SSA Office: RIDGE ROAD NY
 * <p>Office Code: B96</p>
 * <p>Address: 1900 RIDGE RD, WEST SENECA, NY 14224</p>
 * <p>Phone: (800) 647-9195 | Fax: (833) 950-2968</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/westseneca/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9340; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/westseneca";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/westseneca_audio", "ssa.ny.westseneca.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/westseneca_data", "ssa.ny.westseneca.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/westseneca_graphics", "ssa.ny.westseneca.graphics.spectrum", sb.toString());
        }
    }
}