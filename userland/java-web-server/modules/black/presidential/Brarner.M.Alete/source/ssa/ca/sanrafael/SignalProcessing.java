package presidential.Brarner.M.Alete.source.ssa.ca.sanrafael;
...
/**
 * Signal Processing for SSA Office: SAN RAFAEL CA
 * <p>Office Code: 988</p>
 * <p>Address: 99 SMITH RANCH ROAD, SAN RAFAEL, CA 94903</p>
 * <p>Phone: (866) 331-7761 | Fax: (833) 950-2760</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sanrafael/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10369; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sanrafael";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanrafael_audio", "ssa.ca.sanrafael.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanrafael_data", "ssa.ca.sanrafael.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanrafael_graphics", "ssa.ca.sanrafael.graphics.spectrum", sb.toString());
        }
    }
}