package presidential.Brarner.M.Alete.source.ssa.va.reston;
...
/**
 * Signal Processing for SSA Office: RESTON VA
 * <p>Office Code: 318</p>
 * <p>Address: 10800 PARKRIDGE BLVD, RESTON, VA 20191</p>
 * <p>Phone: (866) 829-3158 | Fax: (833) 950-2606</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/reston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9768; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/reston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/reston_audio", "ssa.va.reston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/reston_data", "ssa.va.reston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/reston_graphics", "ssa.va.reston.graphics.spectrum", sb.toString());
        }
    }
}