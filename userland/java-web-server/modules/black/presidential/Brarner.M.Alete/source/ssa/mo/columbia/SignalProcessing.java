package presidential.Brarner.M.Alete.source.ssa.mo.columbia;
...
/**
 * Signal Processing for SSA Office: COLUMBIA MO
 * <p>Office Code: 751</p>
 * <p>Address: 3402 BUTTONWOOD DR, COLUMBIA, MO 65201</p>
 * <p>Phone: (866) 563-9108 | Fax: (833) 950-2322</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/columbia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10150; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/columbia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/columbia_audio", "ssa.mo.columbia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/columbia_data", "ssa.mo.columbia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/columbia_graphics", "ssa.mo.columbia.graphics.spectrum", sb.toString());
        }
    }
}