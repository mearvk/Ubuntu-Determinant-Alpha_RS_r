package presidential.Brarner.M.Alete.source.ssa.va.harrisonburg;
...
/**
 * Signal Processing for SSA Office: HARRISONBURG VA
 * <p>Office Code: C83</p>
 * <p>Address: 351 NORTH MASON STREET, HARRISONBURG, VA 22802</p>
 * <p>Phone: (866) 964-1718 | Fax: (833) 912-2324</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/harrisonburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9387; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/harrisonburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/harrisonburg_audio", "ssa.va.harrisonburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/harrisonburg_data", "ssa.va.harrisonburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/harrisonburg_graphics", "ssa.va.harrisonburg.graphics.spectrum", sb.toString());
        }
    }
}