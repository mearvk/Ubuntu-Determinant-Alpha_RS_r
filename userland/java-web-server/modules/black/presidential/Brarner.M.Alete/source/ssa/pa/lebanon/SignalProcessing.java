...
/**
 * Signal Processing for SSA Office: LEBANON PA
 * <p>Office Code: 240</p>
 * <p>Address: 600 ISABEL DRIVE, SUITE 1, LEBANON, PA 17042</p>
 * <p>Phone: (866) 716-9635 | Fax: (833) 603-0367</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/lebanon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9697; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/lebanon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/lebanon_audio", "ssa.pa.lebanon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/lebanon_data", "ssa.pa.lebanon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/lebanon_graphics", "ssa.pa.lebanon.graphics.spectrum", sb.toString());
        }
    }
}