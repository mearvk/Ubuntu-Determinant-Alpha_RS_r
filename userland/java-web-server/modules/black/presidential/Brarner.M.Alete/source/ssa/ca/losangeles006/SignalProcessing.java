package presidential.Brarner.M.Alete.source.ssa.ca.losangeles006;
...
/**
 * Signal Processing for SSA Office: LOS ANGELES DOWNTOWN
 * <p>Office Code: 951</p>
 * <p>Address: 1401 W 8TH STREET, LOS ANGELES, CA 90017</p>
 * <p>Phone: (877) 803-6308 | Fax: (833) 571-2683</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/losangeles006/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10333; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/losangeles006";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles006_audio", "ssa.ca.losangeles006.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles006_data", "ssa.ca.losangeles006.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles006_graphics", "ssa.ca.losangeles006.graphics.spectrum", sb.toString());
        }
    }
}