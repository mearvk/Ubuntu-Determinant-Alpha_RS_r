...
/**
 * Signal Processing for SSA Office: FOREST MS
 * <p>Office Code: C97</p>
 * <p>Address: 558 DEER FIELD DRIVE, FOREST, MS 39074</p>
 * <p>Phone: (866) 829-2497 | Fax: (833) 597-0074</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/forest/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9398; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/forest";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/forest_audio", "ssa.ms.forest.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/forest_data", "ssa.ms.forest.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/forest_graphics", "ssa.ms.forest.graphics.spectrum", sb.toString());
        }
    }
}