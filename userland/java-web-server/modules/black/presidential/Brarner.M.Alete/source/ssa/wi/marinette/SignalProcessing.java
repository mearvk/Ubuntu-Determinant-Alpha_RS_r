package presidential.Brarner.M.Alete.source.ssa.wi.marinette;
...
/**
 * Signal Processing for SSA Office: MARINETTE WI
 * <p>Office Code: 553</p>
 * <p>Address: 2023 LAKE PARK DR, MARINETTE, WI 54143</p>
 * <p>Phone: (888) 329-5722 | Fax: (833) 597-0058</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/marinette/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9982; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/marinette";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/marinette_audio", "ssa.wi.marinette.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/marinette_data", "ssa.wi.marinette.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/marinette_graphics", "ssa.wi.marinette.graphics.spectrum", sb.toString());
        }
    }
}