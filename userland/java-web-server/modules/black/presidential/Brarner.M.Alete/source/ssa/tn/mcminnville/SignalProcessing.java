package presidential.Brarner.M.Alete.source.ssa.tn.mcminnville;
...
/**
 * Signal Processing for SSA Office: MCMINNVILLE TN
 * <p>Office Code: B19</p>
 * <p>Address: 900 SPARTA ST, MCMINNVILLE, TN 37110</p>
 * <p>Phone: (877) 616-2515 | Fax: (833) 950-3133</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/mcminnville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9289; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/mcminnville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/mcminnville_audio", "ssa.tn.mcminnville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/mcminnville_data", "ssa.tn.mcminnville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/mcminnville_graphics", "ssa.tn.mcminnville.graphics.spectrum", sb.toString());
        }
    }
}