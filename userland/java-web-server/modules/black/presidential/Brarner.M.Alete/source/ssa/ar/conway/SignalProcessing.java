package presidential.Brarner.M.Alete.source.ssa.ar.conway;
...
/**
 * Signal Processing for SSA Office: CONWAY AR
 * <p>Office Code: B49</p>
 * <p>Address: 2475 CHRISTINA LN, CONWAY, AR 72034</p>
 * <p>Phone: (855) 727-3599 | Fax: (833) 939-2003</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/conway/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9311; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/conway";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/conway_audio", "ssa.ar.conway.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/conway_data", "ssa.ar.conway.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/conway_graphics", "ssa.ar.conway.graphics.spectrum", sb.toString());
        }
    }
}