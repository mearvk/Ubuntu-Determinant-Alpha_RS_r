package presidential.Brarner.M.Alete.source.ssa.sc.orangeburg;
...
/**
 * Signal Processing for SSA Office: ORANGEBURG SC
 * <p>Office Code: 594</p>
 * <p>Address: 1379 SIMS ST, ORANGEBURG, SC 29115</p>
 * <p>Phone: (866) 716-8602 | Fax: (833) 950-2247</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/orangeburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10018; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/orangeburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/orangeburg_audio", "ssa.sc.orangeburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/orangeburg_data", "ssa.sc.orangeburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/orangeburg_graphics", "ssa.sc.orangeburg.graphics.spectrum", sb.toString());
        }
    }
}