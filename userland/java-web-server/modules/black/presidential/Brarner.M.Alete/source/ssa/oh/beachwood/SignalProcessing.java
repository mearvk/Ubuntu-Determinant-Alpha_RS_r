package presidential.Brarner.M.Alete.source.ssa.oh.beachwood;
...
/**
 * Signal Processing for SSA Office: CLEVELAND EAST OH
 * <p>Office Code: 406</p>
 * <p>Address: 3591 PARK EAST DR, BEACHWOOD, OH 44122</p>
 * <p>Phone: (877) 402-0823 | Fax: (833) 950-3429</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/beachwood/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9847; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/beachwood";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/beachwood_audio", "ssa.oh.beachwood.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/beachwood_data", "ssa.oh.beachwood.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/beachwood_graphics", "ssa.oh.beachwood.graphics.spectrum", sb.toString());
        }
    }
}