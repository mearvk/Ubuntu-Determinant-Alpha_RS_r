package presidential.Brarner.M.Alete.source.ssa.nj.hoboken;
...
/**
 * Signal Processing for SSA Office: HOBOKEN NJ
 * <p>Office Code: C04</p>
 * <p>Address: 79 HUDSON ST, HOBOKEN, NJ 7030</p>
 * <p>Phone: (877) 505-4547 | Fax: (833) 950-3268</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/hoboken/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9344; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/hoboken";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/hoboken_audio", "ssa.nj.hoboken.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/hoboken_data", "ssa.nj.hoboken.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/hoboken_graphics", "ssa.nj.hoboken.graphics.spectrum", sb.toString());
        }
    }
}