package presidential.Brarner.M.Alete.source.ssa.mi.westbranch;
...
/**
 * Signal Processing for SSA Office: WEST BRANCH MI
 * <p>Office Code: 246</p>
 * <p>Address: 541 PROGRESS ST, WEST BRANCH, MI 48661</p>
 * <p>Phone: (877) 897-0602 | Fax: (833) 902-2654</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/westbranch/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9702; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/westbranch";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/westbranch_audio", "ssa.mi.westbranch.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/westbranch_data", "ssa.mi.westbranch.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/westbranch_graphics", "ssa.mi.westbranch.graphics.spectrum", sb.toString());
        }
    }
}