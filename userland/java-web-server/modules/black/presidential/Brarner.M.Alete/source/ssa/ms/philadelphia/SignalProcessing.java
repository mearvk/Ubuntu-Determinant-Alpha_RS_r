package presidential.Brarner.M.Alete.source.ssa.ms.philadelphia;
...
/**
 * Signal Processing for SSA Office: PHILADELPHIA MS
 * <p>Office Code: A47</p>
 * <p>Address: 100 PILOT ST, PHILADELPHIA, MS 39350</p>
 * <p>Phone: (877) 531-4681 | Fax: (833) 950-2526</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/philadelphia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9232; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/philadelphia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/philadelphia_audio", "ssa.ms.philadelphia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/philadelphia_data", "ssa.ms.philadelphia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/philadelphia_graphics", "ssa.ms.philadelphia.graphics.spectrum", sb.toString());
        }
    }
}