package presidential.Brarner.M.Alete.source.ssa.ca.oakland002;
...
/**
 * Signal Processing for SSA Office: OAKLAND DT CA
 * <p>Office Code: 953</p>
 * <p>Address: 360 22ND ST, OAKLAND, CA 94612</p>
 * <p>Phone: (866) 964-7420 | Fax: (833) 902-2616</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/oakland002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10335; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/oakland002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/oakland002_audio", "ssa.ca.oakland002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/oakland002_data", "ssa.ca.oakland002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/oakland002_graphics", "ssa.ca.oakland002.graphics.spectrum", sb.toString());
        }
    }
}