...
/**
 * Signal Processing for SSA Office: PORT ORANGE FL
 * <p>Office Code: 664</p>
 * <p>Address: 4990 S CLYDE MORRIS BLVD, PORT ORANGE, FL 32127</p>
 * <p>Phone: (866) 210-8089 | Fax: (833) 710-0165</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/portorange/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10083; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/portorange";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/portorange_audio", "ssa.fl.portorange.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/portorange_data", "ssa.fl.portorange.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/portorange_graphics", "ssa.fl.portorange.graphics.spectrum", sb.toString());
        }
    }
}