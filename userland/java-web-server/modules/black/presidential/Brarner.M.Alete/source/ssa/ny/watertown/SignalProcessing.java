package presidential.Brarner.M.Alete.source.ssa.ny.watertown;
...
/**
 * Signal Processing for SSA Office: WATERTOWN NY
 * <p>Office Code: 129</p>
 * <p>Address: 156 BELLEW AVE SOUTH, WATERTOWN, NY 13601</p>
 * <p>Phone: (866) 627-6995 | Fax: (833) 926-1866</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/watertown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9599; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/watertown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/watertown_audio", "ssa.ny.watertown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/watertown_data", "ssa.ny.watertown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/watertown_graphics", "ssa.ny.watertown.graphics.spectrum", sb.toString());
        }
    }
}