...
/**
 * Signal Processing for SSA Office: KEENE NH
 * <p>Office Code: 15</p>
 * <p>Address: 9 ELM STREET, KEENE, NH 3431</p>
 * <p>Phone: (877) 405-3651 | Fax: (833) 515-0449</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nh/keene/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9503; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nh/keene";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nh/keene_audio", "ssa.nh.keene.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nh/keene_data", "ssa.nh.keene.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nh/keene_graphics", "ssa.nh.keene.graphics.spectrum", sb.toString());
        }
    }
}