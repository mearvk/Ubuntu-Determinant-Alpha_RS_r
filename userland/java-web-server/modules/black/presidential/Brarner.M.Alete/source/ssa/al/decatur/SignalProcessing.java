package presidential.Brarner.M.Alete.source.ssa.al.decatur;
...
/**
 * Signal Processing for SSA Office: DECATUR AL
 * <p>Office Code: 625</p>
 * <p>Address: 717 MCGLATHERY LN SE, DECATUR, AL 35601</p>
 * <p>Phone: (888) 289-9185 | Fax: (833) 950-3173</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/decatur/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10048; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/decatur";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/decatur_audio", "ssa.al.decatur.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/decatur_data", "ssa.al.decatur.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/decatur_graphics", "ssa.al.decatur.graphics.spectrum", sb.toString());
        }
    }
}