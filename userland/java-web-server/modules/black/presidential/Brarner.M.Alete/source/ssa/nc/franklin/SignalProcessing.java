...
/**
 * Signal Processing for SSA Office: FRANKLIN NC
 * <p>Office Code: 482</p>
 * <p>Address: 2123 LAKESIDE DR, FRANKLIN, NC 28734</p>
 * <p>Phone: (866) 562-0738 | Fax: (833) 950-3782</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/franklin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9917; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/franklin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/franklin_audio", "ssa.nc.franklin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/franklin_data", "ssa.nc.franklin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/franklin_graphics", "ssa.nc.franklin.graphics.spectrum", sb.toString());
        }
    }
}