package presidential.Brarner.M.Alete.source.ssa.ca.needles;
...
/**
 * Signal Processing for SSA Office: COLORADO RIVER BASIN / NEEDLES CA
 * <p>Office Code: A15</p>
 * <p>Address: 1502 BAILEY AVENUE, NEEDLES, CA 92363</p>
 * <p>Phone: (866) 596-7946 | Fax: (833) 950-3357</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/needles/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9207; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/needles";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/needles_audio", "ssa.ca.needles.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/needles_data", "ssa.ca.needles.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/needles_graphics", "ssa.ca.needles.graphics.spectrum", sb.toString());
        }
    }
}