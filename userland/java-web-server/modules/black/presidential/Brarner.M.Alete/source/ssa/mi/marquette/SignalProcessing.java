...
/**
 * Signal Processing for SSA Office: MARQUETTE MI
 * <p>Office Code: 346</p>
 * <p>Address: 101 W WASHINGTON ST, MARQUETTE, MI 49855</p>
 * <p>Phone: (855) 782-9154 | Fax: (833) 902-2658</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/marquette/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9793; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/marquette";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/marquette_audio", "ssa.mi.marquette.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/marquette_data", "ssa.mi.marquette.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/marquette_graphics", "ssa.mi.marquette.graphics.spectrum", sb.toString());
        }
    }
}