...
/**
 * Signal Processing for SSA Office: LITTLETON NH
 * <p>Office Code: 13</p>
 * <p>Address: 177 MAIN ST, LITTLETON, NH 3561</p>
 * <p>Phone: (877) 405-7658 | Fax: (833) 515-0445</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nh/littleton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9501; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nh/littleton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nh/littleton_audio", "ssa.nh.littleton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nh/littleton_data", "ssa.nh.littleton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nh/littleton_graphics", "ssa.nh.littleton.graphics.spectrum", sb.toString());
        }
    }
}