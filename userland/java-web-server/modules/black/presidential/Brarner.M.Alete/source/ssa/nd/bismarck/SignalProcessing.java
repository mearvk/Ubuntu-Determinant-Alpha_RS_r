package presidential.Brarner.M.Alete.source.ssa.nd.bismarck;
...
/**
 * Signal Processing for SSA Office: BISMARCK ND
 * <p>Office Code: 708</p>
 * <p>Address: 4207 BOULDER RIDGE RD, BISMARCK, ND 58503</p>
 * <p>Phone: (877) 319-6044 | Fax: (833) 950-3545</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nd/bismarck/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10121; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nd/bismarck";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nd/bismarck_audio", "ssa.nd.bismarck.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nd/bismarck_data", "ssa.nd.bismarck.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nd/bismarck_graphics", "ssa.nd.bismarck.graphics.spectrum", sb.toString());
        }
    }
}