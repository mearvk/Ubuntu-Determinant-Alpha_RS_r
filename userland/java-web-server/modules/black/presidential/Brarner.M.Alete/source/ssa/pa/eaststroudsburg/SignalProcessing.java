package presidential.Brarner.M.Alete.source.ssa.pa.eaststroudsburg;
...
/**
 * Signal Processing for SSA Office: EAST STROUDSBURG PA
 * <p>Office Code: A97</p>
 * <p>Address: 9090 FRANKLIN HILL RD, EAST STROUDSBURG, PA 18301</p>
 * <p>Phone: (888) 835-6169 | Fax: (833) 950-2582</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/eaststroudsburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9270; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/eaststroudsburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/eaststroudsburg_audio", "ssa.pa.eaststroudsburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/eaststroudsburg_data", "ssa.pa.eaststroudsburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/eaststroudsburg_graphics", "ssa.pa.eaststroudsburg.graphics.spectrum", sb.toString());
        }
    }
}