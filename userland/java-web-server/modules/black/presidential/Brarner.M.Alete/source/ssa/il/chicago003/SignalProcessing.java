package presidential.Brarner.M.Alete.source.ssa.il.chicago003;
...
/**
 * Signal Processing for SSA Office: CHICAGO-EAST IL
 * <p>Office Code: 497</p>
 * <p>Address: 6338 S COTTAGE GROVE AVE, CHICAGO, IL 60637</p>
 * <p>Phone: (877) 402-0824 | Fax: (833) 950-2802</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/chicago003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9932; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/chicago003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago003_audio", "ssa.il.chicago003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago003_data", "ssa.il.chicago003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago003_graphics", "ssa.il.chicago003.graphics.spectrum", sb.toString());
        }
    }
}