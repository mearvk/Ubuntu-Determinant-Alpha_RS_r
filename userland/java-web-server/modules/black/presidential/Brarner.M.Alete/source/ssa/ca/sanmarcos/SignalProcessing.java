package presidential.Brarner.M.Alete.source.ssa.ca.sanmarcos;
...
/**
 * Signal Processing for SSA Office: SAN MARCOS CA
 * <p>Office Code: 931</p>
 * <p>Address: 367 VIA VERA CRUZ, SAN MARCOS, CA 92078</p>
 * <p>Phone: (866) 614-4769 | Fax: (833) 950-3691</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sanmarcos/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10314; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sanmarcos";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanmarcos_audio", "ssa.ca.sanmarcos.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanmarcos_data", "ssa.ca.sanmarcos.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanmarcos_graphics", "ssa.ca.sanmarcos.graphics.spectrum", sb.toString());
        }
    }
}