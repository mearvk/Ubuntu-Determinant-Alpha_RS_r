package presidential.Brarner.M.Alete.source.ssa.wa.collegeplace;
...
/**
 * Signal Processing for SSA Office: WALLA WALLA WA
 * <p>Office Code: 925</p>
 * <p>Address: 880 NE ROSE ST, COLLEGE PLACE, WA 99324</p>
 * <p>Phone: (866) 366-7814 | Fax: (833) 950-2622</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/collegeplace/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10308; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/collegeplace";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/collegeplace_audio", "ssa.wa.collegeplace.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/collegeplace_data", "ssa.wa.collegeplace.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/collegeplace_graphics", "ssa.wa.collegeplace.graphics.spectrum", sb.toString());
        }
    }
}