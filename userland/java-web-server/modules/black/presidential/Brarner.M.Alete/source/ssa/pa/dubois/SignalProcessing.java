package presidential.Brarner.M.Alete.source.ssa.pa.dubois;
...
/**
 * Signal Processing for SSA Office: DU BOIS PA
 * <p>Office Code: 228</p>
 * <p>Address: 302 LIBERTY BLVD, DUBOIS, PA 15801</p>
 * <p>Phone: (888) 491-1884 | Fax: (833) 461-0038</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/dubois/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9685; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/dubois";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/dubois_audio", "ssa.pa.dubois.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/dubois_data", "ssa.pa.dubois.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/dubois_graphics", "ssa.pa.dubois.graphics.spectrum", sb.toString());
        }
    }
}