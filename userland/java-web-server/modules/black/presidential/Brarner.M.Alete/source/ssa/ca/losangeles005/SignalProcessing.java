package presidential.Brarner.M.Alete.source.ssa.ca.losangeles005;
...
/**
 * Signal Processing for SSA Office: BOYLE HEIGHTS CA
 * <p>Office Code: 904</p>
 * <p>Address: 215 N SOTO STREET, LOS ANGELES, CA 90033</p>
 * <p>Phone: (866) 964-2035 | Fax: (833) 950-3389</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/losangeles005/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10288; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/losangeles005";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles005_audio", "ssa.ca.losangeles005.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles005_data", "ssa.ca.losangeles005.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles005_graphics", "ssa.ca.losangeles005.graphics.spectrum", sb.toString());
        }
    }
}