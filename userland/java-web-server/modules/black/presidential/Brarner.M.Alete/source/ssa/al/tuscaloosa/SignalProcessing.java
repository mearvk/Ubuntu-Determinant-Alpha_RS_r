package presidential.Brarner.M.Alete.source.ssa.al.tuscaloosa;
...
/**
 * Signal Processing for SSA Office: TUSCALOOSA AL
 * <p>Office Code: 629</p>
 * <p>Address: 2005 UNIVERSITY BLVD, SUITE 1200, TUSCALOOSA, AL 35401</p>
 * <p>Phone: (877) 480-4988 | Fax: (833) 950-3497</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/tuscaloosa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10052; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/tuscaloosa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/tuscaloosa_audio", "ssa.al.tuscaloosa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/tuscaloosa_data", "ssa.al.tuscaloosa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/tuscaloosa_graphics", "ssa.al.tuscaloosa.graphics.spectrum", sb.toString());
        }
    }
}