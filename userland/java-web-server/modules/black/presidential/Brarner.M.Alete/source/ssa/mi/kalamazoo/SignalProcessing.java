package presidential.Brarner.M.Alete.source.ssa.mi.kalamazoo;
...
/**
 * Signal Processing for SSA Office: KALAMAZOO MI
 * <p>Office Code: 353</p>
 * <p>Address: 317 SOUTH DRAKE ROAD, KALAMAZOO, MI 49009</p>
 * <p>Phone: (866) 331-9088 | Fax: (833) 950-2128</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/kalamazoo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9800; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/kalamazoo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/kalamazoo_audio", "ssa.mi.kalamazoo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/kalamazoo_data", "ssa.mi.kalamazoo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/kalamazoo_graphics", "ssa.mi.kalamazoo.graphics.spectrum", sb.toString());
        }
    }
}