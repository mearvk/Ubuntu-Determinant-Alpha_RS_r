package presidential.Brarner.M.Alete.source.ssa.ct.middletown;
...
/**
 * Signal Processing for SSA Office: MIDDLETOWN CT
 * <p>Office Code: C64</p>
 * <p>Address: SUITE 800, MIDDLETOWN, CT 6457</p>
 * <p>Phone: (877) 692-3145 | Fax: (833) 950-3256</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ct/middletown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9375; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ct/middletown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ct/middletown_audio", "ssa.ct.middletown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ct/middletown_data", "ssa.ct.middletown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ct/middletown_graphics", "ssa.ct.middletown.graphics.spectrum", sb.toString());
        }
    }
}