...
/**
 * Signal Processing for SSA Office: HAZARD KY
 * <p>Office Code: 446</p>
 * <p>Address: 122 REYNOLDS LANE, HAZARD, KY 41701</p>
 * <p>Phone: (877) 405-0491 | Fax: (833) 950-3483</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/hazard/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9883; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/hazard";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/hazard_audio", "ssa.ky.hazard.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/hazard_data", "ssa.ky.hazard.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/hazard_graphics", "ssa.ky.hazard.graphics.spectrum", sb.toString());
        }
    }
}