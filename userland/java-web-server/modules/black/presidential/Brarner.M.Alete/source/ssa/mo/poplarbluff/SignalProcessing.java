...
/**
 * Signal Processing for SSA Office: POPLAR BLUFF MO
 * <p>Office Code: 749</p>
 * <p>Address: 66 HIGHWAY 142, POPLAR BLUFF, MO 63901</p>
 * <p>Phone: (855) 722-3498 | Fax: (833) 926-1835</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/poplarbluff/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10148; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/poplarbluff";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/poplarbluff_audio", "ssa.mo.poplarbluff.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/poplarbluff_data", "ssa.mo.poplarbluff.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/poplarbluff_graphics", "ssa.mo.poplarbluff.graphics.spectrum", sb.toString());
        }
    }
}