...
/**
 * Signal Processing for SSA Office: FOSU West - Branch 5
 * <p>Office Code: 51P</p>
 * <p>Address: 601 E 12TH ST, KANSAS CITY, MO 64106</p>
 * <p>Phone: (877) 685-5942 | Fax: (833) 551-0604</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/kansascity008/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10381; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/kansascity008";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity008_audio", "ssa.mo.kansascity008.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity008_data", "ssa.mo.kansascity008.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity008_graphics", "ssa.mo.kansascity008.graphics.spectrum", sb.toString());
        }
    }
}