package presidential.Brarner.M.Alete.source.ssa.ar.westmemphis;
...
/**
 * Signal Processing for SSA Office: WEST MEMPHIS AR
 * <p>Office Code: 704</p>
 * <p>Address: 202 SHOPPINGWAY BLVD, WEST MEMPHIS, AR 72301</p>
 * <p>Phone: (866) 627-6994 | Fax: (833) 950-2692</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/westmemphis/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10117; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/westmemphis";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/westmemphis_audio", "ssa.ar.westmemphis.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/westmemphis_data", "ssa.ar.westmemphis.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/westmemphis_graphics", "ssa.ar.westmemphis.graphics.spectrum", sb.toString());
        }
    }
}