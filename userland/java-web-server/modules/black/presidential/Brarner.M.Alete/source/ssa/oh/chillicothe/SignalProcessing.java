package presidential.Brarner.M.Alete.source.ssa.oh.chillicothe;
...
/**
 * Signal Processing for SSA Office: CHILLICOTHE OH
 * <p>Office Code: 410</p>
 * <p>Address: 44 STONERIDGE DRIVE, CHILLICOTHE, OH 45601</p>
 * <p>Phone: (877) 452-6971 | Fax: (833) 873-4343</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/chillicothe/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9851; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/chillicothe";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/chillicothe_audio", "ssa.oh.chillicothe.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/chillicothe_data", "ssa.oh.chillicothe.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/chillicothe_graphics", "ssa.oh.chillicothe.graphics.spectrum", sb.toString());
        }
    }
}