package presidential.Brarner.M.Alete.source.ssa.nj.trenton;
...
/**
 * Signal Processing for SSA Office: TRENTON NJ
 * <p>Office Code: 171</p>
 * <p>Address: 635 S CLINTON AVE, TRENTON, NJ 8611</p>
 * <p>Phone: (866) 964-0026 | Fax: (833) 950-2972</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/trenton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9632; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/trenton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/trenton_audio", "ssa.nj.trenton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/trenton_data", "ssa.nj.trenton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/trenton_graphics", "ssa.nj.trenton.graphics.spectrum", sb.toString());
        }
    }
}