...
/**
 * Signal Processing for SSA Office: HUMACAO PR
 * <p>Office Code: A30</p>
 * <p>Address: 260 BOULEVARD DEL RIO, HUMACAO, PR 791</p>
 * <p>Phone: (866) 604-3335 | Fax: (833) 950-2956</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pr/humacao/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9218; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pr/humacao";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pr/humacao_audio", "ssa.pr.humacao.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pr/humacao_data", "ssa.pr.humacao.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pr/humacao_graphics", "ssa.pr.humacao.graphics.spectrum", sb.toString());
        }
    }
}