package presidential.Brarner.M.Alete.source.ssa.tx.palestine;
...
/**
 * Signal Processing for SSA Office: PALESTINE TX
 * <p>Office Code: 846</p>
 * <p>Address: 215 MEDICAL DRIVE, PALESTINE, TX 75801</p>
 * <p>Phone: (866) 495-0089 | Fax: (833) 950-2408</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/palestine/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10237; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/palestine";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/palestine_audio", "ssa.tx.palestine.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/palestine_data", "ssa.tx.palestine.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/palestine_graphics", "ssa.tx.palestine.graphics.spectrum", sb.toString());
        }
    }
}