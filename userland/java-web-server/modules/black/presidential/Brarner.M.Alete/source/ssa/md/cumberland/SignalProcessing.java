package presidential.Brarner.M.Alete.source.ssa.md.cumberland;
...
/**
 * Signal Processing for SSA Office: CUMBERLAND MD
 * <p>Office Code: 275</p>
 * <p>Address: 217 GLENN ST, CUMBERLAND, MD 21502</p>
 * <p>Phone: (866) 964-7409 | Fax: (833) 597-0147</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/cumberland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9725; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/cumberland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/cumberland_audio", "ssa.md.cumberland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/cumberland_data", "ssa.md.cumberland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/cumberland_graphics", "ssa.md.cumberland.graphics.spectrum", sb.toString());
        }
    }
}