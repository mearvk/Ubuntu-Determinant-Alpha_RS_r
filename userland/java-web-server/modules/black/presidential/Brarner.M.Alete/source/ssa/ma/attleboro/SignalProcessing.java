package presidential.Brarner.M.Alete.source.ssa.ma.attleboro;
...
/**
 * Signal Processing for SSA Office: ATTLEBORO MA
 * <p>Office Code: 49</p>
 * <p>Address: 106 PLEASANT ST, ATTLEBORO, MA 2703</p>
 * <p>Phone: (888) 655-6469 | Fax: (833) 926-1854</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/attleboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9531; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/attleboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/attleboro_audio", "ssa.ma.attleboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/attleboro_data", "ssa.ma.attleboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/attleboro_graphics", "ssa.ma.attleboro.graphics.spectrum", sb.toString());
        }
    }
}