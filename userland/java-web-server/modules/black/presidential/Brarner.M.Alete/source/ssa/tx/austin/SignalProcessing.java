package presidential.Brarner.M.Alete.source.ssa.tx.austin;
...
/**
 * Signal Processing for SSA Office: AUSTIN SOUTH TX
 * <p>Office Code: 00Y</p>
 * <p>Address: 5508 US-290 W, AUSTIN, TX 78735</p>
 * <p>Phone: (855) 221-3523 | Fax: (833) 950-2398</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/austin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9489; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/austin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/austin_audio", "ssa.tx.austin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/austin_data", "ssa.tx.austin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/austin_graphics", "ssa.tx.austin.graphics.spectrum", sb.toString());
        }
    }
}