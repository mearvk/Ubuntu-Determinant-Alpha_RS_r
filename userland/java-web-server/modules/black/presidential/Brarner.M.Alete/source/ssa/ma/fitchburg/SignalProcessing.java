package presidential.Brarner.M.Alete.source.ssa.ma.fitchburg;
...
/**
 * Signal Processing for SSA Office: FITCHBURG MA
 * <p>Office Code: 40</p>
 * <p>Address: 881 MAIN ST 1ST FLOOR, FITCHBURG, MA 1420</p>
 * <p>Phone: (877) 319-0728 | Fax: (833) 902-2520</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/fitchburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9523; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/fitchburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/fitchburg_audio", "ssa.ma.fitchburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/fitchburg_data", "ssa.ma.fitchburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/fitchburg_graphics", "ssa.ma.fitchburg.graphics.spectrum", sb.toString());
        }
    }
}