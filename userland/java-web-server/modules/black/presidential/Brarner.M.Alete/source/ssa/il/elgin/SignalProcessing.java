package presidential.Brarner.M.Alete.source.ssa.il.elgin;
...
/**
 * Signal Processing for SSA Office: ELGIN IL
 * <p>Office Code: 515</p>
 * <p>Address: 790 FLETCHER DR, ELGIN, IL 60123</p>
 * <p>Phone: (877) 405-0435 | Fax: (833) 950-3437</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/elgin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9949; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/elgin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/elgin_audio", "ssa.il.elgin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/elgin_data", "ssa.il.elgin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/elgin_graphics", "ssa.il.elgin.graphics.spectrum", sb.toString());
        }
    }
}