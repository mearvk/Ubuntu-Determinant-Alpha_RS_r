package presidential.Brarner.M.Alete.source.ssa.hi.kapolei;
...
/**
 * Signal Processing for SSA Office: KAPOLEI HI
 * <p>Office Code: 167</p>
 * <p>Address: 970 MANAWAI STREET, KAPOLEI, HI 96707</p>
 * <p>Phone: (855) 572-4866 | Fax: (833) 950-2742</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/hi/kapolei/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9629; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/hi/kapolei";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_hi/kapolei_audio", "ssa.hi.kapolei.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_hi/kapolei_data", "ssa.hi.kapolei.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_hi/kapolei_graphics", "ssa.hi.kapolei.graphics.spectrum", sb.toString());
        }
    }
}