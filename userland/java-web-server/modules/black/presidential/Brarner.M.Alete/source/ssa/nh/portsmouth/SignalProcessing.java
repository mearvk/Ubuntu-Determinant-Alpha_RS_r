package presidential.Brarner.M.Alete.source.ssa.nh.portsmouth;
...
/**
 * Signal Processing for SSA Office: PORTSMOUTH NH
 * <p>Office Code: 11</p>
 * <p>Address: 215 COMMERCE WAY, PORTSMOUTH, NH 3801</p>
 * <p>Phone: (888) 397-9796 | Fax: (833) 950-3589</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nh/portsmouth/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9499; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nh/portsmouth";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nh/portsmouth_audio", "ssa.nh.portsmouth.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nh/portsmouth_data", "ssa.nh.portsmouth.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nh/portsmouth_graphics", "ssa.nh.portsmouth.graphics.spectrum", sb.toString());
        }
    }
}