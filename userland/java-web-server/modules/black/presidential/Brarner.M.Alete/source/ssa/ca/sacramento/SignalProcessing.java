package presidential.Brarner.M.Alete.source.ssa.ca.sacramento;
...
/**
 * Signal Processing for SSA Office: NORTH SACRAMENTO DISTRICT OFFICE
 * <p>Office Code: E28</p>
 * <p>Address: 2424 ARDEN WAY, SACRAMENTO, CA 95825</p>
 * <p>Phone: (855) 782-9153 | Fax: (833) 940-1983</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sacramento/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9460; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sacramento";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sacramento_audio", "ssa.ca.sacramento.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sacramento_data", "ssa.ca.sacramento.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sacramento_graphics", "ssa.ca.sacramento.graphics.spectrum", sb.toString());
        }
    }
}