package presidential.Brarner.M.Alete.source.ssa.va.charlottesville;
...
/**
 * Signal Processing for SSA Office: CHARLOTTESVILLE
 * <p>Office Code: 297</p>
 * <p>Address: 1470 PANTOPS MOUNTAIN PL, CHARLOTTESVILLE, VA 22911</p>
 * <p>Phone: (866) 613-3959 | Fax: (833) 950-2300</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/charlottesville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9747; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/charlottesville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/charlottesville_audio", "ssa.va.charlottesville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/charlottesville_data", "ssa.va.charlottesville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/charlottesville_graphics", "ssa.va.charlottesville.graphics.spectrum", sb.toString());
        }
    }
}