package presidential.Brarner.M.Alete.source.ssa.tx.eaglepass;
...
/**
 * Signal Processing for SSA Office: EAGLE PASS TX
 * <p>Office Code: 844</p>
 * <p>Address: 406 SOUTH TEXAS DR, EAGLE PASS, TX 78852</p>
 * <p>Phone: (888) 862-4864 | Fax: (833) 950-2404</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/eaglepass/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10235; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/eaglepass";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/eaglepass_audio", "ssa.tx.eaglepass.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/eaglepass_data", "ssa.tx.eaglepass.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/eaglepass_graphics", "ssa.tx.eaglepass.graphics.spectrum", sb.toString());
        }
    }
}