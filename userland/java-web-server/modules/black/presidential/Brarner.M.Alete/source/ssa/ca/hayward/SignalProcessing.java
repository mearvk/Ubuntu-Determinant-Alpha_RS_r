package presidential.Brarner.M.Alete.source.ssa.ca.hayward;
...
/**
 * Signal Processing for SSA Office: HAYWARD CA
 * <p>Office Code: 66</p>
 * <p>Address: 24301 SOUTHLAND DR, HAYWARD, CA 94545</p>
 * <p>Phone: (866) 964-5054 | Fax: (833) 950-2734</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/hayward/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9545; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/hayward";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/hayward_audio", "ssa.ca.hayward.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/hayward_data", "ssa.ca.hayward.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/hayward_graphics", "ssa.ca.hayward.graphics.spectrum", sb.toString());
        }
    }
}