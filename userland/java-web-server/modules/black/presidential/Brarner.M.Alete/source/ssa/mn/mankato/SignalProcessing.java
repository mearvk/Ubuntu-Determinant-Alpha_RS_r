package presidential.Brarner.M.Alete.source.ssa.mn.mankato;
...
/**
 * Signal Processing for SSA Office: MANKATO MN
 * <p>Office Code: 678</p>
 * <p>Address: 12 CIVIC CNTR PLAZA, MANKATO, MN 56001</p>
 * <p>Phone: (877) 457-1734 | Fax: (833) 902-2694</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/mankato/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10093; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/mankato";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/mankato_audio", "ssa.mn.mankato.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/mankato_data", "ssa.mn.mankato.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/mankato_graphics", "ssa.mn.mankato.graphics.spectrum", sb.toString());
        }
    }
}