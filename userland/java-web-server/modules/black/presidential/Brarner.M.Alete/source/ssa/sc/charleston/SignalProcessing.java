package presidential.Brarner.M.Alete.source.ssa.sc.charleston;
...
/**
 * Signal Processing for SSA Office: CHARLESTON SC
 * <p>Office Code: 585</p>
 * <p>Address: 1463 TOBIAS GADSON BLVD, CHARLESTON, SC 29407</p>
 * <p>Phone: (866) 495-0111 | Fax: (833) 950-2229</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/charleston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10009; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/charleston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/charleston_audio", "ssa.sc.charleston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/charleston_data", "ssa.sc.charleston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/charleston_graphics", "ssa.sc.charleston.graphics.spectrum", sb.toString());
        }
    }
}