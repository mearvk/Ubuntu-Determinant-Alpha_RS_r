package presidential.Brarner.M.Alete.source.ssa.tn.paris;
...
/**
 * Signal Processing for SSA Office: PARIS TN
 * <p>Office Code: 582</p>
 * <p>Address: 186 COMMERCE ST, PARIS, TN 38242</p>
 * <p>Phone: (866) 698-2507 | Fax: (833) 912-2286</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/paris/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10006; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/paris";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/paris_audio", "ssa.tn.paris.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/paris_data", "ssa.tn.paris.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/paris_graphics", "ssa.tn.paris.graphics.spectrum", sb.toString());
        }
    }
}