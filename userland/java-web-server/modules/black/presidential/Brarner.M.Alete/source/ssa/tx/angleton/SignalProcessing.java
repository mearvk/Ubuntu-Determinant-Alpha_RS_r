package presidential.Brarner.M.Alete.source.ssa.tx.angleton;
...
/**
 * Signal Processing for SSA Office: ANGLETON TX
 * <p>Office Code: A72</p>
 * <p>Address: 2921 N VALDERAS ST, ANGLETON, TX 77515</p>
 * <p>Phone: (866) 338-2940 | Fax: (833) 902-2570</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/angleton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9253; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/angleton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/angleton_audio", "ssa.tx.angleton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/angleton_data", "ssa.tx.angleton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/angleton_graphics", "ssa.tx.angleton.graphics.spectrum", sb.toString());
        }
    }
}