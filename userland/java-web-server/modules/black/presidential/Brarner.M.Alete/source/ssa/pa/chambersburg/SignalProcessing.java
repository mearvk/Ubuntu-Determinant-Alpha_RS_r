package presidential.Brarner.M.Alete.source.ssa.pa.chambersburg;
...
/**
 * Signal Processing for SSA Office: CHAMBERSBURG PA
 * <p>Office Code: 235</p>
 * <p>Address: 50 N THIRD STREET, CHAMBERSBURG, PA 17201</p>
 * <p>Phone: (866) 656-5367 | Fax: (833) 515-0403</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/chambersburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9692; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/chambersburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chambersburg_audio", "ssa.pa.chambersburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chambersburg_data", "ssa.pa.chambersburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chambersburg_graphics", "ssa.pa.chambersburg.graphics.spectrum", sb.toString());
        }
    }
}