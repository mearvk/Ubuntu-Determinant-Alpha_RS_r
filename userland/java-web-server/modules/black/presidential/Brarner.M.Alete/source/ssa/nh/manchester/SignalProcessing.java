...
/**
 * Signal Processing for SSA Office: MANCHESTER NH
 * <p>Office Code: 12</p>
 * <p>Address: 1100 ELM ST, MANCHESTER, NH 3101</p>
 * <p>Phone: (866) 814-5408 | Fax: (833) 950-3591</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nh/manchester/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9500; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nh/manchester";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nh/manchester_audio", "ssa.nh.manchester.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nh/manchester_data", "ssa.nh.manchester.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nh/manchester_graphics", "ssa.nh.manchester.graphics.spectrum", sb.toString());
        }
    }
}