...
/**
 * Signal Processing for SSA Office: ST GEORGE UT
 * <p>Office Code: A07</p>
 * <p>Address: 1091 NORTH BLUFF ST, SAINT GEORGE, UT 84770</p>
 * <p>Phone: (866) 446-7085 | Fax: (833) 950-2894</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ut/saintgeorge/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9204; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ut/saintgeorge";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ut/saintgeorge_audio", "ssa.ut.saintgeorge.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ut/saintgeorge_data", "ssa.ut.saintgeorge.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ut/saintgeorge_graphics", "ssa.ut.saintgeorge.graphics.spectrum", sb.toString());
        }
    }
}