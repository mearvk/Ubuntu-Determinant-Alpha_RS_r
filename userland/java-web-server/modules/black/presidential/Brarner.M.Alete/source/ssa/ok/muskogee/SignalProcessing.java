package presidential.Brarner.M.Alete.source.ssa.ok.muskogee;
...
/**
 * Signal Processing for SSA Office: MUSKOGEE OK
 * <p>Office Code: 787</p>
 * <p>Address: 2401 W. SHAWNEE STREET, MUSKOGEE, OK 74401</p>
 * <p>Phone: (877) 575-5195 | Fax: (833) 950-3013</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/muskogee/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10182; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/muskogee";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/muskogee_audio", "ssa.ok.muskogee.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/muskogee_data", "ssa.ok.muskogee.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/muskogee_graphics", "ssa.ok.muskogee.graphics.spectrum", sb.toString());
        }
    }
}