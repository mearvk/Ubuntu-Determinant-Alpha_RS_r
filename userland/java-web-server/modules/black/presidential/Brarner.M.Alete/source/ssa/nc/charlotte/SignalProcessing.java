package presidential.Brarner.M.Alete.source.ssa.nc.charlotte;
...
/**
 * Signal Processing for SSA Office: CHARLOTTE NC
 * <p>Office Code: 320</p>
 * <p>Address: 2201 CORONATION BLVD., CHARLOTTE, NC 28227</p>
 * <p>Phone: (888) 383-1598 | Fax: (833) 950-2536</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/charlotte/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9769; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/charlotte";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/charlotte_audio", "ssa.nc.charlotte.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/charlotte_data", "ssa.nc.charlotte.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/charlotte_graphics", "ssa.nc.charlotte.graphics.spectrum", sb.toString());
        }
    }
}