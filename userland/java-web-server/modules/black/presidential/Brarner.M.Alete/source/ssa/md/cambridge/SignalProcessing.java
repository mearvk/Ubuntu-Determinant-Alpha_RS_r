...
/**
 * Signal Processing for SSA Office: CAMBRIDGE MD
 * <p>Office Code: 95</p>
 * <p>Address: 309 SUNBURST HWY, CAMBRIDGE, MD 21613</p>
 * <p>Phone: (888) 347-9277 | Fax: (833) 371-0604</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/cambridge/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9566; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/cambridge";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/cambridge_audio", "ssa.md.cambridge.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/cambridge_data", "ssa.md.cambridge.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/cambridge_graphics", "ssa.md.cambridge.graphics.spectrum", sb.toString());
        }
    }
}