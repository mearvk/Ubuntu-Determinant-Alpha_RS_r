package presidential.Brarner.M.Alete.source.ssa.ri.woonsocket;
...
/**
 * Signal Processing for SSA Office: WOONSOCKET RI
 * <p>Office Code: 73</p>
 * <p>Address: 2168 DIAMOND HILL ROAD, WOONSOCKET, RI 2895</p>
 * <p>Phone: (877) 229-3542 | Fax: (833) 950-2348</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ri/woonsocket/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9549; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ri/woonsocket";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ri/woonsocket_audio", "ssa.ri.woonsocket.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ri/woonsocket_data", "ssa.ri.woonsocket.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ri/woonsocket_graphics", "ssa.ri.woonsocket.graphics.spectrum", sb.toString());
        }
    }
}