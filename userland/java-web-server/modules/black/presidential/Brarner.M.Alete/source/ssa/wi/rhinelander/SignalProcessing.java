package presidential.Brarner.M.Alete.source.ssa.wi.rhinelander;
...
/**
 * Signal Processing for SSA Office: RHINELANDER WI
 * <p>Office Code: 878</p>
 * <p>Address: 2023 NAVAJO ST, RHINELANDER, WI 54501</p>
 * <p>Phone: (888) 868-8185 | Fax: (833) 950-2186</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/rhinelander/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10265; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/rhinelander";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/rhinelander_audio", "ssa.wi.rhinelander.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/rhinelander_data", "ssa.wi.rhinelander.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/rhinelander_graphics", "ssa.wi.rhinelander.graphics.spectrum", sb.toString());
        }
    }
}