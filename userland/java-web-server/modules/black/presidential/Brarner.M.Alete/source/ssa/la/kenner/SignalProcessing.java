...
/**
 * Signal Processing for SSA Office: KENNER LA
 * <p>Office Code: A71</p>
 * <p>Address: 1616 JOE YENNI BLVD, KENNER, LA 70065</p>
 * <p>Phone: (888) 850-2232 | Fax: (833) 902-2568</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/kenner/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9252; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/kenner";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/kenner_audio", "ssa.la.kenner.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/kenner_data", "ssa.la.kenner.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/kenner_graphics", "ssa.la.kenner.graphics.spectrum", sb.toString());
        }
    }
}