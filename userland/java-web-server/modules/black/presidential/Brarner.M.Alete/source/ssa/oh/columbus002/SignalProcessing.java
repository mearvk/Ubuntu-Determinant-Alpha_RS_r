package presidential.Brarner.M.Alete.source.ssa.oh.columbus002;
...
/**
 * Signal Processing for SSA Office: COLUMBUS WEST
 * <p>Office Code: E65</p>
 * <p>Address: 1060 GEORGESVILLE ROAD, COLUMBUS, OH 43228</p>
 * <p>Phone: (866) 656-0178 | Fax: (833) 902-2650</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/columbus002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9473; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/columbus002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/columbus002_audio", "ssa.oh.columbus002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/columbus002_data", "ssa.oh.columbus002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/columbus002_graphics", "ssa.oh.columbus002.graphics.spectrum", sb.toString());
        }
    }
}