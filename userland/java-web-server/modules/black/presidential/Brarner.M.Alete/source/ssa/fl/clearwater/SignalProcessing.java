package presidential.Brarner.M.Alete.source.ssa.fl.clearwater;
...
/**
 * Signal Processing for SSA Office: CLEARWATER FL
 * <p>Office Code: 257</p>
 * <p>Address: 2340 DREW STREET, CLEARWATER, FL 33765</p>
 * <p>Phone: (888) 397-5325 | Fax: (833) 950-2204</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/clearwater/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9711; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/clearwater";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/clearwater_audio", "ssa.fl.clearwater.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/clearwater_data", "ssa.fl.clearwater.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/clearwater_graphics", "ssa.fl.clearwater.graphics.spectrum", sb.toString());
        }
    }
}