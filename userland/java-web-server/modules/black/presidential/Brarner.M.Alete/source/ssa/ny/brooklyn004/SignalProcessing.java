package presidential.Brarner.M.Alete.source.ssa.ny.brooklyn004;
...
/**
 * Signal Processing for SSA Office: BROOKLYN BUSHWICK NY
 * <p>Office Code: 135</p>
 * <p>Address: 785 FLUSHING AVE, BROOKLYN, NY 11206</p>
 * <p>Phone: (888) 327-1276 | Fax: (833) 926-2693</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/brooklyn004/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9604; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/brooklyn004";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn004_audio", "ssa.ny.brooklyn004.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn004_data", "ssa.ny.brooklyn004.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn004_graphics", "ssa.ny.brooklyn004.graphics.spectrum", sb.toString());
        }
    }
}