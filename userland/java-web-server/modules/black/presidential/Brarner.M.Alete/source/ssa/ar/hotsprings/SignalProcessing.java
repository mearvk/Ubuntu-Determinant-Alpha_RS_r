package presidential.Brarner.M.Alete.source.ssa.ar.hotsprings;
...
/**
 * Signal Processing for SSA Office: HOT SPRINGS AR
 * <p>Office Code: 760</p>
 * <p>Address: 112 CORPORATE TERRACE, HOT SPRINGS, AR 71913</p>
 * <p>Phone: (855) 531-1685 | Fax: (833) 950-2706</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/hotsprings/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10158; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/hotsprings";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/hotsprings_audio", "ssa.ar.hotsprings.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/hotsprings_data", "ssa.ar.hotsprings.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/hotsprings_graphics", "ssa.ar.hotsprings.graphics.spectrum", sb.toString());
        }
    }
}