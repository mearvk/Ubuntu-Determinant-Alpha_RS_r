package presidential.Brarner.M.Alete.source.ssa.wa.bellevue;
...
/**
 * Signal Processing for SSA Office: BELLEVUE WA
 * <p>Office Code: 190</p>
 * <p>Address: 636 120TH AVE NE, BELLEVUE, WA 98005</p>
 * <p>Phone: (866) 574-2323 | Fax: (833) 912-2340</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/bellevue/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9649; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/bellevue";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/bellevue_audio", "ssa.wa.bellevue.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/bellevue_data", "ssa.wa.bellevue.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/bellevue_graphics", "ssa.wa.bellevue.graphics.spectrum", sb.toString());
        }
    }
}