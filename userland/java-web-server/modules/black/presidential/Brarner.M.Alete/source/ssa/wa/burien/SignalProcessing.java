package presidential.Brarner.M.Alete.source.ssa.wa.burien;
...
/**
 * Signal Processing for SSA Office: BURIEN WA
 * <p>Office Code: C63</p>
 * <p>Address: 151 SW 156TH ST, BURIEN, WA 98166</p>
 * <p>Phone: (866) 964-7380 | Fax: (833) 950-3236</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/burien/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9374; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/burien";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/burien_audio", "ssa.wa.burien.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/burien_data", "ssa.wa.burien.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/burien_graphics", "ssa.wa.burien.graphics.spectrum", sb.toString());
        }
    }
}