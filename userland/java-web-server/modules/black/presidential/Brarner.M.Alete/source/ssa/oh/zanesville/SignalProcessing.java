package presidential.Brarner.M.Alete.source.ssa.oh.zanesville;
...
/**
 * Signal Processing for SSA Office: ZANESVILLE OH
 * <p>Office Code: 396</p>
 * <p>Address: 3823 JAMES COURT, ZANESVILLE, OH 43701</p>
 * <p>Phone: (855) 884-3408 | Fax: (833) 950-3093</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/zanesville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9837; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/zanesville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/zanesville_audio", "ssa.oh.zanesville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/zanesville_data", "ssa.oh.zanesville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/zanesville_graphics", "ssa.oh.zanesville.graphics.spectrum", sb.toString());
        }
    }
}