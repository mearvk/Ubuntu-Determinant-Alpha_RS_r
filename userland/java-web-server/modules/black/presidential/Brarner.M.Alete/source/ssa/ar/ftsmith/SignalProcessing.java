...
/**
 * Signal Processing for SSA Office: FORT SMITH AR
 * <p>Office Code: 756</p>
 * <p>Address: 6801 DALLAS STREET, FT SMITH, AR 72903</p>
 * <p>Phone: (866) 931-8374 | Fax: (833) 950-2698</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/ftsmith/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10154; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/ftsmith";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/ftsmith_audio", "ssa.ar.ftsmith.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/ftsmith_data", "ssa.ar.ftsmith.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/ftsmith_graphics", "ssa.ar.ftsmith.graphics.spectrum", sb.toString());
        }
    }
}