...
/**
 * Signal Processing for SSA Office: CHICAGO SW SUBU
 * <p>Office Code: A58</p>
 * <p>Address: 10718 S ROBERTS RD, PALOS HILLS, IL 60465</p>
 * <p>Phone: (877) 405-4568 | Fax: (833) 950-3059</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/paloshills/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9240; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/paloshills";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/paloshills_audio", "ssa.il.paloshills.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/paloshills_data", "ssa.il.paloshills.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/paloshills_graphics", "ssa.il.paloshills.graphics.spectrum", sb.toString());
        }
    }
}