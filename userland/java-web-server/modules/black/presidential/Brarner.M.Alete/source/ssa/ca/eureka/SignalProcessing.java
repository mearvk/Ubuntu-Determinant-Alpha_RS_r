package presidential.Brarner.M.Alete.source.ssa.ca.eureka;
...
/**
 * Signal Processing for SSA Office: EUREKA CA
 * <p>Office Code: 956</p>
 * <p>Address: 3144 BROADWAY, EUREKA, CA 95501</p>
 * <p>Phone: (866) 828-1991 | Fax: (833) 902-2622</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/eureka/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10338; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/eureka";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/eureka_audio", "ssa.ca.eureka.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/eureka_data", "ssa.ca.eureka.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/eureka_graphics", "ssa.ca.eureka.graphics.spectrum", sb.toString());
        }
    }
}