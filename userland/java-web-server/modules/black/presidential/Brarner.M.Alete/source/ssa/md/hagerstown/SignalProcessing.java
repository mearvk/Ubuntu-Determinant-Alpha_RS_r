package presidential.Brarner.M.Alete.source.ssa.md.hagerstown;
...
/**
 * Signal Processing for SSA Office: HAGERSTOWN MD
 * <p>Office Code: 276</p>
 * <p>Address: 1710 UNDERPASS WAY, HAGERSTOWN, MD 21740</p>
 * <p>Phone: (866) 331-7125 | Fax: (833) 597-0149</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/hagerstown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9726; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/hagerstown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/hagerstown_audio", "ssa.md.hagerstown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/hagerstown_data", "ssa.md.hagerstown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/hagerstown_graphics", "ssa.md.hagerstown.graphics.spectrum", sb.toString());
        }
    }
}