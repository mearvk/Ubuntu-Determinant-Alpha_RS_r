package presidential.Brarner.M.Alete.source.ssa.tn.tullahoma;
...
/**
 * Signal Processing for SSA Office: TULLAHOMA TN
 * <p>Office Code: 577</p>
 * <p>Address: 717 KINGS LANE, TULLAHOMA, TN 37388</p>
 * <p>Phone: (866) 635-0647 | Fax: (833) 905-2060</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/tullahoma/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10001; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/tullahoma";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/tullahoma_audio", "ssa.tn.tullahoma.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/tullahoma_data", "ssa.tn.tullahoma.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/tullahoma_graphics", "ssa.tn.tullahoma.graphics.spectrum", sb.toString());
        }
    }
}