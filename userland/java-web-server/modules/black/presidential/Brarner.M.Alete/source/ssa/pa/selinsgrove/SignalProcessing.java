package presidential.Brarner.M.Alete.source.ssa.pa.selinsgrove;
...
/**
 * Signal Processing for SSA Office: SELINSGROVE PA
 * <p>Office Code: 233</p>
 * <p>Address: 150 SUSQ VLY MALL DR, SELINSGROVE, PA 17870</p>
 * <p>Phone: (866) 593-3796 | Fax: (833) 515-0399</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/selinsgrove/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9690; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/selinsgrove";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/selinsgrove_audio", "ssa.pa.selinsgrove.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/selinsgrove_data", "ssa.pa.selinsgrove.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/selinsgrove_graphics", "ssa.pa.selinsgrove.graphics.spectrum", sb.toString());
        }
    }
}