package presidential.Brarner.M.Alete.source.ssa.va.norfolk;
...
/**
 * Signal Processing for SSA Office: NORFOLK VA
 * <p>Office Code: 287</p>
 * <p>Address: 5850 LAKE HERBERT DR, NORFOLK, VA 23502</p>
 * <p>Phone: (866) 858-6089 | Fax: (833) 912-2330</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/norfolk/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9737; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/norfolk";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/norfolk_audio", "ssa.va.norfolk.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/norfolk_data", "ssa.va.norfolk.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/norfolk_graphics", "ssa.va.norfolk.graphics.spectrum", sb.toString());
        }
    }
}