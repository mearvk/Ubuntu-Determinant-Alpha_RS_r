package presidential.Brarner.M.Alete.source.ssa.ca.berkeley;
...
/**
 * Signal Processing for SSA Office: BERKELEY CA
 * <p>Office Code: 976</p>
 * <p>Address: 2045 ALLSTON WAY, BERKELEY, CA 94704</p>
 * <p>Phone: (877) 531-4696 | Fax: (833) 950-2448</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/berkeley/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10358; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/berkeley";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/berkeley_audio", "ssa.ca.berkeley.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/berkeley_data", "ssa.ca.berkeley.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/berkeley_graphics", "ssa.ca.berkeley.graphics.spectrum", sb.toString());
        }
    }
}