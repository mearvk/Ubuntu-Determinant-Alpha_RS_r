package presidential.Brarner.M.Alete.source.ssa.tx.sherman;
...
/**
 * Signal Processing for SSA Office: SHERMAN TX
 * <p>Office Code: 837</p>
 * <p>Address: 600 EAST PEYTON, SHERMAN, TX 75090</p>
 * <p>Phone: (877) 405-3521 | Fax: (833) 939-2029</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/sherman/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10228; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/sherman";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sherman_audio", "ssa.tx.sherman.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sherman_data", "ssa.tx.sherman.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sherman_graphics", "ssa.tx.sherman.graphics.spectrum", sb.toString());
        }
    }
}