...
/**
 * Signal Processing for SSA Office: SAN LUIS OBISPO CA
 * <p>Office Code: 986</p>
 * <p>Address: 3240 S HIGUERA ST, SAN LUIS OBISPO, CA 93401</p>
 * <p>Phone: (855) 207-4865 | Fax: (833) 950-2756</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sanluisobispo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10367; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sanluisobispo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanluisobispo_audio", "ssa.ca.sanluisobispo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanluisobispo_data", "ssa.ca.sanluisobispo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanluisobispo_graphics", "ssa.ca.sanluisobispo.graphics.spectrum", sb.toString());
        }
    }
}