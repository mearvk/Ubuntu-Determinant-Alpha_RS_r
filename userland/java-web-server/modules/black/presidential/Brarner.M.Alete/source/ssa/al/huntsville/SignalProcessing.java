package presidential.Brarner.M.Alete.source.ssa.al.huntsville;
...
/**
 * Signal Processing for SSA Office: HUNTSVILLE AL
 * <p>Office Code: 632</p>
 * <p>Address: 4970 RESEARCH DRIVE,NW, HUNTSVILLE, AL 35805</p>
 * <p>Phone: (866) 593-0665 | Fax: (833) 950-3503</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/huntsville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10055; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/huntsville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/huntsville_audio", "ssa.al.huntsville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/huntsville_data", "ssa.al.huntsville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/huntsville_graphics", "ssa.al.huntsville.graphics.spectrum", sb.toString());
        }
    }
}