package presidential.Brarner.M.Alete.source.ssa.mi.saginaw;
...
/**
 * Signal Processing for SSA Office: SAGINAW MI
 * <p>Office Code: 348</p>
 * <p>Address: 611 E. GENESEE AVE., SAGINAW, MI 48607</p>
 * <p>Phone: (877) 405-5868 | Fax: (833) 902-2662</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/saginaw/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9795; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/saginaw";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/saginaw_audio", "ssa.mi.saginaw.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/saginaw_data", "ssa.mi.saginaw.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/saginaw_graphics", "ssa.mi.saginaw.graphics.spectrum", sb.toString());
        }
    }
}