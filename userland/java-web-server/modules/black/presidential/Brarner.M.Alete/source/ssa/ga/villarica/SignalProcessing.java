package presidential.Brarner.M.Alete.source.ssa.ga.villarica;
...
/**
 * Signal Processing for SSA Office: VILLA RICA GA
 * <p>Office Code: B25</p>
 * <p>Address: 908 S CARROLL RD, VILLA RICA, GA 30180</p>
 * <p>Phone: (866) 331-2318 | Fax: (833) 950-3459</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/villarica/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9293; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/villarica";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/villarica_audio", "ssa.ga.villarica.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/villarica_data", "ssa.ga.villarica.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/villarica_graphics", "ssa.ga.villarica.graphics.spectrum", sb.toString());
        }
    }
}