package presidential.Brarner.M.Alete.source.ssa.fl.dadecity;
...
/**
 * Signal Processing for SSA Office: DADE CITY FL
 * <p>Office Code: A98</p>
 * <p>Address: 36630 ADAIR ROAD, DADE CITY, FL 33525</p>
 * <p>Phone: (866) 562-1325 | Fax: (833) 950-2816</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/dadecity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9271; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/dadecity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/dadecity_audio", "ssa.fl.dadecity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/dadecity_data", "ssa.fl.dadecity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/dadecity_graphics", "ssa.fl.dadecity.graphics.spectrum", sb.toString());
        }
    }
}