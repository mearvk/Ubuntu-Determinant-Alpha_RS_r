package presidential.Brarner.M.Alete.source.ssa.pa.philadelphia;
...
/**
 * Signal Processing for SSA Office: PHILA SOUTH PA
 * <p>Office Code: 9</p>
 * <p>Address: 3336 S BROAD STREET, PHILADELPHIA, PA 19145</p>
 * <p>Phone: (877) 575-5191 | Fax: (833) 950-2876</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/philadelphia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9497; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/philadelphia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia_audio", "ssa.pa.philadelphia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia_data", "ssa.pa.philadelphia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia_graphics", "ssa.pa.philadelphia.graphics.spectrum", sb.toString());
        }
    }
}