package presidential.Brarner.M.Alete.source.ssa.in.lafayette;
...
/**
 * Signal Processing for SSA Office: LAFAYETTE IN
 * <p>Office Code: 461</p>
 * <p>Address: 10 S. 2ND ST, LAFAYETTE, IN 47901</p>
 * <p>Phone: (888) 884-0522 | Fax: (833) 902-2678</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/lafayette/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9898; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/lafayette";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/lafayette_audio", "ssa.in.lafayette.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/lafayette_data", "ssa.in.lafayette.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/lafayette_graphics", "ssa.in.lafayette.graphics.spectrum", sb.toString());
        }
    }
}