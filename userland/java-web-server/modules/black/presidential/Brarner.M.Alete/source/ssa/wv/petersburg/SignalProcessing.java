package presidential.Brarner.M.Alete.source.ssa.wv.petersburg;
...
/**
 * Signal Processing for SSA Office: PETERSBURG WV
 * <p>Office Code: C89</p>
 * <p>Address: 111 S GROVE ST, PETERSBURG, WV 26847</p>
 * <p>Phone: (877) 405-2885 | Fax: (833) 873-4348</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/petersburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9390; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/petersburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/petersburg_audio", "ssa.wv.petersburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/petersburg_data", "ssa.wv.petersburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/petersburg_graphics", "ssa.wv.petersburg.graphics.spectrum", sb.toString());
        }
    }
}