package presidential.Brarner.M.Alete.source.ssa.wv.martinsburg;
...
/**
 * Signal Processing for SSA Office: MARTINSBURG WV
 * <p>Office Code: 316</p>
 * <p>Address: 14 COMPASS PT, MARTINSBURG, WV 25404</p>
 * <p>Phone: (866) 416-1919 | Fax: (833) 950-2572</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/martinsburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9766; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/martinsburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/martinsburg_audio", "ssa.wv.martinsburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/martinsburg_data", "ssa.wv.martinsburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/martinsburg_graphics", "ssa.wv.martinsburg.graphics.spectrum", sb.toString());
        }
    }
}