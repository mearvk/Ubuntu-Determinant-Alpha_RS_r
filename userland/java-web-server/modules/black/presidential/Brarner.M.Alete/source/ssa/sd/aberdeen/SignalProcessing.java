package presidential.Brarner.M.Alete.source.ssa.sd.aberdeen;
...
/**
 * Signal Processing for SSA Office: ABERDEEN SD
 * <p>Office Code: 716</p>
 * <p>Address: 115 4TH AVE SE, ABERDEEN, SD 57401</p>
 * <p>Phone: (855) 278-4196 | Fax: (833) 950-3549</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sd/aberdeen/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10125; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sd/aberdeen";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sd/aberdeen_audio", "ssa.sd.aberdeen.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sd/aberdeen_data", "ssa.sd.aberdeen.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sd/aberdeen_graphics", "ssa.sd.aberdeen.graphics.spectrum", sb.toString());
        }
    }
}