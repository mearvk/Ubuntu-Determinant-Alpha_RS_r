...
/**
 * Signal Processing for SSA Office: MARSHALL MN
 * <p>Office Code: 681</p>
 * <p>Address: 507 JEWETT STREET, MARSHALL, MN 56258</p>
 * <p>Phone: (855) 210-0122 | Fax: (833) 902-2700</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/marshall/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10096; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/marshall";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/marshall_audio", "ssa.mn.marshall.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/marshall_data", "ssa.mn.marshall.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/marshall_graphics", "ssa.mn.marshall.graphics.spectrum", sb.toString());
        }
    }
}