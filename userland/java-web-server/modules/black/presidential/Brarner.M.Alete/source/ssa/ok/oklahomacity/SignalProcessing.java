package presidential.Brarner.M.Alete.source.ssa.ok.oklahomacity;
...
/**
 * Signal Processing for SSA Office: OKLACITY OK
 * <p>Office Code: 783</p>
 * <p>Address: 12301 N. KELLEY AVE, OKLAHOMA CITY, OK 73131</p>
 * <p>Phone: (866) 331-2207 | Fax: (833) 950-3005</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/oklahomacity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10178; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/oklahomacity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/oklahomacity_audio", "ssa.ok.oklahomacity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/oklahomacity_data", "ssa.ok.oklahomacity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/oklahomacity_graphics", "ssa.ok.oklahomacity.graphics.spectrum", sb.toString());
        }
    }
}