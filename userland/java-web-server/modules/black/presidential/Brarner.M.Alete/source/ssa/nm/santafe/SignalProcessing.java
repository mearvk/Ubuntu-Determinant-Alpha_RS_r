package presidential.Brarner.M.Alete.source.ssa.nm.santafe;
...
/**
 * Signal Processing for SSA Office: SANTA FE NM
 * <p>Office Code: 860</p>
 * <p>Address: 1922 5TH STREET, SANTA FE, NM 87505</p>
 * <p>Phone: (866) 571-8130 | Fax: (833) 950-2722</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nm/santafe/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10248; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nm/santafe";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nm/santafe_audio", "ssa.nm.santafe.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nm/santafe_data", "ssa.nm.santafe.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nm/santafe_graphics", "ssa.nm.santafe.graphics.spectrum", sb.toString());
        }
    }
}