package presidential.Brarner.M.Alete.source.ssa.oh.cleveland003;
...
/**
 * Signal Processing for SSA Office: CLEVE BUCKEYE SHAKER
 * <p>Office Code: 427</p>
 * <p>Address: 11601 SHAKER BLVD, CLEVELAND, OH 44120</p>
 * <p>Phone: (877) 635-3546 | Fax: (833) 596-0589</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/cleveland003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9867; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/cleveland003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cleveland003_audio", "ssa.oh.cleveland003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cleveland003_data", "ssa.oh.cleveland003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cleveland003_graphics", "ssa.oh.cleveland003.graphics.spectrum", sb.toString());
        }
    }
}