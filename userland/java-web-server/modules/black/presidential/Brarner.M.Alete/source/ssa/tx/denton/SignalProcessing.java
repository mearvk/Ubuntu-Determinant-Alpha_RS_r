...
/**
 * Signal Processing for SSA Office: DENTON TX
 * <p>Office Code: A73</p>
 * <p>Address: 2201 COLORADO BLVD, DENTON, TX 76205</p>
 * <p>Phone: (888) 717-1530 | Fax: (833) 902-2571</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/denton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9254; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/denton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/denton_audio", "ssa.tx.denton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/denton_data", "ssa.tx.denton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/denton_graphics", "ssa.tx.denton.graphics.spectrum", sb.toString());
        }
    }
}