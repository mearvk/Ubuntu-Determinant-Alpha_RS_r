package presidential.Brarner.M.Alete.source.ssa.tx.kerrville;
...
/**
 * Signal Processing for SSA Office: KERRVILLE TX
 * <p>Office Code: A75</p>
 * <p>Address: 1060 GUADALUPE ST, KERRVILLE, TX 78028</p>
 * <p>Phone: (877) 895-0043 | Fax: (833) 939-1985</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/kerrville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9256; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/kerrville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/kerrville_audio", "ssa.tx.kerrville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/kerrville_data", "ssa.tx.kerrville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/kerrville_graphics", "ssa.tx.kerrville.graphics.spectrum", sb.toString());
        }
    }
}