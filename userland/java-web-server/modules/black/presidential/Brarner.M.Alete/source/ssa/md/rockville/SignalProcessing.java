package presidential.Brarner.M.Alete.source.ssa.md.rockville;
...
/**
 * Signal Processing for SSA Office: ROCKVILLE MD
 * <p>Office Code: A33</p>
 * <p>Address: 315 N WASHINGTON ST, ROCKVILLE, MD 20850</p>
 * <p>Phone: (866) 838-5341 | Fax: (833) 341-2702</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/rockville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9221; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/rockville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/rockville_audio", "ssa.md.rockville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/rockville_data", "ssa.md.rockville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/rockville_graphics", "ssa.md.rockville.graphics.spectrum", sb.toString());
        }
    }
}