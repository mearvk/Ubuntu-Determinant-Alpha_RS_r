package presidential.Brarner.M.Alete.source.ssa.ks.lawrence;
...
/**
 * Signal Processing for SSA Office: LAWRENCE KS
 * <p>Office Code: D15</p>
 * <p>Address: 1440 WAKARUSA, LAWRENCE, KS 66049</p>
 * <p>Phone: (866) 698-2561 | Fax: (833) 950-2946</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ks/lawrence/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9410; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ks/lawrence";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ks/lawrence_audio", "ssa.ks.lawrence.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ks/lawrence_data", "ssa.ks.lawrence.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ks/lawrence_graphics", "ssa.ks.lawrence.graphics.spectrum", sb.toString());
        }
    }
}