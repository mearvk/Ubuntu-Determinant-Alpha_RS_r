...
/**
 * Signal Processing for SSA Office: ROME GA
 * <p>Office Code: 609</p>
 * <p>Address: 480 RIVERSIDE PKWY NE, ROME, GA 30161</p>
 * <p>Phone: (866) 964-1006 | Fax: (833) 950-2856</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/rome/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10032; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/rome";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/rome_audio", "ssa.ga.rome.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/rome_data", "ssa.ga.rome.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/rome_graphics", "ssa.ga.rome.graphics.spectrum", sb.toString());
        }
    }
}