package presidential.Brarner.M.Alete.source.ssa.mo.rolla;
...
/**
 * Signal Processing for SSA Office: ROLLA MO
 * <p>Office Code: 750</p>
 * <p>Address: 1813 E 10TH ST, ROLLA, MO 65401</p>
 * <p>Phone: (800) 551-2056 | Fax: (833) 926-1837</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/rolla/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10149; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/rolla";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/rolla_audio", "ssa.mo.rolla.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/rolla_data", "ssa.mo.rolla.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/rolla_graphics", "ssa.mo.rolla.graphics.spectrum", sb.toString());
        }
    }
}