package presidential.Brarner.M.Alete.source.ssa.in.valparaiso;
...
/**
 * Signal Processing for SSA Office: VALPARAISO IN
 * <p>Office Code: 475</p>
 * <p>Address: 3810 CALUMET AVE, VALPARAISO, IN 46383</p>
 * <p>Phone: (888) 472-6120 | Fax: (833) 950-2493</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/valparaiso/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9912; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/valparaiso";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/valparaiso_audio", "ssa.in.valparaiso.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/valparaiso_data", "ssa.in.valparaiso.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/valparaiso_graphics", "ssa.in.valparaiso.graphics.spectrum", sb.toString());
        }
    }
}