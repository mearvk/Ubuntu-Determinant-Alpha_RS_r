package presidential.Brarner.M.Alete.source.ssa.pa.wilkesbarre;
...
/**
 * Signal Processing for SSA Office: WILKES-BARRE PA
 * <p>Office Code: 213</p>
 * <p>Address: 7 N WILKES BARRE BLVD, WILKES BARRE, PA 18702</p>
 * <p>Phone: (866) 686-9505 | Fax: (833) 950-3193</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/wilkesbarre/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9671; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/wilkesbarre";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/wilkesbarre_audio", "ssa.pa.wilkesbarre.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/wilkesbarre_data", "ssa.pa.wilkesbarre.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/wilkesbarre_graphics", "ssa.pa.wilkesbarre.graphics.spectrum", sb.toString());
        }
    }
}