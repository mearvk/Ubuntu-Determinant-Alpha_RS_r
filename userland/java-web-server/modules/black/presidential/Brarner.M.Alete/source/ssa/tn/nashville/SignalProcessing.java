package presidential.Brarner.M.Alete.source.ssa.tn.nashville;
...
/**
 * Signal Processing for SSA Office: NASHVILLE  TN
 * <p>Office Code: 565</p>
 * <p>Address: 120 ATHENS WAY, NASHVILLE, TN 37228</p>
 * <p>Phone: (877) 808-5461 | Fax: (833) 597-0080</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/nashville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9990; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/nashville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/nashville_audio", "ssa.tn.nashville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/nashville_data", "ssa.tn.nashville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/nashville_graphics", "ssa.tn.nashville.graphics.spectrum", sb.toString());
        }
    }
}