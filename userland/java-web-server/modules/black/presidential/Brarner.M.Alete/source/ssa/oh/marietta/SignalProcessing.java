package presidential.Brarner.M.Alete.source.ssa.oh.marietta;
...
/**
 * Signal Processing for SSA Office: MARIETTA OH
 * <p>Office Code: 414</p>
 * <p>Address: 1301 GREENE STREET, MARIETTA, OH 45750</p>
 * <p>Phone: (855) 433-5872 | Fax: (833) 950-3725</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/marietta/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9855; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/marietta";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/marietta_audio", "ssa.oh.marietta.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/marietta_data", "ssa.oh.marietta.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/marietta_graphics", "ssa.oh.marietta.graphics.spectrum", sb.toString());
        }
    }
}