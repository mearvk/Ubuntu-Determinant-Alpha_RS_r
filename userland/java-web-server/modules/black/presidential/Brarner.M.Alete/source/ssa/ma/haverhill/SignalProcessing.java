package presidential.Brarner.M.Alete.source.ssa.ma.haverhill;
...
/**
 * Signal Processing for SSA Office: HAVERHILL MA
 * <p>Office Code: 50</p>
 * <p>Address: 62 BROWN ST, HAVERHILL, MA 1830</p>
 * <p>Phone: (866) 964-4324 | Fax: (833) 926-1856</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/haverhill/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9532; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/haverhill";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/haverhill_audio", "ssa.ma.haverhill.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/haverhill_data", "ssa.ma.haverhill.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/haverhill_graphics", "ssa.ma.haverhill.graphics.spectrum", sb.toString());
        }
    }
}