package presidential.Brarner.M.Alete.source.ssa.oh.cincinnati002;
...
/**
 * Signal Processing for SSA Office: CINCINNATI NORTH
 * <p>Office Code: 411</p>
 * <p>Address: 10205 READING RD, CINCINNATI, OH 45241</p>
 * <p>Phone: (877) 833-2704 | Fax: (833) 950-3719</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/cincinnati002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9852; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/cincinnati002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cincinnati002_audio", "ssa.oh.cincinnati002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cincinnati002_data", "ssa.oh.cincinnati002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cincinnati002_graphics", "ssa.oh.cincinnati002.graphics.spectrum", sb.toString());
        }
    }
}