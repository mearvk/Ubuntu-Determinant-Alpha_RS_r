package presidential.Brarner.M.Alete.source.ssa.me.auburn;
...
/**
 * Signal Processing for SSA Office: AUBURN ME
 * <p>Office Code: 4</p>
 * <p>Address: 600 TURNER STREET, AUBURN, ME 4210</p>
 * <p>Phone: (833) 388-6432 | Fax: (833) 950-3581</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/me/auburn/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9493; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/me/auburn";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_me/auburn_audio", "ssa.me.auburn.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_me/auburn_data", "ssa.me.auburn.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_me/auburn_graphics", "ssa.me.auburn.graphics.spectrum", sb.toString());
        }
    }
}