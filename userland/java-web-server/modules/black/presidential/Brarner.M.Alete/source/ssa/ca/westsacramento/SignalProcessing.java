package presidential.Brarner.M.Alete.source.ssa.ca.westsacramento;
...
/**
 * Signal Processing for SSA Office: WEST SACRAMENTO CA
 * <p>Office Code: E29</p>
 * <p>Address: 825 RIVERSIDE PARKWAY, WEST SACRAMENTO, CA 95605</p>
 * <p>Phone: (866) 726-8136 | Fax: (833) 940-1985</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/westsacramento/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9461; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/westsacramento";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/westsacramento_audio", "ssa.ca.westsacramento.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/westsacramento_data", "ssa.ca.westsacramento.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/westsacramento_graphics", "ssa.ca.westsacramento.graphics.spectrum", sb.toString());
        }
    }
}