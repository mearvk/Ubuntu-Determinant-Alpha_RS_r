package presidential.Brarner.M.Alete.source.ssa.ms.corinth;
...
/**
 * Signal Processing for SSA Office: CORINTH MS
 * <p>Office Code: B02</p>
 * <p>Address: 1050 S. HARPER RD, CORINTH, MS 38834</p>
 * <p>Phone: (866) 366-4921 | Fax: (833) 950-2822</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/corinth/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9275; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/corinth";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/corinth_audio", "ssa.ms.corinth.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/corinth_data", "ssa.ms.corinth.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/corinth_graphics", "ssa.ms.corinth.graphics.spectrum", sb.toString());
        }
    }
}