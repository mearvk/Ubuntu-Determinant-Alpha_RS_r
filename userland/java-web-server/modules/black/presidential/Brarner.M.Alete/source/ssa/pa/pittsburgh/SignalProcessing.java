package presidential.Brarner.M.Alete.source.ssa.pa.pittsburgh;
...
/**
 * Signal Processing for SSA Office: PITTS DT PA
 * <p>Office Code: 201</p>
 * <p>Address: 700 GRANT ST, PITTSBURGH, PA 15219</p>
 * <p>Phone: (866) 770-2965 | Fax: (833) 950-2884</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/pittsburgh/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9659; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/pittsburgh";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/pittsburgh_audio", "ssa.pa.pittsburgh.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/pittsburgh_data", "ssa.pa.pittsburgh.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/pittsburgh_graphics", "ssa.pa.pittsburgh.graphics.spectrum", sb.toString());
        }
    }
}