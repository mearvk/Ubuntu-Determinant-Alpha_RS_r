package presidential.Brarner.M.Alete.source.ssa.wi.kenosha;
...
/**
 * Signal Processing for SSA Office: KENOSHA WI
 * <p>Office Code: 547</p>
 * <p>Address: 3915 30TH AVE, KENOSHA, WI 53144</p>
 * <p>Phone: (866) 334-4997 | Fax: (833) 596-0599</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/kenosha/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9976; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/kenosha";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/kenosha_audio", "ssa.wi.kenosha.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/kenosha_data", "ssa.wi.kenosha.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/kenosha_graphics", "ssa.wi.kenosha.graphics.spectrum", sb.toString());
        }
    }
}