package presidential.Brarner.M.Alete.source.ssa.tx.seguin;
...
/**
 * Signal Processing for SSA Office: SEGUIN TX
 * <p>Office Code: B51</p>
 * <p>Address: 927 S ST HWY 123 BYP, SEGUIN, TX 78155</p>
 * <p>Phone: (877) 445-0831 | Fax: (833) 939-2005</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/seguin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9313; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/seguin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/seguin_audio", "ssa.tx.seguin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/seguin_data", "ssa.tx.seguin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/seguin_graphics", "ssa.tx.seguin.graphics.spectrum", sb.toString());
        }
    }
}