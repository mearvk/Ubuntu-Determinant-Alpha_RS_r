package presidential.Brarner.M.Alete.source.ssa.ny.newyork006;
...
/**
 * Signal Processing for SSA Office: NY EAST HARLEM NY
 * <p>Office Code: 156</p>
 * <p>Address: 345 E 102ND ST, NEW YORK, NY 10029</p>
 * <p>Phone: (877) 445-0836 | Fax: (833) 950-2680</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/newyork006/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9623; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/newyork006";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork006_audio", "ssa.ny.newyork006.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork006_data", "ssa.ny.newyork006.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork006_graphics", "ssa.ny.newyork006.graphics.spectrum", sb.toString());
        }
    }
}