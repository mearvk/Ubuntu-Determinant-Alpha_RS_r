package presidential.Brarner.M.Alete.source.ssa.in.fortwayne;
...
/**
 * Signal Processing for SSA Office: FORT WAYNE IN
 * <p>Office Code: 459</p>
 * <p>Address: 2122 LINCOLNWAY CT, FORT WAYNE, IN 46819</p>
 * <p>Phone: (877) 223-6061 | Fax: (833) 902-2674</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/fortwayne/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9896; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/fortwayne";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/fortwayne_audio", "ssa.in.fortwayne.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/fortwayne_data", "ssa.in.fortwayne.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/fortwayne_graphics", "ssa.in.fortwayne.graphics.spectrum", sb.toString());
        }
    }
}