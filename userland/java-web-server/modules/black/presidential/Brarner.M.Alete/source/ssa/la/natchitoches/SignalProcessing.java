package presidential.Brarner.M.Alete.source.ssa.la.natchitoches;
...
/**
 * Signal Processing for SSA Office: NATCHITOCHES LA
 * <p>Office Code: 809</p>
 * <p>Address: 950 KEYSER AVE, NATCHITOCHES, LA 71457</p>
 * <p>Phone: (855) 634-4195 | Fax: (833) 950-3647</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/natchitoches/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10201; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/natchitoches";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/natchitoches_audio", "ssa.la.natchitoches.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/natchitoches_data", "ssa.la.natchitoches.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/natchitoches_graphics", "ssa.la.natchitoches.graphics.spectrum", sb.toString());
        }
    }
}