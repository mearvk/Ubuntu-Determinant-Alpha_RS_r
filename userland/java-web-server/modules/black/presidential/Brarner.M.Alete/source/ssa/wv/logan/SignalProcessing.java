...
/**
 * Signal Processing for SSA Office: LOGAN WV
 * <p>Office Code: 314</p>
 * <p>Address: 1103 GEORGE KOSTAS DR, LOGAN, WV 25601</p>
 * <p>Phone: (877) 405-1455 | Fax: (833) 950-2278</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/logan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9764; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/logan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/logan_audio", "ssa.wv.logan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/logan_data", "ssa.wv.logan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/logan_graphics", "ssa.wv.logan.graphics.spectrum", sb.toString());
        }
    }
}