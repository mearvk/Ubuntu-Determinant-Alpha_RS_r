package presidential.Brarner.M.Alete.source.ssa.ar.fayetteville;
...
/**
 * Signal Processing for SSA Office: FAYETTEVILLE AR
 * <p>Office Code: 763</p>
 * <p>Address: 2153 E. JOYCE BLVD., FAYETTEVILLE, AR 72703</p>
 * <p>Phone: (877) 694-5493 | Fax: (833) 950-2992</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/fayetteville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10161; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/fayetteville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/fayetteville_audio", "ssa.ar.fayetteville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/fayetteville_data", "ssa.ar.fayetteville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/fayetteville_graphics", "ssa.ar.fayetteville.graphics.spectrum", sb.toString());
        }
    }
}