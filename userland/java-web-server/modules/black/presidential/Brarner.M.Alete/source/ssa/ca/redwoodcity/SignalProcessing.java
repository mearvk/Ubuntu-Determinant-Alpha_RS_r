package presidential.Brarner.M.Alete.source.ssa.ca.redwoodcity;
...
/**
 * Signal Processing for SSA Office: REDWOOD CITY CA
 * <p>Office Code: D34</p>
 * <p>Address: 1718 BROADWAY ST, REDWOOD CITY, CA 94063</p>
 * <p>Phone: (888) 860-5582 | Fax: (833) 571-0638</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/redwoodcity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9421; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/redwoodcity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/redwoodcity_audio", "ssa.ca.redwoodcity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/redwoodcity_data", "ssa.ca.redwoodcity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/redwoodcity_graphics", "ssa.ca.redwoodcity.graphics.spectrum", sb.toString());
        }
    }
}