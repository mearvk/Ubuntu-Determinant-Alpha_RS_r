...
/**
 * Signal Processing for SSA Office: BKRSFLD EAST HILLS CA
 * <p>Office Code: 563</p>
 * <p>Address: 2575 HALEY STREET, BAKERSFIELD, CA 93305</p>
 * <p>Phone: (866) 366-9558 | Fax: (833) 950-3383</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/bakersfield/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9989; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/bakersfield";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/bakersfield_audio", "ssa.ca.bakersfield.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/bakersfield_data", "ssa.ca.bakersfield.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/bakersfield_graphics", "ssa.ca.bakersfield.graphics.spectrum", sb.toString());
        }
    }
}