...
/**
 * Signal Processing for SSA Office: DANVILLE KY
 * <p>Office Code: 452</p>
 * <p>Address: 103 BELINDA BLVD, DANVILLE, KY 40422</p>
 * <p>Phone: (877) 512-3850 | Fax: (833) 950-3775</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/danville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9889; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/danville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/danville_audio", "ssa.ky.danville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/danville_data", "ssa.ky.danville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/danville_graphics", "ssa.ky.danville.graphics.spectrum", sb.toString());
        }
    }
}