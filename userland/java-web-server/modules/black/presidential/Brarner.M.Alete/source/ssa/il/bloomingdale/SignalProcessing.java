package presidential.Brarner.M.Alete.source.ssa.il.bloomingdale;
...
/**
 * Signal Processing for SSA Office: BLOOMINGDALE IL
 * <p>Office Code: 522</p>
 * <p>Address: 230 WEST LAKE STREET, BLOOMINGDALE, IL 60108</p>
 * <p>Phone: (877) 845-1577 | Fax: (833) 950-3451</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/bloomingdale/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9956; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/bloomingdale";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/bloomingdale_audio", "ssa.il.bloomingdale.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/bloomingdale_data", "ssa.il.bloomingdale.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/bloomingdale_graphics", "ssa.il.bloomingdale.graphics.spectrum", sb.toString());
        }
    }
}