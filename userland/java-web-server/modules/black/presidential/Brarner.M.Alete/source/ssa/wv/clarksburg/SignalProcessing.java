package presidential.Brarner.M.Alete.source.ssa.wv.clarksburg;
...
/**
 * Signal Processing for SSA Office: CLARKSBURG WV
 * <p>Office Code: 309</p>
 * <p>Address: 320 W PIKE ST, CLARKSBURG, WV 26301</p>
 * <p>Phone: (866) 783-7305 | Fax: (833) 950-2259</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/clarksburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9759; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/clarksburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/clarksburg_audio", "ssa.wv.clarksburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/clarksburg_data", "ssa.wv.clarksburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/clarksburg_graphics", "ssa.wv.clarksburg.graphics.spectrum", sb.toString());
        }
    }
}