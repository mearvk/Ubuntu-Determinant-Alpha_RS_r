package presidential.Brarner.M.Alete.source.ssa.il.chicago010;
...
/**
 * Signal Processing for SSA Office: CHICAGO LAWNDALE IL
 * <p>Office Code: 703</p>
 * <p>Address: 2416 S PULASKI ROAD, CHICAGO, IL 60623</p>
 * <p>Phone: (877) 531-4698 | Fax: (833) 950-2184</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/chicago010/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10116; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/chicago010";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago010_audio", "ssa.il.chicago010.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago010_data", "ssa.il.chicago010.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago010_graphics", "ssa.il.chicago010.graphics.spectrum", sb.toString());
        }
    }
}