package presidential.Brarner.M.Alete.source.ssa.fl.lakeland;
...
/**
 * Signal Processing for SSA Office: LAKELAND FL
 * <p>Office Code: 658</p>
 * <p>Address: 550 COMMERCE DR, LAKELAND, FL 33813</p>
 * <p>Phone: (877) 604-9387 | Fax: (833) 679-0235</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/lakeland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10077; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/lakeland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/lakeland_audio", "ssa.fl.lakeland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/lakeland_data", "ssa.fl.lakeland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/lakeland_graphics", "ssa.fl.lakeland.graphics.spectrum", sb.toString());
        }
    }
}