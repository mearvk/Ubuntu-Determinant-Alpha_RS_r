...
/**
 * Signal Processing for SSA Office: MORROW GA
 * <p>Office Code: 617</p>
 * <p>Address: 6665 PARK PLACE, MORROW, GA 30260</p>
 * <p>Phone: (866) 331-2215 | Fax: (833) 950-3157</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/morrow/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10040; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/morrow";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/morrow_audio", "ssa.ga.morrow.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/morrow_data", "ssa.ga.morrow.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/morrow_graphics", "ssa.ga.morrow.graphics.spectrum", sb.toString());
        }
    }
}