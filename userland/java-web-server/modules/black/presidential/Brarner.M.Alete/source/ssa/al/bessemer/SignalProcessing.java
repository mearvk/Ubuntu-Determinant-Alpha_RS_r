package presidential.Brarner.M.Alete.source.ssa.al.bessemer;
...
/**
 * Signal Processing for SSA Office: BESSEMER AL
 * <p>Office Code: 636</p>
 * <p>Address: 5475 ACADEMY WAY, BESSEMER, AL 35022</p>
 * <p>Phone: (866) 593-5647 | Fax: (833) 950-3511</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/bessemer/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10059; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/bessemer";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/bessemer_audio", "ssa.al.bessemer.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/bessemer_data", "ssa.al.bessemer.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/bessemer_graphics", "ssa.al.bessemer.graphics.spectrum", sb.toString());
        }
    }
}