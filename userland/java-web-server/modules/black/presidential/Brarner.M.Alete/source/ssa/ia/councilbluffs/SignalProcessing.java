...
/**
 * Signal Processing for SSA Office: COUNCIL BLUFFS
 * <p>Office Code: C49</p>
 * <p>Address: 20 ARENA WAY, COUNCIL BLUFFS, IA 51501</p>
 * <p>Phone: (866) 331-9094 | Fax: (833) 950-2936</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/councilbluffs/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9367; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/councilbluffs";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/councilbluffs_audio", "ssa.ia.councilbluffs.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/councilbluffs_data", "ssa.ia.councilbluffs.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/councilbluffs_graphics", "ssa.ia.councilbluffs.graphics.spectrum", sb.toString());
        }
    }
}