...
/**
 * Signal Processing for SSA Office: POUGHKEEPSIE NY
 * <p>Office Code: 133</p>
 * <p>Address: 4 ACADEMY ST, POUGHKEEPSIE, NY 12601</p>
 * <p>Phone: (877) 405-6747 | Fax: (833) 926-2689</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/poughkeepsie/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9602; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/poughkeepsie";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/poughkeepsie_audio", "ssa.ny.poughkeepsie.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/poughkeepsie_data", "ssa.ny.poughkeepsie.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/poughkeepsie_graphics", "ssa.ny.poughkeepsie.graphics.spectrum", sb.toString());
        }
    }
}