package presidential.Brarner.M.Alete.source.ssa.va.culpeper;
...
/**
 * Signal Processing for SSA Office: CULPEPER VA
 * <p>Office Code: A92</p>
 * <p>Address: 1014 S MAIN ST, CULPEPER, VA 22701</p>
 * <p>Phone: (877) 531-4694 | Fax: (833) 912-2316</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/culpeper/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9267; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/culpeper";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/culpeper_audio", "ssa.va.culpeper.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/culpeper_data", "ssa.va.culpeper.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/culpeper_graphics", "ssa.va.culpeper.graphics.spectrum", sb.toString());
        }
    }
}