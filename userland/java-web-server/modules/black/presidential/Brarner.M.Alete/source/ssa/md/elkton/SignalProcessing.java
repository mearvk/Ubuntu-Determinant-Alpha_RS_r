package presidential.Brarner.M.Alete.source.ssa.md.elkton;
...
/**
 * Signal Processing for SSA Office: ELKTON MD
 * <p>Office Code: 96</p>
 * <p>Address: 300 BIG ELK MALL, ELKTON, MD 21921</p>
 * <p>Phone: (866) 331-2218 | Fax: (833) 371-0606</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/elkton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9567; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/elkton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/elkton_audio", "ssa.md.elkton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/elkton_data", "ssa.md.elkton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/elkton_graphics", "ssa.md.elkton.graphics.spectrum", sb.toString());
        }
    }
}