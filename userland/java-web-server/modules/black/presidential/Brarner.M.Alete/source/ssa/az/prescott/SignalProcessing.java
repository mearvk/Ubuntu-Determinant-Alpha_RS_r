...
/**
 * Signal Processing for SSA Office: PRESCOTT AZ
 * <p>Office Code: 909</p>
 * <p>Address: 205 N MARINA, PRESCOTT, AZ 86301</p>
 * <p>Phone: (877) 457-1733 | Fax: (833) 950-3677</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/az/prescott/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10292; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/az/prescott";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_az/prescott_audio", "ssa.az.prescott.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_az/prescott_data", "ssa.az.prescott.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_az/prescott_graphics", "ssa.az.prescott.graphics.spectrum", sb.toString());
        }
    }
}