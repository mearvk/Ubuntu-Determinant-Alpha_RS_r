package presidential.Brarner.M.Alete.source.ssa.ca.fountainvalley;
...
/**
 * Signal Processing for SSA Office: FOUNTAIN VALLEY CA
 * <p>Office Code: A78</p>
 * <p>Address: 17075 NEWHOPE STREET, FOUNTAIN VALLEY, CA 92708</p>
 * <p>Phone: (877) 304-1566 | Fax: (833) 950-3365</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/fountainvalley/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9258; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/fountainvalley";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fountainvalley_audio", "ssa.ca.fountainvalley.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fountainvalley_data", "ssa.ca.fountainvalley.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fountainvalley_graphics", "ssa.ca.fountainvalley.graphics.spectrum", sb.toString());
        }
    }
}