package presidential.Brarner.M.Alete.source.ssa.sc.greenwood;
...
/**
 * Signal Processing for SSA Office: GREENWOOD SC
 * <p>Office Code: 589</p>
 * <p>Address: 115 ENTERPRISE COURT, GREENWOOD, SC 29649</p>
 * <p>Phone: (866) 739-4803 | Fax: (833) 950-2237</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/greenwood/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10013; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/greenwood";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/greenwood_audio", "ssa.sc.greenwood.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/greenwood_data", "ssa.sc.greenwood.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/greenwood_graphics", "ssa.sc.greenwood.graphics.spectrum", sb.toString());
        }
    }
}