...
/**
 * Signal Processing for SSA Office: NEW HAVEN CT
 * <p>Office Code: 85</p>
 * <p>Address: 150 COURT ST, NEW HAVEN, CT 6510</p>
 * <p>Phone: (866) 331-5281 | Fax: (833) 950-2654</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ct/newhaven/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9557; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ct/newhaven";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ct/newhaven_audio", "ssa.ct.newhaven.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ct/newhaven_data", "ssa.ct.newhaven.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ct/newhaven_graphics", "ssa.ct.newhaven.graphics.spectrum", sb.toString());
        }
    }
}