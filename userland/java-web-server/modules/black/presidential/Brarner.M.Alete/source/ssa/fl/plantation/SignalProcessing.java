package presidential.Brarner.M.Alete.source.ssa.fl.plantation;
...
/**
 * Signal Processing for SSA Office: FT LAUDERDALE W
 * <p>Office Code: C19</p>
 * <p>Address: 8501 W SUNRISE BLVD, PLANTATION, FL 33322</p>
 * <p>Phone: (866) 331-9093 | Fax: (833) 950-3469</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/plantation/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9352; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/plantation";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/plantation_audio", "ssa.fl.plantation.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/plantation_data", "ssa.fl.plantation.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/plantation_graphics", "ssa.fl.plantation.graphics.spectrum", sb.toString());
        }
    }
}