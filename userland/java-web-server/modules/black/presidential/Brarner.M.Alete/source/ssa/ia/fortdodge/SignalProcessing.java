package presidential.Brarner.M.Alete.source.ssa.ia.fortdodge;
...
/**
 * Signal Processing for SSA Office: FORT DODGE IA
 * <p>Office Code: 697</p>
 * <p>Address: 2315 2ND AVE N, FORT DODGE, IA 50501</p>
 * <p>Phone: (866) 839-6193 | Fax: (833) 515-0433</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/fortdodge/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10111; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/fortdodge";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/fortdodge_audio", "ssa.ia.fortdodge.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/fortdodge_data", "ssa.ia.fortdodge.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/fortdodge_graphics", "ssa.ia.fortdodge.graphics.spectrum", sb.toString());
        }
    }
}