package presidential.Brarner.M.Alete.source.ssa.mi.grandrapids;
...
/**
 * Signal Processing for SSA Office: GRAND RAPIDS MI
 * <p>Office Code: 347</p>
 * <p>Address: 3045 KNAPP ST NE, GRAND RAPIDS, MI 49525</p>
 * <p>Phone: (877) 319-5710 | Fax: (833) 902-2660</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/grandrapids/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9794; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/grandrapids";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/grandrapids_audio", "ssa.mi.grandrapids.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/grandrapids_data", "ssa.mi.grandrapids.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/grandrapids_graphics", "ssa.mi.grandrapids.graphics.spectrum", sb.toString());
        }
    }
}