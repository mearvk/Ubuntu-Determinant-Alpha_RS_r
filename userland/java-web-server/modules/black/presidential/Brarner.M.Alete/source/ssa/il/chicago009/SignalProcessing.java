package presidential.Brarner.M.Alete.source.ssa.il.chicago009;
...
/**
 * Signal Processing for SSA Office: CHICAGO-SE IL
 * <p>Office Code: 514</p>
 * <p>Address: 9715 S COTTAGE GROVE, CHICAGO, IL 60628</p>
 * <p>Phone: (888) 397-3107 | Fax: (833) 950-3435</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/chicago009/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9948; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/chicago009";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago009_audio", "ssa.il.chicago009.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago009_data", "ssa.il.chicago009.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago009_graphics", "ssa.il.chicago009.graphics.spectrum", sb.toString());
        }
    }
}