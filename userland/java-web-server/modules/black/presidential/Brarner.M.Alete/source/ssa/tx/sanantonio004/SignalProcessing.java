package presidential.Brarner.M.Alete.source.ssa.tx.sanantonio004;
...
/**
 * Signal Processing for SSA Office: SAN ANTONIO SOUTH TX
 * <p>Office Code: 880</p>
 * <p>Address: 3438 E SOUTHCROSS BLVD, SAN ANTONIO, TX 78223</p>
 * <p>Phone: (866) 964-7432 | Fax: (833) 950-3023</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/sanantonio004/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10266; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/sanantonio004";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanantonio004_audio", "ssa.tx.sanantonio004.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanantonio004_data", "ssa.tx.sanantonio004.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanantonio004_graphics", "ssa.tx.sanantonio004.graphics.spectrum", sb.toString());
        }
    }
}