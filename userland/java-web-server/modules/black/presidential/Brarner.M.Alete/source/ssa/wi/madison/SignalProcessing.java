package presidential.Brarner.M.Alete.source.ssa.wi.madison;
...
/**
 * Signal Processing for SSA Office: MADISON WI
 * <p>Office Code: 536</p>
 * <p>Address: 6011 ODANA RD, MADISON, WI 53719</p>
 * <p>Phone: (866) 770-2262 | Fax: (833) 950-3737</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/madison/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9965; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/madison";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/madison_audio", "ssa.wi.madison.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/madison_data", "ssa.wi.madison.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/madison_graphics", "ssa.wi.madison.graphics.spectrum", sb.toString());
        }
    }
}