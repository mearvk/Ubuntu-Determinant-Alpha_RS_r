package presidential.Brarner.M.Alete.source.ssa.tn.oakridge;
...
/**
 * Signal Processing for SSA Office: OAK RIDGE TN
 * <p>Office Code: A51</p>
 * <p>Address: 565 OAK RIDGE TPKE, OAK RIDGE, TN 37830</p>
 * <p>Phone: (888) 676-2954 | Fax: (833) 950-2812</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/oakridge/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9235; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/oakridge";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/oakridge_audio", "ssa.tn.oakridge.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/oakridge_data", "ssa.tn.oakridge.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/oakridge_graphics", "ssa.tn.oakridge.graphics.spectrum", sb.toString());
        }
    }
}