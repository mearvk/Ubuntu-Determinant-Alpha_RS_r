package presidential.Brarner.M.Alete.source.ssa.md.baltimore002;
...
/**
 * Signal Processing for SSA Office: BALTO WEST MD
 * <p>Office Code: 20</p>
 * <p>Address: 1531 S EDGEWOOD STREET, BALTIMORE, MD 21227</p>
 * <p>Phone: (877) 870-6381 | Fax: (833) 371-0600</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/baltimore002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9505; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/baltimore002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/baltimore002_audio", "ssa.md.baltimore002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/baltimore002_data", "ssa.md.baltimore002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/baltimore002_graphics", "ssa.md.baltimore002.graphics.spectrum", sb.toString());
        }
    }
}