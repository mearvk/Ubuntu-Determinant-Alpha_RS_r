package presidential.Brarner.M.Alete.source.ssa.al.alexandercity;
...
/**
 * Signal Processing for SSA Office: ALEXANDER CITY AL
 * <p>Office Code: C32</p>
 * <p>Address: 63 ALIANT PARKWAY, ALEXANDER CITY, AL 35010</p>
 * <p>Phone: (877) 405-0483 | Fax: (833) 950-3767</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/alexandercity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9358; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/alexandercity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/alexandercity_audio", "ssa.al.alexandercity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/alexandercity_data", "ssa.al.alexandercity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/alexandercity_graphics", "ssa.al.alexandercity.graphics.spectrum", sb.toString());
        }
    }
}