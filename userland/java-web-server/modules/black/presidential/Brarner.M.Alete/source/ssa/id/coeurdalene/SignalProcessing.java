package presidential.Brarner.M.Alete.source.ssa.id.coeurdalene;
...
/**
 * Signal Processing for SSA Office: COEUR D ALENE I
 * <p>Office Code: 898</p>
 * <p>Address: 7400 N MINERAL DR, COEUR D' ALENE, ID 83815</p>
 * <p>Phone: (866) 931-2523 | Fax: (833) 950-2308</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/id/coeurdalene/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10282; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/id/coeurdalene";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_id/coeurdalene_audio", "ssa.id.coeurdalene.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_id/coeurdalene_data", "ssa.id.coeurdalene.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_id/coeurdalene_graphics", "ssa.id.coeurdalene.graphics.spectrum", sb.toString());
        }
    }
}