package presidential.Brarner.M.Alete.source.ssa.dc.washington;
...
/**
 * Signal Processing for SSA Office: POSTAL PLAZA DC
 * <p>Office Code: E63</p>
 * <p>Address: 1905-B 9TH ST NE, WASHINGTON, DC 20018</p>
 * <p>Phone: (866) 737-4470 | Fax: (833) 950-2608</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/dc/washington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9471; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/dc/washington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_dc/washington_audio", "ssa.dc.washington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_dc/washington_data", "ssa.dc.washington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_dc/washington_graphics", "ssa.dc.washington.graphics.spectrum", sb.toString());
        }
    }
}