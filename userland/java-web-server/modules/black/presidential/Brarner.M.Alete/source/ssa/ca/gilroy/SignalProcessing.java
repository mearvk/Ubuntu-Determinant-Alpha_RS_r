package presidential.Brarner.M.Alete.source.ssa.ca.gilroy;
...
/**
 * Signal Processing for SSA Office: GILROY CA
 * <p>Office Code: 561</p>
 * <p>Address: 1059 FIRST STREET, GILROY, CA 95020</p>
 * <p>Phone: (877) 452-4198 | Fax: (833) 950-3378</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/gilroy/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9987; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/gilroy";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/gilroy_audio", "ssa.ca.gilroy.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/gilroy_data", "ssa.ca.gilroy.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/gilroy_graphics", "ssa.ca.gilroy.graphics.spectrum", sb.toString());
        }
    }
}