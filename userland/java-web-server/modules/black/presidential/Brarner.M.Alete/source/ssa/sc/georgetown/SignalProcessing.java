...
/**
 * Signal Processing for SSA Office: GEORGETOWN SC
 * <p>Office Code: 593</p>
 * <p>Address: 413 KING ST, GEORGETOWN, SC 29440</p>
 * <p>Phone: (866) 593-1584 | Fax: (833) 950-2245</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/georgetown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10017; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/georgetown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/georgetown_audio", "ssa.sc.georgetown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/georgetown_data", "ssa.sc.georgetown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/georgetown_graphics", "ssa.sc.georgetown.graphics.spectrum", sb.toString());
        }
    }
}