package presidential.Brarner.M.Alete.source.ssa.mi.bentonharbor;
...
/**
 * Signal Processing for SSA Office: BENT HAR-ST JOE
 * <p>Office Code: 365</p>
 * <p>Address: 455 BOND ST, BENTON HARBOR, MI 49022</p>
 * <p>Phone: (877) 405-5457 | Fax: (833) 950-2474</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/bentonharbor/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9812; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/bentonharbor";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/bentonharbor_audio", "ssa.mi.bentonharbor.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/bentonharbor_data", "ssa.mi.bentonharbor.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/bentonharbor_graphics", "ssa.mi.bentonharbor.graphics.spectrum", sb.toString());
        }
    }
}