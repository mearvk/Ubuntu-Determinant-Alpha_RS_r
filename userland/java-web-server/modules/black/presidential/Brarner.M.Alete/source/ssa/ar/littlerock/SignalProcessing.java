...
/**
 * Signal Processing for SSA Office: LITTLE ROCK AR
 * <p>Office Code: 755</p>
 * <p>Address: 700 W CAPITOL STREET, LITTLE ROCK, AR 72201</p>
 * <p>Phone: (866) 593-0933 | Fax: (833) 950-2696</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/littlerock/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10153; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/littlerock";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/littlerock_audio", "ssa.ar.littlerock.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/littlerock_data", "ssa.ar.littlerock.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/littlerock_graphics", "ssa.ar.littlerock.graphics.spectrum", sb.toString());
        }
    }
}