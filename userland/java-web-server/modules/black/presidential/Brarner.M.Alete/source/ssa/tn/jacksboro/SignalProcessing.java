package presidential.Brarner.M.Alete.source.ssa.tn.jacksboro;
...
/**
 * Signal Processing for SSA Office: JACKSBORO TN
 * <p>Office Code: 580</p>
 * <p>Address: 140 SHARP AND PERKINS RD, JACKSBORO, TN 37757</p>
 * <p>Phone: (866) 964-7324 | Fax: (833) 912-2282</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/jacksboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10004; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/jacksboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/jacksboro_audio", "ssa.tn.jacksboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/jacksboro_data", "ssa.tn.jacksboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/jacksboro_graphics", "ssa.tn.jacksboro.graphics.spectrum", sb.toString());
        }
    }
}