package presidential.Brarner.M.Alete.source.ssa.mn.alexandria;
...
/**
 * Signal Processing for SSA Office: ALEXANDRIA MN
 * <p>Office Code: D06</p>
 * <p>Address: 2633 JEFFERSON ST, ALEXANDRIA, MN 56308</p>
 * <p>Phone: (888) 224-8869 | Fax: (833) 950-3711</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/alexandria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9404; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/alexandria";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/alexandria_audio", "ssa.mn.alexandria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/alexandria_data", "ssa.mn.alexandria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/alexandria_graphics", "ssa.mn.alexandria.graphics.spectrum", sb.toString());
        }
    }
}