package presidential.Brarner.M.Alete.source.ssa.oh.bowlinggreen;
...
/**
 * Signal Processing for SSA Office: BOWLING GREEN OH
 * <p>Office Code: B32</p>
 * <p>Address: 745 INNOVATION DRIVE, BOWLING GREEN, OH 43402</p>
 * <p>Phone: (866) 931-7674 | Fax: (833) 950-3403</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/bowlinggreen/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9299; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/bowlinggreen";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/bowlinggreen_audio", "ssa.oh.bowlinggreen.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/bowlinggreen_data", "ssa.oh.bowlinggreen.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/bowlinggreen_graphics", "ssa.oh.bowlinggreen.graphics.spectrum", sb.toString());
        }
    }
}