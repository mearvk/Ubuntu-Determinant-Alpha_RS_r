package presidential.Brarner.M.Alete.source.ssa.oh.warrensvillehts;
...
/**
 * Signal Processing for SSA Office: CLEVELAND SE OH
 * <p>Office Code: 424</p>
 * <p>Address: 18711 MILES ROAD, WARRENSVILLE HTS, OH 44128</p>
 * <p>Phone: (877) 405-0474 | Fax: (833) 596-0585</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/warrensvillehts/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9865; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/warrensvillehts";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/warrensvillehts_audio", "ssa.oh.warrensvillehts.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/warrensvillehts_data", "ssa.oh.warrensvillehts.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/warrensvillehts_graphics", "ssa.oh.warrensvillehts.graphics.spectrum", sb.toString());
        }
    }
}