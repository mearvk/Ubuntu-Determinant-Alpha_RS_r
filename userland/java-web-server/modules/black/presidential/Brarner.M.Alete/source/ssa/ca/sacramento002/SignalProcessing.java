package presidential.Brarner.M.Alete.source.ssa.ca.sacramento002;
...
/**
 * Signal Processing for SSA Office: SOUTH SACRAMENTO CA
 * <p>Office Code: E79</p>
 * <p>Address: 40 MASSIE CIRCLE, SACRAMENTO, CA 95823</p>
 * <p>Phone: (866) 708-3208 | Fax: (833) 940-2009</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sacramento002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9479; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sacramento002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sacramento002_audio", "ssa.ca.sacramento002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sacramento002_data", "ssa.ca.sacramento002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sacramento002_graphics", "ssa.ca.sacramento002.graphics.spectrum", sb.toString());
        }
    }
}