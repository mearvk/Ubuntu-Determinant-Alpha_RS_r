...
/**
 * Signal Processing for SSA Office: FORREST CITY AR
 * <p>Office Code: 765</p>
 * <p>Address: 965 HOLIDAY DR, FORREST CITY, AR 72335</p>
 * <p>Phone: (866) 964-2043 | Fax: (833) 950-2994</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/forrestcity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10162; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/forrestcity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/forrestcity_audio", "ssa.ar.forrestcity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/forrestcity_data", "ssa.ar.forrestcity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/forrestcity_graphics", "ssa.ar.forrestcity.graphics.spectrum", sb.toString());
        }
    }
}