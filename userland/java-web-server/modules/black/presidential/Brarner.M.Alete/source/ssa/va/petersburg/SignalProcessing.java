package presidential.Brarner.M.Alete.source.ssa.va.petersburg;
...
/**
 * Signal Processing for SSA Office: PETERSBURG VA
 * <p>Office Code: 291</p>
 * <p>Address: 100 POPLAR DRIVE, PETERSBURG, VA 23805</p>
 * <p>Phone: (877) 803-6322 | Fax: (833) 950-2288</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/petersburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9741; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/petersburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/petersburg_audio", "ssa.va.petersburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/petersburg_data", "ssa.va.petersburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/petersburg_graphics", "ssa.va.petersburg.graphics.spectrum", sb.toString());
        }
    }
}