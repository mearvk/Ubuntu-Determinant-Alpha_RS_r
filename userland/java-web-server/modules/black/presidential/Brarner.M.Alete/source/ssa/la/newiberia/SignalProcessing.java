package presidential.Brarner.M.Alete.source.ssa.la.newiberia;
...
/**
 * Signal Processing for SSA Office: NEW IBERIA LA
 * <p>Office Code: B52</p>
 * <p>Address: 417 SPANISH TOWN BLVD, NEW IBERIA, LA 70560</p>
 * <p>Phone: (866) 592-1496 | Fax: (833) 939-2006</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/newiberia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9314; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/newiberia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/newiberia_audio", "ssa.la.newiberia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/newiberia_data", "ssa.la.newiberia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/newiberia_graphics", "ssa.la.newiberia.graphics.spectrum", sb.toString());
        }
    }
}