package presidential.Brarner.M.Alete.source.ssa.ms.mosspoint;
...
/**
 * Signal Processing for SSA Office: MOSS POINT MS
 * <p>Office Code: 653</p>
 * <p>Address: 6000 HWY 63, MOSS POINT, MS 39563</p>
 * <p>Phone: (866) 253-5675 | Fax: (833) 554-0367</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/mosspoint/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10073; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/mosspoint";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/mosspoint_audio", "ssa.ms.mosspoint.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/mosspoint_data", "ssa.ms.mosspoint.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/mosspoint_graphics", "ssa.ms.mosspoint.graphics.spectrum", sb.toString());
        }
    }
}