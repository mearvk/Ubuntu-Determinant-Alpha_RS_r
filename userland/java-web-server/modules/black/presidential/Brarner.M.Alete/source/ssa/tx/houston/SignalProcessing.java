package presidential.Brarner.M.Alete.source.ssa.tx.houston;
...
/**
 * Signal Processing for SSA Office: HOUSTON SOUTHWEST TX
 * <p>Office Code: 816</p>
 * <p>Address: 13302 WESTHEIMER RD, HOUSTON, TX 77077</p>
 * <p>Phone: (866) 592-1608 | Fax: (833) 515-0520</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/houston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10207; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/houston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/houston_audio", "ssa.tx.houston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/houston_data", "ssa.tx.houston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/houston_graphics", "ssa.tx.houston.graphics.spectrum", sb.toString());
        }
    }
}