package presidential.Brarner.M.Alete.source.ssa.il.chicago007;
...
/**
 * Signal Processing for SSA Office: CHICAGO-NR NW IL
 * <p>Office Code: 510</p>
 * <p>Address: 3260 W FULLERTON AVE, CHICAGO, IL 60647</p>
 * <p>Phone: (888) 456-9540 | Fax: (833) 950-3113</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/chicago007/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9945; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/chicago007";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago007_audio", "ssa.il.chicago007.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago007_data", "ssa.il.chicago007.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago007_graphics", "ssa.il.chicago007.graphics.spectrum", sb.toString());
        }
    }
}