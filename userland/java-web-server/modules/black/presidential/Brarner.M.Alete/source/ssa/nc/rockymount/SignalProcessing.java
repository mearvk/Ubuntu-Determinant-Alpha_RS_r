package presidential.Brarner.M.Alete.source.ssa.nc.rockymount;
...
/**
 * Signal Processing for SSA Office: ROCKY MOUNT NC
 * <p>Office Code: 326</p>
 * <p>Address: 1071 HUNTER HILL RD, ROCKY MOUNT, NC 27804</p>
 * <p>Phone: (866) 964-0784 | Fax: (833) 950-2548</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/rockymount/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9775; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/rockymount";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/rockymount_audio", "ssa.nc.rockymount.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/rockymount_data", "ssa.nc.rockymount.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/rockymount_graphics", "ssa.nc.rockymount.graphics.spectrum", sb.toString());
        }
    }
}