...
/**
 * Signal Processing for SSA Office: ST THOMAS VI
 * <p>Office Code: 284</p>
 * <p>Address: 8000 NISKY SHOPPING CT, ST THOMAS, VI 802</p>
 * <p>Phone: (866) 876-1799 | Fax: (833) 950-3617</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/vi/stthomas/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9734; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/vi/stthomas";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_vi/stthomas_audio", "ssa.vi.stthomas.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_vi/stthomas_data", "ssa.vi.stthomas.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_vi/stthomas_graphics", "ssa.vi.stthomas.graphics.spectrum", sb.toString());
        }
    }
}