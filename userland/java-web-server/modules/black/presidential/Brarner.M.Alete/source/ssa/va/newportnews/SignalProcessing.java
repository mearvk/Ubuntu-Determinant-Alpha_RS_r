package presidential.Brarner.M.Alete.source.ssa.va.newportnews;
...
/**
 * Signal Processing for SSA Office: NEWPORT NEWS VA
 * <p>Office Code: 293</p>
 * <p>Address: 600 GASTON CT, NEWPORT NEWS, VA 23606</p>
 * <p>Phone: (866) 331-9169 | Fax: (833) 950-2292</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/newportnews/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9743; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/newportnews";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/newportnews_audio", "ssa.va.newportnews.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/newportnews_data", "ssa.va.newportnews.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/newportnews_graphics", "ssa.va.newportnews.graphics.spectrum", sb.toString());
        }
    }
}