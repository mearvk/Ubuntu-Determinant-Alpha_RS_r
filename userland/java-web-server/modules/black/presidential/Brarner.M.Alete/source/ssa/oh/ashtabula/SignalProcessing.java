package presidential.Brarner.M.Alete.source.ssa.oh.ashtabula;
...
/**
 * Signal Processing for SSA Office: ASHTABULA OH
 * <p>Office Code: 392</p>
 * <p>Address: 4815 STATE RD, ASHTABULA, OH 44004</p>
 * <p>Phone: (877) 223-6059 | Fax: (833) 950-3085</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/ashtabula/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9833; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/ashtabula";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/ashtabula_audio", "ssa.oh.ashtabula.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/ashtabula_data", "ssa.oh.ashtabula.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/ashtabula_graphics", "ssa.oh.ashtabula.graphics.spectrum", sb.toString());
        }
    }
}