package presidential.Brarner.M.Alete.source.ssa.wv.mounthope;
...
/**
 * Signal Processing for SSA Office: BECKLEY WV
 * <p>Office Code: 313</p>
 * <p>Address: 5475 ROBERT C. BYRD DR, MOUNT HOPE, WV 25880</p>
 * <p>Phone: (866) 964-2042 | Fax: (833) 950-2276</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/mounthope/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9763; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/mounthope";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/mounthope_audio", "ssa.wv.mounthope.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/mounthope_data", "ssa.wv.mounthope.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/mounthope_graphics", "ssa.wv.mounthope.graphics.spectrum", sb.toString());
        }
    }
}