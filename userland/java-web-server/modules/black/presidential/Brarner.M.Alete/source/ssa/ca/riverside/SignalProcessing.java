package presidential.Brarner.M.Alete.source.ssa.ca.riverside;
...
/**
 * Signal Processing for SSA Office: RIVERSIDE CA
 * <p>Office Code: 251</p>
 * <p>Address: 10000 MAGNOLIA AVE, RIVERSIDE, CA 92503</p>
 * <p>Phone: (866) 931-4495 | Fax: (833) 950-3037</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/riverside/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9706; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/riverside";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/riverside_audio", "ssa.ca.riverside.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/riverside_data", "ssa.ca.riverside.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/riverside_graphics", "ssa.ca.riverside.graphics.spectrum", sb.toString());
        }
    }
}