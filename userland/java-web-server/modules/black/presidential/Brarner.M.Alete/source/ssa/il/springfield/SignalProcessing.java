package presidential.Brarner.M.Alete.source.ssa.il.springfield;
...
/**
 * Signal Processing for SSA Office: SPRINGFIELD IL
 * <p>Office Code: 488</p>
 * <p>Address: 3112 CONSTITUTION DR, SPRINGFIELD, IL 62704</p>
 * <p>Phone: (877) 279-9504 | Fax: (833) 950-2504</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/springfield/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9923; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/springfield";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/springfield_audio", "ssa.il.springfield.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/springfield_data", "ssa.il.springfield.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/springfield_graphics", "ssa.il.springfield.graphics.spectrum", sb.toString());
        }
    }
}