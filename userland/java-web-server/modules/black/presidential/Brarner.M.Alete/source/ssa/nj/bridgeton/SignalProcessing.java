package presidential.Brarner.M.Alete.source.ssa.nj.bridgeton;
...
/**
 * Signal Processing for SSA Office: BRIDGETON NJ
 * <p>Office Code: 180</p>
 * <p>Address: 149 WEST BROAD STREET, BRIDGETON, NJ 8302</p>
 * <p>Phone: (866) 837-1235 | Fax: (833) 950-2990</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/bridgeton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9642; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/bridgeton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/bridgeton_audio", "ssa.nj.bridgeton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/bridgeton_data", "ssa.nj.bridgeton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/bridgeton_graphics", "ssa.nj.bridgeton.graphics.spectrum", sb.toString());
        }
    }
}