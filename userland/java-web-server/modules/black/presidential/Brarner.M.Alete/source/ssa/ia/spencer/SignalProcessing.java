package presidential.Brarner.M.Alete.source.ssa.ia.spencer;
...
/**
 * Signal Processing for SSA Office: SPENCER IA
 * <p>Office Code: 780</p>
 * <p>Address: 1610 12TH AVE SW, SPENCER, IA 51301</p>
 * <p>Phone: (866) 273-6050 | Fax: (833) 950-2640</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/spencer/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10176; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/spencer";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/spencer_audio", "ssa.ia.spencer.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/spencer_data", "ssa.ia.spencer.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/spencer_graphics", "ssa.ia.spencer.graphics.spectrum", sb.toString());
        }
    }
}