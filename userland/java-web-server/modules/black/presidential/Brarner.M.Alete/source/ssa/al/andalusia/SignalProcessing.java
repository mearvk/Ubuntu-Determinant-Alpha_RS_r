package presidential.Brarner.M.Alete.source.ssa.al.andalusia;
...
/**
 * Signal Processing for SSA Office: ANDALUSIA AL
 * <p>Office Code: 634</p>
 * <p>Address: 605 STANLEY AVE, ANDALUSIA, AL 36420</p>
 * <p>Phone: (877) 405-7657 | Fax: (833) 950-3507</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/andalusia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10057; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/andalusia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/andalusia_audio", "ssa.al.andalusia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/andalusia_data", "ssa.al.andalusia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/andalusia_graphics", "ssa.al.andalusia.graphics.spectrum", sb.toString());
        }
    }
}