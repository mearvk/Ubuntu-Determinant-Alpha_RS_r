package presidential.Brarner.M.Alete.source.ssa.ca.salinas;
...
/**
 * Signal Processing for SSA Office: SALINAS CA
 * <p>Office Code: 984</p>
 * <p>Address: 928 E BLANCO RD, SALINAS, CA 93901</p>
 * <p>Phone: (877) 600-2857 | Fax: (833) 950-2752</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/salinas/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10365; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/salinas";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/salinas_audio", "ssa.ca.salinas.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/salinas_data", "ssa.ca.salinas.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/salinas_graphics", "ssa.ca.salinas.graphics.spectrum", sb.toString());
        }
    }
}