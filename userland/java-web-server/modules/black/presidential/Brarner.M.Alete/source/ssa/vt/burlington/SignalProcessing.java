...
/**
 * Signal Processing for SSA Office: BURLINGTON VT
 * <p>Office Code: 22</p>
 * <p>Address: 128 LAKESIDE AVE, BURLINGTON, VT 5401</p>
 * <p>Phone: (877) 840-5776 | Fax: (833) 515-0451</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/vt/burlington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9506; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/vt/burlington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_vt/burlington_audio", "ssa.vt.burlington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_vt/burlington_data", "ssa.vt.burlington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_vt/burlington_graphics", "ssa.vt.burlington.graphics.spectrum", sb.toString());
        }
    }
}