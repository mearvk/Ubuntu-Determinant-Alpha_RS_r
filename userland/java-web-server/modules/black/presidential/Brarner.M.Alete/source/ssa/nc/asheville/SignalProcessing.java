package presidential.Brarner.M.Alete.source.ssa.nc.asheville;
...
/**
 * Signal Processing for SSA Office: ASHEVILLE NC
 * <p>Office Code: 323</p>
 * <p>Address: 800 CENTRE PARK DRIVE, ASHEVILLE, NC 28805</p>
 * <p>Phone: (866) 572-8361 | Fax: (833) 950-2542</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/asheville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9772; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/asheville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/asheville_audio", "ssa.nc.asheville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/asheville_data", "ssa.nc.asheville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/asheville_graphics", "ssa.nc.asheville.graphics.spectrum", sb.toString());
        }
    }
}