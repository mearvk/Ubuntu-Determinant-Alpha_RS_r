package presidential.Brarner.M.Alete.source.ssa.wv.welch;
...
/**
 * Signal Processing for SSA Office: WELCH WV
 * <p>Office Code: 315</p>
 * <p>Address: 50 MCDOWELL STREET, WELCH, WV 24801</p>
 * <p>Phone: (866) 273-0399 | Fax: (833) 950-2280</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/welch/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9765; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/welch";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/welch_audio", "ssa.wv.welch.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/welch_data", "ssa.wv.welch.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/welch_graphics", "ssa.wv.welch.graphics.spectrum", sb.toString());
        }
    }
}