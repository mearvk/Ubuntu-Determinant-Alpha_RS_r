package presidential.Brarner.M.Alete.source.ssa.nj.newton;
...
/**
 * Signal Processing for SSA Office: NEWTON NJ
 * <p>Office Code: C79</p>
 * <p>Address: 20 EAST CLINTON STREET, NEWTON, NJ 7860</p>
 * <p>Phone: (877) 575-5189 | Fax: (833) 950-3283</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/newton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9384; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/newton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/newton_audio", "ssa.nj.newton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/newton_data", "ssa.nj.newton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/newton_graphics", "ssa.nj.newton.graphics.spectrum", sb.toString());
        }
    }
}