package presidential.Brarner.M.Alete.source.ssa.ms.natchez;
...
/**
 * Signal Processing for SSA Office: NATCHEZ MS
 * <p>Office Code: 651</p>
 * <p>Address: 110 LOWER WOODVILLE RD, NATCHEZ, MS 39120</p>
 * <p>Phone: (877) 405-4565 | Fax: (833) 554-0363</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/natchez/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10071; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/natchez";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/natchez_audio", "ssa.ms.natchez.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/natchez_data", "ssa.ms.natchez.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/natchez_graphics", "ssa.ms.natchez.graphics.spectrum", sb.toString());
        }
    }
}