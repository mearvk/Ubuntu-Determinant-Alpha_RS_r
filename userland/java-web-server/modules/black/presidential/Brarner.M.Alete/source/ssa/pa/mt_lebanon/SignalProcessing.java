package presidential.Brarner.M.Alete.source.ssa.pa.mt_lebanon;
...
/**
 * Signal Processing for SSA Office: MT LEBANON PA
 * <p>Office Code: A34</p>
 * <p>Address: 650 WASHINGTON ROAD, PITTSBURGH, PA 15228</p>
 * <p>Phone: (888) 717-1525 | Fax: (833) 950-2576</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/mt-lebanon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9222; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/mt-lebanon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/mt-lebanon_audio", "ssa.pa.mt_lebanon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/mt-lebanon_data", "ssa.pa.mt_lebanon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/mt-lebanon_graphics", "ssa.pa.mt_lebanon.graphics.spectrum", sb.toString());
        }
    }
}