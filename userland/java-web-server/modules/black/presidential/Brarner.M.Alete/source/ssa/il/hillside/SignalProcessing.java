package presidential.Brarner.M.Alete.source.ssa.il.hillside;
...
/**
 * Signal Processing for SSA Office: HILLSIDE IL
 * <p>Office Code: 503</p>
 * <p>Address: 230 NORTH MANNHEIM RD, HILLSIDE, IL 60162</p>
 * <p>Phone: (866) 964-6290 | Fax: (833) 950-3099</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/hillside/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9938; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/hillside";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/hillside_audio", "ssa.il.hillside.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/hillside_data", "ssa.il.hillside.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/hillside_graphics", "ssa.il.hillside.graphics.spectrum", sb.toString());
        }
    }
}