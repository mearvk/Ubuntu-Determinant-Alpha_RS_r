package presidential.Brarner.M.Alete.source.ssa.mt.bozeman;
...
/**
 * Signal Processing for SSA Office: BOZEMAN MT
 * <p>Office Code: D92</p>
 * <p>Address: 3205 N 27TH AVE, BOZEMAN, MT 59718</p>
 * <p>Phone: (833) 452-0419 | Fax: (833) 950-3203</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mt/bozeman/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9451; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mt/bozeman";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mt/bozeman_audio", "ssa.mt.bozeman.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mt/bozeman_data", "ssa.mt.bozeman.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mt/bozeman_graphics", "ssa.mt.bozeman.graphics.spectrum", sb.toString());
        }
    }
}