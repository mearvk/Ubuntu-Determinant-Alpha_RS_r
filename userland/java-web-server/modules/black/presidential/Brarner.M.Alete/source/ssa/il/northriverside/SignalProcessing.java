package presidential.Brarner.M.Alete.source.ssa.il.northriverside;
...
/**
 * Signal Processing for SSA Office: NORTH RIVERSIDE IL
 * <p>Office Code: 502</p>
 * <p>Address: 7222 W CERMAK RD, NORTH RIVERSIDE, IL 60546</p>
 * <p>Phone: (888) 518-0226 | Fax: (833) 950-3097</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/northriverside/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9937; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/northriverside";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/northriverside_audio", "ssa.il.northriverside.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/northriverside_data", "ssa.il.northriverside.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/northriverside_graphics", "ssa.il.northriverside.graphics.spectrum", sb.toString());
        }
    }
}