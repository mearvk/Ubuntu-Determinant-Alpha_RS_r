package presidential.Brarner.M.Alete.source.ssa.il.kankakee;
...
/**
 * Signal Processing for SSA Office: KANKAKEE IL
 * <p>Office Code: 516</p>
 * <p>Address: 630 E. OAK ST., KANKAKEE, IL 60901</p>
 * <p>Phone: (855) 807-8801 | Fax: (833) 950-3439</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/kankakee/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9950; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/kankakee";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/kankakee_audio", "ssa.il.kankakee.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/kankakee_data", "ssa.il.kankakee.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/kankakee_graphics", "ssa.il.kankakee.graphics.spectrum", sb.toString());
        }
    }
}