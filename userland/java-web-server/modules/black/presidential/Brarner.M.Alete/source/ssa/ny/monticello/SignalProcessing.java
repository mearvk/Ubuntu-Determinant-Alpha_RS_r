package presidential.Brarner.M.Alete.source.ssa.ny.monticello;
...
/**
 * Signal Processing for SSA Office: MONTICELLO NY
 * <p>Office Code: 154</p>
 * <p>Address: 60 JEFFERSON ST, MONTICELLO, NY 12701</p>
 * <p>Phone: (855) 794-4728 | Fax: (833) 950-2678</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/monticello/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9622; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/monticello";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/monticello_audio", "ssa.ny.monticello.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/monticello_data", "ssa.ny.monticello.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/monticello_graphics", "ssa.ny.monticello.graphics.spectrum", sb.toString());
        }
    }
}