package presidential.Brarner.M.Alete.source.ssa.co.canoncity;
...
/**
 * Signal Processing for SSA Office: CANON CITY CO
 * <p>Office Code: D29</p>
 * <p>Address: 115 N 10TH ST, CANON CITY, CO 81212</p>
 * <p>Phone: (866) 272-5728 | Fax: (833) 950-2910</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/co/canoncity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9418; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/co/canoncity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_co/canoncity_audio", "ssa.co.canoncity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_co/canoncity_data", "ssa.co.canoncity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_co/canoncity_graphics", "ssa.co.canoncity.graphics.spectrum", sb.toString());
        }
    }
}