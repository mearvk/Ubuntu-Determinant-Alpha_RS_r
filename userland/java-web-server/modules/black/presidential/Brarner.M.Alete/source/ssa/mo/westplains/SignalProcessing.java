package presidential.Brarner.M.Alete.source.ssa.mo.westplains;
...
/**
 * Signal Processing for SSA Office: WEST PLAINS MO
 * <p>Office Code: 560</p>
 * <p>Address: 1612 IMPERIAL DRIVE, WEST PLAINS, MO 65775</p>
 * <p>Phone: (866) 614-2741 | Fax: (833) 873-4346</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/westplains/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9986; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/westplains";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/westplains_audio", "ssa.mo.westplains.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/westplains_data", "ssa.mo.westplains.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/westplains_graphics", "ssa.mo.westplains.graphics.spectrum", sb.toString());
        }
    }
}