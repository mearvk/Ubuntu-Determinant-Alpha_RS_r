package presidential.Brarner.M.Alete.source.ssa.nc.whiteville;
...
/**
 * Signal Processing for SSA Office: WHITEVILLE NC
 * <p>Office Code: A48</p>
 * <p>Address: 204 S LEE ST, WHITEVILLE, NC 28472</p>
 * <p>Phone: (877) 779-7257 | Fax: (833) 950-2528</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/whiteville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9233; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/whiteville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/whiteville_audio", "ssa.nc.whiteville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/whiteville_data", "ssa.nc.whiteville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/whiteville_graphics", "ssa.nc.whiteville.graphics.spectrum", sb.toString());
        }
    }
}