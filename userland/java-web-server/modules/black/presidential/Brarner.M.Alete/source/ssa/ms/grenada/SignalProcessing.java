package presidential.Brarner.M.Alete.source.ssa.ms.grenada;
...
/**
 * Signal Processing for SSA Office: GRENADA MS
 * <p>Office Code: B14</p>
 * <p>Address: 2383 SUNSET DRIVE, GRENADA, MS 38901</p>
 * <p>Phone: (866) 593-8523 | Fax: (833) 950-3125</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/grenada/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9285; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/grenada";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/grenada_audio", "ssa.ms.grenada.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/grenada_data", "ssa.ms.grenada.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/grenada_graphics", "ssa.ms.grenada.graphics.spectrum", sb.toString());
        }
    }
}