...
/**
 * Signal Processing for SSA Office: VALDOSTA GA
 * <p>Office Code: 613</p>
 * <p>Address: 3149 PERIMETER PARK LN, VALDOSTA, GA 31602</p>
 * <p>Phone: (866) 829-2617 | Fax: (833) 950-2864</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/valdosta/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10036; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/valdosta";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/valdosta_audio", "ssa.ga.valdosta.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/valdosta_data", "ssa.ga.valdosta.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/valdosta_graphics", "ssa.ga.valdosta.graphics.spectrum", sb.toString());
        }
    }
}