package presidential.Brarner.M.Alete.source.ssa.ca.crescentcity;
...
/**
 * Signal Processing for SSA Office: CRESCENT CITY CA
 * <p>Office Code: A17</p>
 * <p>Address: 560 E HOOVER AVE, CRESCENT CITY, CA 95531</p>
 * <p>Phone: (855) 727-3600 | Fax: (833) 950-3359</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/crescentcity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9209; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/crescentcity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/crescentcity_audio", "ssa.ca.crescentcity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/crescentcity_data", "ssa.ca.crescentcity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/crescentcity_graphics", "ssa.ca.crescentcity.graphics.spectrum", sb.toString());
        }
    }
}