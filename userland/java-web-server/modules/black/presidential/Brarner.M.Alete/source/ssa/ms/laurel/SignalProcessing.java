package presidential.Brarner.M.Alete.source.ssa.ms.laurel;
...
/**
 * Signal Processing for SSA Office: LAUREL MS
 * <p>Office Code: 652</p>
 * <p>Address: 3210 HWY 15 N, LAUREL, MS 39440</p>
 * <p>Phone: (866) 964-4927 | Fax: (833) 554-0365</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/laurel/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10072; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/laurel";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/laurel_audio", "ssa.ms.laurel.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/laurel_data", "ssa.ms.laurel.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/laurel_graphics", "ssa.ms.laurel.graphics.spectrum", sb.toString());
        }
    }
}