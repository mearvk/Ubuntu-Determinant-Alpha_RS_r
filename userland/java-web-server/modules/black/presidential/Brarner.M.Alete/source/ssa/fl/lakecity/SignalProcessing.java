package presidential.Brarner.M.Alete.source.ssa.fl.lakecity;
...
/**
 * Signal Processing for SSA Office: LAKE CITY FL
 * <p>Office Code: 255</p>
 * <p>Address: 1348 SW BASCOM NORRIS, LAKE CITY, FL 32025</p>
 * <p>Phone: (877) 600-2859 | Fax: (833) 905-2054</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/lakecity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9709; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/lakecity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/lakecity_audio", "ssa.fl.lakecity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/lakecity_data", "ssa.fl.lakecity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/lakecity_graphics", "ssa.fl.lakecity.graphics.spectrum", sb.toString());
        }
    }
}