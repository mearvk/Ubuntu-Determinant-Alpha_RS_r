package presidential.Brarner.M.Alete.source.ssa.ca.norwalk;
...
/**
 * Signal Processing for SSA Office: NORWALK CA
 * <p>Office Code: 562</p>
 * <p>Address: 12440 E IMPERIAL HWY, NORWALK, CA 90650</p>
 * <p>Phone: (866) 331-3281 | Fax: (833) 950-3381</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/norwalk/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9988; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/norwalk";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/norwalk_audio", "ssa.ca.norwalk.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/norwalk_data", "ssa.ca.norwalk.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/norwalk_graphics", "ssa.ca.norwalk.graphics.spectrum", sb.toString());
        }
    }
}