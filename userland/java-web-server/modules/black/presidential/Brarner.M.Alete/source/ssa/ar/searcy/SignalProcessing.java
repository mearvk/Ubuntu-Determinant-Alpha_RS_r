package presidential.Brarner.M.Alete.source.ssa.ar.searcy;
...
/**
 * Signal Processing for SSA Office: SEARCY AR
 * <p>Office Code: A68</p>
 * <p>Address: 701 AIRPORT LOOP, SEARCY, AR 72143</p>
 * <p>Phone: (855) 686-1467 | Fax: (833) 902-2565</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/searcy/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9249; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/searcy";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/searcy_audio", "ssa.ar.searcy.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/searcy_data", "ssa.ar.searcy.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/searcy_graphics", "ssa.ar.searcy.graphics.spectrum", sb.toString());
        }
    }
}