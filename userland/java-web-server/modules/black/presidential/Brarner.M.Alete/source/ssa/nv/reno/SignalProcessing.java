package presidential.Brarner.M.Alete.source.ssa.nv.reno;
...
/**
 * Signal Processing for SSA Office: RENO NV
 * <p>Office Code: 945</p>
 * <p>Address: 1170 HARVARD WAY, RENO, NV 89502</p>
 * <p>Phone: (888) 808-5481 | Fax: (833) 571-2615</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nv/reno/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10327; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nv/reno";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nv/reno_audio", "ssa.nv.reno.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nv/reno_data", "ssa.nv.reno.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nv/reno_graphics", "ssa.nv.reno.graphics.spectrum", sb.toString());
        }
    }
}