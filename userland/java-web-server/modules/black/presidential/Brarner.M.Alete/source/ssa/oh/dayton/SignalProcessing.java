...
/**
 * Signal Processing for SSA Office: DAYTON OH
 * <p>Office Code: 402</p>
 * <p>Address: 200 W 2ND STREET, DAYTON, OH 45402</p>
 * <p>Phone: (888) 329-5724 | Fax: (833) 950-3421</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/dayton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9843; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/dayton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/dayton_audio", "ssa.oh.dayton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/dayton_data", "ssa.oh.dayton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/dayton_graphics", "ssa.oh.dayton.graphics.spectrum", sb.toString());
        }
    }
}