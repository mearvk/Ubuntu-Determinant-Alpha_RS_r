package presidential.Brarner.M.Alete.source.ssa.wa.everett;
...
/**
 * Signal Processing for SSA Office: EVERETT
 * <p>Office Code: 922</p>
 * <p>Address: 3809 BROADWAY, EVERETT, WA 98201</p>
 * <p>Phone: (866) 563-4595 | Fax: (833) 950-2616</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/everett/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10305; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/everett";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/everett_audio", "ssa.wa.everett.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/everett_data", "ssa.wa.everett.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/everett_graphics", "ssa.wa.everett.graphics.spectrum", sb.toString());
        }
    }
}