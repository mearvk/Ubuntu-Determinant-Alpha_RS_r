package presidential.Brarner.M.Alete.source.ssa.nc.salisbury;
...
/**
 * Signal Processing for SSA Office: SALISBURY NC
 * <p>Office Code: 321</p>
 * <p>Address: 1840 JAKE ALEXANDER BLVD W, SALISBURY, NC 28147</p>
 * <p>Phone: (877) 405-3157 | Fax: (833) 950-2538</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/salisbury/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9770; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/salisbury";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/salisbury_audio", "ssa.nc.salisbury.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/salisbury_data", "ssa.nc.salisbury.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/salisbury_graphics", "ssa.nc.salisbury.graphics.spectrum", sb.toString());
        }
    }
}