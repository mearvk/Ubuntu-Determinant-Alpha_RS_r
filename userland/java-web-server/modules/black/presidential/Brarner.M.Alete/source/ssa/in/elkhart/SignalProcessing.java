package presidential.Brarner.M.Alete.source.ssa.in.elkhart;
...
/**
 * Signal Processing for SSA Office: ELKHART IN
 * <p>Office Code: 467</p>
 * <p>Address: 231 WATERFALL DRIVE, ELKHART, IN 46516</p>
 * <p>Phone: (866) 426-0532 | Fax: (833) 950-2146</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/elkhart/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9904; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/elkhart";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/elkhart_audio", "ssa.in.elkhart.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/elkhart_data", "ssa.in.elkhart.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/elkhart_graphics", "ssa.in.elkhart.graphics.spectrum", sb.toString());
        }
    }
}