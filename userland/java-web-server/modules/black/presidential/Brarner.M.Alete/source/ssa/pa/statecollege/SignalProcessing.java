package presidential.Brarner.M.Alete.source.ssa.pa.statecollege;
...
/**
 * Signal Processing for SSA Office: STATE COLLEGE PA
 * <p>Office Code: 236</p>
 * <p>Address: 901 UNIVERSITY DR, STATE COLLEGE, PA 16801</p>
 * <p>Phone: (866) 864-1516 | Fax: (833) 597-0159</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/statecollege/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9693; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/statecollege";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/statecollege_audio", "ssa.pa.statecollege.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/statecollege_data", "ssa.pa.statecollege.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/statecollege_graphics", "ssa.pa.statecollege.graphics.spectrum", sb.toString());
        }
    }
}