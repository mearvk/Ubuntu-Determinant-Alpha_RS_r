package presidential.Brarner.M.Alete.source.ssa.or.salem;
...
/**
 * Signal Processing for SSA Office: SALEM OR
 * <p>Office Code: 935</p>
 * <p>Address: 1750 MCGILCHRIST ST SE, SALEM, OR 97302</p>
 * <p>Phone: (866) 593-1559 | Fax: (833) 950-2914</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/or/salem/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10317; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/or/salem";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_or/salem_audio", "ssa.or.salem.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_or/salem_data", "ssa.or.salem.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_or/salem_graphics", "ssa.or.salem.graphics.spectrum", sb.toString());
        }
    }
}