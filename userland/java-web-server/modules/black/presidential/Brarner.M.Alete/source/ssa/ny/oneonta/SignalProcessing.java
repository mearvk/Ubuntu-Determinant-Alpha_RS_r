package presidential.Brarner.M.Alete.source.ssa.ny.oneonta;
...
/**
 * Signal Processing for SSA Office: ONEONTA NY
 * <p>Office Code: 146</p>
 * <p>Address: 31 MAIN ST, ONEONTA, NY 13820</p>
 * <p>Phone: (877) 628-6581 | Fax: (833) 950-2372</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/oneonta/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9614; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/oneonta";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/oneonta_audio", "ssa.ny.oneonta.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/oneonta_data", "ssa.ny.oneonta.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/oneonta_graphics", "ssa.ny.oneonta.graphics.spectrum", sb.toString());
        }
    }
}