package presidential.Brarner.M.Alete.source.ssa.ca.valencia;
...
/**
 * Signal Processing for SSA Office: SANTA CLARITA CA
 * <p>Office Code: A10</p>
 * <p>Address: 27200 TOURNEY RD, VALENCIA, CA 91355</p>
 * <p>Phone: (888) 632-7072 | Fax: (833) 950-3035</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/valencia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9206; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/valencia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/valencia_audio", "ssa.ca.valencia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/valencia_data", "ssa.ca.valencia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/valencia_graphics", "ssa.ca.valencia.graphics.spectrum", sb.toString());
        }
    }
}