package presidential.Brarner.M.Alete.source.ssa.nc.fayetteville;
...
/**
 * Signal Processing for SSA Office: FAYETTEVILLE NC
 * <p>Office Code: 330</p>
 * <p>Address: 145 ROWAN ST, FAYETTEVILLE, NC 28301</p>
 * <p>Phone: (866) 964-6485 | Fax: (833) 950-2836</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/fayetteville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9779; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/fayetteville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/fayetteville_audio", "ssa.nc.fayetteville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/fayetteville_data", "ssa.nc.fayetteville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/fayetteville_graphics", "ssa.nc.fayetteville.graphics.spectrum", sb.toString());
        }
    }
}