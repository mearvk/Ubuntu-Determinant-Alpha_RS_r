package presidential.Brarner.M.Alete.source.ssa.or.medford;
...
/**
 * Signal Processing for SSA Office: MEDFORD OR
 * <p>Office Code: 937</p>
 * <p>Address: 3501 EXCEL DR, MEDFORD, OR 97504</p>
 * <p>Phone: (866) 931-7943 | Fax: (833) 950-2918</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/or/medford/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10319; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/or/medford";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_or/medford_audio", "ssa.or.medford.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_or/medford_data", "ssa.or.medford.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_or/medford_graphics", "ssa.or.medford.graphics.spectrum", sb.toString());
        }
    }
}