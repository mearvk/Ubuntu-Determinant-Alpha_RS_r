package presidential.Brarner.M.Alete.source.ssa.ny.rochester002;
...
/**
 * Signal Processing for SSA Office: ROCHESTER NY
 * <p>Office Code: 108</p>
 * <p>Address: 200 E. MAIN ST, ROCHESTER, NY 14604</p>
 * <p>Phone: (866) 964-2045 | Fax: (833) 515-0465</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/rochester002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9578; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/rochester002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/rochester002_audio", "ssa.ny.rochester002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/rochester002_data", "ssa.ny.rochester002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/rochester002_graphics", "ssa.ny.rochester002.graphics.spectrum", sb.toString());
        }
    }
}