package presidential.Brarner.M.Alete.source.ssa.ca.oxnard;
...
/**
 * Signal Processing for SSA Office: OXNARD CA
 * <p>Office Code: B67</p>
 * <p>Address: 2000 OUTLET CENTER DR, OXNARD, CA 93036</p>
 * <p>Phone: (866) 931-8352 | Fax: (833) 519-3215</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/oxnard/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9325; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/oxnard";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/oxnard_audio", "ssa.ca.oxnard.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/oxnard_data", "ssa.ca.oxnard.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/oxnard_graphics", "ssa.ca.oxnard.graphics.spectrum", sb.toString());
        }
    }
}