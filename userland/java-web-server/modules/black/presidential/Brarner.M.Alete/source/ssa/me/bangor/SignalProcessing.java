...
/**
 * Signal Processing for SSA Office: BANGOR ME
 * <p>Office Code: 2</p>
 * <p>Address: 202 HARLOW ST, BANGOR, ME 4401</p>
 * <p>Phone: (877) 405-1448 | Fax: (833) 950-3577</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/me/bangor/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9491; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/me/bangor";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_me/bangor_audio", "ssa.me.bangor.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_me/bangor_data", "ssa.me.bangor.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_me/bangor_graphics", "ssa.me.bangor.graphics.spectrum", sb.toString());
        }
    }
}