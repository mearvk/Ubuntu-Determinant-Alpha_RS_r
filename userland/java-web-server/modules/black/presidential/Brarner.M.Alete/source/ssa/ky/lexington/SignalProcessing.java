package presidential.Brarner.M.Alete.source.ssa.ky.lexington;
...
/**
 * Signal Processing for SSA Office: LEXINGTON KY
 * <p>Office Code: 439</p>
 * <p>Address: 2241 BUENA VISTA RD, LEXINGTON, KY 40505</p>
 * <p>Phone: (866) 530-7754 | Fax: (833) 950-3153</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/lexington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9876; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/lexington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/lexington_audio", "ssa.ky.lexington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/lexington_data", "ssa.ky.lexington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/lexington_graphics", "ssa.ky.lexington.graphics.spectrum", sb.toString());
        }
    }
}