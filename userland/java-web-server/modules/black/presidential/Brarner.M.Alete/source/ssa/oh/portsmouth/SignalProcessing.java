package presidential.Brarner.M.Alete.source.ssa.oh.portsmouth;
...
/**
 * Signal Processing for SSA Office: PORTSMOUTH OH
 * <p>Office Code: 401</p>
 * <p>Address: 921 FOURTH STREET, PORTSMOUTH, OH 45662</p>
 * <p>Phone: (866) 613-3961 | Fax: (833) 950-3419</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/portsmouth/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9842; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/portsmouth";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/portsmouth_audio", "ssa.oh.portsmouth.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/portsmouth_data", "ssa.oh.portsmouth.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/portsmouth_graphics", "ssa.oh.portsmouth.graphics.spectrum", sb.toString());
        }
    }
}