package presidential.Brarner.M.Alete.source.ssa.va.martinsville;
...
/**
 * Signal Processing for SSA Office: MARTINSVILLE VA
 * <p>Office Code: A40</p>
 * <p>Address: 320 COMMONWEALTH BLVD W, MARTINSVILLE, VA 24112</p>
 * <p>Phone: (877) 405-9780 | Fax: (833) 912-2312</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/martinsville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9226; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/martinsville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/martinsville_audio", "ssa.va.martinsville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/martinsville_data", "ssa.va.martinsville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/martinsville_graphics", "ssa.va.martinsville.graphics.spectrum", sb.toString());
        }
    }
}