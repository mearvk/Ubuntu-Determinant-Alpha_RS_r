package presidential.Brarner.M.Alete.source.ssa.mo.kansascity003;
...
/**
 * Signal Processing for SSA Office: KANSAS CITY SOUTH MO
 * <p>Office Code: 736</p>
 * <p>Address: 6320 EUCLID AVE, KANSAS CITY, MO 64132</p>
 * <p>Phone: (888) 488-9417 | Fax: (833) 902-2502</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/kansascity003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10138; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/kansascity003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity003_audio", "ssa.mo.kansascity003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity003_data", "ssa.mo.kansascity003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity003_graphics", "ssa.mo.kansascity003.graphics.spectrum", sb.toString());
        }
    }
}