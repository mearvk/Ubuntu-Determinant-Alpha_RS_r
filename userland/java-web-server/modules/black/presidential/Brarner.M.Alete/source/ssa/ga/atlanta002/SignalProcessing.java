package presidential.Brarner.M.Alete.source.ssa.ga.atlanta002;
...
/**
 * Signal Processing for SSA Office: ATLANTA WEST GA
 * <p>Office Code: 720</p>
 * <p>Address: 3800 CAMP CREEK PKWY, ATLANTA, GA 30331</p>
 * <p>Phone: (877) 828-1694 | Fax: (833) 913-2075</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/atlanta002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10128; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/atlanta002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/atlanta002_audio", "ssa.ga.atlanta002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/atlanta002_data", "ssa.ga.atlanta002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/atlanta002_graphics", "ssa.ga.atlanta002.graphics.spectrum", sb.toString());
        }
    }
}