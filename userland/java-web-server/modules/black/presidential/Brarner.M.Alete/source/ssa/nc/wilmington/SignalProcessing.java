package presidential.Brarner.M.Alete.source.ssa.nc.wilmington;
...
/**
 * Signal Processing for SSA Office: WILMINGTON NC
 * <p>Office Code: 327</p>
 * <p>Address: 1528 S 16TH ST, WILMINGTON, NC 28401</p>
 * <p>Phone: (866) 964-6227 | Fax: (833) 950-2550</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/wilmington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9776; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/wilmington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/wilmington_audio", "ssa.nc.wilmington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/wilmington_data", "ssa.nc.wilmington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/wilmington_graphics", "ssa.nc.wilmington.graphics.spectrum", sb.toString());
        }
    }
}