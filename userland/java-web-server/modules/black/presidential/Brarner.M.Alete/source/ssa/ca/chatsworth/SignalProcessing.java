...
/**
 * Signal Processing for SSA Office: CHATSWORTH CA
 * <p>Office Code: 62</p>
 * <p>Address: 20439 NORDHOFF ST, CHATSWORTH, CA 91311</p>
 * <p>Phone: (855) 727-3598 | Fax: (833) 950-2438</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/chatsworth/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9542; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/chatsworth";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/chatsworth_audio", "ssa.ca.chatsworth.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/chatsworth_data", "ssa.ca.chatsworth.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/chatsworth_graphics", "ssa.ca.chatsworth.graphics.spectrum", sb.toString());
        }
    }
}