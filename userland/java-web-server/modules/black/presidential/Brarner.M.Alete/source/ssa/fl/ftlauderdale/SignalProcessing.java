...
/**
 * Signal Processing for SSA Office: FT LAUDERDALE EAST FL
 * <p>Office Code: 665</p>
 * <p>Address: 3201 W COMMERCIAL BLVD, FT LAUDERDALE, FL 33309</p>
 * <p>Phone: (877) 253-4720 | Fax: (833) 710-0167</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/ftlauderdale/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10084; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/ftlauderdale";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/ftlauderdale_audio", "ssa.fl.ftlauderdale.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/ftlauderdale_data", "ssa.fl.ftlauderdale.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/ftlauderdale_graphics", "ssa.fl.ftlauderdale.graphics.spectrum", sb.toString());
        }
    }
}