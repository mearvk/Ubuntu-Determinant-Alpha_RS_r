...
/**
 * Signal Processing for SSA Office: BOISE ID
 * <p>Office Code: 893</p>
 * <p>Address: 1249 S VINNELL WAY, BOISE, ID 83709</p>
 * <p>Phone: (855) 377-9316 | Fax: (833) 912-2549</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/id/boise/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10277; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/id/boise";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_id/boise_audio", "ssa.id.boise.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_id/boise_data", "ssa.id.boise.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_id/boise_graphics", "ssa.id.boise.graphics.spectrum", sb.toString());
        }
    }
}