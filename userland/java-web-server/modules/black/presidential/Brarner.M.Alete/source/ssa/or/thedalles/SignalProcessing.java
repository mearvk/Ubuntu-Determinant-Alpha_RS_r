package presidential.Brarner.M.Alete.source.ssa.or.thedalles;
...
/**
 * Signal Processing for SSA Office: THE DALLES OR
 * <p>Office Code: 689</p>
 * <p>Address: 401 E 3RD ST, THE DALLES, OR 97058</p>
 * <p>Phone: (877) 405-3526 | Fax: (833) 912-2547</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/or/thedalles/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10103; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/or/thedalles";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_or/thedalles_audio", "ssa.or.thedalles.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_or/thedalles_data", "ssa.or.thedalles.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_or/thedalles_graphics", "ssa.or.thedalles.graphics.spectrum", sb.toString());
        }
    }
}