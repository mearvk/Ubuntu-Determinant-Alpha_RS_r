package presidential.Brarner.M.Alete.source.ssa.ok.poteau;
...
/**
 * Signal Processing for SSA Office: POTEAU OK
 * <p>Office Code: E32</p>
 * <p>Address: 1306 TARBY RD, POTEAU, OK 74953</p>
 * <p>Phone: (877) 405-7697 | Fax: (833) 950-2381</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/poteau/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9463; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/poteau";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/poteau_audio", "ssa.ok.poteau.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/poteau_data", "ssa.ok.poteau.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/poteau_graphics", "ssa.ok.poteau.graphics.spectrum", sb.toString());
        }
    }
}