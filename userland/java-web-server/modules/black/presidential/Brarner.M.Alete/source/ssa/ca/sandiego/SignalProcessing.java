package presidential.Brarner.M.Alete.source.ssa.ca.sandiego;
...
/**
 * Signal Processing for SSA Office: KEARNY MESA CA
 * <p>Office Code: D41</p>
 * <p>Address: 8505 AERO DR, SAN DIEGO, CA 92123</p>
 * <p>Phone: (866) 331-6397 | Fax: (833) 902-2596</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sandiego/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9426; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sandiego";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sandiego_audio", "ssa.ca.sandiego.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sandiego_data", "ssa.ca.sandiego.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sandiego_graphics", "ssa.ca.sandiego.graphics.spectrum", sb.toString());
        }
    }
}