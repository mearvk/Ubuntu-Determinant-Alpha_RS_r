package presidential.Brarner.M.Alete.source.ssa.va.farmville;
...
/**
 * Signal Processing for SSA Office: FARMVILLE VA
 * <p>Office Code: 301</p>
 * <p>Address: 324 COMMERCE ROAD, FARMVILLE, VA 23901</p>
 * <p>Phone: (866) 269-4346 | Fax: (833) 950-2598</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/farmville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9751; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/farmville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/farmville_audio", "ssa.va.farmville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/farmville_data", "ssa.va.farmville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/farmville_graphics", "ssa.va.farmville.graphics.spectrum", sb.toString());
        }
    }
}