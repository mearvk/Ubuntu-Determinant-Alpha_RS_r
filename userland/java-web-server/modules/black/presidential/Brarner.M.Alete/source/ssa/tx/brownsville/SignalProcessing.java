package presidential.Brarner.M.Alete.source.ssa.tx.brownsville;
...
/**
 * Signal Processing for SSA Office: BROWNSVILLE TX
 * <p>Office Code: 824</p>
 * <p>Address: 3115 CENTRAL BLVD, BROWNSVILLE, TX 78520</p>
 * <p>Phone: (866) 964-6486 | Fax: (833) 902-2576</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/brownsville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10215; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/brownsville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/brownsville_audio", "ssa.tx.brownsville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/brownsville_data", "ssa.tx.brownsville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/brownsville_graphics", "ssa.tx.brownsville.graphics.spectrum", sb.toString());
        }
    }
}