package presidential.Brarner.M.Alete.source.ssa.mn.bloomington;
...
/**
 * Signal Processing for SSA Office: BLOOMINGTON
 * <p>Office Code: C40</p>
 * <p>Address: 6161 AMERICAN BLVD W, BLOOMINGTON, MN 55438</p>
 * <p>Phone: (866) 964-7341 | Fax: (833) 950-3409</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/bloomington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9361; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/bloomington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/bloomington_audio", "ssa.mn.bloomington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/bloomington_data", "ssa.mn.bloomington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/bloomington_graphics", "ssa.mn.bloomington.graphics.spectrum", sb.toString());
        }
    }
}