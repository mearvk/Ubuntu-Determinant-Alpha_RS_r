package presidential.Brarner.M.Alete.source.ssa.ny.binghamton;
...
/**
 * Signal Processing for SSA Office: BINGHAMTON NY
 * <p>Office Code: 104</p>
 * <p>Address: 2 COURT STREET, BINGHAMTON, NY 13901</p>
 * <p>Phone: (866) 964-3971 | Fax: (833) 950-3607</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/binghamton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9575; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/binghamton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/binghamton_audio", "ssa.ny.binghamton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/binghamton_data", "ssa.ny.binghamton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/binghamton_graphics", "ssa.ny.binghamton.graphics.spectrum", sb.toString());
        }
    }
}