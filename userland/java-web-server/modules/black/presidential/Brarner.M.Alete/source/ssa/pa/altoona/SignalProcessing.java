package presidential.Brarner.M.Alete.source.ssa.pa.altoona;
...
/**
 * Signal Processing for SSA Office: ALTOONA PA
 * <p>Office Code: 207</p>
 * <p>Address: 303 CAYUGA AVE, ALTOONA, PA 16602</p>
 * <p>Phone: (888) 245-5368 | Fax: (833) 950-3181</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/altoona/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9665; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/altoona";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/altoona_audio", "ssa.pa.altoona.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/altoona_data", "ssa.pa.altoona.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/altoona_graphics", "ssa.pa.altoona.graphics.spectrum", sb.toString());
        }
    }
}