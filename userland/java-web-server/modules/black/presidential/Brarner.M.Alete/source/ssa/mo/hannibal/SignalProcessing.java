...
/**
 * Signal Processing for SSA Office: HANNIBAL MO
 * <p>Office Code: 741</p>
 * <p>Address: 155 FORREST DRIVE, HANNIBAL, MO 63401</p>
 * <p>Phone: (866) 331-7094 | Fax: (833) 923-0554</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/hannibal/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10143; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/hannibal";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/hannibal_audio", "ssa.mo.hannibal.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/hannibal_data", "ssa.mo.hannibal.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/hannibal_graphics", "ssa.mo.hannibal.graphics.spectrum", sb.toString());
        }
    }
}