package presidential.Brarner.M.Alete.source.ssa.nc.rockingham;
...
/**
 * Signal Processing for SSA Office: ROCKINGHAM NC
 * <p>Office Code: 342</p>
 * <p>Address: 220 E GREENE ST, ROCKINGHAM, NC 28379</p>
 * <p>Phone: (877) 405-7673 | Fax: (833) 950-3141</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/rockingham/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9789; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/rockingham";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/rockingham_audio", "ssa.nc.rockingham.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/rockingham_data", "ssa.nc.rockingham.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/rockingham_graphics", "ssa.nc.rockingham.graphics.spectrum", sb.toString());
        }
    }
}