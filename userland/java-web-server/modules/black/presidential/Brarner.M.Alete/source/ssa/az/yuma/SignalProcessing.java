...
/**
 * Signal Processing for SSA Office: YUMA AZ
 * <p>Office Code: 911</p>
 * <p>Address: 325 W 19TH ST, YUMA, AZ 85364</p>
 * <p>Phone: (866) 613-2970 | Fax: (833) 950-3679</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/az/yuma/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10294; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/az/yuma";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_az/yuma_audio", "ssa.az.yuma.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_az/yuma_data", "ssa.az.yuma.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_az/yuma_graphics", "ssa.az.yuma.graphics.spectrum", sb.toString());
        }
    }
}