package presidential.Brarner.M.Alete.source.ssa.mi.redford;
...
/**
 * Signal Processing for SSA Office: DETROIT-NW MI
 * <p>Office Code: 363</p>
 * <p>Address: 26840 W SEVEN MILE RD, REDFORD, MI 48240</p>
 * <p>Phone: (888) 329-5729 | Fax: (833) 950-2470</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/redford/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9810; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/redford";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/redford_audio", "ssa.mi.redford.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/redford_data", "ssa.mi.redford.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/redford_graphics", "ssa.mi.redford.graphics.spectrum", sb.toString());
        }
    }
}