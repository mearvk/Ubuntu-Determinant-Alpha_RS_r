package presidential.Brarner.M.Alete.source.ssa.wi.lacrosse;
...
/**
 * Signal Processing for SSA Office: LA CROSSE WI
 * <p>Office Code: 541</p>
 * <p>Address: 210 7TH ST S, LA CROSSE, WI 54601</p>
 * <p>Phone: (866) 770-2345 | Fax: (833) 950-3747</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/lacrosse/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9970; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/lacrosse";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/lacrosse_audio", "ssa.wi.lacrosse.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/lacrosse_data", "ssa.wi.lacrosse.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/lacrosse_graphics", "ssa.wi.lacrosse.graphics.spectrum", sb.toString());
        }
    }
}