package presidential.Brarner.M.Alete.source.ssa.tx.beaumont;
...
/**
 * Signal Processing for SSA Office: BEAUMONT TX
 * <p>Office Code: 818</p>
 * <p>Address: 8455 DISHMAN RD, BEAUMONT, TX 77713</p>
 * <p>Phone: (866) 613-2864 | Fax: (833) 515-0524</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/beaumont/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10209; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/beaumont";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/beaumont_audio", "ssa.tx.beaumont.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/beaumont_data", "ssa.tx.beaumont.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/beaumont_graphics", "ssa.tx.beaumont.graphics.spectrum", sb.toString());
        }
    }
}