package presidential.Brarner.M.Alete.source.ssa.md.frederick;
...
/**
 * Signal Processing for SSA Office: FREDERICK MD
 * <p>Office Code: 529</p>
 * <p>Address: 5340 SPECTRUM DRIVE, FREDERICK, MD 21703</p>
 * <p>Phone: (866) 331-7089 | Fax: (833) 912-2294</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/frederick/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9960; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/frederick";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/frederick_audio", "ssa.md.frederick.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/frederick_data", "ssa.md.frederick.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/frederick_graphics", "ssa.md.frederick.graphics.spectrum", sb.toString());
        }
    }
}