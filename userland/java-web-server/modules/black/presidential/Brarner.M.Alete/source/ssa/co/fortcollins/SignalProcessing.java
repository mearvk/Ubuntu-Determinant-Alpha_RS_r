...
/**
 * Signal Processing for SSA Office: FORT COLLINS CO
 * <p>Office Code: 891</p>
 * <p>Address: 301 S HOWES ST, FORT COLLINS, CO 80521</p>
 * <p>Phone: (866) 336-7385 | Fax: (833) 641-3165</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/co/fortcollins/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10276; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/co/fortcollins";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_co/fortcollins_audio", "ssa.co.fortcollins.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_co/fortcollins_data", "ssa.co.fortcollins.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_co/fortcollins_graphics", "ssa.co.fortcollins.graphics.spectrum", sb.toString());
        }
    }
}