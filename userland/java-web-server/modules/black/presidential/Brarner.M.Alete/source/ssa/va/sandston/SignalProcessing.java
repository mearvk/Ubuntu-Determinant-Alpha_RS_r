package presidential.Brarner.M.Alete.source.ssa.va.sandston;
...
/**
 * Signal Processing for SSA Office: RICHMOND EAST VA
 * <p>Office Code: 300</p>
 * <p>Address: 245 E. WILLIAMSBURG RD, SANDSTON, VA 23150</p>
 * <p>Phone: (866) 218-2307 | Fax: (833) 950-2596</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/sandston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9750; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/sandston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/sandston_audio", "ssa.va.sandston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/sandston_data", "ssa.va.sandston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/sandston_graphics", "ssa.va.sandston.graphics.spectrum", sb.toString());
        }
    }
}