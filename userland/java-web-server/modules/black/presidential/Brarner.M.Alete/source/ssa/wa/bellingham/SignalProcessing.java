package presidential.Brarner.M.Alete.source.ssa.wa.bellingham;
...
/**
 * Signal Processing for SSA Office: BELLINGHAM WA
 * <p>Office Code: 920</p>
 * <p>Address: 710 ALABAMA ST, BELLINGHAM, WA 98225</p>
 * <p>Phone: (866) 256-6906 | Fax: (833) 950-2612</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/bellingham/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10303; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/bellingham";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/bellingham_audio", "ssa.wa.bellingham.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/bellingham_data", "ssa.wa.bellingham.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/bellingham_graphics", "ssa.wa.bellingham.graphics.spectrum", sb.toString());
        }
    }
}