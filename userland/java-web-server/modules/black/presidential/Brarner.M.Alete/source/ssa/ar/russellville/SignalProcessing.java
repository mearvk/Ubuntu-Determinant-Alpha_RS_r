package presidential.Brarner.M.Alete.source.ssa.ar.russellville;
...
/**
 * Signal Processing for SSA Office: RUSSELLVILLE AR
 * <p>Office Code: 766</p>
 * <p>Address: 2708 E PARKWAY DRIVE, RUSSELLVILLE, AR 72802</p>
 * <p>Phone: (877) 445-0827 | Fax: (833) 950-3001</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/russellville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10163; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/russellville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/russellville_audio", "ssa.ar.russellville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/russellville_data", "ssa.ar.russellville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/russellville_graphics", "ssa.ar.russellville.graphics.spectrum", sb.toString());
        }
    }
}