package presidential.Brarner.M.Alete.source.ssa.va.wise;
...
/**
 * Signal Processing for SSA Office: WISE VA
 * <p>Office Code: 299</p>
 * <p>Address: 253 RIDGEVIEW ROAD SW, WISE, VA 24293</p>
 * <p>Phone: (877) 405-7843 | Fax: (833) 950-2594</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/wise/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9749; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/wise";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/wise_audio", "ssa.va.wise.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/wise_data", "ssa.va.wise.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/wise_graphics", "ssa.va.wise.graphics.spectrum", sb.toString());
        }
    }
}