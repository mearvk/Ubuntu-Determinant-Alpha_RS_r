...
/**
 * Signal Processing for SSA Office: CORNING NY
 * <p>Office Code: 140</p>
 * <p>Address: 200 NASSER CIVIC CENTER PLZ, CORNING, NY 14830</p>
 * <p>Phone: (866) 591-3665 | Fax: (833) 950-2362</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/corning/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9609; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/corning";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/corning_audio", "ssa.ny.corning.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/corning_data", "ssa.ny.corning.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/corning_graphics", "ssa.ny.corning.graphics.spectrum", sb.toString());
        }
    }
}