package presidential.Brarner.M.Alete.source.ssa.fl.tampa;
...
/**
 * Signal Processing for SSA Office: TAMPA FL
 * <p>Office Code: 656</p>
 * <p>Address: 7012 W HILLSBOROUGH AVE, TAMPA, FL 33634</p>
 * <p>Phone: (866) 331-2317 | Fax: (833) 579-0465</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/tampa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10075; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/tampa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/tampa_audio", "ssa.fl.tampa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/tampa_data", "ssa.fl.tampa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/tampa_graphics", "ssa.fl.tampa.graphics.spectrum", sb.toString());
        }
    }
}