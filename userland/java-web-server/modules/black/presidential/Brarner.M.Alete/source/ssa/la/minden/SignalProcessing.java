package presidential.Brarner.M.Alete.source.ssa.la.minden;
...
/**
 * Signal Processing for SSA Office: MINDEN LA
 * <p>Office Code: 713</p>
 * <p>Address: 103 MBL BANK DRIVE, MINDEN, LA 71055</p>
 * <p>Phone: (877) 319-5762 | Fax: (833) 950-2694</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/minden/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10123; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/minden";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/minden_audio", "ssa.la.minden.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/minden_data", "ssa.la.minden.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/minden_graphics", "ssa.la.minden.graphics.spectrum", sb.toString());
        }
    }
}