...
/**
 * Signal Processing for SSA Office: WATERLOO IA
 * <p>Office Code: 693</p>
 * <p>Address: 3121 GREYHOUND DR, WATERLOO, IA 50701</p>
 * <p>Phone: (888) 456-9554 | Fax: (833) 515-0425</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/waterloo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10107; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/waterloo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/waterloo_audio", "ssa.ia.waterloo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/waterloo_data", "ssa.ia.waterloo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/waterloo_graphics", "ssa.ia.waterloo.graphics.spectrum", sb.toString());
        }
    }
}