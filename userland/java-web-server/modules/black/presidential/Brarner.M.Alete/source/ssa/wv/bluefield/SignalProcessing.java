package presidential.Brarner.M.Alete.source.ssa.wv.bluefield;
...
/**
 * Signal Processing for SSA Office: BLUEFIELD WV
 * <p>Office Code: 311</p>
 * <p>Address: 3014 E CUMBERLAND ROAD, BLUEFIELD, WV 24701</p>
 * <p>Phone: (888) 475-0295 | Fax: (833) 950-2263</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/bluefield/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9761; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/bluefield";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/bluefield_audio", "ssa.wv.bluefield.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/bluefield_data", "ssa.wv.bluefield.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/bluefield_graphics", "ssa.wv.bluefield.graphics.spectrum", sb.toString());
        }
    }
}