package presidential.Brarner.M.Alete.source.ssa.pa.indiana;
...
/**
 * Signal Processing for SSA Office: INDIANA PA
 * <p>Office Code: 238</p>
 * <p>Address: 1265 WAYNE AVE, INDIANA, PA 15701</p>
 * <p>Phone: (877) 405-7679 | Fax: (833) 603-0363</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/indiana/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9695; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/indiana";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/indiana_audio", "ssa.pa.indiana.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/indiana_data", "ssa.pa.indiana.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/indiana_graphics", "ssa.pa.indiana.graphics.spectrum", sb.toString());
        }
    }
}