package presidential.Brarner.M.Alete.source.ssa.ky.campbellsville;
...
/**
 * Signal Processing for SSA Office: CAMPBELLSVILLE KY
 * <p>Office Code: 450</p>
 * <p>Address: 101 HIESTAND FARM RD, CAMPBELLSVILLE, KY 42718</p>
 * <p>Phone: (877) 828-1695 | Fax: (833) 950-3491</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/campbellsville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9887; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/campbellsville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/campbellsville_audio", "ssa.ky.campbellsville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/campbellsville_data", "ssa.ky.campbellsville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/campbellsville_graphics", "ssa.ky.campbellsville.graphics.spectrum", sb.toString());
        }
    }
}