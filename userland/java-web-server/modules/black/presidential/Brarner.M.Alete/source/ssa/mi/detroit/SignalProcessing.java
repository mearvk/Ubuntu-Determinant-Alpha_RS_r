package presidential.Brarner.M.Alete.source.ssa.mi.detroit;
...
/**
 * Signal Processing for SSA Office: DETROIT-SW MI
 * <p>Office Code: C47</p>
 * <p>Address: 5715 MICHIGAN AVE, DETROIT, MI 48210</p>
 * <p>Phone: (877) 319-0730 | Fax: (833) 950-3701</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/detroit/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9365; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/detroit";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/detroit_audio", "ssa.mi.detroit.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/detroit_data", "ssa.mi.detroit.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/detroit_graphics", "ssa.mi.detroit.graphics.spectrum", sb.toString());
        }
    }
}