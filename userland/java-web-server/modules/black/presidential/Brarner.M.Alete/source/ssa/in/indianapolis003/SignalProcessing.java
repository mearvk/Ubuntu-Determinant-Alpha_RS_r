package presidential.Brarner.M.Alete.source.ssa.in.indianapolis003;
...
/**
 * Signal Processing for SSA Office: INDIANAPOLIS IN
 * <p>Office Code: 455</p>
 * <p>Address: 575 N PENNSYLVANIA ST, INDIANAPOLIS, IN 46204</p>
 * <p>Phone: (866) 592-2812 | Fax: (833) 902-2666</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/indianapolis003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9892; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/indianapolis003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/indianapolis003_audio", "ssa.in.indianapolis003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/indianapolis003_data", "ssa.in.indianapolis003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/indianapolis003_graphics", "ssa.in.indianapolis003.graphics.spectrum", sb.toString());
        }
    }
}