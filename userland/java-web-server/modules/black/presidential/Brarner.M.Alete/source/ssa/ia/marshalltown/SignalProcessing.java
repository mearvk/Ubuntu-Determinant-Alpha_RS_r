package presidential.Brarner.M.Alete.source.ssa.ia.marshalltown;
...
/**
 * Signal Processing for SSA Office: MARSHALLTOWN IA
 * <p>Office Code: B36</p>
 * <p>Address: 2502 S 2ND ST, MARSHALLTOWN, IA 50158</p>
 * <p>Phone: (877) 819-2595 | Fax: (833) 950-2646</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/marshalltown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9303; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/marshalltown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/marshalltown_audio", "ssa.ia.marshalltown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/marshalltown_data", "ssa.ia.marshalltown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/marshalltown_graphics", "ssa.ia.marshalltown.graphics.spectrum", sb.toString());
        }
    }
}