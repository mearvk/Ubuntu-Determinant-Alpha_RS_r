...
/**
 * Signal Processing for SSA Office: OWENSBORO KY
 * <p>Office Code: 444</p>
 * <p>Address: 4532 LUCKY STRIKE LOOP, OWENSBORO, KY 42303</p>
 * <p>Phone: (866) 836-5834 | Fax: (833) 950-3479</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/owensboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9881; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/owensboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/owensboro_audio", "ssa.ky.owensboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/owensboro_data", "ssa.ky.owensboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/owensboro_graphics", "ssa.ky.owensboro.graphics.spectrum", sb.toString());
        }
    }
}