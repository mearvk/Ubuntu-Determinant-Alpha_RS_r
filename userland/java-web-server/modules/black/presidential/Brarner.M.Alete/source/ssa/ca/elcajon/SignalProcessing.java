...
/**
 * Signal Processing for SSA Office: EL CAJON CA
 * <p>Office Code: 250</p>
 * <p>Address: 846 ARNELE AVE, EL CAJON, CA 92020</p>
 * <p>Phone: (866) 964-0012 | Fax: (833) 950-2750</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/elcajon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9705; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/elcajon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/elcajon_audio", "ssa.ca.elcajon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/elcajon_data", "ssa.ca.elcajon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/elcajon_graphics", "ssa.ca.elcajon.graphics.spectrum", sb.toString());
        }
    }
}