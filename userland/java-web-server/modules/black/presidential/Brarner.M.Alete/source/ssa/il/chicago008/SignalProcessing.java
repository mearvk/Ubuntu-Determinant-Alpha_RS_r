package presidential.Brarner.M.Alete.source.ssa.il.chicago008;
...
/**
 * Signal Processing for SSA Office: CHICAGO-NW IL
 * <p>Office Code: 513</p>
 * <p>Address: 4849 N MILWAUKEE AVE, CHICAGO, IL 60630</p>
 * <p>Phone: (888) 748-7667 | Fax: (833) 950-3433</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/chicago008/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9947; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/chicago008";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago008_audio", "ssa.il.chicago008.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago008_data", "ssa.il.chicago008.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago008_graphics", "ssa.il.chicago008.graphics.spectrum", sb.toString());
        }
    }
}