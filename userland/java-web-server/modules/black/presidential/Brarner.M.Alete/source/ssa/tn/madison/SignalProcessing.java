package presidential.Brarner.M.Alete.source.ssa.tn.madison;
...
/**
 * Signal Processing for SSA Office: MADISON TN
 * <p>Office Code: C37</p>
 * <p>Address: 140 CUDE LANE, MADISON, TN 37115</p>
 * <p>Phone: (866) 964-6302 | Fax: (833) 950-3769</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/madison/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9359; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/madison";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/madison_audio", "ssa.tn.madison.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/madison_data", "ssa.tn.madison.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/madison_graphics", "ssa.tn.madison.graphics.spectrum", sb.toString());
        }
    }
}