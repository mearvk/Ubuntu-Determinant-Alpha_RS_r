package presidential.Brarner.M.Alete.source.ssa.ny.peekskill;
...
/**
 * Signal Processing for SSA Office: PEEKSKILL NY
 * <p>Office Code: B93</p>
 * <p>Address: ONE PARK PLACE, PEEKSKILL, NY 10566</p>
 * <p>Phone: (877) 840-5778 | Fax: (833) 950-2964</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/peekskill/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9338; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/peekskill";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/peekskill_audio", "ssa.ny.peekskill.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/peekskill_data", "ssa.ny.peekskill.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/peekskill_graphics", "ssa.ny.peekskill.graphics.spectrum", sb.toString());
        }
    }
}