package presidential.Brarner.M.Alete.source.ssa.pr.guayama;
...
/**
 * Signal Processing for SSA Office: GUAYAMA PR
 * <p>Office Code: A29</p>
 * <p>Address: 54 RD 3 ALBIZU CAMPOS AVE, GUAYAMA, PR 784</p>
 * <p>Phone: (866) 272-8158 | Fax: (833) 950-2954</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pr/guayama/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9217; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pr/guayama";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pr/guayama_audio", "ssa.pr.guayama.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pr/guayama_data", "ssa.pr.guayama.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pr/guayama_graphics", "ssa.pr.guayama.graphics.spectrum", sb.toString());
        }
    }
}