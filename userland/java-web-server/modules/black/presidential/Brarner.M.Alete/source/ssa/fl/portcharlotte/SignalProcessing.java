package presidential.Brarner.M.Alete.source.ssa.fl.portcharlotte;
...
/**
 * Signal Processing for SSA Office: PT CHARLOTTE FL
 * <p>Office Code: A06</p>
 * <p>Address: 4054 BEAVER LN, PORT CHARLOTTE, FL 33952</p>
 * <p>Phone: (877) 405-0490 | Fax: (833) 950-2192</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/portcharlotte/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9203; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/portcharlotte";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/portcharlotte_audio", "ssa.fl.portcharlotte.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/portcharlotte_data", "ssa.fl.portcharlotte.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/portcharlotte_graphics", "ssa.fl.portcharlotte.graphics.spectrum", sb.toString());
        }
    }
}