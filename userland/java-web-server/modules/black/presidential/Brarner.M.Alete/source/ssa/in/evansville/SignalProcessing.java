package presidential.Brarner.M.Alete.source.ssa.in.evansville;
...
/**
 * Signal Processing for SSA Office: EVANSVILLE IN
 * <p>Office Code: 457</p>
 * <p>Address: 2300 N GREEN RIVER RD, EVANSVILLE, IN 47715</p>
 * <p>Phone: (877) 768-5679 | Fax: (833) 902-2670</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/evansville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9894; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/evansville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/evansville_audio", "ssa.in.evansville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/evansville_data", "ssa.in.evansville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/evansville_graphics", "ssa.in.evansville.graphics.spectrum", sb.toString());
        }
    }
}