...
/**
 * Signal Processing for SSA Office: BUTTE MT
 * <p>Office Code: 866</p>
 * <p>Address: 2201 HARRISON AVE, BUTTE, MT 59701</p>
 * <p>Phone: (888) 632-7068 | Fax: (833) 515-0409</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mt/butte/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10254; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mt/butte";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mt/butte_audio", "ssa.mt.butte.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mt/butte_data", "ssa.mt.butte.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mt/butte_graphics", "ssa.mt.butte.graphics.spectrum", sb.toString());
        }
    }
}