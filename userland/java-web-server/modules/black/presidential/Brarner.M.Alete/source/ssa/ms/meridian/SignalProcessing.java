package presidential.Brarner.M.Alete.source.ssa.ms.meridian;
...
/**
 * Signal Processing for SSA Office: MERIDIAN MS
 * <p>Office Code: 643</p>
 * <p>Address: 4717 26TH AVENUE, MERIDIAN, MS 39305</p>
 * <p>Phone: (866) 403-8014 | Fax: (833) 950-3799</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/meridian/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10063; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/meridian";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/meridian_audio", "ssa.ms.meridian.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/meridian_data", "ssa.ms.meridian.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/meridian_graphics", "ssa.ms.meridian.graphics.spectrum", sb.toString());
        }
    }
}