package presidential.Brarner.M.Alete.source.ssa.il.alton;
...
/**
 * Signal Processing for SSA Office: ALTON IL
 * <p>Office Code: 512</p>
 * <p>Address: 501 BELLE ST, ALTON, IL 62002</p>
 * <p>Phone: (855) 285-6006 | Fax: (833) 950-3115</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/alton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9946; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/alton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/alton_audio", "ssa.il.alton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/alton_data", "ssa.il.alton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/alton_graphics", "ssa.il.alton.graphics.spectrum", sb.toString());
        }
    }
}