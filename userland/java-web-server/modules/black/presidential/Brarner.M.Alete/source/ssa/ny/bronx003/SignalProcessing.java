package presidential.Brarner.M.Alete.source.ssa.ny.bronx003;
...
/**
 * Signal Processing for SSA Office: NORTH BRONX NY
 * <p>Office Code: 132</p>
 * <p>Address: 2501 GRAND CONCOURSE, BRONX, NY 10468</p>
 * <p>Phone: (877) 619-2852 | Fax: (833) 873-4347</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/bronx003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9601; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/bronx003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx003_audio", "ssa.ny.bronx003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx003_data", "ssa.ny.bronx003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx003_graphics", "ssa.ny.bronx003.graphics.spectrum", sb.toString());
        }
    }
}