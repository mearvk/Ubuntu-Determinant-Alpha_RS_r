package presidential.Brarner.M.Alete.source.ssa.ma.hanover;
...
/**
 * Signal Processing for SSA Office: HANOVER MA
 * <p>Office Code: B87</p>
 * <p>Address: 198 COLUMBIA RD, HANOVER, MA 2339</p>
 * <p>Phone: (877) 444-6898 | Fax: (833) 950-3252</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/hanover/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9335; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/hanover";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/hanover_audio", "ssa.ma.hanover.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/hanover_data", "ssa.ma.hanover.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/hanover_graphics", "ssa.ma.hanover.graphics.spectrum", sb.toString());
        }
    }
}