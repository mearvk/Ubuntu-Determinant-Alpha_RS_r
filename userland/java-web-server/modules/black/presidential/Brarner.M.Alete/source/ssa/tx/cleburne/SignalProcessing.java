package presidential.Brarner.M.Alete.source.ssa.tx.cleburne;
...
/**
 * Signal Processing for SSA Office: CLEBURNE TX
 * <p>Office Code: B47</p>
 * <p>Address: 1711 W. HENDERSON, CLEBURNE, TX 76033</p>
 * <p>Phone: (866) 227-1616 | Fax: (833) 939-2001</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/cleburne/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9309; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/cleburne";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/cleburne_audio", "ssa.tx.cleburne.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/cleburne_data", "ssa.tx.cleburne.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/cleburne_graphics", "ssa.tx.cleburne.graphics.spectrum", sb.toString());
        }
    }
}