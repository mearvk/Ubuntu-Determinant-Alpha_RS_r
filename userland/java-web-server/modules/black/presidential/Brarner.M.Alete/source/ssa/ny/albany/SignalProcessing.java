package presidential.Brarner.M.Alete.source.ssa.ny.albany;
...
/**
 * Signal Processing for SSA Office: ALBANY NY
 * <p>Office Code: 102</p>
 * <p>Address: 11 A CLINTON AVE, ALBANY, NY 12207</p>
 * <p>Phone: (866) 253-9183 | Fax: (833) 950-3603</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/albany/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9573; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/albany";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/albany_audio", "ssa.ny.albany.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/albany_data", "ssa.ny.albany.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/albany_graphics", "ssa.ny.albany.graphics.spectrum", sb.toString());
        }
    }
}