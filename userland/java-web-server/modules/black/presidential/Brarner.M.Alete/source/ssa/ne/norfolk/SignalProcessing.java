package presidential.Brarner.M.Alete.source.ssa.ne.norfolk;
...
/**
 * Signal Processing for SSA Office: NORFOLK NE
 * <p>Office Code: 730</p>
 * <p>Address: 605 IRON HORSE DR, NORFOLK, NE 68701</p>
 * <p>Phone: (855) 207-7082 | Fax: (833) 902-2496</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ne/norfolk/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10135; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ne/norfolk";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ne/norfolk_audio", "ssa.ne.norfolk.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ne/norfolk_data", "ssa.ne.norfolk.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ne/norfolk_graphics", "ssa.ne.norfolk.graphics.spectrum", sb.toString());
        }
    }
}