package presidential.Brarner.M.Alete.source.ssa.ms.brookhaven;
...
/**
 * Signal Processing for SSA Office: BROOKHAVEN MS
 * <p>Office Code: B09</p>
 * <p>Address: 1392 JOHNNY JOHNSON DR, BROOKHAVEN, MS 39601</p>
 * <p>Phone: (877) 405-3568 | Fax: (833) 950-3117</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/brookhaven/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9281; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/brookhaven";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/brookhaven_audio", "ssa.ms.brookhaven.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/brookhaven_data", "ssa.ms.brookhaven.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/brookhaven_graphics", "ssa.ms.brookhaven.graphics.spectrum", sb.toString());
        }
    }
}