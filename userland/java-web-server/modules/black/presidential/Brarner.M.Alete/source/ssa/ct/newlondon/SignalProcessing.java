package presidential.Brarner.M.Alete.source.ssa.ct.newlondon;
...
/**
 * Signal Processing for SSA Office: NEW LONDON CT
 * <p>Office Code: 84</p>
 * <p>Address: 6 SHAWS CV, NEW LONDON, CT 6320</p>
 * <p>Phone: (866) 643-3401 | Fax: (833) 950-2652</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ct/newlondon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9556; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ct/newlondon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ct/newlondon_audio", "ssa.ct.newlondon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ct/newlondon_data", "ssa.ct.newlondon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ct/newlondon_graphics", "ssa.ct.newlondon.graphics.spectrum", sb.toString());
        }
    }
}