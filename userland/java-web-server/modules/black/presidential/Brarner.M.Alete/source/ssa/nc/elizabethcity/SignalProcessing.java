package presidential.Brarner.M.Alete.source.ssa.nc.elizabethcity;
...
/**
 * Signal Processing for SSA Office: ELIZABETH CITY NC
 * <p>Office Code: 336</p>
 * <p>Address: 1865 W CITY DR, ELIZABETH CITY, NC 27909</p>
 * <p>Phone: (866) 572-2819 | Fax: (833) 950-2846</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/elizabethcity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9784; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/elizabethcity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/elizabethcity_audio", "ssa.nc.elizabethcity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/elizabethcity_data", "ssa.nc.elizabethcity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/elizabethcity_graphics", "ssa.nc.elizabethcity.graphics.spectrum", sb.toString());
        }
    }
}