package presidential.Brarner.M.Alete.source.ssa.nj.glassboro;
...
/**
 * Signal Processing for SSA Office: GLASSBORO NJ
 * <p>Office Code: A25</p>
 * <p>Address: 830 DELSEA DR NORTH, GLASSBORO, NJ 8028</p>
 * <p>Phone: (866) 883-5305 | Fax: (833) 950-2668</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/glassboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9214; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/glassboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/glassboro_audio", "ssa.nj.glassboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/glassboro_data", "ssa.nj.glassboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/glassboro_graphics", "ssa.nj.glassboro.graphics.spectrum", sb.toString());
        }
    }
}