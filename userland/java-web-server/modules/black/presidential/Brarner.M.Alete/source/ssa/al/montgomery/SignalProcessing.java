...
/**
 * Signal Processing for SSA Office: MONTGOMERY AL
 * <p>Office Code: 623</p>
 * <p>Address: 4344 CARMICHAEL RD, MONTGOMERY, AL 36106</p>
 * <p>Phone: (866) 593-0914 | Fax: (833) 950-3169</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/montgomery/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10046; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/montgomery";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/montgomery_audio", "ssa.al.montgomery.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/montgomery_data", "ssa.al.montgomery.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/montgomery_graphics", "ssa.al.montgomery.graphics.spectrum", sb.toString());
        }
    }
}