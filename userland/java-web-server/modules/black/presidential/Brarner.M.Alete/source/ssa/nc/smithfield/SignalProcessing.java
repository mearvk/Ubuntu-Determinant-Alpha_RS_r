...
/**
 * Signal Processing for SSA Office: SMITHFIELD NC
 * <p>Office Code: 484</p>
 * <p>Address: 633 VENTURE DR, SMITHFIELD, NC 27577</p>
 * <p>Phone: (888) 527-9331 | Fax: (833) 950-3787</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/smithfield/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9919; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/smithfield";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/smithfield_audio", "ssa.nc.smithfield.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/smithfield_data", "ssa.nc.smithfield.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/smithfield_graphics", "ssa.nc.smithfield.graphics.spectrum", sb.toString());
        }
    }
}