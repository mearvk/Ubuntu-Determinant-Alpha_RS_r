package presidential.Brarner.M.Alete.source.ssa.ky.pikeville;
...
/**
 * Signal Processing for SSA Office: PIKEVILLE KY
 * <p>Office Code: 448</p>
 * <p>Address: 333 HAMBLEY BLVD, PIKEVILLE, KY 41501</p>
 * <p>Phone: (888) 676-2942 | Fax: (833) 950-3487</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/pikeville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9885; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/pikeville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/pikeville_audio", "ssa.ky.pikeville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/pikeville_data", "ssa.ky.pikeville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/pikeville_graphics", "ssa.ky.pikeville.graphics.spectrum", sb.toString());
        }
    }
}