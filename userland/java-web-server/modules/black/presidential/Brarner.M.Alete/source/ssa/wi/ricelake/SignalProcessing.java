package presidential.Brarner.M.Alete.source.ssa.wi.ricelake;
...
/**
 * Signal Processing for SSA Office: RICE LAKE WI
 * <p>Office Code: 910</p>
 * <p>Address: 1703 W KNAPP STREET, RICE LAKE, WI 54868</p>
 * <p>Phone: (888) 823-3923 | Fax: (833) 950-2190</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/ricelake/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10293; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/ricelake";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/ricelake_audio", "ssa.wi.ricelake.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/ricelake_data", "ssa.wi.ricelake.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/ricelake_graphics", "ssa.wi.ricelake.graphics.spectrum", sb.toString());
        }
    }
}