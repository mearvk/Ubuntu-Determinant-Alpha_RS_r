package presidential.Brarner.M.Alete.source.ssa.va.virginiabeach;
...
/**
 * Signal Processing for SSA Office: VIRGINIA BEACH
 * <p>Office Code: B56</p>
 * <p>Address: 2875 SABRE ST, VIRGINIA BEACH, VA 23452</p>
 * <p>Phone: (888) 377-5237 | Fax: (833) 912-2318</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/virginiabeach/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9317; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/virginiabeach";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/virginiabeach_audio", "ssa.va.virginiabeach.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/virginiabeach_data", "ssa.va.virginiabeach.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/virginiabeach_graphics", "ssa.va.virginiabeach.graphics.spectrum", sb.toString());
        }
    }
}