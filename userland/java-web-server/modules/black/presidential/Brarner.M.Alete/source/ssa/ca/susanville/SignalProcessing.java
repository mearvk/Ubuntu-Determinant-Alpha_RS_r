package presidential.Brarner.M.Alete.source.ssa.ca.susanville;
...
/**
 * Signal Processing for SSA Office: SUSANVILLE
 * <p>Office Code: A01</p>
 * <p>Address: 2603 RIVERSIDE DR, SUSANVILLE, CA 96130</p>
 * <p>Phone: (855) 420-8563 | Fax: (833) 950-3027</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/susanville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9201; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/susanville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/susanville_audio", "ssa.ca.susanville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/susanville_data", "ssa.ca.susanville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/susanville_graphics", "ssa.ca.susanville.graphics.spectrum", sb.toString());
        }
    }
}