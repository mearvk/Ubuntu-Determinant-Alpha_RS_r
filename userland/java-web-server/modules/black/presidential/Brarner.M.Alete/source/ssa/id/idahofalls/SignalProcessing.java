package presidential.Brarner.M.Alete.source.ssa.id.idahofalls;
...
/**
 * Signal Processing for SSA Office: IDAHO FALLS ID
 * <p>Office Code: 897</p>
 * <p>Address: 2196 CHANNING WAY, IDAHO FALLS, ID 83404</p>
 * <p>Phone: (866) 253-0489 | Fax: (833) 950-2306</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/id/idahofalls/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10281; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/id/idahofalls";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_id/idahofalls_audio", "ssa.id.idahofalls.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_id/idahofalls_data", "ssa.id.idahofalls.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_id/idahofalls_graphics", "ssa.id.idahofalls.graphics.spectrum", sb.toString());
        }
    }
}