package presidential.Brarner.M.Alete.source.ssa.nc.sanford;
...
/**
 * Signal Processing for SSA Office: SANFORD NC
 * <p>Office Code: B05</p>
 * <p>Address: 401 TIFFANY DR, SANFORD, NC 27330</p>
 * <p>Phone: (877) 319-5774 | Fax: (833) 950-2826</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/sanford/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9277; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/sanford";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/sanford_audio", "ssa.nc.sanford.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/sanford_data", "ssa.nc.sanford.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/sanford_graphics", "ssa.nc.sanford.graphics.spectrum", sb.toString());
        }
    }
}