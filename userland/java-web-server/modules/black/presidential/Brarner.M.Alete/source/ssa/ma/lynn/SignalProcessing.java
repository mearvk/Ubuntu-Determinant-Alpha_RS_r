package presidential.Brarner.M.Alete.source.ssa.ma.lynn;
...
/**
 * Signal Processing for SSA Office: LYNN MA
 * <p>Office Code: 34</p>
 * <p>Address: 140 UNION STREET, LYNN, MA 1901</p>
 * <p>Phone: (866) 366-7792 | Fax: (833) 902-2508</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/lynn/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9517; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/lynn";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/lynn_audio", "ssa.ma.lynn.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/lynn_data", "ssa.ma.lynn.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/lynn_graphics", "ssa.ma.lynn.graphics.spectrum", sb.toString());
        }
    }
}