package presidential.Brarner.M.Alete.source.ssa.ct.ansonia;
...
/**
 * Signal Processing for SSA Office: ANSONIA CT
 * <p>Office Code: 599</p>
 * <p>Address: 475 MAIN STREET, ANSONIA, CT 6401</p>
 * <p>Phone: (866) 331-7096 | Fax: (833) 950-2666</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ct/ansonia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10022; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ct/ansonia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ct/ansonia_audio", "ssa.ct.ansonia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ct/ansonia_data", "ssa.ct.ansonia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ct/ansonia_graphics", "ssa.ct.ansonia.graphics.spectrum", sb.toString());
        }
    }
}