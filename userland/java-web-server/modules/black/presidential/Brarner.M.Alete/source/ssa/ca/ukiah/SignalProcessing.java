package presidential.Brarner.M.Alete.source.ssa.ca.ukiah;
...
/**
 * Signal Processing for SSA Office: UKIAH CA
 * <p>Office Code: A85</p>
 * <p>Address: 521 S ORCHARD AVE, UKIAH, CA 95482</p>
 * <p>Phone: (888) 590-2706 | Fax: (833) 950-3653</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/ukiah/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9263; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/ukiah";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/ukiah_audio", "ssa.ca.ukiah.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/ukiah_data", "ssa.ca.ukiah.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/ukiah_graphics", "ssa.ca.ukiah.graphics.spectrum", sb.toString());
        }
    }
}