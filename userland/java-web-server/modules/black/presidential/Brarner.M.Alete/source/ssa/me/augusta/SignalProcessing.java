package presidential.Brarner.M.Alete.source.ssa.me.augusta;
...
/**
 * Signal Processing for SSA Office: AUGUSTA ME
 * <p>Office Code: 3</p>
 * <p>Address: 68 SEWALL ST, AUGUSTA, ME 4330</p>
 * <p>Phone: (866) 882-5422 | Fax: (833) 950-3579</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/me/augusta/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9492; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/me/augusta";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_me/augusta_audio", "ssa.me.augusta.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_me/augusta_data", "ssa.me.augusta.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_me/augusta_graphics", "ssa.me.augusta.graphics.spectrum", sb.toString());
        }
    }
}