package presidential.Brarner.M.Alete.source.ssa.ny.patchogue;
...
/**
 * Signal Processing for SSA Office: PATCHOGUE NY
 * <p>Office Code: 136</p>
 * <p>Address: 75 OAK STREET, PATCHOGUE, NY 11772</p>
 * <p>Phone: (866) 771-1991 | Fax: (833) 926-2695</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/patchogue/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9605; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/patchogue";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/patchogue_audio", "ssa.ny.patchogue.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/patchogue_data", "ssa.ny.patchogue.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/patchogue_graphics", "ssa.ny.patchogue.graphics.spectrum", sb.toString());
        }
    }
}