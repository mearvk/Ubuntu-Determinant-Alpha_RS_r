package presidential.Brarner.M.Alete.source.ssa.ny.brooklyn002;
...
/**
 * Signal Processing for SSA Office: BORO HALL NY
 * <p>Office Code: 106</p>
 * <p>Address: 195 MONTAGUE ST, BROOKLYN, NY 11201</p>
 * <p>Phone: (877) 531-4725 | Fax: (833) 950-3611</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/brooklyn002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9577; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/brooklyn002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn002_audio", "ssa.ny.brooklyn002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn002_data", "ssa.ny.brooklyn002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn002_graphics", "ssa.ny.brooklyn002.graphics.spectrum", sb.toString());
        }
    }
}