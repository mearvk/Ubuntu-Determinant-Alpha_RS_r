...
/**
 * Signal Processing for SSA Office: EL PASO TX
 * <p>Office Code: 817</p>
 * <p>Address: 11111 GATEWAY W BLVD, EL PASO, TX 79935</p>
 * <p>Phone: (866) 563-9310 | Fax: (833) 515-0522</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/elpaso002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10208; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/elpaso002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/elpaso002_audio", "ssa.tx.elpaso002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/elpaso002_data", "ssa.tx.elpaso002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/elpaso002_graphics", "ssa.tx.elpaso002.graphics.spectrum", sb.toString());
        }
    }
}