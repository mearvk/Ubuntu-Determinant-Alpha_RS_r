...
/**
 * Signal Processing for SSA Office: WALTERBORO SC
 * <p>Office Code: C93</p>
 * <p>Address: 502 ROBERTSON BLVD, WALTERBORO, SC 29488</p>
 * <p>Phone: (866) 708-2810 | Fax: (843) 549-1578</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/walterboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9394; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/walterboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/walterboro_audio", "ssa.sc.walterboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/walterboro_data", "ssa.sc.walterboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/walterboro_graphics", "ssa.sc.walterboro.graphics.spectrum", sb.toString());
        }
    }
}