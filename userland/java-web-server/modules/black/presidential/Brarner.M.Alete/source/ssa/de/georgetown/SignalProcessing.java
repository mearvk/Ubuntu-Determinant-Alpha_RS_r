package presidential.Brarner.M.Alete.source.ssa.de.georgetown;
...
/**
 * Signal Processing for SSA Office: Georgetown, DE
 * <p>Office Code: C80</p>
 * <p>Address: 17 GEORGETOWN PLZ, GEORGETOWN, DE 19947</p>
 * <p>Phone: (866) 864-1803 | Fax: (833) 912-2298</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/de/georgetown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9385; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/de/georgetown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_de/georgetown_audio", "ssa.de.georgetown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_de/georgetown_data", "ssa.de.georgetown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_de/georgetown_graphics", "ssa.de.georgetown.graphics.spectrum", sb.toString());
        }
    }
}