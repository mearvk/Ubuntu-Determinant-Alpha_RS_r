...
/**
 * Signal Processing for SSA Office: ROSLINDALE MA
 * <p>Office Code: 56</p>
 * <p>Address: 4238 WASHINGTON ST, ROSLINDALE, MA 2131</p>
 * <p>Phone: (866) 331-9173 | Fax: (833) 950-2342</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/roslindale/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9537; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/roslindale";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/roslindale_audio", "ssa.ma.roslindale.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/roslindale_data", "ssa.ma.roslindale.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/roslindale_graphics", "ssa.ma.roslindale.graphics.spectrum", sb.toString());
        }
    }
}