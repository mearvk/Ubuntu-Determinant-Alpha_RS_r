package presidential.Brarner.M.Alete.source.ssa.nc.wilkesboro;
...
/**
 * Signal Processing for SSA Office: WILKESBORO NC
 * <p>Office Code: 339</p>
 * <p>Address: 1517 RIVER ST, WILKESBORO, NC 28697</p>
 * <p>Phone: (866) 331-2298 | Fax: (833) 950-2850</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/wilkesboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9786; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/wilkesboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/wilkesboro_audio", "ssa.nc.wilkesboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/wilkesboro_data", "ssa.nc.wilkesboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/wilkesboro_graphics", "ssa.nc.wilkesboro.graphics.spectrum", sb.toString());
        }
    }
}