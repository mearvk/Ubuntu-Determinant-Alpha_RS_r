...
/**
 * Signal Processing for SSA Office: HARTFORD CT
 * <p>Office Code: 80</p>
 * <p>Address: 135 HIGH ST, HARTFORD, CT 6103</p>
 * <p>Phone: (877) 619-2851 | Fax: (833) 950-2354</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ct/hartford/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9552; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ct/hartford";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ct/hartford_audio", "ssa.ct.hartford.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ct/hartford_data", "ssa.ct.hartford.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ct/hartford_graphics", "ssa.ct.hartford.graphics.spectrum", sb.toString());
        }
    }
}