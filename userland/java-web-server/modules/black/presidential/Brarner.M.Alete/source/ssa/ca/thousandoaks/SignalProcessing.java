package presidential.Brarner.M.Alete.source.ssa.ca.thousandoaks;
...
/**
 * Signal Processing for SSA Office: THOUSAND OAKS CA
 * <p>Office Code: A09</p>
 * <p>Address: 322 E THOUSAND OAKS BL, THOUSAND OAKS, CA 91360</p>
 * <p>Phone: (888) 397-4807 | Fax: (833) 950-3033</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/thousandoaks/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9205; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/thousandoaks";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/thousandoaks_audio", "ssa.ca.thousandoaks.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/thousandoaks_data", "ssa.ca.thousandoaks.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/thousandoaks_graphics", "ssa.ca.thousandoaks.graphics.spectrum", sb.toString());
        }
    }
}