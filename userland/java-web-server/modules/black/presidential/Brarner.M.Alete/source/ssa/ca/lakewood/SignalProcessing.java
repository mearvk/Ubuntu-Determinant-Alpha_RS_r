package presidential.Brarner.M.Alete.source.ssa.ca.lakewood;
...
/**
 * Signal Processing for SSA Office: LAKEWOOD CA
 * <p>Office Code: B59</p>
 * <p>Address: 4957 PARAMOUNT BLVD, LAKEWOOD, CA 90712</p>
 * <p>Phone: (866) 964-6484 | Fax: (833) 950-3663</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/lakewood/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9320; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/lakewood";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/lakewood_audio", "ssa.ca.lakewood.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/lakewood_data", "ssa.ca.lakewood.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/lakewood_graphics", "ssa.ca.lakewood.graphics.spectrum", sb.toString());
        }
    }
}