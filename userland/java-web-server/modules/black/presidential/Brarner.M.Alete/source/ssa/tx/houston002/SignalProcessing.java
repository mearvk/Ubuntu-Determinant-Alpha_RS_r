package presidential.Brarner.M.Alete.source.ssa.tx.houston002;
...
/**
 * Signal Processing for SSA Office: HOUSTON NORTHWEST TX
 * <p>Office Code: 855</p>
 * <p>Address: 16200 DILLARD DR, HOUSTON, TX 77040</p>
 * <p>Phone: (866) 331-3277 | Fax: (833) 950-2712</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/houston002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10243; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/houston002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/houston002_audio", "ssa.tx.houston002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/houston002_data", "ssa.tx.houston002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/houston002_graphics", "ssa.tx.houston002.graphics.spectrum", sb.toString());
        }
    }
}