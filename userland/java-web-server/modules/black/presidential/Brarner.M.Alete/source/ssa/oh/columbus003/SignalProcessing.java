package presidential.Brarner.M.Alete.source.ssa.oh.columbus003;
...
/**
 * Signal Processing for SSA Office: COLUMBUS OH-DT
 * <p>Office Code: 389</p>
 * <p>Address: 200 NORTH HIGH STREET, COLUMBUS, OH 43215</p>
 * <p>Phone: (866) 964-1723 | Fax: (833) 950-3079</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/columbus003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9830; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/columbus003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/columbus003_audio", "ssa.oh.columbus003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/columbus003_data", "ssa.oh.columbus003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/columbus003_graphics", "ssa.oh.columbus003.graphics.spectrum", sb.toString());
        }
    }
}