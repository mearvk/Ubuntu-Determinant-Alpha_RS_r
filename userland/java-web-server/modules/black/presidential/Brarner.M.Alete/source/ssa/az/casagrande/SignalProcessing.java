package presidential.Brarner.M.Alete.source.ssa.az.casagrande;
...
/**
 * Signal Processing for SSA Office: CASA GRANDE AZ
 * <p>Office Code: 903</p>
 * <p>Address: 1637 E MONUMENT PLAZA CIR, CASA GRANDE, AZ 85122</p>
 * <p>Phone: (877) 405-0403 | Fax: (833) 950-3387</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/az/casagrande/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10287; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/az/casagrande";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_az/casagrande_audio", "ssa.az.casagrande.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_az/casagrande_data", "ssa.az.casagrande.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_az/casagrande_graphics", "ssa.az.casagrande.graphics.spectrum", sb.toString());
        }
    }
}