package presidential.Brarner.M.Alete.source.ssa.ny.geneva;
...
/**
 * Signal Processing for SSA Office: GENEVA NY
 * <p>Office Code: 141</p>
 * <p>Address: 15 LEWIS ST, GENEVA, NY 14456</p>
 * <p>Phone: (866) 331-7759 | Fax: (833) 950-2364</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/geneva/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9610; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/geneva";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/geneva_audio", "ssa.ny.geneva.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/geneva_data", "ssa.ny.geneva.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/geneva_graphics", "ssa.ny.geneva.graphics.spectrum", sb.toString());
        }
    }
}