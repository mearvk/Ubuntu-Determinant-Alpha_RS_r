package presidential.Brarner.M.Alete.source.ssa.ny.plattsburgh;
...
/**
 * Signal Processing for SSA Office: PLATTSBURGH NY
 * <p>Office Code: 125</p>
 * <p>Address: 14 DURKEE ST, PLATTSBURGH, NY 12901</p>
 * <p>Phone: (866) 964-7430 | Fax: (833) 902-2540</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/plattsburgh/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9595; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/plattsburgh";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/plattsburgh_audio", "ssa.ny.plattsburgh.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/plattsburgh_data", "ssa.ny.plattsburgh.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/plattsburgh_graphics", "ssa.ny.plattsburgh.graphics.spectrum", sb.toString());
        }
    }
}