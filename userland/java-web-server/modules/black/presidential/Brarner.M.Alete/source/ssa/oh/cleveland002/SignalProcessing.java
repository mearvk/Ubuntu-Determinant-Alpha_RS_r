package presidential.Brarner.M.Alete.source.ssa.oh.cleveland002;
...
/**
 * Signal Processing for SSA Office: CLEVELAND NE OH
 * <p>Office Code: 423</p>
 * <p>Address: 15250 S. WATERLOO RD, CLEVELAND, OH 44110</p>
 * <p>Phone: (866) 592-1802 | Fax: (833) 596-0583</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/cleveland002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9864; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/cleveland002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cleveland002_audio", "ssa.oh.cleveland002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cleveland002_data", "ssa.oh.cleveland002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cleveland002_graphics", "ssa.oh.cleveland002.graphics.spectrum", sb.toString());
        }
    }
}