package presidential.Brarner.M.Alete.source.ssa.in.indianapolis002;
...
/**
 * Signal Processing for SSA Office: INDIANAPOLIS NORTHWEST
 * <p>Office Code: D60</p>
 * <p>Address: 6745 NETWORK PL, INDIANAPOLIS, IN 46278</p>
 * <p>Phone: (866) 218-2309 | Fax: (833) 580-0169</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/indianapolis002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9441; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/indianapolis002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/indianapolis002_audio", "ssa.in.indianapolis002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/indianapolis002_data", "ssa.in.indianapolis002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/indianapolis002_graphics", "ssa.in.indianapolis002.graphics.spectrum", sb.toString());
        }
    }
}