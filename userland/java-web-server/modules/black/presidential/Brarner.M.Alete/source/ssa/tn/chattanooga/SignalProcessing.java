...
/**
 * Signal Processing for SSA Office: CHATTANOOGA TN
 * <p>Office Code: 568</p>
 * <p>Address: 1290 PREMIER DR, CHATTANOOGA, TN 37421</p>
 * <p>Phone: (866) 964-0029 | Fax: (833) 597-0086</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/chattanooga/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9992; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/chattanooga";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/chattanooga_audio", "ssa.tn.chattanooga.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/chattanooga_data", "ssa.tn.chattanooga.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/chattanooga_graphics", "ssa.tn.chattanooga.graphics.spectrum", sb.toString());
        }
    }
}