...
/**
 * Signal Processing for SSA Office: JASPER AL
 * <p>Office Code: 724</p>
 * <p>Address: 501 THE MALL WAY, JASPER, AL 35504</p>
 * <p>Phone: (877) 575-5199 | Fax: (833) 921-1881</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/jasper/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10129; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/jasper";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/jasper_audio", "ssa.al.jasper.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/jasper_data", "ssa.al.jasper.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/jasper_graphics", "ssa.al.jasper.graphics.spectrum", sb.toString());
        }
    }
}