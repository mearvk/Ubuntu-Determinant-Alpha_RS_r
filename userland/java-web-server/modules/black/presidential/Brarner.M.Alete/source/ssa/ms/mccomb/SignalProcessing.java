...
/**
 * Signal Processing for SSA Office: MCCOMB MS
 * <p>Office Code: 650</p>
 * <p>Address: 116 BUSINESS CENTER DR, MCCOMB, MS 39648</p>
 * <p>Phone: (866) 253-5609 | Fax: (833) 554-0361</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/mccomb/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10070; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/mccomb";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/mccomb_audio", "ssa.ms.mccomb.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/mccomb_data", "ssa.ms.mccomb.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/mccomb_graphics", "ssa.ms.mccomb.graphics.spectrum", sb.toString());
        }
    }
}