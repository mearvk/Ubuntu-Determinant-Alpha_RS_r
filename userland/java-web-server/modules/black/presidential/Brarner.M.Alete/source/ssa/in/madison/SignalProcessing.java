package presidential.Brarner.M.Alete.source.ssa.in.madison;
...
/**
 * Signal Processing for SSA Office: MADISON IN
 * <p>Office Code: 474</p>
 * <p>Address: 150 DEMAREE DRIVE, MADISON, IN 47250</p>
 * <p>Phone: (877) 692-3144 | Fax: (833) 950-2491</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/madison/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9911; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/madison";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/madison_audio", "ssa.in.madison.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/madison_data", "ssa.in.madison.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/madison_graphics", "ssa.in.madison.graphics.spectrum", sb.toString());
        }
    }
}