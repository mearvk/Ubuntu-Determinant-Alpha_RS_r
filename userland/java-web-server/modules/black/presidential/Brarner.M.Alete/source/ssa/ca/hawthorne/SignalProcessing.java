...
/**
 * Signal Processing for SSA Office: HAWTHORNE CA
 * <p>Office Code: 971</p>
 * <p>Address: 11539 HAWTHORNE BLVD, HAWTHORNE, CA 90250</p>
 * <p>Phone: (866) 331-7694 | Fax: (833) 950-2116</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/hawthorne/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10353; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/hawthorne";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/hawthorne_audio", "ssa.ca.hawthorne.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/hawthorne_data", "ssa.ca.hawthorne.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/hawthorne_graphics", "ssa.ca.hawthorne.graphics.spectrum", sb.toString());
        }
    }
}