package presidential.Brarner.M.Alete.source.ssa.pa.hermitage;
...
/**
 * Signal Processing for SSA Office: SHARON PA
 * <p>Office Code: 232</p>
 * <p>Address: 2380 GARDEN WAY, HERMITAGE, PA 16148</p>
 * <p>Phone: (877) 467-1702 | Fax: (833) 515-0397</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/hermitage/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9689; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/hermitage";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/hermitage_audio", "ssa.pa.hermitage.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/hermitage_data", "ssa.pa.hermitage.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/hermitage_graphics", "ssa.pa.hermitage.graphics.spectrum", sb.toString());
        }
    }
}