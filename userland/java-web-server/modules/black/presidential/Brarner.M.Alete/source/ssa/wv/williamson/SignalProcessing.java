package presidential.Brarner.M.Alete.source.ssa.wv.williamson;
...
/**
 * Signal Processing for SSA Office: WILLIAMSON WV
 * <p>Office Code: D89</p>
 * <p>Address: 146 EAST FIRST AVE, WILLIAMSON, WV 25661</p>
 * <p>Phone: (888) 759-3920 | Fax: (833) 912-2308</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/williamson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9450; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/williamson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/williamson_audio", "ssa.wv.williamson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/williamson_data", "ssa.wv.williamson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/williamson_graphics", "ssa.wv.williamson.graphics.spectrum", sb.toString());
        }
    }
}