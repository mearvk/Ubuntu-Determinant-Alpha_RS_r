package presidential.Brarner.M.Alete.source.ssa.md.westminster;
...
/**
 * Signal Processing for SSA Office: WESTMINSTER MD
 * <p>Office Code: A96</p>
 * <p>Address: 125 AIRPORT DR, WESTMINSTER, MD 21157</p>
 * <p>Phone: (877) 694-5496 | Fax: (833) 341-2704</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/westminster/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9269; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/westminster";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/westminster_audio", "ssa.md.westminster.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/westminster_data", "ssa.md.westminster.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/westminster_graphics", "ssa.md.westminster.graphics.spectrum", sb.toString());
        }
    }
}