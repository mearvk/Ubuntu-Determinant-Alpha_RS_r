package presidential.Brarner.M.Alete.source.ssa.nj.brick;
...
/**
 * Signal Processing for SSA Office: BRICKTOWN NJ
 * <p>Office Code: E21</p>
 * <p>Address: 2620 YORKTOWNE BLVD, BRICK, NJ 8723</p>
 * <p>Phone: (877) 405-5870 | Fax: (833) 950-3595</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/brick/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9456; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/brick";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/brick_audio", "ssa.nj.brick.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/brick_data", "ssa.nj.brick.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/brick_graphics", "ssa.nj.brick.graphics.spectrum", sb.toString());
        }
    }
}