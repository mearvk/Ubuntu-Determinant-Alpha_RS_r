...
/**
 * Signal Processing for SSA Office: INDEPENDENCE KS
 * <p>Office Code: 775</p>
 * <p>Address: 2125 N PENN AVE, INDEPENDENCE, KS 67301</p>
 * <p>Phone: (877) 512-3855 | Fax: (833) 950-2340</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ks/independence/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10171; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ks/independence";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ks/independence_audio", "ssa.ks.independence.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ks/independence_data", "ssa.ks.independence.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ks/independence_graphics", "ssa.ks.independence.graphics.spectrum", sb.toString());
        }
    }
}