package presidential.Brarner.M.Alete.source.ssa.pa.hazleton;
...
/**
 * Signal Processing for SSA Office: HAZLETON PA
 * <p>Office Code: 206</p>
 * <p>Address: 88 S LAUREL ST, HAZLETON, PA 18201</p>
 * <p>Phone: (866) 388-9878 | Fax: (833) 950-3179</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/hazleton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9664; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/hazleton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/hazleton_audio", "ssa.pa.hazleton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/hazleton_data", "ssa.pa.hazleton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/hazleton_graphics", "ssa.pa.hazleton.graphics.spectrum", sb.toString());
        }
    }
}