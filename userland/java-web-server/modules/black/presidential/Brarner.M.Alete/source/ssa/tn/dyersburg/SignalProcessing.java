package presidential.Brarner.M.Alete.source.ssa.tn.dyersburg;
...
/**
 * Signal Processing for SSA Office: DYERSBURG TN
 * <p>Office Code: 570</p>
 * <p>Address: 1070 VENDALL RD, DYERSBURG, TN 38024</p>
 * <p>Phone: (877) 480-5002 | Fax: (833) 597-0126</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/dyersburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9994; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/dyersburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/dyersburg_audio", "ssa.tn.dyersburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/dyersburg_data", "ssa.tn.dyersburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/dyersburg_graphics", "ssa.tn.dyersburg.graphics.spectrum", sb.toString());
        }
    }
}