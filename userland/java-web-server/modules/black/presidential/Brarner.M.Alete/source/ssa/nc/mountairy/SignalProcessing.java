package presidential.Brarner.M.Alete.source.ssa.nc.mountairy;
...
/**
 * Signal Processing for SSA Office: MT AIRY NC
 * <p>Office Code: B16</p>
 * <p>Address: 1187 N ANDY GRIFFITH PKWY, MOUNT AIRY, NC 27030</p>
 * <p>Phone: (866) 587-4418 | Fax: (833) 950-3129</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/mountairy/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9287; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/mountairy";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/mountairy_audio", "ssa.nc.mountairy.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/mountairy_data", "ssa.nc.mountairy.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/mountairy_graphics", "ssa.nc.mountairy.graphics.spectrum", sb.toString());
        }
    }
}