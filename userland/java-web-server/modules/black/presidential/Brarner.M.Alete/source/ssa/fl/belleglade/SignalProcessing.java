package presidential.Brarner.M.Alete.source.ssa.fl.belleglade;
...
/**
 * Signal Processing for SSA Office: BELLE GLADE FL
 * <p>Office Code: A57</p>
 * <p>Address: 925 SE 1ST STREET, BELLE GLADE, FL 33430</p>
 * <p>Phone: (855) 257-0983 | Fax: (833) 950-2814</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/belleglade/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9239; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/belleglade";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/belleglade_audio", "ssa.fl.belleglade.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/belleglade_data", "ssa.fl.belleglade.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/belleglade_graphics", "ssa.fl.belleglade.graphics.spectrum", sb.toString());
        }
    }
}