package presidential.Brarner.M.Alete.source.ssa.nj.eatontown;
...
/**
 * Signal Processing for SSA Office: EATONTOWN
 * <p>Office Code: 181</p>
 * <p>Address: 7 MERIDIAN RD, EATONTOWN, NJ 7724</p>
 * <p>Phone: (877) 405-0475 | Fax: (833) 950-3289</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/eatontown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9643; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/eatontown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/eatontown_audio", "ssa.nj.eatontown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/eatontown_data", "ssa.nj.eatontown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/eatontown_graphics", "ssa.nj.eatontown.graphics.spectrum", sb.toString());
        }
    }
}