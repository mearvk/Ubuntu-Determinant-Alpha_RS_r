package presidential.Brarner.M.Alete.source.ssa.tx.marshall;
...
/**
 * Signal Processing for SSA Office: MARSHALL TX
 * <p>Office Code: B50</p>
 * <p>Address: 1509 SEDBERRY ST, MARSHALL, TX 75670</p>
 * <p>Phone: (800) 467-5313 | Fax: (833) 939-2004</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/marshall/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9312; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/marshall";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/marshall_audio", "ssa.tx.marshall.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/marshall_data", "ssa.tx.marshall.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/marshall_graphics", "ssa.tx.marshall.graphics.spectrum", sb.toString());
        }
    }
}