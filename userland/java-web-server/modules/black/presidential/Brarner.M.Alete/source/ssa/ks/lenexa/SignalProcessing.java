package presidential.Brarner.M.Alete.source.ssa.ks.lenexa;
...
/**
 * Signal Processing for SSA Office: JOHNSON COUNTY
 * <p>Office Code: 779</p>
 * <p>Address: 15375 W 95TH ST, LENEXA, KS 66219</p>
 * <p>Phone: (877) 445-9978 | Fax: (833) 950-2638</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ks/lenexa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10175; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ks/lenexa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ks/lenexa_audio", "ssa.ks.lenexa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ks/lenexa_data", "ssa.ks.lenexa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ks/lenexa_graphics", "ssa.ks.lenexa.graphics.spectrum", sb.toString());
        }
    }
}