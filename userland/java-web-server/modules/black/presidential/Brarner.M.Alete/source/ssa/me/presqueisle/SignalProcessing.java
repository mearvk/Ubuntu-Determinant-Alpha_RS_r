...
/**
 * Signal Processing for SSA Office: PRESQUE ISLE ME
 * <p>Office Code: 5</p>
 * <p>Address: 365 MAIN ST, PRESQUE ISLE, ME 4769</p>
 * <p>Phone: (866) 837-2719 | Fax: (833) 950-3583</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/me/presqueisle/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9494; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/me/presqueisle";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_me/presqueisle_audio", "ssa.me.presqueisle.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_me/presqueisle_data", "ssa.me.presqueisle.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_me/presqueisle_graphics", "ssa.me.presqueisle.graphics.spectrum", sb.toString());
        }
    }
}