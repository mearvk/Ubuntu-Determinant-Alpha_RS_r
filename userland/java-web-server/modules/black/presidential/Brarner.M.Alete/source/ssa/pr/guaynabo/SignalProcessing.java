...
/**
 * Signal Processing for SSA Office: SAN PATRICIO PR
 * <p>Office Code: 380</p>
 * <p>Address: F5 EBANO ST, GUAYNABO, PR 968</p>
 * <p>Phone: (866) 783-0627 | Fax: (833) 950-3619</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pr/guaynabo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9823; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pr/guaynabo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pr/guaynabo_audio", "ssa.pr.guaynabo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pr/guaynabo_data", "ssa.pr.guaynabo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pr/guaynabo_graphics", "ssa.pr.guaynabo.graphics.spectrum", sb.toString());
        }
    }
}