...
/**
 * Signal Processing for SSA Office: MISSION VIEJO CA
 * <p>Office Code: B58</p>
 * <p>Address: 23311 MADERO, MISSION VIEJO, CA 92691</p>
 * <p>Phone: (888) 306-9878 | Fax: (833) 950-3661</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/missionviejo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9319; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/missionviejo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/missionviejo_audio", "ssa.ca.missionviejo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/missionviejo_data", "ssa.ca.missionviejo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/missionviejo_graphics", "ssa.ca.missionviejo.graphics.spectrum", sb.toString());
        }
    }
}