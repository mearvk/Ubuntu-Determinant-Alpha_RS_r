package presidential.Brarner.M.Alete.source.ssa.ny.whiteplains;
...
/**
 * Signal Processing for SSA Office: WHITE PLAINS NY
 * <p>Office Code: 148</p>
 * <p>Address: 297 KNOLLWOOD RD, WHITE PLAINS, NY 10607</p>
 * <p>Phone: (866) 331-8134 | Fax: (833) 950-2376</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/whiteplains/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9616; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/whiteplains";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/whiteplains_audio", "ssa.ny.whiteplains.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/whiteplains_data", "ssa.ny.whiteplains.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/whiteplains_graphics", "ssa.ny.whiteplains.graphics.spectrum", sb.toString());
        }
    }
}