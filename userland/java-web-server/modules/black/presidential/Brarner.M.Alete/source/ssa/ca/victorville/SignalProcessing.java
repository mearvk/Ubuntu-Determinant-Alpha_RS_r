package presidential.Brarner.M.Alete.source.ssa.ca.victorville;
...
/**
 * Signal Processing for SSA Office: VICTORVILLE CA
 * <p>Office Code: A87</p>
 * <p>Address: 13955 PARK AVE, VICTORVILLE, CA 92392</p>
 * <p>Phone: (877) 405-1435 | Fax: (833) 950-3655</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/victorville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9264; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/victorville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/victorville_audio", "ssa.ca.victorville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/victorville_data", "ssa.ca.victorville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/victorville_graphics", "ssa.ca.victorville.graphics.spectrum", sb.toString());
        }
    }
}