package presidential.Brarner.M.Alete.source.ssa.pa.philadelphia003;
...
/**
 * Signal Processing for SSA Office: PHILA-DOWNTOWN
 * <p>Office Code: 200</p>
 * <p>Address: 1500 JOHN F KENNEDY BLVD, PHILADELPHIA, PA 19102</p>
 * <p>Phone: (866) 613-3969 | Fax: (833) 950-2882</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/philadelphia003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9658; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/philadelphia003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia003_audio", "ssa.pa.philadelphia003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia003_data", "ssa.pa.philadelphia003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia003_graphics", "ssa.pa.philadelphia003.graphics.spectrum", sb.toString());
        }
    }
}