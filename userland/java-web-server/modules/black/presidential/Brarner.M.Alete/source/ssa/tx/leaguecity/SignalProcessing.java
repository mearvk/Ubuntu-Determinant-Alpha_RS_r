package presidential.Brarner.M.Alete.source.ssa.tx.leaguecity;
...
/**
 * Signal Processing for SSA Office: LEAGUE CITY
 * <p>Office Code: 828</p>
 * <p>Address: 2835 GULF FRWY SOUTH, LEAGUE CITY, TX 77573</p>
 * <p>Phone: (866) 299-3254 | Fax: (833) 902-2584</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/leaguecity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10219; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/leaguecity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/leaguecity_audio", "ssa.tx.leaguecity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/leaguecity_data", "ssa.tx.leaguecity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/leaguecity_graphics", "ssa.tx.leaguecity.graphics.spectrum", sb.toString());
        }
    }
}