package presidential.Brarner.M.Alete.source.ssa.ct.meriden;
...
/**
 * Signal Processing for SSA Office: MERIDEN CT
 * <p>Office Code: 88</p>
 * <p>Address: SUITE 212, MERIDEN, CT 6450</p>
 * <p>Phone: (877) 409-8429 | Fax: (833) 950-2660</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ct/meriden/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9560; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ct/meriden";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ct/meriden_audio", "ssa.ct.meriden.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ct/meriden_data", "ssa.ct.meriden.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ct/meriden_graphics", "ssa.ct.meriden.graphics.spectrum", sb.toString());
        }
    }
}