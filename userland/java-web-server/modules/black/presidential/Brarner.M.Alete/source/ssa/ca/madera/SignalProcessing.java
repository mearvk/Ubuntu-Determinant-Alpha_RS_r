package presidential.Brarner.M.Alete.source.ssa.ca.madera;
...
/**
 * Signal Processing for SSA Office: MADERA CA
 * <p>Office Code: 947</p>
 * <p>Address: 348 E YOSEMITE AVE, MADERA, CA 93638</p>
 * <p>Phone: (877) 405-1453 | Fax: (833) 571-2677</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/madera/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10329; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/madera";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/madera_audio", "ssa.ca.madera.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/madera_data", "ssa.ca.madera.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/madera_graphics", "ssa.ca.madera.graphics.spectrum", sb.toString());
        }
    }
}