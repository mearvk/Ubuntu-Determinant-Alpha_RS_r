package presidential.Brarner.M.Alete.source.ssa.pr.aguadilla;
...
/**
 * Signal Processing for SSA Office: AGUADILLA PR
 * <p>Office Code: 528</p>
 * <p>Address: 5000 PEDRO ALBIZU CAMPOS AVE, AGUADILLA, PR 603</p>
 * <p>Phone: (833) 882-1201 | Fax: (833) 950-3621</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pr/aguadilla/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9959; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pr/aguadilla";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pr/aguadilla_audio", "ssa.pr.aguadilla.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pr/aguadilla_data", "ssa.pr.aguadilla.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pr/aguadilla_graphics", "ssa.pr.aguadilla.graphics.spectrum", sb.toString());
        }
    }
}