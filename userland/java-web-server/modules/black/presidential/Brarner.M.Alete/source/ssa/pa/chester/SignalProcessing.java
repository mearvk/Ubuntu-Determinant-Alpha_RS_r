package presidential.Brarner.M.Alete.source.ssa.pa.chester;
...
/**
 * Signal Processing for SSA Office: FOSU East - Branch 5
 * <p>Office Code: F5E</p>
 * <p>Address: 807 CROSBY ST, CHESTER, PA 19013</p>
 * <p>Phone: (877) 685-5942 | Fax: (833) 551-0607</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/chester/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9481; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/chester";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester_audio", "ssa.pa.chester.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester_data", "ssa.pa.chester.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester_graphics", "ssa.pa.chester.graphics.spectrum", sb.toString());
        }
    }
}