package presidential.Brarner.M.Alete.source.ssa.oh.piqua;
...
/**
 * Signal Processing for SSA Office: PIQUA OH
 * <p>Office Code: 418</p>
 * <p>Address: 277 S LOONEY RD, PIQUA, OH 45356</p>
 * <p>Phone: (866) 931-2520 | Fax: (833) 596-0554</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/piqua/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9859; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/piqua";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/piqua_audio", "ssa.oh.piqua.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/piqua_data", "ssa.oh.piqua.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/piqua_graphics", "ssa.oh.piqua.graphics.spectrum", sb.toString());
        }
    }
}