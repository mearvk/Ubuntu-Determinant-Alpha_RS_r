package presidential.Brarner.M.Alete.source.ssa.oh.lakewood;
...
/**
 * Signal Processing for SSA Office: CLEVELAND WEST OH
 * <p>Office Code: 407</p>
 * <p>Address: 17513 DETROIT AVE, LAKEWOOD, OH 44107</p>
 * <p>Phone: (866) 964-4389 | Fax: (833) 950-3431</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/lakewood/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9848; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/lakewood";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/lakewood_audio", "ssa.oh.lakewood.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/lakewood_data", "ssa.oh.lakewood.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/lakewood_graphics", "ssa.oh.lakewood.graphics.spectrum", sb.toString());
        }
    }
}