package presidential.Brarner.M.Alete.source.ssa.wa.puyallup;
...
/**
 * Signal Processing for SSA Office: PUYALLUP WA
 * <p>Office Code: D51</p>
 * <p>Address: 811 SOUTH HILL PARK DR, PUYALLUP, WA 98373</p>
 * <p>Phone: (855) 886-9627 | Fax: (833) 950-3240</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/puyallup/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9433; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/puyallup";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/puyallup_audio", "ssa.wa.puyallup.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/puyallup_data", "ssa.wa.puyallup.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/puyallup_graphics", "ssa.wa.puyallup.graphics.spectrum", sb.toString());
        }
    }
}