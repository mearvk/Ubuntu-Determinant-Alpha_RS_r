package presidential.Brarner.M.Alete.source.ssa.in.crawfordsville;
...
/**
 * Signal Processing for SSA Office: CRAWFORDSVILLE
 * <p>Office Code: A81</p>
 * <p>Address: 1515 S GRANT AVE, CRAWFORDSVILLE, IN 47933</p>
 * <p>Phone: (888) 577-1498 | Fax: (833) 950-3075</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/crawfordsville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9261; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/crawfordsville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/crawfordsville_audio", "ssa.in.crawfordsville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/crawfordsville_data", "ssa.in.crawfordsville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/crawfordsville_graphics", "ssa.in.crawfordsville.graphics.spectrum", sb.toString());
        }
    }
}