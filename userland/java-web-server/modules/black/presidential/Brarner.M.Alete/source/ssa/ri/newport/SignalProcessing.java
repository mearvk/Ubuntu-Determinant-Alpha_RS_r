...
/**
 * Signal Processing for SSA Office: NEWPORT RI
 * <p>Office Code: A89</p>
 * <p>Address: 130 BELLEVUE AVE, NEWPORT, RI 2840</p>
 * <p>Phone: (866) 253-5607 | Fax: (833) 950-3250</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ri/newport/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9266; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ri/newport";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ri/newport_audio", "ssa.ri.newport.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ri/newport_data", "ssa.ri.newport.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ri/newport_graphics", "ssa.ri.newport.graphics.spectrum", sb.toString());
        }
    }
}