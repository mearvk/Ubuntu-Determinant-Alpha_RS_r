package presidential.Brarner.M.Alete.source.ssa.la.hammond;
...
/**
 * Signal Processing for SSA Office: HAMMOND LA
 * <p>Office Code: 808</p>
 * <p>Address: 2100 ROBIN AVE, HAMMOND, LA 70403</p>
 * <p>Phone: (855) 848-7937 | Fax: (833) 950-3645</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/hammond/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10200; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/hammond";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/hammond_audio", "ssa.la.hammond.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/hammond_data", "ssa.la.hammond.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/hammond_graphics", "ssa.la.hammond.graphics.spectrum", sb.toString());
        }
    }
}