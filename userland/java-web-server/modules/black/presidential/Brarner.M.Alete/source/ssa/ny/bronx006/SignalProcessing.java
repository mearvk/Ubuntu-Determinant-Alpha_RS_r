...
/**
 * Signal Processing for SSA Office: LACONIA AVENUE
 * <p>Office Code: 179</p>
 * <p>Address: 3247 LACONIA AVE, BRONX, NY 10469</p>
 * <p>Phone: (866) 347-0054 | Fax: (833) 950-2988</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/bronx006/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9641; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/bronx006";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx006_audio", "ssa.ny.bronx006.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx006_data", "ssa.ny.bronx006.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx006_graphics", "ssa.ny.bronx006.graphics.spectrum", sb.toString());
        }
    }
}