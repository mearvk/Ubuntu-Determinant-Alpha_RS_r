...
/**
 * Signal Processing for SSA Office: BRISTOL VA
 * <p>Office Code: 288</p>
 * <p>Address: 3280 LEE HIGHWAY, BRISTOL, VA 24202</p>
 * <p>Phone: (866) 504-5013 | Fax: (833) 950-2282</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/bristol/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9738; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/bristol";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/bristol_audio", "ssa.va.bristol.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/bristol_data", "ssa.va.bristol.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/bristol_graphics", "ssa.va.bristol.graphics.spectrum", sb.toString());
        }
    }
}