...
/**
 * Signal Processing for SSA Office: FAIRMONT MN
 * <p>Office Code: 686</p>
 * <p>Address: 400 S. STATE ST, FAIRMONT, MN 56031</p>
 * <p>Phone: (877) 405-0414 | Fax: (833) 950-2182</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/fairmont/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10101; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/fairmont";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/fairmont_audio", "ssa.mn.fairmont.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/fairmont_data", "ssa.mn.fairmont.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/fairmont_graphics", "ssa.mn.fairmont.graphics.spectrum", sb.toString());
        }
    }
}