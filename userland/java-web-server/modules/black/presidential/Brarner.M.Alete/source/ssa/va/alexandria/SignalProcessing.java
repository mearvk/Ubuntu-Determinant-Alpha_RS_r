package presidential.Brarner.M.Alete.source.ssa.va.alexandria;
...
/**
 * Signal Processing for SSA Office: ALEXANDRIA VA
 * <p>Office Code: 294</p>
 * <p>Address: 5510 CHEROKEE AVE, ALEXANDRIA, VA 22312</p>
 * <p>Phone: (888) 472-2402 | Fax: (833) 950-2294</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/alexandria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9744; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/alexandria";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/alexandria_audio", "ssa.va.alexandria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/alexandria_data", "ssa.va.alexandria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/alexandria_graphics", "ssa.va.alexandria.graphics.spectrum", sb.toString());
        }
    }
}