package presidential.Brarner.M.Alete.source.ssa.nj.tomsriver;
...
/**
 * Signal Processing for SSA Office: TOMS RIVER NJ
 * <p>Office Code: A26</p>
 * <p>Address: 190 ST CATHERINE BLVD, TOMS RIVER, NJ 8755</p>
 * <p>Phone: (877) 255-1497 | Fax: (833) 950-2670</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/tomsriver/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9215; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/tomsriver";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/tomsriver_audio", "ssa.nj.tomsriver.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/tomsriver_data", "ssa.nj.tomsriver.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/tomsriver_graphics", "ssa.nj.tomsriver.graphics.spectrum", sb.toString());
        }
    }
}