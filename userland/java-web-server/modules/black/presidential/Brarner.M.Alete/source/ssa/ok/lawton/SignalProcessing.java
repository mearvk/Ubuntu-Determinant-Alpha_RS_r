package presidential.Brarner.M.Alete.source.ssa.ok.lawton;
...
/**
 * Signal Processing for SSA Office: LAWTON OK
 * <p>Office Code: 790</p>
 * <p>Address: 1610 SW LEE BLVD, LAWTON, OK 73501</p>
 * <p>Phone: (866) 931-2732 | Fax: (833) 950-3327</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/lawton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10184; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/lawton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/lawton_audio", "ssa.ok.lawton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/lawton_data", "ssa.ok.lawton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/lawton_graphics", "ssa.ok.lawton.graphics.spectrum", sb.toString());
        }
    }
}