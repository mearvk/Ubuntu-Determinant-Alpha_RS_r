...
/**
 * Signal Processing for SSA Office: NEWARK NJ
 * <p>Office Code: 170</p>
 * <p>Address: 970 BROAD STREET, NEWARK, NJ 7102</p>
 * <p>Phone: (877) 255-1507 | Fax: (833) 950-2690</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/newark/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9631; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/newark";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/newark_audio", "ssa.nj.newark.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/newark_data", "ssa.nj.newark.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/newark_graphics", "ssa.nj.newark.graphics.spectrum", sb.toString());
        }
    }
}