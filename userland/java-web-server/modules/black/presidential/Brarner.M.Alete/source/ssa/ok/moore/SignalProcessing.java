...
/**
 * Signal Processing for SSA Office: MOORE OK
 * <p>Office Code: 792</p>
 * <p>Address: 200 NE 27TH ST, MOORE, OK 73160</p>
 * <p>Phone: (866) 964-4260 | Fax: (833) 950-3337</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/moore/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10186; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/moore";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/moore_audio", "ssa.ok.moore.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/moore_data", "ssa.ok.moore.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/moore_graphics", "ssa.ok.moore.graphics.spectrum", sb.toString());
        }
    }
}