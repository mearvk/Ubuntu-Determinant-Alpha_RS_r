...
/**
 * Signal Processing for SSA Office: ROSTRAVER PA
 * <p>Office Code: 241</p>
 * <p>Address: 800 PLAZA DR, ROSTRAVER TWP, PA 15012</p>
 * <p>Phone: (866) 931-4826 | Fax: (833) 603-0369</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/rostravertwp/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9698; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/rostravertwp";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/rostravertwp_audio", "ssa.pa.rostravertwp.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/rostravertwp_data", "ssa.pa.rostravertwp.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/rostravertwp_graphics", "ssa.pa.rostravertwp.graphics.spectrum", sb.toString());
        }
    }
}