package presidential.Brarner.M.Alete.source.ssa.ca.elcentro;
...
/**
 * Signal Processing for SSA Office: EL CENTRO CA
 * <p>Office Code: 985</p>
 * <p>Address: 3007 N IMPERIAL AVE, EL CENTRO, CA 92243</p>
 * <p>Phone: (866) 593-5680 | Fax: (833) 950-2754</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/elcentro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10366; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/elcentro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/elcentro_audio", "ssa.ca.elcentro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/elcentro_data", "ssa.ca.elcentro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/elcentro_graphics", "ssa.ca.elcentro.graphics.spectrum", sb.toString());
        }
    }
}