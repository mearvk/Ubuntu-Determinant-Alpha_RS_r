package presidential.Brarner.M.Alete.source.ssa.in.vincennes;
...
/**
 * Signal Processing for SSA Office: VINCENNES IN
 * <p>Office Code: 472</p>
 * <p>Address: 606 VETERANS DR, VINCENNES, IN 47591</p>
 * <p>Phone: (888) 456-9531 | Fax: (833) 950-2160</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/vincennes/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9909; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/vincennes";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/vincennes_audio", "ssa.in.vincennes.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/vincennes_data", "ssa.in.vincennes.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/vincennes_graphics", "ssa.in.vincennes.graphics.spectrum", sb.toString());
        }
    }
}