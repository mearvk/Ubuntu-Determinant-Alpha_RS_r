package presidential.Brarner.M.Alete.source.ssa.id.pocatello;
...
/**
 * Signal Processing for SSA Office: POCATELLO ID
 * <p>Office Code: 894</p>
 * <p>Address: 861 JEFFERSON AVE, POCATELLO, ID 83201</p>
 * <p>Phone: (866) 643-3407 | Fax: (833) 912-2551</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/id/pocatello/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10278; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/id/pocatello";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_id/pocatello_audio", "ssa.id.pocatello.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_id/pocatello_data", "ssa.id.pocatello.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_id/pocatello_graphics", "ssa.id.pocatello.graphics.spectrum", sb.toString());
        }
    }
}