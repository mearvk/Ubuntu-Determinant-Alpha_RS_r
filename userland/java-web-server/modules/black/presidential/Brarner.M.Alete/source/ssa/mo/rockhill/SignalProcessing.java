...
/**
 * Signal Processing for SSA Office: ST LOUIS-SOUTHSIDE
 * <p>Office Code: 745</p>
 * <p>Address: 9494 MANCHESTER RD, ROCK HILL, MO 63119</p>
 * <p>Phone: (877) 714-0372 | Fax: (833) 926-1831</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/rockhill/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10146; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/rockhill";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/rockhill_audio", "ssa.mo.rockhill.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/rockhill_data", "ssa.mo.rockhill.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/rockhill_graphics", "ssa.mo.rockhill.graphics.spectrum", sb.toString());
        }
    }
}