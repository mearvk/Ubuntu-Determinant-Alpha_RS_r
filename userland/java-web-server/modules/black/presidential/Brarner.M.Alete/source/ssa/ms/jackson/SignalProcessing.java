package presidential.Brarner.M.Alete.source.ssa.ms.jackson;
...
/**
 * Signal Processing for SSA Office: JACKSON MS FO
 * <p>Office Code: 641</p>
 * <p>Address: 100 W CAPITOL STREET, JACKSON, MS 39269</p>
 * <p>Phone: (866) 331-8135 | Fax: (833) 950-3795</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/jackson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10061; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/jackson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/jackson_audio", "ssa.ms.jackson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/jackson_data", "ssa.ms.jackson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/jackson_graphics", "ssa.ms.jackson.graphics.spectrum", sb.toString());
        }
    }
}