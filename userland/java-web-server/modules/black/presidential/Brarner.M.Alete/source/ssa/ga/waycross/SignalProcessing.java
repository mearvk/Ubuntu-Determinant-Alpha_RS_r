package presidential.Brarner.M.Alete.source.ssa.ga.waycross;
...
/**
 * Signal Processing for SSA Office: WAYCROSS GA
 * <p>Office Code: 607</p>
 * <p>Address: 303 ISABELLA ST, WAYCROSS, GA 31501</p>
 * <p>Phone: (877) 405-3578 | Fax: (833) 950-2852</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/waycross/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10030; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/waycross";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/waycross_audio", "ssa.ga.waycross.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/waycross_data", "ssa.ga.waycross.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/waycross_graphics", "ssa.ga.waycross.graphics.spectrum", sb.toString());
        }
    }
}