...
/**
 * Signal Processing for SSA Office: CASPER WY
 * <p>Office Code: 877</p>
 * <p>Address: 150 E B ST, CASPER, WY 82601</p>
 * <p>Phone: (866) 964-3972 | Fax: (833) 515-0421</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wy/casper/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10264; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wy/casper";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wy/casper_audio", "ssa.wy.casper.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wy/casper_data", "ssa.wy.casper.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wy/casper_graphics", "ssa.wy.casper.graphics.spectrum", sb.toString());
        }
    }
}