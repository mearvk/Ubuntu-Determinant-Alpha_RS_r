package presidential.Brarner.M.Alete.source.ssa.mi.monroe;
...
/**
 * Signal Processing for SSA Office: MONROE MI
 * <p>Office Code: 369</p>
 * <p>Address: 1300 S TELEGRAPH RD, MONROE, MI 48161</p>
 * <p>Phone: (877) 274-5416 | Fax: (833) 950-2772</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/monroe/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9816; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/monroe";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/monroe_audio", "ssa.mi.monroe.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/monroe_data", "ssa.mi.monroe.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/monroe_graphics", "ssa.mi.monroe.graphics.spectrum", sb.toString());
        }
    }
}