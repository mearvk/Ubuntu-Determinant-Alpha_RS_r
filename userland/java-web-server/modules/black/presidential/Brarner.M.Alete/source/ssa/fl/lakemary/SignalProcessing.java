package presidential.Brarner.M.Alete.source.ssa.fl.lakemary;
...
/**
 * Signal Processing for SSA Office: LAKE MARY FL
 * <p>Office Code: 269</p>
 * <p>Address: SUITE 2001, LAKE MARY, FL 32746</p>
 * <p>Phone: (866) 964-7379 | Fax: (833) 873-4341</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/lakemary/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9719; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/lakemary";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/lakemary_audio", "ssa.fl.lakemary.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/lakemary_data", "ssa.fl.lakemary.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/lakemary_graphics", "ssa.fl.lakemary.graphics.spectrum", sb.toString());
        }
    }
}