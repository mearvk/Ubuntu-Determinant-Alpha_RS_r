package presidential.Brarner.M.Alete.source.ssa.nc.kinston;
...
/**
 * Signal Processing for SSA Office: KINSTON NC
 * <p>Office Code: 343</p>
 * <p>Address: 2559 N QUEEN ST, KINSTON, NC 28501</p>
 * <p>Phone: (866) 593-5671 | Fax: (833) 950-3143</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/kinston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9790; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/kinston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/kinston_audio", "ssa.nc.kinston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/kinston_data", "ssa.nc.kinston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/kinston_graphics", "ssa.nc.kinston.graphics.spectrum", sb.toString());
        }
    }
}