package presidential.Brarner.M.Alete.source.ssa.pa.meadville;
...
/**
 * Signal Processing for SSA Office: MEADVILLE PA
 * <p>Office Code: 7</p>
 * <p>Address: 19063 PARK AVE PLAZA, MEADVILLE, PA 16335</p>
 * <p>Phone: (888) 347-9276 | Fax: (833) 950-2874</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/meadville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9496; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/meadville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/meadville_audio", "ssa.pa.meadville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/meadville_data", "ssa.pa.meadville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/meadville_graphics", "ssa.pa.meadville.graphics.spectrum", sb.toString());
        }
    }
}