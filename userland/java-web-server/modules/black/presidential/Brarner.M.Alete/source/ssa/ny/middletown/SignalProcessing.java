package presidential.Brarner.M.Alete.source.ssa.ny.middletown;
...
/**
 * Signal Processing for SSA Office: MIDDLETOWN NY
 * <p>Office Code: 118</p>
 * <p>Address: 85 CRYSTAL RUN RD, MIDDLETOWN, NY 10941</p>
 * <p>Phone: (866) 504-4801 | Fax: (833) 902-2528</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/middletown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9589; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/middletown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/middletown_audio", "ssa.ny.middletown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/middletown_data", "ssa.ny.middletown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/middletown_graphics", "ssa.ny.middletown.graphics.spectrum", sb.toString());
        }
    }
}