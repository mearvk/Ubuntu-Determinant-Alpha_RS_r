package presidential.Brarner.M.Alete.source.ssa.la.lacombe;
...
/**
 * Signal Processing for SSA Office: ST TAMMANY LA
 * <p>Office Code: D18</p>
 * <p>Address: 64285 HIGHWAY 434, LACOMBE, LA 70445</p>
 * <p>Phone: (866) 887-8997 | Fax: (833) 939-2009</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/lacombe/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9411; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/lacombe";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/lacombe_audio", "ssa.la.lacombe.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/lacombe_data", "ssa.la.lacombe.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/lacombe_graphics", "ssa.la.lacombe.graphics.spectrum", sb.toString());
        }
    }
}