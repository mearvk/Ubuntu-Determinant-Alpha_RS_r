package presidential.Brarner.M.Alete.source.ssa.ga.winder;
...
/**
 * Signal Processing for SSA Office: WINDER GA
 * <p>Office Code: C31</p>
 * <p>Address: 389 EAST BROAD ST, WINDER, GA 30680</p>
 * <p>Phone: (866) 331-9071 | Fax: (833) 950-3765</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/winder/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9357; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/winder";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/winder_audio", "ssa.ga.winder.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/winder_data", "ssa.ga.winder.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/winder_graphics", "ssa.ga.winder.graphics.spectrum", sb.toString());
        }
    }
}