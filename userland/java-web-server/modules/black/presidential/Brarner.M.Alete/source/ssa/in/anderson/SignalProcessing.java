package presidential.Brarner.M.Alete.source.ssa.in.anderson;
...
/**
 * Signal Processing for SSA Office: ANDERSON IN
 * <p>Office Code: 468</p>
 * <p>Address: 117 S SCATTERFIELD RD, ANDERSON, IN 46012</p>
 * <p>Phone: (866) 875-0394 | Fax: (833) 950-2148</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/anderson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9905; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/anderson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/anderson_audio", "ssa.in.anderson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/anderson_data", "ssa.in.anderson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/anderson_graphics", "ssa.in.anderson.graphics.spectrum", sb.toString());
        }
    }
}