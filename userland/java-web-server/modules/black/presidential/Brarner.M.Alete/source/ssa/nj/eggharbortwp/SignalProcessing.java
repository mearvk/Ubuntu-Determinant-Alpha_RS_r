package presidential.Brarner.M.Alete.source.ssa.nj.eggharbortwp;
...
/**
 * Signal Processing for SSA Office: EGG HARBOR TWP NJ
 * <p>Office Code: 178</p>
 * <p>Address: 1350 DOUGHTY RD, EGG HARBOR TWP, NJ 8234</p>
 * <p>Phone: (877) 714-0394 | Fax: (833) 950-2986</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/eggharbortwp/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9640; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/eggharbortwp";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/eggharbortwp_audio", "ssa.nj.eggharbortwp.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/eggharbortwp_data", "ssa.nj.eggharbortwp.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/eggharbortwp_graphics", "ssa.nj.eggharbortwp.graphics.spectrum", sb.toString());
        }
    }
}