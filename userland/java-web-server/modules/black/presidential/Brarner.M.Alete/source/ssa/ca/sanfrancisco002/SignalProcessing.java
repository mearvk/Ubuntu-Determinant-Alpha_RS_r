package presidential.Brarner.M.Alete.source.ssa.ca.sanfrancisco002;
...
/**
 * Signal Processing for SSA Office: SF MISSION CA
 * <p>Office Code: 781</p>
 * <p>Address: 3140 16TH ST, SAN FRANCISCO, CA 94103</p>
 * <p>Phone: (866) 755-6323 | Fax: (833) 950-3385</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sanfrancisco002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10177; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sanfrancisco002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanfrancisco002_audio", "ssa.ca.sanfrancisco002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanfrancisco002_data", "ssa.ca.sanfrancisco002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanfrancisco002_graphics", "ssa.ca.sanfrancisco002.graphics.spectrum", sb.toString());
        }
    }
}