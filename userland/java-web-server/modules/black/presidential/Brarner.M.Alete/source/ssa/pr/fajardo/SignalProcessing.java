package presidential.Brarner.M.Alete.source.ssa.pr.fajardo;
...
/**
 * Signal Processing for SSA Office: FAJARDO PR
 * <p>Office Code: C71</p>
 * <p>Address: ROAD 3 KM 42.4 QUEBRADA WARD, FAJARDO, PR 738</p>
 * <p>Phone: (855) 856-2728 | Fax: (833) 950-3275</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pr/fajardo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9380; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pr/fajardo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pr/fajardo_audio", "ssa.pr.fajardo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pr/fajardo_data", "ssa.pr.fajardo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pr/fajardo_graphics", "ssa.pr.fajardo.graphics.spectrum", sb.toString());
        }
    }
}