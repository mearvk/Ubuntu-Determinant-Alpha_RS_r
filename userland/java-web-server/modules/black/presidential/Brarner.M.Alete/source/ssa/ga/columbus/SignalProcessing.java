package presidential.Brarner.M.Alete.source.ssa.ga.columbus;
...
/**
 * Signal Processing for SSA Office: COLUMBUS GA
 * <p>Office Code: 605</p>
 * <p>Address: 7263 NORTH LAKE DR, COLUMBUS, GA 31909</p>
 * <p>Phone: (877) 784-3688 | Fax: (833) 950-2568</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/columbus/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10028; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/columbus";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/columbus_audio", "ssa.ga.columbus.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/columbus_data", "ssa.ga.columbus.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/columbus_graphics", "ssa.ga.columbus.graphics.spectrum", sb.toString());
        }
    }
}