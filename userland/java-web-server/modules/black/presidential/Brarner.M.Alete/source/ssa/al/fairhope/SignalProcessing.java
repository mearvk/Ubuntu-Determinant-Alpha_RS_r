...
/**
 * Signal Processing for SSA Office: FAIRHOPE AL
 * <p>Office Code: C27</p>
 * <p>Address: 101 COURTHOUSE DR, FAIRHOPE, AL 36532</p>
 * <p>Phone: (866) 837-5964 | Fax: (833) 950-3759</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/fairhope/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9355; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/fairhope";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/fairhope_audio", "ssa.al.fairhope.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/fairhope_data", "ssa.al.fairhope.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/fairhope_graphics", "ssa.al.fairhope.graphics.spectrum", sb.toString());
        }
    }
}