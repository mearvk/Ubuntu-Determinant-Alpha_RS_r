...
/**
 * Signal Processing for SSA Office: ST ALBANS WV
 * <p>Office Code: C15</p>
 * <p>Address: 49 OLDE MAIN PLAZA, ST ALBANS, WV 25177</p>
 * <p>Phone: (866) 316-8153 | Fax: (833) 912-2304</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/stalbans/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9349; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/stalbans";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/stalbans_audio", "ssa.wv.stalbans.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/stalbans_data", "ssa.wv.stalbans.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/stalbans_graphics", "ssa.wv.stalbans.graphics.spectrum", sb.toString());
        }
    }
}