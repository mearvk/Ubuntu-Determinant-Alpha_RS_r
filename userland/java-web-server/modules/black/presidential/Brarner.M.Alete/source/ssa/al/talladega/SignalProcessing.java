...
/**
 * Signal Processing for SSA Office: TALLADEGA AL
 * <p>Office Code: 635</p>
 * <p>Address: 736 NORTH STREET EAST, TALLADEGA, AL 35160</p>
 * <p>Phone: (877) 619-2854 | Fax: (833) 950-3509</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/talladega/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10058; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/talladega";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/talladega_audio", "ssa.al.talladega.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/talladega_data", "ssa.al.talladega.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/talladega_graphics", "ssa.al.talladega.graphics.spectrum", sb.toString());
        }
    }
}