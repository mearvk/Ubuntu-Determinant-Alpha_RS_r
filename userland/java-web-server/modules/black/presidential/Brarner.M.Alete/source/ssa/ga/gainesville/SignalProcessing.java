package presidential.Brarner.M.Alete.source.ssa.ga.gainesville;
...
/**
 * Signal Processing for SSA Office: GAINESVILLE GA
 * <p>Office Code: 612</p>
 * <p>Address: 2565 THOMPSON BRDG RD, GAINESVILLE, GA 30501</p>
 * <p>Phone: (866) 331-2309 | Fax: (833) 950-2862</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/gainesville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10035; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/gainesville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/gainesville_audio", "ssa.ga.gainesville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/gainesville_data", "ssa.ga.gainesville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/gainesville_graphics", "ssa.ga.gainesville.graphics.spectrum", sb.toString());
        }
    }
}