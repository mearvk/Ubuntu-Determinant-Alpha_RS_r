...
/**
 * Signal Processing for SSA Office: FT WALTON BEACH FL
 * <p>Office Code: A20</p>
 * <p>Address: 111-B RACETRACK RD NW, FORT WALTON BEACH, FL 32547</p>
 * <p>Phone: (866) 331-2194 | Fax: (833) 950-2514</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/fortwaltonbeach/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9210; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/fortwaltonbeach";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/fortwaltonbeach_audio", "ssa.fl.fortwaltonbeach.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/fortwaltonbeach_data", "ssa.fl.fortwaltonbeach.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/fortwaltonbeach_graphics", "ssa.fl.fortwaltonbeach.graphics.spectrum", sb.toString());
        }
    }
}