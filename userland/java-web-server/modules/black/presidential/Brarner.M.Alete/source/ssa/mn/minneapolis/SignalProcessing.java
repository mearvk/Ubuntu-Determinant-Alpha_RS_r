package presidential.Brarner.M.Alete.source.ssa.mn.minneapolis;
...
/**
 * Signal Processing for SSA Office: MINNEAPOLIS MN
 * <p>Office Code: 675</p>
 * <p>Address: 1811 CHICAGO AVE, MINNEAPOLIS, MN 55404</p>
 * <p>Phone: (855) 257-0982 | Fax: (833) 902-2688</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/minneapolis/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10090; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/minneapolis";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/minneapolis_audio", "ssa.mn.minneapolis.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/minneapolis_data", "ssa.mn.minneapolis.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/minneapolis_graphics", "ssa.mn.minneapolis.graphics.spectrum", sb.toString());
        }
    }
}