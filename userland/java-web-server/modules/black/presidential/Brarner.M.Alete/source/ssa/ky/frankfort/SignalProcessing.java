package presidential.Brarner.M.Alete.source.ssa.ky.frankfort;
...
/**
 * Signal Processing for SSA Office: FRANKFORT KY
 * <p>Office Code: 441</p>
 * <p>Address: 140 FLYNN AVE, FRANKFORT, KY 40601</p>
 * <p>Phone: (866) 964-1724 | Fax: (833) 950-3473</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/frankfort/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9878; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/frankfort";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/frankfort_audio", "ssa.ky.frankfort.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/frankfort_data", "ssa.ky.frankfort.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/frankfort_graphics", "ssa.ky.frankfort.graphics.spectrum", sb.toString());
        }
    }
}