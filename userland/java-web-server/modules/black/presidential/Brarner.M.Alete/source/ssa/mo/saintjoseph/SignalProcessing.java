package presidential.Brarner.M.Alete.source.ssa.mo.saintjoseph;
...
/**
 * Signal Processing for SSA Office: ST JOSEPH MO
 * <p>Office Code: 737</p>
 * <p>Address: 3715 BECK RD STE F, SAINT JOSEPH, MO 64506</p>
 * <p>Phone: (888) 366-6148 | Fax: (833) 902-2504</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/saintjoseph/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10139; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/saintjoseph";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/saintjoseph_audio", "ssa.mo.saintjoseph.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/saintjoseph_data", "ssa.mo.saintjoseph.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/saintjoseph_graphics", "ssa.mo.saintjoseph.graphics.spectrum", sb.toString());
        }
    }
}