package presidential.Brarner.M.Alete.source.ssa.ky.prestonsburg;
...
/**
 * Signal Processing for SSA Office: PRESTONSBURG KY
 * <p>Office Code: B24</p>
 * <p>Address: 1897 KY RT 321, PRESTONSBURG, KY 41653</p>
 * <p>Phone: (888) 450-4538 | Fax: (833) 950-3457</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/prestonsburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9292; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/prestonsburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/prestonsburg_audio", "ssa.ky.prestonsburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/prestonsburg_data", "ssa.ky.prestonsburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/prestonsburg_graphics", "ssa.ky.prestonsburg.graphics.spectrum", sb.toString());
        }
    }
}