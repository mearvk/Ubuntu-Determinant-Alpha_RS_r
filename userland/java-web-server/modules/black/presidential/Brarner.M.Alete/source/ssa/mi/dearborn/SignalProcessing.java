package presidential.Brarner.M.Alete.source.ssa.mi.dearborn;
...
/**
 * Signal Processing for SSA Office: DEARBORN
 * <p>Office Code: 361</p>
 * <p>Address: 19853 OUTER DRIVE, DEARBORN, MI 48124</p>
 * <p>Phone: (877) 714-0392 | Fax: (833) 950-2466</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/dearborn/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9808; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/dearborn";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/dearborn_audio", "ssa.mi.dearborn.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/dearborn_data", "ssa.mi.dearborn.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/dearborn_graphics", "ssa.mi.dearborn.graphics.spectrum", sb.toString());
        }
    }
}