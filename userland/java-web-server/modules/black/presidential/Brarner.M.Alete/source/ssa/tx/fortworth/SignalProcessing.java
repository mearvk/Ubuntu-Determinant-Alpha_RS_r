package presidential.Brarner.M.Alete.source.ssa.tx.fortworth;
...
/**
 * Signal Processing for SSA Office: FORT WORTH SOUTH TX
 * <p>Office Code: E35</p>
 * <p>Address: 2901 ALTAMESA BLVD, FORT WORTH, TX 76133</p>
 * <p>Phone: (866) 613-2745 | Fax: (833) 950-2382</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/fortworth/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9464; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/fortworth";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/fortworth_audio", "ssa.tx.fortworth.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/fortworth_data", "ssa.tx.fortworth.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/fortworth_graphics", "ssa.tx.fortworth.graphics.spectrum", sb.toString());
        }
    }
}