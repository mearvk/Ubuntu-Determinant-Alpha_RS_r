package presidential.Brarner.M.Alete.source.ssa.vi.christiansted;
...
/**
 * Signal Processing for SSA Office: ST CROIX VI
 * <p>Office Code: D79</p>
 * <p>Address: 4094 DIAMOND RUBY, CHRISTIANSTED, VI 820</p>
 * <p>Phone: (866) 209-0446 | Fax: (833) 950-3593</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/vi/christiansted/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9447; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/vi/christiansted";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_vi/christiansted_audio", "ssa.vi.christiansted.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_vi/christiansted_data", "ssa.vi.christiansted.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_vi/christiansted_graphics", "ssa.vi.christiansted.graphics.spectrum", sb.toString());
        }
    }
}