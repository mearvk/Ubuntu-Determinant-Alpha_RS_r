...
/**
 * Signal Processing for SSA Office: CORDELE GA
 * <p>Office Code: C91</p>
 * <p>Address: 510 E 15TH AVE, CORDELE, GA 31015</p>
 * <p>Phone: (888) 225-8869 | Fax: (833) 597-0062</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/cordele/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9392; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/cordele";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/cordele_audio", "ssa.ga.cordele.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/cordele_data", "ssa.ga.cordele.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/cordele_graphics", "ssa.ga.cordele.graphics.spectrum", sb.toString());
        }
    }
}