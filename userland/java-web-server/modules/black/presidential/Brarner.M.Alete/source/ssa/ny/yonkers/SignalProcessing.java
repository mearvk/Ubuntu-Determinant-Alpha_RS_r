package presidential.Brarner.M.Alete.source.ssa.ny.yonkers;
...
/**
 * Signal Processing for SSA Office: YONKERS NY
 * <p>Office Code: 113</p>
 * <p>Address: 20 SOUTH BROADWAY, YONKERS, NY 10701</p>
 * <p>Phone: (866) 331-6404 | Fax: (833) 515-0475</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/yonkers/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9584; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/yonkers";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/yonkers_audio", "ssa.ny.yonkers.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/yonkers_data", "ssa.ny.yonkers.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/yonkers_graphics", "ssa.ny.yonkers.graphics.spectrum", sb.toString());
        }
    }
}