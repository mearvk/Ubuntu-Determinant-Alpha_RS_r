package presidential.Brarner.M.Alete.source.ssa.ga.vidalia;
...
/**
 * Signal Processing for SSA Office: VIDALIA GA
 * <p>Office Code: E69</p>
 * <p>Address: 104 W THIRD ST, VIDALIA, GA 30474</p>
 * <p>Phone: (866) 931-2518 | Fax: (833) 902-2710</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/vidalia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9474; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/vidalia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/vidalia_audio", "ssa.ga.vidalia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/vidalia_data", "ssa.ga.vidalia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/vidalia_graphics", "ssa.ga.vidalia.graphics.spectrum", sb.toString());
        }
    }
}