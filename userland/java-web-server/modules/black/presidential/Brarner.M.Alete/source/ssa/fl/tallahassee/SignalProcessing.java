package presidential.Brarner.M.Alete.source.ssa.fl.tallahassee;
...
/**
 * Signal Processing for SSA Office: TALLAHASSEE FL
 * <p>Office Code: 659</p>
 * <p>Address: 2002 OLD ST AUGUSTINE, TALLAHASSEE, FL 32301</p>
 * <p>Phone: (866) 248-2088 | Fax: (833) 679-0237</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/tallahassee/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10078; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/tallahassee";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/tallahassee_audio", "ssa.fl.tallahassee.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/tallahassee_data", "ssa.fl.tallahassee.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/tallahassee_graphics", "ssa.fl.tallahassee.graphics.spectrum", sb.toString());
        }
    }
}