package presidential.Brarner.M.Alete.source.ssa.az.tucson;
...
/**
 * Signal Processing for SSA Office: TUCSON AZ
 * <p>Office Code: 908</p>
 * <p>Address: 3808 N 1ST AVE, TUCSON, AZ 85719</p>
 * <p>Phone: (866) 331-7693 | Fax: (833) 873-4349</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/az/tucson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10291; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/az/tucson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_az/tucson_audio", "ssa.az.tucson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_az/tucson_data", "ssa.az.tucson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_az/tucson_graphics", "ssa.az.tucson.graphics.spectrum", sb.toString());
        }
    }
}