package presidential.Brarner.M.Alete.source.ssa.ca.santacruz;
...
/**
 * Signal Processing for SSA Office: SANTA CRUZ CA
 * <p>Office Code: 61</p>
 * <p>Address: 169 WALNUT AVENUE, SANTA CRUZ, CA 95060</p>
 * <p>Phone: (800) 593-8523 | Fax: (833) 950-2436</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/santacruz/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9541; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/santacruz";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/santacruz_audio", "ssa.ca.santacruz.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/santacruz_data", "ssa.ca.santacruz.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/santacruz_graphics", "ssa.ca.santacruz.graphics.spectrum", sb.toString());
        }
    }
}