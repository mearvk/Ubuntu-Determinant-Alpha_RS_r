package presidential.Brarner.M.Alete.source.ssa.va.accomac;
...
/**
 * Signal Processing for SSA Office: ACCOMAC VA
 * <p>Office Code: B68</p>
 * <p>Address: 22581 CENTER PKWY, ACCOMAC, VA 23301</p>
 * <p>Phone: (866) 964-1019 | Fax: (833) 912-2320</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/accomac/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9326; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/accomac";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/accomac_audio", "ssa.va.accomac.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/accomac_data", "ssa.va.accomac.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/accomac_graphics", "ssa.va.accomac.graphics.spectrum", sb.toString());
        }
    }
}