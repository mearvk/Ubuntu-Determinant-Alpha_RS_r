...
/**
 * Signal Processing for SSA Office: BATON ROUGE NORTH LA
 * <p>Office Code: E36</p>
 * <p>Address: 4332 HARDING BLVD, BATON ROUGE, LA 70807</p>
 * <p>Phone: (888) 487-0143 | Fax: (833) 950-2383</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/batonrouge/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9465; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/batonrouge";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/batonrouge_audio", "ssa.la.batonrouge.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/batonrouge_data", "ssa.la.batonrouge.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/batonrouge_graphics", "ssa.la.batonrouge.graphics.spectrum", sb.toString());
        }
    }
}