package presidential.Brarner.M.Alete.source.ssa.me.waterville;
...
/**
 * Signal Processing for SSA Office: WATERVILLE ME
 * <p>Office Code: C65</p>
 * <p>Address: 14 COLBY STREET, WATERVILLE, ME 4901</p>
 * <p>Phone: (866) 931-9169 | Fax: (833) 950-3258</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/me/waterville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9376; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/me/waterville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_me/waterville_audio", "ssa.me.waterville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_me/waterville_data", "ssa.me.waterville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_me/waterville_graphics", "ssa.me.waterville.graphics.spectrum", sb.toString());
        }
    }
}