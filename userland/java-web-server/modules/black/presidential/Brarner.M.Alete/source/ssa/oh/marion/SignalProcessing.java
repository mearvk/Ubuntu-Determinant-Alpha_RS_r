package presidential.Brarner.M.Alete.source.ssa.oh.marion;
...
/**
 * Signal Processing for SSA Office: MARION OH
 * <p>Office Code: 404</p>
 * <p>Address: 1363 WELLNESS DR, MARION, OH 43302</p>
 * <p>Phone: (888) 475-0296 | Fax: (833) 950-3425</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/marion/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9845; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/marion";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/marion_audio", "ssa.oh.marion.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/marion_data", "ssa.oh.marion.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/marion_graphics", "ssa.oh.marion.graphics.spectrum", sb.toString());
        }
    }
}