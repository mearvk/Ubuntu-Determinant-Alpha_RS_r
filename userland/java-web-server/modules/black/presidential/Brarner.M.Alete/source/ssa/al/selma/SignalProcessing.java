package presidential.Brarner.M.Alete.source.ssa.al.selma;
...
/**
 * Signal Processing for SSA Office: SELMA AL
 * <p>Office Code: 630</p>
 * <p>Address: 120 EXECUTIVE PARK LN, SELMA, AL 36701</p>
 * <p>Phone: (877) 628-6541 | Fax: (833) 950-3499</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/selma/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10053; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/selma";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/selma_audio", "ssa.al.selma.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/selma_data", "ssa.al.selma.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/selma_graphics", "ssa.al.selma.graphics.spectrum", sb.toString());
        }
    }
}