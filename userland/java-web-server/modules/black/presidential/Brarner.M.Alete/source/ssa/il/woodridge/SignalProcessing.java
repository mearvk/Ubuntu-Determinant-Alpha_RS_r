...
/**
 * Signal Processing for SSA Office: WOODRIDGE IL
 * <p>Office Code: A55</p>
 * <p>Address: 7440 PROVIDENCE DR, WOODRIDGE, IL 60517</p>
 * <p>Phone: (866) 303-2724 | Fax: (833) 950-2770</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/woodridge/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9237; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/woodridge";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/woodridge_audio", "ssa.il.woodridge.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/woodridge_data", "ssa.il.woodridge.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/woodridge_graphics", "ssa.il.woodridge.graphics.spectrum", sb.toString());
        }
    }
}