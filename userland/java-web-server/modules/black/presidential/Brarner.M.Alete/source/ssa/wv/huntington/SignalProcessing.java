package presidential.Brarner.M.Alete.source.ssa.wv.huntington;
...
/**
 * Signal Processing for SSA Office: HUNTINGTON WV
 * <p>Office Code: 308</p>
 * <p>Address: 301 9TH STREET, HUNTINGTON, WV 25701</p>
 * <p>Phone: (866) 931-7078 | Fax: (833) 950-2257</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/huntington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9758; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/huntington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/huntington_audio", "ssa.wv.huntington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/huntington_data", "ssa.wv.huntington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/huntington_graphics", "ssa.wv.huntington.graphics.spectrum", sb.toString());
        }
    }
}