...
/**
 * Signal Processing for SSA Office: OTTUMWA IA
 * <p>Office Code: 694</p>
 * <p>Address: 2429 NORTHGATE ST, OTTUMWA, IA 52501</p>
 * <p>Phone: (866) 964-7394 | Fax: (833) 515-0427</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/ottumwa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10108; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/ottumwa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/ottumwa_audio", "ssa.ia.ottumwa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/ottumwa_data", "ssa.ia.ottumwa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/ottumwa_graphics", "ssa.ia.ottumwa.graphics.spectrum", sb.toString());
        }
    }
}