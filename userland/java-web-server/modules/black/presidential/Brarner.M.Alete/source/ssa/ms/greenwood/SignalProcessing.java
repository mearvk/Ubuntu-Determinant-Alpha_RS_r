package presidential.Brarner.M.Alete.source.ssa.ms.greenwood;
...
/**
 * Signal Processing for SSA Office: GREENWOOD MS
 * <p>Office Code: 645</p>
 * <p>Address: 604 YALOBUSHA STREET, GREENWOOD, MS 38930</p>
 * <p>Phone: (866) 331-2209 | Fax: (833) 950-3803</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/greenwood/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10065; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/greenwood";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/greenwood_audio", "ssa.ms.greenwood.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/greenwood_data", "ssa.ms.greenwood.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/greenwood_graphics", "ssa.ms.greenwood.graphics.spectrum", sb.toString());
        }
    }
}