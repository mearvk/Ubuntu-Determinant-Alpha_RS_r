...
/**
 * Signal Processing for SSA Office: SALINA KS
 * <p>Office Code: 770</p>
 * <p>Address: 1410 E IRON AVE, SALINA, KS 67401</p>
 * <p>Phone: (877) 405-3494 | Fax: (833) 950-2332</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ks/salina/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10167; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ks/salina";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ks/salina_audio", "ssa.ks.salina.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ks/salina_data", "ssa.ks.salina.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ks/salina_graphics", "ssa.ks.salina.graphics.spectrum", sb.toString());
        }
    }
}