package presidential.Brarner.M.Alete.source.ssa.ma.taunton;
...
/**
 * Signal Processing for SSA Office: TAUNTON MA
 * <p>Office Code: 57</p>
 * <p>Address: 104 DEAN ST, TAUNTON, MA 2780</p>
 * <p>Phone: (877) 505-4546 | Fax: (833) 950-2344</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/taunton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9538; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/taunton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/taunton_audio", "ssa.ma.taunton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/taunton_data", "ssa.ma.taunton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/taunton_graphics", "ssa.ma.taunton.graphics.spectrum", sb.toString());
        }
    }
}