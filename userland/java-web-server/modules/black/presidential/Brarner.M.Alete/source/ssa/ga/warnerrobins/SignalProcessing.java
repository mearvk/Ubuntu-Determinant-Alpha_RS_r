package presidential.Brarner.M.Alete.source.ssa.ga.warnerrobins;
...
/**
 * Signal Processing for SSA Office: WARNER ROBINS GA
 * <p>Office Code: C92</p>
 * <p>Address: 220 CARL VINSON PKWY, WARNER ROBINS, GA 31088</p>
 * <p>Phone: (866) 931-7084 | Fax: (833) 597-0064</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/warnerrobins/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9393; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/warnerrobins";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/warnerrobins_audio", "ssa.ga.warnerrobins.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/warnerrobins_data", "ssa.ga.warnerrobins.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/warnerrobins_graphics", "ssa.ga.warnerrobins.graphics.spectrum", sb.toString());
        }
    }
}