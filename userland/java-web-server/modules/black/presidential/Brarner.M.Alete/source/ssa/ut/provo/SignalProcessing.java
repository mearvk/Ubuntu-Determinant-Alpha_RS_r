...
/**
 * Signal Processing for SSA Office: PROVO UT
 * <p>Office Code: 902</p>
 * <p>Address: 88 WEST 100 NORTH, PROVO, UT 84601</p>
 * <p>Phone: (866) 366-9549 | Fax: (833) 912-2338</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ut/provo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10286; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ut/provo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ut/provo_audio", "ssa.ut.provo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ut/provo_data", "ssa.ut.provo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ut/provo_graphics", "ssa.ut.provo.graphics.spectrum", sb.toString());
        }
    }
}