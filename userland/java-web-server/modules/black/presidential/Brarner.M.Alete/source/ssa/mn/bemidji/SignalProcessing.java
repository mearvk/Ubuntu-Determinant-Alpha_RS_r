...
/**
 * Signal Processing for SSA Office: BEMIDJI MN
 * <p>Office Code: 682</p>
 * <p>Address: 2900 HANNAH AVE NW, BEMIDJI, MN 56601</p>
 * <p>Phone: (866) 258-6345 | Fax: (833) 902-2702</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/bemidji/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10097; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/bemidji";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/bemidji_audio", "ssa.mn.bemidji.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/bemidji_data", "ssa.mn.bemidji.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/bemidji_graphics", "ssa.mn.bemidji.graphics.spectrum", sb.toString());
        }
    }
}