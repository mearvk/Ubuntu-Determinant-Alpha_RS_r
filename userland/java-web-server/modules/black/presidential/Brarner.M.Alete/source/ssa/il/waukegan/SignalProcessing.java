package presidential.Brarner.M.Alete.source.ssa.il.waukegan;
...
/**
 * Signal Processing for SSA Office: WAUKEGAN IL
 * <p>Office Code: 491</p>
 * <p>Address: 1930 N  LEWIS AVE, WAUKEGAN, IL 60087</p>
 * <p>Phone: (888) 320-0960 | Fax: (833) 950-2510</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/waukegan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9926; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/waukegan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/waukegan_audio", "ssa.il.waukegan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/waukegan_data", "ssa.il.waukegan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/waukegan_graphics", "ssa.il.waukegan.graphics.spectrum", sb.toString());
        }
    }
}