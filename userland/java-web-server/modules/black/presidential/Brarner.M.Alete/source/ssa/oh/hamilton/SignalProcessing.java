package presidential.Brarner.M.Alete.source.ssa.oh.hamilton;
...
/**
 * Signal Processing for SSA Office: HAMILTON OH
 * <p>Office Code: 399</p>
 * <p>Address: 6553 WINFORD AVENUE, HAMILTON, OH 45011</p>
 * <p>Phone: (888) 862-3585 | Fax: (833) 950-3415</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/hamilton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9840; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/hamilton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/hamilton_audio", "ssa.oh.hamilton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/hamilton_data", "ssa.oh.hamilton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/hamilton_graphics", "ssa.oh.hamilton.graphics.spectrum", sb.toString());
        }
    }
}