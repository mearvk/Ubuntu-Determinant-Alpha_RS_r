package presidential.Brarner.M.Alete.source.ssa.vt.rutland;
...
/**
 * Signal Processing for SSA Office: RUTLAND VT
 * <p>Office Code: 23</p>
 * <p>Address: 246 WEST ST, RUTLAND, VT 5701</p>
 * <p>Phone: (866) 690-1944 | Fax: (833) 515-0453</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/vt/rutland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9507; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/vt/rutland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_vt/rutland_audio", "ssa.vt.rutland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_vt/rutland_data", "ssa.vt.rutland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_vt/rutland_graphics", "ssa.vt.rutland.graphics.spectrum", sb.toString());
        }
    }
}