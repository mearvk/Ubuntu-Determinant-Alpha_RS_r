package presidential.Brarner.M.Alete.source.ssa.wy.sheridan;
...
/**
 * Signal Processing for SSA Office: SHERIDAN WY
 * <p>Office Code: D31</p>
 * <p>Address: 2268 N MAIN ST, SHERIDAN, WY 82801</p>
 * <p>Phone: (866) 530-7798 | Fax: (833) 950-3197</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wy/sheridan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9419; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wy/sheridan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wy/sheridan_audio", "ssa.wy.sheridan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wy/sheridan_data", "ssa.wy.sheridan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wy/sheridan_graphics", "ssa.wy.sheridan.graphics.spectrum", sb.toString());
        }
    }
}