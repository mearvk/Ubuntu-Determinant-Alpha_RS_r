package presidential.Brarner.M.Alete.source.ssa.pa.mckeesport;
...
/**
 * Signal Processing for SSA Office: MCKEESPORT PA
 * <p>Office Code: 221</p>
 * <p>Address: 540 5TH AVE, MCKEESPORT, PA 15132</p>
 * <p>Phone: (866) 964-2037 | Fax: (833) 950-3525</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/mckeesport/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9679; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/mckeesport";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/mckeesport_audio", "ssa.pa.mckeesport.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/mckeesport_data", "ssa.pa.mckeesport.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/mckeesport_graphics", "ssa.pa.mckeesport.graphics.spectrum", sb.toString());
        }
    }
}