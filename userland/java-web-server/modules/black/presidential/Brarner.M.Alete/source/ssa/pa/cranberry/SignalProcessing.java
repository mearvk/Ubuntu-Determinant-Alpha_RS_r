package presidential.Brarner.M.Alete.source.ssa.pa.cranberry;
...
/**
 * Signal Processing for SSA Office: CRANBERRY PA
 * <p>Office Code: 211</p>
 * <p>Address: 80 REGINA DR, CRANBERRY, PA 16319</p>
 * <p>Phone: (888) 848-6464 | Fax: (833) 950-3189</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/cranberry/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9669; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/cranberry";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/cranberry_audio", "ssa.pa.cranberry.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/cranberry_data", "ssa.pa.cranberry.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/cranberry_graphics", "ssa.pa.cranberry.graphics.spectrum", sb.toString());
        }
    }
}