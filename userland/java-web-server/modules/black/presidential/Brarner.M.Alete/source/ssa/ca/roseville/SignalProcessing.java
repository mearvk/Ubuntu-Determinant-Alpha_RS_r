package presidential.Brarner.M.Alete.source.ssa.ca.roseville;
...
/**
 * Signal Processing for SSA Office: ROSEVILLE CA
 * <p>Office Code: E77</p>
 * <p>Address: 910 CIRBY WAY, ROSEVILLE, CA 95661</p>
 * <p>Phone: (866) 348-7830 | Fax: (833) 940-2005</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/roseville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9477; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/roseville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/roseville_audio", "ssa.ca.roseville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/roseville_data", "ssa.ca.roseville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/roseville_graphics", "ssa.ca.roseville.graphics.spectrum", sb.toString());
        }
    }
}