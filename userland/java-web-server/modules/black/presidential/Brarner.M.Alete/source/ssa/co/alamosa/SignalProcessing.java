package presidential.Brarner.M.Alete.source.ssa.co.alamosa;
...
/**
 * Signal Processing for SSA Office: ALAMOSA CO
 * <p>Office Code: 888</p>
 * <p>Address: 602 DEL SOL DRIVE 1-A, ALAMOSA, CO 81101</p>
 * <p>Phone: (888) 475-0297 | Fax: (833) 641-2555</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/co/alamosa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10273; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/co/alamosa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_co/alamosa_audio", "ssa.co.alamosa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_co/alamosa_data", "ssa.co.alamosa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_co/alamosa_graphics", "ssa.co.alamosa.graphics.spectrum", sb.toString());
        }
    }
}