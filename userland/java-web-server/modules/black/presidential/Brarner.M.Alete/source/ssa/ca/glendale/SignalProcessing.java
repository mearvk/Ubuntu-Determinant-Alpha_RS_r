package presidential.Brarner.M.Alete.source.ssa.ca.glendale;
...
/**
 * Signal Processing for SSA Office: GLENDALE CA
 * <p>Office Code: 965</p>
 * <p>Address: 225 W BROADWAY, GLENDALE, CA 91204</p>
 * <p>Phone: (855) 886-9633 | Fax: (833) 940-2151</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/glendale/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10347; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/glendale";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/glendale_audio", "ssa.ca.glendale.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/glendale_data", "ssa.ca.glendale.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/glendale_graphics", "ssa.ca.glendale.graphics.spectrum", sb.toString());
        }
    }
}