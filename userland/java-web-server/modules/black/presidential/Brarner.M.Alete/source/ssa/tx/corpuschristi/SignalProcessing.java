...
/**
 * Signal Processing for SSA Office: CORPUS CHRISTI TX
 * <p>Office Code: 825</p>
 * <p>Address: 3801 S PORT AVE, CORPUS CHRISTI, TX 78415</p>
 * <p>Phone: (866) 613-2859 | Fax: (833) 902-2578</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/corpuschristi/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10216; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/corpuschristi";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/corpuschristi_audio", "ssa.tx.corpuschristi.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/corpuschristi_data", "ssa.tx.corpuschristi.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/corpuschristi_graphics", "ssa.tx.corpuschristi.graphics.spectrum", sb.toString());
        }
    }
}