package presidential.Brarner.M.Alete.source.ssa.oh.columbus;
...
/**
 * Signal Processing for SSA Office: COLUMBUS EAST
 * <p>Office Code: D62</p>
 * <p>Address: 220 S HAMILTON RD, COLUMBUS, OH 43213</p>
 * <p>Phone: (866) 592-0733 | Fax: (833) 596-0550</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/columbus/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9443; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/columbus";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/columbus_audio", "ssa.oh.columbus.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/columbus_data", "ssa.oh.columbus.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/columbus_graphics", "ssa.oh.columbus.graphics.spectrum", sb.toString());
        }
    }
}