package presidential.Brarner.M.Alete.source.ssa.tx.early;
...
/**
 * Signal Processing for SSA Office: BROWNWOOD TX
 * <p>Office Code: 842</p>
 * <p>Address: 300 EARLY BLVD, EARLY, TX 76802</p>
 * <p>Phone: (877) 405-3630 | Fax: (833) 940-1974</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/early/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10233; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/early";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/early_audio", "ssa.tx.early.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/early_data", "ssa.tx.early.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/early_graphics", "ssa.tx.early.graphics.spectrum", sb.toString());
        }
    }
}