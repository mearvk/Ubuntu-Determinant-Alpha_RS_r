...
/**
 * Signal Processing for SSA Office: BURBANK CA
 * <p>Office Code: A80</p>
 * <p>Address: 1420 W OLIVE AVE, BURBANK, CA 91506</p>
 * <p>Phone: (888) 748-7699 | Fax: (833) 950-3369</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/burbank/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9260; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/burbank";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/burbank_audio", "ssa.ca.burbank.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/burbank_data", "ssa.ca.burbank.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/burbank_graphics", "ssa.ca.burbank.graphics.spectrum", sb.toString());
        }
    }
}