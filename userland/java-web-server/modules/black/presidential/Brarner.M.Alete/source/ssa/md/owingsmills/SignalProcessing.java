package presidential.Brarner.M.Alete.source.ssa.md.owingsmills;
...
/**
 * Signal Processing for SSA Office: OWINGS MILLS MD
 * <p>Office Code: 197</p>
 * <p>Address: 5 PARK CENTER COURT, OWINGS MILLS, MD 21117</p>
 * <p>Phone: (866) 681-1412 | Fax: (833) 597-0136</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/owingsmills/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9655; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/owingsmills";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/owingsmills_audio", "ssa.md.owingsmills.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/owingsmills_data", "ssa.md.owingsmills.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/owingsmills_graphics", "ssa.md.owingsmills.graphics.spectrum", sb.toString());
        }
    }
}