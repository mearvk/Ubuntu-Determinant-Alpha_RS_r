...
/**
 * Signal Processing for SSA Office: MINOT ND
 * <p>Office Code: 706</p>
 * <p>Address: 1414 20TH AVE SW, MINOT, ND 58701</p>
 * <p>Phone: (866) 415-3193 | Fax: (833) 950-3541</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nd/minot/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10119; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nd/minot";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nd/minot_audio", "ssa.nd.minot.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nd/minot_data", "ssa.nd.minot.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nd/minot_graphics", "ssa.nd.minot.graphics.spectrum", sb.toString());
        }
    }
}