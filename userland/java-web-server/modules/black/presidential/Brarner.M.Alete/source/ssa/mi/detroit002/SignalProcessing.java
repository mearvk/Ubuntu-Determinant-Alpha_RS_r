package presidential.Brarner.M.Alete.source.ssa.mi.detroit002;
...
/**
 * Signal Processing for SSA Office: DETROIT-D/T MI
 * <p>Office Code: 345</p>
 * <p>Address: 477 MICHIGAN AVE, DETROIT, MI 48226</p>
 * <p>Phone: (888) 748-7691 | Fax: (833) 902-2656</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/detroit002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9792; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/detroit002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/detroit002_audio", "ssa.mi.detroit002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/detroit002_data", "ssa.mi.detroit002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/detroit002_graphics", "ssa.mi.detroit002.graphics.spectrum", sb.toString());
        }
    }
}