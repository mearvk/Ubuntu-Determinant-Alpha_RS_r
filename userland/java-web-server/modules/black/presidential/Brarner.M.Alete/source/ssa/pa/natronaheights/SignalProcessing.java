package presidential.Brarner.M.Alete.source.ssa.pa.natronaheights;
...
/**
 * Signal Processing for SSA Office: Natrona Heights
 * <p>Office Code: 225</p>
 * <p>Address: 1721 UNION AVE, NATRONA HEIGHTS, PA 15065</p>
 * <p>Phone: (888) 377-4710 | Fax: (833) 950-3531</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/natronaheights/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9682; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/natronaheights";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/natronaheights_audio", "ssa.pa.natronaheights.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/natronaheights_data", "ssa.pa.natronaheights.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/natronaheights_graphics", "ssa.pa.natronaheights.graphics.spectrum", sb.toString());
        }
    }
}