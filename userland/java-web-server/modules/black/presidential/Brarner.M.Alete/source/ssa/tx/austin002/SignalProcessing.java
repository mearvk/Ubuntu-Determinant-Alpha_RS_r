package presidential.Brarner.M.Alete.source.ssa.tx.austin002;
...
/**
 * Signal Processing for SSA Office: AUSTIN TX
 * <p>Office Code: 813</p>
 * <p>Address: 1029 CAMINO LA COSTA, AUSTIN, TX 78752</p>
 * <p>Phone: (866) 627-6991 | Fax: (833) 515-0511</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/austin002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10204; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/austin002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/austin002_audio", "ssa.tx.austin002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/austin002_data", "ssa.tx.austin002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/austin002_graphics", "ssa.tx.austin002.graphics.spectrum", sb.toString());
        }
    }
}