package presidential.Brarner.M.Alete.source.ssa.nj.paterson;
...
/**
 * Signal Processing for SSA Office: PATERSON NJ
 * <p>Office Code: 173</p>
 * <p>Address: 200 FEDERAL PLZ, PATERSON, NJ 7505</p>
 * <p>Phone: (888) 397-9806 | Fax: (833) 950-2976</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/paterson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9634; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/paterson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/paterson_audio", "ssa.nj.paterson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/paterson_data", "ssa.nj.paterson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/paterson_graphics", "ssa.nj.paterson.graphics.spectrum", sb.toString());
        }
    }
}