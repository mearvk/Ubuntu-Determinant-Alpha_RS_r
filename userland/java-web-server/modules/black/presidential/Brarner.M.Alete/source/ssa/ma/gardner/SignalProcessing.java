...
/**
 * Signal Processing for SSA Office: GARDNER MA
 * <p>Office Code: C69</p>
 * <p>Address: 354 MAIN ST STE 2, GARDNER, MA 1440</p>
 * <p>Phone: (844) 371-8116 | Fax: (833) 436-4143</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/gardner/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9379; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/gardner";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/gardner_audio", "ssa.ma.gardner.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/gardner_data", "ssa.ma.gardner.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/gardner_graphics", "ssa.ma.gardner.graphics.spectrum", sb.toString());
        }
    }
}