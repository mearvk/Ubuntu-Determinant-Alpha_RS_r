...
/**
 * Signal Processing for SSA Office: LYNCHBURG VA
 * <p>Office Code: 289</p>
 * <p>Address: 7618 TIMBERLAKE RD, LYNCHBURG, VA 24502</p>
 * <p>Phone: (866) 964-6142 | Fax: (833) 950-2284</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/lynchburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9739; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/lynchburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/lynchburg_audio", "ssa.va.lynchburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/lynchburg_data", "ssa.va.lynchburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/lynchburg_graphics", "ssa.va.lynchburg.graphics.spectrum", sb.toString());
        }
    }
}