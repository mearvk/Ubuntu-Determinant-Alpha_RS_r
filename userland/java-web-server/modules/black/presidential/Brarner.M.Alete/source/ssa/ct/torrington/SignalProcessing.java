package presidential.Brarner.M.Alete.source.ssa.ct.torrington;
...
/**
 * Signal Processing for SSA Office: TORRINGTON CT
 * <p>Office Code: 89</p>
 * <p>Address: 147 LITCHFIELD STREET, TORRINGTON, CT 6790</p>
 * <p>Phone: (877) 405-0486 | Fax: (833) 950-2662</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ct/torrington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9561; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ct/torrington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ct/torrington_audio", "ssa.ct.torrington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ct/torrington_data", "ssa.ct.torrington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ct/torrington_graphics", "ssa.ct.torrington.graphics.spectrum", sb.toString());
        }
    }
}