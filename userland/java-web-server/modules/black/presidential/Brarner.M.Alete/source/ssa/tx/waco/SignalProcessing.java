package presidential.Brarner.M.Alete.source.ssa.tx.waco;
...
/**
 * Signal Processing for SSA Office: WACO TX
 * <p>Office Code: 826</p>
 * <p>Address: 1700 LAKE AIR DR, WACO, TX 76710</p>
 * <p>Phone: (866) 964-6304 | Fax: (833) 902-2580</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/waco/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10217; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/waco";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/waco_audio", "ssa.tx.waco.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/waco_data", "ssa.tx.waco.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/waco_graphics", "ssa.tx.waco.graphics.spectrum", sb.toString());
        }
    }
}