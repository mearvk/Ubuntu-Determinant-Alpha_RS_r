package presidential.Brarner.M.Alete.source.ssa.sc.clinton;
...
/**
 * Signal Processing for SSA Office: CLINTON SC
 * <p>Office Code: C16</p>
 * <p>Address: 292 PROFESSIONAL PARK RD, CLINTON, SC 29325</p>
 * <p>Phone: (866) 526-9854 | Fax: (833) 950-3463</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/clinton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9350; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/clinton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/clinton_audio", "ssa.sc.clinton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/clinton_data", "ssa.sc.clinton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/clinton_graphics", "ssa.sc.clinton.graphics.spectrum", sb.toString());
        }
    }
}