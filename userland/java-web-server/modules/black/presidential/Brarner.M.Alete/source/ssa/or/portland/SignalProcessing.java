package presidential.Brarner.M.Alete.source.ssa.or.portland;
...
/**
 * Signal Processing for SSA Office: PORTLAND METRO OR
 * <p>Office Code: 932</p>
 * <p>Address: 1538 SW YAMHILL ST, PORTLAND, OR 97205</p>
 * <p>Phone: (888) 632-6990 | Fax: (833) 950-2630</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/or/portland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10315; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/or/portland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_or/portland_audio", "ssa.or.portland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_or/portland_data", "ssa.or.portland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_or/portland_graphics", "ssa.or.portland.graphics.spectrum", sb.toString());
        }
    }
}