package presidential.Brarner.M.Alete.source.ssa.wi.milwaukee;
...
/**
 * Signal Processing for SSA Office: MILW-WEST WI
 * <p>Office Code: D08</p>
 * <p>Address: 5020 W NORTH AVE, MILWAUKEE, WI 53208</p>
 * <p>Phone: (866) 716-8594 | Fax: (833) 580-0157</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/milwaukee/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9405; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/milwaukee";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/milwaukee_audio", "ssa.wi.milwaukee.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/milwaukee_data", "ssa.wi.milwaukee.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/milwaukee_graphics", "ssa.wi.milwaukee.graphics.spectrum", sb.toString());
        }
    }
}