...
/**
 * Signal Processing for SSA Office: WASHINGTON NC
 * <p>Office Code: B17</p>
 * <p>Address: 1633 JOHN SMALL AVE, WASHINGTON, NC 27889</p>
 * <p>Phone: (866) 574-2589 | Fax: (833) 950-3131</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/washington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9288; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/washington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/washington_audio", "ssa.nc.washington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/washington_data", "ssa.nc.washington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/washington_graphics", "ssa.nc.washington.graphics.spectrum", sb.toString());
        }
    }
}