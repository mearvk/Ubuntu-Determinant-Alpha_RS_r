...
/**
 * Signal Processing for SSA Office: SHAWNEE OK
 * <p>Office Code: 796</p>
 * <p>Address: 909 E FEDERAL ST, SHAWNEE, OK 74804</p>
 * <p>Phone: (877) 897-0604 | Fax: (833) 950-3343</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/shawnee/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10189; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/shawnee";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/shawnee_audio", "ssa.ok.shawnee.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/shawnee_data", "ssa.ok.shawnee.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/shawnee_graphics", "ssa.ok.shawnee.graphics.spectrum", sb.toString());
        }
    }
}