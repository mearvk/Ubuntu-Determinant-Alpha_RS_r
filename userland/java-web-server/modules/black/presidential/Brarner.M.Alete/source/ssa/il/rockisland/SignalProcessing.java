package presidential.Brarner.M.Alete.source.ssa.il.rockisland;
...
/**
 * Signal Processing for SSA Office: ROCK ISLAND IL
 * <p>Office Code: 489</p>
 * <p>Address: 2350 4TH AVE, ROCK ISLAND, IL 61201</p>
 * <p>Phone: (866) 414-9166 | Fax: (833) 950-2506</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/rockisland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9924; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/rockisland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/rockisland_audio", "ssa.il.rockisland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/rockisland_data", "ssa.il.rockisland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/rockisland_graphics", "ssa.il.rockisland.graphics.spectrum", sb.toString());
        }
    }
}