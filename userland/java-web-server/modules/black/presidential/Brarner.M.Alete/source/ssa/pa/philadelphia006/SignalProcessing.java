package presidential.Brarner.M.Alete.source.ssa.pa.philadelphia006;
...
/**
 * Signal Processing for SSA Office: PHILA UNIVERSITY CITY
 * <p>Office Code: 230</p>
 * <p>Address: 4240 MARKET STREET, PHILADELPHIA, PA 19104</p>
 * <p>Phone: (877) 445-9977 | Fax: (833) 515-0393</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/philadelphia006/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9687; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/philadelphia006";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia006_audio", "ssa.pa.philadelphia006.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia006_data", "ssa.pa.philadelphia006.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia006_graphics", "ssa.pa.philadelphia006.graphics.spectrum", sb.toString());
        }
    }
}