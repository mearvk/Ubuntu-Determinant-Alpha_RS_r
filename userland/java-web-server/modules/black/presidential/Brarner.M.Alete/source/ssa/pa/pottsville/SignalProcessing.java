package presidential.Brarner.M.Alete.source.ssa.pa.pottsville;
...
/**
 * Signal Processing for SSA Office: POTTSVILLE PA
 * <p>Office Code: 220</p>
 * <p>Address: 2221 W MARKET STREET, POTTSVILLE, PA 17901</p>
 * <p>Phone: (866) 269-0880 | Fax: (833) 950-3523</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/pottsville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9678; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/pottsville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/pottsville_audio", "ssa.pa.pottsville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/pottsville_data", "ssa.pa.pottsville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/pottsville_graphics", "ssa.pa.pottsville.graphics.spectrum", sb.toString());
        }
    }
}