...
/**
 * Signal Processing for SSA Office: PHOENIX DOWNTOWN AZ
 * <p>Office Code: 913</p>
 * <p>Address: 250 N 7TH AVE, PHOENIX, AZ 85007</p>
 * <p>Phone: (866) 964-4852 | Fax: (833) 950-3683</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/az/phoenix002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10296; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/az/phoenix002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_az/phoenix002_audio", "ssa.az.phoenix002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_az/phoenix002_data", "ssa.az.phoenix002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_az/phoenix002_graphics", "ssa.az.phoenix002.graphics.spectrum", sb.toString());
        }
    }
}