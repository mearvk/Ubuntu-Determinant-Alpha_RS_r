package presidential.Brarner.M.Alete.source.ssa.pa.easton;
...
/**
 * Signal Processing for SSA Office: EASTON PA
 * <p>Office Code: 229</p>
 * <p>Address: 134 S FOURTH ST, EASTON, PA 18042</p>
 * <p>Phone: (866) 964-5056 | Fax: (833) 515-0391</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/easton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9686; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/easton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/easton_audio", "ssa.pa.easton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/easton_data", "ssa.pa.easton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/easton_graphics", "ssa.pa.easton.graphics.spectrum", sb.toString());
        }
    }
}