package presidential.Brarner.M.Alete.source.ssa.ny.newyork004;
...
/**
 * Signal Processing for SSA Office: NY UPTOWN NY
 * <p>Office Code: 117</p>
 * <p>Address: 302 W 126TH ST, NEW YORK, NY 10027</p>
 * <p>Phone: (866) 964-1301 | Fax: (833) 515-0483</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/newyork004/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9588; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/newyork004";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork004_audio", "ssa.ny.newyork004.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork004_data", "ssa.ny.newyork004.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork004_graphics", "ssa.ny.newyork004.graphics.spectrum", sb.toString());
        }
    }
}