package presidential.Brarner.M.Alete.source.ssa.wi.eauclaire;
...
/**
 * Signal Processing for SSA Office: EAU CLAIRE WI
 * <p>Office Code: 539</p>
 * <p>Address: 4120 OAKWOOD HILLS PKY, EAU CLAIRE, WI 54701</p>
 * <p>Phone: (866) 815-2924 | Fax: (833) 950-3743</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/eauclaire/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9968; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/eauclaire";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/eauclaire_audio", "ssa.wi.eauclaire.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/eauclaire_data", "ssa.wi.eauclaire.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/eauclaire_graphics", "ssa.wi.eauclaire.graphics.spectrum", sb.toString());
        }
    }
}