package presidential.Brarner.M.Alete.source.ssa.nc.greenville;
...
/**
 * Signal Processing for SSA Office: GREENVILLE NC
 * <p>Office Code: 335</p>
 * <p>Address: 2805 S CHARLES BLVD, GREENVILLE, NC 27858</p>
 * <p>Phone: (866) 494-4001 | Fax: (833) 950-2844</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/greenville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9783; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/greenville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/greenville_audio", "ssa.nc.greenville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/greenville_data", "ssa.nc.greenville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/greenville_graphics", "ssa.nc.greenville.graphics.spectrum", sb.toString());
        }
    }
}