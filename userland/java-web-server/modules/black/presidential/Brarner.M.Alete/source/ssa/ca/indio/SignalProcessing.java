package presidential.Brarner.M.Alete.source.ssa.ca.indio;
...
/**
 * Signal Processing for SSA Office: INDIO CA
 * <p>Office Code: E39</p>
 * <p>Address: 46845 MONROE STREET, INDIO, CA 92201</p>
 * <p>Phone: (877) 319-5758 | Fax: (833) 940-1989</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/indio/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9467; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/indio";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/indio_audio", "ssa.ca.indio.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/indio_data", "ssa.ca.indio.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/indio_graphics", "ssa.ca.indio.graphics.spectrum", sb.toString());
        }
    }
}