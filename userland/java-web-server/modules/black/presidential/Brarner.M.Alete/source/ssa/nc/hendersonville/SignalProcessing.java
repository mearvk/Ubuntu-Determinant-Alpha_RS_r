package presidential.Brarner.M.Alete.source.ssa.nc.hendersonville;
...
/**
 * Signal Processing for SSA Office: HENDERSONVILLE NC
 * <p>Office Code: 483</p>
 * <p>Address: 205 S GROVE STREET, HENDERSONVILLE, NC 28792</p>
 * <p>Phone: (866) 964-5053 | Fax: (833) 950-3785</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/hendersonville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9918; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/hendersonville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/hendersonville_audio", "ssa.nc.hendersonville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/hendersonville_data", "ssa.nc.hendersonville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/hendersonville_graphics", "ssa.nc.hendersonville.graphics.spectrum", sb.toString());
        }
    }
}