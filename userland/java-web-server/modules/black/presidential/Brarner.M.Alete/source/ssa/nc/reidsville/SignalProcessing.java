package presidential.Brarner.M.Alete.source.ssa.nc.reidsville;
...
/**
 * Signal Processing for SSA Office: REIDSVILLE NC
 * <p>Office Code: B11</p>
 * <p>Address: 2402 FREEWAY DR, REIDSVILLE, NC 27320</p>
 * <p>Phone: (866) 748-2091 | Fax: (833) 950-3121</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/reidsville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9283; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/reidsville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/reidsville_audio", "ssa.nc.reidsville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/reidsville_data", "ssa.nc.reidsville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/reidsville_graphics", "ssa.nc.reidsville.graphics.spectrum", sb.toString());
        }
    }
}