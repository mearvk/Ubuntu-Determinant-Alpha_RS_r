package presidential.Brarner.M.Alete.source.ssa.wa.mtvernon;
...
/**
 * Signal Processing for SSA Office: MT VERNON WA
 * <p>Office Code: D50</p>
 * <p>Address: 710 E COLLEGE WAY, MT VERNON, WA 98273</p>
 * <p>Phone: (866) 931-7108 | Fax: (833) 950-3238</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/mtvernon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9432; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/mtvernon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/mtvernon_audio", "ssa.wa.mtvernon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/mtvernon_data", "ssa.wa.mtvernon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/mtvernon_graphics", "ssa.wa.mtvernon.graphics.spectrum", sb.toString());
        }
    }
}