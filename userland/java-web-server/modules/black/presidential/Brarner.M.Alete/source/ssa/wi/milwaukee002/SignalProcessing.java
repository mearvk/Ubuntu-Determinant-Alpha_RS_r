package presidential.Brarner.M.Alete.source.ssa.wi.milwaukee002;
...
/**
 * Signal Processing for SSA Office: MILW NORTH WI
 * <p>Office Code: 535</p>
 * <p>Address: 9120 W CAPITOL DR, MILWAUKEE, WI 53222</p>
 * <p>Phone: (888) 823-4323 | Fax: (833) 950-3735</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/milwaukee002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9964; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/milwaukee002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/milwaukee002_audio", "ssa.wi.milwaukee002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/milwaukee002_data", "ssa.wi.milwaukee002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/milwaukee002_graphics", "ssa.wi.milwaukee002.graphics.spectrum", sb.toString());
        }
    }
}