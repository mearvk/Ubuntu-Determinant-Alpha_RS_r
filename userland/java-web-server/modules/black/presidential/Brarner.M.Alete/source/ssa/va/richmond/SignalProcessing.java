package presidential.Brarner.M.Alete.source.ssa.va.richmond;
...
/**
 * Signal Processing for SSA Office: RICHMOND DTN VA
 * <p>Office Code: 285</p>
 * <p>Address: 1834 W CARY STREET, RICHMOND, VA 23220</p>
 * <p>Phone: (866) 679-6684 | Fax: (833) 912-2326</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/richmond/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9735; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/richmond";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/richmond_audio", "ssa.va.richmond.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/richmond_data", "ssa.va.richmond.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/richmond_graphics", "ssa.va.richmond.graphics.spectrum", sb.toString());
        }
    }
}