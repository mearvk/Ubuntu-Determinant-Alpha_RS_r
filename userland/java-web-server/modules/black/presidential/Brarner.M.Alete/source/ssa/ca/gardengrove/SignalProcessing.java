package presidential.Brarner.M.Alete.source.ssa.ca.gardengrove;
...
/**
 * Signal Processing for SSA Office: GARDEN GROVE CA
 * <p>Office Code: D36</p>
 * <p>Address: 11900 GILBERT STREET, GARDEN GROVE, CA 92841</p>
 * <p>Phone: (877) 669-3115 | Fax: (833) 571-0642</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/gardengrove/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9423; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/gardengrove";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/gardengrove_audio", "ssa.ca.gardengrove.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/gardengrove_data", "ssa.ca.gardengrove.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/gardengrove_graphics", "ssa.ca.gardengrove.graphics.spectrum", sb.toString());
        }
    }
}