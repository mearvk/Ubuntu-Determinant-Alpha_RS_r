package presidential.Brarner.M.Alete.source.ssa.oh.cleveland004;
...
/**
 * Signal Processing for SSA Office: CLEVELAND NW OH
 * <p>Office Code: 431</p>
 * <p>Address: 4321 LORAIN AVE STE B, CLEVELAND, OH 44113</p>
 * <p>Phone: (877) 876-3172 | Fax: (833) 596-0591</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/cleveland004/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9869; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/cleveland004";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cleveland004_audio", "ssa.oh.cleveland004.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cleveland004_data", "ssa.oh.cleveland004.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cleveland004_graphics", "ssa.oh.cleveland004.graphics.spectrum", sb.toString());
        }
    }
}