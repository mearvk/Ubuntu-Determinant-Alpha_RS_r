package presidential.Brarner.M.Alete.source.ssa.in.southbend;
...
/**
 * Signal Processing for SSA Office: SOUTH BEND IN
 * <p>Office Code: 456</p>
 * <p>Address: 602 S MICHIGAN ST, SOUTH BEND, IN 46601</p>
 * <p>Phone: (877) 274-5415 | Fax: (833) 902-2668</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/southbend/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9893; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/southbend";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/southbend_audio", "ssa.in.southbend.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/southbend_data", "ssa.in.southbend.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/southbend_graphics", "ssa.in.southbend.graphics.spectrum", sb.toString());
        }
    }
}