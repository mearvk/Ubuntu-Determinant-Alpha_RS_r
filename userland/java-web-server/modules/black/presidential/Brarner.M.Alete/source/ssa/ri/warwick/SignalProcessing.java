package presidential.Brarner.M.Alete.source.ssa.ri.warwick;
...
/**
 * Signal Processing for SSA Office: WARWICK RI
 * <p>Office Code: 75</p>
 * <p>Address: 30 QUAKER LANE, WARWICK, RI 2886</p>
 * <p>Phone: (866) 964-2038 | Fax: (833) 950-2352</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ri/warwick/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9551; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ri/warwick";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ri/warwick_audio", "ssa.ri.warwick.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ri/warwick_data", "ssa.ri.warwick.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ri/warwick_graphics", "ssa.ri.warwick.graphics.spectrum", sb.toString());
        }
    }
}