package presidential.Brarner.M.Alete.source.ssa.fl.deland;
...
/**
 * Signal Processing for SSA Office: DELAND FL
 * <p>Office Code: 259</p>
 * <p>Address: 1629 S ADELLE AVE, DELAND, FL 32720</p>
 * <p>Phone: (866) 964-7396 | Fax: (833) 950-2208</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/deland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9713; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/deland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/deland_audio", "ssa.fl.deland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/deland_data", "ssa.fl.deland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/deland_graphics", "ssa.fl.deland.graphics.spectrum", sb.toString());
        }
    }
}