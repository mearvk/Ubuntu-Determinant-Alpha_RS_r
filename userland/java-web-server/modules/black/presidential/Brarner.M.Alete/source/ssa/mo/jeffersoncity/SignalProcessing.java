package presidential.Brarner.M.Alete.source.ssa.mo.jeffersoncity;
...
/**
 * Signal Processing for SSA Office: JEFFERSON CITY
 * <p>Office Code: 740</p>
 * <p>Address: 129 SCOTT STATION ROAD, JEFFERSON CITY, MO 65109</p>
 * <p>Phone: (877) 405-9803 | Fax: (833) 923-0552</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/jeffersoncity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10142; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/jeffersoncity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/jeffersoncity_audio", "ssa.mo.jeffersoncity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/jeffersoncity_data", "ssa.mo.jeffersoncity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/jeffersoncity_graphics", "ssa.mo.jeffersoncity.graphics.spectrum", sb.toString());
        }
    }
}