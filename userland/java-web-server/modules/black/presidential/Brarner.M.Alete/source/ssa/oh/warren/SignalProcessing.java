...
/**
 * Signal Processing for SSA Office: WARREN OH
 * <p>Office Code: 403</p>
 * <p>Address: 258 E MARKET STREET, WARREN, OH 44481</p>
 * <p>Phone: (866) 964-7339 | Fax: (833) 950-3423</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/warren/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9844; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/warren";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/warren_audio", "ssa.oh.warren.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/warren_data", "ssa.oh.warren.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/warren_graphics", "ssa.oh.warren.graphics.spectrum", sb.toString());
        }
    }
}