package presidential.Brarner.M.Alete.source.ssa.nc.albemarle;
...
/**
 * Signal Processing for SSA Office: ALBEMARLE NC
 * <p>Office Code: 481</p>
 * <p>Address: 202 CHARTER ST, ALBEMARLE, NC 28001</p>
 * <p>Phone: (866) 319-8268 | Fax: (833) 950-3781</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/albemarle/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9916; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/albemarle";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/albemarle_audio", "ssa.nc.albemarle.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/albemarle_data", "ssa.nc.albemarle.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/albemarle_graphics", "ssa.nc.albemarle.graphics.spectrum", sb.toString());
        }
    }
}