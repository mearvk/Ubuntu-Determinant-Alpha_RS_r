...
/**
 * Signal Processing for SSA Office: ANTIOCH CA
 * <p>Office Code: B63</p>
 * <p>Address: 2508 VERNE ROBERTS CIR, ANTIOCH, CA 94509</p>
 * <p>Phone: (866) 331-2324 | Fax: (833) 950-3669</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/antioch/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9323; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/antioch";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/antioch_audio", "ssa.ca.antioch.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/antioch_data", "ssa.ca.antioch.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/antioch_graphics", "ssa.ca.antioch.graphics.spectrum", sb.toString());
        }
    }
}