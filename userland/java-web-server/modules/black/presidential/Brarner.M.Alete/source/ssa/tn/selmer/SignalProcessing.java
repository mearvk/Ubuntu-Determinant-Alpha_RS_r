package presidential.Brarner.M.Alete.source.ssa.tn.selmer;
...
/**
 * Signal Processing for SSA Office: SELMER TN
 * <p>Office Code: D00</p>
 * <p>Address: 661 MULBERRY AVE, SELMER, TN 38375</p>
 * <p>Phone: (888) 397-4814 | Fax: (833) 597-0076</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/selmer/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9399; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/selmer";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/selmer_audio", "ssa.tn.selmer.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/selmer_data", "ssa.tn.selmer.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/selmer_graphics", "ssa.tn.selmer.graphics.spectrum", sb.toString());
        }
    }
}