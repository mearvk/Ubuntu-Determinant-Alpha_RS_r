...
/**
 * Signal Processing for SSA Office: YANKTON SD
 * <p>Office Code: D33</p>
 * <p>Address: 1818 BROADWAY AVE, YANKTON, SD 57078</p>
 * <p>Phone: (877) 405-3522 | Fax: (833) 950-3201</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sd/yankton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9420; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sd/yankton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sd/yankton_audio", "ssa.sd.yankton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sd/yankton_data", "ssa.sd.yankton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sd/yankton_graphics", "ssa.sd.yankton.graphics.spectrum", sb.toString());
        }
    }
}