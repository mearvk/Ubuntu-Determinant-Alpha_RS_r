package presidential.Brarner.M.Alete.source.ssa.mo.fenton;
...
/**
 * Signal Processing for SSA Office: ST LOUIS SOUTHWEST
 * <p>Office Code: C51</p>
 * <p>Address: 650 GRAVOIS BLUFF BLVD, FENTON, MO 63026</p>
 * <p>Phone: (866) 331-2307 | Fax: (833) 950-2938</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/fenton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9368; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/fenton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/fenton_audio", "ssa.mo.fenton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/fenton_data", "ssa.mo.fenton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/fenton_graphics", "ssa.mo.fenton.graphics.spectrum", sb.toString());
        }
    }
}