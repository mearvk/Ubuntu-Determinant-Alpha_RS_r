package presidential.Brarner.M.Alete.source.ssa.mn.winona;
...
/**
 * Signal Processing for SSA Office: WINONA MN
 * <p>Office Code: 680</p>
 * <p>Address: 910 E 2ND ST, WINONA, MN 55987</p>
 * <p>Phone: (877) 600-2853 | Fax: (833) 902-2698</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/winona/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10095; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/winona";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/winona_audio", "ssa.mn.winona.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/winona_data", "ssa.mn.winona.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/winona_graphics", "ssa.mn.winona.graphics.spectrum", sb.toString());
        }
    }
}