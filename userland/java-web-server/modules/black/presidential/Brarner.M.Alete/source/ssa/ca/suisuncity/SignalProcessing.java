package presidential.Brarner.M.Alete.source.ssa.ca.suisuncity;
...
/**
 * Signal Processing for SSA Office: SUISUN CITY CA
 * <p>Office Code: D47</p>
 * <p>Address: 700 MAIN STREET, SUISUN CITY, CA 94585</p>
 * <p>Phone: (866) 964-5021 | Fax: (833) 902-2604</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/suisuncity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9429; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/suisuncity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/suisuncity_audio", "ssa.ca.suisuncity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/suisuncity_data", "ssa.ca.suisuncity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/suisuncity_graphics", "ssa.ca.suisuncity.graphics.spectrum", sb.toString());
        }
    }
}