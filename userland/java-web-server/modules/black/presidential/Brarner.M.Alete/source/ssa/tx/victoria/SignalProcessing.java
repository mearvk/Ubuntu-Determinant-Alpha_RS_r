package presidential.Brarner.M.Alete.source.ssa.tx.victoria;
...
/**
 * Signal Processing for SSA Office: VICTORIA TX
 * <p>Office Code: 839</p>
 * <p>Address: 8208 NE ZAC LENTZ PKWY, VICTORIA, TX 77904</p>
 * <p>Phone: (877) 229-3536 | Fax: (833) 940-1968</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/victoria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10230; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/victoria";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/victoria_audio", "ssa.tx.victoria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/victoria_data", "ssa.tx.victoria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/victoria_graphics", "ssa.tx.victoria.graphics.spectrum", sb.toString());
        }
    }
}