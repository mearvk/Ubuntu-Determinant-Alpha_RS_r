...
/**
 * Signal Processing for SSA Office: SALISBURY MD
 * <p>Office Code: 274</p>
 * <p>Address: 2414 NORTHGATE DR, SALISBURY, MD 21801</p>
 * <p>Phone: (866) 273-5083 | Fax: (833) 597-0145</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/salisbury/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9724; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/salisbury";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/salisbury_audio", "ssa.md.salisbury.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/salisbury_data", "ssa.md.salisbury.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/salisbury_graphics", "ssa.md.salisbury.graphics.spectrum", sb.toString());
        }
    }
}