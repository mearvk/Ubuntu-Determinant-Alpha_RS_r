package presidential.Brarner.M.Alete.source.ssa.wa.yakima;
...
/**
 * Signal Processing for SSA Office: YAKIMA WA
 * <p>Office Code: 919</p>
 * <p>Address: 801 FRUITVALE BLVD, YAKIMA, WA 98902</p>
 * <p>Phone: (866) 338-8552 | Fax: (833) 950-2320</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/yakima/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10302; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/yakima";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/yakima_audio", "ssa.wa.yakima.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/yakima_data", "ssa.wa.yakima.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/yakima_graphics", "ssa.wa.yakima.graphics.spectrum", sb.toString());
        }
    }
}