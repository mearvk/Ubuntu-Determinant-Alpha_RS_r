package presidential.Brarner.M.Alete.source.ssa.fl.staugustine;
...
/**
 * Signal Processing for SSA Office: ST AUGUSTINE FL
 * <p>Office Code: 870</p>
 * <p>Address: 2428 OLD MOULTRIE ROAD, ST AUGUSTINE, FL 32086</p>
 * <p>Phone: (877) 405-5867 | Fax: (833) 921-1883</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/staugustine/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10257; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/staugustine";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/staugustine_audio", "ssa.fl.staugustine.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/staugustine_data", "ssa.fl.staugustine.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/staugustine_graphics", "ssa.fl.staugustine.graphics.spectrum", sb.toString());
        }
    }
}