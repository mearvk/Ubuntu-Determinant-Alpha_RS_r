package presidential.Brarner.M.Alete.source.ssa.al.mobile;
...
/**
 * Signal Processing for SSA Office: MOBILE AL
 * <p>Office Code: 624</p>
 * <p>Address: 550 GOVERNMENT ST, MOBILE, AL 36602</p>
 * <p>Phone: (866) 593-1922 | Fax: (833) 950-3171</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/mobile/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10047; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/mobile";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/mobile_audio", "ssa.al.mobile.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/mobile_data", "ssa.al.mobile.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/mobile_graphics", "ssa.al.mobile.graphics.spectrum", sb.toString());
        }
    }
}