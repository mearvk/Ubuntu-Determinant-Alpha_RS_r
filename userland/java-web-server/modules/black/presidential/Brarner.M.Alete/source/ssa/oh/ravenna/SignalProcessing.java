package presidential.Brarner.M.Alete.source.ssa.oh.ravenna;
...
/**
 * Signal Processing for SSA Office: RAVENNA OH
 * <p>Office Code: A66</p>
 * <p>Address: 444 ENTERPRISE PKWY, RAVENNA, OH 44266</p>
 * <p>Phone: (855) 863-3562 | Fax: (833) 950-3073</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/ravenna/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9247; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/ravenna";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/ravenna_audio", "ssa.oh.ravenna.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/ravenna_data", "ssa.oh.ravenna.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/ravenna_graphics", "ssa.oh.ravenna.graphics.spectrum", sb.toString());
        }
    }
}