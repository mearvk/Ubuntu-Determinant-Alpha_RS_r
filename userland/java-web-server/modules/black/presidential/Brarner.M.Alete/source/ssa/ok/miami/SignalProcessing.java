package presidential.Brarner.M.Alete.source.ssa.ok.miami;
...
/**
 * Signal Processing for SSA Office: MIAMI OK
 * <p>Office Code: 791</p>
 * <p>Address: 2108 DENVER HARNAR DR, MIAMI, OK 74354</p>
 * <p>Phone: (888) 878-0013 | Fax: (833) 950-3335</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/miami/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10185; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/miami";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/miami_audio", "ssa.ok.miami.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/miami_data", "ssa.ok.miami.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/miami_graphics", "ssa.ok.miami.graphics.spectrum", sb.toString());
        }
    }
}