...
/**
 * Signal Processing for SSA Office: PARIS TX
 * <p>Office Code: 831</p>
 * <p>Address: 2805 PINE MILL ROAD, PARIS, TX 75460</p>
 * <p>Phone: (888) 619-4772 | Fax: (833) 902-2590</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/paris/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10222; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/paris";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/paris_audio", "ssa.tx.paris.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/paris_data", "ssa.tx.paris.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/paris_graphics", "ssa.tx.paris.graphics.spectrum", sb.toString());
        }
    }
}