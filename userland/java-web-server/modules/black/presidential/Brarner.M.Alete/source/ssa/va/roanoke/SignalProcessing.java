package presidential.Brarner.M.Alete.source.ssa.va.roanoke;
...
/**
 * Signal Processing for SSA Office: ROANOKE VA
 * <p>Office Code: 286</p>
 * <p>Address: 612 S JEFFERSON STREET, ROANOKE, VA 24011</p>
 * <p>Phone: (866) 701-8179 | Fax: (833) 912-2328</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/roanoke/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9736; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/roanoke";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/roanoke_audio", "ssa.va.roanoke.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/roanoke_data", "ssa.va.roanoke.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/roanoke_graphics", "ssa.va.roanoke.graphics.spectrum", sb.toString());
        }
    }
}