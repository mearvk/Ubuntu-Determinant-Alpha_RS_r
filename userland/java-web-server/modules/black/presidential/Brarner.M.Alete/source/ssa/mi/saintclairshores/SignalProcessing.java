package presidential.Brarner.M.Alete.source.ssa.mi.saintclairshores;
...
/**
 * Signal Processing for SSA Office: DETROIT-EAST MI
 * <p>Office Code: 357</p>
 * <p>Address: 19503 E. EIGHT MILE RD., SAINT CLAIR SHORES, MI 48080</p>
 * <p>Phone: (877) 845-0540 | Fax: (833) 950-2136</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/saintclairshores/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9804; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/saintclairshores";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/saintclairshores_audio", "ssa.mi.saintclairshores.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/saintclairshores_data", "ssa.mi.saintclairshores.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/saintclairshores_graphics", "ssa.mi.saintclairshores.graphics.spectrum", sb.toString());
        }
    }
}