package presidential.Brarner.M.Alete.source.ssa.ms.hernando;
...
/**
 * Signal Processing for SSA Office: HERNANDO MS
 * <p>Office Code: C21</p>
 * <p>Address: 2631 MCINGVALE RD, HERNANDO, MS 38632</p>
 * <p>Phone: (866) 739-4771 | Fax: (833) 950-3471</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/hernando/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9353; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/hernando";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/hernando_audio", "ssa.ms.hernando.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/hernando_data", "ssa.ms.hernando.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/hernando_graphics", "ssa.ms.hernando.graphics.spectrum", sb.toString());
        }
    }
}