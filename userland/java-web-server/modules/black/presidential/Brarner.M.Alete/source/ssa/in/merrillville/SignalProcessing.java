package presidential.Brarner.M.Alete.source.ssa.in.merrillville;
...
/**
 * Signal Processing for SSA Office: MERRILLVILLE IN
 * <p>Office Code: D61</p>
 * <p>Address: 1438 E 85TH AVE, MERRILLVILLE, IN 46410</p>
 * <p>Phone: (877) 692-3142 | Fax: (833) 580-0171</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/merrillville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9442; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/merrillville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/merrillville_audio", "ssa.in.merrillville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/merrillville_data", "ssa.in.merrillville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/merrillville_graphics", "ssa.in.merrillville.graphics.spectrum", sb.toString());
        }
    }
}