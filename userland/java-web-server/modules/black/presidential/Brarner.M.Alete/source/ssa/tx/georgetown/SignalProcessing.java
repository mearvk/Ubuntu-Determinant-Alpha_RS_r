package presidential.Brarner.M.Alete.source.ssa.tx.georgetown;
...
/**
 * Signal Processing for SSA Office: GEORGETOWN TX
 * <p>Office Code: E45</p>
 * <p>Address: 3010 WILLIAMS DR, GEORGETOWN, TX 78628</p>
 * <p>Phone: (877) 531-4699 | Fax: (833) 950-2386</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/georgetown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9470; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/georgetown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/georgetown_audio", "ssa.tx.georgetown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/georgetown_data", "ssa.tx.georgetown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/georgetown_graphics", "ssa.tx.georgetown.graphics.spectrum", sb.toString());
        }
    }
}