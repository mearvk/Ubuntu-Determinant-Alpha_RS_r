...
/**
 * Signal Processing for SSA Office: FOSU East - Branch 1 -FO/1
 * <p>Office Code: LX1</p>
 * <p>Address: 807 CROSBY ST, CHESTER, PA 19013</p>
 * <p>Phone: (877) 685-5942 | Fax: (833) 997-3175</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/chester003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9486; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/chester003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester003_audio", "ssa.pa.chester003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester003_data", "ssa.pa.chester003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester003_graphics", "ssa.pa.chester003.graphics.spectrum", sb.toString());
        }
    }
}