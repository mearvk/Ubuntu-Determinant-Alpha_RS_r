...
/**
 * Signal Processing for SSA Office: BATAVIA OH
 * <p>Office Code: A64</p>
 * <p>Address: 1050 HOSPITAL DR, BATAVIA, OH 45103</p>
 * <p>Phone: (800) 453-0494 | Fax: (833) 950-3068</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/batavia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9245; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/batavia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/batavia_audio", "ssa.oh.batavia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/batavia_data", "ssa.oh.batavia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/batavia_graphics", "ssa.oh.batavia.graphics.spectrum", sb.toString());
        }
    }
}