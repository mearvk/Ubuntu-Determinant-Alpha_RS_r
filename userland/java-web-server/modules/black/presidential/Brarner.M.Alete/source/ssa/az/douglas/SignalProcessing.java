...
/**
 * Signal Processing for SSA Office: DOUGLAS AZ
 * <p>Office Code: B62</p>
 * <p>Address: 600 E 15TH ST, DOUGLAS, AZ 85607</p>
 * <p>Phone: (877) 480-4858 | Fax: (833) 950-3667</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/az/douglas/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9322; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/az/douglas";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_az/douglas_audio", "ssa.az.douglas.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_az/douglas_data", "ssa.az.douglas.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_az/douglas_graphics", "ssa.az.douglas.graphics.spectrum", sb.toString());
        }
    }
}