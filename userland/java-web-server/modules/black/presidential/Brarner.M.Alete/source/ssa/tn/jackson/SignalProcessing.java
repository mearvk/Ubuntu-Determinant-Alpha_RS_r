package presidential.Brarner.M.Alete.source.ssa.tn.jackson;
...
/**
 * Signal Processing for SSA Office: JACKSON TN
 * <p>Office Code: 571</p>
 * <p>Address: 415 CHEYENNE DR, JACKSON, TN 38305</p>
 * <p>Phone: (888) 383-1593 | Fax: (833) 597-0128</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/jackson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9995; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/jackson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/jackson_audio", "ssa.tn.jackson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/jackson_data", "ssa.tn.jackson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/jackson_graphics", "ssa.tn.jackson.graphics.spectrum", sb.toString());
        }
    }
}