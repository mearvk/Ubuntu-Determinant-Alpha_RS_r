package presidential.Brarner.M.Alete.source.ssa.tx.elpaso;
...
/**
 * Signal Processing for SSA Office: EL PASO DOWNTOWN TX
 * <p>Office Code: E24</p>
 * <p>Address: 600 TEXAS AVE, EL PASO, TX 79901</p>
 * <p>Phone: (866) 964-6229 | Fax: (833) 939-2019</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/elpaso/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9457; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/elpaso";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/elpaso_audio", "ssa.tx.elpaso.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/elpaso_data", "ssa.tx.elpaso.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/elpaso_graphics", "ssa.tx.elpaso.graphics.spectrum", sb.toString());
        }
    }
}