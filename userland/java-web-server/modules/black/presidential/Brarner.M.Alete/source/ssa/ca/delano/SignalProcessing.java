package presidential.Brarner.M.Alete.source.ssa.ca.delano;
...
/**
 * Signal Processing for SSA Office: DELANO CA
 * <p>Office Code: 942</p>
 * <p>Address: 2234 GIRARD STREET, DELANO, CA 93215</p>
 * <p>Phone: (866) 635-0287 | Fax: (833) 571-2609</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/delano/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10324; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/delano";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/delano_audio", "ssa.ca.delano.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/delano_data", "ssa.ca.delano.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/delano_graphics", "ssa.ca.delano.graphics.spectrum", sb.toString());
        }
    }
}