package presidential.Brarner.M.Alete.source.ssa.ca.losangeles004;
...
/**
 * Signal Processing for SSA Office: UNIVERSITY VILLAGE CA
 * <p>Office Code: 253</p>
 * <p>Address: 1122 W WASHINGTON BLVD, LOS ANGELES, CA 90015</p>
 * <p>Phone: (866) 964-7401 | Fax: (833) 950-3041</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/losangeles004/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9708; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/losangeles004";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles004_audio", "ssa.ca.losangeles004.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles004_data", "ssa.ca.losangeles004.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles004_graphics", "ssa.ca.losangeles004.graphics.spectrum", sb.toString());
        }
    }
}