package presidential.Brarner.M.Alete.source.ssa.az.mesa;
...
/**
 * Signal Processing for SSA Office: MESA AZ
 * <p>Office Code: 929</p>
 * <p>Address: 702 W JEROME AVENUE, MESA, AZ 85210</p>
 * <p>Phone: (866) 964-1716 | Fax: (833) 950-3687</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/az/mesa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10312; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/az/mesa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_az/mesa_audio", "ssa.az.mesa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_az/mesa_data", "ssa.az.mesa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_az/mesa_graphics", "ssa.az.mesa.graphics.spectrum", sb.toString());
        }
    }
}