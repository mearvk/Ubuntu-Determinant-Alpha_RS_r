...
/**
 * Signal Processing for SSA Office: FINDLAY OH
 * <p>Office Code: 413</p>
 * <p>Address: 15085 FLAG CITY DR, FINDLAY, OH 45840</p>
 * <p>Phone: (877) 628-6548 | Fax: (833) 950-3723</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/findlay/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9854; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/findlay";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/findlay_audio", "ssa.oh.findlay.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/findlay_data", "ssa.oh.findlay.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/findlay_graphics", "ssa.oh.findlay.graphics.spectrum", sb.toString());
        }
    }
}