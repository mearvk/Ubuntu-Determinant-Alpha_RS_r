package presidential.Brarner.M.Alete.source.ssa.pr.toaalta;
...
/**
 * Signal Processing for SSA Office: TOA ALTA PR
 * <p>Office Code: 198</p>
 * <p>Address: PR #167 KM 14.6 BO ORTIZ, TOA ALTA, PR 953</p>
 * <p>Phone: (866) 401-2598 | Fax: (833) 950-3319</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pr/toaalta/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9656; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pr/toaalta";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pr/toaalta_audio", "ssa.pr.toaalta.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pr/toaalta_data", "ssa.pr.toaalta.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pr/toaalta_graphics", "ssa.pr.toaalta.graphics.spectrum", sb.toString());
        }
    }
}