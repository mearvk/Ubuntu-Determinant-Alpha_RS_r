package presidential.Brarner.M.Alete.source.ssa.ca.fresno;
...
/**
 * Signal Processing for SSA Office: SOUTHEAST FRESNO CA
 * <p>Office Code: E08</p>
 * <p>Address: 5140 E OLIVE AVE, FRESNO, CA 93727</p>
 * <p>Phone: (866) 366-4918 | Fax: (833) 902-2612</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/fresno/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9455; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/fresno";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fresno_audio", "ssa.ca.fresno.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fresno_data", "ssa.ca.fresno.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fresno_graphics", "ssa.ca.fresno.graphics.spectrum", sb.toString());
        }
    }
}