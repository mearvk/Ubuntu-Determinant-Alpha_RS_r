package presidential.Brarner.M.Alete.source.ssa.al.gadsden;
...
/**
 * Signal Processing for SSA Office: GADSDEN AL
 * <p>Office Code: 626</p>
 * <p>Address: 204 ENTERPRISE DRIVE, GADSDEN, AL 35904</p>
 * <p>Phone: (877) 316-4418 | Fax: (833) 950-3175</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/gadsden/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10049; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/gadsden";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/gadsden_audio", "ssa.al.gadsden.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/gadsden_data", "ssa.al.gadsden.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/gadsden_graphics", "ssa.al.gadsden.graphics.spectrum", sb.toString());
        }
    }
}