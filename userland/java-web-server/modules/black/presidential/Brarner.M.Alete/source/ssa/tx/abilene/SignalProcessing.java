package presidential.Brarner.M.Alete.source.ssa.tx.abilene;
...
/**
 * Signal Processing for SSA Office: ABILENE TX
 * <p>Office Code: 829</p>
 * <p>Address: 1202 E SOUTH 11TH ST, ABILENE, TX 79602</p>
 * <p>Phone: (877) 607-9525 | Fax: (833) 902-2586</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/abilene/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10220; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/abilene";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/abilene_audio", "ssa.tx.abilene.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/abilene_data", "ssa.tx.abilene.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/abilene_graphics", "ssa.tx.abilene.graphics.spectrum", sb.toString());
        }
    }
}