package presidential.Brarner.M.Alete.source.ssa.mo.lebanon;
...
/**
 * Signal Processing for SSA Office: LEBANON MO
 * <p>Office Code: C52</p>
 * <p>Address: 2546 S JEFFERSON AVE, LEBANON, MO 65536</p>
 * <p>Phone: (866) 931-7104 | Fax: (833) 950-2940</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/lebanon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9369; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/lebanon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/lebanon_audio", "ssa.mo.lebanon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/lebanon_data", "ssa.mo.lebanon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/lebanon_graphics", "ssa.mo.lebanon.graphics.spectrum", sb.toString());
        }
    }
}