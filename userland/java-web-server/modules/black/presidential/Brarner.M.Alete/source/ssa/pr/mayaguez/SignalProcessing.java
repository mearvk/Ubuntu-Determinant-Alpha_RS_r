...
/**
 * Signal Processing for SSA Office: MAYAGUEZ PR
 * <p>Office Code: 279</p>
 * <p>Address: 357 HOSTOS AVE, MAYAGUEZ, PR 680</p>
 * <p>Phone: (855) 620-5726 | Fax: (833) 950-3325</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pr/mayaguez/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9729; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pr/mayaguez";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pr/mayaguez_audio", "ssa.pr.mayaguez.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pr/mayaguez_data", "ssa.pr.mayaguez.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pr/mayaguez_graphics", "ssa.pr.mayaguez.graphics.spectrum", sb.toString());
        }
    }
}