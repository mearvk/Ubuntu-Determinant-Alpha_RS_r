package presidential.Brarner.M.Alete.source.ssa.ca.fremont;
...
/**
 * Signal Processing for SSA Office: FREMONT CA
 * <p>Office Code: B60</p>
 * <p>Address: 3100 MOWRY AVE, FREMONT, CA 94538</p>
 * <p>Phone: (888) 632-7073 | Fax: (833) 950-3665</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/fremont/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9321; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/fremont";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fremont_audio", "ssa.ca.fremont.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fremont_data", "ssa.ca.fremont.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fremont_graphics", "ssa.ca.fremont.graphics.spectrum", sb.toString());
        }
    }
}