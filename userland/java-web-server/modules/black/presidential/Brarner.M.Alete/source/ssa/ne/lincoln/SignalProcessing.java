...
/**
 * Signal Processing for SSA Office: LINCOLN NE
 * <p>Office Code: 726</p>
 * <p>Address: 100 CENTENNIAL MALL N, LINCOLN, NE 68508</p>
 * <p>Phone: (866) 593-2880 | Fax: (833) 641-3167</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ne/lincoln/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10131; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ne/lincoln";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ne/lincoln_audio", "ssa.ne.lincoln.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ne/lincoln_data", "ssa.ne.lincoln.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ne/lincoln_graphics", "ssa.ne.lincoln.graphics.spectrum", sb.toString());
        }
    }
}