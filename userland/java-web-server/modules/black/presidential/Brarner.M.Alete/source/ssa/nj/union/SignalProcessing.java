package presidential.Brarner.M.Alete.source.ssa.nj.union;
...
/**
 * Signal Processing for SSA Office: UNION TOWNSHIP NJ
 * <p>Office Code: 174</p>
 * <p>Address: 855 LEHIGH AVE, UNION, NJ 7083</p>
 * <p>Phone: (877) 803-6306 | Fax: (833) 950-2978</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/union/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9635; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/union";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/union_audio", "ssa.nj.union.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/union_data", "ssa.nj.union.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/union_graphics", "ssa.nj.union.graphics.spectrum", sb.toString());
        }
    }
}