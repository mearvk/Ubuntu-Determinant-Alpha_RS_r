package presidential.Brarner.M.Alete.source.ssa.nh.concord;
...
/**
 * Signal Processing for SSA Office: CONCORD NH
 * <p>Office Code: 10</p>
 * <p>Address: 70 COMMERCIAL ST, CONCORD, NH 3301</p>
 * <p>Phone: (888) 397-9798 | Fax: (833) 950-3587</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nh/concord/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9498; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nh/concord";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nh/concord_audio", "ssa.nh.concord.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nh/concord_data", "ssa.nh.concord.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nh/concord_graphics", "ssa.nh.concord.graphics.spectrum", sb.toString());
        }
    }
}