...
/**
 * Signal Processing for SSA Office: HURON SD
 * <p>Office Code: 718</p>
 * <p>Address: 200 4TH STREET SW, HURON, SD 57350</p>
 * <p>Phone: (866) 563-4604 | Fax: (833) 873-4345</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sd/huron/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10127; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sd/huron";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sd/huron_audio", "ssa.sd.huron.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sd/huron_data", "ssa.sd.huron.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sd/huron_graphics", "ssa.sd.huron.graphics.spectrum", sb.toString());
        }
    }
}