package presidential.Brarner.M.Alete.source.ssa.id.lewiston;
...
/**
 * Signal Processing for SSA Office: LEWISTON ID
 * <p>Office Code: 895</p>
 * <p>Address: 1617 19TH AVE, LEWISTON, ID 83501</p>
 * <p>Phone: (877) 405-9796 | Fax: (833) 395-3398</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/id/lewiston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10279; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/id/lewiston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_id/lewiston_audio", "ssa.id.lewiston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_id/lewiston_data", "ssa.id.lewiston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_id/lewiston_graphics", "ssa.id.lewiston.graphics.spectrum", sb.toString());
        }
    }
}