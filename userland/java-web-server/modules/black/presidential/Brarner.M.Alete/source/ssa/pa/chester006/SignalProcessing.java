package presidential.Brarner.M.Alete.source.ssa.pa.chester006;
...
/**
 * Signal Processing for SSA Office: FOSU East - Branch 3
 * <p>Office Code: 8N0</p>
 * <p>Address: 807 CROSBY ST, CHESTER, PA 19013</p>
 * <p>Phone: (877) 685-5942 | Fax: (833) 551-0605</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/chester006/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10376; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/chester006";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester006_audio", "ssa.pa.chester006.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester006_data", "ssa.pa.chester006.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester006_graphics", "ssa.pa.chester006.graphics.spectrum", sb.toString());
        }
    }
}