package presidential.Brarner.M.Alete.source.ssa.ky.paducah;
...
/**
 * Signal Processing for SSA Office: PADUCAH KY
 * <p>Office Code: 440</p>
 * <p>Address: 125 BRETT CHASE, PADUCAH, KY 42003</p>
 * <p>Phone: (866) 614-7905 | Fax: (833) 950-3155</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/paducah/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9877; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/paducah";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/paducah_audio", "ssa.ky.paducah.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/paducah_data", "ssa.ky.paducah.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/paducah_graphics", "ssa.ky.paducah.graphics.spectrum", sb.toString());
        }
    }
}