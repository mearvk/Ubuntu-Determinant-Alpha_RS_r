package presidential.Brarner.M.Alete.source.ssa.co.montrose;
...
/**
 * Signal Processing for SSA Office: MONTROSE CO
 * <p>Office Code: D26</p>
 * <p>Address: 1805 PAVILION DR, MONTROSE, CO 81401</p>
 * <p>Phone: (866) 758-1317 | Fax: (833) 950-2906</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/co/montrose/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9416; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/co/montrose";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_co/montrose_audio", "ssa.co.montrose.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_co/montrose_data", "ssa.co.montrose.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_co/montrose_graphics", "ssa.co.montrose.graphics.spectrum", sb.toString());
        }
    }
}