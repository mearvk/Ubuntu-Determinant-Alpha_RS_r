package presidential.Brarner.M.Alete.source.ssa.fl.seffner;
...
/**
 * Signal Processing for SSA Office: EAST HILLSBOROUGH FL
 * <p>Office Code: 266</p>
 * <p>Address: 2027 S PARSONS AVE, SEFFNER, FL 33584</p>
 * <p>Phone: (866) 593-8721 | Fax: (833) 950-2532</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/seffner/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9716; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/seffner";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/seffner_audio", "ssa.fl.seffner.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/seffner_data", "ssa.fl.seffner.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/seffner_graphics", "ssa.fl.seffner.graphics.spectrum", sb.toString());
        }
    }
}