package presidential.Brarner.M.Alete.source.ssa.oh.eastliverpool;
...
/**
 * Signal Processing for SSA Office: EAST LIVERPOOL OH
 * <p>Office Code: 417</p>
 * <p>Address: 120 EAST FOURTH STREET, EAST LIVERPOOL, OH 43920</p>
 * <p>Phone: (855) 269-9178 | Fax: (833) 950-3731</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/eastliverpool/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9858; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/eastliverpool";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/eastliverpool_audio", "ssa.oh.eastliverpool.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/eastliverpool_data", "ssa.oh.eastliverpool.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/eastliverpool_graphics", "ssa.oh.eastliverpool.graphics.spectrum", sb.toString());
        }
    }
}