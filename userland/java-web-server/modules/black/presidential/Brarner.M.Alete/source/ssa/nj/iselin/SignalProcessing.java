package presidential.Brarner.M.Alete.source.ssa.nj.iselin;
...
/**
 * Signal Processing for SSA Office: WOODBRIDGE NJ
 * <p>Office Code: 175</p>
 * <p>Address: 190 MIDDLESEX TPKE, ISELIN, NJ 8830</p>
 * <p>Phone: (877) 600-2852 | Fax: (833) 950-2980</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/iselin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9636; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/iselin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/iselin_audio", "ssa.nj.iselin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/iselin_data", "ssa.nj.iselin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/iselin_graphics", "ssa.nj.iselin.graphics.spectrum", sb.toString());
        }
    }
}