...
/**
 * Signal Processing for SSA Office: AMES IA
 * <p>Office Code: B37</p>
 * <p>Address: 2615 UNIVERSITY BLVD, AMES, IA 50010</p>
 * <p>Phone: (866) 899-1928 | Fax: (833) 950-2648</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/ames/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9304; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/ames";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/ames_audio", "ssa.ia.ames.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/ames_data", "ssa.ia.ames.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/ames_graphics", "ssa.ia.ames.graphics.spectrum", sb.toString());
        }
    }
}