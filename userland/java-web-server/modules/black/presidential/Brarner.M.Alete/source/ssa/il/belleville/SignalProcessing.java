package presidential.Brarner.M.Alete.source.ssa.il.belleville;
...
/**
 * Signal Processing for SSA Office: BELLEVILLE IL
 * <p>Office Code: D59</p>
 * <p>Address: 227 W POINTE DR, BELLEVILLE, IL 62226</p>
 * <p>Phone: (877) 405-0471 | Fax: (833) 580-0167</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/belleville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9440; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/belleville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/belleville_audio", "ssa.il.belleville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/belleville_data", "ssa.il.belleville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/belleville_graphics", "ssa.il.belleville.graphics.spectrum", sb.toString());
        }
    }
}