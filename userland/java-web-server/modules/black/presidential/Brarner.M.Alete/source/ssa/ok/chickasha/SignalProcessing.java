package presidential.Brarner.M.Alete.source.ssa.ok.chickasha;
...
/**
 * Signal Processing for SSA Office: CHICKASHA OK
 * <p>Office Code: 785</p>
 * <p>Address: 506 W UTAH AVE, CHICKASHA, OK 73018</p>
 * <p>Phone: (877) 622-9096 | Fax: (833) 950-3009</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/chickasha/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10180; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/chickasha";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/chickasha_audio", "ssa.ok.chickasha.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/chickasha_data", "ssa.ok.chickasha.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/chickasha_graphics", "ssa.ok.chickasha.graphics.spectrum", sb.toString());
        }
    }
}