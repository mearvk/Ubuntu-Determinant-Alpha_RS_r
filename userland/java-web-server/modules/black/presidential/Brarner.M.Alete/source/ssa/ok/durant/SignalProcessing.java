...
/**
 * Signal Processing for SSA Office: DURANT OK
 * <p>Office Code: D21</p>
 * <p>Address: 121 S 12TH AVE, DURANT, OK 74701</p>
 * <p>Phone: (866) 495-0042 | Fax: (833) 939-2015</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/durant/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9413; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/durant";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/durant_audio", "ssa.ok.durant.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/durant_data", "ssa.ok.durant.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/durant_graphics", "ssa.ok.durant.graphics.spectrum", sb.toString());
        }
    }
}