package presidential.Brarner.M.Alete.source.ssa.fl.fortmyers;
...
/**
 * Signal Processing for SSA Office: FORT MYERS FL
 * <p>Office Code: 670</p>
 * <p>Address: 4220 EXECUTIVE CIRCLE, FORT MYERS, FL 33916</p>
 * <p>Phone: (888) 318-9114 | Fax: (833) 795-0128</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/fortmyers/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10086; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/fortmyers";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/fortmyers_audio", "ssa.fl.fortmyers.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/fortmyers_data", "ssa.fl.fortmyers.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/fortmyers_graphics", "ssa.fl.fortmyers.graphics.spectrum", sb.toString());
        }
    }
}