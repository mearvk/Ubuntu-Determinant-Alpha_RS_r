package presidential.Brarner.M.Alete.source.ssa.il.normal;
...
/**
 * Signal Processing for SSA Office: NORMAL IL
 * <p>Office Code: 507</p>
 * <p>Address: 328 SUSAN DR, NORMAL, IL 61761</p>
 * <p>Phone: (877) 405-4640 | Fax: (833) 950-3107</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/normal/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9942; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/normal";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/normal_audio", "ssa.il.normal.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/normal_data", "ssa.il.normal.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/normal_graphics", "ssa.il.normal.graphics.spectrum", sb.toString());
        }
    }
}