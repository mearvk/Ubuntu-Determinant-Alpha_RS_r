package presidential.Brarner.M.Alete.source.ssa.tx.greenville;
...
/**
 * Signal Processing for SSA Office: GREENVILLE TX
 * <p>Office Code: 845</p>
 * <p>Address: 2717 TERRELL ROAD, GREENVILLE, TX 75402</p>
 * <p>Phone: (888) 306-3534 | Fax: (833) 950-2406</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/greenville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10236; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/greenville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/greenville_audio", "ssa.tx.greenville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/greenville_data", "ssa.tx.greenville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/greenville_graphics", "ssa.tx.greenville.graphics.spectrum", sb.toString());
        }
    }
}