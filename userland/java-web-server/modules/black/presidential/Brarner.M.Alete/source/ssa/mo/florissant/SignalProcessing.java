package presidential.Brarner.M.Alete.source.ssa.mo.florissant;
...
/**
 * Signal Processing for SSA Office: ST LOUIS NORTH COUNTY
 * <p>Office Code: E76</p>
 * <p>Address: 880 RUE ST. FRANCOIS, FLORISSANT, MO 63031</p>
 * <p>Phone: (866) 931-2871 | Fax: (833) 950-3244</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/florissant/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9476; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/florissant";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/florissant_audio", "ssa.mo.florissant.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/florissant_data", "ssa.mo.florissant.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/florissant_graphics", "ssa.mo.florissant.graphics.spectrum", sb.toString());
        }
    }
}