package presidential.Brarner.M.Alete.source.ssa.oh.middleburghts;
...
/**
 * Signal Processing for SSA Office: CLEVELAND SW OH
 * <p>Office Code: 432</p>
 * <p>Address: 7344 PEARL RD, MIDDLEBURG HTS, OH 44130</p>
 * <p>Phone: (866) 931-9176 | Fax: (833) 902-2664</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/middleburghts/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9870; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/middleburghts";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/middleburghts_audio", "ssa.oh.middleburghts.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/middleburghts_data", "ssa.oh.middleburghts.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/middleburghts_graphics", "ssa.oh.middleburghts.graphics.spectrum", sb.toString());
        }
    }
}