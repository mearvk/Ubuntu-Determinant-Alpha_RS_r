package presidential.Brarner.M.Alete.source.ssa.wa.longview;
...
/**
 * Signal Processing for SSA Office: LONGVIEW WA
 * <p>Office Code: 928</p>
 * <p>Address: 840 OCEAN BEACH HWY, LONGVIEW, WA 98632</p>
 * <p>Phone: (866) 495-0044 | Fax: (833) 950-2628</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/longview/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10311; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/longview";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/longview_audio", "ssa.wa.longview.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/longview_data", "ssa.wa.longview.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/longview_graphics", "ssa.wa.longview.graphics.spectrum", sb.toString());
        }
    }
}