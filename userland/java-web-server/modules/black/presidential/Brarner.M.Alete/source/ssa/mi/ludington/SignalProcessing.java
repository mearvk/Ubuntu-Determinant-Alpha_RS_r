package presidential.Brarner.M.Alete.source.ssa.mi.ludington;
...
/**
 * Signal Processing for SSA Office: LUDINGTON MI
 * <p>Office Code: 244</p>
 * <p>Address: 150 N JEBAVY DR, LUDINGTON, MI 49431</p>
 * <p>Phone: (866) 495-0075 | Fax: (833) 902-2652</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/ludington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9700; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/ludington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/ludington_audio", "ssa.mi.ludington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/ludington_data", "ssa.mi.ludington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/ludington_graphics", "ssa.mi.ludington.graphics.spectrum", sb.toString());
        }
    }
}