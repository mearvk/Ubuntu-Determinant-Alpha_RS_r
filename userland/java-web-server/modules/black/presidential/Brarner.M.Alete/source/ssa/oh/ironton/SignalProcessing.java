package presidential.Brarner.M.Alete.source.ssa.oh.ironton;
...
/**
 * Signal Processing for SSA Office: IRONTON OH
 * <p>Office Code: 421</p>
 * <p>Address: 611 VERNON STREET, IRONTON, OH 45638</p>
 * <p>Phone: (866) 789-1073 | Fax: (833) 596-0579</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/ironton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9862; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/ironton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/ironton_audio", "ssa.oh.ironton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/ironton_data", "ssa.oh.ironton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/ironton_graphics", "ssa.oh.ironton.graphics.spectrum", sb.toString());
        }
    }
}