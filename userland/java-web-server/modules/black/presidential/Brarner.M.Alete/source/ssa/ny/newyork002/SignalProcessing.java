package presidential.Brarner.M.Alete.source.ssa.ny.newyork002;
...
/**
 * Signal Processing for SSA Office: NY MIDTOWN NY
 * <p>Office Code: 100</p>
 * <p>Address: 237 W 48TH STREET, NEW YORK, NY 10036</p>
 * <p>Phone: (866) 964-0783 | Fax: (833) 950-3599</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/newyork002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9571; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/newyork002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork002_audio", "ssa.ny.newyork002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork002_data", "ssa.ny.newyork002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork002_graphics", "ssa.ny.newyork002.graphics.spectrum", sb.toString());
        }
    }
}