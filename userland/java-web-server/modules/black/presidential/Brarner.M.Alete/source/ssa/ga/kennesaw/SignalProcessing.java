package presidential.Brarner.M.Alete.source.ssa.ga.kennesaw;
...
/**
 * Signal Processing for SSA Office: KENNESAW GA
 * <p>Office Code: 619</p>
 * <p>Address: 200 CHASTAIN CENTER BLVD, KENNESAW, GA 30144</p>
 * <p>Phone: (866) 964-4690 | Fax: (833) 950-3161</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/kennesaw/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10042; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/kennesaw";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/kennesaw_audio", "ssa.ga.kennesaw.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/kennesaw_data", "ssa.ga.kennesaw.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/kennesaw_graphics", "ssa.ga.kennesaw.graphics.spectrum", sb.toString());
        }
    }
}