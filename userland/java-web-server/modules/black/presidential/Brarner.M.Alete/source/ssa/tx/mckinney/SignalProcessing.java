package presidential.Brarner.M.Alete.source.ssa.tx.mckinney;
...
/**
 * Signal Processing for SSA Office: MCKINNEY TX
 * <p>Office Code: A76</p>
 * <p>Address: 3250 CRAIG DR, MCKINNEY, TX 75070</p>
 * <p>Phone: (866) 931-2731 | Fax: (833) 939-1986</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/mckinney/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9257; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/mckinney";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/mckinney_audio", "ssa.tx.mckinney.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/mckinney_data", "ssa.tx.mckinney.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/mckinney_graphics", "ssa.tx.mckinney.graphics.spectrum", sb.toString());
        }
    }
}