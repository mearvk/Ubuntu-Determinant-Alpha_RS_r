package presidential.Brarner.M.Alete.source.ssa.tn.gallatin;
...
/**
 * Signal Processing for SSA Office: GALLATIN TN
 * <p>Office Code: 558</p>
 * <p>Address: 637 COMMONS DRIVE, GALLATIN, TN 37066</p>
 * <p>Phone: (866) 964-7392 | Fax: (833) 950-3791</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/gallatin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9985; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/gallatin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/gallatin_audio", "ssa.tn.gallatin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/gallatin_data", "ssa.tn.gallatin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/gallatin_graphics", "ssa.tn.gallatin.graphics.spectrum", sb.toString());
        }
    }
}