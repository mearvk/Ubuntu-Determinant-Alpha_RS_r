package presidential.Brarner.M.Alete.source.ssa.tn.cookeville;
...
/**
 * Signal Processing for SSA Office: COOKEVILLE TN
 * <p>Office Code: 573</p>
 * <p>Address: 1145 PERIMETER PARK DR, COOKEVILLE, TN 38501</p>
 * <p>Phone: (888) 717-1528 | Fax: (833) 597-0132</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/cookeville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9997; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/cookeville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/cookeville_audio", "ssa.tn.cookeville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/cookeville_data", "ssa.tn.cookeville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/cookeville_graphics", "ssa.tn.cookeville.graphics.spectrum", sb.toString());
        }
    }
}