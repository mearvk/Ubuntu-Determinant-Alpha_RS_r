package presidential.Brarner.M.Alete.source.ssa.nc.greensboro;
...
/**
 * Signal Processing for SSA Office: GREENSBORO NC
 * <p>Office Code: 325</p>
 * <p>Address: 6005 LANDMARK CTR BLVD, GREENSBORO, NC 27407</p>
 * <p>Phone: (877) 319-3075 | Fax: (833) 950-2546</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/greensboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9774; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/greensboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/greensboro_audio", "ssa.nc.greensboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/greensboro_data", "ssa.nc.greensboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/greensboro_graphics", "ssa.nc.greensboro.graphics.spectrum", sb.toString());
        }
    }
}