package presidential.Brarner.M.Alete.source.ssa.la.batonrouge002;
...
/**
 * Signal Processing for SSA Office: BATON ROUGE LA
 * <p>Office Code: 803</p>
 * <p>Address: 5455 BANKERS AVE, BATON ROUGE, LA 70808</p>
 * <p>Phone: (866) 613-3070 | Fax: (833) 950-3635</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/batonrouge002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10195; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/batonrouge002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/batonrouge002_audio", "ssa.la.batonrouge002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/batonrouge002_data", "ssa.la.batonrouge002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/batonrouge002_graphics", "ssa.la.batonrouge002.graphics.spectrum", sb.toString());
        }
    }
}