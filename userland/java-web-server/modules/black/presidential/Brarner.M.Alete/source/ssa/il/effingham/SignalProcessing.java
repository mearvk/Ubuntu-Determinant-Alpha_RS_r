package presidential.Brarner.M.Alete.source.ssa.il.effingham;
...
/**
 * Signal Processing for SSA Office: EFFINGHAM IL
 * <p>Office Code: 521</p>
 * <p>Address: 1207 NETWORK CENTRE DR, EFFINGHAM, IL 62401</p>
 * <p>Phone: (855) 213-5288 | Fax: (833) 950-3449</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/effingham/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9955; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/effingham";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/effingham_audio", "ssa.il.effingham.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/effingham_data", "ssa.il.effingham.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/effingham_graphics", "ssa.il.effingham.graphics.spectrum", sb.toString());
        }
    }
}