...
/**
 * Signal Processing for SSA Office: ANNAPOLIS MD
 * <p>Office Code: 277</p>
 * <p>Address: 185 HARRY S TRUMAN PARKWAY, ANNAPOLIS, MD 21401</p>
 * <p>Phone: (888) 840-0684 | Fax: (833) 597-0151</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/annapolis/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9727; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/annapolis";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/annapolis_audio", "ssa.md.annapolis.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/annapolis_data", "ssa.md.annapolis.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/annapolis_graphics", "ssa.md.annapolis.graphics.spectrum", sb.toString());
        }
    }
}