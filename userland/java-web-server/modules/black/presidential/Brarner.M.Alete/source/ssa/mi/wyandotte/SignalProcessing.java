package presidential.Brarner.M.Alete.source.ssa.mi.wyandotte;
...
/**
 * Signal Processing for SSA Office: WYANDOTTE MI
 * <p>Office Code: A63</p>
 * <p>Address: 3450 BIDDLE AVE      ., WYANDOTTE, MI 48192</p>
 * <p>Phone: (866) 964-7407 | Fax: (833) 950-3067</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/wyandotte/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9244; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/wyandotte";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/wyandotte_audio", "ssa.mi.wyandotte.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/wyandotte_data", "ssa.mi.wyandotte.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/wyandotte_graphics", "ssa.mi.wyandotte.graphics.spectrum", sb.toString());
        }
    }
}