package presidential.Brarner.M.Alete.source.ssa.mp.saipan;
...
/**
 * Signal Processing for SSA Office: SAIPAN MP
 * <p>Office Code: E02</p>
 * <p>Address: MARINA HEIGHTS BUSINESS PARK, SAIPAN, MP 96950</p>
 * <p>Phone: (855) 616-6449 | Fax: (833) 902-2610</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mp/saipan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9453; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mp/saipan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mp/saipan_audio", "ssa.mp.saipan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mp/saipan_data", "ssa.mp.saipan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mp/saipan_graphics", "ssa.mp.saipan.graphics.spectrum", sb.toString());
        }
    }
}