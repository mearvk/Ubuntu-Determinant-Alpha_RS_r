package presidential.Brarner.M.Alete.source.ssa.tx.dallas002;
...
/**
 * Signal Processing for SSA Office: DALLAS FAIR PARK TX
 * <p>Office Code: 851</p>
 * <p>Address: 2530 S MALCOLM X BLVD, DALLAS, TX 75215</p>
 * <p>Phone: (888) 717-1529 | Fax: (833) 950-2416</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/dallas002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10240; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/dallas002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/dallas002_audio", "ssa.tx.dallas002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/dallas002_data", "ssa.tx.dallas002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/dallas002_graphics", "ssa.tx.dallas002.graphics.spectrum", sb.toString());
        }
    }
}