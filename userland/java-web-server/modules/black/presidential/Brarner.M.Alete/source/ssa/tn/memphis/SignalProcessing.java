package presidential.Brarner.M.Alete.source.ssa.tn.memphis;
...
/**
 * Signal Processing for SSA Office: MEMPHIS NORTH TN
 * <p>Office Code: C90</p>
 * <p>Address: 3602 AUSTIN PEAY HWY, MEMPHIS, TN 38128</p>
 * <p>Phone: (855) 420-8557 | Fax: (833) 597-0060</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/memphis/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9391; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/memphis";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/memphis_audio", "ssa.tn.memphis.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/memphis_data", "ssa.tn.memphis.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/memphis_graphics", "ssa.tn.memphis.graphics.spectrum", sb.toString());
        }
    }
}