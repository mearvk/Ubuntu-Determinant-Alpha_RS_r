package presidential.Brarner.M.Alete.source.ssa.ny.horseheads;
...
/**
 * Signal Processing for SSA Office: HORSEHEADS NY
 * <p>Office Code: 114</p>
 * <p>Address: 3345 CHAMBERS RD S, HORSEHEADS, NY 14845</p>
 * <p>Phone: (866) 964-1715 | Fax: (833) 515-0477</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/horseheads/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9585; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/horseheads";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/horseheads_audio", "ssa.ny.horseheads.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/horseheads_data", "ssa.ny.horseheads.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/horseheads_graphics", "ssa.ny.horseheads.graphics.spectrum", sb.toString());
        }
    }
}