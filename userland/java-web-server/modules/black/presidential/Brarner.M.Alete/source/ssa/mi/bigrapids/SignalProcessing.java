package presidential.Brarner.M.Alete.source.ssa.mi.bigrapids;
...
/**
 * Signal Processing for SSA Office: BIG RAPIDS MI
 * <p>Office Code: C54</p>
 * <p>Address: 502 N STATE ST, BIG RAPIDS, MI 49307</p>
 * <p>Phone: (855) 245-0641 | Fax: (833) 950-3705</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/bigrapids/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9371; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/bigrapids";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/bigrapids_audio", "ssa.mi.bigrapids.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/bigrapids_data", "ssa.mi.bigrapids.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/bigrapids_graphics", "ssa.mi.bigrapids.graphics.spectrum", sb.toString());
        }
    }
}