package presidential.Brarner.M.Alete.source.ssa.tx.balchsprings;
...
/**
 * Signal Processing for SSA Office: DALLAS PLEASANT GROVE
 * <p>Office Code: E64</p>
 * <p>Address: 2300 DUNSON DR, BALCH SPRINGS, TX 75180</p>
 * <p>Phone: (855) 531-1683 | Fax: (833) 950-2387</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/balchsprings/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9472; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/balchsprings";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/balchsprings_audio", "ssa.tx.balchsprings.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/balchsprings_data", "ssa.tx.balchsprings.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/balchsprings_graphics", "ssa.tx.balchsprings.graphics.spectrum", sb.toString());
        }
    }
}