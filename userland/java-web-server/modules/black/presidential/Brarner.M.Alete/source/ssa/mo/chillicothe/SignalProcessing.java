package presidential.Brarner.M.Alete.source.ssa.mo.chillicothe;
...
/**
 * Signal Processing for SSA Office: CHILLICOTHE MO
 * <p>Office Code: 97</p>
 * <p>Address: 1105 S MITCHELL AVE, CHILLICOTHE, MO 64601</p>
 * <p>Phone: (877) 405-7668 | Fax: (833) 950-3559</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/chillicothe/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9568; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/chillicothe";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/chillicothe_audio", "ssa.mo.chillicothe.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/chillicothe_data", "ssa.mo.chillicothe.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/chillicothe_graphics", "ssa.mo.chillicothe.graphics.spectrum", sb.toString());
        }
    }
}