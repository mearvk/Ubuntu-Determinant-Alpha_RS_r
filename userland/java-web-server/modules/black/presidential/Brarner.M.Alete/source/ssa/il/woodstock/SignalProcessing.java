package presidential.Brarner.M.Alete.source.ssa.il.woodstock;
...
/**
 * Signal Processing for SSA Office: WOODSTOCK IL
 * <p>Office Code: A60</p>
 * <p>Address: 2450 LAKE SHORE DR, WOODSTOCK, IL 60098</p>
 * <p>Phone: (877) 405-7828 | Fax: (833) 950-3063</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/woodstock/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9242; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/woodstock";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/woodstock_audio", "ssa.il.woodstock.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/woodstock_data", "ssa.il.woodstock.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/woodstock_graphics", "ssa.il.woodstock.graphics.spectrum", sb.toString());
        }
    }
}