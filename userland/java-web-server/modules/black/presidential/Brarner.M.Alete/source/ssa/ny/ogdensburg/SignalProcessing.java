package presidential.Brarner.M.Alete.source.ssa.ny.ogdensburg;
...
/**
 * Signal Processing for SSA Office: OGDENSBURG NY
 * <p>Office Code: 116</p>
 * <p>Address: 101 FORD STREET, OGDENSBURG, NY 13669</p>
 * <p>Phone: (866) 572-8369 | Fax: (833) 515-0481</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/ogdensburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9587; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/ogdensburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/ogdensburg_audio", "ssa.ny.ogdensburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/ogdensburg_data", "ssa.ny.ogdensburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/ogdensburg_graphics", "ssa.ny.ogdensburg.graphics.spectrum", sb.toString());
        }
    }
}