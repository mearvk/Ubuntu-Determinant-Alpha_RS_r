package presidential.Brarner.M.Alete.source.ssa.sc.spartanburg;
...
/**
 * Signal Processing for SSA Office: SPARTANBURG SC
 * <p>Office Code: 584</p>
 * <p>Address: 145 N CHURCH ST, SPARTANBURG, SC 29306</p>
 * <p>Phone: (866) 701-6620 | Fax: (833) 912-2290</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/spartanburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10008; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/spartanburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/spartanburg_audio", "ssa.sc.spartanburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/spartanburg_data", "ssa.sc.spartanburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/spartanburg_graphics", "ssa.sc.spartanburg.graphics.spectrum", sb.toString());
        }
    }
}