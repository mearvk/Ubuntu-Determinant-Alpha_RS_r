package presidential.Brarner.M.Alete.source.ssa.wi.mountpleasant;
...
/**
 * Signal Processing for SSA Office: MOUNT PLEASANT/RACINE
 * <p>Office Code: 540</p>
 * <p>Address: 13200 GLOBE DR, MOUNT PLEASANT, WI 53177</p>
 * <p>Phone: (866) 270-8629 | Fax: (833) 950-3745</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/mountpleasant/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9969; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/mountpleasant";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/mountpleasant_audio", "ssa.wi.mountpleasant.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/mountpleasant_data", "ssa.wi.mountpleasant.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/mountpleasant_graphics", "ssa.wi.mountpleasant.graphics.spectrum", sb.toString());
        }
    }
}