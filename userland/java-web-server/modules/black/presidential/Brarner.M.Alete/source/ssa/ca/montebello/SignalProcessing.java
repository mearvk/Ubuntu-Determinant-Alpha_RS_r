package presidential.Brarner.M.Alete.source.ssa.ca.montebello;
...
/**
 * Signal Processing for SSA Office: MONTEBELLO CA
 * <p>Office Code: 63</p>
 * <p>Address: 2216 W BEVERLY BLVD, MONTEBELLO, CA 90640</p>
 * <p>Phone: (866) 964-7435 | Fax: (833) 950-2440</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/montebello/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9543; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/montebello";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/montebello_audio", "ssa.ca.montebello.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/montebello_data", "ssa.ca.montebello.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/montebello_graphics", "ssa.ca.montebello.graphics.spectrum", sb.toString());
        }
    }
}