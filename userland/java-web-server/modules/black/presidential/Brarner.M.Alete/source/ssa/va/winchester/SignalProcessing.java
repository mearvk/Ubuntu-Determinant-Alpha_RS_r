...
/**
 * Signal Processing for SSA Office: WINCHESTER VA
 * <p>Office Code: 295</p>
 * <p>Address: 323 HOPE DRIVE, WINCHESTER, VA 22601</p>
 * <p>Phone: (866) 331-2320 | Fax: (833) 950-2296</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/winchester/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9745; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/winchester";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/winchester_audio", "ssa.va.winchester.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/winchester_data", "ssa.va.winchester.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/winchester_graphics", "ssa.va.winchester.graphics.spectrum", sb.toString());
        }
    }
}