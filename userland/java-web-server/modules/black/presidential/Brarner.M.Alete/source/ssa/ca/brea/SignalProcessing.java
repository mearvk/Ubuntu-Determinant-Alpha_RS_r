package presidential.Brarner.M.Alete.source.ssa.ca.brea;
...
/**
 * Signal Processing for SSA Office: BREA CA
 * <p>Office Code: D39</p>
 * <p>Address: 3230 E IMPERIAL HWY, BREA, CA 92821</p>
 * <p>Phone: (866) 593-2757 | Fax: (833) 902-2594</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/brea/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9425; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/brea";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/brea_audio", "ssa.ca.brea.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/brea_data", "ssa.ca.brea.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/brea_graphics", "ssa.ca.brea.graphics.spectrum", sb.toString());
        }
    }
}