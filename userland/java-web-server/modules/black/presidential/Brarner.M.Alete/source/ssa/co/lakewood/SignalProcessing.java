package presidential.Brarner.M.Alete.source.ssa.co.lakewood;
...
/**
 * Signal Processing for SSA Office: LAKEWOOD CO
 * <p>Office Code: 93</p>
 * <p>Address: 13151 W ALAMEDA PKWY, LAKEWOOD, CO 80228</p>
 * <p>Phone: (866) 563-9469 | Fax: (833) 950-3537</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/co/lakewood/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9564; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/co/lakewood";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_co/lakewood_audio", "ssa.co.lakewood.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_co/lakewood_data", "ssa.co.lakewood.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_co/lakewood_graphics", "ssa.co.lakewood.graphics.spectrum", sb.toString());
        }
    }
}