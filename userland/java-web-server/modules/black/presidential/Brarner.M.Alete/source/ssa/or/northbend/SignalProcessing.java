package presidential.Brarner.M.Alete.source.ssa.or.northbend;
...
/**
 * Signal Processing for SSA Office: NORTH BEND OR
 * <p>Office Code: 938</p>
 * <p>Address: 3661 BROADWAY AVE, NORTH BEND, OR 97459</p>
 * <p>Phone: (866) 275-9901 | Fax: (833) 950-2920</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/or/northbend/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10320; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/or/northbend";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_or/northbend_audio", "ssa.or.northbend.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_or/northbend_data", "ssa.or.northbend.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_or/northbend_graphics", "ssa.or.northbend.graphics.spectrum", sb.toString());
        }
    }
}