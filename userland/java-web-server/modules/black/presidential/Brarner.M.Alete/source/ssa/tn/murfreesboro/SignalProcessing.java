package presidential.Brarner.M.Alete.source.ssa.tn.murfreesboro;
...
/**
 * Signal Processing for SSA Office: MURFREESBORO TN
 * <p>Office Code: 578</p>
 * <p>Address: 2836 SAINT PATRICK CT, MURFREESBORO, TN 37128</p>
 * <p>Phone: (866) 593-3112 | Fax: (833) 905-2062</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/murfreesboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10002; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/murfreesboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/murfreesboro_audio", "ssa.tn.murfreesboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/murfreesboro_data", "ssa.tn.murfreesboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/murfreesboro_graphics", "ssa.tn.murfreesboro.graphics.spectrum", sb.toString());
        }
    }
}