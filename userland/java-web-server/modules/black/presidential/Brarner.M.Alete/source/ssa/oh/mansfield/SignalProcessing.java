package presidential.Brarner.M.Alete.source.ssa.oh.mansfield;
...
/**
 * Signal Processing for SSA Office: MANSFIELD OH
 * <p>Office Code: 393</p>
 * <p>Address: 1287 SOUTH TRIMBLE RD, MANSFIELD, OH 44907</p>
 * <p>Phone: (888) 491-1882 | Fax: (833) 950-3087</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/mansfield/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9834; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/mansfield";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/mansfield_audio", "ssa.oh.mansfield.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/mansfield_data", "ssa.oh.mansfield.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/mansfield_graphics", "ssa.oh.mansfield.graphics.spectrum", sb.toString());
        }
    }
}