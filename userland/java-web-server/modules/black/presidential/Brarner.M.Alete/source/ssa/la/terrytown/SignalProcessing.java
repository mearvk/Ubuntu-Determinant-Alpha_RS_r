package presidential.Brarner.M.Alete.source.ssa.la.terrytown;
...
/**
 * Signal Processing for SSA Office: ORL WEST LA
 * <p>Office Code: A70</p>
 * <p>Address: 115 TERRY PKWY, TERRYTOWN, LA 70056</p>
 * <p>Phone: (866) 931-2524 | Fax: (833) 902-2567</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/terrytown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9251; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/terrytown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/terrytown_audio", "ssa.la.terrytown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/terrytown_data", "ssa.la.terrytown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/terrytown_graphics", "ssa.la.terrytown.graphics.spectrum", sb.toString());
        }
    }
}