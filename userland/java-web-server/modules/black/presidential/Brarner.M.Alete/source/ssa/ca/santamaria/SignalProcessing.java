package presidential.Brarner.M.Alete.source.ssa.ca.santamaria;
...
/**
 * Signal Processing for SSA Office: SANTA MARIA CA
 * <p>Office Code: 68</p>
 * <p>Address: 2436 PROFESSIONAL PKWY, SANTA MARIA, CA 93455</p>
 * <p>Phone: (866) 331-2316 | Fax: (833) 950-2736</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/santamaria/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9546; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/santamaria";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/santamaria_audio", "ssa.ca.santamaria.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/santamaria_data", "ssa.ca.santamaria.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/santamaria_graphics", "ssa.ca.santamaria.graphics.spectrum", sb.toString());
        }
    }
}