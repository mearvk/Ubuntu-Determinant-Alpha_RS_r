package presidential.Brarner.M.Alete.source.ssa.co.littleton;
...
/**
 * Signal Processing for SSA Office: LITTLETON CO
 * <p>Office Code: 92</p>
 * <p>Address: 8000 SOUTHPARK LN, LITTLETON, CO 80120</p>
 * <p>Phone: (888) 824-4384 | Fax: (833) 950-3535</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/co/littleton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9563; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/co/littleton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_co/littleton_audio", "ssa.co.littleton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_co/littleton_data", "ssa.co.littleton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_co/littleton_graphics", "ssa.co.littleton.graphics.spectrum", sb.toString());
        }
    }
}