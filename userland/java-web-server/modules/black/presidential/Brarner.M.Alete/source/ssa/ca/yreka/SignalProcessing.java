package presidential.Brarner.M.Alete.source.ssa.ca.yreka;
...
/**
 * Signal Processing for SSA Office: YREKA CA
 * <p>Office Code: A03</p>
 * <p>Address: 1960 S. OREGON STREET, YREKA, CA 96097</p>
 * <p>Phone: (888) 366-6145 | Fax: (833) 950-3031</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/yreka/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9202; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/yreka";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/yreka_audio", "ssa.ca.yreka.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/yreka_data", "ssa.ca.yreka.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/yreka_graphics", "ssa.ca.yreka.graphics.spectrum", sb.toString());
        }
    }
}