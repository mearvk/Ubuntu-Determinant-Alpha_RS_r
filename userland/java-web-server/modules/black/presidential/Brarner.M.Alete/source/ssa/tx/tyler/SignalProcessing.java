package presidential.Brarner.M.Alete.source.ssa.tx.tyler;
...
/**
 * Signal Processing for SSA Office: TYLER TX
 * <p>Office Code: 819</p>
 * <p>Address: 5509 DONNYBROOK AVE, TYLER, TX 75703</p>
 * <p>Phone: (877) 319-5707 | Fax: (833) 519-3207</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/tyler/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10210; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/tyler";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/tyler_audio", "ssa.tx.tyler.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/tyler_data", "ssa.tx.tyler.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/tyler_graphics", "ssa.tx.tyler.graphics.spectrum", sb.toString());
        }
    }
}