package presidential.Brarner.M.Alete.source.ssa.fl.tampa002;
...
/**
 * Signal Processing for SSA Office: CARROLLWOOD FL
 * <p>Office Code: 949</p>
 * <p>Address: 10050 N FLORIDA AVE, TAMPA, FL 33612</p>
 * <p>Phone: (855) 433-5873 | Fax: (833) 921-1896</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/tampa002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10331; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/tampa002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/tampa002_audio", "ssa.fl.tampa002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/tampa002_data", "ssa.fl.tampa002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/tampa002_graphics", "ssa.fl.tampa002.graphics.spectrum", sb.toString());
        }
    }
}