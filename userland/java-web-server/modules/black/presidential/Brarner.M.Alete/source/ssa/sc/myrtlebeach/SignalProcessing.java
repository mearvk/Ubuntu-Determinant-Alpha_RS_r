package presidential.Brarner.M.Alete.source.ssa.sc.myrtlebeach;
...
/**
 * Signal Processing for SSA Office: MYRTLE BEACH SC
 * <p>Office Code: 592</p>
 * <p>Address: 611 BURROUGHS AND CHAPIN BLVD, MYRTLE BEACH, SC 29577</p>
 * <p>Phone: (888) 577-6601 | Fax: (833) 950-2243</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/myrtlebeach/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10016; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/myrtlebeach";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/myrtlebeach_audio", "ssa.sc.myrtlebeach.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/myrtlebeach_data", "ssa.sc.myrtlebeach.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/myrtlebeach_graphics", "ssa.sc.myrtlebeach.graphics.spectrum", sb.toString());
        }
    }
}