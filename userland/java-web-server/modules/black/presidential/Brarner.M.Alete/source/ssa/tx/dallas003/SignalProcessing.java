package presidential.Brarner.M.Alete.source.ssa.tx.dallas003;
...
/**
 * Signal Processing for SSA Office: DALLAS OAK CLIFF TX
 * <p>Office Code: 853</p>
 * <p>Address: 2475 CLIFF CREEK CROSSING DR, DALLAS, TX 75237</p>
 * <p>Phone: (866) 931-4958 | Fax: (833) 950-2420</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/dallas003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10242; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/dallas003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/dallas003_audio", "ssa.tx.dallas003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/dallas003_data", "ssa.tx.dallas003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/dallas003_graphics", "ssa.tx.dallas003.graphics.spectrum", sb.toString());
        }
    }
}