package presidential.Brarner.M.Alete.source.ssa.wa.kent;
...
/**
 * Signal Processing for SSA Office: KENT WA
 * <p>Office Code: 191</p>
 * <p>Address: 321 RAMSAY WAY, KENT, WA 98032</p>
 * <p>Phone: (866) 931-7671 | Fax: (833) 912-2342</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/kent/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9650; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/kent";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/kent_audio", "ssa.wa.kent.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/kent_data", "ssa.wa.kent.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/kent_graphics", "ssa.wa.kent.graphics.spectrum", sb.toString());
        }
    }
}