package presidential.Brarner.M.Alete.source.ssa.al.florence;
...
/**
 * Signal Processing for SSA Office: FLORENCE AL
 * <p>Office Code: 631</p>
 * <p>Address: 203 SOUTH WALNUT ST, FLORENCE, AL 35630</p>
 * <p>Phone: (855) 884-3407 | Fax: (833) 950-3501</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/florence/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10054; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/florence";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/florence_audio", "ssa.al.florence.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/florence_data", "ssa.al.florence.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/florence_graphics", "ssa.al.florence.graphics.spectrum", sb.toString());
        }
    }
}