package presidential.Brarner.M.Alete.source.ssa.ca.yubacity;
...
/**
 * Signal Processing for SSA Office: YUBA CITY CA
 * <p>Office Code: 989</p>
 * <p>Address: 355 PERCY AVENUE, YUBA CITY, CA 95991</p>
 * <p>Phone: (866) 331-5449 | Fax: (833) 950-2762</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/yubacity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10370; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/yubacity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/yubacity_audio", "ssa.ca.yubacity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/yubacity_data", "ssa.ca.yubacity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/yubacity_graphics", "ssa.ca.yubacity.graphics.spectrum", sb.toString());
        }
    }
}