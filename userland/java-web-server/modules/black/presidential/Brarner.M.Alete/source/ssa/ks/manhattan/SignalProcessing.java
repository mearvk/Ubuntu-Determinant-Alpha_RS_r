package presidential.Brarner.M.Alete.source.ssa.ks.manhattan;
...
/**
 * Signal Processing for SSA Office: MANHATTAN KS
 * <p>Office Code: 778</p>
 * <p>Address: 1121 HUDSON AVE, MANHATTAN, KS 66503</p>
 * <p>Phone: (877) 840-5741 | Fax: (833) 950-2636</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ks/manhattan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10174; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ks/manhattan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ks/manhattan_audio", "ssa.ks.manhattan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ks/manhattan_data", "ssa.ks.manhattan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ks/manhattan_graphics", "ssa.ks.manhattan.graphics.spectrum", sb.toString());
        }
    }
}