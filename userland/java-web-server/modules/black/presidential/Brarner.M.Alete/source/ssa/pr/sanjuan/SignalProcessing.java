package presidential.Brarner.M.Alete.source.ssa.pr.sanjuan;
...
/**
 * Signal Processing for SSA Office: SAN JUAN PR
 * <p>Office Code: 271</p>
 * <p>Address: STE 106, SAN JUAN, PR 918</p>
 * <p>Phone: (866) 270-0406 | Fax: (833) 950-3321</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pr/sanjuan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9721; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pr/sanjuan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pr/sanjuan_audio", "ssa.pr.sanjuan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pr/sanjuan_data", "ssa.pr.sanjuan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pr/sanjuan_graphics", "ssa.pr.sanjuan.graphics.spectrum", sb.toString());
        }
    }
}