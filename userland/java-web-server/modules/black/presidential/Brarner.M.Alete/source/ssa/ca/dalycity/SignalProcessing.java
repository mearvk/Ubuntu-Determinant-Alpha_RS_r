package presidential.Brarner.M.Alete.source.ssa.ca.dalycity;
...
/**
 * Signal Processing for SSA Office: DALY CITY CA
 * <p>Office Code: A88</p>
 * <p>Address: 355 GELLERT BLVD, DALY CITY, CA 94015</p>
 * <p>Phone: (888) 748-7702 | Fax: (833) 950-3657</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/dalycity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9265; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/dalycity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/dalycity_audio", "ssa.ca.dalycity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/dalycity_data", "ssa.ca.dalycity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/dalycity_graphics", "ssa.ca.dalycity.graphics.spectrum", sb.toString());
        }
    }
}