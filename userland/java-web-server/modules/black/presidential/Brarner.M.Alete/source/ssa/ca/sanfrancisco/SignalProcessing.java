package presidential.Brarner.M.Alete.source.ssa.ca.sanfrancisco;
...
/**
 * Signal Processing for SSA Office: SF CHINATOWN CA
 * <p>Office Code: 252</p>
 * <p>Address: 560 KEARNY STREET, SAN FRANCISCO, CA 94108</p>
 * <p>Phone: (877) 319-3070 | Fax: (833) 950-3039</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sanfrancisco/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9707; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sanfrancisco";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanfrancisco_audio", "ssa.ca.sanfrancisco.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanfrancisco_data", "ssa.ca.sanfrancisco.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanfrancisco_graphics", "ssa.ca.sanfrancisco.graphics.spectrum", sb.toString());
        }
    }
}