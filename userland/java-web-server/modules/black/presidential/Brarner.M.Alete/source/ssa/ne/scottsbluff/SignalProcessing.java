package presidential.Brarner.M.Alete.source.ssa.ne.scottsbluff;
...
/**
 * Signal Processing for SSA Office: SCOTTSBLUFF NE
 * <p>Office Code: 729</p>
 * <p>Address: 415 VALLEY VIEW DR, SCOTTSBLUFF, NE 69361</p>
 * <p>Phone: (800) 297-4291 | Fax: (833) 902-2494</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ne/scottsbluff/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10134; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ne/scottsbluff";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ne/scottsbluff_audio", "ssa.ne.scottsbluff.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ne/scottsbluff_data", "ssa.ne.scottsbluff.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ne/scottsbluff_graphics", "ssa.ne.scottsbluff.graphics.spectrum", sb.toString());
        }
    }
}