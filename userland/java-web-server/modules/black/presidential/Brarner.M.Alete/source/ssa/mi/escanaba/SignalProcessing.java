package presidential.Brarner.M.Alete.source.ssa.mi.escanaba;
...
/**
 * Signal Processing for SSA Office: ESCANABA MI
 * <p>Office Code: 355</p>
 * <p>Address: 1013 1ST AVE NORTH, ESCANABA, MI 49829</p>
 * <p>Phone: (877) 545-5503 | Fax: (833) 950-2132</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/escanaba/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9802; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/escanaba";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/escanaba_audio", "ssa.mi.escanaba.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/escanaba_data", "ssa.mi.escanaba.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/escanaba_graphics", "ssa.mi.escanaba.graphics.spectrum", sb.toString());
        }
    }
}