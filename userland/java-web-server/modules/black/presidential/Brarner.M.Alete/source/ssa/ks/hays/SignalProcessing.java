package presidential.Brarner.M.Alete.source.ssa.ks.hays;
...
/**
 * Signal Processing for SSA Office: HAYS KS
 * <p>Office Code: 776</p>
 * <p>Address: 1212 E 27TH ST, HAYS, KS 67601</p>
 * <p>Phone: (888) 552-7176 | Fax: (833) 950-2632</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ks/hays/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10172; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ks/hays";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ks/hays_audio", "ssa.ks.hays.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ks/hays_data", "ssa.ks.hays.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ks/hays_graphics", "ssa.ks.hays.graphics.spectrum", sb.toString());
        }
    }
}