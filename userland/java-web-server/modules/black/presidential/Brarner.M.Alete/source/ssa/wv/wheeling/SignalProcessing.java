package presidential.Brarner.M.Alete.source.ssa.wv.wheeling;
...
/**
 * Signal Processing for SSA Office: WHEELING WV
 * <p>Office Code: 306</p>
 * <p>Address: 1231 WARWOOD AVENUE, WHEELING, WV 26003</p>
 * <p>Phone: (877) 480-5001 | Fax: (833) 950-2249</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/wheeling/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9756; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/wheeling";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/wheeling_audio", "ssa.wv.wheeling.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/wheeling_data", "ssa.wv.wheeling.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/wheeling_graphics", "ssa.wv.wheeling.graphics.spectrum", sb.toString());
        }
    }
}