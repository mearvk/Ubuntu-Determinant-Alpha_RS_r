package presidential.Brarner.M.Alete.source.ssa.wa.vancouver;
...
/**
 * Signal Processing for SSA Office: VANCOUVER WA
 * <p>Office Code: 923</p>
 * <p>Address: 805 BROADWAY ST, VANCOUVER, WA 98660</p>
 * <p>Phone: (866) 605-8967 | Fax: (833) 950-2618</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/vancouver/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10306; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/vancouver";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/vancouver_audio", "ssa.wa.vancouver.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/vancouver_data", "ssa.wa.vancouver.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/vancouver_graphics", "ssa.wa.vancouver.graphics.spectrum", sb.toString());
        }
    }
}