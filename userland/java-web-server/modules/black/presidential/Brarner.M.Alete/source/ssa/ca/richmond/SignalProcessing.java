package presidential.Brarner.M.Alete.source.ssa.ca.richmond;
...
/**
 * Signal Processing for SSA Office: RICHMOND CA
 * <p>Office Code: 383</p>
 * <p>Address: 3164 GARRITY WAY, RICHMOND, CA 94806</p>
 * <p>Phone: (877) 877-3116 | Fax: (833) 950-3043</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/richmond/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9824; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/richmond";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/richmond_audio", "ssa.ca.richmond.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/richmond_data", "ssa.ca.richmond.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/richmond_graphics", "ssa.ca.richmond.graphics.spectrum", sb.toString());
        }
    }
}