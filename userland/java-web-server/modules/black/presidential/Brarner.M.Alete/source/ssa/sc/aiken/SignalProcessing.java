package presidential.Brarner.M.Alete.source.ssa.sc.aiken;
...
/**
 * Signal Processing for SSA Office: AIKEN SC
 * <p>Office Code: 596</p>
 * <p>Address: 151 CORPORATE PKWY, AIKEN, SC 29803</p>
 * <p>Phone: (866) 275-8271 | Fax: (833) 950-2554</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/aiken/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10020; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/aiken";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/aiken_audio", "ssa.sc.aiken.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/aiken_data", "ssa.sc.aiken.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/aiken_graphics", "ssa.sc.aiken.graphics.spectrum", sb.toString());
        }
    }
}