package presidential.Brarner.M.Alete.source.ssa.mi.fortgratiot;
...
/**
 * Signal Processing for SSA Office: FORT GRATIOT
 * <p>Office Code: 362</p>
 * <p>Address: 2620 KRAFFT RD, FORT GRATIOT, MI 48059</p>
 * <p>Phone: (877) 895-0042 | Fax: (833) 950-2468</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/fortgratiot/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9809; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/fortgratiot";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/fortgratiot_audio", "ssa.mi.fortgratiot.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/fortgratiot_data", "ssa.mi.fortgratiot.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/fortgratiot_graphics", "ssa.mi.fortgratiot.graphics.spectrum", sb.toString());
        }
    }
}