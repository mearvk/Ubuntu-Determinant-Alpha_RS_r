package presidential.Brarner.M.Alete.source.ssa.tx.sanangelo;
...
/**
 * Signal Processing for SSA Office: SAN ANGELO TX
 * <p>Office Code: 822</p>
 * <p>Address: 40 W TWOHIG, SAN ANGELO, TX 76903</p>
 * <p>Phone: (877) 840-5742 | Fax: (833) 519-3213</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/sanangelo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10213; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/sanangelo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanangelo_audio", "ssa.tx.sanangelo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanangelo_data", "ssa.tx.sanangelo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanangelo_graphics", "ssa.tx.sanangelo.graphics.spectrum", sb.toString());
        }
    }
}