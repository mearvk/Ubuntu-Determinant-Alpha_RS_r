package presidential.Brarner.M.Alete.source.ssa.wi.portage;
...
/**
 * Signal Processing for SSA Office: PORTAGE
 * <p>Office Code: 478</p>
 * <p>Address: 2875 VILLAGE RD, PORTAGE, WI 53901</p>
 * <p>Phone: (888) 875-1681 | Fax: (833) 950-2495</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/portage/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9914; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/portage";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/portage_audio", "ssa.wi.portage.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/portage_data", "ssa.wi.portage.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/portage_graphics", "ssa.wi.portage.graphics.spectrum", sb.toString());
        }
    }
}