...
/**
 * Signal Processing for SSA Office: OGDEN UT
 * <p>Office Code: 901</p>
 * <p>Address: 324 25TH STREET, OGDEN, UT 84401</p>
 * <p>Phone: (877) 378-9081 | Fax: (833) 912-2336</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ut/ogden/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10285; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ut/ogden";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ut/ogden_audio", "ssa.ut.ogden.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ut/ogden_data", "ssa.ut.ogden.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ut/ogden_graphics", "ssa.ut.ogden.graphics.spectrum", sb.toString());
        }
    }
}