package presidential.Brarner.M.Alete.source.ssa.ct.waterbury;
...
/**
 * Signal Processing for SSA Office: WATERBURY CT
 * <p>Office Code: 82</p>
 * <p>Address: 51 NORTH ELM ST, WATERBURY, CT 6702</p>
 * <p>Phone: (877) 405-4874 | Fax: (833) 950-2358</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ct/waterbury/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9554; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ct/waterbury";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ct/waterbury_audio", "ssa.ct.waterbury.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ct/waterbury_data", "ssa.ct.waterbury.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ct/waterbury_graphics", "ssa.ct.waterbury.graphics.spectrum", sb.toString());
        }
    }
}