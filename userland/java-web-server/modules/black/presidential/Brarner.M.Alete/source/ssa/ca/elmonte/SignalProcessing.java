package presidential.Brarner.M.Alete.source.ssa.ca.elmonte;
...
/**
 * Signal Processing for SSA Office: EL MONTE CA
 * <p>Office Code: 384</p>
 * <p>Address: 9351 TELSTAR AVE., EL MONTE, CA 91731</p>
 * <p>Phone: (866) 931-0340 | Fax: (833) 950-3045</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/elmonte/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9825; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/elmonte";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/elmonte_audio", "ssa.ca.elmonte.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/elmonte_data", "ssa.ca.elmonte.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/elmonte_graphics", "ssa.ca.elmonte.graphics.spectrum", sb.toString());
        }
    }
}