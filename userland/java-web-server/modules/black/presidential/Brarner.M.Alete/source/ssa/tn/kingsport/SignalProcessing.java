package presidential.Brarner.M.Alete.source.ssa.tn.kingsport;
...
/**
 * Signal Processing for SSA Office: KINGSPORT TN
 * <p>Office Code: 579</p>
 * <p>Address: 2401 SOUTH WILCOX DR, KINGSPORT, TN 37660</p>
 * <p>Phone: (888) 487-0161 | Fax: (833) 905-2064</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/kingsport/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10003; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/kingsport";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/kingsport_audio", "ssa.tn.kingsport.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/kingsport_data", "ssa.tn.kingsport.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/kingsport_graphics", "ssa.tn.kingsport.graphics.spectrum", sb.toString());
        }
    }
}