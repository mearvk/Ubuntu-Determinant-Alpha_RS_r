package presidential.Brarner.M.Alete.source.ssa.mo.kennett;
...
/**
 * Signal Processing for SSA Office: KENNETT MO
 * <p>Office Code: 752</p>
 * <p>Address: 800 SOUTH BYPASS, KENNETT, MO 63857</p>
 * <p>Phone: (866) 931-4497 | Fax: (833) 950-2324</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/kennett/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10151; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/kennett";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kennett_audio", "ssa.mo.kennett.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kennett_data", "ssa.mo.kennett.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kennett_graphics", "ssa.mo.kennett.graphics.spectrum", sb.toString());
        }
    }
}