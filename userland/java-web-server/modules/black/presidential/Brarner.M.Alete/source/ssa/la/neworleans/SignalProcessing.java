...
/**
 * Signal Processing for SSA Office: NEW ORLEANS DWNTWN LA
 * <p>Office Code: 800</p>
 * <p>Address: 400 POYDRAS STREET, NEW ORLEANS, LA 70130</p>
 * <p>Phone: (855) 257-0984 | Fax: (833) 950-3349</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/neworleans/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10192; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/neworleans";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/neworleans_audio", "ssa.la.neworleans.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/neworleans_data", "ssa.la.neworleans.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/neworleans_graphics", "ssa.la.neworleans.graphics.spectrum", sb.toString());
        }
    }
}