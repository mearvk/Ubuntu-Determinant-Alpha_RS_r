...
/**
 * Signal Processing for SSA Office: NEWNAN GA
 * <p>Office Code: I15</p>
 * <p>Address: 246 BULLSBORO DR, NEWNAN, GA 30263</p>
 * <p>Phone: (855) 863-3561 | Fax: (833) 905-2050</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/newnan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9482; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/newnan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/newnan_audio", "ssa.ga.newnan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/newnan_data", "ssa.ga.newnan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/newnan_graphics", "ssa.ga.newnan.graphics.spectrum", sb.toString());
        }
    }
}