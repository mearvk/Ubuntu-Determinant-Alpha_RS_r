package presidential.Brarner.M.Alete.source.ssa.tx.houston004;
...
/**
 * Signal Processing for SSA Office: HOUSTON SOUTHEAST TX
 * <p>Office Code: 857</p>
 * <p>Address: 8989 LAKES AT 610 DR, HOUSTON, TX 77054</p>
 * <p>Phone: (866) 404-1861 | Fax: (833) 950-2716</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/houston004/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10245; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/houston004";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/houston004_audio", "ssa.tx.houston004.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/houston004_data", "ssa.tx.houston004.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/houston004_graphics", "ssa.tx.houston004.graphics.spectrum", sb.toString());
        }
    }
}