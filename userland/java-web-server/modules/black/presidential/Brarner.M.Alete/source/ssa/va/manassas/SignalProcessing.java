package presidential.Brarner.M.Alete.source.ssa.va.manassas;
...
/**
 * Signal Processing for SSA Office: MANASSAS VA
 * <p>Office Code: A39</p>
 * <p>Address: 9500 CENTER STREET, MANASSAS, VA 20110</p>
 * <p>Phone: (855) 210-0123 | Fax: (833) 612-0144</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/manassas/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9225; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/manassas";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/manassas_audio", "ssa.va.manassas.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/manassas_data", "ssa.va.manassas.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/manassas_graphics", "ssa.va.manassas.graphics.spectrum", sb.toString());
        }
    }
}