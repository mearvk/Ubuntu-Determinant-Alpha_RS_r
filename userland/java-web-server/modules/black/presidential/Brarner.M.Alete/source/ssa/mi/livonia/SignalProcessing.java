package presidential.Brarner.M.Alete.source.ssa.mi.livonia;
...
/**
 * Signal Processing for SSA Office: LIVONIA MI
 * <p>Office Code: D09</p>
 * <p>Address: 34010 PLYMOUTH ROAD, LIVONIA, MI 48150</p>
 * <p>Phone: (866) 964-7371 | Fax: (833) 580-0159</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/livonia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9406; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/livonia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/livonia_audio", "ssa.mi.livonia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/livonia_data", "ssa.mi.livonia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/livonia_graphics", "ssa.mi.livonia.graphics.spectrum", sb.toString());
        }
    }
}