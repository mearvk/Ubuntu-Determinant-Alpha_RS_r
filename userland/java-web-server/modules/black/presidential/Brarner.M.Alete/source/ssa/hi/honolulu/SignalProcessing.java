package presidential.Brarner.M.Alete.source.ssa.hi.honolulu;
...
/**
 * Signal Processing for SSA Office: HONOLULU HI
 * <p>Office Code: 990</p>
 * <p>Address: 300 ALA MOANA BLVD, HONOLULU, HI 96850</p>
 * <p>Phone: (855) 572-4879 | Fax: (833) 950-2764</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/hi/honolulu/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10371; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/hi/honolulu";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_hi/honolulu_audio", "ssa.hi.honolulu.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_hi/honolulu_data", "ssa.hi.honolulu.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_hi/honolulu_graphics", "ssa.hi.honolulu.graphics.spectrum", sb.toString());
        }
    }
}