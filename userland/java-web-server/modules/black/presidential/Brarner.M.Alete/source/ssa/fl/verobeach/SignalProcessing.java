package presidential.Brarner.M.Alete.source.ssa.fl.verobeach;
...
/**
 * Signal Processing for SSA Office: VERO BEACH FL
 * <p>Office Code: B21</p>
 * <p>Address: 724 20TH ST, VERO BEACH, FL 32960</p>
 * <p>Phone: (866) 964-7414 | Fax: (833) 950-3453</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/verobeach/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9291; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/verobeach";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/verobeach_audio", "ssa.fl.verobeach.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/verobeach_data", "ssa.fl.verobeach.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/verobeach_graphics", "ssa.fl.verobeach.graphics.spectrum", sb.toString());
        }
    }
}