...
/**
 * Signal Processing for SSA Office: CARROLL IA
 * <p>Office Code: 701</p>
 * <p>Address: 818 BELLA VISTA DR, CARROLL, IA 51401</p>
 * <p>Phone: (866) 572-8381 | Fax: (833) 515-0441</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/carroll/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10115; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/carroll";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/carroll_audio", "ssa.ia.carroll.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/carroll_data", "ssa.ia.carroll.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/carroll_graphics", "ssa.ia.carroll.graphics.spectrum", sb.toString());
        }
    }
}