...
/**
 * Signal Processing for SSA Office: L.A. WESTWOOD CA
 * <p>Office Code: 970</p>
 * <p>Address: 11500 W OLYMPIC BLVD, LOS ANGELES, CA 90064</p>
 * <p>Phone: (866) 964-4779 | Fax: (833) 950-2114</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/losangeles007/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10352; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/losangeles007";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles007_audio", "ssa.ca.losangeles007.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles007_data", "ssa.ca.losangeles007.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles007_graphics", "ssa.ca.losangeles007.graphics.spectrum", sb.toString());
        }
    }
}