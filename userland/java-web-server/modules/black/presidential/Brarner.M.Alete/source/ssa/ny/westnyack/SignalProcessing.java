...
/**
 * Signal Processing for SSA Office: WEST NYACK NY
 * <p>Office Code: 149</p>
 * <p>Address: 240 WEST NYACK ROAD, WEST NYACK, NY 10994</p>
 * <p>Phone: (866) 755-4334 | Fax: (833) 950-2378</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/westnyack/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9617; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/westnyack";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/westnyack_audio", "ssa.ny.westnyack.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/westnyack_data", "ssa.ny.westnyack.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/westnyack_graphics", "ssa.ny.westnyack.graphics.spectrum", sb.toString());
        }
    }
}