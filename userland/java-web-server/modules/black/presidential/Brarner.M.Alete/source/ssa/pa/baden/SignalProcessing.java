package presidential.Brarner.M.Alete.source.ssa.pa.baden;
...
/**
 * Signal Processing for SSA Office: AMBRIDGE PA
 * <p>Office Code: 222</p>
 * <p>Address: 350 LOGAN LN, BADEN, PA 15005</p>
 * <p>Phone: (866) 331-6401 | Fax: (833) 950-3527</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/baden/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9680; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/baden";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/baden_audio", "ssa.pa.baden.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/baden_data", "ssa.pa.baden.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/baden_graphics", "ssa.pa.baden.graphics.spectrum", sb.toString());
        }
    }
}