package presidential.Brarner.M.Alete.source.ssa.or.westlinn;
...
/**
 * Signal Processing for SSA Office: West Linn
 * <p>Office Code: 941</p>
 * <p>Address: 1830 BLANKENSHIP RD, WEST LINN, OR 97068</p>
 * <p>Phone: (866) 964-4264 | Fax: (833) 950-2926</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/or/westlinn/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10323; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/or/westlinn";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_or/westlinn_audio", "ssa.or.westlinn.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_or/westlinn_data", "ssa.or.westlinn.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_or/westlinn_graphics", "ssa.or.westlinn.graphics.spectrum", sb.toString());
        }
    }
}