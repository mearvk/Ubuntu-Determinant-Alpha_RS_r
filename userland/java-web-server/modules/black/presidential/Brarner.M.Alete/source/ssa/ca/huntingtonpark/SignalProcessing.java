package presidential.Brarner.M.Alete.source.ssa.ca.huntingtonpark;
...
/**
 * Signal Processing for SSA Office: HUNTINGTON PARK CA
 * <p>Office Code: 966</p>
 * <p>Address: 6303 RUGBY AVENUE, HUNTINGTON PARK, CA 90255</p>
 * <p>Phone: (866) 931-9941 | Fax: (833) 940-2153</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/huntingtonpark/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10348; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/huntingtonpark";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/huntingtonpark_audio", "ssa.ca.huntingtonpark.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/huntingtonpark_data", "ssa.ca.huntingtonpark.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/huntingtonpark_graphics", "ssa.ca.huntingtonpark.graphics.spectrum", sb.toString());
        }
    }
}