package presidential.Brarner.M.Alete.source.ssa.fl.sebring;
...
/**
 * Signal Processing for SSA Office: SEBRING FL
 * <p>Office Code: B13</p>
 * <p>Address: 3700 COMMERCIAL DRIVE, SEBRING, FL 33870</p>
 * <p>Phone: (877) 405-0415 | Fax: (833) 950-3123</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/sebring/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9284; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/sebring";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/sebring_audio", "ssa.fl.sebring.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/sebring_data", "ssa.fl.sebring.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/sebring_graphics", "ssa.fl.sebring.graphics.spectrum", sb.toString());
        }
    }
}