package presidential.Brarner.M.Alete.source.ssa.in.terrehaute;
...
/**
 * Signal Processing for SSA Office: TERRE HAUTE IN
 * <p>Office Code: 458</p>
 * <p>Address: 222 CHERRY ST, TERRE HAUTE, IN 47807</p>
 * <p>Phone: (866) 635-0282 | Fax: (833) 902-2672</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/terrehaute/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9895; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/terrehaute";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/terrehaute_audio", "ssa.in.terrehaute.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/terrehaute_data", "ssa.in.terrehaute.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/terrehaute_graphics", "ssa.in.terrehaute.graphics.spectrum", sb.toString());
        }
    }
}