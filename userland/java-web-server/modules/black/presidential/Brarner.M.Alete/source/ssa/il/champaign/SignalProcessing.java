package presidential.Brarner.M.Alete.source.ssa.il.champaign;
...
/**
 * Signal Processing for SSA Office: CHAMPAIGN IL
 * <p>Office Code: 501</p>
 * <p>Address: 101 S COUNTRY FAIR DR, CHAMPAIGN, IL 61821</p>
 * <p>Phone: (877) 819-2593 | Fax: (833) 950-2810</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/champaign/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9936; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/champaign";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/champaign_audio", "ssa.il.champaign.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/champaign_data", "ssa.il.champaign.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/champaign_graphics", "ssa.il.champaign.graphics.spectrum", sb.toString());
        }
    }
}