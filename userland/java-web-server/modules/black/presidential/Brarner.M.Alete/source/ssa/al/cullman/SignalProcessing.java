...
/**
 * Signal Processing for SSA Office: CULLMAN AL
 * <p>Office Code: A21</p>
 * <p>Address: 1908 COMMERCE AVE NW, CULLMAN, AL 35055</p>
 * <p>Phone: (877) 803-6323 | Fax: (833) 950-2516</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/cullman/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9211; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/cullman";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/cullman_audio", "ssa.al.cullman.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/cullman_data", "ssa.al.cullman.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/cullman_graphics", "ssa.al.cullman.graphics.spectrum", sb.toString());
        }
    }
}