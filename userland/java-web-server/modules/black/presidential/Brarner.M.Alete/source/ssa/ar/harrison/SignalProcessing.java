package presidential.Brarner.M.Alete.source.ssa.ar.harrison;
...
/**
 * Signal Processing for SSA Office: HARRISON AR
 * <p>Office Code: A67</p>
 * <p>Address: 131 W INDUSTRIAL PK RD, HARRISON, AR 72601</p>
 * <p>Phone: (877) 512-3851 | Fax: (833) 902-2564</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/harrison/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9248; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/harrison";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/harrison_audio", "ssa.ar.harrison.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/harrison_data", "ssa.ar.harrison.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/harrison_graphics", "ssa.ar.harrison.graphics.spectrum", sb.toString());
        }
    }
}