package presidential.Brarner.M.Alete.source.ssa.il.galesburg;
...
/**
 * Signal Processing for SSA Office: GALESBURG IL
 * <p>Office Code: 505</p>
 * <p>Address: 2060 WINDISH DRIVE, GALESBURG, IL 61401</p>
 * <p>Phone: (877) 405-7659 | Fax: (833) 950-3103</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/galesburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9940; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/galesburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/galesburg_audio", "ssa.il.galesburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/galesburg_data", "ssa.il.galesburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/galesburg_graphics", "ssa.il.galesburg.graphics.spectrum", sb.toString());
        }
    }
}