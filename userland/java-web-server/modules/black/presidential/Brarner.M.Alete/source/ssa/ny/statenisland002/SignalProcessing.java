package presidential.Brarner.M.Alete.source.ssa.ny.statenisland002;
...
/**
 * Signal Processing for SSA Office: STATEN ISLAND NY
 * <p>Office Code: 121</p>
 * <p>Address: 1441 SOUTH AVE, STATEN ISLAND, NY 10314</p>
 * <p>Phone: (866) 331-5288 | Fax: (833) 902-2534</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/statenisland002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9592; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/statenisland002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/statenisland002_audio", "ssa.ny.statenisland002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/statenisland002_data", "ssa.ny.statenisland002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/statenisland002_graphics", "ssa.ny.statenisland002.graphics.spectrum", sb.toString());
        }
    }
}