package presidential.Brarner.M.Alete.source.ssa.nc.winstonsalem;
...
/**
 * Signal Processing for SSA Office: WINSTON SALEM NC
 * <p>Office Code: 324</p>
 * <p>Address: 1370 LOCKLAND AVE, WINSTON SALEM, NC 27103</p>
 * <p>Phone: (877) 402-0828 | Fax: (833) 950-2544</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/winstonsalem/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9773; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/winstonsalem";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/winstonsalem_audio", "ssa.nc.winstonsalem.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/winstonsalem_data", "ssa.nc.winstonsalem.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/winstonsalem_graphics", "ssa.nc.winstonsalem.graphics.spectrum", sb.toString());
        }
    }
}