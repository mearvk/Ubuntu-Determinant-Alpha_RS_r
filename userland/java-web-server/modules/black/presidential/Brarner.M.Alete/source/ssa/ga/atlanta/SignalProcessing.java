package presidential.Brarner.M.Alete.source.ssa.ga.atlanta;
...
/**
 * Signal Processing for SSA Office: ATLANTA-D/T GA
 * <p>Office Code: 600</p>
 * <p>Address: 401 W PEACHTREE ST NW, ATLANTA, GA 30308</p>
 * <p>Phone: (866) 931-9946 | Fax: (833) 950-2558</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/atlanta/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10023; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/atlanta";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/atlanta_audio", "ssa.ga.atlanta.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/atlanta_data", "ssa.ga.atlanta.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/atlanta_graphics", "ssa.ga.atlanta.graphics.spectrum", sb.toString());
        }
    }
}