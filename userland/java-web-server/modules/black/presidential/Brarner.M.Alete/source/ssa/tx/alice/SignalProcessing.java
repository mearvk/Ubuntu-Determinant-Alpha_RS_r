...
/**
 * Signal Processing for SSA Office: ALICE TX
 * <p>Office Code: 874</p>
 * <p>Address: 1000 MEDICAL CTR BLVD, ALICE, TX 78332</p>
 * <p>Phone: (888) 388-8744 | Fax: (833) 950-3019</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/alice/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10261; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/alice";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/alice_audio", "ssa.tx.alice.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/alice_data", "ssa.tx.alice.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/alice_graphics", "ssa.tx.alice.graphics.spectrum", sb.toString());
        }
    }
}