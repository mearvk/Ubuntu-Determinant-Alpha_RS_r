package presidential.Brarner.M.Alete.source.ssa.ca.torrance;
...
/**
 * Signal Processing for SSA Office: TORRANCE CA
 * <p>Office Code: 983</p>
 * <p>Address: 20000 MARINER AVE STE 150, TORRANCE, CA 90503</p>
 * <p>Phone: (877) 319-0732 | Fax: (833) 950-2460</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/torrance/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10364; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/torrance";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/torrance_audio", "ssa.ca.torrance.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/torrance_data", "ssa.ca.torrance.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/torrance_graphics", "ssa.ca.torrance.graphics.spectrum", sb.toString());
        }
    }
}