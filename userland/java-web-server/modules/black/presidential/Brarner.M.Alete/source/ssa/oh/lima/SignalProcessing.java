package presidential.Brarner.M.Alete.source.ssa.oh.lima;
...
/**
 * Signal Processing for SSA Office: LIMA OH
 * <p>Office Code: 394</p>
 * <p>Address: 401 WEST NORTH ST, LIMA, OH 45801</p>
 * <p>Phone: (800) 223-0288 | Fax: (833) 950-3089</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/lima/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9835; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/lima";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/lima_audio", "ssa.oh.lima.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/lima_data", "ssa.oh.lima.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/lima_graphics", "ssa.oh.lima.graphics.spectrum", sb.toString());
        }
    }
}