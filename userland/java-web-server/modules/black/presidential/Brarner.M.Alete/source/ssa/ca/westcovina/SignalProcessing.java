package presidential.Brarner.M.Alete.source.ssa.ca.westcovina;
...
/**
 * Signal Processing for SSA Office: WEST COVINA CA
 * <p>Office Code: 943</p>
 * <p>Address: 501 S VINCENT AVE, WEST COVINA, CA 91790</p>
 * <p>Phone: (866) 964-0162 | Fax: (833) 571-2611</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/westcovina/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10325; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/westcovina";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/westcovina_audio", "ssa.ca.westcovina.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/westcovina_data", "ssa.ca.westcovina.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/westcovina_graphics", "ssa.ca.westcovina.graphics.spectrum", sb.toString());
        }
    }
}