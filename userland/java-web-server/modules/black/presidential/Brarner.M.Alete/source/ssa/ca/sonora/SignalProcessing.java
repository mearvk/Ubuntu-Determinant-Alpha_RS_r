package presidential.Brarner.M.Alete.source.ssa.ca.sonora;
...
/**
 * Signal Processing for SSA Office: SONORA CA
 * <p>Office Code: 480</p>
 * <p>Address: 745 MORNING STAR DRIVE, SONORA, CA 95370</p>
 * <p>Phone: (888) 397-4125 | Fax: (833) 950-3375</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sonora/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9915; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sonora";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sonora_audio", "ssa.ca.sonora.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sonora_data", "ssa.ca.sonora.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sonora_graphics", "ssa.ca.sonora.graphics.spectrum", sb.toString());
        }
    }
}