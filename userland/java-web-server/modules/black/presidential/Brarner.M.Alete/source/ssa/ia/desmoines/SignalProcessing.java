package presidential.Brarner.M.Alete.source.ssa.ia.desmoines;
...
/**
 * Signal Processing for SSA Office: DES MOINES IA
 * <p>Office Code: 690</p>
 * <p>Address: 455 SW 5TH ST, DES MOINES, IA 50309</p>
 * <p>Phone: (866) 964-7583 | Fax: (833) 950-3567</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/desmoines/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10104; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/desmoines";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/desmoines_audio", "ssa.ia.desmoines.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/desmoines_data", "ssa.ia.desmoines.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/desmoines_graphics", "ssa.ia.desmoines.graphics.spectrum", sb.toString());
        }
    }
}