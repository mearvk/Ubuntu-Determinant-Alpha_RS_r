package presidential.Brarner.M.Alete.source.ssa.ny.syracuse;
...
/**
 * Signal Processing for SSA Office: SYRACUSE NY
 * <p>Office Code: 101</p>
 * <p>Address: 100 S CLINTON ST, SYRACUSE, NY 13261</p>
 * <p>Phone: (866) 755-4884 | Fax: (833) 950-3601</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/syracuse/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9572; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/syracuse";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/syracuse_audio", "ssa.ny.syracuse.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/syracuse_data", "ssa.ny.syracuse.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/syracuse_graphics", "ssa.ny.syracuse.graphics.spectrum", sb.toString());
        }
    }
}