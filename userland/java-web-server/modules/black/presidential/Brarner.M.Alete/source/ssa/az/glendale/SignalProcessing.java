package presidential.Brarner.M.Alete.source.ssa.az.glendale;
...
/**
 * Signal Processing for SSA Office: GLENDALE AZ
 * <p>Office Code: 914</p>
 * <p>Address: 5907 W KINGS AVE, GLENDALE, AZ 85306</p>
 * <p>Phone: (888) 886-7213 | Fax: (833) 950-3685</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/az/glendale/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10297; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/az/glendale";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_az/glendale_audio", "ssa.az.glendale.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_az/glendale_data", "ssa.az.glendale.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_az/glendale_graphics", "ssa.az.glendale.graphics.spectrum", sb.toString());
        }
    }
}