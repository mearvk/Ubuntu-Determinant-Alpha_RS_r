package presidential.Brarner.M.Alete.source.ssa.ca.hemet;
...
/**
 * Signal Processing for SSA Office: HEMET CA
 * <p>Office Code: 906</p>
 * <p>Address: 3095 W DEVONSHIRE AVE, HEMET, CA 92545</p>
 * <p>Phone: (855) 207-7083 | Fax: (833) 950-3391</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/hemet/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10289; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/hemet";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/hemet_audio", "ssa.ca.hemet.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/hemet_data", "ssa.ca.hemet.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/hemet_graphics", "ssa.ca.hemet.graphics.spectrum", sb.toString());
        }
    }
}