package presidential.Brarner.M.Alete.source.ssa.mo.independence;
...
/**
 * Signal Processing for SSA Office: INDEPENDENCE MO
 * <p>Office Code: 748</p>
 * <p>Address: 3520 S NOLAND RD, INDEPENDENCE, MO 64055</p>
 * <p>Phone: (866) 864-1517 | Fax: (833) 926-1833</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/independence/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10147; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/independence";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/independence_audio", "ssa.mo.independence.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/independence_data", "ssa.mo.independence.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/independence_graphics", "ssa.mo.independence.graphics.spectrum", sb.toString());
        }
    }
}