package presidential.Brarner.M.Alete.source.ssa.tx.bigspring;
...
/**
 * Signal Processing for SSA Office: BIG SPRING TX
 * <p>Office Code: 832</p>
 * <p>Address: 501 BIRDWELL LN, BIG SPRING, TX 79720</p>
 * <p>Phone: (888) 748-2018 | Fax: (833) 902-2592</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/bigspring/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10223; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/bigspring";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/bigspring_audio", "ssa.tx.bigspring.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/bigspring_data", "ssa.tx.bigspring.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/bigspring_graphics", "ssa.tx.bigspring.graphics.spectrum", sb.toString());
        }
    }
}