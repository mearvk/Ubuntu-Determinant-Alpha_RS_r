package presidential.Brarner.M.Alete.source.ssa.co.pueblo;
...
/**
 * Signal Processing for SSA Office: PUEBLO CO
 * <p>Office Code: 883</p>
 * <p>Address: 3769 PARKER BLVD, PUEBLO, CO 81008</p>
 * <p>Phone: (888) 737-1761 | Fax: (833) 612-0148</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/co/pueblo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10269; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/co/pueblo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_co/pueblo_audio", "ssa.co.pueblo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_co/pueblo_data", "ssa.co.pueblo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_co/pueblo_graphics", "ssa.co.pueblo.graphics.spectrum", sb.toString());
        }
    }
}