...
/**
 * Signal Processing for SSA Office: DANBURY CT
 * <p>Office Code: 90</p>
 * <p>Address: 131 WEST ST, DANBURY, CT 6810</p>
 * <p>Phone: (866) 275-7821 | Fax: (833) 950-2664</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ct/danbury/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9562; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ct/danbury";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ct/danbury_audio", "ssa.ct.danbury.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ct/danbury_data", "ssa.ct.danbury.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ct/danbury_graphics", "ssa.ct.danbury.graphics.spectrum", sb.toString());
        }
    }
}