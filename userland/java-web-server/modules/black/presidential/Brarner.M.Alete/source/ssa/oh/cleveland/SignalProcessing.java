...
/**
 * Signal Processing for SSA Office: CLEVELAND DT OH
 * <p>Office Code: 388</p>
 * <p>Address: 1240 E 9TH ST, CLEVELAND, OH 44199</p>
 * <p>Phone: (877) 378-9078 | Fax: (833) 950-3077</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/cleveland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9829; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/cleveland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cleveland_audio", "ssa.oh.cleveland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cleveland_data", "ssa.oh.cleveland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cleveland_graphics", "ssa.oh.cleveland.graphics.spectrum", sb.toString());
        }
    }
}