package presidential.Brarner.M.Alete.source.ssa.ca.sacramento003;
...
/**
 * Signal Processing for SSA Office: SACRAMENTO CA
 * <p>Office Code: 955</p>
 * <p>Address: 8581 FOLSOM BLVD, SACRAMENTO, CA 95826</p>
 * <p>Phone: (877) 274-5419 | Fax: (833) 902-2620</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sacramento003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10337; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sacramento003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sacramento003_audio", "ssa.ca.sacramento003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sacramento003_data", "ssa.ca.sacramento003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sacramento003_graphics", "ssa.ca.sacramento003.graphics.spectrum", sb.toString());
        }
    }
}