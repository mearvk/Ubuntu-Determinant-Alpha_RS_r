package presidential.Brarner.M.Alete.source.ssa.ny.jamaica;
...
/**
 * Signal Processing for SSA Office: JAMAICA NY
 * <p>Office Code: 120</p>
 * <p>Address: 155-10 JAMAICA AVE, JAMAICA, NY 11432</p>
 * <p>Phone: (866) 592-0802 | Fax: (833) 902-2532</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/jamaica/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9591; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/jamaica";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/jamaica_audio", "ssa.ny.jamaica.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/jamaica_data", "ssa.ny.jamaica.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/jamaica_graphics", "ssa.ny.jamaica.graphics.spectrum", sb.toString());
        }
    }
}