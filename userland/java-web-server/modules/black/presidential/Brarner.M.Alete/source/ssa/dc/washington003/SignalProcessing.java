package presidential.Brarner.M.Alete.source.ssa.dc.washington003;
...
/**
 * Signal Processing for SSA Office: ANACOSTIA DC
 * <p>Office Code: 531</p>
 * <p>Address: 2041 MLK JR AVE SE, WASHINGTON, DC 20020</p>
 * <p>Phone: (866) 495-0048 | Fax: (833) 950-2892</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/dc/washington003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9962; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/dc/washington003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_dc/washington003_audio", "ssa.dc.washington003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_dc/washington003_data", "ssa.dc.washington003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_dc/washington003_graphics", "ssa.dc.washington003.graphics.spectrum", sb.toString());
        }
    }
}