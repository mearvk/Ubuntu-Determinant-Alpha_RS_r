package presidential.Brarner.M.Alete.source.ssa.va.hampton;
...
/**
 * Signal Processing for SSA Office: HAMPTON VA
 * <p>Office Code: C81</p>
 * <p>Address: 1521 HARDY CASH DR, HAMPTON, VA 23666</p>
 * <p>Phone: (866) 592-2669 | Fax: (833) 912-2322</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/hampton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9386; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/hampton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/hampton_audio", "ssa.va.hampton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/hampton_data", "ssa.va.hampton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/hampton_graphics", "ssa.va.hampton.graphics.spectrum", sb.toString());
        }
    }
}