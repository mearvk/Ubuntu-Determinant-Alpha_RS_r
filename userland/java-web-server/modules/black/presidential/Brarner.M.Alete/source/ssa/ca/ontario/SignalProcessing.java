...
/**
 * Signal Processing for SSA Office: ONTARIO CA
 * <p>Office Code: 476</p>
 * <p>Address: 1100 E HOLT BLVD, ONTARIO, CA 91761</p>
 * <p>Phone: (866) 331-2216 | Fax: (833) 950-3373</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/ontario/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9913; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/ontario";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/ontario_audio", "ssa.ca.ontario.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/ontario_data", "ssa.ca.ontario.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/ontario_graphics", "ssa.ca.ontario.graphics.spectrum", sb.toString());
        }
    }
}