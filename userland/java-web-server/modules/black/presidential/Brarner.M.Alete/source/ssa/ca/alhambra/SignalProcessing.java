package presidential.Brarner.M.Alete.source.ssa.ca.alhambra;
...
/**
 * Signal Processing for SSA Office: ALHAMBRA CA
 * <p>Office Code: D46</p>
 * <p>Address: 555 W MAIN ST, ALHAMBRA, CA 91801</p>
 * <p>Phone: (866) 227-6561 | Fax: (833) 902-2602</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/alhambra/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9428; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/alhambra";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/alhambra_audio", "ssa.ca.alhambra.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/alhambra_data", "ssa.ca.alhambra.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/alhambra_graphics", "ssa.ca.alhambra.graphics.spectrum", sb.toString());
        }
    }
}