package presidential.Brarner.M.Alete.source.ssa.az.showlow;
...
/**
 * Signal Processing for SSA Office: SHOW LOW AZ
 * <p>Office Code: I60</p>
 * <p>Address: 2500 E COOLEY ST, SHOW LOW, AZ 85901</p>
 * <p>Phone: (877) 850-7831 | Fax: (833) 940-2145</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/az/showlow/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9483; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/az/showlow";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_az/showlow_audio", "ssa.az.showlow.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_az/showlow_data", "ssa.az.showlow.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_az/showlow_graphics", "ssa.az.showlow.graphics.spectrum", sb.toString());
        }
    }
}