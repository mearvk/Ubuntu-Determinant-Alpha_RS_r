package presidential.Brarner.M.Alete.source.ssa.ky.mayfield;
...
/**
 * Signal Processing for SSA Office: MAYFIELD KY
 * <p>Office Code: B27</p>
 * <p>Address: 1526 CUBA ROAD, MAYFIELD, KY 42066</p>
 * <p>Phone: (866) 931-8366 | Fax: (833) 950-3461</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/mayfield/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9294; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/mayfield";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/mayfield_audio", "ssa.ky.mayfield.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/mayfield_data", "ssa.ky.mayfield.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/mayfield_graphics", "ssa.ky.mayfield.graphics.spectrum", sb.toString());
        }
    }
}