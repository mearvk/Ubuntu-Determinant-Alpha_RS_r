package presidential.Brarner.M.Alete.source.ssa.in.columbus;
...
/**
 * Signal Processing for SSA Office: COLUMBUS IN
 * <p>Office Code: 473</p>
 * <p>Address: 2535 ARNOLD STREET, COLUMBUS, IN 47203</p>
 * <p>Phone: (866) 755-0990 | Fax: (833) 950-2162</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/columbus/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9910; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/columbus";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/columbus_audio", "ssa.in.columbus.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/columbus_data", "ssa.in.columbus.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/columbus_graphics", "ssa.in.columbus.graphics.spectrum", sb.toString());
        }
    }
}