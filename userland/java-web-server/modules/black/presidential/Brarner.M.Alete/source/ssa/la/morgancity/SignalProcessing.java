package presidential.Brarner.M.Alete.source.ssa.la.morgancity;
...
/**
 * Signal Processing for SSA Office: MORGAN CITY LA
 * <p>Office Code: 812</p>
 * <p>Address: 1279 CLOTHILDE ST, MORGAN CITY, LA 70380</p>
 * <p>Phone: (855) 433-5874 | Fax: (833) 950-3651</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/morgancity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10203; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/morgancity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/morgancity_audio", "ssa.la.morgancity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/morgancity_data", "ssa.la.morgancity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/morgancity_graphics", "ssa.la.morgancity.graphics.spectrum", sb.toString());
        }
    }
}