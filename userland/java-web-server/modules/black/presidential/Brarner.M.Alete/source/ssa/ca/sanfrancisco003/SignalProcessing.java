package presidential.Brarner.M.Alete.source.ssa.ca.sanfrancisco003;
...
/**
 * Signal Processing for SSA Office: SF DOWNTOWN CA
 * <p>Office Code: 950</p>
 * <p>Address: 90 7TH ST, SAN FRANCISCO, CA 94103</p>
 * <p>Phone: (866) 964-5051 | Fax: (833) 571-2681</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sanfrancisco003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10332; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sanfrancisco003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanfrancisco003_audio", "ssa.ca.sanfrancisco003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanfrancisco003_data", "ssa.ca.sanfrancisco003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanfrancisco003_graphics", "ssa.ca.sanfrancisco003.graphics.spectrum", sb.toString());
        }
    }
}