package presidential.Brarner.M.Alete.source.ssa.il.chicago005;
...
/**
 * Signal Processing for SSA Office: CHICAGO NORTH IL
 * <p>Office Code: 499</p>
 * <p>Address: 2127 W LAWRENCE AVE, CHICAGO, IL 60625</p>
 * <p>Phone: (877) 409-8426 | Fax: (833) 950-2806</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/chicago005/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9934; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/chicago005";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago005_audio", "ssa.il.chicago005.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago005_data", "ssa.il.chicago005.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago005_graphics", "ssa.il.chicago005.graphics.spectrum", sb.toString());
        }
    }
}