package presidential.Brarner.M.Alete.source.ssa.ne.northplatte;
...
/**
 * Signal Processing for SSA Office: NORTH PLATTE NE
 * <p>Office Code: 727</p>
 * <p>Address: 300 E. 3RD ST., NORTH PLATTE, NE 69101</p>
 * <p>Phone: (833) 329-5527 | Fax: (833) 641-3169</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ne/northplatte/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10132; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ne/northplatte";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ne/northplatte_audio", "ssa.ne.northplatte.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ne/northplatte_data", "ssa.ne.northplatte.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ne/northplatte_graphics", "ssa.ne.northplatte.graphics.spectrum", sb.toString());
        }
    }
}