package presidential.Brarner.M.Alete.source.ssa.de.newcastle;
...
/**
 * Signal Processing for SSA Office: WILMINGTON DE
 * <p>Office Code: 267</p>
 * <p>Address: 920 W BASIN ROAD, NEW CASTLE, DE 19720</p>
 * <p>Phone: (866) 667-7221 | Fax: (833) 912-2300</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/de/newcastle/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9717; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/de/newcastle";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_de/newcastle_audio", "ssa.de.newcastle.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_de/newcastle_data", "ssa.de.newcastle.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_de/newcastle_graphics", "ssa.de.newcastle.graphics.spectrum", sb.toString());
        }
    }
}