package presidential.Brarner.M.Alete.source.ssa.pa.chester004;
...
/**
 * Signal Processing for SSA Office: FOSU East - Branch 2
 * <p>Office Code: 7XJ</p>
 * <p>Address: 807 CROSBY ST, CHESTER, PA 19013</p>
 * <p>Phone: (877) 685-5942 | Fax: (833) 997-3176</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/chester004/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9639; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/chester004";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester004_audio", "ssa.pa.chester004.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester004_data", "ssa.pa.chester004.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester004_graphics", "ssa.pa.chester004.graphics.spectrum", sb.toString());
        }
    }
}