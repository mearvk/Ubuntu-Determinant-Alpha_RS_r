package presidential.Brarner.M.Alete.source.ssa.nc.asheboro;
...
/**
 * Signal Processing for SSA Office: ASHEBORO NC
 * <p>Office Code: D01</p>
 * <p>Address: 157 DUBLIN SQUARE RD STE K, ASHEBORO, NC 27203</p>
 * <p>Phone: (888) 472-6119 | Fax: (833) 597-0078</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/asheboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9400; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/asheboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/asheboro_audio", "ssa.nc.asheboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/asheboro_data", "ssa.nc.asheboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/asheboro_graphics", "ssa.nc.asheboro.graphics.spectrum", sb.toString());
        }
    }
}