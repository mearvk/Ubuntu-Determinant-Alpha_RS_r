package presidential.Brarner.M.Alete.source.ssa.md.silverspring;
...
/**
 * Signal Processing for SSA Office: SILVER SPRING MD
 * <p>Office Code: 282</p>
 * <p>Address: 10230 NEW HAMPSHIRE AVE, SILVER SPRING, MD 20903</p>
 * <p>Phone: (877) 512-3848 | Fax: (833) 597-0155</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/silverspring/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9732; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/silverspring";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/silverspring_audio", "ssa.md.silverspring.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/silverspring_data", "ssa.md.silverspring.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/silverspring_graphics", "ssa.md.silverspring.graphics.spectrum", sb.toString());
        }
    }
}