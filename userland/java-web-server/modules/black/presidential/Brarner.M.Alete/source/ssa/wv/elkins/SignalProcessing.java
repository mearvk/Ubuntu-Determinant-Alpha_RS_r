package presidential.Brarner.M.Alete.source.ssa.wv.elkins;
...
/**
 * Signal Processing for SSA Office: ELKINS WV
 * <p>Office Code: 310</p>
 * <p>Address: 300 THIRD STREET, ELKINS, WV 26241</p>
 * <p>Phone: (877) 828-1693 | Fax: (833) 950-2261</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/elkins/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9760; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/elkins";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/elkins_audio", "ssa.wv.elkins.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/elkins_data", "ssa.wv.elkins.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/elkins_graphics", "ssa.wv.elkins.graphics.spectrum", sb.toString());
        }
    }
}