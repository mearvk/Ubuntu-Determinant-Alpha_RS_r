package presidential.Brarner.M.Alete.source.ssa.ca.losangeles002;
...
/**
 * Signal Processing for SSA Office: CRENSHAW CA
 * <p>Office Code: 26</p>
 * <p>Address: 3840 CRENSHAW BLVD, LOS ANGELES, CA 90008</p>
 * <p>Phone: (877) 531-4693 | Fax: (833) 950-2426</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/losangeles002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9510; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/losangeles002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles002_audio", "ssa.ca.losangeles002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles002_data", "ssa.ca.losangeles002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/losangeles002_graphics", "ssa.ca.losangeles002.graphics.spectrum", sb.toString());
        }
    }
}