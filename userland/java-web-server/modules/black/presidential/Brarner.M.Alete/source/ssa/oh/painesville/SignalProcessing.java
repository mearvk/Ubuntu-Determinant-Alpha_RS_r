...
/**
 * Signal Processing for SSA Office: PAINESVILLE OH
 * <p>Office Code: 378</p>
 * <p>Address: 55 W JACKSON ST, PAINESVILLE, OH 44077</p>
 * <p>Phone: (877) 692-3143 | Fax: (833) 950-2788</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/painesville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9822; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/painesville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/painesville_audio", "ssa.oh.painesville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/painesville_data", "ssa.oh.painesville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/painesville_graphics", "ssa.oh.painesville.graphics.spectrum", sb.toString());
        }
    }
}