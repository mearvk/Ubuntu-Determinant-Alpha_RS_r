package presidential.Brarner.M.Alete.source.ssa.ca.lodi;
...
/**
 * Signal Processing for SSA Office: LODI CA
 * <p>Office Code: B74</p>
 * <p>Address: 1110 W KETTLEMAN LANE, LODI, CA 95240</p>
 * <p>Phone: (888) 257-2641 | Fax: (833) 571-0632</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/lodi/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9329; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/lodi";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/lodi_audio", "ssa.ca.lodi.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/lodi_data", "ssa.ca.lodi.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/lodi_graphics", "ssa.ca.lodi.graphics.spectrum", sb.toString());
        }
    }
}