package presidential.Brarner.M.Alete.source.ssa.wa.tacoma;
...
/**
 * Signal Processing for SSA Office: TACOMA WA
 * <p>Office Code: 917</p>
 * <p>Address: 2608 S 47TH ST, TACOMA, WA 98409</p>
 * <p>Phone: (888) 487-9229 | Fax: (833) 950-2316</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/tacoma/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10300; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/tacoma";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/tacoma_audio", "ssa.wa.tacoma.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/tacoma_data", "ssa.wa.tacoma.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/tacoma_graphics", "ssa.wa.tacoma.graphics.spectrum", sb.toString());
        }
    }
}