...
/**
 * Signal Processing for SSA Office: MADISONVILLE KY
 * <p>Office Code: 453</p>
 * <p>Address: 4431 HANSON RD, MADISONVILLE, KY 42431</p>
 * <p>Phone: (877) 626-9912 | Fax: (833) 950-3777</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/madisonville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9890; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/madisonville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/madisonville_audio", "ssa.ky.madisonville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/madisonville_data", "ssa.ky.madisonville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/madisonville_graphics", "ssa.ky.madisonville.graphics.spectrum", sb.toString());
        }
    }
}