package presidential.Brarner.M.Alete.source.ssa.mi.sterlingheights;
...
/**
 * Signal Processing for SSA Office: STERLING HEIGHTS
 * <p>Office Code: D14</p>
 * <p>Address: 7385 TRIANGLE DRIVE, STERLING HEIGHTS, MI 48314</p>
 * <p>Phone: (888) 619-4768 | Fax: (833) 580-0165</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/sterlingheights/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9409; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/sterlingheights";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/sterlingheights_audio", "ssa.mi.sterlingheights.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/sterlingheights_data", "ssa.mi.sterlingheights.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/sterlingheights_graphics", "ssa.mi.sterlingheights.graphics.spectrum", sb.toString());
        }
    }
}