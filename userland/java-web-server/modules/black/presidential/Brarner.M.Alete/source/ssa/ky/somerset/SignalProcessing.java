...
/**
 * Signal Processing for SSA Office: SOMERSET KY
 * <p>Office Code: 454</p>
 * <p>Address: 3975 S HIGHWAY 27, SOMERSET, KY 42501</p>
 * <p>Phone: (877) 714-0375 | Fax: (833) 950-3779</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/somerset/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9891; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/somerset";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/somerset_audio", "ssa.ky.somerset.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/somerset_data", "ssa.ky.somerset.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/somerset_graphics", "ssa.ky.somerset.graphics.spectrum", sb.toString());
        }
    }
}