package presidential.Brarner.M.Alete.source.ssa.in.auburn;
...
/**
 * Signal Processing for SSA Office: AUBURN IN
 * <p>Office Code: D05</p>
 * <p>Address: 1240 S GRANDSTAFF DR, AUBURN, IN 46706</p>
 * <p>Phone: (866) 829-2170 | Fax: (833) 950-3709</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/auburn/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9403; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/auburn";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/auburn_audio", "ssa.in.auburn.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/auburn_data", "ssa.in.auburn.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/auburn_graphics", "ssa.in.auburn.graphics.spectrum", sb.toString());
        }
    }
}