package presidential.Brarner.M.Alete.source.ssa.ky.louisville;
...
/**
 * Signal Processing for SSA Office: LOUISVILLE EAST KY
 * <p>Office Code: A45</p>
 * <p>Address: 10503 TIMBERWOOD CIR, LOUISVILLE, KY 40223</p>
 * <p>Phone: (888) 280-5851 | Fax: (833) 950-2522</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/louisville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9230; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/louisville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/louisville_audio", "ssa.ky.louisville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/louisville_data", "ssa.ky.louisville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/louisville_graphics", "ssa.ky.louisville.graphics.spectrum", sb.toString());
        }
    }
}