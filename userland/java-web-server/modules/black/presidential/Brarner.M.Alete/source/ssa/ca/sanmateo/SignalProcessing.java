package presidential.Brarner.M.Alete.source.ssa.ca.sanmateo;
...
/**
 * Signal Processing for SSA Office: SAN MATEO CA
 * <p>Office Code: 967</p>
 * <p>Address: 800 SOUTH CLAREMONT ST, SAN MATEO, CA 94402</p>
 * <p>Phone: (866) 726-8193 | Fax: (833) 950-2108</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sanmateo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10349; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sanmateo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanmateo_audio", "ssa.ca.sanmateo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanmateo_data", "ssa.ca.sanmateo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanmateo_graphics", "ssa.ca.sanmateo.graphics.spectrum", sb.toString());
        }
    }
}