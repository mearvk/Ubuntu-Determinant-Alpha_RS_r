package presidential.Brarner.M.Alete.source.ssa.oh.fremont;
...
/**
 * Signal Processing for SSA Office: FREMONT OH
 * <p>Office Code: D13</p>
 * <p>Address: 2220 ENTERPRISE STREET, FREMONT, OH 43420</p>
 * <p>Phone: (866) 614-4760 | Fax: (833) 580-0163</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/fremont/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9408; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/fremont";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/fremont_audio", "ssa.oh.fremont.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/fremont_data", "ssa.oh.fremont.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/fremont_graphics", "ssa.oh.fremont.graphics.spectrum", sb.toString());
        }
    }
}