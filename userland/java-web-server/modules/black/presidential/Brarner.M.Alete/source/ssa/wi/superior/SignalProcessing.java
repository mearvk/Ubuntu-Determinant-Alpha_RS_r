package presidential.Brarner.M.Alete.source.ssa.wi.superior;
...
/**
 * Signal Processing for SSA Office: SUPERIOR WI
 * <p>Office Code: 544</p>
 * <p>Address: 4221 TOWER AVE, SUPERIOR, WI 54880</p>
 * <p>Phone: (877) 628-6578 | Fax: (833) 596-0593</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/superior/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9973; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/superior";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/superior_audio", "ssa.wi.superior.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/superior_data", "ssa.wi.superior.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/superior_graphics", "ssa.wi.superior.graphics.spectrum", sb.toString());
        }
    }
}