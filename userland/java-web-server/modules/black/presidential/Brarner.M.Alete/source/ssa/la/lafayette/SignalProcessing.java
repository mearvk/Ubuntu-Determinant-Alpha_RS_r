package presidential.Brarner.M.Alete.source.ssa.la.lafayette;
...
/**
 * Signal Processing for SSA Office: LAFAYETTE LA
 * <p>Office Code: 806</p>
 * <p>Address: 106 CORPORATE BLVD, LAFAYETTE, LA 70508</p>
 * <p>Phone: (888) 619-4771 | Fax: (833) 950-3641</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/lafayette/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10198; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/lafayette";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/lafayette_audio", "ssa.la.lafayette.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/lafayette_data", "ssa.la.lafayette.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/lafayette_graphics", "ssa.la.lafayette.graphics.spectrum", sb.toString());
        }
    }
}