package presidential.Brarner.M.Alete.source.ssa.pa.york;
...
/**
 * Signal Processing for SSA Office: YORK PA
 * <p>Office Code: 216</p>
 * <p>Address: 2670 INDUSTRIAL HWY, YORK, PA 17402</p>
 * <p>Phone: (888) 329-5732 | Fax: (833) 950-3515</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/york/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9674; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/york";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/york_audio", "ssa.pa.york.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/york_data", "ssa.pa.york.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/york_graphics", "ssa.pa.york.graphics.spectrum", sb.toString());
        }
    }
}