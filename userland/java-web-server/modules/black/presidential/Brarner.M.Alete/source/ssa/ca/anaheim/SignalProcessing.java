package presidential.Brarner.M.Alete.source.ssa.ca.anaheim;
...
/**
 * Signal Processing for SSA Office: ANAHEIM CA
 * <p>Office Code: 249</p>
 * <p>Address: 900 S HARBOR BLVD, ANAHEIM, CA 92805</p>
 * <p>Phone: (866) 657-3133 | Fax: (833) 950-2748</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/anaheim/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9704; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/anaheim";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/anaheim_audio", "ssa.ca.anaheim.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/anaheim_data", "ssa.ca.anaheim.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/anaheim_graphics", "ssa.ca.anaheim.graphics.spectrum", sb.toString());
        }
    }
}