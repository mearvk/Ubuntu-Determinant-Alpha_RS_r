package presidential.Brarner.M.Alete.source.ssa.ma.newbedford;
...
/**
 * Signal Processing for SSA Office: NEW BEDFORD MA
 * <p>Office Code: 38</p>
 * <p>Address: 53 NORTH 6TH STREET, NEW BEDFORD, MA 2740</p>
 * <p>Phone: (866) 964-7413 | Fax: (833) 902-2516</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/newbedford/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9521; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/newbedford";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/newbedford_audio", "ssa.ma.newbedford.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/newbedford_data", "ssa.ma.newbedford.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/newbedford_graphics", "ssa.ma.newbedford.graphics.spectrum", sb.toString());
        }
    }
}