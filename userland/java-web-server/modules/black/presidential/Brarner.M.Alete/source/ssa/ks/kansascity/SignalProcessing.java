package presidential.Brarner.M.Alete.source.ssa.ks.kansascity;
...
/**
 * Signal Processing for SSA Office: KANSAS CITY KS
 * <p>Office Code: 772</p>
 * <p>Address: 850 NEBRASKA AVE, KANSAS CITY, KS 66101</p>
 * <p>Phone: (866) 331-2197 | Fax: (833) 436-4147</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ks/kansascity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10169; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ks/kansascity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ks/kansascity_audio", "ssa.ks.kansascity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ks/kansascity_data", "ssa.ks.kansascity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ks/kansascity_graphics", "ssa.ks.kansascity.graphics.spectrum", sb.toString());
        }
    }
}