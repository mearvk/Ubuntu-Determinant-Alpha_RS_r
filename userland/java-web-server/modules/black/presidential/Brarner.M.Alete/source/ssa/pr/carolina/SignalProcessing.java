package presidential.Brarner.M.Alete.source.ssa.pr.carolina;
...
/**
 * Signal Processing for SSA Office: CAROLINA PR
 * <p>Office Code: A31</p>
 * <p>Address: 5829 AVE 65INF STE 201, CAROLINA, PR 987</p>
 * <p>Phone: (833) 882-1202 | Fax: (833) 950-2958</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pr/carolina/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9219; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pr/carolina";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pr/carolina_audio", "ssa.pr.carolina.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pr/carolina_data", "ssa.pr.carolina.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pr/carolina_graphics", "ssa.pr.carolina.graphics.spectrum", sb.toString());
        }
    }
}