package presidential.Brarner.M.Alete.source.ssa.vt.montpelier;
...
/**
 * Signal Processing for SSA Office: MONTPELIER VT
 * <p>Office Code: 24</p>
 * <p>Address: 33 SCHOOL ST, MONTPELIER, VT 5602</p>
 * <p>Phone: (877) 505-4542 | Fax: (833) 515-0455</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/vt/montpelier/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9508; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/vt/montpelier";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_vt/montpelier_audio", "ssa.vt.montpelier.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_vt/montpelier_data", "ssa.vt.montpelier.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_vt/montpelier_graphics", "ssa.vt.montpelier.graphics.spectrum", sb.toString());
        }
    }
}