package presidential.Brarner.M.Alete.source.ssa.ny.riverhead;
...
/**
 * Signal Processing for SSA Office: RIVERHEAD NY
 * <p>Office Code: 163</p>
 * <p>Address: 526 EAST MAIN STREET, RIVERHEAD, NY 11901</p>
 * <p>Phone: (888) 397-9819 | Fax: (833) 950-2688</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/riverhead/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9627; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/riverhead";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/riverhead_audio", "ssa.ny.riverhead.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/riverhead_data", "ssa.ny.riverhead.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/riverhead_graphics", "ssa.ny.riverhead.graphics.spectrum", sb.toString());
        }
    }
}