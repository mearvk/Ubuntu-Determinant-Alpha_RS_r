package presidential.Brarner.M.Alete.source.ssa.ms.vicksburg;
...
/**
 * Signal Processing for SSA Office: VICKSBURG MS
 * <p>Office Code: 640</p>
 * <p>Address: 4155 CLAY ST, VICKSBURG, MS 39183</p>
 * <p>Phone: (866) 964-0996 | Fax: (833) 950-3793</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/vicksburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10060; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/vicksburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/vicksburg_audio", "ssa.ms.vicksburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/vicksburg_data", "ssa.ms.vicksburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/vicksburg_graphics", "ssa.ms.vicksburg.graphics.spectrum", sb.toString());
        }
    }
}