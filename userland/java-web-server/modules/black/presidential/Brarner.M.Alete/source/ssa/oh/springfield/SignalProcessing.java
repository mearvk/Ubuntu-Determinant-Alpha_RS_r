package presidential.Brarner.M.Alete.source.ssa.oh.springfield;
...
/**
 * Signal Processing for SSA Office: SPRINGFIELD OH
 * <p>Office Code: 398</p>
 * <p>Address: 1610 N LIMESTONE ST, SPRINGFIELD, OH 45503</p>
 * <p>Phone: (877) 405-1451 | Fax: (833) 950-3413</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/springfield/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9839; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/springfield";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/springfield_audio", "ssa.oh.springfield.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/springfield_data", "ssa.oh.springfield.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/springfield_graphics", "ssa.oh.springfield.graphics.spectrum", sb.toString());
        }
    }
}