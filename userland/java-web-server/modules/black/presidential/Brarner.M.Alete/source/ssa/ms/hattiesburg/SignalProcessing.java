...
/**
 * Signal Processing for SSA Office: HATTIESBURG MS
 * <p>Office Code: 642</p>
 * <p>Address: 1911 BROADWAY DR, HATTIESBURG, MS 39402</p>
 * <p>Phone: (866) 331-2186 | Fax: (833) 950-3797</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/hattiesburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10062; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/hattiesburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/hattiesburg_audio", "ssa.ms.hattiesburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/hattiesburg_data", "ssa.ms.hattiesburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/hattiesburg_graphics", "ssa.ms.hattiesburg.graphics.spectrum", sb.toString());
        }
    }
}