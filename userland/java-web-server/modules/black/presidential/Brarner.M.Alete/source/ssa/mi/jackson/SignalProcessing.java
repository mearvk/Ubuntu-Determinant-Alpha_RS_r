package presidential.Brarner.M.Alete.source.ssa.mi.jackson;
...
/**
 * Signal Processing for SSA Office: JACKSON MI
 * <p>Office Code: 351</p>
 * <p>Address: 234 W LOUIS GLICK HWY, JACKSON, MI 49201</p>
 * <p>Phone: (877) 405-0473 | Fax: (833) 950-2124</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/jackson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9798; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/jackson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/jackson_audio", "ssa.mi.jackson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/jackson_data", "ssa.mi.jackson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/jackson_graphics", "ssa.mi.jackson.graphics.spectrum", sb.toString());
        }
    }
}