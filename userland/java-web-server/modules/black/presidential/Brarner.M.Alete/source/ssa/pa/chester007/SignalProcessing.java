package presidential.Brarner.M.Alete.source.ssa.pa.chester007;
...
/**
 * Signal Processing for SSA Office: FOSU East - Branch 4
 * <p>Office Code: 4IX</p>
 * <p>Address: 807 CROSBY ST, CHESTER, PA 19013</p>
 * <p>Phone: (877) 685-5942 | Fax: (833) 551-0606</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/chester007/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10377; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/chester007";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester007_audio", "ssa.pa.chester007.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester007_data", "ssa.pa.chester007.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/chester007_graphics", "ssa.pa.chester007.graphics.spectrum", sb.toString());
        }
    }
}