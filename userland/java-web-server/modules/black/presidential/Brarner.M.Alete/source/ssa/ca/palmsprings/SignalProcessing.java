package presidential.Brarner.M.Alete.source.ssa.ca.palmsprings;
...
/**
 * Signal Processing for SSA Office: PALM SPRINGS CA
 * <p>Office Code: 70</p>
 * <p>Address: 4201 E RAMON RD, PALM SPRINGS, CA 92264</p>
 * <p>Phone: (877) 873-9105 | Fax: (833) 950-2738</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/palmsprings/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9547; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/palmsprings";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/palmsprings_audio", "ssa.ca.palmsprings.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/palmsprings_data", "ssa.ca.palmsprings.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/palmsprings_graphics", "ssa.ca.palmsprings.graphics.spectrum", sb.toString());
        }
    }
}