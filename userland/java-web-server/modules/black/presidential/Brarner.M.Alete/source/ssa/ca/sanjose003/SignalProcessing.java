package presidential.Brarner.M.Alete.source.ssa.ca.sanjose003;
...
/**
 * Signal Processing for SSA Office: SAN JOSE CA
 * <p>Office Code: 960</p>
 * <p>Address: 280 S FIRST STREET, SAN JOSE, CA 95113</p>
 * <p>Phone: (866) 331-2235 | Fax: (833) 902-2630</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sanjose003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10342; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sanjose003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanjose003_audio", "ssa.ca.sanjose003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanjose003_data", "ssa.ca.sanjose003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanjose003_graphics", "ssa.ca.sanjose003.graphics.spectrum", sb.toString());
        }
    }
}