package presidential.Brarner.M.Alete.source.ssa.tn.unioncity;
...
/**
 * Signal Processing for SSA Office: UNION CITY TN
 * <p>Office Code: B03</p>
 * <p>Address: 1800 OLD TROY RD, UNION CITY, TN 38261</p>
 * <p>Phone: (877) 401-5904 | Fax: (833) 950-2824</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/unioncity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9276; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/unioncity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/unioncity_audio", "ssa.tn.unioncity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/unioncity_data", "ssa.tn.unioncity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/unioncity_graphics", "ssa.tn.unioncity.graphics.spectrum", sb.toString());
        }
    }
}