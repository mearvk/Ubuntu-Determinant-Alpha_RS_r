package presidential.Brarner.M.Alete.source.ssa.va.portsmouth;
...
/**
 * Signal Processing for SSA Office: PORTSMOUTH VA
 * <p>Office Code: 302</p>
 * <p>Address: 3305 AIRLINE BLVD, PORTSMOUTH, VA 23701</p>
 * <p>Phone: (866) 593-8851 | Fax: (833) 950-2600</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/portsmouth/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9752; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/portsmouth";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/portsmouth_audio", "ssa.va.portsmouth.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/portsmouth_data", "ssa.va.portsmouth.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/portsmouth_graphics", "ssa.va.portsmouth.graphics.spectrum", sb.toString());
        }
    }
}