package presidential.Brarner.M.Alete.source.ssa.sc.columbia;
...
/**
 * Signal Processing for SSA Office: COLUMBIA SC
 * <p>Office Code: 583</p>
 * <p>Address: 1835 ASSEMBLY ST, COLUMBIA, SC 29201</p>
 * <p>Phone: (866) 964-7594 | Fax: (833) 912-2288</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/columbia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10007; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/columbia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/columbia_audio", "ssa.sc.columbia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/columbia_data", "ssa.sc.columbia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/columbia_graphics", "ssa.sc.columbia.graphics.spectrum", sb.toString());
        }
    }
}