package presidential.Brarner.M.Alete.source.ssa.tx.portarthur;
...
/**
 * Signal Processing for SSA Office: PORT ARTHUR TX
 * <p>Office Code: 830</p>
 * <p>Address: 8208 9TH AVE, PORT ARTHUR, TX 77642</p>
 * <p>Phone: (866) 964-1720 | Fax: (833) 902-2588</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/portarthur/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10221; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/portarthur";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/portarthur_audio", "ssa.tx.portarthur.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/portarthur_data", "ssa.tx.portarthur.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/portarthur_graphics", "ssa.tx.portarthur.graphics.spectrum", sb.toString());
        }
    }
}