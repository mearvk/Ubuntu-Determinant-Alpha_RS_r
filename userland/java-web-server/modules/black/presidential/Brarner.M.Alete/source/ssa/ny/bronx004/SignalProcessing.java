package presidential.Brarner.M.Alete.source.ssa.ny.bronx004;
...
/**
 * Signal Processing for SSA Office: EAST BRONX NY
 * <p>Office Code: 147</p>
 * <p>Address: 1380 PARKER ST, BRONX, NY 10462</p>
 * <p>Phone: (866) 931-2526 | Fax: (833) 950-2374</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/bronx004/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9615; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/bronx004";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx004_audio", "ssa.ny.bronx004.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx004_data", "ssa.ny.bronx004.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx004_graphics", "ssa.ny.bronx004.graphics.spectrum", sb.toString());
        }
    }
}