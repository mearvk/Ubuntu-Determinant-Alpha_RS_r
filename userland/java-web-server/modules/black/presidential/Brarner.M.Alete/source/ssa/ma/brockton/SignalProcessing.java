package presidential.Brarner.M.Alete.source.ssa.ma.brockton;
...
/**
 * Signal Processing for SSA Office: BROCKTON MA
 * <p>Office Code: 39</p>
 * <p>Address: 30 CHRISTY DR, BROCKTON, MA 2301</p>
 * <p>Phone: (888) 717-1524 | Fax: (833) 902-2518</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/brockton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9522; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/brockton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/brockton_audio", "ssa.ma.brockton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/brockton_data", "ssa.ma.brockton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/brockton_graphics", "ssa.ma.brockton.graphics.spectrum", sb.toString());
        }
    }
}