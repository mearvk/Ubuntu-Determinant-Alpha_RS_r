package presidential.Brarner.M.Alete.source.ssa.ak.juneau;
...
/**
 * Signal Processing for SSA Office: JUNEAU AK
 * <p>Office Code: 996</p>
 * <p>Address: 709 WEST NINTH STREET, JUNEAU, AK 99801</p>
 * <p>Phone: (800) 478-7124 | Fax: (833) 950-2928</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ak/juneau/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10373; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ak/juneau";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ak/juneau_audio", "ssa.ak.juneau.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ak/juneau_data", "ssa.ak.juneau.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ak/juneau_graphics", "ssa.ak.juneau.graphics.spectrum", sb.toString());
        }
    }
}