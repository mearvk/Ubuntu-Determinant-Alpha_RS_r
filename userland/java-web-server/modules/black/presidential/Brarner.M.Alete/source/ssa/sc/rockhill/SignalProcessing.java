package presidential.Brarner.M.Alete.source.ssa.sc.rockhill;
...
/**
 * Signal Processing for SSA Office: ROCK HILL SC
 * <p>Office Code: 588</p>
 * <p>Address: 499 LAKESHORE PKWY, ROCK HILL, SC 29730</p>
 * <p>Phone: (877) 626-9589 | Fax: (833) 950-2235</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/rockhill/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10012; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/rockhill";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/rockhill_audio", "ssa.sc.rockhill.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/rockhill_data", "ssa.sc.rockhill.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/rockhill_graphics", "ssa.sc.rockhill.graphics.spectrum", sb.toString());
        }
    }
}