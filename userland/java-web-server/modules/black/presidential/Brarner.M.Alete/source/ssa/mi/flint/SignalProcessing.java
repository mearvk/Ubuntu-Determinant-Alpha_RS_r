...
/**
 * Signal Processing for SSA Office: NORTH FLINT MI
 * <p>Office Code: E00</p>
 * <p>Address: 2021 W. CARPENTER RD, FLINT, MI 48505</p>
 * <p>Phone: (877) 748-9766 | Fax: (833) 902-2644</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/flint/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9452; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/flint";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/flint_audio", "ssa.mi.flint.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/flint_data", "ssa.mi.flint.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/flint_graphics", "ssa.mi.flint.graphics.spectrum", sb.toString());
        }
    }
}