package presidential.Brarner.M.Alete.source.ssa.mi.roseville;
...
/**
 * Signal Processing for SSA Office: ROSEVILLE MI
 * <p>Office Code: 364</p>
 * <p>Address: 15250 E 12 MILE RD, ROSEVILLE, MI 48066</p>
 * <p>Phone: (877) 833-2541 | Fax: (833) 950-2472</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/roseville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9811; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/roseville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/roseville_audio", "ssa.mi.roseville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/roseville_data", "ssa.mi.roseville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/roseville_graphics", "ssa.mi.roseville.graphics.spectrum", sb.toString());
        }
    }
}