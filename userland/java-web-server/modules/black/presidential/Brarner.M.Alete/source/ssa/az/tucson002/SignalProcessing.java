package presidential.Brarner.M.Alete.source.ssa.az.tucson002;
...
/**
 * Signal Processing for SSA Office: SOUTH TUCSON AZ
 * <p>Office Code: 930</p>
 * <p>Address: 88 W 38TH ST, TUCSON, AZ 85713</p>
 * <p>Phone: (866) 220-7896 | Fax: (833) 950-3689</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/az/tucson002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10313; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/az/tucson002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_az/tucson002_audio", "ssa.az.tucson002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_az/tucson002_data", "ssa.az.tucson002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_az/tucson002_graphics", "ssa.az.tucson002.graphics.spectrum", sb.toString());
        }
    }
}