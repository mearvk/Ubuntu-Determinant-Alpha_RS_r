...
/**
 * Signal Processing for SSA Office: PORTERVILLE CA
 * <p>Office Code: 944</p>
 * <p>Address: 890 W MORTON AVENUE, PORTERVILLE, CA 93257</p>
 * <p>Phone: (866) 388-8903 | Fax: (833) 571-2613</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/porterville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10326; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/porterville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/porterville_audio", "ssa.ca.porterville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/porterville_data", "ssa.ca.porterville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/porterville_graphics", "ssa.ca.porterville.graphics.spectrum", sb.toString());
        }
    }
}