package presidential.Brarner.M.Alete.source.ssa.az.apachejunction;
...
/**
 * Signal Processing for SSA Office: APACHE JUNCTION AZ
 * <p>Office Code: 912</p>
 * <p>Address: 253 W SUPERSTITION BLVD, APACHE JUNCTION, AZ 85120</p>
 * <p>Phone: (866) 964-7417 | Fax: (833) 950-3681</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/az/apachejunction/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10295; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/az/apachejunction";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_az/apachejunction_audio", "ssa.az.apachejunction.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_az/apachejunction_data", "ssa.az.apachejunction.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_az/apachejunction_graphics", "ssa.az.apachejunction.graphics.spectrum", sb.toString());
        }
    }
}