package presidential.Brarner.M.Alete.source.ssa.ar.batesville;
...
/**
 * Signal Processing for SSA Office: BATESVILLE AR
 * <p>Office Code: 767</p>
 * <p>Address: 151 DRY KILN RD, BATESVILLE, AR 72501</p>
 * <p>Phone: (866) 816-5651 | Fax: (833) 950-3003</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/batesville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10164; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/batesville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/batesville_audio", "ssa.ar.batesville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/batesville_data", "ssa.ar.batesville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/batesville_graphics", "ssa.ar.batesville.graphics.spectrum", sb.toString());
        }
    }
}