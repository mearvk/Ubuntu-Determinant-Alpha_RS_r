...
/**
 * Signal Processing for SSA Office: WEST BEND WI
 * <p>Office Code: A61</p>
 * <p>Address: 1145 VERN STREET, WEST BEND, WI 53090</p>
 * <p>Phone: (888) 655-0843 | Fax: (833) 950-3065</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/westbend/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9243; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/westbend";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/westbend_audio", "ssa.wi.westbend.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/westbend_data", "ssa.wi.westbend.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/westbend_graphics", "ssa.wi.westbend.graphics.spectrum", sb.toString());
        }
    }
}