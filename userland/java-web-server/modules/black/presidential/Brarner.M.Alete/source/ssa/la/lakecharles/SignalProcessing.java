package presidential.Brarner.M.Alete.source.ssa.la.lakecharles;
...
/**
 * Signal Processing for SSA Office: LAKE CHARLES LA
 * <p>Office Code: 805</p>
 * <p>Address: 149 W 18TH ST, LAKE CHARLES, LA 70601</p>
 * <p>Phone: (877) 409-8431 | Fax: (833) 950-3639</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/lakecharles/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10197; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/lakecharles";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/lakecharles_audio", "ssa.la.lakecharles.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/lakecharles_data", "ssa.la.lakecharles.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/lakecharles_graphics", "ssa.la.lakecharles.graphics.spectrum", sb.toString());
        }
    }
}