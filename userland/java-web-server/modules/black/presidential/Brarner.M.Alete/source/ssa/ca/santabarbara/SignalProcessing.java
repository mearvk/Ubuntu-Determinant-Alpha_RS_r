package presidential.Brarner.M.Alete.source.ssa.ca.santabarbara;
...
/**
 * Signal Processing for SSA Office: SANTA BARBARA CA
 * <p>Office Code: 961</p>
 * <p>Address: 122 W FIGUEROA ST, SANTA BARBARA, CA 93101</p>
 * <p>Phone: (866) 695-6285 | Fax: (833) 902-2632</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/santabarbara/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10343; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/santabarbara";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/santabarbara_audio", "ssa.ca.santabarbara.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/santabarbara_data", "ssa.ca.santabarbara.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/santabarbara_graphics", "ssa.ca.santabarbara.graphics.spectrum", sb.toString());
        }
    }
}