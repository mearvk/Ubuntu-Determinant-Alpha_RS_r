...
/**
 * Signal Processing for SSA Office: EAST ORANGE NJ
 * <p>Office Code: 184</p>
 * <p>Address: 7 GLENWOOD AVE, EAST ORANGE, NJ 7017</p>
 * <p>Phone: (866) 964-0030 | Fax: (833) 950-3311</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/eastorange/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9645; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/eastorange";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/eastorange_audio", "ssa.nj.eastorange.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/eastorange_data", "ssa.nj.eastorange.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/eastorange_graphics", "ssa.nj.eastorange.graphics.spectrum", sb.toString());
        }
    }
}