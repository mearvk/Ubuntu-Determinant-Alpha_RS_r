package presidential.Brarner.M.Alete.source.ssa.as.pagopago;
...
/**
 * Signal Processing for SSA Office: PAGO PAGO AM SAMOA
 * <p>Office Code: 25</p>
 * <p>Address: 1 UTULEI ROAD, PAGO PAGO, AS 96799</p>
 * <p>Phone: (855) 602-5033 | Fax: (833) 950-2424</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/as/pagopago/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9509; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/as/pagopago";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_as/pagopago_audio", "ssa.as.pagopago.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_as/pagopago_data", "ssa.as.pagopago.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_as/pagopago_graphics", "ssa.as.pagopago.graphics.spectrum", sb.toString());
        }
    }
}