package presidential.Brarner.M.Alete.source.ssa.ca.chulavista;
...
/**
 * Signal Processing for SSA Office: CHULA VISTA CA
 * <p>Office Code: 436</p>
 * <p>Address: 626 L STREET, CHULA VISTA, CA 91911</p>
 * <p>Phone: (888) 487-9907 | Fax: (833) 950-3055</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/chulavista/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9873; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/chulavista";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/chulavista_audio", "ssa.ca.chulavista.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/chulavista_data", "ssa.ca.chulavista.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/chulavista_graphics", "ssa.ca.chulavista.graphics.spectrum", sb.toString());
        }
    }
}