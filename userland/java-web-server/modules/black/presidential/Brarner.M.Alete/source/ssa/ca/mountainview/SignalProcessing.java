package presidential.Brarner.M.Alete.source.ssa.ca.mountainview;
...
/**
 * Signal Processing for SSA Office: MOUNTAIN VIEW CA
 * <p>Office Code: A83</p>
 * <p>Address: 701 N SHORELINE BLVD, MOUNTAIN VIEW, CA 94043</p>
 * <p>Phone: (877) 319-0161 | Fax: (833) 950-3371</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/mountainview/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9262; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/mountainview";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/mountainview_audio", "ssa.ca.mountainview.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/mountainview_data", "ssa.ca.mountainview.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/mountainview_graphics", "ssa.ca.mountainview.graphics.spectrum", sb.toString());
        }
    }
}