package presidential.Brarner.M.Alete.source.ssa.mi.inkster;
...
/**
 * Signal Processing for SSA Office: INKSTER MI
 * <p>Office Code: C44</p>
 * <p>Address: 28657 CHERRY HILL RD, INKSTER, MI 48141</p>
 * <p>Phone: (866) 704-4860 | Fax: (833) 950-3697</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/inkster/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9363; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/inkster";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/inkster_audio", "ssa.mi.inkster.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/inkster_data", "ssa.mi.inkster.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/inkster_graphics", "ssa.mi.inkster.graphics.spectrum", sb.toString());
        }
    }
}