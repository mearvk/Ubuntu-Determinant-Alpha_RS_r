package presidential.Brarner.M.Alete.source.ssa.ok.enid;
...
/**
 * Signal Processing for SSA Office: ENID OK
 * <p>Office Code: 788</p>
 * <p>Address: 2202 N VAN BUREN ST, ENID, OK 73703</p>
 * <p>Phone: (877) 405-0436 | Fax: (833) 950-3015</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/enid/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10183; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/enid";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/enid_audio", "ssa.ok.enid.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/enid_data", "ssa.ok.enid.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/enid_graphics", "ssa.ok.enid.graphics.spectrum", sb.toString());
        }
    }
}