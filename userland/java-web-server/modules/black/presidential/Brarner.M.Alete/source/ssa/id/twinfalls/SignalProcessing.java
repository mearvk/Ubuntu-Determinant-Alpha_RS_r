package presidential.Brarner.M.Alete.source.ssa.id.twinfalls;
...
/**
 * Signal Processing for SSA Office: TWIN FALLS ID
 * <p>Office Code: 896</p>
 * <p>Address: 1437 FILLMORE ST, TWIN FALLS, ID 83301</p>
 * <p>Phone: (866) 748-2087 | Fax: (833) 950-2304</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/id/twinfalls/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10280; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/id/twinfalls";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_id/twinfalls_audio", "ssa.id.twinfalls.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_id/twinfalls_data", "ssa.id.twinfalls.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_id/twinfalls_graphics", "ssa.id.twinfalls.graphics.spectrum", sb.toString());
        }
    }
}