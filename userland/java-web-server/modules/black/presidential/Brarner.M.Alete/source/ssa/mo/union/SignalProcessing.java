package presidential.Brarner.M.Alete.source.ssa.mo.union;
...
/**
 * Signal Processing for SSA Office: UNION MO
 * <p>Office Code: B38</p>
 * <p>Address: 43 PRAIRIE DELL PLZ, UNION, MO 63084</p>
 * <p>Phone: (866) 837-1063 | Fax: (833) 950-2650</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/union/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9305; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/union";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/union_audio", "ssa.mo.union.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/union_data", "ssa.mo.union.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/union_graphics", "ssa.mo.union.graphics.spectrum", sb.toString());
        }
    }
}