package presidential.Brarner.M.Alete.source.ssa.ny.bronx005;
...
/**
 * Signal Processing for SSA Office: MOTT HAVEN NY
 * <p>Office Code: 158</p>
 * <p>Address: 460 WILLIS AVE, BRONX, NY 10455</p>
 * <p>Phone: (866) 220-7889 | Fax: (833) 950-2682</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/bronx005/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9624; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/bronx005";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx005_audio", "ssa.ny.bronx005.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx005_data", "ssa.ny.bronx005.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx005_graphics", "ssa.ny.bronx005.graphics.spectrum", sb.toString());
        }
    }
}