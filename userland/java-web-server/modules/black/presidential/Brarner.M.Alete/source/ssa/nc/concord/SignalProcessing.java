package presidential.Brarner.M.Alete.source.ssa.nc.concord;
...
/**
 * Signal Processing for SSA Office: CONCORD NC
 * <p>Office Code: 344</p>
 * <p>Address: 830 FLORENCE ST NW, CONCORD, NC 28027</p>
 * <p>Phone: (888) 366-6149 | Fax: (833) 950-3145</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/concord/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9791; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/concord";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/concord_audio", "ssa.nc.concord.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/concord_data", "ssa.nc.concord.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/concord_graphics", "ssa.nc.concord.graphics.spectrum", sb.toString());
        }
    }
}