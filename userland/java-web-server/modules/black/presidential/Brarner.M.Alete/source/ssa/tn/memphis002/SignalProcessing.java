package presidential.Brarner.M.Alete.source.ssa.tn.memphis002;
...
/**
 * Signal Processing for SSA Office: MEMPHIS SOUTH TN
 * <p>Office Code: 556</p>
 * <p>Address: 3461 SOUTH THIRD ST, MEMPHIS, TN 38109</p>
 * <p>Phone: (855) 782-9155 | Fax: (833) 950-3789</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/memphis002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9984; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/memphis002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/memphis002_audio", "ssa.tn.memphis002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/memphis002_data", "ssa.tn.memphis002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/memphis002_graphics", "ssa.tn.memphis002.graphics.spectrum", sb.toString());
        }
    }
}