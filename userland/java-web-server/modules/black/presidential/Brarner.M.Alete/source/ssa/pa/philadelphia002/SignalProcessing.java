package presidential.Brarner.M.Alete.source.ssa.pa.philadelphia002;
...
/**
 * Signal Processing for SSA Office: PHILA ARAMINGO PA
 * <p>Office Code: 194</p>
 * <p>Address: 3400 ARAMINGO AVE, PHILADELPHIA, PA 19134</p>
 * <p>Phone: (855) 248-0233 | Fax: (833) 950-2880</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/philadelphia002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9652; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/philadelphia002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia002_audio", "ssa.pa.philadelphia002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia002_data", "ssa.pa.philadelphia002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia002_graphics", "ssa.pa.philadelphia002.graphics.spectrum", sb.toString());
        }
    }
}