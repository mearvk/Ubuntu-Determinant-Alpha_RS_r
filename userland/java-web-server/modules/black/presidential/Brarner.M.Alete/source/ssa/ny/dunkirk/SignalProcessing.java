...
/**
 * Signal Processing for SSA Office: DUNKIRK NY
 * <p>Office Code: C72</p>
 * <p>Address: 437 MAIN ST, DUNKIRK, NY 14048</p>
 * <p>Phone: (888) 862-2139 | Fax: (833) 950-3277</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/dunkirk/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9381; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/dunkirk";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/dunkirk_audio", "ssa.ny.dunkirk.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/dunkirk_data", "ssa.ny.dunkirk.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/dunkirk_graphics", "ssa.ny.dunkirk.graphics.spectrum", sb.toString());
        }
    }
}