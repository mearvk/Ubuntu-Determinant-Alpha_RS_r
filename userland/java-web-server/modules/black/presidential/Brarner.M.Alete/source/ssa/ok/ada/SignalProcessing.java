...
/**
 * Signal Processing for SSA Office: ADA OK
 * <p>Office Code: 797</p>
 * <p>Address: 921 LONNIE ABBOTT BLVD, ADA, OK 74820</p>
 * <p>Phone: (888) 810-1940 | Fax: (833) 950-3345</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/ada/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10190; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/ada";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/ada_audio", "ssa.ok.ada.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/ada_data", "ssa.ok.ada.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/ada_graphics", "ssa.ok.ada.graphics.spectrum", sb.toString());
        }
    }
}