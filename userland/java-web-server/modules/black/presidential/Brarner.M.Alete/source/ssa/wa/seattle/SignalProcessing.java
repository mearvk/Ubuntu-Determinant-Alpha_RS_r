package presidential.Brarner.M.Alete.source.ssa.wa.seattle;
...
/**
 * Signal Processing for SSA Office: SEATTLE NORTH WA
 * <p>Office Code: C62</p>
 * <p>Address: 13510 AURORA AVE N, SEATTLE, WA 98133</p>
 * <p>Phone: (866) 931-2875 | Fax: (833) 950-3234</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/seattle/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9373; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/seattle";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/seattle_audio", "ssa.wa.seattle.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/seattle_data", "ssa.wa.seattle.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/seattle_graphics", "ssa.wa.seattle.graphics.spectrum", sb.toString());
        }
    }
}