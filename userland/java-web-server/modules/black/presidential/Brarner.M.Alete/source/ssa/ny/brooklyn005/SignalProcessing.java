package presidential.Brarner.M.Alete.source.ssa.ny.brooklyn005;
...
/**
 * Signal Processing for SSA Office: BROOKLYN NEW UTRECHT
 * <p>Office Code: 137</p>
 * <p>Address: 7714 17 AVENUE, BROOKLYN, NY 11214</p>
 * <p>Phone: (866) 585-9320 | Fax: (833) 926-2697</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/brooklyn005/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9606; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/brooklyn005";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn005_audio", "ssa.ny.brooklyn005.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn005_data", "ssa.ny.brooklyn005.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn005_graphics", "ssa.ny.brooklyn005.graphics.spectrum", sb.toString());
        }
    }
}