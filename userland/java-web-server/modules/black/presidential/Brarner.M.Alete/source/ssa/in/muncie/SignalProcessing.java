...
/**
 * Signal Processing for SSA Office: MUNCIE IN
 * <p>Office Code: 463</p>
 * <p>Address: 600 NORTH WALNUT ST, MUNCIE, IN 47305</p>
 * <p>Phone: (866) 964-7586 | Fax: (833) 902-2682</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/muncie/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9900; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/muncie";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/muncie_audio", "ssa.in.muncie.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/muncie_data", "ssa.in.muncie.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/muncie_graphics", "ssa.in.muncie.graphics.spectrum", sb.toString());
        }
    }
}