...
/**
 * Signal Processing for SSA Office: ROSEBURG OR
 * <p>Office Code: 939</p>
 * <p>Address: 1730 NW HUGHWOOD AVE, ROSEBURG, OR 97471</p>
 * <p>Phone: (866) 614-0031 | Fax: (833) 950-2922</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/or/roseburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10321; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/or/roseburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_or/roseburg_audio", "ssa.or.roseburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_or/roseburg_data", "ssa.or.roseburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_or/roseburg_graphics", "ssa.or.roseburg.graphics.spectrum", sb.toString());
        }
    }
}