...
/**
 * Signal Processing for SSA Office: BETHLEHEM PA
 * <p>Office Code: C10</p>
 * <p>Address: 3450 HIGH POINT BLVD, BETHLEHEM, PA 18017</p>
 * <p>Phone: (866) 783-7458 | Fax: (833) 950-2584</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/bethlehem/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9346; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/bethlehem";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/bethlehem_audio", "ssa.pa.bethlehem.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/bethlehem_data", "ssa.pa.bethlehem.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/bethlehem_graphics", "ssa.pa.bethlehem.graphics.spectrum", sb.toString());
        }
    }
}