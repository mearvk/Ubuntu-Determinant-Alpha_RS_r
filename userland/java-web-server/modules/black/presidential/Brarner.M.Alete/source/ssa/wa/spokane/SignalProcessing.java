package presidential.Brarner.M.Alete.source.ssa.wa.spokane;
...
/**
 * Signal Processing for SSA Office: SPOKANE WA
 * <p>Office Code: 915</p>
 * <p>Address: 714 N IRON BRIDGE WAY, SPOKANE, WA 99202</p>
 * <p>Phone: (866) 331-5532 | Fax: (833) 950-2312</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/spokane/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10298; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/spokane";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/spokane_audio", "ssa.wa.spokane.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/spokane_data", "ssa.wa.spokane.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/spokane_graphics", "ssa.wa.spokane.graphics.spectrum", sb.toString());
        }
    }
}