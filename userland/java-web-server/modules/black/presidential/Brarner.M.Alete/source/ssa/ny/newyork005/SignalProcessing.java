package presidential.Brarner.M.Alete.source.ssa.ny.newyork005;
...
/**
 * Signal Processing for SSA Office: INWOOD HILL NY
 * <p>Office Code: 134</p>
 * <p>Address: 4941 BROADWAY, NEW YORK, NY 10034</p>
 * <p>Phone: (877) 445-0838 | Fax: (833) 926-2691</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/newyork005/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9603; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/newyork005";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork005_audio", "ssa.ny.newyork005.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork005_data", "ssa.ny.newyork005.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork005_graphics", "ssa.ny.newyork005.graphics.spectrum", sb.toString());
        }
    }
}