...
/**
 * Signal Processing for SSA Office: COVINGTON GA
 * <p>Office Code: C96</p>
 * <p>Address: 9180 COVINGTON BY PASS RD, COVINGTON, GA 30014</p>
 * <p>Phone: (877) 873-9106 | Fax: (833) 597-0072</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/covington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9397; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/covington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/covington_audio", "ssa.ga.covington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/covington_data", "ssa.ga.covington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/covington_graphics", "ssa.ga.covington.graphics.spectrum", sb.toString());
        }
    }
}