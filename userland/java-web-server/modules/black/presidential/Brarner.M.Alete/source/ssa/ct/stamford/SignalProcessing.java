package presidential.Brarner.M.Alete.source.ssa.ct.stamford;
...
/**
 * Signal Processing for SSA Office: STAMFORD CT
 * <p>Office Code: 87</p>
 * <p>Address: 2 LANDMARK SQUARE, STAMFORD, CT 6901</p>
 * <p>Phone: (866) 770-1881 | Fax: (833) 950-2658</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ct/stamford/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9559; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ct/stamford";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ct/stamford_audio", "ssa.ct.stamford.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ct/stamford_data", "ssa.ct.stamford.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ct/stamford_graphics", "ssa.ct.stamford.graphics.spectrum", sb.toString());
        }
    }
}