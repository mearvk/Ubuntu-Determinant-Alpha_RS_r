package presidential.Brarner.M.Alete.source.ssa.il.chicago006;
...
/**
 * Signal Processing for SSA Office: CHICAGO SOUTH
 * <p>Office Code: 500</p>
 * <p>Address: 9443 S WESTERN AVE, CHICAGO, IL 60643</p>
 * <p>Phone: (877) 409-8427 | Fax: (833) 950-2808</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/chicago006/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9935; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/chicago006";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago006_audio", "ssa.il.chicago006.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago006_data", "ssa.il.chicago006.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago006_graphics", "ssa.il.chicago006.graphics.spectrum", sb.toString());
        }
    }
}