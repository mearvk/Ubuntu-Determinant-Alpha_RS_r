package presidential.Brarner.M.Alete.source.ssa.ma.roxbury;
...
/**
 * Signal Processing for SSA Office: ROXBURY MA
 * <p>Office Code: 33</p>
 * <p>Address: 10 MALCOLM X BLVD, ROXBURY, MA 2119</p>
 * <p>Phone: (855) 278-4195 | Fax: (833) 515-0463</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/roxbury/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9516; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/roxbury";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/roxbury_audio", "ssa.ma.roxbury.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/roxbury_data", "ssa.ma.roxbury.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/roxbury_graphics", "ssa.ma.roxbury.graphics.spectrum", sb.toString());
        }
    }
}