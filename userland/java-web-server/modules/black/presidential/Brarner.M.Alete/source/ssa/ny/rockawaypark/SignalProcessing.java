package presidential.Brarner.M.Alete.source.ssa.ny.rockawaypark;
...
/**
 * Signal Processing for SSA Office: ROCKAWAY PARK NY
 * <p>Office Code: 162</p>
 * <p>Address: 11306 ROCKAWAY BCH BLVD, ROCKAWAY PARK, NY 11694</p>
 * <p>Phone: (866) 331-2310 | Fax: (833) 950-2686</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/rockawaypark/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9626; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/rockawaypark";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/rockawaypark_audio", "ssa.ny.rockawaypark.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/rockawaypark_data", "ssa.ny.rockawaypark.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/rockawaypark_graphics", "ssa.ny.rockawaypark.graphics.spectrum", sb.toString());
        }
    }
}