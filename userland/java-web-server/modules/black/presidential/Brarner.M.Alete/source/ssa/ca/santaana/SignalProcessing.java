package presidential.Brarner.M.Alete.source.ssa.ca.santaana;
...
/**
 * Signal Processing for SSA Office: SANTA ANA CA
 * <p>Office Code: 972</p>
 * <p>Address: 1851 EAST FIRST STREET, SANTA ANA, CA 92705</p>
 * <p>Phone: (888) 366-6146 | Fax: (833) 950-2118</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/santaana/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10354; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/santaana";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/santaana_audio", "ssa.ca.santaana.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/santaana_data", "ssa.ca.santaana.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/santaana_graphics", "ssa.ca.santaana.graphics.spectrum", sb.toString());
        }
    }
}