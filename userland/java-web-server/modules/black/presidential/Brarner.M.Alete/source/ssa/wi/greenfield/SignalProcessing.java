package presidential.Brarner.M.Alete.source.ssa.wi.greenfield;
...
/**
 * Signal Processing for SSA Office: GREENFIELD WI
 * <p>Office Code: E26</p>
 * <p>Address: 8455 W LAYTON AVE, GREENFIELD, WI 53228</p>
 * <p>Phone: (877) 600-2856 | Fax: (833) 902-2648</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/greenfield/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9458; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/greenfield";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/greenfield_audio", "ssa.wi.greenfield.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/greenfield_data", "ssa.wi.greenfield.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/greenfield_graphics", "ssa.wi.greenfield.graphics.spectrum", sb.toString());
        }
    }
}