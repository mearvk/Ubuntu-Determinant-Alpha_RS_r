package presidential.Brarner.M.Alete.source.ssa.il.quincy;
...
/**
 * Signal Processing for SSA Office: QUINCY IL
 * <p>Office Code: 490</p>
 * <p>Address: 2401 LIND STREET, QUINCY, IL 62301</p>
 * <p>Phone: (888) 279-5999 | Fax: (833) 950-2508</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/quincy/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9925; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/quincy";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/quincy_audio", "ssa.il.quincy.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/quincy_data", "ssa.il.quincy.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/quincy_graphics", "ssa.il.quincy.graphics.spectrum", sb.toString());
        }
    }
}