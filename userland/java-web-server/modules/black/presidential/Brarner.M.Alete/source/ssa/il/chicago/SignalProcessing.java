...
/**
 * Signal Processing for SSA Office: BACK OF THE YARDS
 * <p>Office Code: E05</p>
 * <p>Address: 5253 S ASHLAND AVE, CHICAGO, IL 60609</p>
 * <p>Phone: (877) 897-0608 | Fax: (833) 902-2646</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/chicago/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9454; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/chicago";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago_audio", "ssa.il.chicago.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago_data", "ssa.il.chicago.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago_graphics", "ssa.il.chicago.graphics.spectrum", sb.toString());
        }
    }
}