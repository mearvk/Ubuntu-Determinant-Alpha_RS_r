package presidential.Brarner.M.Alete.source.ssa.ar.sherwood;
...
/**
 * Signal Processing for SSA Office: SHERWOOD AR
 * <p>Office Code: E37</p>
 * <p>Address: 3608 EAST KIEHL AVE, SHERWOOD, AR 72120</p>
 * <p>Phone: (877) 512-3854 | Fax: (833) 950-2384</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/sherwood/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9466; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/sherwood";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/sherwood_audio", "ssa.ar.sherwood.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/sherwood_data", "ssa.ar.sherwood.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/sherwood_graphics", "ssa.ar.sherwood.graphics.spectrum", sb.toString());
        }
    }
}