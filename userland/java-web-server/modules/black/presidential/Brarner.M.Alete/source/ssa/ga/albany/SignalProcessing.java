package presidential.Brarner.M.Alete.source.ssa.ga.albany;
...
/**
 * Signal Processing for SSA Office: ALBANY GA
 * <p>Office Code: 602</p>
 * <p>Address: 1522 W 3RD AVE, ALBANY, GA 31707</p>
 * <p>Phone: (877) 319-0733 | Fax: (833) 950-2562</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/albany/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10025; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/albany";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/albany_audio", "ssa.ga.albany.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/albany_data", "ssa.ga.albany.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/albany_graphics", "ssa.ga.albany.graphics.spectrum", sb.toString());
        }
    }
}