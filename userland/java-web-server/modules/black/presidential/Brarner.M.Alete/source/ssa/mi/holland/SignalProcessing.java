package presidential.Brarner.M.Alete.source.ssa.mi.holland;
...
/**
 * Signal Processing for SSA Office: HOLLAND MI
 * <p>Office Code: B28</p>
 * <p>Address: 657 HASTINGS AVE, HOLLAND, MI 49423</p>
 * <p>Phone: (877) 223-6062 | Fax: (833) 950-3395</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/holland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9295; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/holland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/holland_audio", "ssa.mi.holland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/holland_data", "ssa.mi.holland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/holland_graphics", "ssa.mi.holland.graphics.spectrum", sb.toString());
        }
    }
}