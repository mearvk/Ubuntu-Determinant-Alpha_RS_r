...
/**
 * Signal Processing for SSA Office: ROCKFORD IL
 * <p>Office Code: 496</p>
 * <p>Address: 502 E JEFFERSON ST, ROCKFORD, IL 61107</p>
 * <p>Phone: (877) 628-6570 | Fax: (833) 950-2800</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/rockford/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9931; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/rockford";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/rockford_audio", "ssa.il.rockford.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/rockford_data", "ssa.il.rockford.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/rockford_graphics", "ssa.il.rockford.graphics.spectrum", sb.toString());
        }
    }
}