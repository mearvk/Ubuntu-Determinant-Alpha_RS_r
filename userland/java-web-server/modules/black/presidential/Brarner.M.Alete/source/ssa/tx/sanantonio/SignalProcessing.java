package presidential.Brarner.M.Alete.source.ssa.tx.sanantonio;
...
/**
 * Signal Processing for SSA Office: SAN ANTONIO DOWNTOWN
 * <p>Office Code: 00N</p>
 * <p>Address: 727 E CESAR CHAVEZ, SAN ANTONIO, TX 78206</p>
 * <p>Phone: (877) 405-0482 | Fax: (833) 950-2396</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/sanantonio/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9488; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/sanantonio";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanantonio_audio", "ssa.tx.sanantonio.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanantonio_data", "ssa.tx.sanantonio.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanantonio_graphics", "ssa.tx.sanantonio.graphics.spectrum", sb.toString());
        }
    }
}