package presidential.Brarner.M.Alete.source.ssa.wi.milwaukee003;
...
/**
 * Signal Processing for SSA Office: MILW DT WI
 * <p>Office Code: 548</p>
 * <p>Address: 310 W WISCONSIN AVE, MILWAUKEE, WI 53203</p>
 * <p>Phone: (866) 467-9626 | Fax: (833) 596-0601</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/milwaukee003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9977; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/milwaukee003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/milwaukee003_audio", "ssa.wi.milwaukee003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/milwaukee003_data", "ssa.wi.milwaukee003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/milwaukee003_graphics", "ssa.wi.milwaukee003.graphics.spectrum", sb.toString());
        }
    }
}