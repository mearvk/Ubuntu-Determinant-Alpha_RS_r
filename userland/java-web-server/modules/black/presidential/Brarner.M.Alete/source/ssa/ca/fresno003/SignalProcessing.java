...
/**
 * Signal Processing for SSA Office: FRESNO CA
 * <p>Office Code: 952</p>
 * <p>Address: 640 W LOCUST AVENUE, FRESNO, CA 93650</p>
 * <p>Phone: (866) 931-9041 | Fax: (833) 580-0155</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/fresno003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10334; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/fresno003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fresno003_audio", "ssa.ca.fresno003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fresno003_data", "ssa.ca.fresno003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fresno003_graphics", "ssa.ca.fresno003.graphics.spectrum", sb.toString());
        }
    }
}