package presidential.Brarner.M.Alete.source.ssa.ma.boston;
...
/**
 * Signal Processing for SSA Office: BOSTON MA
 * <p>Office Code: 30</p>
 * <p>Address: 10 CAUSEWAY STREET, BOSTON, MA 2222</p>
 * <p>Phone: (866) 964-7311 | Fax: (833) 515-0457</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/boston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9513; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/boston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/boston_audio", "ssa.ma.boston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/boston_data", "ssa.ma.boston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/boston_graphics", "ssa.ma.boston.graphics.spectrum", sb.toString());
        }
    }
}