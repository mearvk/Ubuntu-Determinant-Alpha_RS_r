package presidential.Brarner.M.Alete.source.ssa.ct.easthartford;
...
/**
 * Signal Processing for SSA Office: EAST HARTFORD CT
 * <p>Office Code: A23</p>
 * <p>Address: 478 BURNSIDE AVENUE, EAST HARTFORD, CT 6108</p>
 * <p>Phone: (866) 706-6759 | Fax: (833) 950-3246</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ct/easthartford/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9212; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ct/easthartford";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ct/easthartford_audio", "ssa.ct.easthartford.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ct/easthartford_data", "ssa.ct.easthartford.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ct/easthartford_graphics", "ssa.ct.easthartford.graphics.spectrum", sb.toString());
        }
    }
}