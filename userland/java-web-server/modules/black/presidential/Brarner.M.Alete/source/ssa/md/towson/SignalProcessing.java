package presidential.Brarner.M.Alete.source.ssa.md.towson;
...
/**
 * Signal Processing for SSA Office: TOWSON MD
 * <p>Office Code: 278</p>
 * <p>Address: 1220 E JOPPA RD, TOWSON, MD 21286</p>
 * <p>Phone: (866) 614-4758 | Fax: (833) 597-0153</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/towson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9728; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/towson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/towson_audio", "ssa.md.towson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/towson_data", "ssa.md.towson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/towson_graphics", "ssa.md.towson.graphics.spectrum", sb.toString());
        }
    }
}