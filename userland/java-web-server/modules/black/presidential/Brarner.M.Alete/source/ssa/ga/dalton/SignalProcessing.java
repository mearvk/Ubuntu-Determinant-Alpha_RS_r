package presidential.Brarner.M.Alete.source.ssa.ga.dalton;
...
/**
 * Signal Processing for SSA Office: DALTON GA
 * <p>Office Code: 618</p>
 * <p>Address: 301 POINT NORTH PL, DALTON, GA 30720</p>
 * <p>Phone: (866) 593-5681 | Fax: (833) 950-3159</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/dalton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10041; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/dalton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/dalton_audio", "ssa.ga.dalton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/dalton_data", "ssa.ga.dalton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/dalton_graphics", "ssa.ga.dalton.graphics.spectrum", sb.toString());
        }
    }
}