package presidential.Brarner.M.Alete.source.ssa.tx.lufkin;
...
/**
 * Signal Processing for SSA Office: LUFKIN TX
 * <p>Office Code: 833</p>
 * <p>Address: 702 E DENMAN AVE, LUFKIN, TX 75901</p>
 * <p>Phone: (877) 407-3442 | Fax: (833) 939-2021</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/lufkin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10224; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/lufkin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/lufkin_audio", "ssa.tx.lufkin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/lufkin_data", "ssa.tx.lufkin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/lufkin_graphics", "ssa.tx.lufkin.graphics.spectrum", sb.toString());
        }
    }
}