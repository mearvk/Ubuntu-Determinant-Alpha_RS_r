package presidential.Brarner.M.Alete.source.ssa.wa.silverdale;
...
/**
 * Signal Processing for SSA Office: KITSAP WA
 * <p>Office Code: 926</p>
 * <p>Address: 9594 MICKELBERRY RD NW, SILVERDALE, WA 98383</p>
 * <p>Phone: (855) 820-0098 | Fax: (833) 950-2624</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/silverdale/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10309; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/silverdale";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/silverdale_audio", "ssa.wa.silverdale.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/silverdale_data", "ssa.wa.silverdale.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/silverdale_graphics", "ssa.wa.silverdale.graphics.spectrum", sb.toString());
        }
    }
}