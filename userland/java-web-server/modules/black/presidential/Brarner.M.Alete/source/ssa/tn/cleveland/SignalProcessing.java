package presidential.Brarner.M.Alete.source.ssa.tn.cleveland;
...
/**
 * Signal Processing for SSA Office: CLEVELAND TN
 * <p>Office Code: 581</p>
 * <p>Address: 529 INMAN ST W, CLEVELAND, TN 37311</p>
 * <p>Phone: (855) 207-4867 | Fax: (833) 912-2284</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/cleveland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10005; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/cleveland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/cleveland_audio", "ssa.tn.cleveland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/cleveland_data", "ssa.tn.cleveland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/cleveland_graphics", "ssa.tn.cleveland.graphics.spectrum", sb.toString());
        }
    }
}