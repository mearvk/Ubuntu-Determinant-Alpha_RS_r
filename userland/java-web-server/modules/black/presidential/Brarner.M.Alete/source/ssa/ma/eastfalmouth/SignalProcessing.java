...
/**
 * Signal Processing for SSA Office: FALMOUTH MA
 * <p>Office Code: B88</p>
 * <p>Address: 48 RESEARCH RD, EAST FALMOUTH, MA 2536</p>
 * <p>Phone: (855) 881-0212 | Fax: (833) 950-3254</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/eastfalmouth/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9336; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/eastfalmouth";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/eastfalmouth_audio", "ssa.ma.eastfalmouth.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/eastfalmouth_data", "ssa.ma.eastfalmouth.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/eastfalmouth_graphics", "ssa.ma.eastfalmouth.graphics.spectrum", sb.toString());
        }
    }
}