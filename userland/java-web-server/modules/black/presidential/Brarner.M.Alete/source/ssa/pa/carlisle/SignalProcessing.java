package presidential.Brarner.M.Alete.source.ssa.pa.carlisle;
...
/**
 * Signal Processing for SSA Office: CARLISLE PA
 * <p>Office Code: A35</p>
 * <p>Address: 200 S SPRING GARDEN ST, CARLISLE, PA 17013</p>
 * <p>Phone: (866) 635-0507 | Fax: (833) 950-2578</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/carlisle/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9223; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/carlisle";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/carlisle_audio", "ssa.pa.carlisle.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/carlisle_data", "ssa.pa.carlisle.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/carlisle_graphics", "ssa.pa.carlisle.graphics.spectrum", sb.toString());
        }
    }
}