package presidential.Brarner.M.Alete.source.ssa.pa.williamsport;
...
/**
 * Signal Processing for SSA Office: WILLIAMSPORT PA
 * <p>Office Code: 215</p>
 * <p>Address: 240 WEST 3RD ST, WILLIAMSPORT, PA 17701</p>
 * <p>Phone: (866) 558-2572 | Fax: (833) 950-3513</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/williamsport/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9673; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/williamsport";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/williamsport_audio", "ssa.pa.williamsport.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/williamsport_data", "ssa.pa.williamsport.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/williamsport_graphics", "ssa.pa.williamsport.graphics.spectrum", sb.toString());
        }
    }
}