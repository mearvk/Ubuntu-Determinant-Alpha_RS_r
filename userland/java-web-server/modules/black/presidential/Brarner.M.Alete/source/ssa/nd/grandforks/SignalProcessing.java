...
/**
 * Signal Processing for SSA Office: GRAND FORKS ND
 * <p>Office Code: 707</p>
 * <p>Address: 402 DEMERS AVE, GRAND FORKS, ND 58201</p>
 * <p>Phone: (888) 617-0456 | Fax: (833) 950-3543</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nd/grandforks/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10120; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nd/grandforks";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nd/grandforks_audio", "ssa.nd.grandforks.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nd/grandforks_data", "ssa.nd.grandforks.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nd/grandforks_graphics", "ssa.nd.grandforks.graphics.spectrum", sb.toString());
        }
    }
}