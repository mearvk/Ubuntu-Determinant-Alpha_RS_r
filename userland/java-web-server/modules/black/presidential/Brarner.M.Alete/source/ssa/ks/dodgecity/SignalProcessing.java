package presidential.Brarner.M.Alete.source.ssa.ks.dodgecity;
...
/**
 * Signal Processing for SSA Office: DODGE CITY KS
 * <p>Office Code: 771</p>
 * <p>Address: 2204 SUMMERLON CIR, DODGE CITY, KS 67801</p>
 * <p>Phone: (877) 694-5494 | Fax: (833) 950-2334</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ks/dodgecity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10168; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ks/dodgecity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ks/dodgecity_audio", "ssa.ks.dodgecity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ks/dodgecity_data", "ssa.ks.dodgecity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ks/dodgecity_graphics", "ssa.ks.dodgecity.graphics.spectrum", sb.toString());
        }
    }
}