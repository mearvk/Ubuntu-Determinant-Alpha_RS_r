package presidential.Brarner.M.Alete.source.ssa.il.decatur;
...
/**
 * Signal Processing for SSA Office: DECATUR IL
 * <p>Office Code: 506</p>
 * <p>Address: 606 W PERSHING RD, DECATUR, IL 62526</p>
 * <p>Phone: (888) 619-4773 | Fax: (833) 950-3105</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/decatur/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9941; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/decatur";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/decatur_audio", "ssa.il.decatur.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/decatur_data", "ssa.il.decatur.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/decatur_graphics", "ssa.il.decatur.graphics.spectrum", sb.toString());
        }
    }
}