...
/**
 * Signal Processing for SSA Office: ALPENA MI
 * <p>Office Code: 370</p>
 * <p>Address: 111 N 4TH AVE, ALPENA, MI 49707</p>
 * <p>Phone: (877) 452-4195 | Fax: (833) 950-2774</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/alpena/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9817; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/alpena";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/alpena_audio", "ssa.mi.alpena.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/alpena_data", "ssa.mi.alpena.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/alpena_graphics", "ssa.mi.alpena.graphics.spectrum", sb.toString());
        }
    }
}