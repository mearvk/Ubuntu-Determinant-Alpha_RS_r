package presidential.Brarner.M.Alete.source.ssa.nm.riorancho;
...
/**
 * Signal Processing for SSA Office: RIO RANCHO NM
 * <p>Office Code: 00K</p>
 * <p>Address: 4433 JAGER DR NE, RIO RANCHO, NM 87144</p>
 * <p>Phone: (866) 530-7783 | Fax: (833) 950-2394</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nm/riorancho/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9487; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nm/riorancho";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nm/riorancho_audio", "ssa.nm.riorancho.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nm/riorancho_data", "ssa.nm.riorancho.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nm/riorancho_graphics", "ssa.nm.riorancho.graphics.spectrum", sb.toString());
        }
    }
}