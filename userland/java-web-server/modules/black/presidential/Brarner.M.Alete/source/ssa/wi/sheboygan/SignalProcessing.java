package presidential.Brarner.M.Alete.source.ssa.wi.sheboygan;
...
/**
 * Signal Processing for SSA Office: SHEBOYGAN WI
 * <p>Office Code: 543</p>
 * <p>Address: 1137 N 26TH ST, SHEBOYGAN, WI 53081</p>
 * <p>Phone: (877) 635-3549 | Fax: (833) 950-3751</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/sheboygan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9972; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/sheboygan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/sheboygan_audio", "ssa.wi.sheboygan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/sheboygan_data", "ssa.wi.sheboygan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/sheboygan_graphics", "ssa.wi.sheboygan.graphics.spectrum", sb.toString());
        }
    }
}