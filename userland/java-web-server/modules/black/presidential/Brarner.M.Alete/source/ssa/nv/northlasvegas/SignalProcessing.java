...
/**
 * Signal Processing for SSA Office: NORTH LAS VEGAS NV
 * <p>Office Code: D49</p>
 * <p>Address: 4340 SIMMONS STREET, NORTH LAS VEGAS, NV 89032</p>
 * <p>Phone: (866) 614-9667 | Fax: (833) 902-2608</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nv/northlasvegas/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9431; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nv/northlasvegas";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nv/northlasvegas_audio", "ssa.nv.northlasvegas.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nv/northlasvegas_data", "ssa.nv.northlasvegas.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nv/northlasvegas_graphics", "ssa.nv.northlasvegas.graphics.spectrum", sb.toString());
        }
    }
}