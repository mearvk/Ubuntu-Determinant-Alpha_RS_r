...
/**
 * Signal Processing for SSA Office: LITCHFIELD IL
 * <p>Office Code: A56</p>
 * <p>Address: 1107 W FERDON, LITCHFIELD, IL 62056</p>
 * <p>Phone: (877) 319-3077 | Fax: (833) 950-3057</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/litchfield/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9238; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/litchfield";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/litchfield_audio", "ssa.il.litchfield.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/litchfield_data", "ssa.il.litchfield.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/litchfield_graphics", "ssa.il.litchfield.graphics.spectrum", sb.toString());
        }
    }
}