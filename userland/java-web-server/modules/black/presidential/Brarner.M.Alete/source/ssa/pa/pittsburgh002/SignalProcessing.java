...
/**
 * Signal Processing for SSA Office: PITTS EAST LIBERTY PA
 * <p>Office Code: 231</p>
 * <p>Address: 6117 STATION ST, PITTSBURGH, PA 15206</p>
 * <p>Phone: (877) 405-3575 | Fax: (833) 515-0395</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/pittsburgh002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9688; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/pittsburgh002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/pittsburgh002_audio", "ssa.pa.pittsburgh002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/pittsburgh002_data", "ssa.pa.pittsburgh002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/pittsburgh002_graphics", "ssa.pa.pittsburgh002.graphics.spectrum", sb.toString());
        }
    }
}