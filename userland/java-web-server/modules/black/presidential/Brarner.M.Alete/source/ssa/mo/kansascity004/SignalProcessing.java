package presidential.Brarner.M.Alete.source.ssa.mo.kansascity004;
...
/**
 * Signal Processing for SSA Office: KANSAS CITY NORTH
 * <p>Office Code: 777</p>
 * <p>Address: 8620 N GREEN HILLS RD, KANSAS CITY, MO 64154</p>
 * <p>Phone: (877) 805-6671 | Fax: (833) 950-2634</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/kansascity004/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10173; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/kansascity004";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity004_audio", "ssa.mo.kansascity004.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity004_data", "ssa.mo.kansascity004.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity004_graphics", "ssa.mo.kansascity004.graphics.spectrum", sb.toString());
        }
    }
}