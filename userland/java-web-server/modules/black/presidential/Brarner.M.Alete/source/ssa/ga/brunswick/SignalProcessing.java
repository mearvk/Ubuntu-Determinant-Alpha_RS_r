package presidential.Brarner.M.Alete.source.ssa.ga.brunswick;
...
/**
 * Signal Processing for SSA Office: BRUNSWICK GA
 * <p>Office Code: 614</p>
 * <p>Address: 134 JUNIPER CT, BRUNSWICK, GA 31520</p>
 * <p>Phone: (866) 964-6563 | Fax: (833) 950-2866</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/brunswick/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10037; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/brunswick";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/brunswick_audio", "ssa.ga.brunswick.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/brunswick_data", "ssa.ga.brunswick.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/brunswick_graphics", "ssa.ga.brunswick.graphics.spectrum", sb.toString());
        }
    }
}