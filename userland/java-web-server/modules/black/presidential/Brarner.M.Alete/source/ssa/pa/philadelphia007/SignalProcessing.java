package presidential.Brarner.M.Alete.source.ssa.pa.philadelphia007;
...
/**
 * Signal Processing for SSA Office: PHILA-NICETOWN
 * <p>Office Code: 245</p>
 * <p>Address: 2929 NORTH BROAD ST, PHILADELPHIA, PA 19132</p>
 * <p>Phone: (877) 319-0727 | Fax: (833) 612-0140</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/philadelphia007/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9701; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/philadelphia007";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia007_audio", "ssa.pa.philadelphia007.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia007_data", "ssa.pa.philadelphia007.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia007_graphics", "ssa.pa.philadelphia007.graphics.spectrum", sb.toString());
        }
    }
}