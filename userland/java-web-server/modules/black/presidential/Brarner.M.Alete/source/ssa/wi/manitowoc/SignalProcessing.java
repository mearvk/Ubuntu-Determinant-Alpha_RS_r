...
/**
 * Signal Processing for SSA Office: MANITOWOC WI
 * <p>Office Code: 554</p>
 * <p>Address: 1603 MIRRO DR, MANITOWOC, WI 54220</p>
 * <p>Phone: (877) 409-8430 | Fax: (833) 902-2684</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/manitowoc/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9983; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/manitowoc";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/manitowoc_audio", "ssa.wi.manitowoc.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/manitowoc_data", "ssa.wi.manitowoc.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/manitowoc_graphics", "ssa.wi.manitowoc.graphics.spectrum", sb.toString());
        }
    }
}