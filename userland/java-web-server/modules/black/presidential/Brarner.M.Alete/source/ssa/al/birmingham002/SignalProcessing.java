package presidential.Brarner.M.Alete.source.ssa.al.birmingham002;
...
/**
 * Signal Processing for SSA Office: BIRMINGHAM DT AL
 * <p>Office Code: 622</p>
 * <p>Address: 1200 REV ABRAHAM WOODS JR BLVD N, BIRMINGHAM, AL 35285</p>
 * <p>Phone: (866) 592-3734 | Fax: (833) 787-1781</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/birmingham002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10045; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/birmingham002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/birmingham002_audio", "ssa.al.birmingham002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/birmingham002_data", "ssa.al.birmingham002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/birmingham002_graphics", "ssa.al.birmingham002.graphics.spectrum", sb.toString());
        }
    }
}