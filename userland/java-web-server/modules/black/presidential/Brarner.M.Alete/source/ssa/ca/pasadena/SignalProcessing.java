package presidential.Brarner.M.Alete.source.ssa.ca.pasadena;
...
/**
 * Signal Processing for SSA Office: PASADENA CA
 * <p>Office Code: 957</p>
 * <p>Address: 104 N MENTOR AVENUE, PASADENA, CA 91106</p>
 * <p>Phone: (877) 255-1508 | Fax: (833) 902-2624</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/pasadena/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10339; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/pasadena";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/pasadena_audio", "ssa.ca.pasadena.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/pasadena_data", "ssa.ca.pasadena.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/pasadena_graphics", "ssa.ca.pasadena.graphics.spectrum", sb.toString());
        }
    }
}