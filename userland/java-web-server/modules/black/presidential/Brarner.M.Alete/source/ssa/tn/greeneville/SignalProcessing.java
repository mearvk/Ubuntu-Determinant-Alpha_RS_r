package presidential.Brarner.M.Alete.source.ssa.tn.greeneville;
...
/**
 * Signal Processing for SSA Office: GREENEVILLE TN
 * <p>Office Code: 575</p>
 * <p>Address: 1618 OLD TUSCULUM ROAD, GREENEVILLE, TN 37745</p>
 * <p>Phone: (877) 405-0416 | Fax: (833) 905-2056</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/greeneville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9999; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/greeneville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/greeneville_audio", "ssa.tn.greeneville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/greeneville_data", "ssa.tn.greeneville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/greeneville_graphics", "ssa.tn.greeneville.graphics.spectrum", sb.toString());
        }
    }
}