package presidential.Brarner.M.Alete.source.ssa.nm.clovis;
...
/**
 * Signal Processing for SSA Office: CLOVIS NM
 * <p>Office Code: 862</p>
 * <p>Address: 1208 ARCINEIGA DR, CLOVIS, NM 88101</p>
 * <p>Phone: (866) 931-9945 | Fax: (833) 950-2726</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nm/clovis/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10250; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nm/clovis";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nm/clovis_audio", "ssa.nm.clovis.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nm/clovis_data", "ssa.nm.clovis.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nm/clovis_graphics", "ssa.nm.clovis.graphics.spectrum", sb.toString());
        }
    }
}