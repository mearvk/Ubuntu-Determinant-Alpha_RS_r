package presidential.Brarner.M.Alete.source.ssa.fl.westpalmbeach;
...
/**
 * Signal Processing for SSA Office: WEST PALM BEACH FL
 * <p>Office Code: 661</p>
 * <p>Address: 801 CLEMATIS STREET, WEST PALM BEACH, FL 33401</p>
 * <p>Phone: (866) 783-7339 | Fax: (833) 679-0242</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/westpalmbeach/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10080; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/westpalmbeach";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/westpalmbeach_audio", "ssa.fl.westpalmbeach.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/westpalmbeach_data", "ssa.fl.westpalmbeach.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/westpalmbeach_graphics", "ssa.fl.westpalmbeach.graphics.spectrum", sb.toString());
        }
    }
}