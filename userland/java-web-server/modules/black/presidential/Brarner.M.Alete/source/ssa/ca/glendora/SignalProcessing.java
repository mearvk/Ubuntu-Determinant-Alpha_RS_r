package presidential.Brarner.M.Alete.source.ssa.ca.glendora;
...
/**
 * Signal Processing for SSA Office: GLENDORA CA
 * <p>Office Code: E31</p>
 * <p>Address: 1165 E ROUTE 66, GLENDORA, CA 91740</p>
 * <p>Phone: (866) 964-6045 | Fax: (833) 940-1987</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/glendora/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9462; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/glendora";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/glendora_audio", "ssa.ca.glendora.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/glendora_data", "ssa.ca.glendora.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/glendora_graphics", "ssa.ca.glendora.graphics.spectrum", sb.toString());
        }
    }
}