package presidential.Brarner.M.Alete.source.ssa.la.bogalusa;
...
/**
 * Signal Processing for SSA Office: BOGALUSA LA
 * <p>Office Code: A69</p>
 * <p>Address: 438 AVENUE B, BOGALUSA, LA 70427</p>
 * <p>Phone: (888) 748-7678 | Fax: (833) 902-2566</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/bogalusa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9250; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/bogalusa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/bogalusa_audio", "ssa.la.bogalusa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/bogalusa_data", "ssa.la.bogalusa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/bogalusa_graphics", "ssa.la.bogalusa.graphics.spectrum", sb.toString());
        }
    }
}