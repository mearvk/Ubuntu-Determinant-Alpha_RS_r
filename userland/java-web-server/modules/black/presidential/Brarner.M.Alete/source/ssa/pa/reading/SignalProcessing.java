package presidential.Brarner.M.Alete.source.ssa.pa.reading;
...
/**
 * Signal Processing for SSA Office: READING PA
 * <p>Office Code: 203</p>
 * <p>Address: 201 PENN ST, READING, PA 19601</p>
 * <p>Phone: (866) 274-5960 | Fax: (833) 950-2888</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/reading/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9661; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/reading";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/reading_audio", "ssa.pa.reading.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/reading_data", "ssa.pa.reading.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/reading_graphics", "ssa.pa.reading.graphics.spectrum", sb.toString());
        }
    }
}