package presidential.Brarner.M.Alete.source.ssa.il.chicago002;
...
/**
 * Signal Processing for SSA Office: CHICAGO LOOP IL
 * <p>Office Code: 485</p>
 * <p>Address: 605 W WASHINGTON BLVD, CHICAGO, IL 60661</p>
 * <p>Phone: (866) 739-4765 | Fax: (833) 787-1783</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/chicago002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9920; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/chicago002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago002_audio", "ssa.il.chicago002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago002_data", "ssa.il.chicago002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/chicago002_graphics", "ssa.il.chicago002.graphics.spectrum", sb.toString());
        }
    }
}