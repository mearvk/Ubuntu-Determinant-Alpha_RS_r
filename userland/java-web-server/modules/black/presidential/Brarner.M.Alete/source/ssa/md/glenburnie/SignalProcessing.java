...
/**
 * Signal Processing for SSA Office: GLEN BURNIE MD
 * <p>Office Code: 283</p>
 * <p>Address: 337 HOSPITAL DR, GLEN BURNIE, MD 21061</p>
 * <p>Phone: (866) 528-9873 | Fax: (833) 597-0157</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/glenburnie/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9733; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/glenburnie";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/glenburnie_audio", "ssa.md.glenburnie.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/glenburnie_data", "ssa.md.glenburnie.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/glenburnie_graphics", "ssa.md.glenburnie.graphics.spectrum", sb.toString());
        }
    }
}