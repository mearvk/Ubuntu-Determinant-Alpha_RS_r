package presidential.Brarner.M.Alete.source.ssa.ma.salem;
...
/**
 * Signal Processing for SSA Office: SALEM MA
 * <p>Office Code: 46</p>
 * <p>Address: 35 CONGRESS ST, SALEM, MA 1970</p>
 * <p>Phone: (866) 248-2394 | Fax: (833) 926-1841</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/salem/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9528; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/salem";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/salem_audio", "ssa.ma.salem.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/salem_data", "ssa.ma.salem.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/salem_graphics", "ssa.ma.salem.graphics.spectrum", sb.toString());
        }
    }
}