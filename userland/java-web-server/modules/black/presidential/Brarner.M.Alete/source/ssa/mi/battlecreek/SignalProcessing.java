package presidential.Brarner.M.Alete.source.ssa.mi.battlecreek;
...
/**
 * Signal Processing for SSA Office: BATTLE CREEK MI
 * <p>Office Code: 359</p>
 * <p>Address: 5700 BECKLEY RD, BATTLE CREEK, MI 49015</p>
 * <p>Phone: (877) 445-0829 | Fax: (833) 950-2462</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/battlecreek/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9806; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/battlecreek";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/battlecreek_audio", "ssa.mi.battlecreek.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/battlecreek_data", "ssa.mi.battlecreek.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/battlecreek_graphics", "ssa.mi.battlecreek.graphics.spectrum", sb.toString());
        }
    }
}