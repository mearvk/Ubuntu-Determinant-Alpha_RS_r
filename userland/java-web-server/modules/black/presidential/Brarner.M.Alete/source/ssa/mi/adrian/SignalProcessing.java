package presidential.Brarner.M.Alete.source.ssa.mi.adrian;
...
/**
 * Signal Processing for SSA Office: ADRIAN MI
 * <p>Office Code: B31</p>
 * <p>Address: 1040 S WINTER ST, ADRIAN, MI 49221</p>
 * <p>Phone: (877) 512-5943 | Fax: (833) 950-3401</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/adrian/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9298; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/adrian";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/adrian_audio", "ssa.mi.adrian.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/adrian_data", "ssa.mi.adrian.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/adrian_graphics", "ssa.mi.adrian.graphics.spectrum", sb.toString());
        }
    }
}