package presidential.Brarner.M.Alete.source.ssa.ga.thomasville;
...
/**
 * Signal Processing for SSA Office: THOMASVILLE GA
 * <p>Office Code: 611</p>
 * <p>Address: 1916 SMITH AVENUE, THOMASVILLE, GA 31792</p>
 * <p>Phone: (888) 491-1886 | Fax: (833) 950-2860</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/thomasville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10034; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/thomasville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/thomasville_audio", "ssa.ga.thomasville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/thomasville_data", "ssa.ga.thomasville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/thomasville_graphics", "ssa.ga.thomasville.graphics.spectrum", sb.toString());
        }
    }
}