package presidential.Brarner.M.Alete.source.ssa.pa.lewistown;
...
/**
 * Signal Processing for SSA Office: LEWISTOWN PA
 * <p>Office Code: A94</p>
 * <p>Address: 208 WEST 3RD STREET, LEWISTOWN, PA 17044</p>
 * <p>Phone: (888) 306-4336 | Fax: (833) 950-2580</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/lewistown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9268; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/lewistown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/lewistown_audio", "ssa.pa.lewistown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/lewistown_data", "ssa.pa.lewistown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/lewistown_graphics", "ssa.pa.lewistown.graphics.spectrum", sb.toString());
        }
    }
}