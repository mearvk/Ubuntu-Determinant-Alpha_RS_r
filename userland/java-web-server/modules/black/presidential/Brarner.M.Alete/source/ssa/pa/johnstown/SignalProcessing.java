package presidential.Brarner.M.Alete.source.ssa.pa.johnstown;
...
/**
 * Signal Processing for SSA Office: JOHNSTOWN PA
 * <p>Office Code: 214</p>
 * <p>Address: 334 WASHINGTON ST, JOHNSTOWN, PA 15901</p>
 * <p>Phone: (866) 331-7128 | Fax: (833) 950-3195</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/johnstown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9672; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/johnstown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/johnstown_audio", "ssa.pa.johnstown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/johnstown_data", "ssa.pa.johnstown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/johnstown_graphics", "ssa.pa.johnstown.graphics.spectrum", sb.toString());
        }
    }
}