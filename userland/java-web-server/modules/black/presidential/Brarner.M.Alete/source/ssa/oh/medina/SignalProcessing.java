package presidential.Brarner.M.Alete.source.ssa.oh.medina;
...
/**
 * Signal Processing for SSA Office: MEDINA OH
 * <p>Office Code: B30</p>
 * <p>Address: 4035 N JEFFERSON ST, MEDINA, OH 44256</p>
 * <p>Phone: (866) 613-2774 | Fax: (833) 950-3399</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/medina/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9297; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/medina";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/medina_audio", "ssa.oh.medina.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/medina_data", "ssa.oh.medina.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/medina_graphics", "ssa.oh.medina.graphics.spectrum", sb.toString());
        }
    }
}