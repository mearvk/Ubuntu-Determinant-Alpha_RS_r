...
/**
 * Signal Processing for SSA Office: CENTRALIA WA
 * <p>Office Code: D54</p>
 * <p>Address: 1821 COOKS HILL RD, CENTRALIA, WA 98531</p>
 * <p>Phone: (855) 848-7942 | Fax: (833) 950-3555</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/centralia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9436; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/centralia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/centralia_audio", "ssa.wa.centralia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/centralia_data", "ssa.wa.centralia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/centralia_graphics", "ssa.wa.centralia.graphics.spectrum", sb.toString());
        }
    }
}