package presidential.Brarner.M.Alete.source.ssa.nc.wilson;
...
/**
 * Signal Processing for SSA Office: WILSON NC
 * <p>Office Code: A49</p>
 * <p>Address: 1911 WESTWOOD AVE W, WILSON, NC 27893</p>
 * <p>Phone: (866) 366-5804 | Fax: (833) 950-2530</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/wilson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9234; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/wilson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/wilson_audio", "ssa.nc.wilson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/wilson_data", "ssa.nc.wilson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/wilson_graphics", "ssa.nc.wilson.graphics.spectrum", sb.toString());
        }
    }
}