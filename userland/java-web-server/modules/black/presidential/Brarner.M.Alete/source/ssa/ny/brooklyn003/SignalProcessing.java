package presidential.Brarner.M.Alete.source.ssa.ny.brooklyn003;
...
/**
 * Signal Processing for SSA Office: BROOKLYN FLATBUSH NY
 * <p>Office Code: 127</p>
 * <p>Address: 672 PARKSIDE AVE, BROOKLYN, NY 11226</p>
 * <p>Phone: (866) 563-9461 | Fax: (833) 902-2544</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/brooklyn003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9597; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/brooklyn003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn003_audio", "ssa.ny.brooklyn003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn003_data", "ssa.ny.brooklyn003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn003_graphics", "ssa.ny.brooklyn003.graphics.spectrum", sb.toString());
        }
    }
}