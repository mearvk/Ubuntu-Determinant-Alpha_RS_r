package presidential.Brarner.M.Alete.source.ssa.oh.lorain;
...
/**
 * Signal Processing for SSA Office: LORAIN OH
 * <p>Office Code: 391</p>
 * <p>Address: 221 W 5TH ST, LORAIN, OH 44052</p>
 * <p>Phone: (866) 415-0172 | Fax: (833) 950-3083</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/lorain/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9832; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/lorain";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/lorain_audio", "ssa.oh.lorain.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/lorain_data", "ssa.oh.lorain.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/lorain_graphics", "ssa.oh.lorain.graphics.spectrum", sb.toString());
        }
    }
}