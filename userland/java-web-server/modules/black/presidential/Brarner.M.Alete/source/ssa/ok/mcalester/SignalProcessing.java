package presidential.Brarner.M.Alete.source.ssa.ok.mcalester;
...
/**
 * Signal Processing for SSA Office: McAlester OK
 * <p>Office Code: 793</p>
 * <p>Address: 902 S GEORGE NIGH EXPY, MCALESTER, OK 74501</p>
 * <p>Phone: (877) 893-4665 | Fax: (833) 950-3339</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/mcalester/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10187; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/mcalester";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/mcalester_audio", "ssa.ok.mcalester.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/mcalester_data", "ssa.ok.mcalester.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/mcalester_graphics", "ssa.ok.mcalester.graphics.spectrum", sb.toString());
        }
    }
}