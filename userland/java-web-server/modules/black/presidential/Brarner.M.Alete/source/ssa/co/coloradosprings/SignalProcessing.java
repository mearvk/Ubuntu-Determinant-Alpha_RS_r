package presidential.Brarner.M.Alete.source.ssa.co.coloradosprings;
...
/**
 * Signal Processing for SSA Office: COLORADO SPRINGS CO
 * <p>Office Code: 887</p>
 * <p>Address: 2306 E PIKES PEAK AVE, COLORADO SPRINGS, CO 80909</p>
 * <p>Phone: (888) 880-0688 | Fax: (833) 641-2553</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/co/coloradosprings/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10272; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/co/coloradosprings";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_co/coloradosprings_audio", "ssa.co.coloradosprings.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_co/coloradosprings_data", "ssa.co.coloradosprings.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_co/coloradosprings_graphics", "ssa.co.coloradosprings.graphics.spectrum", sb.toString());
        }
    }
}