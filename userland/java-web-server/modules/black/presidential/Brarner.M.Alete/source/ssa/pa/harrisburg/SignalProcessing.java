package presidential.Brarner.M.Alete.source.ssa.pa.harrisburg;
...
/**
 * Signal Processing for SSA Office: HARRISBURG PA
 * <p>Office Code: 204</p>
 * <p>Address: 555 WALNUT STREET, HARRISBURG, PA 17101</p>
 * <p>Phone: (888) 327-1176 | Fax: (833) 950-2890</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/harrisburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9662; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/harrisburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/harrisburg_audio", "ssa.pa.harrisburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/harrisburg_data", "ssa.pa.harrisburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/harrisburg_graphics", "ssa.pa.harrisburg.graphics.spectrum", sb.toString());
        }
    }
}