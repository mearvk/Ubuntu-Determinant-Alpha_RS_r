package presidential.Brarner.M.Alete.source.ssa.id.caldwell;
...
/**
 * Signal Processing for SSA Office: CALDWELL ID
 * <p>Office Code: 899</p>
 * <p>Address: 1118 S KIMBALL AVE, CALDWELL, ID 83605</p>
 * <p>Phone: (877) 836-1560 | Fax: (833) 950-2310</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/id/caldwell/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10283; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/id/caldwell";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_id/caldwell_audio", "ssa.id.caldwell.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_id/caldwell_data", "ssa.id.caldwell.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_id/caldwell_graphics", "ssa.id.caldwell.graphics.spectrum", sb.toString());
        }
    }
}