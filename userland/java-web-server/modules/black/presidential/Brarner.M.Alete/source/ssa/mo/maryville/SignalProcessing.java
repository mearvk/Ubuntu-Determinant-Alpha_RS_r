package presidential.Brarner.M.Alete.source.ssa.mo.maryville;
...
/**
 * Signal Processing for SSA Office: MARYVILLE MO
 * <p>Office Code: C53</p>
 * <p>Address: 518 W SOUTH HILLS DR, MARYVILLE, MO 64468</p>
 * <p>Phone: (877) 833-2731 | Fax: (833) 950-2942</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/maryville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9370; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/maryville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/maryville_audio", "ssa.mo.maryville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/maryville_data", "ssa.mo.maryville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/maryville_graphics", "ssa.mo.maryville.graphics.spectrum", sb.toString());
        }
    }
}