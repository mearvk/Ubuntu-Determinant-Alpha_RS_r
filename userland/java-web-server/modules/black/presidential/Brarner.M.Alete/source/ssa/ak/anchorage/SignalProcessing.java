package presidential.Brarner.M.Alete.source.ssa.ak.anchorage;
...
/**
 * Signal Processing for SSA Office: ANCHORAGE AK
 * <p>Office Code: 997</p>
 * <p>Address: 222 W 8TH AVE, ANCHORAGE, AK 99513</p>
 * <p>Phone: (866) 772-3081 | Fax: (833) 950-2930</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ak/anchorage/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10374; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ak/anchorage";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ak/anchorage_audio", "ssa.ak.anchorage.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ak/anchorage_data", "ssa.ak.anchorage.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ak/anchorage_graphics", "ssa.ak.anchorage.graphics.spectrum", sb.toString());
        }
    }
}