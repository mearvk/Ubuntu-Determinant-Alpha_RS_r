package presidential.Brarner.M.Alete.source.ssa.va.southboston;
...
/**
 * Signal Processing for SSA Office: SOUTH BOSTON VA
 * <p>Office Code: 304</p>
 * <p>Address: 2049 HAMILTON BLVD, SOUTH BOSTON, VA 24592</p>
 * <p>Phone: (888) 327-1407 | Fax: (833) 950-2604</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/southboston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9754; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/southboston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/southboston_audio", "ssa.va.southboston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/southboston_data", "ssa.va.southboston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/southboston_graphics", "ssa.va.southboston.graphics.spectrum", sb.toString());
        }
    }
}