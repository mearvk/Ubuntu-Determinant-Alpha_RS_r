package presidential.Brarner.M.Alete.source.ssa.ma.springfield;
...
/**
 * Signal Processing for SSA Office: SPRINGFIELD MA
 * <p>Office Code: 31</p>
 * <p>Address: 70 BOND STREET, SPRINGFIELD, MA 1104</p>
 * <p>Phone: (866) 964-5061 | Fax: (833) 515-0459</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/springfield/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9514; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/springfield";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/springfield_audio", "ssa.ma.springfield.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/springfield_data", "ssa.ma.springfield.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/springfield_graphics", "ssa.ma.springfield.graphics.spectrum", sb.toString());
        }
    }
}