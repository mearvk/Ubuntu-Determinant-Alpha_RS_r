package presidential.Brarner.M.Alete.source.ssa.ca.oroville;
...
/**
 * Signal Processing for SSA Office: OROVILLE CA
 * <p>Office Code: E27</p>
 * <p>Address: 115 TABLE MOUNTAIN BL, OROVILLE, CA 95965</p>
 * <p>Phone: (866) 331-7130 | Fax: (833) 902-2614</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/oroville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9459; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/oroville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/oroville_audio", "ssa.ca.oroville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/oroville_data", "ssa.ca.oroville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/oroville_graphics", "ssa.ca.oroville.graphics.spectrum", sb.toString());
        }
    }
}