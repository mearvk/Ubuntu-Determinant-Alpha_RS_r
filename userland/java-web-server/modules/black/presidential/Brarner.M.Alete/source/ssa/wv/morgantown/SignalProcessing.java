package presidential.Brarner.M.Alete.source.ssa.wv.morgantown;
...
/**
 * Signal Processing for SSA Office: MORGANTOWN WV
 * <p>Office Code: 312</p>
 * <p>Address: 3596 COLLINS FERRY RD, MORGANTOWN, WV 26505</p>
 * <p>Phone: (866) 770-2055 | Fax: (833) 950-2265</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/morgantown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9762; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/morgantown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/morgantown_audio", "ssa.wv.morgantown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/morgantown_data", "ssa.wv.morgantown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/morgantown_graphics", "ssa.wv.morgantown.graphics.spectrum", sb.toString());
        }
    }
}