package presidential.Brarner.M.Alete.source.ssa.mi.pontiac;
...
/**
 * Signal Processing for SSA Office: PONTIAC MI
 * <p>Office Code: 350</p>
 * <p>Address: 1280 PONTIAC RD, PONTIAC, MI 48340</p>
 * <p>Phone: (866) 299-3777 | Fax: (833) 950-2122</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/pontiac/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9797; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/pontiac";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/pontiac_audio", "ssa.mi.pontiac.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/pontiac_data", "ssa.mi.pontiac.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/pontiac_graphics", "ssa.mi.pontiac.graphics.spectrum", sb.toString());
        }
    }
}