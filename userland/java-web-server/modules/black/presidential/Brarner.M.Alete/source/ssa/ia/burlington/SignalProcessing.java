package presidential.Brarner.M.Alete.source.ssa.ia.burlington;
...
/**
 * Signal Processing for SSA Office: BURLINGTON IA
 * <p>Office Code: 699</p>
 * <p>Address: 3920 DIVISION ST, BURLINGTON, IA 52601</p>
 * <p>Phone: (866) 338-4183 | Fax: (833) 515-0437</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/burlington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10113; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/burlington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/burlington_audio", "ssa.ia.burlington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/burlington_data", "ssa.ia.burlington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/burlington_graphics", "ssa.ia.burlington.graphics.spectrum", sb.toString());
        }
    }
}