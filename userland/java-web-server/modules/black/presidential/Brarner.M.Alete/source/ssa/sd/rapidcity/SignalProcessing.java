package presidential.Brarner.M.Alete.source.ssa.sd.rapidcity;
...
/**
 * Signal Processing for SSA Office: RAPID CITY SD
 * <p>Office Code: 717</p>
 * <p>Address: 2200 NORTH MAPLE AVE, RAPID CITY, SD 57701</p>
 * <p>Phone: (866) 964-7416 | Fax: (833) 950-3551</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sd/rapidcity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10126; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sd/rapidcity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sd/rapidcity_audio", "ssa.sd.rapidcity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sd/rapidcity_data", "ssa.sd.rapidcity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sd/rapidcity_graphics", "ssa.sd.rapidcity.graphics.spectrum", sb.toString());
        }
    }
}