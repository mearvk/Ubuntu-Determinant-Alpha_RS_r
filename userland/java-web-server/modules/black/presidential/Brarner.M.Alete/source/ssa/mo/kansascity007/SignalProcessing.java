package presidential.Brarner.M.Alete.source.ssa.mo.kansascity007;
...
/**
 * Signal Processing for SSA Office: FOSU West - Branch 4
 * <p>Office Code: 6K7</p>
 * <p>Address: 601 E 12TH ST, KANSAS CITY, MO 64106</p>
 * <p>Phone: (877) 685-5942 | Fax: (833) 551-0603</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/kansascity007/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10380; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/kansascity007";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity007_audio", "ssa.mo.kansascity007.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity007_data", "ssa.mo.kansascity007.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity007_graphics", "ssa.mo.kansascity007.graphics.spectrum", sb.toString());
        }
    }
}