package presidential.Brarner.M.Alete.source.ssa.pr.arecibo;
...
/**
 * Signal Processing for SSA Office: ARECIBO PR
 * <p>Office Code: 280</p>
 * <p>Address: 880 ISAAC CRUZ STGO ST, ARECIBO, PR 612</p>
 * <p>Phone: (866) 754-3541 | Fax: (833) 950-3613</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pr/arecibo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9730; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pr/arecibo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pr/arecibo_audio", "ssa.pr.arecibo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pr/arecibo_data", "ssa.pr.arecibo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pr/arecibo_graphics", "ssa.pr.arecibo.graphics.spectrum", sb.toString());
        }
    }
}