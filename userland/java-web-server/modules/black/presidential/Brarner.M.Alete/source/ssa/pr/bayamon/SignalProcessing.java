package presidential.Brarner.M.Alete.source.ssa.pr.bayamon;
...
/**
 * Signal Processing for SSA Office: HATO TEJAS PR
 * <p>Office Code: B00</p>
 * <p>Address: 7 FL, ROAD 2 KM 12.3, BAYAMON, PR 959</p>
 * <p>Phone: (855) 748-7638 | Fax: (833) 950-2960</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pr/bayamon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9273; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pr/bayamon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pr/bayamon_audio", "ssa.pr.bayamon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pr/bayamon_data", "ssa.pr.bayamon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pr/bayamon_graphics", "ssa.pr.bayamon.graphics.spectrum", sb.toString());
        }
    }
}