package presidential.Brarner.M.Alete.source.ssa.oh.toledo002;
...
/**
 * Signal Processing for SSA Office: TOLEDO OH DT
 * <p>Office Code: 395</p>
 * <p>Address: 433 N SUMMIT ST, TOLEDO, OH 43604</p>
 * <p>Phone: (866) 331-2196 | Fax: (833) 950-3091</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/toledo002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9836; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/toledo002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/toledo002_audio", "ssa.oh.toledo002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/toledo002_data", "ssa.oh.toledo002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/toledo002_graphics", "ssa.oh.toledo002.graphics.spectrum", sb.toString());
        }
    }
}