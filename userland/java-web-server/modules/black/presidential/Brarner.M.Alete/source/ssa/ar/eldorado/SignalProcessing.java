package presidential.Brarner.M.Alete.source.ssa.ar.eldorado;
...
/**
 * Signal Processing for SSA Office: EL DORADO AR
 * <p>Office Code: 761</p>
 * <p>Address: 2600 W HILLSBORO, EL DORADO, AR 71730</p>
 * <p>Phone: (866) 526-9254 | Fax: (833) 950-2708</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/eldorado/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10159; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/eldorado";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/eldorado_audio", "ssa.ar.eldorado.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/eldorado_data", "ssa.ar.eldorado.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/eldorado_graphics", "ssa.ar.eldorado.graphics.spectrum", sb.toString());
        }
    }
}