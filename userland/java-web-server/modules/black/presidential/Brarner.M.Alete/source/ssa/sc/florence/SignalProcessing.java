package presidential.Brarner.M.Alete.source.ssa.sc.florence;
...
/**
 * Signal Processing for SSA Office: FLORENCE SC
 * <p>Office Code: 587</p>
 * <p>Address: 181 DOZIER BLVD, FLORENCE, SC 29501</p>
 * <p>Phone: (888) 385-1173 | Fax: (833) 950-2233</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/florence/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10011; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/florence";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/florence_audio", "ssa.sc.florence.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/florence_data", "ssa.sc.florence.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/florence_graphics", "ssa.sc.florence.graphics.spectrum", sb.toString());
        }
    }
}