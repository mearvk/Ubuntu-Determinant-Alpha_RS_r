...
/**
 * Signal Processing for SSA Office: SANDUSKY OH
 * <p>Office Code: 409</p>
 * <p>Address: 252 WAYNE STREET, SANDUSKY, OH 44870</p>
 * <p>Phone: (866) 588-7397 | Fax: (833) 950-3715</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/sandusky/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9850; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/sandusky";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/sandusky_audio", "ssa.oh.sandusky.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/sandusky_data", "ssa.oh.sandusky.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/sandusky_graphics", "ssa.oh.sandusky.graphics.spectrum", sb.toString());
        }
    }
}