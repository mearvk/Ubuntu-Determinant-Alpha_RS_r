package presidential.Brarner.M.Alete.source.ssa.ny.westbabylon;
...
/**
 * Signal Processing for SSA Office: WEST BABYLON NY
 * <p>Office Code: B97</p>
 * <p>Address: 510 PARK AVENUE, WEST BABYLON, NY 11704</p>
 * <p>Phone: (866) 964-7375 | Fax: (833) 950-2970</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/westbabylon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9341; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/westbabylon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/westbabylon_audio", "ssa.ny.westbabylon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/westbabylon_data", "ssa.ny.westbabylon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/westbabylon_graphics", "ssa.ny.westbabylon.graphics.spectrum", sb.toString());
        }
    }
}