package presidential.Brarner.M.Alete.source.ssa.wi.appleton;
...
/**
 * Signal Processing for SSA Office: APPLETON WI
 * <p>Office Code: 549</p>
 * <p>Address: 607 W NORTHLAND AVE, APPLETON, WI 54911</p>
 * <p>Phone: (877) 694-5495 | Fax: (833) 596-0603</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/appleton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9978; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/appleton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/appleton_audio", "ssa.wi.appleton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/appleton_data", "ssa.wi.appleton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/appleton_graphics", "ssa.wi.appleton.graphics.spectrum", sb.toString());
        }
    }
}