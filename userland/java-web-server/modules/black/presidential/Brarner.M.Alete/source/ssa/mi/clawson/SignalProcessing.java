package presidential.Brarner.M.Alete.source.ssa.mi.clawson;
...
/**
 * Signal Processing for SSA Office: CLAWSON MI
 * <p>Office Code: 375</p>
 * <p>Address: 140 NORTH CROOKS, CLAWSON, MI 48017</p>
 * <p>Phone: (888) 456-9559 | Fax: (833) 950-2784</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/clawson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9820; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/clawson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/clawson_audio", "ssa.mi.clawson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/clawson_data", "ssa.mi.clawson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/clawson_graphics", "ssa.mi.clawson.graphics.spectrum", sb.toString());
        }
    }
}