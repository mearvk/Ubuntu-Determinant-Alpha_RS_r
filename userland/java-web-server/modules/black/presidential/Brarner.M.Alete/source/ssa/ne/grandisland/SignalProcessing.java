...
/**
 * Signal Processing for SSA Office: GRAND ISLAND NE
 * <p>Office Code: 728</p>
 * <p>Address: 115 N WEBB RD, GRAND ISLAND, NE 68803</p>
 * <p>Phone: (877) 407-3441 | Fax: (833) 902-2492</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ne/grandisland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10133; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ne/grandisland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ne/grandisland_audio", "ssa.ne.grandisland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ne/grandisland_data", "ssa.ne.grandisland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ne/grandisland_graphics", "ssa.ne.grandisland.graphics.spectrum", sb.toString());
        }
    }
}