package presidential.Brarner.M.Alete.source.ssa.ny.oswego;
...
/**
 * Signal Processing for SSA Office: OSWEGO NY
 * <p>Office Code: 123</p>
 * <p>Address: 17 FOURTH AVE, OSWEGO, NY 13126</p>
 * <p>Phone: (866) 964-7593 | Fax: (833) 902-2538</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/oswego/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9594; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/oswego";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/oswego_audio", "ssa.ny.oswego.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/oswego_data", "ssa.ny.oswego.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/oswego_graphics", "ssa.ny.oswego.graphics.spectrum", sb.toString());
        }
    }
}