package presidential.Brarner.M.Alete.source.ssa.fl.jacksonville002;
...
/**
 * Signal Processing for SSA Office: JACKSONVILLE SOUTH FL
 * <p>Office Code: 655</p>
 * <p>Address: 7185 BENTLEY ROAD, JACKSONVILLE, FL 32256</p>
 * <p>Phone: (877) 409-8424 | Fax: (833) 554-0369</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/jacksonville002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10074; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/jacksonville002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/jacksonville002_audio", "ssa.fl.jacksonville002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/jacksonville002_data", "ssa.fl.jacksonville002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/jacksonville002_graphics", "ssa.fl.jacksonville002.graphics.spectrum", sb.toString());
        }
    }
}