package presidential.Brarner.M.Alete.source.ssa.md.baltimore005;
...
/**
 * Signal Processing for SSA Office: BALTIMORE DTN MD
 * <p>Office Code: 273</p>
 * <p>Address: 1010 PARK AVE, BALTIMORE, MD 21201</p>
 * <p>Phone: (866) 931-9942 | Fax: (833) 597-0140</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/baltimore005/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9723; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/baltimore005";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/baltimore005_audio", "ssa.md.baltimore005.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/baltimore005_data", "ssa.md.baltimore005.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/baltimore005_graphics", "ssa.md.baltimore005.graphics.spectrum", sb.toString());
        }
    }
}