package presidential.Brarner.M.Alete.source.ssa.me.saco;
...
/**
 * Signal Processing for SSA Office: SACO ME
 * <p>Office Code: A24</p>
 * <p>Address: 110 MAIN ST, SACO, ME 4072</p>
 * <p>Phone: (877) 253-4715 | Fax: (833) 950-3248</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/me/saco/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9213; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/me/saco";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_me/saco_audio", "ssa.me.saco.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_me/saco_data", "ssa.me.saco.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_me/saco_graphics", "ssa.me.saco.graphics.spectrum", sb.toString());
        }
    }
}