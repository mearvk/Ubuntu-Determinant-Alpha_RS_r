package presidential.Brarner.M.Alete.source.ssa.fl.portstlucie;
...
/**
 * Signal Processing for SSA Office: PORT ST LUCIE FL
 * <p>Office Code: 256</p>
 * <p>Address: 6810 S US HWY 1, PORT ST LUCIE, FL 34952</p>
 * <p>Phone: (866) 366-1627 | Fax: (833) 950-2202</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/portstlucie/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9710; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/portstlucie";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/portstlucie_audio", "ssa.fl.portstlucie.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/portstlucie_data", "ssa.fl.portstlucie.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/portstlucie_graphics", "ssa.fl.portstlucie.graphics.spectrum", sb.toString());
        }
    }
}