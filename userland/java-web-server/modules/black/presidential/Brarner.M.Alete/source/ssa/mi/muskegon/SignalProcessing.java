package presidential.Brarner.M.Alete.source.ssa.mi.muskegon;
...
/**
 * Signal Processing for SSA Office: MUSKEGON MI
 * <p>Office Code: 360</p>
 * <p>Address: 340 MORRIS AVENUE, MUSKEGON, MI 49440</p>
 * <p>Phone: (866) 763-2632 | Fax: (833) 950-2464</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/muskegon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9807; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/muskegon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/muskegon_audio", "ssa.mi.muskegon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/muskegon_data", "ssa.mi.muskegon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/muskegon_graphics", "ssa.mi.muskegon.graphics.spectrum", sb.toString());
        }
    }
}