package presidential.Brarner.M.Alete.source.ssa.ar.jonesboro;
...
/**
 * Signal Processing for SSA Office: JONESBORO AR
 * <p>Office Code: 758</p>
 * <p>Address: 1809 LATOURETTE DRIVE, JONESBORO, AR 72404</p>
 * <p>Phone: (866) 842-7369 | Fax: (833) 950-2702</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/jonesboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10156; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/jonesboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/jonesboro_audio", "ssa.ar.jonesboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/jonesboro_data", "ssa.ar.jonesboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/jonesboro_graphics", "ssa.ar.jonesboro.graphics.spectrum", sb.toString());
        }
    }
}