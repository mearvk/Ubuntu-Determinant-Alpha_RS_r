...
/**
 * Signal Processing for SSA Office: GREENBELT MD
 * <p>Office Code: C07</p>
 * <p>Address: 7401 FORBES BLVD, SEABROOK, MD 20706</p>
 * <p>Phone: (866) 338-4115 | Fax: (833) 341-2706</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/seabrook/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9345; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/seabrook";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/seabrook_audio", "ssa.md.seabrook.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/seabrook_data", "ssa.md.seabrook.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/seabrook_graphics", "ssa.md.seabrook.graphics.spectrum", sb.toString());
        }
    }
}