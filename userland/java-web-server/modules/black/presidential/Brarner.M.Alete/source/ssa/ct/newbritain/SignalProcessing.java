...
/**
 * Signal Processing for SSA Office: NEW BRITAIN CT
 * <p>Office Code: 86</p>
 * <p>Address: 1 HERALD SQUARE, NEW BRITAIN, CT 6051</p>
 * <p>Phone: (866) 858-6086 | Fax: (833) 950-2656</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ct/newbritain/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9558; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ct/newbritain";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ct/newbritain_audio", "ssa.ct.newbritain.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ct/newbritain_data", "ssa.ct.newbritain.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ct/newbritain_graphics", "ssa.ct.newbritain.graphics.spectrum", sb.toString());
        }
    }
}