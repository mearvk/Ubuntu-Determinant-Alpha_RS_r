package presidential.Brarner.M.Alete.source.ssa.or.warrenton;
...
/**
 * Signal Processing for SSA Office: WARRENTON OR
 * <p>Office Code: D52</p>
 * <p>Address: 1479 SE DISCOVERY LN, WARRENTON, OR 97146</p>
 * <p>Phone: (877) 840-5743 | Fax: (833) 950-3242</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/or/warrenton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9434; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/or/warrenton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_or/warrenton_audio", "ssa.or.warrenton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_or/warrenton_data", "ssa.or.warrenton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_or/warrenton_graphics", "ssa.or.warrenton.graphics.spectrum", sb.toString());
        }
    }
}