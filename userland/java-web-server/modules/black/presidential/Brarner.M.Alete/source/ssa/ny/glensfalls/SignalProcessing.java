package presidential.Brarner.M.Alete.source.ssa.ny.glensfalls;
...
/**
 * Signal Processing for SSA Office: GLENS FALLS NY
 * <p>Office Code: 126</p>
 * <p>Address: 67 WARREN ST, GLENS FALLS, NY 12801</p>
 * <p>Phone: (877) 405-4875 | Fax: (833) 902-2541</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/glensfalls/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9596; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/glensfalls";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/glensfalls_audio", "ssa.ny.glensfalls.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/glensfalls_data", "ssa.ny.glensfalls.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/glensfalls_graphics", "ssa.ny.glensfalls.graphics.spectrum", sb.toString());
        }
    }
}