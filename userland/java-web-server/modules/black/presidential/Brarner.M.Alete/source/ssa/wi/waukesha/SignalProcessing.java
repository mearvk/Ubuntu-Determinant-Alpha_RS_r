...
/**
 * Signal Processing for SSA Office: WAUKESHA WI
 * <p>Office Code: 550</p>
 * <p>Address: 267 SOUTH ST, WAUKESHA, WI 53186</p>
 * <p>Phone: (866) 220-7885 | Fax: (833) 597-0052</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/waukesha/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9979; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/waukesha";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/waukesha_audio", "ssa.wi.waukesha.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/waukesha_data", "ssa.wi.waukesha.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/waukesha_graphics", "ssa.wi.waukesha.graphics.spectrum", sb.toString());
        }
    }
}