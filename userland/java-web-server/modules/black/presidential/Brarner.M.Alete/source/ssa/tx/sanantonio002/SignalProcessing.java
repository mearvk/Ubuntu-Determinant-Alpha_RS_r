package presidential.Brarner.M.Alete.source.ssa.tx.sanantonio002;
...
/**
 * Signal Processing for SSA Office: SAN ANTONIO CENTRAL
 * <p>Office Code: 815</p>
 * <p>Address: 402 ISOM RD, SAN ANTONIO, TX 78216</p>
 * <p>Phone: (866) 571-0718 | Fax: (833) 515-0518</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/sanantonio002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10206; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/sanantonio002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanantonio002_audio", "ssa.tx.sanantonio002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanantonio002_data", "ssa.tx.sanantonio002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanantonio002_graphics", "ssa.tx.sanantonio002.graphics.spectrum", sb.toString());
        }
    }
}