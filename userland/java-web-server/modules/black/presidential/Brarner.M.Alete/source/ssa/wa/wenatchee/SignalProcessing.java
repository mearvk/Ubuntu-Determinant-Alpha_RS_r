package presidential.Brarner.M.Alete.source.ssa.wa.wenatchee;
...
/**
 * Signal Processing for SSA Office: WENATCHEE WA
 * <p>Office Code: 924</p>
 * <p>Address: 129 S CHELAN AVE, WENATCHEE, WA 98801</p>
 * <p>Phone: (877) 669-3125 | Fax: (833) 950-2620</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/wenatchee/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10307; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/wenatchee";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/wenatchee_audio", "ssa.wa.wenatchee.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/wenatchee_data", "ssa.wa.wenatchee.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/wenatchee_graphics", "ssa.wa.wenatchee.graphics.spectrum", sb.toString());
        }
    }
}