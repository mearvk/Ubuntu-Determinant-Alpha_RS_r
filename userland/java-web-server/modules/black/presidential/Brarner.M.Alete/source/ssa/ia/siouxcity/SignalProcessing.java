package presidential.Brarner.M.Alete.source.ssa.ia.siouxcity;
...
/**
 * Signal Processing for SSA Office: SIOUX CITY IA
 * <p>Office Code: 692</p>
 * <p>Address: 3555 SOUTHERN HILLS DR, SIOUX CITY, IA 51106</p>
 * <p>Phone: (866) 338-2859 | Fax: (833) 950-3571</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/siouxcity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10106; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/siouxcity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/siouxcity_audio", "ssa.ia.siouxcity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/siouxcity_data", "ssa.ia.siouxcity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/siouxcity_graphics", "ssa.ia.siouxcity.graphics.spectrum", sb.toString());
        }
    }
}