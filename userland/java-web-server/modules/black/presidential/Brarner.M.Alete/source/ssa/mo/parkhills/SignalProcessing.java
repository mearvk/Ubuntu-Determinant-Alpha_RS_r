...
/**
 * Signal Processing for SSA Office: PARK HILLS MO
 * <p>Office Code: 753</p>
 * <p>Address: 507 E MAIN STREET, PARK HILLS, MO 63601</p>
 * <p>Phone: (877) 622-9009 | Fax: (833) 950-2326</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/parkhills/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10152; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/parkhills";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/parkhills_audio", "ssa.mo.parkhills.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/parkhills_data", "ssa.mo.parkhills.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/parkhills_graphics", "ssa.mo.parkhills.graphics.spectrum", sb.toString());
        }
    }
}