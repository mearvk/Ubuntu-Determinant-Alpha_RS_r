...
/**
 * Signal Processing for SSA Office: CLIFTON NJ
 * <p>Office Code: 177</p>
 * <p>Address: 935 ALLWOOD RD, CLIFTON, NJ 7012</p>
 * <p>Phone: (866) 964-0170 | Fax: (833) 346-7157</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/clifton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9638; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/clifton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/clifton_audio", "ssa.nj.clifton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/clifton_data", "ssa.nj.clifton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/clifton_graphics", "ssa.nj.clifton.graphics.spectrum", sb.toString());
        }
    }
}