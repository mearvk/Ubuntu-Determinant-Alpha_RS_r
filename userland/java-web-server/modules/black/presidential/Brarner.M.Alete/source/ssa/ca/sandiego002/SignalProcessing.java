package presidential.Brarner.M.Alete.source.ssa.ca.sandiego002;
...
/**
 * Signal Processing for SSA Office: SAN DIEGO CA
 * <p>Office Code: 954</p>
 * <p>Address: 1333 FRONT STREET, SAN DIEGO, CA 92101</p>
 * <p>Phone: (855) 820-0097 | Fax: (833) 902-2618</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sandiego002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10336; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sandiego002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sandiego002_audio", "ssa.ca.sandiego002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sandiego002_data", "ssa.ca.sandiego002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sandiego002_graphics", "ssa.ca.sandiego002.graphics.spectrum", sb.toString());
        }
    }
}