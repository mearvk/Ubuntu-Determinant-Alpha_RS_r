...
/**
 * Signal Processing for SSA Office: ALBUQUERQUE NM
 * <p>Office Code: 858</p>
 * <p>Address: 500 LEAD AVE SW, ALBUQUERQUE, NM 87102</p>
 * <p>Phone: (866) 613-9961 | Fax: (833) 950-2718</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nm/albuquerque/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10246; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nm/albuquerque";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nm/albuquerque_audio", "ssa.nm.albuquerque.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nm/albuquerque_data", "ssa.nm.albuquerque.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nm/albuquerque_graphics", "ssa.nm.albuquerque.graphics.spectrum", sb.toString());
        }
    }
}