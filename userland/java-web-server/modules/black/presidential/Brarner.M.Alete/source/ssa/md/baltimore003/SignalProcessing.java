package presidential.Brarner.M.Alete.source.ssa.md.baltimore003;
...
/**
 * Signal Processing for SSA Office: BALTO ROSSVILLE MD
 * <p>Office Code: 196</p>
 * <p>Address: 5235 KING AVENUE, BALTIMORE, MD 21237</p>
 * <p>Phone: (866) 348-5818 | Fax: (833) 461-0032</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/baltimore003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9654; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/baltimore003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/baltimore003_audio", "ssa.md.baltimore003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/baltimore003_data", "ssa.md.baltimore003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/baltimore003_graphics", "ssa.md.baltimore003.graphics.spectrum", sb.toString());
        }
    }
}