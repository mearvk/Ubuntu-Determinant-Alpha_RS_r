package presidential.Brarner.M.Alete.source.ssa.or.portland002;
...
/**
 * Signal Processing for SSA Office: PORTLAND-EAST O
 * <p>Office Code: 940</p>
 * <p>Address: 17925 SE DIVISION ST, PORTLAND, OR 97236</p>
 * <p>Phone: (866) 331-6402 | Fax: (833) 950-2924</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/or/portland002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10322; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/or/portland002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_or/portland002_audio", "ssa.or.portland002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_or/portland002_data", "ssa.or.portland002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_or/portland002_graphics", "ssa.or.portland002.graphics.spectrum", sb.toString());
        }
    }
}