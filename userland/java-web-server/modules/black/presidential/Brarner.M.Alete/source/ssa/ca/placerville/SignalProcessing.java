package presidential.Brarner.M.Alete.source.ssa.ca.placerville;
...
/**
 * Signal Processing for SSA Office: PLACERVILLE CA
 * <p>Office Code: E78</p>
 * <p>Address: 3916 MISSOURI FLAT RD, PLACERVILLE, CA 95667</p>
 * <p>Phone: (877) 545-5497 | Fax: (833) 940-2007</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/placerville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9478; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/placerville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/placerville_audio", "ssa.ca.placerville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/placerville_data", "ssa.ca.placerville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/placerville_graphics", "ssa.ca.placerville.graphics.spectrum", sb.toString());
        }
    }
}