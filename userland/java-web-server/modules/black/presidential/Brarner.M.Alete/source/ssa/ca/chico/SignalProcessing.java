package presidential.Brarner.M.Alete.source.ssa.ca.chico;
...
/**
 * Signal Processing for SSA Office: CHICO CA
 * <p>Office Code: 979</p>
 * <p>Address: 1370 E. LASSEN AVE, CHICO, CA 95973</p>
 * <p>Phone: (866) 964-7585 | Fax: (833) 950-2452</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/chico/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10360; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/chico";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/chico_audio", "ssa.ca.chico.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/chico_data", "ssa.ca.chico.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/chico_graphics", "ssa.ca.chico.graphics.spectrum", sb.toString());
        }
    }
}