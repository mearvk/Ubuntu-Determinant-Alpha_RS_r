package presidential.Brarner.M.Alete.source.ssa.fl.cocoa;
...
/**
 * Signal Processing for SSA Office: COCOA FL
 * <p>Office Code: E98</p>
 * <p>Address: 310 CANAVERAL GROVES, COCOA, FL 32926</p>
 * <p>Phone: (866) 964-0798 | Fax: (833) 902-2712</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/cocoa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9480; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/cocoa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/cocoa_audio", "ssa.fl.cocoa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/cocoa_data", "ssa.fl.cocoa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/cocoa_graphics", "ssa.fl.cocoa.graphics.spectrum", sb.toString());
        }
    }
}