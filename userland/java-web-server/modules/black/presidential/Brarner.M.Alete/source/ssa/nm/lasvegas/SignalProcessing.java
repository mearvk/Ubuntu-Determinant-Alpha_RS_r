package presidential.Brarner.M.Alete.source.ssa.nm.lasvegas;
...
/**
 * Signal Processing for SSA Office: LAS VEGAS NM
 * <p>Office Code: B55</p>
 * <p>Address: 2520 RIDGE RUNNER RD, LAS VEGAS, NM 87701</p>
 * <p>Phone: (866) 635-0856 | Fax: (833) 939-2008</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nm/lasvegas/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9316; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nm/lasvegas";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nm/lasvegas_audio", "ssa.nm.lasvegas.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nm/lasvegas_data", "ssa.nm.lasvegas.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nm/lasvegas_graphics", "ssa.nm.lasvegas.graphics.spectrum", sb.toString());
        }
    }
}