package presidential.Brarner.M.Alete.source.ssa.ca.lamesa;
...
/**
 * Signal Processing for SSA Office: LA MESA CA
 * <p>Office Code: B80</p>
 * <p>Address: 7961 UNIVERSITY AVE, LA MESA, CA 91942</p>
 * <p>Phone: (877) 405-1445 | Fax: (833) 571-0636</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/lamesa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9334; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/lamesa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/lamesa_audio", "ssa.ca.lamesa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/lamesa_data", "ssa.ca.lamesa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/lamesa_graphics", "ssa.ca.lamesa.graphics.spectrum", sb.toString());
        }
    }
}