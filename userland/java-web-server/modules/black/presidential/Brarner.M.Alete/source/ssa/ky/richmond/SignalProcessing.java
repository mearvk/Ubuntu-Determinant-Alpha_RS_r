package presidential.Brarner.M.Alete.source.ssa.ky.richmond;
...
/**
 * Signal Processing for SSA Office: RICHMOND KY
 * <p>Office Code: A46</p>
 * <p>Address: 1060 GIBSON BAY DRIVE, RICHMOND, KY 40475</p>
 * <p>Phone: (866) 838-8945 | Fax: (833) 950-2524</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/richmond/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9231; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/richmond";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/richmond_audio", "ssa.ky.richmond.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/richmond_data", "ssa.ky.richmond.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/richmond_graphics", "ssa.ky.richmond.graphics.spectrum", sb.toString());
        }
    }
}