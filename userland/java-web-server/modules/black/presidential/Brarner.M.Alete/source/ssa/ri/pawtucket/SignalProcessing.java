package presidential.Brarner.M.Alete.source.ssa.ri.pawtucket;
...
/**
 * Signal Processing for SSA Office: PAWTUCKET RI
 * <p>Office Code: 74</p>
 * <p>Address: 4 PLEASANT ST, PAWTUCKET, RI 2860</p>
 * <p>Phone: (866) 931-7079 | Fax: (833) 950-2350</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ri/pawtucket/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9550; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ri/pawtucket";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ri/pawtucket_audio", "ssa.ri.pawtucket.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ri/pawtucket_data", "ssa.ri.pawtucket.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ri/pawtucket_graphics", "ssa.ri.pawtucket.graphics.spectrum", sb.toString());
        }
    }
}