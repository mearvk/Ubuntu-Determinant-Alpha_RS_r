...
/**
 * Signal Processing for SSA Office: RICHMOND IN
 * <p>Office Code: 460</p>
 * <p>Address: 500 NORTH A STREET, RICHMOND, IN 47374</p>
 * <p>Phone: (866) 446-6190 | Fax: (833) 902-2676</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/richmond/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9897; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/richmond";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/richmond_audio", "ssa.in.richmond.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/richmond_data", "ssa.in.richmond.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/richmond_graphics", "ssa.in.richmond.graphics.spectrum", sb.toString());
        }
    }
}