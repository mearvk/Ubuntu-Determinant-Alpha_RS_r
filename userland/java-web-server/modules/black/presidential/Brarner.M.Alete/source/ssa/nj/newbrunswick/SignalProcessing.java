package presidential.Brarner.M.Alete.source.ssa.nj.newbrunswick;
...
/**
 * Signal Processing for SSA Office: NEW BRUNSWICK NJ
 * <p>Office Code: 187</p>
 * <p>Address: 550 JERSEY AVENUE, NEW BRUNSWICK, NJ 8901</p>
 * <p>Phone: (877) 803-6313 | Fax: (833) 950-3315</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/newbrunswick/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9647; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/newbrunswick";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/newbrunswick_audio", "ssa.nj.newbrunswick.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/newbrunswick_data", "ssa.nj.newbrunswick.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/newbrunswick_graphics", "ssa.nj.newbrunswick.graphics.spectrum", sb.toString());
        }
    }
}