package presidential.Brarner.M.Alete.source.ssa.tn.columbia;
...
/**
 * Signal Processing for SSA Office: COLUMBIA TN
 * <p>Office Code: 569</p>
 * <p>Address: 1885 SHADY BROOK ST, COLUMBIA, TN 38401</p>
 * <p>Phone: (877) 876-3174 | Fax: (833) 597-0124</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/columbia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9993; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/columbia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/columbia_audio", "ssa.tn.columbia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/columbia_data", "ssa.tn.columbia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/columbia_graphics", "ssa.tn.columbia.graphics.spectrum", sb.toString());
        }
    }
}