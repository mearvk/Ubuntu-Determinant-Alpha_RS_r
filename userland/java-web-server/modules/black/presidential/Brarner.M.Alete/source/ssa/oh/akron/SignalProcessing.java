package presidential.Brarner.M.Alete.source.ssa.oh.akron;
...
/**
 * Signal Processing for SSA Office: AKRON OH
 * <p>Office Code: 390</p>
 * <p>Address: 2 S MAIN ST, AKRON, OH 44308</p>
 * <p>Phone: (877) 600-2858 | Fax: (833) 950-3081</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/akron/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9831; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/akron";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/akron_audio", "ssa.oh.akron.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/akron_data", "ssa.oh.akron.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/akron_graphics", "ssa.oh.akron.graphics.spectrum", sb.toString());
        }
    }
}