package presidential.Brarner.M.Alete.source.ssa.ga.lagrange;
...
/**
 * Signal Processing for SSA Office: LAGRANGE GA
 * <p>Office Code: 608</p>
 * <p>Address: 1300 LAFAYETTE PKWY, LAGRANGE, GA 30241</p>
 * <p>Phone: (866) 836-6744 | Fax: (833) 950-2854</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/lagrange/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10031; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/lagrange";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/lagrange_audio", "ssa.ga.lagrange.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/lagrange_data", "ssa.ga.lagrange.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/lagrange_graphics", "ssa.ga.lagrange.graphics.spectrum", sb.toString());
        }
    }
}