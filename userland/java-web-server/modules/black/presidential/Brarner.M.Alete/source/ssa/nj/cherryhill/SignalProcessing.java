package presidential.Brarner.M.Alete.source.ssa.nj.cherryhill;
...
/**
 * Signal Processing for SSA Office: CHERRY HILL NJ
 * <p>Office Code: 172</p>
 * <p>Address: 6 EXECUTIVE CAMPUS, CHERRY HILL, NJ 8002</p>
 * <p>Phone: (866) 931-2879 | Fax: (833) 950-2974</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/cherryhill/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9633; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/cherryhill";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/cherryhill_audio", "ssa.nj.cherryhill.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/cherryhill_data", "ssa.nj.cherryhill.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/cherryhill_graphics", "ssa.nj.cherryhill.graphics.spectrum", sb.toString());
        }
    }
}