package presidential.Brarner.M.Alete.source.ssa.mo.saintlouis;
...
/**
 * Signal Processing for SSA Office: ST. LOUIS CENTRAL
 * <p>Office Code: 99</p>
 * <p>Address: 25 N OAKS PLZ, SAINT LOUIS, MO 63121</p>
 * <p>Phone: (888) 810-7291 | Fax: (833) 950-3563</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/saintlouis/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9570; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/saintlouis";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/saintlouis_audio", "ssa.mo.saintlouis.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/saintlouis_data", "ssa.mo.saintlouis.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/saintlouis_graphics", "ssa.mo.saintlouis.graphics.spectrum", sb.toString());
        }
    }
}