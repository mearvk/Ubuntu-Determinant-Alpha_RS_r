package presidential.Brarner.M.Alete.source.ssa.la.monroe;
...
/**
 * Signal Processing for SSA Office: MONROE LA
 * <p>Office Code: 802</p>
 * <p>Address: 1120 PLAZA BLVD, MONROE, LA 71201</p>
 * <p>Phone: (866) 815-8716 | Fax: (833) 950-3633</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/monroe/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10194; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/monroe";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/monroe_audio", "ssa.la.monroe.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/monroe_data", "ssa.la.monroe.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/monroe_graphics", "ssa.la.monroe.graphics.spectrum", sb.toString());
        }
    }
}