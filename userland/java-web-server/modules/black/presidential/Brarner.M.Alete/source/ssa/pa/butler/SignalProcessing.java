package presidential.Brarner.M.Alete.source.ssa.pa.butler;
...
/**
 * Signal Processing for SSA Office: BUTLER PA
 * <p>Office Code: 239</p>
 * <p>Address: 102 WOODY DR, BUTLER, PA 16001</p>
 * <p>Phone: (877) 583-4102 | Fax: (833) 603-0365</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/butler/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9696; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/butler";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/butler_audio", "ssa.pa.butler.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/butler_data", "ssa.pa.butler.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/butler_graphics", "ssa.pa.butler.graphics.spectrum", sb.toString());
        }
    }
}