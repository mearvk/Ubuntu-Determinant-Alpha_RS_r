...
/**
 * Signal Processing for SSA Office: FRAMINGHAM MA
 * <p>Office Code: 53</p>
 * <p>Address: ONE CLARKS HILL, FRAMINGHAM, MA 1702</p>
 * <p>Phone: (844) 587-1390 | Fax: (833) 926-1862</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/framingham/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9535; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/framingham";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/framingham_audio", "ssa.ma.framingham.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/framingham_data", "ssa.ma.framingham.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/framingham_graphics", "ssa.ma.framingham.graphics.spectrum", sb.toString());
        }
    }
}