...
/**
 * Signal Processing for SSA Office: PARSIPPANY NJ
 * <p>Office Code: 186</p>
 * <p>Address: 2200 STATE ROUTE 10 WEST, PARSIPPANY, NJ 7054</p>
 * <p>Phone: (866) 331-7131 | Fax: (833) 950-3313</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/parsippany/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9646; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/parsippany";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/parsippany_audio", "ssa.nj.parsippany.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/parsippany_data", "ssa.nj.parsippany.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/parsippany_graphics", "ssa.nj.parsippany.graphics.spectrum", sb.toString());
        }
    }
}