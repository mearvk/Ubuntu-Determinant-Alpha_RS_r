...
/**
 * Signal Processing for SSA Office: HELENA MT
 * <p>Office Code: 865</p>
 * <p>Address: 10 W 15TH ST, HELENA, MT 59626</p>
 * <p>Phone: (866) 563-9496 | Fax: (833) 515-0407</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mt/helena/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10253; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mt/helena";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mt/helena_audio", "ssa.mt.helena.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mt/helena_data", "ssa.mt.helena.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mt/helena_graphics", "ssa.mt.helena.graphics.spectrum", sb.toString());
        }
    }
}