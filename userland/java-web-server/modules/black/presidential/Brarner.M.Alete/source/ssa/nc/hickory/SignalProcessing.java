package presidential.Brarner.M.Alete.source.ssa.nc.hickory;
...
/**
 * Signal Processing for SSA Office: HICKORY NC
 * <p>Office Code: 331</p>
 * <p>Address: 1501 US HWY 321 NW, HICKORY, NC 28601</p>
 * <p>Phone: (888) 877-1615 | Fax: (833) 950-2838</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/hickory/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9780; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/hickory";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/hickory_audio", "ssa.nc.hickory.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/hickory_data", "ssa.nc.hickory.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/hickory_graphics", "ssa.nc.hickory.graphics.spectrum", sb.toString());
        }
    }
}