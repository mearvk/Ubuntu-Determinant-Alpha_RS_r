package presidential.Brarner.M.Alete.source.ssa.ma.quincy;
...
/**
 * Signal Processing for SSA Office: QUINCY MA
 * <p>Office Code: 47</p>
 * <p>Address: 1515 HANCOCK ST, QUINCY, MA 2169</p>
 * <p>Phone: (866) 593-4392 | Fax: (833) 926-1843</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/quincy/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9529; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/quincy";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/quincy_audio", "ssa.ma.quincy.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/quincy_data", "ssa.ma.quincy.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/quincy_graphics", "ssa.ma.quincy.graphics.spectrum", sb.toString());
        }
    }
}