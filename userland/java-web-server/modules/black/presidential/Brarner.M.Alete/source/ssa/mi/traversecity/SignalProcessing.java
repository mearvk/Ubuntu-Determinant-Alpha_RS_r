package presidential.Brarner.M.Alete.source.ssa.mi.traversecity;
...
/**
 * Signal Processing for SSA Office: TRAVERSE CITY MI
 * <p>Office Code: 352</p>
 * <p>Address: 1329 S DIVISION ST, TRAVERSE CITY, MI 49684</p>
 * <p>Phone: (866) 739-4802 | Fax: (833) 950-2126</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/traversecity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9799; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/traversecity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/traversecity_audio", "ssa.mi.traversecity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/traversecity_data", "ssa.mi.traversecity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/traversecity_graphics", "ssa.mi.traversecity.graphics.spectrum", sb.toString());
        }
    }
}