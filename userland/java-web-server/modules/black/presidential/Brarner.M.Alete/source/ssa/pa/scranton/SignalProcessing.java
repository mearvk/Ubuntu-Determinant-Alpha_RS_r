package presidential.Brarner.M.Alete.source.ssa.pa.scranton;
...
/**
 * Signal Processing for SSA Office: SCRANTON PA
 * <p>Office Code: 202</p>
 * <p>Address: 300 LACKAWANNA AVE, SCRANTON, PA 18503</p>
 * <p>Phone: (866) 635-0767 | Fax: (833) 950-2886</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/scranton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9660; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/scranton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/scranton_audio", "ssa.pa.scranton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/scranton_data", "ssa.pa.scranton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/scranton_graphics", "ssa.pa.scranton.graphics.spectrum", sb.toString());
        }
    }
}