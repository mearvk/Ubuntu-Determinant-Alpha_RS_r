package presidential.Brarner.M.Alete.source.ssa.mo.stlouis;
...
/**
 * Signal Processing for SSA Office: ST LOUIS-DTN MO
 * <p>Office Code: 735</p>
 * <p>Address: 717 N 16TH STREET, ST LOUIS, MO 63103</p>
 * <p>Phone: (888) 748-2014 | Fax: (833) 902-2500</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/stlouis/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10137; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/stlouis";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/stlouis_audio", "ssa.mo.stlouis.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/stlouis_data", "ssa.mo.stlouis.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/stlouis_graphics", "ssa.mo.stlouis.graphics.spectrum", sb.toString());
        }
    }
}