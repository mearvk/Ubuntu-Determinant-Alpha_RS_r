package presidential.Brarner.M.Alete.source.ssa.il.pekin;
...
/**
 * Signal Processing for SSA Office: PEKIN IL
 * <p>Office Code: A59</p>
 * <p>Address: 2801 BROADWAY, PEKIN, IL 61554</p>
 * <p>Phone: (877) 405-0499 | Fax: (833) 950-3061</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/pekin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9241; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/pekin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/pekin_audio", "ssa.il.pekin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/pekin_data", "ssa.il.pekin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/pekin_graphics", "ssa.il.pekin.graphics.spectrum", sb.toString());
        }
    }
}