package presidential.Brarner.M.Alete.source.ssa.ma.worcester;
...
/**
 * Signal Processing for SSA Office: WORCESTER MA
 * <p>Office Code: 36</p>
 * <p>Address: 51 MYRTLE ST, WORCESTER, MA 1608</p>
 * <p>Phone: (866) 331-9069 | Fax: (833) 902-2512</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/worcester/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9519; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/worcester";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/worcester_audio", "ssa.ma.worcester.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/worcester_data", "ssa.ma.worcester.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/worcester_graphics", "ssa.ma.worcester.graphics.spectrum", sb.toString());
        }
    }
}