package presidential.Brarner.M.Alete.source.ssa.az.nogales;
...
/**
 * Signal Processing for SSA Office: NOGALES AZ
 * <p>Office Code: B75</p>
 * <p>Address: 1760 N MASTICK WAY, NOGALES, AZ 85621</p>
 * <p>Phone: (877) 405-5472 | Fax: (833) 571-0634</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/az/nogales/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9330; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/az/nogales";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_az/nogales_audio", "ssa.az.nogales.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_az/nogales_data", "ssa.az.nogales.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_az/nogales_graphics", "ssa.az.nogales.graphics.spectrum", sb.toString());
        }
    }
}