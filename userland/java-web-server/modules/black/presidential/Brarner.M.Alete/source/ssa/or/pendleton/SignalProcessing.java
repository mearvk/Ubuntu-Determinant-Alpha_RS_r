package presidential.Brarner.M.Alete.source.ssa.or.pendleton;
...
/**
 * Signal Processing for SSA Office: PENDLETON OR
 * <p>Office Code: B78</p>
 * <p>Address: 1229 SE 3RD STREET, PENDLETON, OR 97801</p>
 * <p>Phone: (877) 405-0480 | Fax: (833) 950-3232</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/or/pendleton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9333; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/or/pendleton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_or/pendleton_audio", "ssa.or.pendleton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_or/pendleton_data", "ssa.or.pendleton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_or/pendleton_graphics", "ssa.or.pendleton.graphics.spectrum", sb.toString());
        }
    }
}