package presidential.Brarner.M.Alete.source.ssa.ma.cambridge;
...
/**
 * Signal Processing for SSA Office: CAMBRIDGE MA
 * <p>Office Code: 32</p>
 * <p>Address: 10 FAWCETT ST, CAMBRIDGE, MA 2138</p>
 * <p>Phone: (888) 527-9340 | Fax: (833) 515-0461</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/cambridge/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9515; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/cambridge";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/cambridge_audio", "ssa.ma.cambridge.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/cambridge_data", "ssa.ma.cambridge.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/cambridge_graphics", "ssa.ma.cambridge.graphics.spectrum", sb.toString());
        }
    }
}