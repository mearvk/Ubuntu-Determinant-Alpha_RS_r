package presidential.Brarner.M.Alete.source.ssa.pa.westchester;
...
/**
 * Signal Processing for SSA Office: WEST CHESTER PA
 * <p>Office Code: 237</p>
 * <p>Address: 1101 WEST CHESTER PIKE, WEST CHESTER, PA 19382</p>
 * <p>Phone: (888) 306-3216 | Fax: (833) 787-1782</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/westchester/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9694; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/westchester";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/westchester_audio", "ssa.pa.westchester.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/westchester_data", "ssa.pa.westchester.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/westchester_graphics", "ssa.pa.westchester.graphics.spectrum", sb.toString());
        }
    }
}