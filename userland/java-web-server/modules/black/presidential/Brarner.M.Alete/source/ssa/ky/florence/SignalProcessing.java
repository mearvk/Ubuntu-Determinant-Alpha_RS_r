package presidential.Brarner.M.Alete.source.ssa.ky.florence;
...
/**
 * Signal Processing for SSA Office: FLORENCE KY
 * <p>Office Code: 442</p>
 * <p>Address: 7 YOUELL STREET, FLORENCE, KY 41042</p>
 * <p>Phone: (866) 504-4224 | Fax: (833) 950-3475</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/florence/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9879; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/florence";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/florence_audio", "ssa.ky.florence.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/florence_data", "ssa.ky.florence.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/florence_graphics", "ssa.ky.florence.graphics.spectrum", sb.toString());
        }
    }
}