package presidential.Brarner.M.Alete.source.ssa.wa.seattle002;
...
/**
 * Signal Processing for SSA Office: SEATTLE METRO WA
 * <p>Office Code: 916</p>
 * <p>Address: 915 2ND AVE, SEATTLE, WA 98174</p>
 * <p>Phone: (866) 494-3135 | Fax: (833) 346-7160</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/seattle002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10299; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/seattle002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/seattle002_audio", "ssa.wa.seattle002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/seattle002_data", "ssa.wa.seattle002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/seattle002_graphics", "ssa.wa.seattle002.graphics.spectrum", sb.toString());
        }
    }
}