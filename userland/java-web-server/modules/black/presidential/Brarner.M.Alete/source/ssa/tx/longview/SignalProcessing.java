package presidential.Brarner.M.Alete.source.ssa.tx.longview;
...
/**
 * Signal Processing for SSA Office: LONGVIEW TX
 * <p>Office Code: 835</p>
 * <p>Address: 611 CLINIC DR, LONGVIEW, TX 75605</p>
 * <p>Phone: (888) 617-0455 | Fax: (833) 939-2025</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/longview/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10226; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/longview";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/longview_audio", "ssa.tx.longview.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/longview_data", "ssa.tx.longview.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/longview_graphics", "ssa.tx.longview.graphics.spectrum", sb.toString());
        }
    }
}