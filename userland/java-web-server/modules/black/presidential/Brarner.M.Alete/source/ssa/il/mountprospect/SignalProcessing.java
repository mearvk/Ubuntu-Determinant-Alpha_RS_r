...
/**
 * Signal Processing for SSA Office: MOUNT PROSPECT IL
 * <p>Office Code: 532</p>
 * <p>Address: 705 NORTH WHEELING RD, MOUNT PROSPECT, IL 60056</p>
 * <p>Phone: (866) 931-8350 | Fax: (833) 950-3733</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/mountprospect/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9963; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/mountprospect";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/mountprospect_audio", "ssa.il.mountprospect.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/mountprospect_data", "ssa.il.mountprospect.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/mountprospect_graphics", "ssa.il.mountprospect.graphics.spectrum", sb.toString());
        }
    }
}