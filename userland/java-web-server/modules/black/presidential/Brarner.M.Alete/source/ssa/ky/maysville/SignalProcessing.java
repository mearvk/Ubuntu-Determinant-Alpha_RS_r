package presidential.Brarner.M.Alete.source.ssa.ky.maysville;
...
/**
 * Signal Processing for SSA Office: MAYSVILLE KY
 * <p>Office Code: 428</p>
 * <p>Address: 509 MARKETPLACE DR, MAYSVILLE, KY 41056</p>
 * <p>Phone: (855) 807-8802 | Fax: (833) 950-3147</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/maysville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9868; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/maysville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/maysville_audio", "ssa.ky.maysville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/maysville_data", "ssa.ky.maysville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/maysville_graphics", "ssa.ky.maysville.graphics.spectrum", sb.toString());
        }
    }
}