package presidential.Brarner.M.Alete.source.ssa.ca.modesto;
...
/**
 * Signal Processing for SSA Office: MODESTO CA
 * <p>Office Code: 978</p>
 * <p>Address: 1521 N CARPENTER RD, MODESTO, CA 95351</p>
 * <p>Phone: (888) 748-7698 | Fax: (833) 950-2450</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/modesto/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10359; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/modesto";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/modesto_audio", "ssa.ca.modesto.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/modesto_data", "ssa.ca.modesto.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/modesto_graphics", "ssa.ca.modesto.graphics.spectrum", sb.toString());
        }
    }
}