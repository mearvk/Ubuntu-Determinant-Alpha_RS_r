package presidential.Brarner.M.Alete.source.ssa.ca.sanfernando;
...
/**
 * Signal Processing for SSA Office: SAN FERNANDO CA
 * <p>Office Code: 27</p>
 * <p>Address: 456 S F MISSION BLVD, SAN FERNANDO, CA 91340</p>
 * <p>Phone: (888) 383-1599 | Fax: (833) 950-2428</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sanfernando/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9511; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sanfernando";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanfernando_audio", "ssa.ca.sanfernando.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanfernando_data", "ssa.ca.sanfernando.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanfernando_graphics", "ssa.ca.sanfernando.graphics.spectrum", sb.toString());
        }
    }
}