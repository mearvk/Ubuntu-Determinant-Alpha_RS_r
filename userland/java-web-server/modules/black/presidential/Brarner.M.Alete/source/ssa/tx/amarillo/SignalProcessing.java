package presidential.Brarner.M.Alete.source.ssa.tx.amarillo;
...
/**
 * Signal Processing for SSA Office: AMARILLO TX
 * <p>Office Code: 820</p>
 * <p>Address: 4750  CANYON DR, AMARILLO, TX 79109</p>
 * <p>Phone: (877) 803-6318 | Fax: (833) 519-3209</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/amarillo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10211; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/amarillo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/amarillo_audio", "ssa.tx.amarillo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/amarillo_data", "ssa.tx.amarillo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/amarillo_graphics", "ssa.tx.amarillo.graphics.spectrum", sb.toString());
        }
    }
}