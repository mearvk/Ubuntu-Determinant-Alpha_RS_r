package presidential.Brarner.M.Alete.source.ssa.tx.waxahachie;
...
/**
 * Signal Processing for SSA Office: WAXAHACHIE TX
 * <p>Office Code: D20</p>
 * <p>Address: 100 DEAN BOX DRIVE, WAXAHACHIE, TX 75165</p>
 * <p>Phone: (866) 563-1912 | Fax: (833) 939-2014</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/waxahachie/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9412; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/waxahachie";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/waxahachie_audio", "ssa.tx.waxahachie.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/waxahachie_data", "ssa.tx.waxahachie.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/waxahachie_graphics", "ssa.tx.waxahachie.graphics.spectrum", sb.toString());
        }
    }
}