package presidential.Brarner.M.Alete.source.ssa.mi.lansing;
...
/**
 * Signal Processing for SSA Office: LANSING MI
 * <p>Office Code: 354</p>
 * <p>Address: 5210 PERRY ROBINSON, LANSING, MI 48911</p>
 * <p>Phone: (877) 512-5944 | Fax: (833) 950-2130</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/lansing/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9801; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/lansing";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/lansing_audio", "ssa.mi.lansing.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/lansing_data", "ssa.mi.lansing.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/lansing_graphics", "ssa.mi.lansing.graphics.spectrum", sb.toString());
        }
    }
}