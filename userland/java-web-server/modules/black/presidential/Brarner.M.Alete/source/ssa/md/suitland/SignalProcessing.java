package presidential.Brarner.M.Alete.source.ssa.md.suitland;
...
/**
 * Signal Processing for SSA Office: CAMP SPRINGS MD
 * <p>Office Code: 527</p>
 * <p>Address: 6110 ALLENTOWN ROAD, SUITLAND, MD 20746</p>
 * <p>Phone: (877) 512-3849 | Fax: (833) 912-2292</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/suitland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9958; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/suitland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/suitland_audio", "ssa.md.suitland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/suitland_data", "ssa.md.suitland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/suitland_graphics", "ssa.md.suitland.graphics.spectrum", sb.toString());
        }
    }
}