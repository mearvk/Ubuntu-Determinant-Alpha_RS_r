package presidential.Brarner.M.Alete.source.ssa.mn.rochester;
...
/**
 * Signal Processing for SSA Office: ROCHESTER MN
 * <p>Office Code: 685</p>
 * <p>Address: 206 BROADWAY AVE S, ROCHESTER, MN 55904</p>
 * <p>Phone: (877) 405-3631 | Fax: (833) 950-2180</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/rochester/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10100; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/rochester";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/rochester_audio", "ssa.mn.rochester.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/rochester_data", "ssa.mn.rochester.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/rochester_graphics", "ssa.mn.rochester.graphics.spectrum", sb.toString());
        }
    }
}