...
/**
 * Signal Processing for SSA Office: CARBONDALE IL
 * <p>Office Code: 517</p>
 * <p>Address: 250 W CHERRY ST, CARBONDALE, IL 62901</p>
 * <p>Phone: (877) 714-0377 | Fax: (833) 950-3441</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/carbondale/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9951; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/carbondale";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/carbondale_audio", "ssa.il.carbondale.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/carbondale_data", "ssa.il.carbondale.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/carbondale_graphics", "ssa.il.carbondale.graphics.spectrum", sb.toString());
        }
    }
}