...
/**
 * Signal Processing for SSA Office: NEW CASTLE PA
 * <p>Office Code: 210</p>
 * <p>Address: 1708 WILMINGTON RD, NEW CASTLE, PA 16105</p>
 * <p>Phone: (866) 331-5286 | Fax: (833) 950-3187</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/newcastle/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9668; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/newcastle";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/newcastle_audio", "ssa.pa.newcastle.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/newcastle_data", "ssa.pa.newcastle.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/newcastle_graphics", "ssa.pa.newcastle.graphics.spectrum", sb.toString());
        }
    }
}