...
/**
 * Signal Processing for SSA Office: HILO HI
 * <p>Office Code: 991</p>
 * <p>Address: 111 E PUAINAKO ST, HILO, HI 96720</p>
 * <p>Phone: (855) 572-4860 | Fax: (833) 950-2766</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/hi/hilo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10372; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/hi/hilo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_hi/hilo_audio", "ssa.hi.hilo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_hi/hilo_data", "ssa.hi.hilo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_hi/hilo_graphics", "ssa.hi.hilo.graphics.spectrum", sb.toString());
        }
    }
}