package presidential.Brarner.M.Alete.source.ssa.ma.lawrence;
...
/**
 * Signal Processing for SSA Office: LAWRENCE MA
 * <p>Office Code: 41</p>
 * <p>Address: 439 S UNION ST, LAWRENCE, MA 1843</p>
 * <p>Phone: (877) 669-3127 | Fax: (833) 902-2522</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/lawrence/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9524; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/lawrence";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/lawrence_audio", "ssa.ma.lawrence.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/lawrence_data", "ssa.ma.lawrence.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/lawrence_graphics", "ssa.ma.lawrence.graphics.spectrum", sb.toString());
        }
    }
}