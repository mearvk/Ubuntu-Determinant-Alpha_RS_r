package presidential.Brarner.M.Alete.source.ssa.il.freeport;
...
/**
 * Signal Processing for SSA Office: FREEPORT IL
 * <p>Office Code: 520</p>
 * <p>Address: 4 E LINDEN ST, FREEPORT, IL 61032</p>
 * <p>Phone: (855) 628-1591 | Fax: (833) 950-3447</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/freeport/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9954; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/freeport";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/freeport_audio", "ssa.il.freeport.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/freeport_data", "ssa.il.freeport.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/freeport_graphics", "ssa.il.freeport.graphics.spectrum", sb.toString());
        }
    }
}