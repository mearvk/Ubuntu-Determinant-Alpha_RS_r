package presidential.Brarner.M.Alete.source.ssa.fl.miami002;
...
/**
 * Signal Processing for SSA Office: PERRINE FL
 * <p>Office Code: 261</p>
 * <p>Address: 11100 SW 211TH ST, MIAMI, FL 33189</p>
 * <p>Phone: (866) 964-6593 | Fax: (833) 950-2212</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/miami002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9714; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/miami002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/miami002_audio", "ssa.fl.miami002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/miami002_data", "ssa.fl.miami002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/miami002_graphics", "ssa.fl.miami002.graphics.spectrum", sb.toString());
        }
    }
}