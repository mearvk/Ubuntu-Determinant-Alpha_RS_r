package presidential.Brarner.M.Alete.source.ssa.ga.griffin;
...
/**
 * Signal Processing for SSA Office: GRIFFIN GA
 * <p>Office Code: 616</p>
 * <p>Address: 1548 FLYNT ST, GRIFFIN, GA 30223</p>
 * <p>Phone: (866) 964-1005 | Fax: (833) 950-2870</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/griffin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10039; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/griffin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/griffin_audio", "ssa.ga.griffin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/griffin_data", "ssa.ga.griffin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/griffin_graphics", "ssa.ga.griffin.graphics.spectrum", sb.toString());
        }
    }
}