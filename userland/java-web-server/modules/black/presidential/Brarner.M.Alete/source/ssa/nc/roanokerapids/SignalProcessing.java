package presidential.Brarner.M.Alete.source.ssa.nc.roanokerapids;
...
/**
 * Signal Processing for SSA Office: ROANOKE RAPIDS NC
 * <p>Office Code: 340</p>
 * <p>Address: 833 GREGORY DRIVE, ROANOKE RAPIDS, NC 27870</p>
 * <p>Phone: (866) 269-2010 | Fax: (833) 950-3137</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/roanokerapids/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9787; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/roanokerapids";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/roanokerapids_audio", "ssa.nc.roanokerapids.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/roanokerapids_data", "ssa.nc.roanokerapids.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/roanokerapids_graphics", "ssa.nc.roanokerapids.graphics.spectrum", sb.toString());
        }
    }
}