package presidential.Brarner.M.Alete.source.ssa.pa.pottstown;
...
/**
 * Signal Processing for SSA Office: POTTSTOWN PA
 * <p>Office Code: C14</p>
 * <p>Address: 80 ROBINSON ST, POTTSTOWN, PA 19464</p>
 * <p>Phone: (866) 964-7415 | Fax: (833) 950-2588</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/pottstown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9348; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/pottstown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/pottstown_audio", "ssa.pa.pottstown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/pottstown_data", "ssa.pa.pottstown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/pottstown_graphics", "ssa.pa.pottstown.graphics.spectrum", sb.toString());
        }
    }
}