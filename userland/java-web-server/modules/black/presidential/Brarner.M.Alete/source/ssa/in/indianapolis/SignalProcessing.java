...
/**
 * Signal Processing for SSA Office: INDIANAPOLIS NORTHEAST
 * <p>Office Code: C41</p>
 * <p>Address: 1625 N POST ROAD, INDIANAPOLIS, IN 46219</p>
 * <p>Phone: (866) 220-7899 | Fax: (833) 950-3411</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/indianapolis/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9362; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/indianapolis";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/indianapolis_audio", "ssa.in.indianapolis.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/indianapolis_data", "ssa.in.indianapolis.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/indianapolis_graphics", "ssa.in.indianapolis.graphics.spectrum", sb.toString());
        }
    }
}