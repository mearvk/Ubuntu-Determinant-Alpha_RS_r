package presidential.Brarner.M.Alete.source.ssa.ky.middlesboro;
...
/**
 * Signal Processing for SSA Office: MIDDLESBORO KY
 * <p>Office Code: 451</p>
 * <p>Address: 10 TECH PARK DRIVE, MIDDLESBORO, KY 40965</p>
 * <p>Phone: (877) 619-2853 | Fax: (833) 950-3773</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/middlesboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9888; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/middlesboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/middlesboro_audio", "ssa.ky.middlesboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/middlesboro_data", "ssa.ky.middlesboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/middlesboro_graphics", "ssa.ky.middlesboro.graphics.spectrum", sb.toString());
        }
    }
}