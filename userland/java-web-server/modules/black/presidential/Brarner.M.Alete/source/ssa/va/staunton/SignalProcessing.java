...
/**
 * Signal Processing for SSA Office: STAUNTON VA
 * <p>Office Code: 290</p>
 * <p>Address: 1600 N COALTER ST, STAUNTON, VA 24401</p>
 * <p>Phone: (888) 632-6896 | Fax: (833) 950-2286</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/staunton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9740; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/staunton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/staunton_audio", "ssa.va.staunton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/staunton_data", "ssa.va.staunton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/staunton_graphics", "ssa.va.staunton.graphics.spectrum", sb.toString());
        }
    }
}