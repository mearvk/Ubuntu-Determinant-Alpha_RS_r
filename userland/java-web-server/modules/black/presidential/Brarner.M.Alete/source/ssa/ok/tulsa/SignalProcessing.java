package presidential.Brarner.M.Alete.source.ssa.ok.tulsa;
...
/**
 * Signal Processing for SSA Office: TULSA OK
 * <p>Office Code: 784</p>
 * <p>Address: 14002 EAST 21ST STREET, TULSA, OK 74134</p>
 * <p>Phone: (866) 931-7106 | Fax: (833) 950-3007</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/tulsa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10179; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/tulsa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/tulsa_audio", "ssa.ok.tulsa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/tulsa_data", "ssa.ok.tulsa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/tulsa_graphics", "ssa.ok.tulsa.graphics.spectrum", sb.toString());
        }
    }
}