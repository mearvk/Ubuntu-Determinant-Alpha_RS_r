package presidential.Brarner.M.Alete.source.ssa.or.beaverton;
...
/**
 * Signal Processing for SSA Office: BEAVERTON OR
 * <p>Office Code: 687</p>
 * <p>Address: 11975 SW 2ND ST, BEAVERTON, OR 97005</p>
 * <p>Phone: (866) 964-2036 | Fax: (833) 912-2545</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/or/beaverton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10102; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/or/beaverton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_or/beaverton_audio", "ssa.or.beaverton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_or/beaverton_data", "ssa.or.beaverton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_or/beaverton_graphics", "ssa.or.beaverton.graphics.spectrum", sb.toString());
        }
    }
}