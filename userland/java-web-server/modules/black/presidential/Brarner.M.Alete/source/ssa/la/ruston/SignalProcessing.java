package presidential.Brarner.M.Alete.source.ssa.la.ruston;
...
/**
 * Signal Processing for SSA Office: RUSTON LA
 * <p>Office Code: B43</p>
 * <p>Address: 2017 BULAR ST, RUSTON, LA 71270</p>
 * <p>Phone: (877) 405-7823 | Fax: (833) 939-1987</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/ruston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9307; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/ruston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/ruston_audio", "ssa.la.ruston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/ruston_data", "ssa.la.ruston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/ruston_graphics", "ssa.la.ruston.graphics.spectrum", sb.toString());
        }
    }
}