package presidential.Brarner.M.Alete.source.ssa.wi.wisconsinrapids;
...
/**
 * Signal Processing for SSA Office: WISCONSIN RAPIDS
 * <p>Office Code: 551</p>
 * <p>Address: 2213 8TH ST SOUTH, WISCONSIN RAPIDS, WI 54494</p>
 * <p>Phone: (855) 686-1465 | Fax: (833) 597-0054</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/wisconsinrapids/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9980; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/wisconsinrapids";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/wisconsinrapids_audio", "ssa.wi.wisconsinrapids.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/wisconsinrapids_data", "ssa.wi.wisconsinrapids.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/wisconsinrapids_graphics", "ssa.wi.wisconsinrapids.graphics.spectrum", sb.toString());
        }
    }
}