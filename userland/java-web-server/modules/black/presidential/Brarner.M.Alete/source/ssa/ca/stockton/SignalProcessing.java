package presidential.Brarner.M.Alete.source.ssa.ca.stockton;
...
/**
 * Signal Processing for SSA Office: STOCKTON CA
 * <p>Office Code: 962</p>
 * <p>Address: 4747 FEATHER RIVER DR, STOCKTON, CA 95219</p>
 * <p>Phone: (877) 803-6314 | Fax: (833) 902-2634</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/stockton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10344; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/stockton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/stockton_audio", "ssa.ca.stockton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/stockton_data", "ssa.ca.stockton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/stockton_graphics", "ssa.ca.stockton.graphics.spectrum", sb.toString());
        }
    }
}