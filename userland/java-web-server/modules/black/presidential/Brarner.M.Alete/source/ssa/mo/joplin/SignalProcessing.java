package presidential.Brarner.M.Alete.source.ssa.mo.joplin;
...
/**
 * Signal Processing for SSA Office: JOPLIN MO
 * <p>Office Code: 744</p>
 * <p>Address: 4102 S ARIZONA AVE, JOPLIN, MO 64804</p>
 * <p>Phone: (866) 964-7421 | Fax: (833) 926-1829</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/joplin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10145; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/joplin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/joplin_audio", "ssa.mo.joplin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/joplin_data", "ssa.mo.joplin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/joplin_graphics", "ssa.mo.joplin.graphics.spectrum", sb.toString());
        }
    }
}