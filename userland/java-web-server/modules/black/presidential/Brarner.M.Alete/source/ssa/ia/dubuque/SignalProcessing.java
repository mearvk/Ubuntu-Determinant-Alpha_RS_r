package presidential.Brarner.M.Alete.source.ssa.ia.dubuque;
...
/**
 * Signal Processing for SSA Office: DUBUQUE IA
 * <p>Office Code: 695</p>
 * <p>Address: 1635 ASSOCIATES DR, DUBUQUE, IA 52002</p>
 * <p>Phone: (877) 405-3650 | Fax: (833) 515-0429</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/dubuque/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10109; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/dubuque";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/dubuque_audio", "ssa.ia.dubuque.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/dubuque_data", "ssa.ia.dubuque.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/dubuque_graphics", "ssa.ia.dubuque.graphics.spectrum", sb.toString());
        }
    }
}