package presidential.Brarner.M.Alete.source.ssa.co.denver;
...
/**
 * Signal Processing for SSA Office: DENVER CO
 * <p>Office Code: 882</p>
 * <p>Address: 1500 CHAMPA ST, DENVER, CO 80202</p>
 * <p>Phone: (866) 613-9904 | Fax: (833) 612-0146</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/co/denver/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10268; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/co/denver";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_co/denver_audio", "ssa.co.denver.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_co/denver_data", "ssa.co.denver.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_co/denver_graphics", "ssa.co.denver.graphics.spectrum", sb.toString());
        }
    }
}