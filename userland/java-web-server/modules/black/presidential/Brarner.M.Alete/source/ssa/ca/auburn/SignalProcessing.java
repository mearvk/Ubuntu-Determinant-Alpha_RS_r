package presidential.Brarner.M.Alete.source.ssa.ca.auburn;
...
/**
 * Signal Processing for SSA Office: AUBURN CA
 * <p>Office Code: D35</p>
 * <p>Address: 11855 EDGEWOOD RD, AUBURN, CA 95603</p>
 * <p>Phone: (866) 931-6087 | Fax: (833) 571-0640</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/auburn/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9422; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/auburn";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/auburn_audio", "ssa.ca.auburn.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/auburn_data", "ssa.ca.auburn.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/auburn_graphics", "ssa.ca.auburn.graphics.spectrum", sb.toString());
        }
    }
}