package presidential.Brarner.M.Alete.source.ssa.oh.dayton002;
...
/**
 * Signal Processing for SSA Office: DAYTON-WEST OH
 * <p>Office Code: 426</p>
 * <p>Address: 4375 HOOVER AVE, DAYTON, OH 45417</p>
 * <p>Phone: (877) 895-0038 | Fax: (833) 596-0587</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/dayton002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9866; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/dayton002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/dayton002_audio", "ssa.oh.dayton002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/dayton002_data", "ssa.oh.dayton002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/dayton002_graphics", "ssa.oh.dayton002.graphics.spectrum", sb.toString());
        }
    }
}