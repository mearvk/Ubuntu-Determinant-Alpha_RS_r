package presidential.Brarner.M.Alete.source.ssa.wa.kennewick;
...
/**
 * Signal Processing for SSA Office: TRI-CITIES WA
 * <p>Office Code: 927</p>
 * <p>Address: 8131 W KLAMATH CT, KENNEWICK, WA 99336</p>
 * <p>Phone: (866) 269-6671 | Fax: (833) 950-2626</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/kennewick/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10310; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/kennewick";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/kennewick_audio", "ssa.wa.kennewick.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/kennewick_data", "ssa.wa.kennewick.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/kennewick_graphics", "ssa.wa.kennewick.graphics.spectrum", sb.toString());
        }
    }
}