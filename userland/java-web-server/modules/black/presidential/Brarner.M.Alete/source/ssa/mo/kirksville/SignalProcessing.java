package presidential.Brarner.M.Alete.source.ssa.mo.kirksville;
...
/**
 * Signal Processing for SSA Office: KIRKSVILLE MO
 * <p>Office Code: B41</p>
 * <p>Address: 1305 CROWN DRIVE, KIRKSVILLE, MO 63501</p>
 * <p>Phone: (888) 386-2705 | Fax: (833) 950-2932</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/kirksville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9306; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/kirksville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kirksville_audio", "ssa.mo.kirksville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kirksville_data", "ssa.mo.kirksville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kirksville_graphics", "ssa.mo.kirksville.graphics.spectrum", sb.toString());
        }
    }
}