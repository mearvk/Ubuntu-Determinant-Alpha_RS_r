package presidential.Brarner.M.Alete.source.ssa.az.phoenix;
...
/**
 * Signal Processing for SSA Office: PHOENIX NORTH AZ
 * <p>Office Code: 907</p>
 * <p>Address: 16241 N TATUM BLVD, PHOENIX, AZ 85032</p>
 * <p>Phone: (866) 348-7855 | Fax: (833) 950-3673</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/az/phoenix/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10290; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/az/phoenix";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_az/phoenix_audio", "ssa.az.phoenix.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_az/phoenix_data", "ssa.az.phoenix.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_az/phoenix_graphics", "ssa.az.phoenix.graphics.spectrum", sb.toString());
        }
    }
}