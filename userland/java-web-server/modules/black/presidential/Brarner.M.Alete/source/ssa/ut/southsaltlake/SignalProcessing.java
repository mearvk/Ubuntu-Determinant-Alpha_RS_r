package presidential.Brarner.M.Alete.source.ssa.ut.southsaltlake;
...
/**
 * Signal Processing for SSA Office: SALT LAKE CITY UTAH
 * <p>Office Code: 900</p>
 * <p>Address: 2511 S WEST TEMPLE, SOUTH SALT LAKE, UT 84115</p>
 * <p>Phone: (866) 851-5275 | Fax: (833) 912-2334</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ut/southsaltlake/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10284; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ut/southsaltlake";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ut/southsaltlake_audio", "ssa.ut.southsaltlake.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ut/southsaltlake_data", "ssa.ut.southsaltlake.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ut/southsaltlake_graphics", "ssa.ut.southsaltlake.graphics.spectrum", sb.toString());
        }
    }
}