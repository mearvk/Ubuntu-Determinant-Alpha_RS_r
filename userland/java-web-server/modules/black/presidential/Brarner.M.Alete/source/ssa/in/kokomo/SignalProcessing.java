package presidential.Brarner.M.Alete.source.ssa.in.kokomo;
...
/**
 * Signal Processing for SSA Office: KOKOMO IN
 * <p>Office Code: 462</p>
 * <p>Address: 353 W. ALTO RD, KOKOMO, IN 46902</p>
 * <p>Phone: (866) 365-3036 | Fax: (833) 902-2680</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/kokomo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9899; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/kokomo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/kokomo_audio", "ssa.in.kokomo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/kokomo_data", "ssa.in.kokomo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/kokomo_graphics", "ssa.in.kokomo.graphics.spectrum", sb.toString());
        }
    }
}