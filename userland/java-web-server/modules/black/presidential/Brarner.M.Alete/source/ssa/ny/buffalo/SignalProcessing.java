package presidential.Brarner.M.Alete.source.ssa.ny.buffalo;
...
/**
 * Signal Processing for SSA Office: BUFFALO NY
 * <p>Office Code: 103</p>
 * <p>Address: 478 MAIN STREET, BUFFALO, NY 14202</p>
 * <p>Phone: (855) 881-0213 | Fax: (833) 950-3605</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/buffalo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9574; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/buffalo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/buffalo_audio", "ssa.ny.buffalo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/buffalo_data", "ssa.ny.buffalo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/buffalo_graphics", "ssa.ny.buffalo.graphics.spectrum", sb.toString());
        }
    }
}