package presidential.Brarner.M.Alete.source.ssa.ca.hollywood;
...
/**
 * Signal Processing for SSA Office: HOLLYWOOD CA
 * <p>Office Code: 968</p>
 * <p>Address: 1122 N VINE ST, HOLLYWOOD, CA 90038</p>
 * <p>Phone: (866) 613-2861 | Fax: (833) 950-2110</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/hollywood/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10350; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/hollywood";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/hollywood_audio", "ssa.ca.hollywood.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/hollywood_data", "ssa.ca.hollywood.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/hollywood_graphics", "ssa.ca.hollywood.graphics.spectrum", sb.toString());
        }
    }
}