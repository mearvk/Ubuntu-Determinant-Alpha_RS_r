...
/**
 * Signal Processing for SSA Office: GUAM
 * <p>Office Code: 168</p>
 * <p>Address: 770 EAST SUNSET BLVD, BARRIGADA, GU 96913</p>
 * <p>Phone: (855) 616-6393 | Fax: (833) 950-2744</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/gu/barrigada/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9630; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/gu/barrigada";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_gu/barrigada_audio", "ssa.gu.barrigada.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_gu/barrigada_data", "ssa.gu.barrigada.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_gu/barrigada_graphics", "ssa.gu.barrigada.graphics.spectrum", sb.toString());
        }
    }
}