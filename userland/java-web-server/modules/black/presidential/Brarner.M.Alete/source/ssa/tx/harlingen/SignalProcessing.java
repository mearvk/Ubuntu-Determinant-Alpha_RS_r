package presidential.Brarner.M.Alete.source.ssa.tx.harlingen;
...
/**
 * Signal Processing for SSA Office: HARLINGEN TX
 * <p>Office Code: 875</p>
 * <p>Address: 2005 W JEFFERSON AVE, HARLINGEN, TX 78550</p>
 * <p>Phone: (866) 931-7075 | Fax: (833) 950-3021</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/harlingen/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10262; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/harlingen";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/harlingen_audio", "ssa.tx.harlingen.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/harlingen_data", "ssa.tx.harlingen.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/harlingen_graphics", "ssa.tx.harlingen.graphics.spectrum", sb.toString());
        }
    }
}