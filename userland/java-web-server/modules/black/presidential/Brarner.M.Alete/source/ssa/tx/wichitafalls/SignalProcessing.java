package presidential.Brarner.M.Alete.source.ssa.tx.wichitafalls;
...
/**
 * Signal Processing for SSA Office: WICHITA FALLS TX
 * <p>Office Code: 823</p>
 * <p>Address: 4314 WENDOVER ST, WICHITA FALLS, TX 76309</p>
 * <p>Phone: (866) 815-9605 | Fax: (833) 902-2574</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/wichitafalls/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10214; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/wichitafalls";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/wichitafalls_audio", "ssa.tx.wichitafalls.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/wichitafalls_data", "ssa.tx.wichitafalls.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/wichitafalls_graphics", "ssa.tx.wichitafalls.graphics.spectrum", sb.toString());
        }
    }
}