package presidential.Brarner.M.Alete.source.ssa.il.sterling;
...
/**
 * Signal Processing for SSA Office: STERLING IL
 * <p>Office Code: 518</p>
 * <p>Address: 3610 E LINCOLNWAY, STERLING, IL 61081</p>
 * <p>Phone: (866) 789-1093 | Fax: (833) 950-3443</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/sterling/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9952; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/sterling";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/sterling_audio", "ssa.il.sterling.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/sterling_data", "ssa.il.sterling.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/sterling_graphics", "ssa.il.sterling.graphics.spectrum", sb.toString());
        }
    }
}