package presidential.Brarner.M.Alete.source.ssa.fl.kissimmee;
...
/**
 * Signal Processing for SSA Office: KISSIMMEE FL
 * <p>Office Code: A16</p>
 * <p>Address: 4030 WEST VINE ST., KISSIMMEE, FL 34741</p>
 * <p>Phone: (866) 614-4754 | Fax: (833) 950-2512</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/kissimmee/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9208; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/kissimmee";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/kissimmee_audio", "ssa.fl.kissimmee.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/kissimmee_data", "ssa.fl.kissimmee.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/kissimmee_graphics", "ssa.fl.kissimmee.graphics.spectrum", sb.toString());
        }
    }
}