package presidential.Brarner.M.Alete.source.ssa.ca.fontana;
...
/**
 * Signal Processing for SSA Office: FONTANA CA
 * <p>Office Code: B69</p>
 * <p>Address: 10668 SIERRA AVE, FONTANA, CA 92337</p>
 * <p>Phone: (866) 726-7865 | Fax: (833) 571-0628</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/fontana/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9327; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/fontana";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fontana_audio", "ssa.ca.fontana.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fontana_data", "ssa.ca.fontana.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fontana_graphics", "ssa.ca.fontana.graphics.spectrum", sb.toString());
        }
    }
}