package presidential.Brarner.M.Alete.source.ssa.nc.gastonia;
...
/**
 * Signal Processing for SSA Office: GASTONIA NC
 * <p>Office Code: 332</p>
 * <p>Address: 609 COTTON BLOSSOM CIR, GASTONIA, NC 28054</p>
 * <p>Phone: (866) 331-2193 | Fax: (833) 950-2840</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/gastonia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9781; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/gastonia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/gastonia_audio", "ssa.nc.gastonia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/gastonia_data", "ssa.nc.gastonia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/gastonia_graphics", "ssa.nc.gastonia.graphics.spectrum", sb.toString());
        }
    }
}