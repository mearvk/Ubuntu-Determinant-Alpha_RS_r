package presidential.Brarner.M.Alete.source.ssa.fl.miami;
...
/**
 * Signal Processing for SSA Office: LITTLE HAVANA FL
 * <p>Office Code: C29</p>
 * <p>Address: 3663 SW 8TH ST, MIAMI, FL 33135</p>
 * <p>Phone: (877) 714-0373 | Fax: (833) 950-3763</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/miami/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9356; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/miami";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/miami_audio", "ssa.fl.miami.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/miami_data", "ssa.fl.miami.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/miami_graphics", "ssa.fl.miami.graphics.spectrum", sb.toString());
        }
    }
}