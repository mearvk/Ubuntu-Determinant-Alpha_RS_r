package presidential.Brarner.M.Alete.source.ssa.tx.fortworth002;
...
/**
 * Signal Processing for SSA Office: FORTWORTH TX
 * <p>Office Code: 821</p>
 * <p>Address: 819 TAYLOR ST, FORT WORTH, TX 76102</p>
 * <p>Phone: (866) 704-4858 | Fax: (833) 519-3211</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/fortworth002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10212; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/fortworth002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/fortworth002_audio", "ssa.tx.fortworth002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/fortworth002_data", "ssa.tx.fortworth002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/fortworth002_graphics", "ssa.tx.fortworth002.graphics.spectrum", sb.toString());
        }
    }
}