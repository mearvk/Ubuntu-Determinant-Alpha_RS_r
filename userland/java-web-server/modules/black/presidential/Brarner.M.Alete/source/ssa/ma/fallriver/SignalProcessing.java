package presidential.Brarner.M.Alete.source.ssa.ma.fallriver;
...
/**
 * Signal Processing for SSA Office: FALL RIVER MA
 * <p>Office Code: 42</p>
 * <p>Address: 400 NORTH MAIN STREET, FALL RIVER, MA 2720</p>
 * <p>Phone: (866) 964-3967 | Fax: (833) 902-2524</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/fallriver/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9525; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/fallriver";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/fallriver_audio", "ssa.ma.fallriver.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/fallriver_data", "ssa.ma.fallriver.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/fallriver_graphics", "ssa.ma.fallriver.graphics.spectrum", sb.toString());
        }
    }
}