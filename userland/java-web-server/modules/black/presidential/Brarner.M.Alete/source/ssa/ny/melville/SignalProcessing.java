package presidential.Brarner.M.Alete.source.ssa.ny.melville;
...
/**
 * Signal Processing for SSA Office: MELVILLE NY
 * <p>Office Code: 144</p>
 * <p>Address: 1121 WALT WHITMAN RD, MELVILLE, NY 11747</p>
 * <p>Phone: (866) 964-0165 | Fax: (833) 950-2370</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/melville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9613; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/melville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/melville_audio", "ssa.ny.melville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/melville_data", "ssa.ny.melville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/melville_graphics", "ssa.ny.melville.graphics.spectrum", sb.toString());
        }
    }
}