package presidential.Brarner.M.Alete.source.ssa.ky.jackson;
...
/**
 * Signal Processing for SSA Office: JACKSON KY
 * <p>Office Code: D80</p>
 * <p>Address: 850 HWY 15 N, JACKSON, KY 41339</p>
 * <p>Phone: (866) 366-4920 | Fax: (833) 902-2708</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/jackson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9448; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/jackson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/jackson_audio", "ssa.ky.jackson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/jackson_data", "ssa.ky.jackson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/jackson_graphics", "ssa.ky.jackson.graphics.spectrum", sb.toString());
        }
    }
}