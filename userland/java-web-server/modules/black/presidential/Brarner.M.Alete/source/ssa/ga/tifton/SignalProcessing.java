package presidential.Brarner.M.Alete.source.ssa.ga.tifton;
...
/**
 * Signal Processing for SSA Office: TIFTON GA
 * <p>Office Code: C95</p>
 * <p>Address: 732 2ND ST W, TIFTON, GA 31794</p>
 * <p>Phone: (877) 635-3542 | Fax: (833) 597-0070</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/tifton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9396; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/tifton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/tifton_audio", "ssa.ga.tifton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/tifton_data", "ssa.ga.tifton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/tifton_graphics", "ssa.ga.tifton.graphics.spectrum", sb.toString());
        }
    }
}