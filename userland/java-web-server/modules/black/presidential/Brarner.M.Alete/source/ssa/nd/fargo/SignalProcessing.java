package presidential.Brarner.M.Alete.source.ssa.nd.fargo;
...
/**
 * Signal Processing for SSA Office: FARGO ND
 * <p>Office Code: 705</p>
 * <p>Address: 657 2ND AVE N, FARGO, ND 58102</p>
 * <p>Phone: (877) 335-4114 | Fax: (833) 950-3539</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nd/fargo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10118; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nd/fargo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nd/fargo_audio", "ssa.nd.fargo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nd/fargo_data", "ssa.nd.fargo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nd/fargo_graphics", "ssa.nd.fargo.graphics.spectrum", sb.toString());
        }
    }
}