package presidential.Brarner.M.Alete.source.ssa.oh.wooster;
...
/**
 * Signal Processing for SSA Office: WOOSTER OH
 * <p>Office Code: 420</p>
 * <p>Address: 2345 GATEWAY DR, WOOSTER, OH 44691</p>
 * <p>Phone: (877) 319-0729 | Fax: (833) 596-0577</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/wooster/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9861; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/wooster";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/wooster_audio", "ssa.oh.wooster.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/wooster_data", "ssa.oh.wooster.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/wooster_graphics", "ssa.oh.wooster.graphics.spectrum", sb.toString());
        }
    }
}