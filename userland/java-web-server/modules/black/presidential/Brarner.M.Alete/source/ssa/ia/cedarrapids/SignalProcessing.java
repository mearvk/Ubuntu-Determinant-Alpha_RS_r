package presidential.Brarner.M.Alete.source.ssa.ia.cedarrapids;
...
/**
 * Signal Processing for SSA Office: CEDAR RAPIDS IA
 * <p>Office Code: 696</p>
 * <p>Address: 3165 WILLIAMS BLVD SW, CEDAR RAPIDS, IA 52404</p>
 * <p>Phone: (866) 495-0088 | Fax: (833) 515-0431</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/cedarrapids/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10110; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/cedarrapids";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/cedarrapids_audio", "ssa.ia.cedarrapids.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/cedarrapids_data", "ssa.ia.cedarrapids.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/cedarrapids_graphics", "ssa.ia.cedarrapids.graphics.spectrum", sb.toString());
        }
    }
}