...
/**
 * Signal Processing for SSA Office: HOBBS NM
 * <p>Office Code: B53</p>
 * <p>Address: 501 E BENDER BLVD, HOBBS, NM 88240</p>
 * <p>Phone: (866) 254-2611 | Fax: (833) 939-2007</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nm/hobbs/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9315; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nm/hobbs";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nm/hobbs_audio", "ssa.nm.hobbs.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nm/hobbs_data", "ssa.nm.hobbs.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nm/hobbs_graphics", "ssa.nm.hobbs.graphics.spectrum", sb.toString());
        }
    }
}