package presidential.Brarner.M.Alete.source.ssa.ma.pittsfield;
...
/**
 * Signal Processing for SSA Office: PITTSFIELD MA
 * <p>Office Code: 37</p>
 * <p>Address: 78 CENTER ST, PITTSFIELD, MA 1201</p>
 * <p>Phone: (866) 446-7111 | Fax: (833) 902-2514</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/pittsfield/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9520; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/pittsfield";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/pittsfield_audio", "ssa.ma.pittsfield.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/pittsfield_data", "ssa.ma.pittsfield.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/pittsfield_graphics", "ssa.ma.pittsfield.graphics.spectrum", sb.toString());
        }
    }
}