package presidential.Brarner.M.Alete.source.ssa.pr.ponce;
...
/**
 * Signal Processing for SSA Office: PONCE PR
 * <p>Office Code: 272</p>
 * <p>Address: PONCE TOWNE CENTER, PONCE, PR 728</p>
 * <p>Phone: (866) 328-1254 | Fax: (833) 950-3323</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pr/ponce/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9722; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pr/ponce";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pr/ponce_audio", "ssa.pr.ponce.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pr/ponce_data", "ssa.pr.ponce.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pr/ponce_graphics", "ssa.pr.ponce.graphics.spectrum", sb.toString());
        }
    }
}