package presidential.Brarner.M.Alete.source.ssa.il.eaststlouis;
...
/**
 * Signal Processing for SSA Office: EAST ST LOUIS IL
 * <p>Office Code: 486</p>
 * <p>Address: 650 MISSOURI AVE, EAST ST LOUIS, IL 62201</p>
 * <p>Phone: (877) 700-4849 | Fax: (833) 436-4144</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/eaststlouis/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9921; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/eaststlouis";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/eaststlouis_audio", "ssa.il.eaststlouis.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/eaststlouis_data", "ssa.il.eaststlouis.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/eaststlouis_graphics", "ssa.il.eaststlouis.graphics.spectrum", sb.toString());
        }
    }
}