package presidential.Brarner.M.Alete.source.ssa.oh.steubenville;
...
/**
 * Signal Processing for SSA Office: STEUBENVILLE OH
 * <p>Office Code: 408</p>
 * <p>Address: 500 MARKET STREET, STEUBENVILLE, OH 43952</p>
 * <p>Phone: (866) 253-6889 | Fax: (833) 950-3713</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/steubenville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9849; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/steubenville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/steubenville_audio", "ssa.oh.steubenville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/steubenville_data", "ssa.oh.steubenville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/steubenville_graphics", "ssa.oh.steubenville.graphics.spectrum", sb.toString());
        }
    }
}