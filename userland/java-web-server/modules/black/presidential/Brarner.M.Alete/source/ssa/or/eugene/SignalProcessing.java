package presidential.Brarner.M.Alete.source.ssa.or.eugene;
...
/**
 * Signal Processing for SSA Office: EUGENE OR
 * <p>Office Code: 933</p>
 * <p>Address: 2504 OAKMONT WAY, EUGENE, OR 97401</p>
 * <p>Phone: (866) 563-3450 | Fax: (833) 950-2912</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/or/eugene/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10316; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/or/eugene";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_or/eugene_audio", "ssa.or.eugene.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_or/eugene_data", "ssa.or.eugene.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_or/eugene_graphics", "ssa.or.eugene.graphics.spectrum", sb.toString());
        }
    }
}