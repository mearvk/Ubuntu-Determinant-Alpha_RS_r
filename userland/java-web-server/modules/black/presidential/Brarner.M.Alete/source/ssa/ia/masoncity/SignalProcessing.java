package presidential.Brarner.M.Alete.source.ssa.ia.masoncity;
...
/**
 * Signal Processing for SSA Office: MASON CITY IA
 * <p>Office Code: 698</p>
 * <p>Address: 625 VILLAGE GREEN DR SW, MASON CITY, IA 50401</p>
 * <p>Phone: (866) 365-6708 | Fax: (833) 515-0435</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/masoncity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10112; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/masoncity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/masoncity_audio", "ssa.ia.masoncity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/masoncity_data", "ssa.ia.masoncity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/masoncity_graphics", "ssa.ia.masoncity.graphics.spectrum", sb.toString());
        }
    }
}