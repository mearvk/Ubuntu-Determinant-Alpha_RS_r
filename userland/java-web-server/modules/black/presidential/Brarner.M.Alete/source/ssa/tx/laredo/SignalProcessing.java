package presidential.Brarner.M.Alete.source.ssa.tx.laredo;
...
/**
 * Signal Processing for SSA Office: LAREDO TX
 * <p>Office Code: 840</p>
 * <p>Address: 215 CALLE DEL NORTE, LAREDO, TX 78041</p>
 * <p>Phone: (866) 704-4857 | Fax: (833) 940-1970</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/laredo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10231; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/laredo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/laredo_audio", "ssa.tx.laredo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/laredo_data", "ssa.tx.laredo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/laredo_graphics", "ssa.tx.laredo.graphics.spectrum", sb.toString());
        }
    }
}