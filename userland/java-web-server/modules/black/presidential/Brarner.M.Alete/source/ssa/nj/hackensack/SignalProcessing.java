package presidential.Brarner.M.Alete.source.ssa.nj.hackensack;
...
/**
 * Signal Processing for SSA Office: HACKENSACK NJ
 * <p>Office Code: 182</p>
 * <p>Address: 401 HACKENSACK AVE, HACKENSACK, NJ 7601</p>
 * <p>Phone: (866) 964-4680 | Fax: (833) 950-3291</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nj/hackensack/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9644; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nj/hackensack";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nj/hackensack_audio", "ssa.nj.hackensack.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nj/hackensack_data", "ssa.nj.hackensack.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nj/hackensack_graphics", "ssa.nj.hackensack.graphics.spectrum", sb.toString());
        }
    }
}