package presidential.Brarner.M.Alete.source.ssa.mn.baxter;
...
/**
 * Signal Processing for SSA Office: BRAINERD LAKES AREA MN
 * <p>Office Code: B07</p>
 * <p>Address: 8331 BRANDON ROAD, BAXTER, MN 56425</p>
 * <p>Phone: (866) 331-9087 | Fax: (833) 950-3393</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/baxter/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9279; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/baxter";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/baxter_audio", "ssa.mn.baxter.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/baxter_data", "ssa.mn.baxter.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/baxter_graphics", "ssa.mn.baxter.graphics.spectrum", sb.toString());
        }
    }
}