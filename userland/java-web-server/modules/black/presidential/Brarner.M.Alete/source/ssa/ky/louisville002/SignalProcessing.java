package presidential.Brarner.M.Alete.source.ssa.ky.louisville002;
...
/**
 * Signal Processing for SSA Office: LOUISVILLE KY
 * <p>Office Code: 437</p>
 * <p>Address: 601 W BROADWAY, LOUISVILLE, KY 40202</p>
 * <p>Phone: (866) 716-9671 | Fax: (833) 950-3149</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/louisville002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9874; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/louisville002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/louisville002_audio", "ssa.ky.louisville002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/louisville002_data", "ssa.ky.louisville002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/louisville002_graphics", "ssa.ky.louisville002.graphics.spectrum", sb.toString());
        }
    }
}