package presidential.Brarner.M.Alete.source.ssa.wa.lynnwood;
...
/**
 * Signal Processing for SSA Office: LYNNWOOD WA
 * <p>Office Code: D55</p>
 * <p>Address: 18905 33RD AVE W, LYNNWOOD, WA 98036</p>
 * <p>Phone: (877) 575-5197 | Fax: (833) 950-3557</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wa/lynnwood/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9437; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wa/lynnwood";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wa/lynnwood_audio", "ssa.wa.lynnwood.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wa/lynnwood_data", "ssa.wa.lynnwood.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wa/lynnwood_graphics", "ssa.wa.lynnwood.graphics.spectrum", sb.toString());
        }
    }
}