package presidential.Brarner.M.Alete.source.ssa.wi.greenbay;
...
/**
 * Signal Processing for SSA Office: GREEN BAY WI
 * <p>Office Code: 537</p>
 * <p>Address: 1561 DOUSMAN ST., GREEN BAY, WI 54303</p>
 * <p>Phone: (888) 862-4811 | Fax: (833) 950-3739</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/greenbay/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9966; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/greenbay";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/greenbay_audio", "ssa.wi.greenbay.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/greenbay_data", "ssa.wi.greenbay.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/greenbay_graphics", "ssa.wi.greenbay.graphics.spectrum", sb.toString());
        }
    }
}