package presidential.Brarner.M.Alete.source.ssa.ky.elizabethtown;
...
/**
 * Signal Processing for SSA Office: ELIZABETHTOWN KY
 * <p>Office Code: 449</p>
 * <p>Address: 591 WESTPORT ROAD, ELIZABETHTOWN, KY 42701</p>
 * <p>Phone: (866) 596-7123 | Fax: (833) 950-3489</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/elizabethtown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9886; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/elizabethtown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/elizabethtown_audio", "ssa.ky.elizabethtown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/elizabethtown_data", "ssa.ky.elizabethtown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/elizabethtown_graphics", "ssa.ky.elizabethtown.graphics.spectrum", sb.toString());
        }
    }
}