package presidential.Brarner.M.Alete.source.ssa.pa.philadelphia004;
...
/**
 * Signal Processing for SSA Office: PHILA GERMANTOWN PA
 * <p>Office Code: 218</p>
 * <p>Address: 701 EAST CHELTEN AVE, PHILADELPHIA, PA 19144</p>
 * <p>Phone: (866) 495-0255 | Fax: (833) 346-7158</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/philadelphia004/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9676; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/philadelphia004";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia004_audio", "ssa.pa.philadelphia004.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia004_data", "ssa.pa.philadelphia004.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia004_graphics", "ssa.pa.philadelphia004.graphics.spectrum", sb.toString());
        }
    }
}