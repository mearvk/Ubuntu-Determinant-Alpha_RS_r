package presidential.Brarner.M.Alete.source.ssa.ga.augusta;
...
/**
 * Signal Processing for SSA Office: AUGUSTA GA
 * <p>Office Code: 606</p>
 * <p>Address: 115 ROBERT C DANIEL JR PKWY, AUGUSTA, GA 30909</p>
 * <p>Phone: (877) 616-2523 | Fax: (833) 950-2570</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/augusta/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10029; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/augusta";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/augusta_audio", "ssa.ga.augusta.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/augusta_data", "ssa.ga.augusta.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/augusta_graphics", "ssa.ga.augusta.graphics.spectrum", sb.toString());
        }
    }
}