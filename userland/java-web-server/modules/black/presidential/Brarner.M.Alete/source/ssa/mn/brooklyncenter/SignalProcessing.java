package presidential.Brarner.M.Alete.source.ssa.mn.brooklyncenter;
...
/**
 * Signal Processing for SSA Office: BROOKLYN CENTER
 * <p>Office Code: C39</p>
 * <p>Address: 3280 NORTHWAY DRIVE, BROOKLYN CENTER, MN 55429</p>
 * <p>Phone: (866) 931-0341 | Fax: (833) 950-3407</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/brooklyncenter/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9360; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/brooklyncenter";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/brooklyncenter_audio", "ssa.mn.brooklyncenter.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/brooklyncenter_data", "ssa.mn.brooklyncenter.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/brooklyncenter_graphics", "ssa.mn.brooklyncenter.graphics.spectrum", sb.toString());
        }
    }
}