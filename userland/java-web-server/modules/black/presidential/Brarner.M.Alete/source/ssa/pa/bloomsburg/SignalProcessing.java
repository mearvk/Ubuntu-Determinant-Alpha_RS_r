...
/**
 * Signal Processing for SSA Office: BLOOMSBURG PA
 * <p>Office Code: 192</p>
 * <p>Address: 700 MARKET ST, BLOOMSBURG, PA 17815</p>
 * <p>Phone: (866) 526-9847 | Fax: (833) 950-2878</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/bloomsburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9651; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/bloomsburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/bloomsburg_audio", "ssa.pa.bloomsburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/bloomsburg_data", "ssa.pa.bloomsburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/bloomsburg_graphics", "ssa.pa.bloomsburg.graphics.spectrum", sb.toString());
        }
    }
}