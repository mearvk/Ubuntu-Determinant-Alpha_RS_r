...
/**
 * Signal Processing for SSA Office: WATERTOWN SD
 * <p>Office Code: C58</p>
 * <p>Address: 514 JENSON AVE SE, WATERTOWN, SD 57201</p>
 * <p>Phone: (888) 737-1763 | Fax: (833) 950-2896</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sd/watertown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9372; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sd/watertown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sd/watertown_audio", "ssa.sd.watertown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sd/watertown_data", "ssa.sd.watertown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sd/watertown_graphics", "ssa.sd.watertown.graphics.spectrum", sb.toString());
        }
    }
}