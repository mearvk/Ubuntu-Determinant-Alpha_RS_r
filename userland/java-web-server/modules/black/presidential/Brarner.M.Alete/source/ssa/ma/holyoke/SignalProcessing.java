...
/**
 * Signal Processing for SSA Office: HOLYOKE MA
 * <p>Office Code: 44</p>
 * <p>Address: 200 HIGH STREET, HOLYOKE, MA 1040</p>
 * <p>Phone: (877) 480-4989 | Fax: (833) 902-2526</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/holyoke/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9526; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/holyoke";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/holyoke_audio", "ssa.ma.holyoke.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/holyoke_data", "ssa.ma.holyoke.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/holyoke_graphics", "ssa.ma.holyoke.graphics.spectrum", sb.toString());
        }
    }
}