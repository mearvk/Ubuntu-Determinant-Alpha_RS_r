package presidential.Brarner.M.Alete.source.ssa.nc.goldsboro;
...
/**
 * Signal Processing for SSA Office: GOLDSBORO NC
 * <p>Office Code: 329</p>
 * <p>Address: 915 W NEW HOPE ROAD, GOLDSBORO, NC 27534</p>
 * <p>Phone: (866) 964-7372 | Fax: (833) 950-2834</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/goldsboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9778; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/goldsboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/goldsboro_audio", "ssa.nc.goldsboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/goldsboro_data", "ssa.nc.goldsboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/goldsboro_graphics", "ssa.nc.goldsboro.graphics.spectrum", sb.toString());
        }
    }
}