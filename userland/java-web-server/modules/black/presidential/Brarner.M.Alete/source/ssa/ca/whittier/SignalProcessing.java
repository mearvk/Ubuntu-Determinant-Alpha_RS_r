package presidential.Brarner.M.Alete.source.ssa.ca.whittier;
...
/**
 * Signal Processing for SSA Office: WHITTIER CA
 * <p>Office Code: 982</p>
 * <p>Address: 7200 GREENLEAF AVE, WHITTIER, CA 90602</p>
 * <p>Phone: (866) 336-2187 | Fax: (833) 950-2458</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/whittier/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10363; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/whittier";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/whittier_audio", "ssa.ca.whittier.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/whittier_data", "ssa.ca.whittier.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/whittier_graphics", "ssa.ca.whittier.graphics.spectrum", sb.toString());
        }
    }
}