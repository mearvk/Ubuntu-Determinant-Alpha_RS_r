...
/**
 * Signal Processing for SSA Office: NORWICH CT
 * <p>Office Code: C68</p>
 * <p>Address: 55 MAIN ST, NORWICH, CT 6360</p>
 * <p>Phone: (888) 482-3170 | Fax: (833) 950-3262</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ct/norwich/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9378; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ct/norwich";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ct/norwich_audio", "ssa.ct.norwich.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ct/norwich_data", "ssa.ct.norwich.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ct/norwich_graphics", "ssa.ct.norwich.graphics.spectrum", sb.toString());
        }
    }
}