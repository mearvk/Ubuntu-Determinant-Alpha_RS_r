package presidential.Brarner.M.Alete.source.ssa.co.aurora;
...
/**
 * Signal Processing for SSA Office: AURORA CO
 * <p>Office Code: D24</p>
 * <p>Address: 14280 E JEWELL AVE, AURORA, CO 80012</p>
 * <p>Phone: (866) 931-9965 | Fax: (833) 436-4146</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/co/aurora/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9415; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/co/aurora";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_co/aurora_audio", "ssa.co.aurora.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_co/aurora_data", "ssa.co.aurora.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_co/aurora_graphics", "ssa.co.aurora.graphics.spectrum", sb.toString());
        }
    }
}