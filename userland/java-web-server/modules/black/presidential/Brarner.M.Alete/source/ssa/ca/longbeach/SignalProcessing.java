package presidential.Brarner.M.Alete.source.ssa.ca.longbeach;
...
/**
 * Signal Processing for SSA Office: LONG BEACH CA
 * <p>Office Code: 958</p>
 * <p>Address: 2005 LONG BEACH BLVD, LONG BEACH, CA 90806</p>
 * <p>Phone: (888) 256-2631 | Fax: (833) 902-2626</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/longbeach/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10340; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/longbeach";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/longbeach_audio", "ssa.ca.longbeach.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/longbeach_data", "ssa.ca.longbeach.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/longbeach_graphics", "ssa.ca.longbeach.graphics.spectrum", sb.toString());
        }
    }
}