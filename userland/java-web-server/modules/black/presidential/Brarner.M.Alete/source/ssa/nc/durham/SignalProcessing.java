...
/**
 * Signal Processing for SSA Office: DURHAM NC
 * <p>Office Code: 328</p>
 * <p>Address: 3511 SHANNON RD, DURHAM, NC 27707</p>
 * <p>Phone: (888) 759-3908 | Fax: (833) 950-2832</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/durham/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9777; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/durham";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/durham_audio", "ssa.nc.durham.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/durham_data", "ssa.nc.durham.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/durham_graphics", "ssa.nc.durham.graphics.spectrum", sb.toString());
        }
    }
}