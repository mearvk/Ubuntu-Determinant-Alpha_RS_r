package presidential.Brarner.M.Alete.source.ssa.la.opelousas;
...
/**
 * Signal Processing for SSA Office: OPELOUSAS LA
 * <p>Office Code: 810</p>
 * <p>Address: 5097 I49 S SERVICE RD, OPELOUSAS, LA 70570</p>
 * <p>Phone: (866) 698-3338 | Fax: (833) 950-3649</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/opelousas/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10202; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/opelousas";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/opelousas_audio", "ssa.la.opelousas.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/opelousas_data", "ssa.la.opelousas.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/opelousas_graphics", "ssa.la.opelousas.graphics.spectrum", sb.toString());
        }
    }
}