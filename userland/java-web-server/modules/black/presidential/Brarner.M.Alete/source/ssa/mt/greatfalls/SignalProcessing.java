package presidential.Brarner.M.Alete.source.ssa.mt.greatfalls;
...
/**
 * Signal Processing for SSA Office: GREAT FALLS MT
 * <p>Office Code: 869</p>
 * <p>Address: 2008 23RD ST S, GREAT FALLS, MT 59405</p>
 * <p>Phone: (877) 583-4114 | Fax: (833) 515-0413</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mt/greatfalls/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10256; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mt/greatfalls";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mt/greatfalls_audio", "ssa.mt.greatfalls.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mt/greatfalls_data", "ssa.mt.greatfalls.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mt/greatfalls_graphics", "ssa.mt.greatfalls.graphics.spectrum", sb.toString());
        }
    }
}