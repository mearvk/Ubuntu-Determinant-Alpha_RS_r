package presidential.Brarner.M.Alete.source.ssa.fl.marianna;
...
/**
 * Signal Processing for SSA Office: MARIANNA FL
 * <p>Office Code: C22</p>
 * <p>Address: 4227 LAFAYETTE ST, MARIANNA, FL 32446</p>
 * <p>Phone: (888) 397-4815 | Fax: (833) 950-3753</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/marianna/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9354; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/marianna";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/marianna_audio", "ssa.fl.marianna.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/marianna_data", "ssa.fl.marianna.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/marianna_graphics", "ssa.fl.marianna.graphics.spectrum", sb.toString());
        }
    }
}