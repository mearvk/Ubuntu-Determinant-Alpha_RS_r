package presidential.Brarner.M.Alete.source.ssa.ca.sanjose002;
...
/**
 * Signal Processing for SSA Office: SAN JOSE EAST CA
 * <p>Office Code: 385</p>
 * <p>Address: 2500 FONTAINE RD, SAN JOSE, CA 95121</p>
 * <p>Phone: (866) 931-4496 | Fax: (833) 950-3047</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sanjose002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9826; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sanjose002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanjose002_audio", "ssa.ca.sanjose002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanjose002_data", "ssa.ca.sanjose002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanjose002_graphics", "ssa.ca.sanjose002.graphics.spectrum", sb.toString());
        }
    }
}