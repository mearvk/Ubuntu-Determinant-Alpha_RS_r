package presidential.Brarner.M.Alete.source.ssa.ny.statenisland;
...
/**
 * Signal Processing for SSA Office: HYLAN BLVD NY
 * <p>Office Code: D58</p>
 * <p>Address: 1510 HYLAN BLVD, STATEN ISLAND, NY 10305</p>
 * <p>Phone: (877) 457-1736 | Fax: (833) 950-3287</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/statenisland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9439; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/statenisland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/statenisland_audio", "ssa.ny.statenisland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/statenisland_data", "ssa.ny.statenisland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/statenisland_graphics", "ssa.ny.statenisland.graphics.spectrum", sb.toString());
        }
    }
}