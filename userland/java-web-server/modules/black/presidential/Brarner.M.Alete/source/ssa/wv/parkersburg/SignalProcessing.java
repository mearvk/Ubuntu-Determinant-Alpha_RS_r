package presidential.Brarner.M.Alete.source.ssa.wv.parkersburg;
...
/**
 * Signal Processing for SSA Office: PARKERSBURG WV
 * <p>Office Code: 307</p>
 * <p>Address: 700 MARKET ST, PARKERSBURG, WV 26101</p>
 * <p>Phone: (866) 574-2533 | Fax: (833) 950-2251</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wv/parkersburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9757; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wv/parkersburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wv/parkersburg_audio", "ssa.wv.parkersburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wv/parkersburg_data", "ssa.wv.parkersburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wv/parkersburg_graphics", "ssa.wv.parkersburg.graphics.spectrum", sb.toString());
        }
    }
}