package presidential.Brarner.M.Alete.source.ssa.mi.highlandpark;
...
/**
 * Signal Processing for SSA Office: DETROIT-HIGH PK
 * <p>Office Code: 358</p>
 * <p>Address: 60 EAST GRAND AVENUE, HIGHLAND PARK, MI 48203</p>
 * <p>Phone: (877) 512-5945 | Fax: (833) 950-2138</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/highlandpark/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9805; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/highlandpark";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/highlandpark_audio", "ssa.mi.highlandpark.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/highlandpark_data", "ssa.mi.highlandpark.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/highlandpark_graphics", "ssa.mi.highlandpark.graphics.spectrum", sb.toString());
        }
    }
}