package presidential.Brarner.M.Alete.source.ssa.il.aurora;
...
/**
 * Signal Processing for SSA Office: AURORA IL
 * <p>Office Code: 508</p>
 * <p>Address: 1325 N. LAKE STREET, AURORA, IL 60506</p>
 * <p>Phone: (877) 274-5412 | Fax: (833) 950-3109</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/aurora/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9943; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/aurora";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/aurora_audio", "ssa.il.aurora.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/aurora_data", "ssa.il.aurora.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/aurora_graphics", "ssa.il.aurora.graphics.spectrum", sb.toString());
        }
    }
}