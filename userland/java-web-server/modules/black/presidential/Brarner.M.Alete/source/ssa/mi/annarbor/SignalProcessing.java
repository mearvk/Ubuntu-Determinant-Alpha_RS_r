package presidential.Brarner.M.Alete.source.ssa.mi.annarbor;
...
/**
 * Signal Processing for SSA Office: ANN ARBOR MI
 * <p>Office Code: 366</p>
 * <p>Address: 3971 RESEARCH PARK DR, ANN ARBOR, MI 48108</p>
 * <p>Phone: (877) 402-0825 | Fax: (734) 769-9916</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/annarbor/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9813; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/annarbor";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/annarbor_audio", "ssa.mi.annarbor.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/annarbor_data", "ssa.mi.annarbor.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/annarbor_graphics", "ssa.mi.annarbor.graphics.spectrum", sb.toString());
        }
    }
}