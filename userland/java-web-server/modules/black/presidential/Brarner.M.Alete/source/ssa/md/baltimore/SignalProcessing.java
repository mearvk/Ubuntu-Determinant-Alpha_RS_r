package presidential.Brarner.M.Alete.source.ssa.md.baltimore;
...
/**
 * Signal Processing for SSA Office: BALTO NE MD
 * <p>Office Code: 19</p>
 * <p>Address: 2401 BELAIR RD, BALTIMORE, MD 21213</p>
 * <p>Phone: (866) 336-9653 | Fax: (833) 341-2708</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/baltimore/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9504; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/baltimore";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/baltimore_audio", "ssa.md.baltimore.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/baltimore_data", "ssa.md.baltimore.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/baltimore_graphics", "ssa.md.baltimore.graphics.spectrum", sb.toString());
        }
    }
}