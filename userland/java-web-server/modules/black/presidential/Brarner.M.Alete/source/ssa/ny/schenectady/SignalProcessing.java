package presidential.Brarner.M.Alete.source.ssa.ny.schenectady;
...
/**
 * Signal Processing for SSA Office: SCHENECTADY NY
 * <p>Office Code: 105</p>
 * <p>Address: ONE BROADWAY CENTER, SCHENECTADY, NY 12305</p>
 * <p>Phone: (866) 964-1296 | Fax: (833) 950-3609</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/schenectady/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9576; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/schenectady";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/schenectady_audio", "ssa.ny.schenectady.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/schenectady_data", "ssa.ny.schenectady.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/schenectady_graphics", "ssa.ny.schenectady.graphics.spectrum", sb.toString());
        }
    }
}