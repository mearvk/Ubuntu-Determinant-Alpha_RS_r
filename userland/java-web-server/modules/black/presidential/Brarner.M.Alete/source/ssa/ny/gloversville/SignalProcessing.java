package presidential.Brarner.M.Alete.source.ssa.ny.gloversville;
...
/**
 * Signal Processing for SSA Office: GLOVERSVILLE NY
 * <p>Office Code: 122</p>
 * <p>Address: 13 N ARLINGTON AVE, GLOVERSVILLE, NY 12078</p>
 * <p>Phone: (888) 528-9446 | Fax: (833) 902-2536</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/gloversville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9593; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/gloversville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/gloversville_audio", "ssa.ny.gloversville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/gloversville_data", "ssa.ny.gloversville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/gloversville_graphics", "ssa.ny.gloversville.graphics.spectrum", sb.toString());
        }
    }
}