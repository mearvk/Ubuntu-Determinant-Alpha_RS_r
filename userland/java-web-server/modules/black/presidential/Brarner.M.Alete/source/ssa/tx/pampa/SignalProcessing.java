package presidential.Brarner.M.Alete.source.ssa.tx.pampa;
...
/**
 * Signal Processing for SSA Office: PAMPA TX
 * <p>Office Code: 847</p>
 * <p>Address: 2333 N HOBART ST, PAMPA, TX 79065</p>
 * <p>Phone: (877) 897-0603 | Fax: (833) 950-2410</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/pampa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10238; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/pampa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/pampa_audio", "ssa.tx.pampa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/pampa_data", "ssa.tx.pampa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/pampa_graphics", "ssa.tx.pampa.graphics.spectrum", sb.toString());
        }
    }
}