package presidential.Brarner.M.Alete.source.ssa.ca.fresno002;
...
/**
 * Signal Processing for SSA Office: WEST FRESNO CA
 * <p>Office Code: 386</p>
 * <p>Address: 865 FULTON STREET, FRESNO, CA 93721</p>
 * <p>Phone: (877) 311-2640 | Fax: (833) 950-3049</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/fresno002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9827; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/fresno002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fresno002_audio", "ssa.ca.fresno002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fresno002_data", "ssa.ca.fresno002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/fresno002_graphics", "ssa.ca.fresno002.graphics.spectrum", sb.toString());
        }
    }
}