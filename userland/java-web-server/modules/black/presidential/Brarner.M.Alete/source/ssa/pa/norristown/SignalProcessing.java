package presidential.Brarner.M.Alete.source.ssa.pa.norristown;
...
/**
 * Signal Processing for SSA Office: NORRISTOWN PA
 * <p>Office Code: 227</p>
 * <p>Address: 1700 MARKLEY ST, NORRISTOWN, PA 19401</p>
 * <p>Phone: (866) 964-6305 | Fax: (833) 461-0036</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/norristown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9684; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/norristown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/norristown_audio", "ssa.pa.norristown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/norristown_data", "ssa.pa.norristown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/norristown_graphics", "ssa.pa.norristown.graphics.spectrum", sb.toString());
        }
    }
}