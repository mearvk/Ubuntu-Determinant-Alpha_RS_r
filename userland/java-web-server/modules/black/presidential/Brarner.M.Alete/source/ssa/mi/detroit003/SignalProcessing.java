package presidential.Brarner.M.Alete.source.ssa.mi.detroit003;
...
/**
 * Signal Processing for SSA Office: GRAND RIVER MI
 * <p>Office Code: 372</p>
 * <p>Address: 9222 GRAND RIVER AVE, DETROIT, MI 48204</p>
 * <p>Phone: (866) 405-0043 | Fax: (833) 950-2778</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/detroit003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9818; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/detroit003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/detroit003_audio", "ssa.mi.detroit003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/detroit003_data", "ssa.mi.detroit003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/detroit003_graphics", "ssa.mi.detroit003.graphics.spectrum", sb.toString());
        }
    }
}