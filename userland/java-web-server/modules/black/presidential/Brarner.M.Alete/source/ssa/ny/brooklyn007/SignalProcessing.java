package presidential.Brarner.M.Alete.source.ssa.ny.brooklyn007;
...
/**
 * Signal Processing for SSA Office: BEDFORD HEIGHTS NY
 * <p>Office Code: 160</p>
 * <p>Address: 1540 FULTON STREET, BROOKLYN, NY 11216</p>
 * <p>Phone: (866) 592-4845 | Fax: (833) 950-2684</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/brooklyn007/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9625; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/brooklyn007";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn007_audio", "ssa.ny.brooklyn007.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn007_data", "ssa.ny.brooklyn007.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/brooklyn007_graphics", "ssa.ny.brooklyn007.graphics.spectrum", sb.toString());
        }
    }
}