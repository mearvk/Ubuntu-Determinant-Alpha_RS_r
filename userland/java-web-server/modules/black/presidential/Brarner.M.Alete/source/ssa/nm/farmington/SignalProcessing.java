package presidential.Brarner.M.Alete.source.ssa.nm.farmington;
...
/**
 * Signal Processing for SSA Office: FARMINGTON NM
 * <p>Office Code: 864</p>
 * <p>Address: 4650 N BUTLER, FARMINGTON, NM 87401</p>
 * <p>Phone: (866) 931-7656 | Fax: (833) 950-2730</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nm/farmington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10252; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nm/farmington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nm/farmington_audio", "ssa.nm.farmington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nm/farmington_data", "ssa.nm.farmington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nm/farmington_graphics", "ssa.nm.farmington.graphics.spectrum", sb.toString());
        }
    }
}