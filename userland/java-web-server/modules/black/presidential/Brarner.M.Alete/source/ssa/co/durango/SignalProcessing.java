package presidential.Brarner.M.Alete.source.ssa.co.durango;
...
/**
 * Signal Processing for SSA Office: DURANGO CO
 * <p>Office Code: 890</p>
 * <p>Address: 103 SHEPPARD DRIVE, DURANGO, CO 81303</p>
 * <p>Phone: (888) 472-6115 | Fax: (833) 641-3163</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/co/durango/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10275; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/co/durango";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_co/durango_audio", "ssa.co.durango.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_co/durango_data", "ssa.co.durango.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_co/durango_graphics", "ssa.co.durango.graphics.spectrum", sb.toString());
        }
    }
}