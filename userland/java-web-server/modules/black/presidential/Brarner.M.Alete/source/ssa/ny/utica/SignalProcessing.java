package presidential.Brarner.M.Alete.source.ssa.ny.utica;
...
/**
 * Signal Processing for SSA Office: UTICA NY
 * <p>Office Code: 110</p>
 * <p>Address: 10 BROAD STREET, UTICA, NY 13501</p>
 * <p>Phone: (877) 405-6750 | Fax: (833) 515-0469</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/utica/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9581; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/utica";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/utica_audio", "ssa.ny.utica.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/utica_data", "ssa.ny.utica.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/utica_graphics", "ssa.ny.utica.graphics.spectrum", sb.toString());
        }
    }
}