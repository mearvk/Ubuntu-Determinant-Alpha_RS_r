package presidential.Brarner.M.Alete.source.ssa.tx.conroe;
...
/**
 * Signal Processing for SSA Office: CONROE TX
 * <p>Office Code: A74</p>
 * <p>Address: 600 SGT ED HOLCOMB BLVD N, CONROE, TX 77304</p>
 * <p>Phone: (866) 614-0032 | Fax: (833) 902-2572</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/conroe/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9255; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/conroe";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/conroe_audio", "ssa.tx.conroe.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/conroe_data", "ssa.tx.conroe.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/conroe_graphics", "ssa.tx.conroe.graphics.spectrum", sb.toString());
        }
    }
}