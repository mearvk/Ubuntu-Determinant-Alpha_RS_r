package presidential.Brarner.M.Alete.source.ssa.nm.lascruces;
...
/**
 * Signal Processing for SSA Office: LAS CRUCES NM
 * <p>Office Code: 863</p>
 * <p>Address: 2141 SUMMIT COURT, LAS CRUCES, NM 88011</p>
 * <p>Phone: (866) 563-9294 | Fax: (833) 950-2728</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nm/lascruces/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10251; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nm/lascruces";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nm/lascruces_audio", "ssa.nm.lascruces.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nm/lascruces_data", "ssa.nm.lascruces.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nm/lascruces_graphics", "ssa.nm.lascruces.graphics.spectrum", sb.toString());
        }
    }
}