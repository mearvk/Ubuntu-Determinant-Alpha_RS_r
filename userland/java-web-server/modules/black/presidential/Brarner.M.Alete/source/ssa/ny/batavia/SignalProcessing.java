package presidential.Brarner.M.Alete.source.ssa.ny.batavia;
...
/**
 * Signal Processing for SSA Office: BATAVIA NY
 * <p>Office Code: 143</p>
 * <p>Address: 571 EAST MAIN STREET, BATAVIA, NY 14020</p>
 * <p>Phone: (866) 931-7103 | Fax: (833) 950-2368</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/batavia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9612; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/batavia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/batavia_audio", "ssa.ny.batavia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/batavia_data", "ssa.ny.batavia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/batavia_graphics", "ssa.ny.batavia.graphics.spectrum", sb.toString());
        }
    }
}