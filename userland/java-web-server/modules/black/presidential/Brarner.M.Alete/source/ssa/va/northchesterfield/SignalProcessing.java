...
/**
 * Signal Processing for SSA Office: CHESTERFIELD
 * <p>Office Code: A41</p>
 * <p>Address: 600 SOUTHLAKE BLVD, NORTH CHESTERFIELD, VA 23236</p>
 * <p>Phone: (877) 773-7231 | Fax: (833) 912-2314</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/northchesterfield/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9227; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/northchesterfield";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/northchesterfield_audio", "ssa.va.northchesterfield.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/northchesterfield_data", "ssa.va.northchesterfield.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/northchesterfield_graphics", "ssa.va.northchesterfield.graphics.spectrum", sb.toString());
        }
    }
}