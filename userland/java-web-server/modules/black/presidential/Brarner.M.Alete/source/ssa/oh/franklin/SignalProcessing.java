package presidential.Brarner.M.Alete.source.ssa.oh.franklin;
...
/**
 * Signal Processing for SSA Office: MIDDLETOWN OHIO
 * <p>Office Code: A65</p>
 * <p>Address: 3715 TOWNE BLVD, FRANKLIN, OH 45005</p>
 * <p>Phone: (877) 457-1738 | Fax: (833) 950-3071</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/franklin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9246; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/franklin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/franklin_audio", "ssa.oh.franklin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/franklin_data", "ssa.oh.franklin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/franklin_graphics", "ssa.oh.franklin.graphics.spectrum", sb.toString());
        }
    }
}