package presidential.Brarner.M.Alete.source.ssa.ny.newyork003;
...
/**
 * Signal Processing for SSA Office: NY DOWNTOWN NY
 * <p>Office Code: 109</p>
 * <p>Address: 123 WILLIAM ST, NEW YORK, NY 10038</p>
 * <p>Phone: (866) 335-1089 | Fax: (833) 515-0467</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/newyork003/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9579; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/newyork003";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork003_audio", "ssa.ny.newyork003.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork003_data", "ssa.ny.newyork003.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/newyork003_graphics", "ssa.ny.newyork003.graphics.spectrum", sb.toString());
        }
    }
}