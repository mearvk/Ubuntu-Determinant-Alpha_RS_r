...
/**
 * Signal Processing for SSA Office: DOTHAN AL
 * <p>Office Code: 628</p>
 * <p>Address: 1778 WHATLEY DRIVE, DOTHAN, AL 36303</p>
 * <p>Phone: (877) 452-4192 | Fax: (833) 950-3495</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/dothan/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10051; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/dothan";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/dothan_audio", "ssa.al.dothan.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/dothan_data", "ssa.al.dothan.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/dothan_graphics", "ssa.al.dothan.graphics.spectrum", sb.toString());
        }
    }
}