package presidential.Brarner.M.Alete.source.ssa.wi.oshkosh;
...
/**
 * Signal Processing for SSA Office: OSHKOSH WI
 * <p>Office Code: 545</p>
 * <p>Address: 400 CITY CENTER STE B, OSHKOSH, WI 54901</p>
 * <p>Phone: (877) 445-0834 | Fax: (833) 596-0595</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wi/oshkosh/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9974; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wi/oshkosh";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wi/oshkosh_audio", "ssa.wi.oshkosh.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wi/oshkosh_data", "ssa.wi.oshkosh.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wi/oshkosh_graphics", "ssa.wi.oshkosh.graphics.spectrum", sb.toString());
        }
    }
}