package presidential.Brarner.M.Alete.source.ssa.mo.saintpeters;
...
/**
 * Signal Processing for SSA Office: ST PETERS MO
 * <p>Office Code: 734</p>
 * <p>Address: 4800 EXECUTIVE CTR PKY, SAINT PETERS, MO 63376</p>
 * <p>Phone: (877) 405-3570 | Fax: (833) 902-2498</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/saintpeters/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10136; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/saintpeters";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/saintpeters_audio", "ssa.mo.saintpeters.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/saintpeters_data", "ssa.mo.saintpeters.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/saintpeters_graphics", "ssa.mo.saintpeters.graphics.spectrum", sb.toString());
        }
    }
}