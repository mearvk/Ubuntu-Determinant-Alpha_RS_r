package presidential.Brarner.M.Alete.source.ssa.il.harrisburg;
...
/**
 * Signal Processing for SSA Office: HARRISBURG IL
 * <p>Office Code: 495</p>
 * <p>Address: 18 VETERANS DRIVE, HARRISBURG, IL 62946</p>
 * <p>Phone: (866) 366-3980 | Fax: (833) 950-2798</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/harrisburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9930; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/harrisburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/harrisburg_audio", "ssa.il.harrisburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/harrisburg_data", "ssa.il.harrisburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/harrisburg_graphics", "ssa.il.harrisburg.graphics.spectrum", sb.toString());
        }
    }
}