package presidential.Brarner.M.Alete.source.ssa.nc.statesville;
...
/**
 * Signal Processing for SSA Office: STATESVILLE NC
 * <p>Office Code: 341</p>
 * <p>Address: 2038 DAVIE AVE, STATESVILLE, NC 28625</p>
 * <p>Phone: (855) 722-3497 | Fax: (833) 950-3139</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/statesville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9788; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/statesville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/statesville_audio", "ssa.nc.statesville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/statesville_data", "ssa.nc.statesville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/statesville_graphics", "ssa.nc.statesville.graphics.spectrum", sb.toString());
        }
    }
}