package presidential.Brarner.M.Alete.source.ssa.sc.greenville;
...
/**
 * Signal Processing for SSA Office: GREENVILLE SC
 * <p>Office Code: 586</p>
 * <p>Address: 319 PELHAM RD, GREENVILLE, SC 29615</p>
 * <p>Phone: (877) 274-5423 | Fax: (833) 950-2231</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/greenville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10010; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/greenville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/greenville_audio", "ssa.sc.greenville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/greenville_data", "ssa.sc.greenville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/greenville_graphics", "ssa.sc.greenville.graphics.spectrum", sb.toString());
        }
    }
}