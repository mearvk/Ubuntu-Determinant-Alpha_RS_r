package presidential.Brarner.M.Alete.source.ssa.nc.lumberton;
...
/**
 * Signal Processing for SSA Office: LUMBERTON NC
 * <p>Office Code: 338</p>
 * <p>Address: 4430 KAHN DR, LUMBERTON, NC 28358</p>
 * <p>Phone: (866) 931-7099 | Fax: (833) 950-2848</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/lumberton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9785; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/lumberton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/lumberton_audio", "ssa.nc.lumberton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/lumberton_data", "ssa.nc.lumberton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/lumberton_graphics", "ssa.nc.lumberton.graphics.spectrum", sb.toString());
        }
    }
}