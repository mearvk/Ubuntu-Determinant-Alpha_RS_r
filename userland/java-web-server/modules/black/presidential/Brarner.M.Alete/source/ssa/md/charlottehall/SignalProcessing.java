package presidential.Brarner.M.Alete.source.ssa.md.charlottehall;
...
/**
 * Signal Processing for SSA Office: CHARLOTTE HALL MD
 * <p>Office Code: 530</p>
 * <p>Address: 30071 BUSINESS CTR DR, CHARLOTTE HALL, MD 20622</p>
 * <p>Phone: (888) 866-5181 | Fax: (833) 912-2296</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/charlottehall/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9961; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/charlottehall";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/charlottehall_audio", "ssa.md.charlottehall.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/charlottehall_data", "ssa.md.charlottehall.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/charlottehall_graphics", "ssa.md.charlottehall.graphics.spectrum", sb.toString());
        }
    }
}