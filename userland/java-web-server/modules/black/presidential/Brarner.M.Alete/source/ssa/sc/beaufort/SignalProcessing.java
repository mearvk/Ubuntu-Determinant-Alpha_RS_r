package presidential.Brarner.M.Alete.source.ssa.sc.beaufort;
...
/**
 * Signal Processing for SSA Office: BEAUFORT SC
 * <p>Office Code: 597</p>
 * <p>Address: 646 ROBERT SMALLS PKWY, BEAUFORT, SC 29906</p>
 * <p>Phone: (866) 254-3316 | Fax: (833) 436-4142</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/beaufort/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10021; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/beaufort";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/beaufort_audio", "ssa.sc.beaufort.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/beaufort_data", "ssa.sc.beaufort.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/beaufort_graphics", "ssa.sc.beaufort.graphics.spectrum", sb.toString());
        }
    }
}