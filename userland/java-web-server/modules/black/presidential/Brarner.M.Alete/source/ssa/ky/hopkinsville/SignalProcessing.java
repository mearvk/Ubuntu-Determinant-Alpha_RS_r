package presidential.Brarner.M.Alete.source.ssa.ky.hopkinsville;
...
/**
 * Signal Processing for SSA Office: HOPKINSVILLE KY
 * <p>Office Code: 447</p>
 * <p>Address: 1650 MARIE DRIVE, HOPKINSVILLE, KY 42240</p>
 * <p>Phone: (877) 405-7656 | Fax: (833) 950-3485</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ky/hopkinsville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9884; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ky/hopkinsville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ky/hopkinsville_audio", "ssa.ky.hopkinsville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ky/hopkinsville_data", "ssa.ky.hopkinsville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ky/hopkinsville_graphics", "ssa.ky.hopkinsville.graphics.spectrum", sb.toString());
        }
    }
}