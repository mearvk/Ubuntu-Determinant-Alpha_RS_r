package presidential.Brarner.M.Alete.source.ssa.ok.bartlesville;
...
/**
 * Signal Processing for SSA Office: BARTLESVILLE OK
 * <p>Office Code: 794</p>
 * <p>Address: 900 LEISURE LN, BARTLESVILLE, OK 74006</p>
 * <p>Phone: (877) 836-1557 | Fax: (833) 873-4344</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/bartlesville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10188; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/bartlesville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/bartlesville_audio", "ssa.ok.bartlesville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/bartlesville_data", "ssa.ok.bartlesville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/bartlesville_graphics", "ssa.ok.bartlesville.graphics.spectrum", sb.toString());
        }
    }
}