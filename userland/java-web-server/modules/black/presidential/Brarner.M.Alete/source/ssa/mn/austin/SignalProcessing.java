package presidential.Brarner.M.Alete.source.ssa.mn.austin;
...
/**
 * Signal Processing for SSA Office: AUSTIN MN
 * <p>Office Code: 684</p>
 * <p>Address: 404 2ND ST NW, AUSTIN, MN 55912</p>
 * <p>Phone: (866) 504-5010 | Fax: (833) 950-2178</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/austin/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10099; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/austin";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/austin_audio", "ssa.mn.austin.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/austin_data", "ssa.mn.austin.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/austin_graphics", "ssa.mn.austin.graphics.spectrum", sb.toString());
        }
    }
}