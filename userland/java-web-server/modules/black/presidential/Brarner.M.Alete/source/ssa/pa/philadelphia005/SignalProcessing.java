package presidential.Brarner.M.Alete.source.ssa.pa.philadelphia005;
...
/**
 * Signal Processing for SSA Office: PHILA NORTHEAST PA
 * <p>Office Code: 219</p>
 * <p>Address: 9300 ASHTON RD, PHILADELPHIA, PA 19114</p>
 * <p>Phone: (866) 331-7840 | Fax: (833) 950-3521</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/philadelphia005/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9677; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/philadelphia005";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia005_audio", "ssa.pa.philadelphia005.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia005_data", "ssa.pa.philadelphia005.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/philadelphia005_graphics", "ssa.pa.philadelphia005.graphics.spectrum", sb.toString());
        }
    }
}