package presidential.Brarner.M.Alete.source.ssa.mt.kalispell;
...
/**
 * Signal Processing for SSA Office: KALISPELL MT
 * <p>Office Code: 872</p>
 * <p>Address: 275 CORPORATE DR, KALISPELL, MT 59901</p>
 * <p>Phone: (888) 487-0150 | Fax: (833) 515-0417</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mt/kalispell/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10259; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mt/kalispell";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mt/kalispell_audio", "ssa.mt.kalispell.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mt/kalispell_data", "ssa.mt.kalispell.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mt/kalispell_graphics", "ssa.mt.kalispell.graphics.spectrum", sb.toString());
        }
    }
}