...
/**
 * Signal Processing for SSA Office: DEFIANCE OH
 * <p>Office Code: 412</p>
 * <p>Address: 273 STADIUM DR, DEFIANCE, OH 43512</p>
 * <p>Phone: (877) 600-2860 | Fax: (833) 950-3721</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/defiance/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9853; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/defiance";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/defiance_audio", "ssa.oh.defiance.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/defiance_data", "ssa.oh.defiance.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/defiance_graphics", "ssa.oh.defiance.graphics.spectrum", sb.toString());
        }
    }
}