package presidential.Brarner.M.Alete.source.ssa.mo.nevada;
...
/**
 * Signal Processing for SSA Office: NEVADA MO
 * <p>Office Code: B35</p>
 * <p>Address: 120 S COMMERCE DR, NEVADA, MO 64772</p>
 * <p>Phone: (888) 808-5441 | Fax: (833) 950-2644</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/nevada/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9302; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/nevada";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/nevada_audio", "ssa.mo.nevada.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/nevada_data", "ssa.mo.nevada.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/nevada_graphics", "ssa.mo.nevada.graphics.spectrum", sb.toString());
        }
    }
}