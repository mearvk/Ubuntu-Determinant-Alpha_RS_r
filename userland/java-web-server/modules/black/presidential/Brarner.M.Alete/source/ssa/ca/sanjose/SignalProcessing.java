package presidential.Brarner.M.Alete.source.ssa.ca.sanjose;
...
/**
 * Signal Processing for SSA Office: SAN JOSE SOUTH
 * <p>Office Code: E41</p>
 * <p>Address: 6140 COTTLE RD, SAN JOSE, CA 95123</p>
 * <p>Phone: (888) 383-1180 | Fax: (833) 940-1991</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/sanjose/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9468; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/sanjose";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanjose_audio", "ssa.ca.sanjose.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanjose_data", "ssa.ca.sanjose.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/sanjose_graphics", "ssa.ca.sanjose.graphics.spectrum", sb.toString());
        }
    }
}