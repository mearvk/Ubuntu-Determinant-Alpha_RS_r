package presidential.Brarner.M.Alete.source.ssa.il.danville;
...
/**
 * Signal Processing for SSA Office: DANVILLE IL
 * <p>Office Code: 493</p>
 * <p>Address: 400 N. VERMILION ST., DANVILLE, IL 61832</p>
 * <p>Phone: (866) 331-5394 | Fax: (833) 950-2794</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/danville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9928; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/danville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/danville_audio", "ssa.il.danville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/danville_data", "ssa.il.danville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/danville_graphics", "ssa.il.danville.graphics.spectrum", sb.toString());
        }
    }
}