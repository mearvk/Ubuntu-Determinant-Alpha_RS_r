...
/**
 * Signal Processing for SSA Office: DULUTH MN
 * <p>Office Code: 676</p>
 * <p>Address: 230 W SUPERIOR ST, DULUTH, MN 55802</p>
 * <p>Phone: (855) 863-3560 | Fax: (833) 902-2690</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/duluth/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10091; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/duluth";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/duluth_audio", "ssa.mn.duluth.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/duluth_data", "ssa.mn.duluth.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/duluth_graphics", "ssa.mn.duluth.graphics.spectrum", sb.toString());
        }
    }
}