package presidential.Brarner.M.Alete.source.ssa.in.hammond;
...
/**
 * Signal Processing for SSA Office: HAMMOND IN
 * <p>Office Code: 469</p>
 * <p>Address: 418 E DOUGLAS STREET, HAMMOND, IN 46320</p>
 * <p>Phone: (877) 512-3859 | Fax: (833) 950-2150</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/hammond/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9906; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/hammond";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/hammond_audio", "ssa.in.hammond.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/hammond_data", "ssa.in.hammond.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/hammond_graphics", "ssa.in.hammond.graphics.spectrum", sb.toString());
        }
    }
}