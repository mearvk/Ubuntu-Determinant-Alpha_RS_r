package presidential.Brarner.M.Alete.source.ssa.pa.upperdarby;
...
/**
 * Signal Processing for SSA Office: UPPER DARBY PA
 * <p>Office Code: 243</p>
 * <p>Address: 8645 WEST CHESTER PIKE, UPPER DARBY, PA 19082</p>
 * <p>Phone: (866) 964-0780 | Fax: (833) 612-0138</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/upperdarby/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9699; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/upperdarby";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/upperdarby_audio", "ssa.pa.upperdarby.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/upperdarby_data", "ssa.pa.upperdarby.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/upperdarby_graphics", "ssa.pa.upperdarby.graphics.spectrum", sb.toString());
        }
    }
}