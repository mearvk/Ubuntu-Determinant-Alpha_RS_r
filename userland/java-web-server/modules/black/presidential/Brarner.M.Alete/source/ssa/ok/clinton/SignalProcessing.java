package presidential.Brarner.M.Alete.source.ssa.ok.clinton;
...
/**
 * Signal Processing for SSA Office: CLINTON OK
 * <p>Office Code: 798</p>
 * <p>Address: 410 OPAL AVE, CLINTON, OK 73601</p>
 * <p>Phone: (877) 405-9345 | Fax: (833) 950-3347</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ok/clinton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10191; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ok/clinton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ok/clinton_audio", "ssa.ok.clinton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ok/clinton_data", "ssa.ok.clinton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ok/clinton_graphics", "ssa.ok.clinton.graphics.spectrum", sb.toString());
        }
    }
}