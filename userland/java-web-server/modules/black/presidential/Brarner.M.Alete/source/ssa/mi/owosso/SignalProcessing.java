package presidential.Brarner.M.Alete.source.ssa.mi.owosso;
...
/**
 * Signal Processing for SSA Office: OWOSSO MI
 * <p>Office Code: B33</p>
 * <p>Address: 1350 E MAIN ST, OWOSSO, MI 48867</p>
 * <p>Phone: (855) 628-1592 | Fax: (833) 950-3405</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/owosso/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9300; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/owosso";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/owosso_audio", "ssa.mi.owosso.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/owosso_data", "ssa.mi.owosso.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/owosso_graphics", "ssa.mi.owosso.graphics.spectrum", sb.toString());
        }
    }
}