package presidential.Brarner.M.Alete.source.ssa.tx.corsicana;
...
/**
 * Signal Processing for SSA Office: CORSICANA TX
 * <p>Office Code: 843</p>
 * <p>Address: 221 S 45TH ST, CORSICANA, TX 75110</p>
 * <p>Phone: (888) 456-9551 | Fax: (833) 950-2402</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/corsicana/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10234; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/corsicana";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/corsicana_audio", "ssa.tx.corsicana.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/corsicana_data", "ssa.tx.corsicana.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/corsicana_graphics", "ssa.tx.corsicana.graphics.spectrum", sb.toString());
        }
    }
}