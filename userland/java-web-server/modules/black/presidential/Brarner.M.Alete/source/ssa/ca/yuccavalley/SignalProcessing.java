package presidential.Brarner.M.Alete.source.ssa.ca.yuccavalley;
...
/**
 * Signal Processing for SSA Office: MORONGO BASIN CA
 * <p>Office Code: A53</p>
 * <p>Address: 56492 29 PALMS HWY, YUCCA VALLEY, CA 92284</p>
 * <p>Phone: (877) 325-7417 | Fax: (833) 950-3363</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/yuccavalley/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9236; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/yuccavalley";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/yuccavalley_audio", "ssa.ca.yuccavalley.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/yuccavalley_data", "ssa.ca.yuccavalley.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/yuccavalley_graphics", "ssa.ca.yuccavalley.graphics.spectrum", sb.toString());
        }
    }
}