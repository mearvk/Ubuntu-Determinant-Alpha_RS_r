...
/**
 * Signal Processing for SSA Office: GWINNETT GA
 * <p>Office Code: 620</p>
 * <p>Address: 4365 SHACKLEFORD RD, NORCROSS, GA 30093</p>
 * <p>Phone: (877) 803-6320 | Fax: (833) 950-3163</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/norcross/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10043; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/norcross";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/norcross_audio", "ssa.ga.norcross.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/norcross_data", "ssa.ga.norcross.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/norcross_graphics", "ssa.ga.norcross.graphics.spectrum", sb.toString());
        }
    }
}