package presidential.Brarner.M.Alete.source.ssa.va.danville;
...
/**
 * Signal Processing for SSA Office: DANVILLE VA
 * <p>Office Code: 292</p>
 * <p>Address: 3295 US HWY 29, DANVILLE, VA 24540</p>
 * <p>Phone: (866) 331-5398 | Fax: (833) 950-2290</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/danville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9742; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/danville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/danville_audio", "ssa.va.danville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/danville_data", "ssa.va.danville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/danville_graphics", "ssa.va.danville.graphics.spectrum", sb.toString());
        }
    }
}