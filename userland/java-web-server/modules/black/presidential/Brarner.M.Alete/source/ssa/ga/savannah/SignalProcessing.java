...
/**
 * Signal Processing for SSA Office: SAVANNAH GA
 * <p>Office Code: 601</p>
 * <p>Address: 325 W MONTGOMERY XRD, SAVANNAH, GA 31406</p>
 * <p>Phone: (866) 366-4923 | Fax: (833) 950-2560</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/savannah/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10024; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/savannah";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/savannah_audio", "ssa.ga.savannah.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/savannah_data", "ssa.ga.savannah.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/savannah_graphics", "ssa.ga.savannah.graphics.spectrum", sb.toString());
        }
    }
}