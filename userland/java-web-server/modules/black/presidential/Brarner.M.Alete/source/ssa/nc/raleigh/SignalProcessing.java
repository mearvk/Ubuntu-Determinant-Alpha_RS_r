package presidential.Brarner.M.Alete.source.ssa.nc.raleigh;
...
/**
 * Signal Processing for SSA Office: RALEIGH NC
 * <p>Office Code: 322</p>
 * <p>Address: 3315 POOLE RD, RALEIGH, NC 27610</p>
 * <p>Phone: (877) 803-6311 | Fax: (833) 950-2540</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/raleigh/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9771; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/raleigh";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/raleigh_audio", "ssa.nc.raleigh.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/raleigh_data", "ssa.nc.raleigh.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/raleigh_graphics", "ssa.nc.raleigh.graphics.spectrum", sb.toString());
        }
    }
}