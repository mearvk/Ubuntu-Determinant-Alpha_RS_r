...
/**
 * Signal Processing for SSA Office: BLYTHEVILLE AR
 * <p>Office Code: 762</p>
 * <p>Address: 1403 S DIVISION ST, BLYTHEVILLE, AR 72315</p>
 * <p>Phone: (866) 842-6638 | Fax: (833) 950-2710</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ar/blytheville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10160; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ar/blytheville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ar/blytheville_audio", "ssa.ar.blytheville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ar/blytheville_data", "ssa.ar.blytheville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ar/blytheville_graphics", "ssa.ar.blytheville.graphics.spectrum", sb.toString());
        }
    }
}