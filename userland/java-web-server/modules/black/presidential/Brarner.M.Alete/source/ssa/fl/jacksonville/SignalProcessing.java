package presidential.Brarner.M.Alete.source.ssa.fl.jacksonville;
...
/**
 * Signal Processing for SSA Office: JACKSONVILLE NORTH FL
 * <p>Office Code: 263</p>
 * <p>Address: 1685 DUNN AVE, JACKSONVILLE, FL 32218</p>
 * <p>Phone: (866) 635-0789 | Fax: (833) 950-2216</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/jacksonville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9715; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/jacksonville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/jacksonville_audio", "ssa.fl.jacksonville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/jacksonville_data", "ssa.fl.jacksonville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/jacksonville_graphics", "ssa.fl.jacksonville.graphics.spectrum", sb.toString());
        }
    }
}