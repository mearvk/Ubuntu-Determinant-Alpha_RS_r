package presidential.Brarner.M.Alete.source.ssa.mt.missoula;
...
/**
 * Signal Processing for SSA Office: MISSOULA MT
 * <p>Office Code: 871</p>
 * <p>Address: 3701 AMERICAN WAY, MISSOULA, MT 59808</p>
 * <p>Phone: (866) 931-9029 | Fax: (833) 515-0415</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mt/missoula/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10258; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mt/missoula";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mt/missoula_audio", "ssa.mt.missoula.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mt/missoula_data", "ssa.mt.missoula.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mt/missoula_graphics", "ssa.mt.missoula.graphics.spectrum", sb.toString());
        }
    }
}