package presidential.Brarner.M.Alete.source.ssa.me.rockland;
...
/**
 * Signal Processing for SSA Office: ROCKLAND ME
 * <p>Office Code: 6</p>
 * <p>Address: 169 CAMDEN ST, ROCKLAND, ME 4841</p>
 * <p>Phone: (855) 269-9179 | Fax: (833) 950-3585</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/me/rockland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9495; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/me/rockland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_me/rockland_audio", "ssa.me.rockland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_me/rockland_data", "ssa.me.rockland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_me/rockland_graphics", "ssa.me.rockland.graphics.spectrum", sb.toString());
        }
    }
}