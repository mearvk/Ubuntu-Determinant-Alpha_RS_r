package presidential.Brarner.M.Alete.source.ssa.ks.topeka;
...
/**
 * Signal Processing for SSA Office: TOPEKA KS
 * <p>Office Code: 768</p>
 * <p>Address: 600 SW COMMERCE PL, TOPEKA, KS 66615</p>
 * <p>Phone: (888) 327-1271 | Fax: (833) 950-2328</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ks/topeka/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10165; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ks/topeka";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ks/topeka_audio", "ssa.ks.topeka.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ks/topeka_data", "ssa.ks.topeka.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ks/topeka_graphics", "ssa.ks.topeka.graphics.spectrum", sb.toString());
        }
    }
}