...
/**
 * Signal Processing for SSA Office: WYTHEVILLE VA
 * <p>Office Code: 298</p>
 * <p>Address: 130 WITHERS LANE, WYTHEVILLE, VA 24382</p>
 * <p>Phone: (888) 632-6893 | Fax: (833) 950-2592</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/wytheville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9748; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/wytheville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/wytheville_audio", "ssa.va.wytheville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/wytheville_data", "ssa.va.wytheville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/wytheville_graphics", "ssa.va.wytheville.graphics.spectrum", sb.toString());
        }
    }
}