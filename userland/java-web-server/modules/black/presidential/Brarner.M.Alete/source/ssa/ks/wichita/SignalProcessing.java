package presidential.Brarner.M.Alete.source.ssa.ks.wichita;
...
/**
 * Signal Processing for SSA Office: WICHITA KS
 * <p>Office Code: 769</p>
 * <p>Address: 3216 N CYPRESS ST, WICHITA, KS 67226</p>
 * <p>Phone: (866) 931-9173 | Fax: (833) 950-2330</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ks/wichita/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10166; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ks/wichita";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ks/wichita_audio", "ssa.ks.wichita.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ks/wichita_data", "ssa.ks.wichita.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ks/wichita_graphics", "ssa.ks.wichita.graphics.spectrum", sb.toString());
        }
    }
}