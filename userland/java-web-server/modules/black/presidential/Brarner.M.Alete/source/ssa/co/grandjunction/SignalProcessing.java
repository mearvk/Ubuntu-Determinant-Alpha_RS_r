...
/**
 * Signal Processing for SSA Office: GRAND JUNCTION CO
 * <p>Office Code: 884</p>
 * <p>Address: 825 NORTH CREST DRIVE, GRAND JUNCTION, CO 81506</p>
 * <p>Phone: (866) 931-7120 | Fax: (833) 612-0150</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/co/grandjunction/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10270; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/co/grandjunction";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_co/grandjunction_audio", "ssa.co.grandjunction.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_co/grandjunction_data", "ssa.co.grandjunction.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_co/grandjunction_graphics", "ssa.co.grandjunction.graphics.spectrum", sb.toString());
        }
    }
}