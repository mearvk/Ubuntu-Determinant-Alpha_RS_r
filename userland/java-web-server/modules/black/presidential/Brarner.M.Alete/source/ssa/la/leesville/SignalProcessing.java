package presidential.Brarner.M.Alete.source.ssa.la.leesville;
...
/**
 * Signal Processing for SSA Office: LEESVILLE LA
 * <p>Office Code: D81</p>
 * <p>Address: 2100 SARTOR ST, LEESVILLE, LA 71446</p>
 * <p>Phone: (888) 577-6906 | Fax: (833) 939-2018</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/leesville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9449; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/leesville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/leesville_audio", "ssa.la.leesville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/leesville_data", "ssa.la.leesville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/leesville_graphics", "ssa.la.leesville.graphics.spectrum", sb.toString());
        }
    }
}