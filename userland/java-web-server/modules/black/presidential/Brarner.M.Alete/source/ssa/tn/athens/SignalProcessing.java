package presidential.Brarner.M.Alete.source.ssa.tn.athens;
...
/**
 * Signal Processing for SSA Office: ATHENS TN
 * <p>Office Code: C94</p>
 * <p>Address: 921 CONGRESS PKWY N, ATHENS, TN 37303</p>
 * <p>Phone: (866) 964-7431 | Fax: (833) 597-0068</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/athens/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9395; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/athens";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/athens_audio", "ssa.tn.athens.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/athens_data", "ssa.tn.athens.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/athens_graphics", "ssa.tn.athens.graphics.spectrum", sb.toString());
        }
    }
}