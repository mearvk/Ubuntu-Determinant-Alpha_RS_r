...
/**
 * Signal Processing for SSA Office: FAIRBANKS AK
 * <p>Office Code: 998</p>
 * <p>Address: 101 12TH AVENUE, FAIRBANKS, AK 99701</p>
 * <p>Phone: (800) 478-0391 | Fax: (833) 950-3224</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ak/fairbanks/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10375; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ak/fairbanks";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ak/fairbanks_audio", "ssa.ak.fairbanks.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ak/fairbanks_data", "ssa.ak.fairbanks.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ak/fairbanks_graphics", "ssa.ak.fairbanks.graphics.spectrum", sb.toString());
        }
    }
}