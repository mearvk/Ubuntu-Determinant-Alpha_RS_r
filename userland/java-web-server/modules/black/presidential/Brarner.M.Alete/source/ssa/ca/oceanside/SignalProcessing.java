package presidential.Brarner.M.Alete.source.ssa.ca.oceanside;
...
/**
 * Signal Processing for SSA Office: OCEANSIDE CA
 * <p>Office Code: 987</p>
 * <p>Address: 2160 S EL CAMINO REAL, OCEANSIDE, CA 92054</p>
 * <p>Phone: (855) 287-4793 | Fax: (833) 950-2758</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/oceanside/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10368; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/oceanside";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/oceanside_audio", "ssa.ca.oceanside.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/oceanside_data", "ssa.ca.oceanside.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/oceanside_graphics", "ssa.ca.oceanside.graphics.spectrum", sb.toString());
        }
    }
}