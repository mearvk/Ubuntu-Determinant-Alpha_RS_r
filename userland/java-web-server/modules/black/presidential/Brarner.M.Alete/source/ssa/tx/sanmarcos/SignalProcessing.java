package presidential.Brarner.M.Alete.source.ssa.tx.sanmarcos;
...
/**
 * Signal Processing for SSA Office: SAN MARCOS TX
 * <p>Office Code: E44</p>
 * <p>Address: 900 BUGG LANE, SAN MARCOS, TX 78666</p>
 * <p>Phone: (866) 388-8515 | Fax: (833) 950-2385</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/sanmarcos/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9469; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/sanmarcos";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanmarcos_audio", "ssa.tx.sanmarcos.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanmarcos_data", "ssa.tx.sanmarcos.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/sanmarcos_graphics", "ssa.tx.sanmarcos.graphics.spectrum", sb.toString());
        }
    }
}