...
/**
 * Signal Processing for SSA Office: CHEYENNE WY
 * <p>Office Code: 876</p>
 * <p>Address: 3001 E PERSHING BLVD, CHEYENNE, WY 82001</p>
 * <p>Phone: (866) 336-7580 | Fax: (833) 515-0419</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/wy/cheyenne/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10263; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/wy/cheyenne";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_wy/cheyenne_audio", "ssa.wy.cheyenne.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_wy/cheyenne_data", "ssa.wy.cheyenne.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_wy/cheyenne_graphics", "ssa.wy.cheyenne.graphics.spectrum", sb.toString());
        }
    }
}