package presidential.Brarner.M.Alete.source.ssa.ga.statesboro;
...
/**
 * Signal Processing for SSA Office: STATESBORO GA
 * <p>Office Code: A44</p>
 * <p>Address: 1050 BRANNEN ST, STATESBORO, GA 30461</p>
 * <p>Phone: (866) 748-2088 | Fax: (833) 950-2520</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/statesboro/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9229; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/statesboro";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/statesboro_audio", "ssa.ga.statesboro.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/statesboro_data", "ssa.ga.statesboro.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/statesboro_graphics", "ssa.ga.statesboro.graphics.spectrum", sb.toString());
        }
    }
}