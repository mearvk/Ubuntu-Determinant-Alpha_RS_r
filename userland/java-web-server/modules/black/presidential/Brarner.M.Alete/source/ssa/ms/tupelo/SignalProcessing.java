package presidential.Brarner.M.Alete.source.ssa.ms.tupelo;
...
/**
 * Signal Processing for SSA Office: TUPELO MS
 * <p>Office Code: 648</p>
 * <p>Address: 199 SADDLE CREEK DRIVE, TUPELO, MS 38801</p>
 * <p>Phone: (866) 504-4267 | Fax: (833) 950-3809</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/tupelo/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10068; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/tupelo";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/tupelo_audio", "ssa.ms.tupelo.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/tupelo_data", "ssa.ms.tupelo.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/tupelo_graphics", "ssa.ms.tupelo.graphics.spectrum", sb.toString());
        }
    }
}