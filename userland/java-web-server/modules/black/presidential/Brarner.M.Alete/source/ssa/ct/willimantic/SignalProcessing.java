package presidential.Brarner.M.Alete.source.ssa.ct.willimantic;
...
/**
 * Signal Processing for SSA Office: WILLIMANTIC CT
 * <p>Office Code: 83</p>
 * <p>Address: 1320 MAIN ST, WILLIMANTIC, CT 6226</p>
 * <p>Phone: (877) 405-0488 | Fax: (833) 950-2360</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ct/willimantic/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9555; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ct/willimantic";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ct/willimantic_audio", "ssa.ct.willimantic.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ct/willimantic_data", "ssa.ct.willimantic.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ct/willimantic_graphics", "ssa.ct.willimantic.graphics.spectrum", sb.toString());
        }
    }
}