package presidential.Brarner.M.Alete.source.ssa.in.michigancity;
...
/**
 * Signal Processing for SSA Office: MICHIGAN CITY IN
 * <p>Office Code: 470</p>
 * <p>Address: 636 PINE STREET, MICHIGAN CITY, IN 46360</p>
 * <p>Phone: (866) 248-2393 | Fax: (833) 950-2156</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/michigancity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9907; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/michigancity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/michigancity_audio", "ssa.in.michigancity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/michigancity_data", "ssa.in.michigancity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/michigancity_graphics", "ssa.in.michigancity.graphics.spectrum", sb.toString());
        }
    }
}