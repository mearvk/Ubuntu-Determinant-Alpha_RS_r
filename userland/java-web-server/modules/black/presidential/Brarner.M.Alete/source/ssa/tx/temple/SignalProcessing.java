package presidential.Brarner.M.Alete.source.ssa.tx.temple;
...
/**
 * Signal Processing for SSA Office: TEMPLE TX
 * <p>Office Code: 838</p>
 * <p>Address: 511 NORTH MAIN, TEMPLE, TX 76501</p>
 * <p>Phone: (866) 593-1341 | Fax: (833) 939-2031</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/temple/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10229; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/temple";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/temple_audio", "ssa.tx.temple.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/temple_data", "ssa.tx.temple.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/temple_graphics", "ssa.tx.temple.graphics.spectrum", sb.toString());
        }
    }
}