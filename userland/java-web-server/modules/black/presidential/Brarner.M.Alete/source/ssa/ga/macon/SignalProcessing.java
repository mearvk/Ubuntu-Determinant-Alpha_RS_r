package presidential.Brarner.M.Alete.source.ssa.ga.macon;
...
/**
 * Signal Processing for SSA Office: MACON GA
 * <p>Office Code: 603</p>
 * <p>Address: 3530 RIVERSIDE DRIVE, MACON, GA 31210</p>
 * <p>Phone: (888) 759-3917 | Fax: (833) 950-2564</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ga/macon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10026; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ga/macon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ga/macon_audio", "ssa.ga.macon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ga/macon_data", "ssa.ga.macon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ga/macon_graphics", "ssa.ga.macon.graphics.spectrum", sb.toString());
        }
    }
}