package presidential.Brarner.M.Alete.source.ssa.ca.visalia;
...
/**
 * Signal Processing for SSA Office: VISALIA CA
 * <p>Office Code: 980</p>
 * <p>Address: 1901 E NOBLE AVENUE, VISALIA, CA 93292</p>
 * <p>Phone: (866) 344-8475 | Fax: (833) 950-2454</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/visalia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10361; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/visalia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/visalia_audio", "ssa.ca.visalia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/visalia_data", "ssa.ca.visalia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/visalia_graphics", "ssa.ca.visalia.graphics.spectrum", sb.toString());
        }
    }
}