package presidential.Brarner.M.Alete.source.ssa.mi.flint002;
...
/**
 * Signal Processing for SSA Office: FLINT-DOWNTOWN
 * <p>Office Code: 349</p>
 * <p>Address: 1149 ROBERT T LONGWAY, FLINT, MI 48503</p>
 * <p>Phone: (888) 318-7282 | Fax: (833) 950-2120</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/flint002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9796; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/flint002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/flint002_audio", "ssa.mi.flint002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/flint002_data", "ssa.mi.flint002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/flint002_graphics", "ssa.mi.flint002.graphics.spectrum", sb.toString());
        }
    }
}