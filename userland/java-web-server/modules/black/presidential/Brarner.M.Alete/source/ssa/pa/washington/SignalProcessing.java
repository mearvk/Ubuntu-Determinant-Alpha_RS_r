package presidential.Brarner.M.Alete.source.ssa.pa.washington;
...
/**
 * Signal Processing for SSA Office: WASHINGTON PA
 * <p>Office Code: 226</p>
 * <p>Address: 95 W BEAU ST, WASHINGTON, PA 15301</p>
 * <p>Phone: (855) 829-8917 | Fax: (833) 461-0034</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/washington/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9683; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/washington";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/washington_audio", "ssa.pa.washington.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/washington_data", "ssa.pa.washington.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/washington_graphics", "ssa.pa.washington.graphics.spectrum", sb.toString());
        }
    }
}