package presidential.Brarner.M.Alete.source.ssa.ny.hudson;
...
/**
 * Signal Processing for SSA Office: HUDSON NY
 * <p>Office Code: 153</p>
 * <p>Address: 747 WARREN STREET, HUDSON, NY 12534</p>
 * <p>Phone: (877) 828-1691 | Fax: (833) 950-2676</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/hudson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9621; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/hudson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/hudson_audio", "ssa.ny.hudson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/hudson_data", "ssa.ny.hudson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/hudson_graphics", "ssa.ny.hudson.graphics.spectrum", sb.toString());
        }
    }
}