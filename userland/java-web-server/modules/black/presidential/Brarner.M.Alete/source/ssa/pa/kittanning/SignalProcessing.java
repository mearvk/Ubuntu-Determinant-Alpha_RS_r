package presidential.Brarner.M.Alete.source.ssa.pa.kittanning;
...
/**
 * Signal Processing for SSA Office: KITTANNING PA
 * <p>Office Code: C86</p>
 * <p>Address: 159 BUTLER RD, KITTANNING, PA 16201</p>
 * <p>Phone: (877) 255-1372 | Fax: (833) 950-2872</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/kittanning/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9389; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/kittanning";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/kittanning_audio", "ssa.pa.kittanning.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/kittanning_data", "ssa.pa.kittanning.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/kittanning_graphics", "ssa.pa.kittanning.graphics.spectrum", sb.toString());
        }
    }
}