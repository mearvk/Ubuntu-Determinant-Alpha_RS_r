package presidential.Brarner.M.Alete.source.ssa.mo.sedalia;
...
/**
 * Signal Processing for SSA Office: SEDALIA MO
 * <p>Office Code: 743</p>
 * <p>Address: 3404 W 10TH ST, SEDALIA, MO 65301</p>
 * <p>Phone: (877) 405-5459 | Fax: (833) 923-0558</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/sedalia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10144; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/sedalia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/sedalia_audio", "ssa.mo.sedalia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/sedalia_data", "ssa.mo.sedalia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/sedalia_graphics", "ssa.mo.sedalia.graphics.spectrum", sb.toString());
        }
    }
}