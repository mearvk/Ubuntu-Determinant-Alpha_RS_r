...
/**
 * Signal Processing for SSA Office: MT VERNON IL
 * <p>Office Code: 492</p>
 * <p>Address: 105 S 6TH ST, MOUNT VERNON, IL 62864</p>
 * <p>Phone: (866) 931-2549 | Fax: (833) 950-2792</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/il/mountvernon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9927; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/il/mountvernon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_il/mountvernon_audio", "ssa.il.mountvernon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_il/mountvernon_data", "ssa.il.mountvernon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_il/mountvernon_graphics", "ssa.il.mountvernon.graphics.spectrum", sb.toString());
        }
    }
}