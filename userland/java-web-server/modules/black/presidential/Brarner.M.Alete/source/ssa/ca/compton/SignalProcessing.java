...
/**
 * Signal Processing for SSA Office: COMPTON CA
 * <p>Office Code: 434</p>
 * <p>Address: 171 E COMPTON BLVD, COMPTON, CA 90220</p>
 * <p>Phone: (888) 472-6117 | Fax: (833) 950-3051</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/compton/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9871; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/compton";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/compton_audio", "ssa.ca.compton.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/compton_data", "ssa.ca.compton.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/compton_graphics", "ssa.ca.compton.graphics.spectrum", sb.toString());
        }
    }
}