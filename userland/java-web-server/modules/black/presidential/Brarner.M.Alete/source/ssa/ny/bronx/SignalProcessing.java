package presidential.Brarner.M.Alete.source.ssa.ny.bronx;
...
/**
 * Signal Processing for SSA Office: WEST FARMS NY
 * <p>Office Code: C77</p>
 * <p>Address: 1829 SOUTHERN BLVD, BRONX, NY 10460</p>
 * <p>Phone: (866) 964-2558 | Fax: (833) 950-3281</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/bronx/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9383; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/bronx";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx_audio", "ssa.ny.bronx.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx_data", "ssa.ny.bronx.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/bronx_graphics", "ssa.ny.bronx.graphics.spectrum", sb.toString());
        }
    }
}