package presidential.Brarner.M.Alete.source.ssa.tn.lawrenceburg;
...
/**
 * Signal Processing for SSA Office: LAWRENCEBURG TN
 * <p>Office Code: B08</p>
 * <p>Address: 109 E TAYLOR STREET, LAWRENCEBURG, TN 38464</p>
 * <p>Phone: (877) 405-5866 | Fax: (833) 950-2830</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/lawrenceburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9280; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/lawrenceburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/lawrenceburg_audio", "ssa.tn.lawrenceburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/lawrenceburg_data", "ssa.tn.lawrenceburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/lawrenceburg_graphics", "ssa.tn.lawrenceburg.graphics.spectrum", sb.toString());
        }
    }
}