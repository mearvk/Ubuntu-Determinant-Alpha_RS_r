package presidential.Brarner.M.Alete.source.ssa.ca.pomona;
...
/**
 * Signal Processing for SSA Office: POMONA VALLEY CA
 * <p>Office Code: 981</p>
 * <p>Address: 2130 N GAREY AVE, POMONA, CA 91767</p>
 * <p>Phone: (888) 808-5486 | Fax: (833) 950-2456</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/pomona/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10362; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/pomona";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/pomona_audio", "ssa.ca.pomona.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/pomona_data", "ssa.ca.pomona.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/pomona_graphics", "ssa.ca.pomona.graphics.spectrum", sb.toString());
        }
    }
}