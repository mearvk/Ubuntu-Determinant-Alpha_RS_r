package presidential.Brarner.M.Alete.source.ssa.ny.niagarafalls;
...
/**
 * Signal Processing for SSA Office: NIAGARA FALLS NY
 * <p>Office Code: 115</p>
 * <p>Address: 6540 NIAGARA FALLS BVD, NIAGARA FALLS, NY 14304</p>
 * <p>Phone: (877) 480-4992 | Fax: (833) 515-0479</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/niagarafalls/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9586; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/niagarafalls";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/niagarafalls_audio", "ssa.ny.niagarafalls.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/niagarafalls_data", "ssa.ny.niagarafalls.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/niagarafalls_graphics", "ssa.ny.niagarafalls.graphics.spectrum", sb.toString());
        }
    }
}