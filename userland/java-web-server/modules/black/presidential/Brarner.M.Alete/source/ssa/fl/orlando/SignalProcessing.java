package presidential.Brarner.M.Alete.source.ssa.fl.orlando;
...
/**
 * Signal Processing for SSA Office: ORLANDO FL
 * <p>Office Code: 657</p>
 * <p>Address: 500 N ORANGE AVE, ORLANDO, FL 32801</p>
 * <p>Phone: (866) 964-6146 | Fax: (833) 579-0467</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/orlando/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10076; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/orlando";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/orlando_audio", "ssa.fl.orlando.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/orlando_data", "ssa.fl.orlando.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/orlando_graphics", "ssa.fl.orlando.graphics.spectrum", sb.toString());
        }
    }
}