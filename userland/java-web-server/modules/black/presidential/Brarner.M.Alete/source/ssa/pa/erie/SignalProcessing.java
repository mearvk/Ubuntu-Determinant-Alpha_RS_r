package presidential.Brarner.M.Alete.source.ssa.pa.erie;
...
/**
 * Signal Processing for SSA Office: ERIE PA
 * <p>Office Code: 205</p>
 * <p>Address: 717 STATE ST, ERIE, PA 16501</p>
 * <p>Phone: (877) 405-2887 | Fax: (833) 950-3177</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/erie/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9663; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/erie";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/erie_audio", "ssa.pa.erie.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/erie_data", "ssa.pa.erie.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/erie_graphics", "ssa.pa.erie.graphics.spectrum", sb.toString());
        }
    }
}