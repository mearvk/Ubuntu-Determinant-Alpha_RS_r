...
/**
 * Signal Processing for SSA Office: NEW BERN NC
 * <p>Office Code: 334</p>
 * <p>Address: 1420 MCCARTHY BLVD, NEW BERN, NC 28562</p>
 * <p>Phone: (888) 491-1885 | Fax: (833) 950-2842</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nc/newbern/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9782; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nc/newbern";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nc/newbern_audio", "ssa.nc.newbern.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nc/newbern_data", "ssa.nc.newbern.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nc/newbern_graphics", "ssa.nc.newbern.graphics.spectrum", sb.toString());
        }
    }
}