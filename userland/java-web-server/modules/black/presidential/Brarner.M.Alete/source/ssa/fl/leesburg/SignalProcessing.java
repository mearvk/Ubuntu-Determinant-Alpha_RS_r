package presidential.Brarner.M.Alete.source.ssa.fl.leesburg;
...
/**
 * Signal Processing for SSA Office: LEESBURG FL
 * <p>Office Code: 258</p>
 * <p>Address: 900 N 14TH STREET, LEESBURG, FL 34748</p>
 * <p>Phone: (866) 836-3623 | Fax: (833) 950-2206</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/leesburg/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9712; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/leesburg";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/leesburg_audio", "ssa.fl.leesburg.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/leesburg_data", "ssa.fl.leesburg.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/leesburg_graphics", "ssa.fl.leesburg.graphics.spectrum", sb.toString());
        }
    }
}