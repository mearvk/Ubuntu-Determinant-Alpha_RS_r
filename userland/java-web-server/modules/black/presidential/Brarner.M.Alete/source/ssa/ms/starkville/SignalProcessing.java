package presidential.Brarner.M.Alete.source.ssa.ms.starkville;
...
/**
 * Signal Processing for SSA Office: STARKVILLE MS
 * <p>Office Code: D02</p>
 * <p>Address: 1089C STARK RD, STARKVILLE, MS 39759</p>
 * <p>Phone: (800) 305-6919 | Fax: (833) 902-2704</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/starkville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9401; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/starkville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/starkville_audio", "ssa.ms.starkville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/starkville_data", "ssa.ms.starkville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/starkville_graphics", "ssa.ms.starkville.graphics.spectrum", sb.toString());
        }
    }
}