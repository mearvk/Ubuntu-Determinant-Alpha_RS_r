package presidential.Brarner.M.Alete.source.ssa.in.newalbany;
...
/**
 * Signal Processing for SSA Office: NEW ALBANY IN
 * <p>Office Code: 465</p>
 * <p>Address: 3700 BLACKISTON BLVD, NEW ALBANY, IN 47150</p>
 * <p>Phone: (866) 331-9073 | Fax: (833) 950-2142</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/in/newalbany/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9902; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/in/newalbany";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_in/newalbany_audio", "ssa.in.newalbany.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_in/newalbany_data", "ssa.in.newalbany.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_in/newalbany_graphics", "ssa.in.newalbany.graphics.spectrum", sb.toString());
        }
    }
}