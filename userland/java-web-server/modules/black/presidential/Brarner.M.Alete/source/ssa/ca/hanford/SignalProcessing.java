package presidential.Brarner.M.Alete.source.ssa.ca.hanford;
...
/**
 * Signal Processing for SSA Office: HANFORD CA
 * <p>Office Code: B65</p>
 * <p>Address: 330 NORTH HARRIS ST, HANFORD, CA 93230</p>
 * <p>Phone: (855) 207-4866 | Fax: (833) 950-3671</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/hanford/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9324; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/hanford";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/hanford_audio", "ssa.ca.hanford.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/hanford_data", "ssa.ca.hanford.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/hanford_graphics", "ssa.ca.hanford.graphics.spectrum", sb.toString());
        }
    }
}