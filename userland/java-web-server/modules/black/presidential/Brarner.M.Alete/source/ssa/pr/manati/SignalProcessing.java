package presidential.Brarner.M.Alete.source.ssa.pr.manati;
...
/**
 * Signal Processing for SSA Office: MANATI PR
 * <p>Office Code: B89</p>
 * <p>Address: ESQ EXPRESO TO CIALES, MANATI, PR 674</p>
 * <p>Phone: (866) 256-2681 | Fax: (833) 950-2962</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pr/manati/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9337; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pr/manati";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pr/manati_audio", "ssa.pr.manati.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pr/manati_data", "ssa.pr.manati.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pr/manati_graphics", "ssa.pr.manati.graphics.spectrum", sb.toString());
        }
    }
}