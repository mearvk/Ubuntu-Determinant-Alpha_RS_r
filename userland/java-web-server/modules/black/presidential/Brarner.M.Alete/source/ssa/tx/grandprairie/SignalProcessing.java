package presidential.Brarner.M.Alete.source.ssa.tx.grandprairie;
...
/**
 * Signal Processing for SSA Office: MID CITIES TX
 * <p>Office Code: 873</p>
 * <p>Address: 2010 N STATE HWY 360, GRAND PRAIRIE, TX 75050</p>
 * <p>Phone: (855) 722-3499 | Fax: (833) 950-3017</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/grandprairie/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10260; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/grandprairie";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/grandprairie_audio", "ssa.tx.grandprairie.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/grandprairie_data", "ssa.tx.grandprairie.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/grandprairie_graphics", "ssa.tx.grandprairie.graphics.spectrum", sb.toString());
        }
    }
}