package presidential.Brarner.M.Alete.source.ssa.tn.clarksville;
...
/**
 * Signal Processing for SSA Office: CLARKSVILLE TN
 * <p>Office Code: 574</p>
 * <p>Address: 119 CENTER POINTE DR, CLARKSVILLE, TN 37040</p>
 * <p>Phone: (877) 531-4695 | Fax: (833) 597-0134</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/clarksville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9998; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/clarksville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/clarksville_audio", "ssa.tn.clarksville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/clarksville_data", "ssa.tn.clarksville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/clarksville_graphics", "ssa.tn.clarksville.graphics.spectrum", sb.toString());
        }
    }
}