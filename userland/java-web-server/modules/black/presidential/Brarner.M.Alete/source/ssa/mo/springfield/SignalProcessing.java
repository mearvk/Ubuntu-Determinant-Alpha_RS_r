...
/**
 * Signal Processing for SSA Office: SPRINGFIELD MO
 * <p>Office Code: 738</p>
 * <p>Address: 1570 W BATTLEFIELD ST, SPRINGFIELD, MO 65807</p>
 * <p>Phone: (877) 850-7824 | Fax: (833) 902-2506</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/springfield/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10140; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/springfield";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/springfield_audio", "ssa.mo.springfield.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/springfield_data", "ssa.mo.springfield.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/springfield_graphics", "ssa.mo.springfield.graphics.spectrum", sb.toString());
        }
    }
}