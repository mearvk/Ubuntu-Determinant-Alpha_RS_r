package presidential.Brarner.M.Alete.source.ssa.al.jackson;
...
/**
 * Signal Processing for SSA Office: JACKSON AL
 * <p>Office Code: D68</p>
 * <p>Address: 4249 N COLLEGE AVE, JACKSON, AL 36545</p>
 * <p>Phone: (877) 476-4484 | Fax: (833) 902-2706</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/jackson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9445; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/jackson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/jackson_audio", "ssa.al.jackson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/jackson_data", "ssa.al.jackson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/jackson_graphics", "ssa.al.jackson.graphics.spectrum", sb.toString());
        }
    }
}