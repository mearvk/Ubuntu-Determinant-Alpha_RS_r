package presidential.Brarner.M.Alete.source.ssa.ia.creston;
...
/**
 * Signal Processing for SSA Office: CRESTON IA
 * <p>Office Code: 700</p>
 * <p>Address: 906 E TAYLOR ST, CRESTON, IA 50801</p>
 * <p>Phone: (866) 613-2827 | Fax: (833) 515-0439</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/creston/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10114; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/creston";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/creston_audio", "ssa.ia.creston.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/creston_data", "ssa.ia.creston.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/creston_graphics", "ssa.ia.creston.graphics.spectrum", sb.toString());
        }
    }
}