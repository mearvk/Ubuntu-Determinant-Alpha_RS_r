package presidential.Brarner.M.Alete.source.ssa.va.suffolk;
...
/**
 * Signal Processing for SSA Office: SUFFOLK VA
 * <p>Office Code: 303</p>
 * <p>Address: 502 HILLPOINT BLVD, SUFFOLK, VA 23434</p>
 * <p>Phone: (866) 835-7769 | Fax: (833) 950-2602</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/va/suffolk/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9753; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/va/suffolk";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_va/suffolk_audio", "ssa.va.suffolk.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_va/suffolk_data", "ssa.va.suffolk.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_va/suffolk_graphics", "ssa.va.suffolk.graphics.spectrum", sb.toString());
        }
    }
}