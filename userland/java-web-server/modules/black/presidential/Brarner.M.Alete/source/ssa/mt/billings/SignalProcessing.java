package presidential.Brarner.M.Alete.source.ssa.mt.billings;
...
/**
 * Signal Processing for SSA Office: BILLINGS MT
 * <p>Office Code: 868</p>
 * <p>Address: 2900 4TH AVE N, BILLINGS, MT 59101</p>
 * <p>Phone: (866) 895-1795 | Fax: (833) 515-0411</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mt/billings/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10255; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mt/billings";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mt/billings_audio", "ssa.mt.billings.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mt/billings_data", "ssa.mt.billings.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mt/billings_graphics", "ssa.mt.billings.graphics.spectrum", sb.toString());
        }
    }
}