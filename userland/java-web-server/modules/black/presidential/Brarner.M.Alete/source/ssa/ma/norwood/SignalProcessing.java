package presidential.Brarner.M.Alete.source.ssa.ma.norwood;
...
/**
 * Signal Processing for SSA Office: NORWOOD MA
 * <p>Office Code: 52</p>
 * <p>Address: ONE EDGEWATER DRIVE, NORWOOD, MA 2062</p>
 * <p>Phone: (866) 563-9533 | Fax: (833) 926-1860</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/norwood/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9534; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/norwood";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/norwood_audio", "ssa.ma.norwood.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/norwood_data", "ssa.ma.norwood.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/norwood_graphics", "ssa.ma.norwood.graphics.spectrum", sb.toString());
        }
    }
}