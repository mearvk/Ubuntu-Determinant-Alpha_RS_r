package presidential.Brarner.M.Alete.source.ssa.ia.davenport;
...
/**
 * Signal Processing for SSA Office: DAVENPORT IA
 * <p>Office Code: 691</p>
 * <p>Address: 4319 N BRADY ST, DAVENPORT, IA 52806</p>
 * <p>Phone: (855) 420-8556 | Fax: (833) 950-3569</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ia/davenport/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10105; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ia/davenport";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ia/davenport_audio", "ssa.ia.davenport.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ia/davenport_data", "ssa.ia.davenport.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ia/davenport_graphics", "ssa.ia.davenport.graphics.spectrum", sb.toString());
        }
    }
}