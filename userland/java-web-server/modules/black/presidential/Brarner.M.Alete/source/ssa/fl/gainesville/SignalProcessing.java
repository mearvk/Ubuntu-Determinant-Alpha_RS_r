...
/**
 * Signal Processing for SSA Office: GAINESVILLE FL
 * <p>Office Code: 663</p>
 * <p>Address: 4562 NW 13 STREET, GAINESVILLE, FL 32609</p>
 * <p>Phone: (877) 219-8323 | Fax: (833) 710-0163</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/gainesville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10082; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/gainesville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/gainesville_audio", "ssa.fl.gainesville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/gainesville_data", "ssa.fl.gainesville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/gainesville_graphics", "ssa.fl.gainesville.graphics.spectrum", sb.toString());
        }
    }
}