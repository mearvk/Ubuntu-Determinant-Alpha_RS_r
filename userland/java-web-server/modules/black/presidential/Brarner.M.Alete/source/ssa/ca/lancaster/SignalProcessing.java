package presidential.Brarner.M.Alete.source.ssa.ca.lancaster;
...
/**
 * Signal Processing for SSA Office: LANCASTER CA
 * <p>Office Code: 59</p>
 * <p>Address: 42225 10TH ST W, LANCASTER, CA 93534</p>
 * <p>Phone: (866) 964-1725 | Fax: (833) 950-2432</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/lancaster/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9539; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/lancaster";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/lancaster_audio", "ssa.ca.lancaster.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/lancaster_data", "ssa.ca.lancaster.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/lancaster_graphics", "ssa.ca.lancaster.graphics.spectrum", sb.toString());
        }
    }
}