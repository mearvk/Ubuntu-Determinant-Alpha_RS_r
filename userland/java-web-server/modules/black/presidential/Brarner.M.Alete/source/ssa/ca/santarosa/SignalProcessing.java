package presidential.Brarner.M.Alete.source.ssa.ca.santarosa;
...
/**
 * Signal Processing for SSA Office: SANTA ROSA CA
 * <p>Office Code: 964</p>
 * <p>Address: 2099 RANGE AVE, SANTA ROSA, CA 95401</p>
 * <p>Phone: (877) 870-6384 | Fax: (833) 940-2149</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/santarosa/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10346; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/santarosa";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/santarosa_audio", "ssa.ca.santarosa.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/santarosa_data", "ssa.ca.santarosa.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/santarosa_graphics", "ssa.ca.santarosa.graphics.spectrum", sb.toString());
        }
    }
}