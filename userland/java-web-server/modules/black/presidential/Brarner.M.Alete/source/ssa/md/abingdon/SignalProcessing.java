...
/**
 * Signal Processing for SSA Office: ABINGDON MD
 * <p>Office Code: 94</p>
 * <p>Address: CORPORATE CENTER DR, ABINGDON, MD 21009</p>
 * <p>Phone: (877) 701-2142 | Fax: (833) 371-0602</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/md/abingdon/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9565; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/md/abingdon";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_md/abingdon_audio", "ssa.md.abingdon.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_md/abingdon_data", "ssa.md.abingdon.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_md/abingdon_graphics", "ssa.md.abingdon.graphics.spectrum", sb.toString());
        }
    }
}