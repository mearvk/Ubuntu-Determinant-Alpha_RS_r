package presidential.Brarner.M.Alete.source.ssa.ca.concord;
...
/**
 * Signal Processing for SSA Office: CONCORD CA
 * <p>Office Code: 248</p>
 * <p>Address: 2150 JOHN GLENN DR, CONCORD, CA 94520</p>
 * <p>Phone: (877) 319-6042 | Fax: (833) 950-2746</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/concord/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9703; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/concord";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/concord_audio", "ssa.ca.concord.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/concord_data", "ssa.ca.concord.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/concord_graphics", "ssa.ca.concord.graphics.spectrum", sb.toString());
        }
    }
}