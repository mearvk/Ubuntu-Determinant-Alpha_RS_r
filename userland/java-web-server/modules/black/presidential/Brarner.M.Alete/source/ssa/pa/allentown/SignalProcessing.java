package presidential.Brarner.M.Alete.source.ssa.pa.allentown;
...
/**
 * Signal Processing for SSA Office: ALLENTOWN PA
 * <p>Office Code: 209</p>
 * <p>Address: 41 N 4TH ST, ALLENTOWN, PA 18102</p>
 * <p>Phone: (877) 405-6746 | Fax: (833) 950-3185</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/allentown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9667; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/allentown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/allentown_audio", "ssa.pa.allentown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/allentown_data", "ssa.pa.allentown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/allentown_graphics", "ssa.pa.allentown.graphics.spectrum", sb.toString());
        }
    }
}