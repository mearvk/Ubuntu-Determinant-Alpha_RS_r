...
/**
 * Signal Processing for SSA Office: TROY NY
 * <p>Office Code: 130</p>
 * <p>Address: 120 HOOSICK ST, TROY, NY 12180</p>
 * <p>Phone: (866) 770-2662 | Fax: (833) 926-1868</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/troy/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9600; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/troy";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/troy_audio", "ssa.ny.troy.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/troy_data", "ssa.ny.troy.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/troy_graphics", "ssa.ny.troy.graphics.spectrum", sb.toString());
        }
    }
}