package presidential.Brarner.M.Alete.source.ssa.mn.hibbing;
...
/**
 * Signal Processing for SSA Office: HIBBING MN
 * <p>Office Code: 683</p>
 * <p>Address: 1122 E 25TH STREET, HIBBING, MN 55746</p>
 * <p>Phone: (866) 964-4320 | Fax: (833) 950-2164</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mn/hibbing/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10098; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mn/hibbing";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mn/hibbing_audio", "ssa.mn.hibbing.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mn/hibbing_data", "ssa.mn.hibbing.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mn/hibbing_graphics", "ssa.mn.hibbing.graphics.spectrum", sb.toString());
        }
    }
}