package presidential.Brarner.M.Alete.source.ssa.nv.lasvegas;
...
/**
 * Signal Processing for SSA Office: LAS VEGAS NV
 * <p>Office Code: 946</p>
 * <p>Address: 1250 S BUFFALO DR, LAS VEGAS, NV 89117</p>
 * <p>Phone: (866) 704-4859 | Fax: (833) 346-7159</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nv/lasvegas/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10328; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nv/lasvegas";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nv/lasvegas_audio", "ssa.nv.lasvegas.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nv/lasvegas_data", "ssa.nv.lasvegas.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nv/lasvegas_graphics", "ssa.nv.lasvegas.graphics.spectrum", sb.toString());
        }
    }
}