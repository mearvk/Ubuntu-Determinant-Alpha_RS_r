package presidential.Brarner.M.Alete.source.ssa.ca.redding;
...
/**
 * Signal Processing for SSA Office: REDDING CA
 * <p>Office Code: 969</p>
 * <p>Address: 2660 PARK MARINA DR, REDDING, CA 96001</p>
 * <p>Phone: (866) 964-1236 | Fax: (833) 950-2112</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/redding/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10351; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/redding";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/redding_audio", "ssa.ca.redding.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/redding_data", "ssa.ca.redding.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/redding_graphics", "ssa.ca.redding.graphics.spectrum", sb.toString());
        }
    }
}