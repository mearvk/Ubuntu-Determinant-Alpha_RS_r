...
/**
 * Signal Processing for SSA Office: MOUNT PLEASANT
 * <p>Office Code: 367</p>
 * <p>Address: 1940 SWEENEY ST, MT PLEASANT, MI 48858</p>
 * <p>Phone: (877) 405-7667 | Fax: (833) 950-2478</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mi/mtpleasant/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9814; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mi/mtpleasant";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mi/mtpleasant_audio", "ssa.mi.mtpleasant.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mi/mtpleasant_data", "ssa.mi.mtpleasant.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mi/mtpleasant_graphics", "ssa.mi.mtpleasant.graphics.spectrum", sb.toString());
        }
    }
}