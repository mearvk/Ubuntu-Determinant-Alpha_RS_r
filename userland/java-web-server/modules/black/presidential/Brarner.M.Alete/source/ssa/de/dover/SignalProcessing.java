package presidential.Brarner.M.Alete.source.ssa.de.dover;
...
/**
 * Signal Processing for SSA Office: DOVER DE
 * <p>Office Code: 268</p>
 * <p>Address: 655 S BAY RD, DOVER, DE 19901</p>
 * <p>Phone: (877) 701-2141 | Fax: (833) 912-2302</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/de/dover/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9718; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/de/dover";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_de/dover_audio", "ssa.de.dover.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_de/dover_data", "ssa.de.dover.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_de/dover_graphics", "ssa.de.dover.graphics.spectrum", sb.toString());
        }
    }
}