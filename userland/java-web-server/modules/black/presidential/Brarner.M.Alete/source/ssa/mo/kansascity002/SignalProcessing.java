package presidential.Brarner.M.Alete.source.ssa.mo.kansascity002;
...
/**
 * Signal Processing for SSA Office: KANSAS CITY (GATEWAY)
 * <p>Office Code: 98</p>
 * <p>Address: 1800 E TRUMAN RD, KANSAS CITY, MO 64127</p>
 * <p>Phone: (888) 221-3612 | Fax: (833) 950-3561</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/mo/kansascity002/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9569; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/mo/kansascity002";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity002_audio", "ssa.mo.kansascity002.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity002_data", "ssa.mo.kansascity002.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_mo/kansascity002_graphics", "ssa.mo.kansascity002.graphics.spectrum", sb.toString());
        }
    }
}