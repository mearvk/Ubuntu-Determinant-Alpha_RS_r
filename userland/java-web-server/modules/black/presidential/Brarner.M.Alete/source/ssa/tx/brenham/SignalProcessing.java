package presidential.Brarner.M.Alete.source.ssa.tx.brenham;
...
/**
 * Signal Processing for SSA Office: BRENHAM TX
 * <p>Office Code: B48</p>
 * <p>Address: 2901 VICTORY LN, BRENHAM, TX 77833</p>
 * <p>Phone: (855) 287-4792 | Fax: (833) 939-2002</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/brenham/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9310; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/brenham";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/brenham_audio", "ssa.tx.brenham.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/brenham_data", "ssa.tx.brenham.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/brenham_graphics", "ssa.tx.brenham.graphics.spectrum", sb.toString());
        }
    }
}