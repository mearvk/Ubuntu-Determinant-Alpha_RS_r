package presidential.Brarner.M.Alete.source.ssa.tx.texarkana;
...
/**
 * Signal Processing for SSA Office: TEXARKANA TX
 * <p>Office Code: 757</p>
 * <p>Address: 5735 SUMMERHILL RD., TEXARKANA, TX 75503</p>
 * <p>Phone: (866) 931-7675 | Fax: (833) 950-2700</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tx/texarkana/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10155; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tx/texarkana";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tx/texarkana_audio", "ssa.tx.texarkana.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tx/texarkana_data", "ssa.tx.texarkana.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tx/texarkana_graphics", "ssa.tx.texarkana.graphics.spectrum", sb.toString());
        }
    }
}