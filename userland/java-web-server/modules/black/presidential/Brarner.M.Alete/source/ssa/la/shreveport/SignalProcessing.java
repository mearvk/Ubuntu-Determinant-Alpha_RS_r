...
/**
 * Signal Processing for SSA Office: SHREVEPORT LA
 * <p>Office Code: 801</p>
 * <p>Address: 1240 S POINTE PKWY, SHREVEPORT, LA 71105</p>
 * <p>Phone: (877) 319-3074 | Fax: (833) 950-3351</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/la/shreveport/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10193; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/la/shreveport";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_la/shreveport_audio", "ssa.la.shreveport.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_la/shreveport_data", "ssa.la.shreveport.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_la/shreveport_graphics", "ssa.la.shreveport.graphics.spectrum", sb.toString());
        }
    }
}