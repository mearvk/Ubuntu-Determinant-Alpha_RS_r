package presidential.Brarner.M.Alete.source.ssa.ma.malden;
...
/**
 * Signal Processing for SSA Office: MALDEN MA
 * <p>Office Code: 45</p>
 * <p>Address: 192 COMMERCIAL ST, MALDEN, MA 2148</p>
 * <p>Phone: (866) 596-8598 | Fax: (833) 926-1839</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ma/malden/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9527; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ma/malden";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ma/malden_audio", "ssa.ma.malden.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ma/malden_data", "ssa.ma.malden.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ma/malden_graphics", "ssa.ma.malden.graphics.spectrum", sb.toString());
        }
    }
}