package presidential.Brarner.M.Alete.source.ssa.ca.nationalcity;
...
/**
 * Signal Processing for SSA Office: NATIONAL CITY CA
 * <p>Office Code: 435</p>
 * <p>Address: 700 E 24TH ST, NATIONAL CITY, CA 91950</p>
 * <p>Phone: (866) 331-2203 | Fax: (833) 950-3053</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ca/nationalcity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9872; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ca/nationalcity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ca/nationalcity_audio", "ssa.ca.nationalcity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ca/nationalcity_data", "ssa.ca.nationalcity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ca/nationalcity_graphics", "ssa.ca.nationalcity.graphics.spectrum", sb.toString());
        }
    }
}