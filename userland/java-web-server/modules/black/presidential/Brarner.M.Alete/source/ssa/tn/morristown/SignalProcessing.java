package presidential.Brarner.M.Alete.source.ssa.tn.morristown;
...
/**
 * Signal Processing for SSA Office: MORRISTOWN TN
 * <p>Office Code: 576</p>
 * <p>Address: 3112 MILLERS POINT DR, MORRISTOWN, TN 37813</p>
 * <p>Phone: (866) 875-6156 | Fax: (833) 905-2058</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/tn/morristown/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10000; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/tn/morristown";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_tn/morristown_audio", "ssa.tn.morristown.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_tn/morristown_data", "ssa.tn.morristown.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_tn/morristown_graphics", "ssa.tn.morristown.graphics.spectrum", sb.toString());
        }
    }
}