package presidential.Brarner.M.Alete.source.ssa.fl.ocala;
...
/**
 * Signal Processing for SSA Office: OCALA FL
 * <p>Office Code: 674</p>
 * <p>Address: 933 E SILVER SPGS BLVD, OCALA, FL 34470</p>
 * <p>Phone: (877) 626-9911 | Fax: (833) 913-2071</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/ocala/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10089; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/ocala";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/ocala_audio", "ssa.fl.ocala.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/ocala_data", "ssa.fl.ocala.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/ocala_graphics", "ssa.fl.ocala.graphics.spectrum", sb.toString());
        }
    }
}