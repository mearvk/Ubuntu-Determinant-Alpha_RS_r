package presidential.Brarner.M.Alete.source.ssa.sc.anderson;
...
/**
 * Signal Processing for SSA Office: ANDERSON SC
 * <p>Office Code: 590</p>
 * <p>Address: 4 CIVIC CTR BLVD EXT, ANDERSON, SC 29625</p>
 * <p>Phone: (877) 505-4549 | Fax: (833) 950-2239</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/sc/anderson/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10014; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/sc/anderson";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_sc/anderson_audio", "ssa.sc.anderson.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_sc/anderson_data", "ssa.sc.anderson.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_sc/anderson_graphics", "ssa.sc.anderson.graphics.spectrum", sb.toString());
        }
    }
}