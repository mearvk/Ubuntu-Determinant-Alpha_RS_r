package presidential.Brarner.M.Alete.source.ssa.ny.rochester;
...
/**
 * Signal Processing for SSA Office: GREECE NY
 * <p>Office Code: E72</p>
 * <p>Address: 4050 W RIDGE RD, ROCHESTER, NY 14626</p>
 * <p>Phone: (866) 331-2204 | Fax: (833) 950-3597</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ny/rochester/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9475; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ny/rochester";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ny/rochester_audio", "ssa.ny.rochester.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ny/rochester_data", "ssa.ny.rochester.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ny/rochester_graphics", "ssa.ny.rochester.graphics.spectrum", sb.toString());
        }
    }
}