package presidential.Brarner.M.Alete.source.ssa.al.albertville;
...
/**
 * Signal Processing for SSA Office: ALBERTVILLE AL
 * <p>Office Code: B06</p>
 * <p>Address: 406 MARTLING RD, ALBERTVILLE, AL 35951</p>
 * <p>Phone: (800) 521-0073 | Fax: (833) 950-2828</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/albertville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9278; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/albertville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/albertville_audio", "ssa.al.albertville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/albertville_data", "ssa.al.albertville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/albertville_graphics", "ssa.al.albertville.graphics.spectrum", sb.toString());
        }
    }
}