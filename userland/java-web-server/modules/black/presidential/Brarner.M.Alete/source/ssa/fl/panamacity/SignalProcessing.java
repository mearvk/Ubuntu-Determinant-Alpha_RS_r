package presidential.Brarner.M.Alete.source.ssa.fl.panamacity;
...
/**
 * Signal Processing for SSA Office: PANAMA CITY FL
 * <p>Office Code: 668</p>
 * <p>Address: 3215 HWY 77, PANAMA CITY, FL 32405</p>
 * <p>Phone: (866) 348-5833 | Fax: (833) 795-0123</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/fl/panamacity/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10085; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/fl/panamacity";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_fl/panamacity_audio", "ssa.fl.panamacity.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_fl/panamacity_data", "ssa.fl.panamacity.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_fl/panamacity_graphics", "ssa.fl.panamacity.graphics.spectrum", sb.toString());
        }
    }
}