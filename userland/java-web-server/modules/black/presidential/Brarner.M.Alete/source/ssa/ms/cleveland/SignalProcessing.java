package presidential.Brarner.M.Alete.source.ssa.ms.cleveland;
...
/**
 * Signal Processing for SSA Office: CLEVELAND MS
 * <p>Office Code: A99</p>
 * <p>Address: 407 INDUSTRIAL PARKWAY, CLEVELAND, MS 38732</p>
 * <p>Phone: (877) 405-4638 | Fax: (833) 950-2818</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/ms/cleveland/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9272; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/ms/cleveland";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_ms/cleveland_audio", "ssa.ms.cleveland.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_ms/cleveland_data", "ssa.ms.cleveland.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_ms/cleveland_graphics", "ssa.ms.cleveland.graphics.spectrum", sb.toString());
        }
    }
}