package presidential.Brarner.M.Alete.source.ssa.nm.roswell;
...
/**
 * Signal Processing for SSA Office: ROSWELL NM
 * <p>Office Code: 859</p>
 * <p>Address: 500 N RICHARDSON AVENUE, ROSWELL, NM 88201</p>
 * <p>Phone: (866) 563-9470 | Fax: (833) 950-2720</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/nm/roswell/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10247; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/nm/roswell";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_nm/roswell_audio", "ssa.nm.roswell.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_nm/roswell_data", "ssa.nm.roswell.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_nm/roswell_graphics", "ssa.nm.roswell.graphics.spectrum", sb.toString());
        }
    }
}