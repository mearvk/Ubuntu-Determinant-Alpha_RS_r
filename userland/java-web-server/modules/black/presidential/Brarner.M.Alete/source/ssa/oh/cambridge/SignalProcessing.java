package presidential.Brarner.M.Alete.source.ssa.oh.cambridge;
...
/**
 * Signal Processing for SSA Office: CAMBRIDGE OH
 * <p>Office Code: C48</p>
 * <p>Address: 1225 WOODLAWN AVE, CAMBRIDGE, OH 43725</p>
 * <p>Phone: (866) 883-5281 | Fax: (833) 950-3703</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/cambridge/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9366; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/cambridge";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cambridge_audio", "ssa.oh.cambridge.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cambridge_data", "ssa.oh.cambridge.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/cambridge_graphics", "ssa.oh.cambridge.graphics.spectrum", sb.toString());
        }
    }
}