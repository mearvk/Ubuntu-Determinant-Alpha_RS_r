...
/**
 * Signal Processing for SSA Office: NEW PHILADELPHIA OH
 * <p>Office Code: 416</p>
 * <p>Address: 1260 MONROE ST NW, NEW PHILADELPHIA, OH 44663</p>
 * <p>Phone: (866) 731-4236 | Fax: (833) 950-3729</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/oh/newphiladelphia/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9857; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/oh/newphiladelphia";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_oh/newphiladelphia_audio", "ssa.oh.newphiladelphia.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_oh/newphiladelphia_data", "ssa.oh.newphiladelphia.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_oh/newphiladelphia_graphics", "ssa.oh.newphiladelphia.graphics.spectrum", sb.toString());
        }
    }
}