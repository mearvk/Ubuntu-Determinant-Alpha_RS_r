package presidential.Brarner.M.Alete.source.ssa.pa.monroeville;
...
/**
 * Signal Processing for SSA Office: MONROEVILLE PA
 * <p>Office Code: C11</p>
 * <p>Address: 300 OXFORD DR, MONROEVILLE, PA 15146</p>
 * <p>Phone: (888) 527-9339 | Fax: (833) 950-2586</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/pa/monroeville/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 9347; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/pa/monroeville";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_pa/monroeville_audio", "ssa.pa.monroeville.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_pa/monroeville_data", "ssa.pa.monroeville.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_pa/monroeville_graphics", "ssa.pa.monroeville.graphics.spectrum", sb.toString());
        }
    }
}