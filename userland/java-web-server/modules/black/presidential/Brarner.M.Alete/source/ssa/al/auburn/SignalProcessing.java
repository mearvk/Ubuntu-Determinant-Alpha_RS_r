package presidential.Brarner.M.Alete.source.ssa.al.auburn;
...
/**
 * Signal Processing for SSA Office: AUBURN AL
 * <p>Office Code: 633</p>
 * <p>Address: 2454 E UNIVERSITY DR, AUBURN, AL 36830</p>
 * <p>Phone: (877) 512-3857 | Fax: (833) 950-3505</p>
 */
public class SignalProcessing
{
    ...
    static { loadConfig("source-code/ssa/al/auburn/config.xml"); }
    ...
    private static void loadConfig(String path) {
        try {
            ...
            socketPort = 10056; localInputPath = "."; dbUrl = "jdbc:mysql://localhost:3306/Science";
            dbUser = "root"; dbPass = ""; outputDir = "output/ssa/al/auburn";
        }
    }
    ...
    public static class Audio {
        public static void process() throws Exception {
            ...
            output("ssa_al/auburn_audio", "ssa.al.auburn.audio.fft", sb.toString());
        }
    }
    ...
    public static class Data {
        public static void process() throws Exception {
            ...
            output("ssa_al/auburn_data", "ssa.al.auburn.data.stats", "mean=" + mean + "\nvariance=" + var + "\nn=" + raw.length + "\n");
        }
    }
    ...
    public static class Graphics {
        public static void process() throws Exception {
            ...
            output("ssa_al/auburn_graphics", "ssa.al.auburn.graphics.spectrum", sb.toString());
        }
    }
}