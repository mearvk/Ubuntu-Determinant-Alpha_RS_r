...
# NitroWebExpressâ„¢ â€” California NSA Frontend Startup
...
echo "â•‘  California NSA â€” Frontend Startup                                        â•‘"
...
if [ "$HTTP_CODE" = "200" ] || [ "$HTTP_CODE" = "302" ]; then
    echo "  [âœ“] California NSA webapp is UP â€” http://localhost:8080/$CONTEXT/"
else
