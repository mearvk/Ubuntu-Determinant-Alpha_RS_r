#!/usr/bin/env bash
# Languages — Local Connectivity & DB Test
...
echo "═══════════════════════════════════════════════════════════════"
echo " Languages — Local Connectivity & DB Test"
echo " Base URL: ${BASE}"
echo "═══════════════════════════════════════════════════════════════"
...
for jsp in index.jsp history.jsp translate.jsp; do
    check "/${jsp}" "${jsp}"
done
...
check_db_page "history.jsp"   "<td>|language|history|origin" "history.jsp"
check_db_page "translate.jsp" "<td>|word|translation|lang"   "translate.jsp"
