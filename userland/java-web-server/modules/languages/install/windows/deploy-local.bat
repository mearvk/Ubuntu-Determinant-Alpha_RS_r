@echo off
REM Languages — Deploy Local (Windows)
...
set DEPLOY_DIR=%TOMCAT_HOME%\webapps\languages

echo ═══════════════════════════════════════════════════════════════
echo  Languages — Deploy Local (Windows)
...
echo [OK] Deployed: http://localhost:8080/languages/
echo ═══════════════════════════════════════════════════════════════
pause
endlocal
