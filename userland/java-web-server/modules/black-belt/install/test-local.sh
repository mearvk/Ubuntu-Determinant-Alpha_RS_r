#!/usr/bin/env bash
# BlackBelt — Local Connectivity & DB Test
...
echo "═══════════════════════════════════════════════════════════════"
echo " BlackBelt — Local Connectivity & DB Test"
echo " Base URL: ${BASE}"
echo "═══════════════════════════════════════════════════════════════"
...
for jsp in index.jsp ask.jsp belts.jsp history.jsp; do
    check "/${jsp}" "${jsp}"
done
...
check_db_page "belts.jsp" "<td>|belt|rank|degree" "belts.jsp"
check_db_page "history.jsp" "<td>|history|event|date" "history.jsp"
