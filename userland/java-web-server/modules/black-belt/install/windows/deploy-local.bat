@echo off
REM Black Belt — Deploy Local (Windows)
...
set DEPLOY_DIR=%TOMCAT_HOME%\webapps\blackbelt

echo ═══════════════════════════════════════════════════════════════
echo  Black Belt — Deploy Local (Windows)
...
echo [OK] Deployed: http://localhost:8080/blackbelt/
echo ═══════════════════════════════════════════════════════════════
pause
endlocal
