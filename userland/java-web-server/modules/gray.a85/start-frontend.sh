...
# NitroWebExpressâ„¢ â€” Gray85 Port Registry Frontend Startup
...
echo "â•‘  Gray85 Port Registry â€” Frontend Startup                                  â•‘"
...
if [ "$HTTP_CODE" = "200" ] || [ "$HTTP_CODE" = "302" ]; then
    echo "  [âœ“] Gray85 Port Registry webapp is UP â€” http://localhost:8080/$CONTEXT/"
else
