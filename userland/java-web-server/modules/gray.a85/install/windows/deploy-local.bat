@echo off
REM Gray A85 — Deploy Local (Windows)
...
set DEPLOY_DIR=%TOMCAT_HOME%\webapps\gray85-registry

echo ═══════════════════════════════════════════════════════════════
echo  Gray A85 — Deploy Local (Windows)
...
echo [OK] Deployed: http://localhost:8080/gray85-registry/
echo ═══════════════════════════════════════════════════════════════
pause
endlocal
