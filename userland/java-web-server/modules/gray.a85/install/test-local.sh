#!/usr/bin/env bash
# Gray85CremeRegistry — Local Connectivity & DB Test
...
echo "═══════════════════════════════════════════════════════════════"
echo " Gray85CremeRegistry — Local Connectivity & DB Test"
echo " Base URL: ${BASE}"
echo "═══════════════════════════════════════════════════════════════"
...
for jsp in index.jsp bindings.jsp creme.jsp leases.jsp status.jsp; do
    check "/${jsp}" "${jsp}"
done
...
check_db_page "bindings.jsp" "<td>|binding|port|service" "bindings.jsp"
check_db_page "creme.jsp"    "<td>|creme|entry|value"    "creme.jsp"
check_db_page "leases.jsp"   "<td>|lease|expiry|host"    "leases.jsp"
