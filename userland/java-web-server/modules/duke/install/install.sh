#!/bin/bash
# Duke University™ — Module Install Script
...
echo "═══════════════════════════════════════════════════════════════"
echo " Duke University™ — Module Install"
echo "═══════════════════════════════════════════════════════════════"
echo ""
...
if [ -f "$MOD_ROOT/servlets/setup-db.sh" ]; then
    bash "$MOD_ROOT/servlets/setup-db.sh" && echo "  [✓] Database nwe_duke ready" || echo "  [!] Database setup had issues"
else
...
if type nwe_ensure_ufw &>/dev/null; then
    ...
    sudo ufw allow 49213/tcp >/dev/null 2>&1 && echo "  [✓] Port 49213 (backend) opened" || true
else
    ...
    if command -v ufw &>/dev/null; then
        ...
        sudo ufw allow 49213/tcp >/dev/null 2>&1
...
echo ""
echo "═══════════════════════════════════════════════════════════════"
echo " Duke University™ install complete."
echo " Backend port: 49213"
echo " Frontend:     http://localhost:8080/california-duke/"
echo "═══════════════════════════════════════════════════════════════"
