...
# NitroWebExpressâ„¢ â€” Duke University Frontend Startup
...
echo "â•‘  Duke University â€” Frontend Startup                                       â•‘"
...
if [ "$HTTP_CODE" = "200" ] || [ "$HTTP_CODE" = "302" ]; then
    echo "  [âœ“] Duke University webapp is UP â€” http://localhost:8080/$CONTEXT/"
else
