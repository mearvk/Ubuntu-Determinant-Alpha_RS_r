...
<%
    ...
    if ("POST".equals(request.getMethod())) {
        ...
        String collegeName = "Pratt School of Engineering";
...
<head>
    ...
    <title>Pratt School of Engineering — Duke University</title>
...
<body>
    ...
    <section class="hero">
        <h1>Pratt School of Engineering</h1>
        <p>Duke's engineering school — a leader in AI, quantum computing, robotics, and biomedical engineering, producing innovators who solve the world's most complex problems.</p>
    </section>
    ...
    <section class="section">
        ...
        <div class="table-wrap">
            <table>
                <tr><th>Programs Offered</th><td>Biomedical Engineering (BME), Civil &amp; Environmental Engineering (CEE), Electrical &amp; Computer Engineering (ECE), Mechanical Engineering &amp; Materials Science (MEMS), Computer Science (CS)</td></tr>
                <tr><th>Degrees</th><td>B.S.E., M.S., M.Eng., Ph.D.</td></tr>
                <tr><th>Notable Strengths</th><td>Artificial Intelligence, Quantum Computing, Robotics, Biomedical Engineering, Materials Science</td></tr>
                <tr><th>Approximate Enrollment</th><td>~1,400 undergraduates, ~1,200 graduate students</td></tr>
            </table>
        </div>
    </section>
    ...
    <section class="section">
        ...
        <div class="table-wrap">
            <table>
                <tr><th>Website</th><td><a href="https://pratt.duke.edu" style="color:#4B9CD3;">pratt.duke.edu</a></td></tr>
                <tr><th>Phone</th><td>(919) 660-5386</td></tr>
                <tr><th>Address</th><td>305 Teer Engineering Building, Box 90271, Durham NC 27708</td></tr>
            </table>
        </div>
    </section>

    <section class="section">
        <h2>Contact Pratt Engineering</h2>
        <p>Send an inquiry directly to the Pratt School of Engineering.</p>
        ...
        <form method="POST" action="pratt.jsp">
