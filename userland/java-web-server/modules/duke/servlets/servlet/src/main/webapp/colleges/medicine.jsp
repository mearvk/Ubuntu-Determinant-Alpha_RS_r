...
<%
    ...
    if ("POST".equals(request.getMethod())) {
        ...
        String collegeName = "Duke School of Medicine";
...
<head>
    ...
    <title>Duke School of Medicine — Duke University</title>
...
<body>
    ...
    <section class="hero">
        <h1>Duke School of Medicine</h1>
        <p>World-class medical research and education — advancing human health through groundbreaking discoveries in genomics, neuroscience, cancer biology, and immunology.</p>
    </section>
    ...
    <section class="section">
        ...
        <div class="table-wrap">
            <table>
                <tr><th>Programs Offered</th><td>Doctor of Medicine (MD), Ph.D., MD-PhD, Doctor of Physical Therapy (DPT), Physician Assistant (PA), Master's Programs</td></tr>
                <tr><th>Degrees</th><td>MD, PhD, MD-PhD, DPT, MHS, MMCi</td></tr>
                <tr><th>Major Research Areas</th><td>Genomics, Neuroscience, Cancer Biology, Immunology, Cardiovascular Medicine, Global Health</td></tr>
                <tr><th>Approximate Enrollment</th><td>~500 MD students, 1,000+ researchers</td></tr>
            </table>
        </div>
    </section>
    ...
    <section class="section">
        ...
        <div class="table-wrap">
            <table>
                <tr><th>Website</th><td><a href="https://medschool.duke.edu" style="color:#4B9CD3;">medschool.duke.edu</a></td></tr>
                <tr><th>Phone</th><td>(919) 684-2985</td></tr>
                <tr><th>Address</th><td>DUMC 3710, Durham NC 27710</td></tr>
            </table>
        </div>
    </section>

    <section class="section">
        <h2>Contact Duke Medicine</h2>
        <p>Send an inquiry directly to the Duke School of Medicine.</p>
        ...
        <form method="POST" action="medicine.jsp">
            ...
            <div class="form-group">
                ...
                <select id="inquiry_type" name="inquiry_type" required>
                    ...
                    <option value="MD Admissions">MD Admissions</option>
