...
# NitroWebExpressâ„¢ â€” Futuresâ„¢ Frontend Shutdown
...
echo "â•‘  Futuresâ„¢ Frontend â€” Shutdown                                             â•‘"
...
echo ""
echo "â•”â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•—"
echo "â•‘  Futuresâ„¢ Frontend Stopped                                                â•‘"
echo "â•‘                                                                            â•‘"
echo "â•‘  Management:                                                               â•‘"
echo "â•‘  Restart module:   bash start-frontend.sh                                 â•‘"
