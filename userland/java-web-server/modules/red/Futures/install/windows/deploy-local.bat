@echo off
REM Futures — Deploy Local (Windows)
...
set DEPLOY_DIR=%TOMCAT_HOME%\webapps\futures

echo ═══════════════════════════════════════════════════════════════
echo  Futures — Deploy Local (Windows)
...
echo [OK] Deployed: http://localhost:8080/futures/
echo ═══════════════════════════════════════════════════════════════
pause
endlocal
