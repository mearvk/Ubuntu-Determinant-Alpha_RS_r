...
# NitroWebExpressâ„¢ â€” California CIA Frontend Startup
...
echo "â•‘  California CIA â€” Frontend Startup                                        â•‘"
...
if [ "$HTTP_CODE" = "200" ] || [ "$HTTP_CODE" = "302" ]; then
    echo "  [âœ“] California CIA webapp is UP â€” http://localhost:8080/$CONTEXT/"
else
