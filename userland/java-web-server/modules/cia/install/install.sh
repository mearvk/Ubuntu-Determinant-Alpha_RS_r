#!/bin/bash
# California CIA™ — Module Install Script
...
echo "═══════════════════════════════════════════════════════════════"
echo " California CIA™ — Module Install"
echo "═══════════════════════════════════════════════════════════════"
echo ""
...
if [ -f "$MOD_ROOT/servlets/setup-db.sh" ]; then
    bash "$MOD_ROOT/servlets/setup-db.sh" && echo "  [✓] Database nwe_california_cia ready" || echo "  [!] Database setup had issues"
else
...
if type nwe_ensure_ufw &>/dev/null; then
    ...
    sudo ufw allow 49211/tcp >/dev/null 2>&1 && echo "  [✓] Port 49211 (backend) opened" || true
else
    ...
    if command -v ufw &>/dev/null; then
        ...
        sudo ufw allow 49211/tcp >/dev/null 2>&1
...
echo ""
echo "═══════════════════════════════════════════════════════════════"
echo " California CIA™ install complete."
echo " Backend port: 49211"
echo " Frontend:     http://localhost:8080/california-cia/"
echo "═══════════════════════════════════════════════════════════════"
