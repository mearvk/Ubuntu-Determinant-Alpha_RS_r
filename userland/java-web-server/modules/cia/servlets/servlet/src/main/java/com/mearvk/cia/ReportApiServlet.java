...
public class ReportApiServlet extends HttpServlet {
    @Override protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        try (Connection conn = getConn(req.getServletContext());
             PreparedStatement ps = conn.prepareStatement("INSERT INTO intelligence_reports (category, report_text, status) VALUES (?, ?, 'pending')", Statement.RETURN_GENERATED_KEYS)) {
