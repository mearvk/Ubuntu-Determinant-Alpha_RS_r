...
package international.radio.mexico;
...
public class MexicoSignalServer implements Runnable
{
    ...
    private void handleClient(Socket client)
    {
             ...
             OutputStream out = client.getOutputStream())
        {
            ...
            {
                out.write(("ALIVE|international.radio.mexico|port=" + PORT + "\n").getBytes(StandardCharsets.UTF_8));
            }
            else
            {
     ...
     *
     * @param sourceId source identifier from international.radio.mexico-config.xml
