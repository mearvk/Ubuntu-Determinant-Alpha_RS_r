...
`Ubuntu 22.04.3 LTS Source 1`

Files

221 chunks (`ubuntu_1_aa` → `ubuntu_1_im`)
...
`Ubuntu 22.04.3 LTS Source 2`

Files

221 chunks (`ubuntu_2_aa` → `ubuntu_2_im`)
...
`Ubuntu 22.04.3 LTS Source 3`

Files

62 chunks (`ubuntu_3_aa` → `ubuntu_3_cj`)
...
`Ubuntu 22.04.3 LTS Source 4`

Files

71 chunks (`ubuntu_4_aa` → `ubuntu_4_cs`)
...
`a_ k.Quit if your ahead`

Purpose

Signals end of the source disc set
...
MySQL Connector/J 9.7.0 source archive

`mysql-connector-j_9.7.0-1ubuntu25.10_all.deb`

2.5 MB

MySQL Connector/J 9.7.0 Debian package (binary)
...
`reassemble-source-iso-1.sh`

Reassemble Source Disc 1 (core, compilers, desktop)

`reassemble-source-iso-2.sh`

Reassemble Source Disc 2 (libraries, language packs)

`reassemble-source-iso-3.sh`

Reassemble Source Disc 3 (GPU drivers, audio, Java)

`reassemble-source-iso-4.sh`

Reassemble Source Disc 4 (kernel, dictionaries, OpenStack)

`reassemble-source-all.sh`

Reassemble all 4 discs (optionally extract pool)

`extract-source-packages.sh`

Extract individual or all source packages for development
