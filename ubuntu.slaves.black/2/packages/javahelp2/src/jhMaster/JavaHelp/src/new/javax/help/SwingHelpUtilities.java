      ...
      "HelpFavoritesNavigatorUI", basicPackageName + "BasicFavoritesNavigatorUI",
	   "HelpContentViewerUI", basicContentViewerUI,
	      ...
	      "HelpOnItemCursor", basicOnItemCursor,
               "BackAction.icon", makeBasicIcon("images/Back.png"),
            "ForwardAction.icon", makeBasicIcon("images/Forward.png"),
              "PrintAction.icon", makeBasicIcon("images/Print.png"),
         "PrintSetupAction.icon", makeBasicIcon("images/PrintSetup.png"),
             "ReloadAction.icon", makeBasicIcon("images/Reload.png"),
          "FavoritesAction.icon", makeBasicIcon("images/Favorites.png"),
               "HomeAction.icon", makeBasicIcon("images/Home.png"),
      	     "FavoritesNav.icon", makeBasicIcon("images/FavoritesNav.png"),
                 "IndexNav.icon", makeBasicIcon("images/IndexNav.png"),
                   "TOCNav.icon", makeBasicIcon("images/TOCNav.png"),
                "SearchNav.icon", makeBasicIcon("images/SearchNav.png"),
              "GlossaryNav.icon", makeBasicIcon("images/GlossaryNav.png"),
               "HistoryNav.icon", makeBasicIcon("images/HistoryNav.png"),
                "SearchLow.icon", makeBasicIcon("images/SearchLow.png"),
             "SearchMedLow.icon", makeBasicIcon("images/SearchMedLow.png"),
                "SearchMed.icon", makeBasicIcon("images/SearchMed.png"),
            "SearchMedHigh.icon", makeBasicIcon("images/SearchMedHigh.png"),
               "SearchHigh.icon", makeBasicIcon("images/SearchHigh.png")
	};
