...
are permitted. I< Optional. Type uniline.  > 
...
B<X11Forwarding> and B<X11UseLocalhost>. I< Optional. Type list of node of class L<Sshd::MatchBlock|Config::Model::models::Sshd::MatchBlock> .  > 
...
Specifies the L<moduli(5)> file
that contains the Diffie-Hellman groups used for the
“diffie-hellman-group-exchange-sha1” and
“diffie-hellman-group-exchange-sha256” key
exchange methods. The default is I</etc/ssh/moduli>. I< Optional. Type uniline.  > 
...
whichever is lower. The default is B<none>. I< Optional. Type uniline.  > 
...
=head2 PerSourceNetBlockSize

Specifies the number of bits of
...
considered individually. I< Optional. Type uniline.  > 
...
any effect for other, non-FIDO, public key types. I< Optional. Type enum. choice: 'none', 'touch-required', 'verify-required'.  > 
