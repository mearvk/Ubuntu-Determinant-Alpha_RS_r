...
/* In the original code, the code to add of the "b" was conditionally included
   only if the macro STDIO_NEEDS_BINARY was defined.  But for Netpbm, there
   is no need make a distinction; we always add the "b".  -BJH 2000.07.20.
*/
