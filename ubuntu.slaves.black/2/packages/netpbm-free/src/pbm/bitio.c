/*\
 * $Id: bitio.c,v 1.2 2003/09/02 11:52:17 aba-guest Exp $
 *
 ...
 *
 * $Log: bitio.c,v $
 * Revision 1.2  2003/09/02 11:52:17  aba-guest
 * reduced number of compiler warnings
 *
 * Revision 1.1  2003/08/15 14:30:17  aba-guest
 * Next part of update to 9.25
 *
