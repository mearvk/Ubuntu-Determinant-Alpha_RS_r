...
static void
process_atk_byte ARGS((int *pcurcount, unsigned char *pcurbyte, 
                  FILE *file, unsigned char newbyte, int eolflag));
static void
write_atk_bytes ARGS((FILE *file, unsigned char curbyte, 
...
static void
write_atk_bytes (FILE *file, unsigned char curbyte, unsigned int curcount) {
...
static void
process_atk_byte (int *pcurcount, unsigned char *pcurbyte, 
                  FILE *file, unsigned char newbyte, int eolflag) {
