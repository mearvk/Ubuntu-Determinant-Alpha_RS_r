...
from jupyter_core.version import version_info, __version__
...
htmlhelp_basename = 'jupyter_coredoc'
...
latex_documents = [
  (master_doc, 'jupyter_core.tex', 'jupyter\\_core Documentation',
...
man_pages = [
    (master_doc, 'jupyter_core', 'jupyter_core Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'jupyter_core', 'jupyter_core Documentation',
   author, 'jupyter_core', 'One line description of project.',
   'Miscellaneous'),
]
