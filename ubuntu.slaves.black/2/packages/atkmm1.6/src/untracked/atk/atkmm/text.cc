...
Glib::SignalProxy< void,int,int > Text::signal_text_changed()
{
  return Glib::SignalProxy< void,int,int >(this, &Text_signal_text_changed_info);
}


Glib::SignalProxy< void,int > Text::signal_text_caret_moved()
{
  return Glib::SignalProxy< void,int >(this, &Text_signal_text_caret_moved_info);
}


Glib::SignalProxy< void > Text::signal_text_selection_changed()
{
  return Glib::SignalProxy< void >(this, &Text_signal_text_selection_changed_info);
}


Glib::SignalProxy< void > Text::signal_text_attributes_changed()
{
  return Glib::SignalProxy< void >(this, &Text_signal_text_attributes_changed_info);
}
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->get_text)
  {
    Glib::ustring retval(Glib::convert_return_gchar_ptr_to_ustring((*base->get_text)(const_cast<AtkText*>(gobj()),start_offset,end_offset)));
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->get_text_after_offset)
  {
    Glib::ustring retval(Glib::convert_return_gchar_ptr_to_ustring((*base->get_text_after_offset)(const_cast<AtkText*>(gobj()),offset,((AtkTextBoundary)(boundary_type)),&(start_offset),&(end_offset))));
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->get_text_at_offset)
  {
    Glib::ustring retval(Glib::convert_return_gchar_ptr_to_ustring((*base->get_text_at_offset)(const_cast<AtkText*>(gobj()),offset,((AtkTextBoundary)(boundary_type)),&(start_offset),&(end_offset))));
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->get_text_before_offset)
  {
    Glib::ustring retval(Glib::convert_return_gchar_ptr_to_ustring((*base->get_text_before_offset)(const_cast<AtkText*>(gobj()),offset,((AtkTextBoundary)(boundary_type)),&(start_offset),&(end_offset))));
    return retval;
  }
...
g_type_interface_peek(G_OBJECT_GET_CLASS(gobject_), CppObjectType::get_type()) // Get the interface.
  ...
  if(base && base->get_selection)
  {
    Glib::ustring retval(Glib::convert_return_gchar_ptr_to_ustring((*base->get_selection)(const_cast<AtkText*>(gobj()),selection_num,&(start_offset),&(end_offset))));
    return retval;
  }
