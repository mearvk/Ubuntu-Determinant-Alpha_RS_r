...
{
  using namespace Atk;
  using SlotType = sigc::slot< void,guint,gpointer >;
...
{
  using namespace Atk;
  using SlotType = sigc::slot< void,AtkPropertyValues* >;
...
{
  using namespace Atk;
  using SlotType = sigc::slot< void,void** >;
...
Glib::SignalProxy< void,guint,gpointer > Object::signal_children_changed()
{
  return Glib::SignalProxy< void,guint,gpointer >(this, &Object_signal_children_changed_info);
}


Glib::SignalProxy< void,bool > Object::signal_focus_event()
{
  return Glib::SignalProxy< void,bool >(this, &Object_signal_focus_event_info);
}


Glib::SignalProxy< void,AtkPropertyValues* > Object::signal_property_change()
{
  return Glib::SignalProxy< void,AtkPropertyValues* >(this, &Object_signal_property_change_info);
}


Glib::SignalProxy< void,const Glib::ustring&,bool > Object::signal_state_change()
{
  return Glib::SignalProxy< void,const Glib::ustring&,bool >(this, &Object_signal_state_change_info);
}


Glib::SignalProxy< void > Object::signal_visible_data_changed()
{
  return Glib::SignalProxy< void >(this, &Object_signal_visible_data_changed_info);
}


Glib::SignalProxy< void,void** > Object::signal_active_descendant_changed()
{
  return Glib::SignalProxy< void,void** >(this, &Object_signal_active_descendant_changed_info);
}
