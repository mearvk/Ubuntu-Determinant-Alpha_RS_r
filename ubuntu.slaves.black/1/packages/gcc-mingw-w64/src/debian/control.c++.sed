...
s/@@RECOMMENDS@@//g
s/@@REPLACES32@@/gcc-mingw-w64 (<< ${firstsplit:Version}), g++-mingw-w64-i686 (<< ${threadsplit:Version})/g
s/@@REPLACES64@@/gcc-mingw-w64 (<< ${firstsplit:Version}), g++-mingw-w64-x86-64 (<< ${threadsplit:Version})/g
s/@@CONFLICTS32@@//g
s/@@CONFLICTS64@@//g
s/@@BREAKS32@@/gcc-mingw-w64 (<< ${firstsplit:Version}), g++-mingw-w64-i686 (<< ${threadsplit:Version})/g
s/@@BREAKS64@@/gcc-mingw-w64 (<< ${firstsplit:Version}), g++-mingw-w64-x86-64 (<< ${threadsplit:Version})/g
