...
@item FASTA
FAhrzeugbetriebs- und Servicedaten-Transfer und -Analyse (BMW)

@item FAT
File Allocation Table (DOS, FS)
...
@item FCBB
Fibre Channel BackBone (FCP), "FC-BB"
...
@item FCIA
Fibre Channel Industry Association (org.)
...
@item FDSN
Federation of Digital Seismograph Networks (org.)
...
@item FEM
Fabric Expander Module (Dell, FSE)
...
@item FHIR
Fast Healthcare Interoperability Resources (USA)
...
@item FOAF
Friend Of A Friend [vocabulary] (RDF)
...
@item FOIP
Face Over Internet Protocol (IP), "FoIP"
...
@item FOP
Formatting Object Processor (Apache, XSL-FO)
...
@item FOSSFA
Free Software and Open Source Foundation for Africa (org., Africa)
...
@item FS
Forward Secrecy (cryptography, PFS)
...
@item FSE
Fabric Switch Engine (Dell, FEM)

@item FSF
Free Software Foundation (org., GNU)

@item FSFE
Free Software Foundation Europe (org., FSF)

@item FSG
Free Standards Group (org.)
...
@item FSP
Firmware Support Package (Intel)
