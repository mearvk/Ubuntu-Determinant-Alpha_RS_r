...
@item E4M
Encryption 4 Masses (cryptography)
...
@item EBPF
Extended Berkeley Packet Filter (BPF), "eBPF"
...
@item ECIX
European Commercial Internet eXchange (company)
...
@item ECRYPTFS
Enterprise Cryptographic FileSystem (Linux, FS), "EcryptFS"
...
@item ECTEG
European Cybercrime Training and Education Group (org., Europe), "E.C.T.E.G."
...
@item EDPB
European Data Protection Board (org.)
...
@item EDRAM
Embedded Dynamic Random Access Memory (RAM, DRAM, IC), "eDRAM"

@item EDRAM
Enhanced Dynamic Random Access Memory (RAM, DRAM, IC)

@item EDRI
European Digital RIghts (org., Europe), "EDRi"

@item EDS
Electronic Data Systems [corporation] (provider, USA)

@item EDSA
Europaeischer DatenSchutzAusschuss (org.)

@item EDSAC
Electronic Delay Storage Automatic Calculator

@item EDSAP
Early Detection Sensor and Algorithm Package (Samsung)

@item EDSFF
Enterprise and Datacenter Storage Form Factor (Intel, Samsung, Facebook)
...
@item EITO
European Information Technology Observatory (org.)
...
@item EME
Encrypted Media Extensions (HTML, DRM)
...
@item EMIB
Embedded Multi-die Interconnect Bridge (IC, Intel)
...
@item EMMC
Embedded MultiMedia Card (JEDEC, MMC), "eMMC"
...
@item ENCFS
ENCrypted File System (Linux, FS), "EncFS"
...
@item ENUC
Embedded Next Unit of Computing (Intel, NUC), "eNUC"
...
@item EPCC
Edinburgh Parallel Computing Center (org., UK, HPC)

@item EPDF
Embedded Portable Document Format (Adobe, PDF, HTML)

@item EPEL
Extra Packages for Enterprise Linux (Linux, RHEL, Fedora, RedHat)
...
@item EPP
Extensible Provisioning Protocol (RFC 3730/3731/3732/3733/3734/3735)

@item EPRML
Extended Partial Response - Maximum Likelihood (PRML, HDD, HD-DVD)
...
@item EPT
Extended Page Tables (SLAT, Intel)
...
@item ESA
Entertainment Software Association (org., USA)
...
@item ESIM
Embedded Subscriber Identity Module (SIM, mobile-systems), "eSIM"
...
@item ESK
[Fraunhofer] Einrichtung Systeme der Kommunikationstechnik (org.)
...
@item ESP
[IP] Encapsulating Security Payload (IPSEC, IP, RFC 1825/1827/2406, VPN)
...
@item ETLS
Enterprise Transport Layer Security (TLS, ETSI), "eTLS"

@item ETNO
European Telecommunications Network Operators Association (org., ISP)

@item ETO
Essentials - Tools - Objects (Apple), "E.T.O."

@item ETP
Enhanced Tracking Protection (WWW, Firefox)
...
@item ETS
Emergency Telecommunication Service (RFC 3689)

@item ETS
Enhanced Transmission Selection (IEEE 802.1Qaz, DCB)
...
@item EUCTF
European Union Cybercrime Taskforce (org., Europe)
...
@item EUFS
Embedded Universal Flash Storage (UFS), "eUFS"
...
@item EURID
European Registry of Internet Domain names (org., Internet, Europe)

@item EUROISPA
EUROpean Internet Service Provider Association (org., ISP), "EuroISPA"
...
@item EUTRA
Evolved UMTS Terrestrial Radio Access (UMTS, LTE), "E-UTRA"
...
@item EXIF
Exchangeable Image File Format (DCF, photo, CIPA)
