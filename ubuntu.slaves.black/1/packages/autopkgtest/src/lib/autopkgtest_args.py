...
for details.'''
    ...
    g_test.add_argument('-a', '--architecture', metavar='ARCH',
                        help='run tests for (and when asked, build binaries '
                        'for) ARCH instead of the testbed host architecture. '
                        'Assumes ARCH is available as a foreign architecture '
                        'on the testbed and its binaries can be run, '
