...
''')
    ...
    def test_install_packages_permanent_sandbox(self):
        ...
        release = self._setup_foonux_config(release='jammy')
        zonetab = os.path.join(self.rootdir, 'usr/share/zoneinfo/zone.tab')

        impl.install_packages(self.rootdir, self.configdir, release,
        ...
        self.assertRaises(SystemExit, impl.install_packages, self.rootdir,
                          self.configdir, release, [('libc6', None)], False,
        ...
        for f in glob.glob(f'{self.cachedir}/{release}/apt/var/cache/apt/archives/coreutils*'):
            os.unlink(f)
        impl.install_packages(self.rootdir, self.configdir, release,
        ...
        self.assertRaises(SystemExit, impl.install_packages, self.rootdir,
                          self.configdir, release, [('aspell-doc', None)], False,
                          self.cachedir, permanent_rootdir=True)
    ...
    def test_install_old_packages(self):
        ...
        obsolete = impl.install_packages(self.rootdir, self.configdir, release,
