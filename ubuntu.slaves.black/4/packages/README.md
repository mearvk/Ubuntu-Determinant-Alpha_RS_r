...
|-----:|---------|-----------------|----------------|-----------------:|----------------|:-----------------:|---------|-------------|:---:|
| 1 | **openssl** | 1998 | OpenSSL Project | 28 | High | 72 | High — foundational; changes need strong evidence and review | OpenSSL — TLS/crypto toolkit and library | [x] |
...
| 14 | **linux-meta** | 2005 | Ubuntu | 21 | Moderate | 58 | Medium — meaningful integration/hardening value | Meta-packages selecting the Ubuntu kernel | [x] |
...
| 24 | **linux-base** | 2009 | Debian/Ubuntu | 17 | Moderate | 56 | Medium — meaningful integration/hardening value | Base system for the Linux kernel packages | [x] |
