...
The xmcLook icon set is presented here as the public-facing visual greeting for the tool. Each icon should be understood as a member of one system rather than as an isolated graphic.

> **See the symbol. Understand the action. Continue with confidence.**
...
- scalable vector artwork where available;
...
This document is the visual greeting and icon-gallery companion for `tools/xmclook`. It is intentionally written as a human-readable design document so the icon system can be understood before the implementation is opened.

Where an icon asset exists in this directory, the README and future public documentation should prefer showing the actual repository asset rather than substituting an unrelated illustration.
