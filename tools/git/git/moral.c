/* Native moral/blessing implementation. */
#include "git-compat-util.h"
#include "moral.h"

int git_moral_bless(struct git_moral_blessing *blessing,
	uintmax_t spell_count, int great_user, const char *software)
{
	if (!blessing || !spell_count || !software)
		return -1;
	if (spell_count > UINTMAX_MAX /
		git_moral_mana_for_spell(great_user != 0))
		return -1;
...
uintmax_t git_moral_total_mana(uintmax_t prior_mana,
