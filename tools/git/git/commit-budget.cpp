/*
 * C++ companion for the native commit-part planning policy.
 *
...
extern "C" int git_commit_part_plan_validate(
	const struct git_commit_part_plan *plan)
{
...
extern "C" uintmax_t git_commit_part_units_for_push(
	uintmax_t units, unsigned int push_index)
{
	uintmax_t first;
